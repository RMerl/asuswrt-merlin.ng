 ...
 *
 * $Id: bcmpcie.h 786719 2020-05-06 03:45:37Z $
 */
 ...
 * 0x83 : Host Memory Offload support, including SW_PAGING, In-Place Access, etc.
 */
 ...
 * -------------------------------------------------------
 *
 * Host Memory Offload features include text offload, aka SW_PAGING, and data offload with AIP.
 * Both use the host_location_info struct to convey the host addresses at which the pageable
 * text segment and the rodata segment are placed in the host DDR, in a reverse TLV (r-TLV)
 * fashion.
 *
 */
