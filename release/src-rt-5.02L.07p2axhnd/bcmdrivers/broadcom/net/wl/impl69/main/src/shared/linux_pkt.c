 ...
 *
 * $Id: linux_pkt.c 789774 2020-08-07 00:07:51Z $
 */
...
#ifdef BCM_OBJECT_TRACE
void BCMFASTPATH
linux_pktfree_slow(osl_t *osh, void *p, bool send, int line, const char *caller)
#else
void BCMFASTPATH
linux_pktfree_slow(osl_t *osh, void *p, bool send)
#endif /* BCM_OBJECT_TRACE */
{
	struct sk_buff *skb, *nskb;
	if (osh == NULL)
