...
typedef RDD_PACKETS_AND_BYTES_DTS * aligned_RDD_PACKETS_AND_BYTES_DTS ALIGNMENT8;
...
} RDD_PACKETS_AND_BYTES_DTS_NEW;
typedef RDD_PACKETS_AND_BYTES_DTS_NEW * aligned_RDD_PACKETS_AND_BYTES_DTS_NEW ALIGNMENT8;
...
/* >>>CPU_RX_FPM_POOL_NUMBER_MAPPING_TABLE */
...
#define RDD_CPU_RX_FPM_POOL_NUMBER_MAPPING_TABLE_SIZE     16
typedef struct
{
	RDD_FPM_POOL_NUMBER_DTS	entry[ RDD_CPU_RX_FPM_POOL_NUMBER_MAPPING_TABLE_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_CPU_RX_FPM_POOL_NUMBER_MAPPING_TABLE_DTS;

extern uint32_t RDD_CPU_RX_FPM_POOL_NUMBER_MAPPING_TABLE_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_CPU_RX_FPM_POOL_NUMBER_MAPPING_TABLE_PTR(core_id)	( RDD_CPU_RX_FPM_POOL_NUMBER_MAPPING_TABLE_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_CPU_RX_FPM_POOL_NUMBER_MAPPING_TABLE_ADDRESS_ARR[core_id] ))
...
typedef struct
{
	...
	union{
		...
		struct{
			...
			uint32_t	reserved3_sid_9_2       	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
			uint32_t	reserved3_frag_length   	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
		};
	};
	/* Union WORD 1 */
	union{
	...
	union{
		...
		struct{
			...
			uint32_t	bn0_first               	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of payload_offset_sop union */
		};
		/* Sub Union 3 */
		struct{
...
{
#ifndef FIRMWARE_LITTLE_ENDIAN
	uint32_t	bb_destination	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#else
	uint32_t	bb_destination	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
#endif
}
...
typedef RDD_BB_DESTINATION_ENTRY_DTS * aligned_RDD_BB_DESTINATION_ENTRY_DTS ALIGNMENT8;
...
} RDD_BB_DESTINATION_ENTRY_DTS_NEW;
typedef RDD_BB_DESTINATION_ENTRY_DTS_NEW * aligned_RDD_BB_DESTINATION_ENTRY_DTS_NEW ALIGNMENT8;
...
#define RDD_PROCESSING_RX_DESCRIPTOR_IS_LOOPBACK_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PROCESSING_RX_DESCRIPTOR_DTS) + 5, 1, 1, r)
#define RDD_PROCESSING_RX_DESCRIPTOR_IS_LOOPBACK_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PROCESSING_RX_DESCRIPTOR_DTS) + 5, 1, 1, v)
#define RDD_PROCESSING_RX_DESCRIPTOR_IS_LOOPBACK_READ(r, p)                        FIELD_MREAD_8((uint8_t *)p + 5, 1, 1, r)
#define RDD_PROCESSING_RX_DESCRIPTOR_IS_LOOPBACK_WRITE(v, p)                       FIELD_MWRITE_8((uint8_t *)p + 5, 1, 1, v)
#define RDD_PROCESSING_RX_DESCRIPTOR_CPU_TX_READ_G(r, g, idx)                      GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PROCESSING_RX_DESCRIPTOR_DTS) + 5, 0, 1, r)
#define RDD_PROCESSING_RX_DESCRIPTOR_CPU_TX_WRITE_G(v, g, idx)                     GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PROCESSING_RX_DESCRIPTOR_DTS) + 5, 0, 1, v)
#define RDD_PROCESSING_RX_DESCRIPTOR_CPU_TX_READ(r, p)                             FIELD_MREAD_8((uint8_t *)p + 5, 0, 1, r)
#define RDD_PROCESSING_RX_DESCRIPTOR_CPU_TX_WRITE(v, p)                            FIELD_MWRITE_8((uint8_t *)p + 5, 0, 1, v)
#define RDD_PROCESSING_RX_DESCRIPTOR_G9991_SYSTEM_PORT_READ_G(r, g, idx)           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PROCESSING_RX_DESCRIPTOR_DTS) + 6, 7, 1, r)
#define RDD_PROCESSING_RX_DESCRIPTOR_G9991_SYSTEM_PORT_WRITE_G(v, g, idx)          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PROCESSING_RX_DESCRIPTOR_DTS) + 6, 7, 1, v)
#define RDD_PROCESSING_RX_DESCRIPTOR_G9991_SYSTEM_PORT_READ(r, p)                  FIELD_MREAD_8((uint8_t *)p + 6, 7, 1, r)
#define RDD_PROCESSING_RX_DESCRIPTOR_G9991_SYSTEM_PORT_WRITE(v, p)                 FIELD_MWRITE_8((uint8_t *)p + 6, 7, 1, v)
...
#define RDD_SRAM_SCRATCH_SIZE     2048
typedef struct
{
	RDD_BYTE_1_DTS	entry[ RDD_SRAM_SCRATCH_SIZE ];
}
__PACKING_ATTRIBUTE_STRUCT_END__ RDD_SRAM_SCRATCH_DTS;

extern uint32_t RDD_SRAM_SCRATCH_ADDRESS_ARR[GROUPED_EN_SEGMENTS_NUM];

#define RDD_SRAM_SCRATCH_PTR(core_id)	( RDD_SRAM_SCRATCH_DTS * )(DEVICE_ADDRESS( rdp_runner_core_addr[core_id] + RDD_SRAM_SCRATCH_ADDRESS_ARR[core_id] ))
...
#define RDD_PROCESSING_TX_DESCRIPTOR_CONG_STATE_STREAM_L_READ( wv )            FIELD_GET( wv, 28, 3 )
#define RDD_PROCESSING_TX_DESCRIPTOR_CONG_STATE_STREAM_L_WRITE( v, wv )        FIELD_SET( v, 28, 3, wv )
...
#define RDD_PROCESSING_TX_DESCRIPTOR_STREAM_ID_L_READ( wv )                    FIELD_GET( wv, 28, 3 )
#define RDD_PROCESSING_TX_DESCRIPTOR_STREAM_ID_L_WRITE( v, wv )                FIELD_SET( v, 28, 3, wv )
...
#define PARSER_SUMMARY_IP_LEN_ERROR_F_OFFSET                     22
#define PARSER_SUMMARY_IP_LEN_ERROR_F_WIDTH                      1
#define PARSER_SUMMARY_IP_LEN_ERROR_OFFSET                       1
#define PARSER_SUMMARY_IP_LEN_ERROR_WORD_OFFSET                  0
#define PARSER_SUMMARY_IP_LEN_ERROR_F_OFFSET_MOD8                6
#define PARSER_SUMMARY_IP_LEN_ERROR_F_OFFSET_MOD16               6
...
#define PARSER_SUMMARY_HDR_LEN_ERR_F_OFFSET                      20
#define PARSER_SUMMARY_HDR_LEN_ERR_F_WIDTH                       1
#define PARSER_SUMMARY_HDR_LEN_ERR_OFFSET                        1
#define PARSER_SUMMARY_HDR_LEN_ERR_WORD_OFFSET                   0
#define PARSER_SUMMARY_HDR_LEN_ERR_F_OFFSET_MOD8                 4
#define PARSER_SUMMARY_HDR_LEN_ERR_F_OFFSET_MOD16                4
#define PARSER_SUMMARY_CHKSM_ERR_F_OFFSET                        19
#define PARSER_SUMMARY_CHKSM_ERR_F_WIDTH                         1
#define PARSER_SUMMARY_CHKSM_ERR_OFFSET                          1
#define PARSER_SUMMARY_CHKSM_ERR_WORD_OFFSET                     0
#define PARSER_SUMMARY_CHKSM_ERR_F_OFFSET_MOD8                   3
#define PARSER_SUMMARY_CHKSM_ERR_F_OFFSET_MOD16                  3
#define PARSER_SUMMARY_VER_MISS_F_OFFSET                         18
#define PARSER_SUMMARY_VER_MISS_F_WIDTH                          1
#define PARSER_SUMMARY_VER_MISS_OFFSET                           1
#define PARSER_SUMMARY_VER_MISS_WORD_OFFSET                      0
#define PARSER_SUMMARY_VER_MISS_F_OFFSET_MOD8                    2
#define PARSER_SUMMARY_VER_MISS_F_OFFSET_MOD16                   2
...
#define PARSER_SUMMARY_NON_L4_FAST_PROTOCOL_F_OFFSET             8
#define PARSER_SUMMARY_NON_L4_FAST_PROTOCOL_F_WIDTH              1
#define PARSER_SUMMARY_NON_L4_FAST_PROTOCOL_OFFSET               2
#define PARSER_SUMMARY_NON_L4_FAST_PROTOCOL_WORD_OFFSET          0
#define PARSER_SUMMARY_NON_L4_FAST_PROTOCOL_F_OFFSET_MOD8        0
#define PARSER_SUMMARY_NON_L4_FAST_PROTOCOL_F_OFFSET_MOD16       8
#define PARSER_SUMMARY_GRE_PROTOCOL_ERROR_F_OFFSET               7
#define PARSER_SUMMARY_GRE_PROTOCOL_ERROR_F_WIDTH                1
#define PARSER_SUMMARY_GRE_PROTOCOL_ERROR_OFFSET                 3
#define PARSER_SUMMARY_GRE_PROTOCOL_ERROR_WORD_OFFSET            0
#define PARSER_SUMMARY_GRE_PROTOCOL_ERROR_F_OFFSET_MOD8          7
#define PARSER_SUMMARY_GRE_PROTOCOL_ERROR_F_OFFSET_MOD16         7
#define PARSER_SUMMARY_FREE_F_OFFSET                             6
#define PARSER_SUMMARY_FREE_F_WIDTH                              1
#define PARSER_SUMMARY_FREE_OFFSET                               3
#define PARSER_SUMMARY_FREE_WORD_OFFSET                          0
#define PARSER_SUMMARY_FREE_F_OFFSET_MOD8                        6
#define PARSER_SUMMARY_FREE_F_OFFSET_MOD16                       6
...
typedef struct
{
	...
	uint32_t	non_l4_fast_protocol  	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	gre_protocol_error    	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	free                  	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_PARSER_SUMMARY_IP_LEN_ERROR_READ_G(r, g, idx)                    GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 1, 6, 1, r)
#define RDD_PARSER_SUMMARY_IP_LEN_ERROR_WRITE_G(v, g, idx)                   GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 1, 6, 1, v)
#define RDD_PARSER_SUMMARY_IP_LEN_ERROR_READ(r, p)                           FIELD_MREAD_8((uint8_t *)p + 1, 6, 1, r)
#define RDD_PARSER_SUMMARY_IP_LEN_ERROR_WRITE(v, p)                          FIELD_MWRITE_8((uint8_t *)p + 1, 6, 1, v)
...
#define RDD_PARSER_SUMMARY_HDR_LEN_ERR_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 1, 4, 1, r)
#define RDD_PARSER_SUMMARY_HDR_LEN_ERR_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 1, 4, 1, v)
#define RDD_PARSER_SUMMARY_HDR_LEN_ERR_READ(r, p)                            FIELD_MREAD_8((uint8_t *)p + 1, 4, 1, r)
#define RDD_PARSER_SUMMARY_HDR_LEN_ERR_WRITE(v, p)                           FIELD_MWRITE_8((uint8_t *)p + 1, 4, 1, v)
#define RDD_PARSER_SUMMARY_CHKSM_ERR_READ_G(r, g, idx)                       GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 1, 3, 1, r)
#define RDD_PARSER_SUMMARY_CHKSM_ERR_WRITE_G(v, g, idx)                      GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 1, 3, 1, v)
#define RDD_PARSER_SUMMARY_CHKSM_ERR_READ(r, p)                              FIELD_MREAD_8((uint8_t *)p + 1, 3, 1, r)
#define RDD_PARSER_SUMMARY_CHKSM_ERR_WRITE(v, p)                             FIELD_MWRITE_8((uint8_t *)p + 1, 3, 1, v)
#define RDD_PARSER_SUMMARY_VER_MISS_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 1, 2, 1, r)
#define RDD_PARSER_SUMMARY_VER_MISS_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 1, 2, 1, v)
#define RDD_PARSER_SUMMARY_VER_MISS_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p + 1, 2, 1, r)
#define RDD_PARSER_SUMMARY_VER_MISS_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p + 1, 2, 1, v)
...
#define RDD_PARSER_SUMMARY_NON_L4_FAST_PROTOCOL_READ_G(r, g, idx)            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 2, 0, 1, r)
#define RDD_PARSER_SUMMARY_NON_L4_FAST_PROTOCOL_WRITE_G(v, g, idx)           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 2, 0, 1, v)
#define RDD_PARSER_SUMMARY_NON_L4_FAST_PROTOCOL_READ(r, p)                   FIELD_MREAD_8((uint8_t *)p + 2, 0, 1, r)
#define RDD_PARSER_SUMMARY_NON_L4_FAST_PROTOCOL_WRITE(v, p)                  FIELD_MWRITE_8((uint8_t *)p + 2, 0, 1, v)
#define RDD_PARSER_SUMMARY_GRE_PROTOCOL_ERROR_READ_G(r, g, idx)              GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 3, 7, 1, r)
#define RDD_PARSER_SUMMARY_GRE_PROTOCOL_ERROR_WRITE_G(v, g, idx)             GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 3, 7, 1, v)
#define RDD_PARSER_SUMMARY_GRE_PROTOCOL_ERROR_READ(r, p)                     FIELD_MREAD_8((uint8_t *)p + 3, 7, 1, r)
#define RDD_PARSER_SUMMARY_GRE_PROTOCOL_ERROR_WRITE(v, p)                    FIELD_MWRITE_8((uint8_t *)p + 3, 7, 1, v)
#define RDD_PARSER_SUMMARY_FREE_READ_G(r, g, idx)                            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 3, 6, 1, r)
#define RDD_PARSER_SUMMARY_FREE_WRITE_G(v, g, idx)                           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_SUMMARY_DTS) + 3, 6, 1, v)
#define RDD_PARSER_SUMMARY_FREE_READ(r, p)                                   FIELD_MREAD_8((uint8_t *)p + 3, 6, 1, r)
#define RDD_PARSER_SUMMARY_FREE_WRITE(v, p)                                  FIELD_MWRITE_8((uint8_t *)p + 3, 6, 1, v)
...
#define PARSER_RESULT_IP_FRAGMENT_F_OFFSET                      30
...
#define PARSER_RESULT_IP_FRAGMENT_F_OFFSET_MOD8                 6
#define PARSER_RESULT_IP_FRAGMENT_F_OFFSET_MOD16                14
#define PARSER_RESULT_L4_1588_F_OFFSET                          29
#define PARSER_RESULT_L4_1588_F_WIDTH                           1
#define PARSER_RESULT_L4_1588_OFFSET                            0
#define PARSER_RESULT_L4_1588_WORD_OFFSET                       0
#define PARSER_RESULT_L4_1588_F_OFFSET_MOD8                     5
#define PARSER_RESULT_L4_1588_F_OFFSET_MOD16                    13
#define PARSER_RESULT_TCP_UDP_F_OFFSET                          28
#define PARSER_RESULT_TCP_UDP_F_WIDTH                           1
#define PARSER_RESULT_TCP_UDP_OFFSET                            0
#define PARSER_RESULT_TCP_UDP_WORD_OFFSET                       0
#define PARSER_RESULT_TCP_UDP_F_OFFSET_MOD8                     4
#define PARSER_RESULT_TCP_UDP_F_OFFSET_MOD16                    12
#define PARSER_RESULT_DHCP_F_OFFSET                             27
#define PARSER_RESULT_DHCP_F_WIDTH                              1
#define PARSER_RESULT_DHCP_OFFSET                               0
#define PARSER_RESULT_DHCP_WORD_OFFSET                          0
#define PARSER_RESULT_DHCP_F_OFFSET_MOD8                        3
#define PARSER_RESULT_DHCP_F_OFFSET_MOD16                       11
#define PARSER_RESULT_BROADCAST_F_OFFSET                        26
#define PARSER_RESULT_BROADCAST_F_WIDTH                         1
#define PARSER_RESULT_BROADCAST_OFFSET                          0
#define PARSER_RESULT_BROADCAST_WORD_OFFSET                     0
#define PARSER_RESULT_BROADCAST_F_OFFSET_MOD8                   2
#define PARSER_RESULT_BROADCAST_F_OFFSET_MOD16                  10
#define PARSER_RESULT_MULTICAST_F_OFFSET                        25
#define PARSER_RESULT_MULTICAST_F_WIDTH                         1
#define PARSER_RESULT_MULTICAST_OFFSET                          0
#define PARSER_RESULT_MULTICAST_WORD_OFFSET                     0
#define PARSER_RESULT_MULTICAST_F_OFFSET_MOD8                   1
#define PARSER_RESULT_MULTICAST_F_OFFSET_MOD16                  9
#define PARSER_RESULT_DOS_ATTACK_F_OFFSET                       24
#define PARSER_RESULT_DOS_ATTACK_F_WIDTH                        1
#define PARSER_RESULT_DOS_ATTACK_OFFSET                         0
#define PARSER_RESULT_DOS_ATTACK_WORD_OFFSET                    0
#define PARSER_RESULT_DOS_ATTACK_F_OFFSET_MOD8                  0
#define PARSER_RESULT_DOS_ATTACK_F_OFFSET_MOD16                 8
#define PARSER_RESULT_MC_L3_CTL_F_OFFSET                        23
#define PARSER_RESULT_MC_L3_CTL_F_WIDTH                         1
#define PARSER_RESULT_MC_L3_CTL_OFFSET                          1
#define PARSER_RESULT_MC_L3_CTL_WORD_OFFSET                     0
#define PARSER_RESULT_MC_L3_CTL_F_OFFSET_MOD8                   7
#define PARSER_RESULT_MC_L3_CTL_F_OFFSET_MOD16                  7
#define PARSER_RESULT_IP_LEN_ERROR_F_OFFSET                     22
#define PARSER_RESULT_IP_LEN_ERROR_F_WIDTH                      1
#define PARSER_RESULT_IP_LEN_ERROR_OFFSET                       1
#define PARSER_RESULT_IP_LEN_ERROR_WORD_OFFSET                  0
#define PARSER_RESULT_IP_LEN_ERROR_F_OFFSET_MOD8                6
#define PARSER_RESULT_IP_LEN_ERROR_F_OFFSET_MOD16               6
#define PARSER_RESULT_ICMPV6_F_OFFSET                           21
#define PARSER_RESULT_ICMPV6_F_WIDTH                            1
#define PARSER_RESULT_ICMPV6_OFFSET                             1
#define PARSER_RESULT_ICMPV6_WORD_OFFSET                        0
#define PARSER_RESULT_ICMPV6_F_OFFSET_MOD8                      5
#define PARSER_RESULT_ICMPV6_F_OFFSET_MOD16                     5
#define PARSER_RESULT_HDR_LEN_ERR_F_OFFSET                      20
#define PARSER_RESULT_HDR_LEN_ERR_F_WIDTH                       1
#define PARSER_RESULT_HDR_LEN_ERR_OFFSET                        1
#define PARSER_RESULT_HDR_LEN_ERR_WORD_OFFSET                   0
#define PARSER_RESULT_HDR_LEN_ERR_F_OFFSET_MOD8                 4
#define PARSER_RESULT_HDR_LEN_ERR_F_OFFSET_MOD16                4
#define PARSER_RESULT_CHKSM_ERR_F_OFFSET                        19
#define PARSER_RESULT_CHKSM_ERR_F_WIDTH                         1
#define PARSER_RESULT_CHKSM_ERR_OFFSET                          1
#define PARSER_RESULT_CHKSM_ERR_WORD_OFFSET                     0
#define PARSER_RESULT_CHKSM_ERR_F_OFFSET_MOD8                   3
#define PARSER_RESULT_CHKSM_ERR_F_OFFSET_MOD16                  3
#define PARSER_RESULT_VER_MISS_F_OFFSET                         18
#define PARSER_RESULT_VER_MISS_F_WIDTH                          1
#define PARSER_RESULT_VER_MISS_OFFSET                           1
#define PARSER_RESULT_VER_MISS_WORD_OFFSET                      0
#define PARSER_RESULT_VER_MISS_F_OFFSET_MOD8                    2
#define PARSER_RESULT_VER_MISS_F_OFFSET_MOD16                   2
#define PARSER_RESULT_LAYER3_PROTOCOL_F_OFFSET                  16
#define PARSER_RESULT_LAYER3_PROTOCOL_F_WIDTH                   2
#define PARSER_RESULT_LAYER3_PROTOCOL_OFFSET                    1
#define PARSER_RESULT_LAYER3_PROTOCOL_WORD_OFFSET               0
#define PARSER_RESULT_LAYER3_PROTOCOL_F_OFFSET_MOD8             0
#define PARSER_RESULT_LAYER3_PROTOCOL_F_OFFSET_MOD16            0
#define PARSER_RESULT_IPV6_EXT_HEADER_FILTER_F_OFFSET           15
#define PARSER_RESULT_IPV6_EXT_HEADER_FILTER_F_WIDTH            1
#define PARSER_RESULT_IPV6_EXT_HEADER_FILTER_OFFSET             2
#define PARSER_RESULT_IPV6_EXT_HEADER_FILTER_WORD_OFFSET        0
#define PARSER_RESULT_IPV6_EXT_HEADER_FILTER_F_OFFSET_MOD8      7
#define PARSER_RESULT_IPV6_EXT_HEADER_FILTER_F_OFFSET_MOD16     15
#define PARSER_RESULT_TCP_FLAG_F_OFFSET                         14
#define PARSER_RESULT_TCP_FLAG_F_WIDTH                          1
#define PARSER_RESULT_TCP_FLAG_OFFSET                           2
#define PARSER_RESULT_TCP_FLAG_WORD_OFFSET                      0
#define PARSER_RESULT_TCP_FLAG_F_OFFSET_MOD8                    6
#define PARSER_RESULT_TCP_FLAG_F_OFFSET_MOD16                   14
#define PARSER_RESULT_EXCEPTION_F_OFFSET                        13
#define PARSER_RESULT_EXCEPTION_F_WIDTH                         1
#define PARSER_RESULT_EXCEPTION_OFFSET                          2
#define PARSER_RESULT_EXCEPTION_WORD_OFFSET                     0
#define PARSER_RESULT_EXCEPTION_F_OFFSET_MOD8                   5
#define PARSER_RESULT_EXCEPTION_F_OFFSET_MOD16                  13
#define PARSER_RESULT_IP_MC_L2_F_OFFSET                         12
#define PARSER_RESULT_IP_MC_L2_F_WIDTH                          1
#define PARSER_RESULT_IP_MC_L2_OFFSET                           2
#define PARSER_RESULT_IP_MC_L2_WORD_OFFSET                      0
...
#define PARSER_RESULT_MC_L3_OFFSET                              2
#define PARSER_RESULT_MC_L3_WORD_OFFSET                         0
...
#define PARSER_RESULT_ERROR_OFFSET                              2
#define PARSER_RESULT_ERROR_WORD_OFFSET                         0
#define PARSER_RESULT_ERROR_F_OFFSET_MOD8                       2
#define PARSER_RESULT_ERROR_F_OFFSET_MOD16                      10
#define PARSER_RESULT_TUNNEL_F_OFFSET                           9
#define PARSER_RESULT_TUNNEL_F_WIDTH                            1
#define PARSER_RESULT_TUNNEL_OFFSET                             2
#define PARSER_RESULT_TUNNEL_WORD_OFFSET                        0
#define PARSER_RESULT_TUNNEL_F_OFFSET_MOD8                      1
#define PARSER_RESULT_TUNNEL_F_OFFSET_MOD16                     9
#define PARSER_RESULT_NON_L4_FAST_PROTOCOL_F_OFFSET             8
#define PARSER_RESULT_NON_L4_FAST_PROTOCOL_F_WIDTH              1
#define PARSER_RESULT_NON_L4_FAST_PROTOCOL_OFFSET               2
#define PARSER_RESULT_NON_L4_FAST_PROTOCOL_WORD_OFFSET          0
#define PARSER_RESULT_NON_L4_FAST_PROTOCOL_F_OFFSET_MOD8        0
#define PARSER_RESULT_NON_L4_FAST_PROTOCOL_F_OFFSET_MOD16       8
#define PARSER_RESULT_GRE_PROTOCOL_ERROR_F_OFFSET               7
#define PARSER_RESULT_GRE_PROTOCOL_ERROR_F_WIDTH                1
#define PARSER_RESULT_GRE_PROTOCOL_ERROR_OFFSET                 3
#define PARSER_RESULT_GRE_PROTOCOL_ERROR_WORD_OFFSET            0
#define PARSER_RESULT_GRE_PROTOCOL_ERROR_F_OFFSET_MOD8          7
#define PARSER_RESULT_GRE_PROTOCOL_ERROR_F_OFFSET_MOD16         7
#define PARSER_RESULT_FREE_F_OFFSET                             6
#define PARSER_RESULT_FREE_F_WIDTH                              1
#define PARSER_RESULT_FREE_OFFSET                               3
#define PARSER_RESULT_FREE_WORD_OFFSET                          0
#define PARSER_RESULT_FREE_F_OFFSET_MOD8                        6
#define PARSER_RESULT_FREE_F_OFFSET_MOD16                       6
#define PARSER_RESULT_DNS_F_OFFSET                              5
#define PARSER_RESULT_DNS_F_WIDTH                               1
#define PARSER_RESULT_DNS_OFFSET                                3
#define PARSER_RESULT_DNS_WORD_OFFSET                           0
#define PARSER_RESULT_DNS_F_OFFSET_MOD8                         5
#define PARSER_RESULT_DNS_F_OFFSET_MOD16                        5
#define PARSER_RESULT_FIRST_IP_FRAGMENT_F_OFFSET                4
#define PARSER_RESULT_FIRST_IP_FRAGMENT_F_WIDTH                 1
#define PARSER_RESULT_FIRST_IP_FRAGMENT_OFFSET                  3
#define PARSER_RESULT_FIRST_IP_FRAGMENT_WORD_OFFSET             0
#define PARSER_RESULT_FIRST_IP_FRAGMENT_F_OFFSET_MOD8           4
#define PARSER_RESULT_FIRST_IP_FRAGMENT_F_OFFSET_MOD16          4
#define PARSER_RESULT_L2_PROTOCOL_F_OFFSET                      0
#define PARSER_RESULT_L2_PROTOCOL_F_WIDTH                       4
#define PARSER_RESULT_L2_PROTOCOL_OFFSET                        3
#define PARSER_RESULT_L2_PROTOCOL_WORD_OFFSET                   0
#define PARSER_RESULT_L2_PROTOCOL_F_OFFSET_MOD8                 0
#define PARSER_RESULT_L2_PROTOCOL_F_OFFSET_MOD16                0
#define PARSER_RESULT_L4_PROTOCOL_F_OFFSET                      28
#define PARSER_RESULT_L4_PROTOCOL_F_WIDTH                       4
#define PARSER_RESULT_L4_PROTOCOL_OFFSET                        4
#define PARSER_RESULT_L4_PROTOCOL_WORD_OFFSET                   1
#define PARSER_RESULT_L4_PROTOCOL_F_OFFSET_MOD8                 4
#define PARSER_RESULT_L4_PROTOCOL_F_OFFSET_MOD16                12
#define PARSER_RESULT_V6_AH_F_OFFSET                            27
#define PARSER_RESULT_V6_AH_F_WIDTH                             1
#define PARSER_RESULT_V6_AH_OFFSET                              4
#define PARSER_RESULT_V6_AH_WORD_OFFSET                         1
#define PARSER_RESULT_V6_AH_F_OFFSET_MOD8                       3
#define PARSER_RESULT_V6_AH_F_OFFSET_MOD16                      11
#define PARSER_RESULT_V6_DEST_OPT_F_OFFSET                      26
#define PARSER_RESULT_V6_DEST_OPT_F_WIDTH                       1
#define PARSER_RESULT_V6_DEST_OPT_OFFSET                        4
#define PARSER_RESULT_V6_DEST_OPT_WORD_OFFSET                   1
#define PARSER_RESULT_V6_DEST_OPT_F_OFFSET_MOD8                 2
#define PARSER_RESULT_V6_DEST_OPT_F_OFFSET_MOD16                10
#define PARSER_RESULT_V6_ROUTE_F_OFFSET                         25
#define PARSER_RESULT_V6_ROUTE_F_WIDTH                          1
#define PARSER_RESULT_V6_ROUTE_OFFSET                           4
#define PARSER_RESULT_V6_ROUTE_WORD_OFFSET                      1
#define PARSER_RESULT_V6_ROUTE_F_OFFSET_MOD8                    1
#define PARSER_RESULT_V6_ROUTE_F_OFFSET_MOD16                   9
#define PARSER_RESULT_V6_HOP_F_OFFSET                           24
#define PARSER_RESULT_V6_HOP_F_WIDTH                            1
#define PARSER_RESULT_V6_HOP_OFFSET                             4
#define PARSER_RESULT_V6_HOP_WORD_OFFSET                        1
#define PARSER_RESULT_V6_HOP_F_OFFSET_MOD8                      0
#define PARSER_RESULT_V6_HOP_F_OFFSET_MOD16                     8
#define PARSER_RESULT_TCP_FLAGS_F_OFFSET                        16
#define PARSER_RESULT_TCP_FLAGS_F_WIDTH                         8
#define PARSER_RESULT_TCP_FLAGS_OFFSET                          5
#define PARSER_RESULT_TCP_FLAGS_WORD_OFFSET                     1
#define PARSER_RESULT_TCP_FLAGS_F_OFFSET_MOD16                  0
#define PARSER_RESULT_LAYER3_OFFSET_F_OFFSET                    8
#define PARSER_RESULT_LAYER3_OFFSET_F_WIDTH                     8
#define PARSER_RESULT_LAYER3_OFFSET_OFFSET                      6
#define PARSER_RESULT_LAYER3_OFFSET_WORD_OFFSET                 1
#define PARSER_RESULT_LAYER3_OFFSET_F_OFFSET_MOD16              8
#define PARSER_RESULT_LAYER4_OFFSET_F_OFFSET                    0
#define PARSER_RESULT_LAYER4_OFFSET_F_WIDTH                     8
#define PARSER_RESULT_LAYER4_OFFSET_OFFSET                      7
#define PARSER_RESULT_LAYER4_OFFSET_WORD_OFFSET                 1
#define PARSER_RESULT_LAYER4_OFFSET_F_OFFSET_MOD16              0
...
#define PARSER_RESULT_INNER_VLAN_F_OFFSET                       0
#define PARSER_RESULT_INNER_VLAN_F_WIDTH                        16
#define PARSER_RESULT_INNER_VLAN_OFFSET                         10
#define PARSER_RESULT_INNER_VLAN_WORD_OFFSET                    2
#define PARSER_RESULT_ETHENRNET_VERSION_F_OFFSET                30
#define PARSER_RESULT_ETHENRNET_VERSION_F_WIDTH                 2
#define PARSER_RESULT_ETHENRNET_VERSION_OFFSET                  12
#define PARSER_RESULT_ETHENRNET_VERSION_WORD_OFFSET             3
#define PARSER_RESULT_ETHENRNET_VERSION_F_OFFSET_MOD8           6
#define PARSER_RESULT_ETHENRNET_VERSION_F_OFFSET_MOD16          14
#define PARSER_RESULT_P_TAG_F_OFFSET                            29
#define PARSER_RESULT_P_TAG_F_WIDTH                             1
#define PARSER_RESULT_P_TAG_OFFSET                              12
#define PARSER_RESULT_P_TAG_WORD_OFFSET                         3
#define PARSER_RESULT_P_TAG_F_OFFSET_MOD8                       5
#define PARSER_RESULT_P_TAG_F_OFFSET_MOD16                      13
#define PARSER_RESULT_VID_FILTER_HIT_F_OFFSET                   28
#define PARSER_RESULT_VID_FILTER_HIT_F_WIDTH                    1
#define PARSER_RESULT_VID_FILTER_HIT_OFFSET                     12
#define PARSER_RESULT_VID_FILTER_HIT_WORD_OFFSET                3
#define PARSER_RESULT_VID_FILTER_HIT_F_OFFSET_MOD8              4
#define PARSER_RESULT_VID_FILTER_HIT_F_OFFSET_MOD16             12
#define PARSER_RESULT_VID_FILTER_MATCH_F_OFFSET                 24
#define PARSER_RESULT_VID_FILTER_MATCH_F_WIDTH                  4
#define PARSER_RESULT_VID_FILTER_MATCH_OFFSET                   12
#define PARSER_RESULT_VID_FILTER_MATCH_WORD_OFFSET              3
#define PARSER_RESULT_VID_FILTER_MATCH_F_OFFSET_MOD8            0
#define PARSER_RESULT_VID_FILTER_MATCH_F_OFFSET_MOD16           8
#define PARSER_RESULT_TAG_TYPE_F_OFFSET                         22
#define PARSER_RESULT_TAG_TYPE_F_WIDTH                          2
#define PARSER_RESULT_TAG_TYPE_OFFSET                           13
#define PARSER_RESULT_TAG_TYPE_WORD_OFFSET                      3
#define PARSER_RESULT_TAG_TYPE_F_OFFSET_MOD8                    6
#define PARSER_RESULT_TAG_TYPE_F_OFFSET_MOD16                   6
#define PARSER_RESULT_TPID_VLAN_0_F_OFFSET                      19
#define PARSER_RESULT_TPID_VLAN_0_F_WIDTH                       3
#define PARSER_RESULT_TPID_VLAN_0_OFFSET                        13
#define PARSER_RESULT_TPID_VLAN_0_WORD_OFFSET                   3
#define PARSER_RESULT_TPID_VLAN_0_F_OFFSET_MOD8                 3
#define PARSER_RESULT_TPID_VLAN_0_F_OFFSET_MOD16                3
#define PARSER_RESULT_TPID_VLAN_1_F_OFFSET                      16
#define PARSER_RESULT_TPID_VLAN_1_F_WIDTH                       3
#define PARSER_RESULT_TPID_VLAN_1_OFFSET                        13
#define PARSER_RESULT_TPID_VLAN_1_WORD_OFFSET                   3
#define PARSER_RESULT_TPID_VLAN_1_F_OFFSET_MOD8                 0
#define PARSER_RESULT_TPID_VLAN_1_F_OFFSET_MOD16                0
#define PARSER_RESULT_DA_FILTER_NUMBER_F_OFFSET                 12
#define PARSER_RESULT_DA_FILTER_NUMBER_F_WIDTH                  4
#define PARSER_RESULT_DA_FILTER_NUMBER_OFFSET                   14
#define PARSER_RESULT_DA_FILTER_NUMBER_WORD_OFFSET              3
#define PARSER_RESULT_DA_FILTER_NUMBER_F_OFFSET_MOD8            4
#define PARSER_RESULT_DA_FILTER_NUMBER_F_OFFSET_MOD16           12
#define PARSER_RESULT_UNUSED_F_OFFSET                           8
#define PARSER_RESULT_UNUSED_F_WIDTH                            4
#define PARSER_RESULT_UNUSED_OFFSET                             14
#define PARSER_RESULT_UNUSED_WORD_OFFSET                        3
#define PARSER_RESULT_UNUSED_F_OFFSET_MOD8                      0
#define PARSER_RESULT_UNUSED_F_OFFSET_MOD16                     8
#define PARSER_RESULT_LAYER2_OFFSET_F_OFFSET                    0
#define PARSER_RESULT_LAYER2_OFFSET_F_WIDTH                     8
#define PARSER_RESULT_LAYER2_OFFSET_OFFSET                      15
#define PARSER_RESULT_LAYER2_OFFSET_WORD_OFFSET                 3
#define PARSER_RESULT_LAYER2_OFFSET_F_OFFSET_MOD16              0
#define PARSER_RESULT_IP_FILTER_MATCH_F_OFFSET                  31
#define PARSER_RESULT_IP_FILTER_MATCH_F_WIDTH                   1
#define PARSER_RESULT_IP_FILTER_MATCH_OFFSET                    16
#define PARSER_RESULT_IP_FILTER_MATCH_WORD_OFFSET               4
#define PARSER_RESULT_IP_FILTER_MATCH_F_OFFSET_MOD8             7
#define PARSER_RESULT_IP_FILTER_MATCH_F_OFFSET_MOD16            15
#define PARSER_RESULT_IP_FILTER_NUM_F_OFFSET                    30
#define PARSER_RESULT_IP_FILTER_NUM_F_WIDTH                     1
#define PARSER_RESULT_IP_FILTER_NUM_OFFSET                      16
#define PARSER_RESULT_IP_FILTER_NUM_WORD_OFFSET                 4
#define PARSER_RESULT_IP_FILTER_NUM_F_OFFSET_MOD8               6
#define PARSER_RESULT_IP_FILTER_NUM_F_OFFSET_MOD16              14
#define PARSER_RESULT_UNUSED1_F_OFFSET                          25
#define PARSER_RESULT_UNUSED1_F_WIDTH                           5
#define PARSER_RESULT_UNUSED1_OFFSET                            16
#define PARSER_RESULT_UNUSED1_WORD_OFFSET                       4
#define PARSER_RESULT_UNUSED1_F_OFFSET_MOD8                     1
#define PARSER_RESULT_UNUSED1_F_OFFSET_MOD16                    9
#define PARSER_RESULT_IPV6_F_OFFSET                             24
#define PARSER_RESULT_IPV6_F_WIDTH                              1
#define PARSER_RESULT_IPV6_OFFSET                               16
#define PARSER_RESULT_IPV6_WORD_OFFSET                          4
#define PARSER_RESULT_IPV6_F_OFFSET_MOD8                        0
#define PARSER_RESULT_IPV6_F_OFFSET_MOD16                       8
#define PARSER_RESULT_PROTOCOL_F_OFFSET                         16
#define PARSER_RESULT_PROTOCOL_F_WIDTH                          8
#define PARSER_RESULT_PROTOCOL_OFFSET                           17
#define PARSER_RESULT_PROTOCOL_WORD_OFFSET                      4
#define PARSER_RESULT_PROTOCOL_F_OFFSET_MOD16                   0
#define PARSER_RESULT_FRAGMENT_HEADER_OFFSET_F_OFFSET           8
#define PARSER_RESULT_FRAGMENT_HEADER_OFFSET_F_WIDTH            8
#define PARSER_RESULT_FRAGMENT_HEADER_OFFSET_OFFSET             18
#define PARSER_RESULT_FRAGMENT_HEADER_OFFSET_WORD_OFFSET        4
#define PARSER_RESULT_FRAGMENT_HEADER_OFFSET_F_OFFSET_MOD16     8
#define PARSER_RESULT_UNUSED3_F_OFFSET                          4
#define PARSER_RESULT_UNUSED3_F_WIDTH                           4
#define PARSER_RESULT_UNUSED3_OFFSET                            19
#define PARSER_RESULT_UNUSED3_WORD_OFFSET                       4
#define PARSER_RESULT_UNUSED3_F_OFFSET_MOD8                     4
#define PARSER_RESULT_UNUSED3_F_OFFSET_MOD16                    4
#define PARSER_RESULT_DOS_ATTACK_REASON_F_OFFSET                0
#define PARSER_RESULT_DOS_ATTACK_REASON_F_WIDTH                 4
#define PARSER_RESULT_DOS_ATTACK_REASON_OFFSET                  19
#define PARSER_RESULT_DOS_ATTACK_REASON_WORD_OFFSET             4
#define PARSER_RESULT_DOS_ATTACK_REASON_F_OFFSET_MOD8           0
#define PARSER_RESULT_DOS_ATTACK_REASON_F_OFFSET_MOD16          0
#define PARSER_RESULT_ICMPV6_TYPE_F_OFFSET                      24
#define PARSER_RESULT_ICMPV6_TYPE_F_WIDTH                       8
#define PARSER_RESULT_ICMPV6_TYPE_OFFSET                        20
#define PARSER_RESULT_ICMPV6_TYPE_WORD_OFFSET                   5
#define PARSER_RESULT_ICMPV6_TYPE_F_OFFSET_MOD16                8
#define PARSER_RESULT_IP_TTL_F_OFFSET                           16
#define PARSER_RESULT_IP_TTL_F_WIDTH                            8
#define PARSER_RESULT_IP_TTL_OFFSET                             21
#define PARSER_RESULT_IP_TTL_WORD_OFFSET                        5
#define PARSER_RESULT_IP_TTL_F_OFFSET_MOD16                     0
#define PARSER_RESULT_IP_LENGTH_F_OFFSET                        0
#define PARSER_RESULT_IP_LENGTH_F_WIDTH                         16
#define PARSER_RESULT_IP_LENGTH_OFFSET                          22
#define PARSER_RESULT_IP_LENGTH_WORD_OFFSET                     5
#define PARSER_RESULT_NOT_WRITTEN_F_OFFSET                      0
#define PARSER_RESULT_NOT_WRITTEN_F_WIDTH                       32
#define PARSER_RESULT_NOT_WRITTEN_OFFSET                        24
#define PARSER_RESULT_NOT_WRITTEN_WORD_OFFSET                   6
#define PARSER_RESULT_DA_CRC_F_OFFSET                           0
#define PARSER_RESULT_DA_CRC_F_WIDTH                            32
#define PARSER_RESULT_DA_CRC_OFFSET                             28
#define PARSER_RESULT_DA_CRC_WORD_OFFSET                        7
#define PARSER_RESULT_SA_CRC_F_OFFSET                           0
#define PARSER_RESULT_SA_CRC_F_WIDTH                            32
#define PARSER_RESULT_SA_CRC_OFFSET                             32
#define PARSER_RESULT_SA_CRC_WORD_OFFSET                        8
#define PARSER_RESULT_VLAN_ETH_TYPE_CRC_F_OFFSET                0
#define PARSER_RESULT_VLAN_ETH_TYPE_CRC_F_WIDTH                 32
#define PARSER_RESULT_VLAN_ETH_TYPE_CRC_OFFSET                  36
#define PARSER_RESULT_VLAN_ETH_TYPE_CRC_WORD_OFFSET             9
#define PARSER_RESULT_TOS_L2_F_OFFSET                           24
#define PARSER_RESULT_TOS_L2_F_WIDTH                            8
#define PARSER_RESULT_TOS_L2_OFFSET                             40
#define PARSER_RESULT_TOS_L2_WORD_OFFSET                        10
#define PARSER_RESULT_TOS_L2_F_OFFSET_MOD16                     8
#define PARSER_RESULT_LOOKUP_PORT_F_OFFSET                      19
#define PARSER_RESULT_LOOKUP_PORT_F_WIDTH                       5
#define PARSER_RESULT_LOOKUP_PORT_OFFSET                        41
#define PARSER_RESULT_LOOKUP_PORT_WORD_OFFSET                   10
#define PARSER_RESULT_LOOKUP_PORT_F_OFFSET_MOD8                 3
#define PARSER_RESULT_LOOKUP_PORT_F_OFFSET_MOD16                3
#define PARSER_RESULT_VLANS_NUM_F_OFFSET                        16
#define PARSER_RESULT_VLANS_NUM_F_WIDTH                         3
#define PARSER_RESULT_VLANS_NUM_OFFSET                          41
#define PARSER_RESULT_VLANS_NUM_WORD_OFFSET                     10
#define PARSER_RESULT_VLANS_NUM_F_OFFSET_MOD8                   0
#define PARSER_RESULT_VLANS_NUM_F_OFFSET_MOD16                  0
#define PARSER_RESULT_VALID_F_OFFSET                            15
#define PARSER_RESULT_VALID_F_WIDTH                             1
#define PARSER_RESULT_VALID_OFFSET                              42
#define PARSER_RESULT_VALID_WORD_OFFSET                         10
#define PARSER_RESULT_VALID_F_OFFSET_MOD8                       7
#define PARSER_RESULT_VALID_F_OFFSET_MOD16                      15
#define PARSER_RESULT_TCP_PURE_ACK_F_OFFSET                     14
#define PARSER_RESULT_TCP_PURE_ACK_F_WIDTH                      1
#define PARSER_RESULT_TCP_PURE_ACK_OFFSET                       42
#define PARSER_RESULT_TCP_PURE_ACK_WORD_OFFSET                  10
#define PARSER_RESULT_TCP_PURE_ACK_F_OFFSET_MOD8                6
#define PARSER_RESULT_TCP_PURE_ACK_F_OFFSET_MOD16               14
#define PARSER_RESULT_LLC_SNAP_F_OFFSET                         13
#define PARSER_RESULT_LLC_SNAP_F_WIDTH                          1
#define PARSER_RESULT_LLC_SNAP_OFFSET                           42
#define PARSER_RESULT_LLC_SNAP_WORD_OFFSET                      10
#define PARSER_RESULT_LLC_SNAP_F_OFFSET_MOD8                    5
#define PARSER_RESULT_LLC_SNAP_F_OFFSET_MOD16                   13
#define PARSER_RESULT_UNUSED2_F_OFFSET                          4
#define PARSER_RESULT_UNUSED2_F_WIDTH                           9
#define PARSER_RESULT_UNUSED2_OFFSET                            42
#define PARSER_RESULT_UNUSED2_WORD_OFFSET                       10
#define PARSER_RESULT_UNUSED2_F_OFFSET_MOD16                    4
#define PARSER_RESULT_VAR_LEN_CTX_F_OFFSET                      0
#define PARSER_RESULT_VAR_LEN_CTX_F_WIDTH                       4
#define PARSER_RESULT_VAR_LEN_CTX_OFFSET                        43
#define PARSER_RESULT_VAR_LEN_CTX_WORD_OFFSET                   10
#define PARSER_RESULT_VAR_LEN_CTX_F_OFFSET_MOD8                 0
#define PARSER_RESULT_VAR_LEN_CTX_F_OFFSET_MOD16                0
#define PARSER_RESULT_SOURCE_IP_F_OFFSET                        0
#define PARSER_RESULT_SOURCE_IP_F_WIDTH                         32
#define PARSER_RESULT_SOURCE_IP_OFFSET                          44
#define PARSER_RESULT_SOURCE_IP_WORD_OFFSET                     11
#define PARSER_RESULT_DESTINATION_IP_F_OFFSET                   0
#define PARSER_RESULT_DESTINATION_IP_F_WIDTH                    32
#define PARSER_RESULT_DESTINATION_IP_OFFSET                     48
#define PARSER_RESULT_DESTINATION_IP_WORD_OFFSET                12
#define PARSER_RESULT_SOURCE_PORT_F_OFFSET                      16
#define PARSER_RESULT_SOURCE_PORT_F_WIDTH                       16
#define PARSER_RESULT_SOURCE_PORT_OFFSET                        52
#define PARSER_RESULT_SOURCE_PORT_WORD_OFFSET                   13
#define PARSER_RESULT_DESTINATION_PORT_F_OFFSET                 0
#define PARSER_RESULT_DESTINATION_PORT_F_WIDTH                  16
#define PARSER_RESULT_DESTINATION_PORT_OFFSET                   54
#define PARSER_RESULT_DESTINATION_PORT_WORD_OFFSET              13
...
typedef struct
{
	...
	uint32_t	chksm_err             	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	ver_miss              	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	layer3_protocol       	:2	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	ipv6_ext_header_filter	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	tcp_flag              	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	exception             	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	ip_mc_l2              	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	...
	uint32_t	icmpv6_type           	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	ip_ttl                	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	ip_length             	:16	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	not_written           	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	da_crc                	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	sa_crc                	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	vlan_eth_type_crc     	:32	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	uint32_t	tos_l2                	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	...
	uint32_t	unused2               	:9	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_PARSER_RESULT_IP_FRAGMENT_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 6, 1, r)
#define RDD_PARSER_RESULT_IP_FRAGMENT_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 6, 1, v)
#define RDD_PARSER_RESULT_IP_FRAGMENT_READ(r, p)                            FIELD_MREAD_8((uint8_t *)p, 6, 1, r)
#define RDD_PARSER_RESULT_IP_FRAGMENT_WRITE(v, p)                           FIELD_MWRITE_8((uint8_t *)p, 6, 1, v)
#define RDD_PARSER_RESULT_L4_1588_READ_G(r, g, idx)                         GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 5, 1, r)
#define RDD_PARSER_RESULT_L4_1588_WRITE_G(v, g, idx)                        GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 5, 1, v)
#define RDD_PARSER_RESULT_L4_1588_READ(r, p)                                FIELD_MREAD_8((uint8_t *)p, 5, 1, r)
#define RDD_PARSER_RESULT_L4_1588_WRITE(v, p)                               FIELD_MWRITE_8((uint8_t *)p, 5, 1, v)
#define RDD_PARSER_RESULT_TCP_UDP_READ_G(r, g, idx)                         GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 4, 1, r)
#define RDD_PARSER_RESULT_TCP_UDP_WRITE_G(v, g, idx)                        GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 4, 1, v)
#define RDD_PARSER_RESULT_TCP_UDP_READ(r, p)                                FIELD_MREAD_8((uint8_t *)p, 4, 1, r)
#define RDD_PARSER_RESULT_TCP_UDP_WRITE(v, p)                               FIELD_MWRITE_8((uint8_t *)p, 4, 1, v)
#define RDD_PARSER_RESULT_DHCP_READ_G(r, g, idx)                            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 3, 1, r)
#define RDD_PARSER_RESULT_DHCP_WRITE_G(v, g, idx)                           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 3, 1, v)
#define RDD_PARSER_RESULT_DHCP_READ(r, p)                                   FIELD_MREAD_8((uint8_t *)p, 3, 1, r)
#define RDD_PARSER_RESULT_DHCP_WRITE(v, p)                                  FIELD_MWRITE_8((uint8_t *)p, 3, 1, v)
#define RDD_PARSER_RESULT_BROADCAST_READ_G(r, g, idx)                       GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 2, 1, r)
#define RDD_PARSER_RESULT_BROADCAST_WRITE_G(v, g, idx)                      GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 2, 1, v)
#define RDD_PARSER_RESULT_BROADCAST_READ(r, p)                              FIELD_MREAD_8((uint8_t *)p, 2, 1, r)
#define RDD_PARSER_RESULT_BROADCAST_WRITE(v, p)                             FIELD_MWRITE_8((uint8_t *)p, 2, 1, v)
#define RDD_PARSER_RESULT_MULTICAST_READ_G(r, g, idx)                       GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 1, 1, r)
#define RDD_PARSER_RESULT_MULTICAST_WRITE_G(v, g, idx)                      GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 1, 1, v)
#define RDD_PARSER_RESULT_MULTICAST_READ(r, p)                              FIELD_MREAD_8((uint8_t *)p, 1, 1, r)
#define RDD_PARSER_RESULT_MULTICAST_WRITE(v, p)                             FIELD_MWRITE_8((uint8_t *)p, 1, 1, v)
#define RDD_PARSER_RESULT_DOS_ATTACK_READ_G(r, g, idx)                      GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 0, 1, r)
#define RDD_PARSER_RESULT_DOS_ATTACK_WRITE_G(v, g, idx)                     GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS), 0, 1, v)
#define RDD_PARSER_RESULT_DOS_ATTACK_READ(r, p)                             FIELD_MREAD_8((uint8_t *)p, 0, 1, r)
#define RDD_PARSER_RESULT_DOS_ATTACK_WRITE(v, p)                            FIELD_MWRITE_8((uint8_t *)p, 0, 1, v)
#define RDD_PARSER_RESULT_MC_L3_CTL_READ_G(r, g, idx)                       GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 7, 1, r)
#define RDD_PARSER_RESULT_MC_L3_CTL_WRITE_G(v, g, idx)                      GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 7, 1, v)
#define RDD_PARSER_RESULT_MC_L3_CTL_READ(r, p)                              FIELD_MREAD_8((uint8_t *)p + 1, 7, 1, r)
#define RDD_PARSER_RESULT_MC_L3_CTL_WRITE(v, p)                             FIELD_MWRITE_8((uint8_t *)p + 1, 7, 1, v)
#define RDD_PARSER_RESULT_IP_LEN_ERROR_READ_G(r, g, idx)                    GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 6, 1, r)
#define RDD_PARSER_RESULT_IP_LEN_ERROR_WRITE_G(v, g, idx)                   GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 6, 1, v)
#define RDD_PARSER_RESULT_IP_LEN_ERROR_READ(r, p)                           FIELD_MREAD_8((uint8_t *)p + 1, 6, 1, r)
#define RDD_PARSER_RESULT_IP_LEN_ERROR_WRITE(v, p)                          FIELD_MWRITE_8((uint8_t *)p + 1, 6, 1, v)
#define RDD_PARSER_RESULT_ICMPV6_READ_G(r, g, idx)                          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 5, 1, r)
#define RDD_PARSER_RESULT_ICMPV6_WRITE_G(v, g, idx)                         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 5, 1, v)
#define RDD_PARSER_RESULT_ICMPV6_READ(r, p)                                 FIELD_MREAD_8((uint8_t *)p + 1, 5, 1, r)
#define RDD_PARSER_RESULT_ICMPV6_WRITE(v, p)                                FIELD_MWRITE_8((uint8_t *)p + 1, 5, 1, v)
#define RDD_PARSER_RESULT_HDR_LEN_ERR_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 4, 1, r)
#define RDD_PARSER_RESULT_HDR_LEN_ERR_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 4, 1, v)
#define RDD_PARSER_RESULT_HDR_LEN_ERR_READ(r, p)                            FIELD_MREAD_8((uint8_t *)p + 1, 4, 1, r)
#define RDD_PARSER_RESULT_HDR_LEN_ERR_WRITE(v, p)                           FIELD_MWRITE_8((uint8_t *)p + 1, 4, 1, v)
#define RDD_PARSER_RESULT_CHKSM_ERR_READ_G(r, g, idx)                       GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 3, 1, r)
#define RDD_PARSER_RESULT_CHKSM_ERR_WRITE_G(v, g, idx)                      GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 3, 1, v)
#define RDD_PARSER_RESULT_CHKSM_ERR_READ(r, p)                              FIELD_MREAD_8((uint8_t *)p + 1, 3, 1, r)
#define RDD_PARSER_RESULT_CHKSM_ERR_WRITE(v, p)                             FIELD_MWRITE_8((uint8_t *)p + 1, 3, 1, v)
#define RDD_PARSER_RESULT_VER_MISS_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 2, 1, r)
#define RDD_PARSER_RESULT_VER_MISS_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 2, 1, v)
#define RDD_PARSER_RESULT_VER_MISS_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p + 1, 2, 1, r)
#define RDD_PARSER_RESULT_VER_MISS_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p + 1, 2, 1, v)
#define RDD_PARSER_RESULT_LAYER3_PROTOCOL_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 0, 2, r)
#define RDD_PARSER_RESULT_LAYER3_PROTOCOL_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 1, 0, 2, v)
#define RDD_PARSER_RESULT_LAYER3_PROTOCOL_READ(r, p)                        FIELD_MREAD_8((uint8_t *)p + 1, 0, 2, r)
#define RDD_PARSER_RESULT_LAYER3_PROTOCOL_WRITE(v, p)                       FIELD_MWRITE_8((uint8_t *)p + 1, 0, 2, v)
#define RDD_PARSER_RESULT_IPV6_EXT_HEADER_FILTER_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 7, 1, r)
#define RDD_PARSER_RESULT_IPV6_EXT_HEADER_FILTER_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 7, 1, v)
#define RDD_PARSER_RESULT_IPV6_EXT_HEADER_FILTER_READ(r, p)                 FIELD_MREAD_8((uint8_t *)p + 2, 7, 1, r)
#define RDD_PARSER_RESULT_IPV6_EXT_HEADER_FILTER_WRITE(v, p)                FIELD_MWRITE_8((uint8_t *)p + 2, 7, 1, v)
#define RDD_PARSER_RESULT_TCP_FLAG_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 6, 1, r)
#define RDD_PARSER_RESULT_TCP_FLAG_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 6, 1, v)
#define RDD_PARSER_RESULT_TCP_FLAG_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p + 2, 6, 1, r)
#define RDD_PARSER_RESULT_TCP_FLAG_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p + 2, 6, 1, v)
#define RDD_PARSER_RESULT_EXCEPTION_READ_G(r, g, idx)                       GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 5, 1, r)
#define RDD_PARSER_RESULT_EXCEPTION_WRITE_G(v, g, idx)                      GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 5, 1, v)
#define RDD_PARSER_RESULT_EXCEPTION_READ(r, p)                              FIELD_MREAD_8((uint8_t *)p + 2, 5, 1, r)
#define RDD_PARSER_RESULT_EXCEPTION_WRITE(v, p)                             FIELD_MWRITE_8((uint8_t *)p + 2, 5, 1, v)
#define RDD_PARSER_RESULT_IP_MC_L2_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 4, 1, r)
#define RDD_PARSER_RESULT_IP_MC_L2_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 4, 1, v)
#define RDD_PARSER_RESULT_IP_MC_L2_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p + 2, 4, 1, r)
#define RDD_PARSER_RESULT_IP_MC_L2_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p + 2, 4, 1, v)
#define RDD_PARSER_RESULT_MC_L3_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 3, 1, r)
#define RDD_PARSER_RESULT_MC_L3_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 3, 1, v)
#define RDD_PARSER_RESULT_MC_L3_READ(r, p)                                  FIELD_MREAD_8((uint8_t *)p + 2, 3, 1, r)
#define RDD_PARSER_RESULT_MC_L3_WRITE(v, p)                                 FIELD_MWRITE_8((uint8_t *)p + 2, 3, 1, v)
#define RDD_PARSER_RESULT_ERROR_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 2, 1, r)
#define RDD_PARSER_RESULT_ERROR_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 2, 1, v)
#define RDD_PARSER_RESULT_ERROR_READ(r, p)                                  FIELD_MREAD_8((uint8_t *)p + 2, 2, 1, r)
#define RDD_PARSER_RESULT_ERROR_WRITE(v, p)                                 FIELD_MWRITE_8((uint8_t *)p + 2, 2, 1, v)
#define RDD_PARSER_RESULT_TUNNEL_READ_G(r, g, idx)                          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 1, 1, r)
#define RDD_PARSER_RESULT_TUNNEL_WRITE_G(v, g, idx)                         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 1, 1, v)
#define RDD_PARSER_RESULT_TUNNEL_READ(r, p)                                 FIELD_MREAD_8((uint8_t *)p + 2, 1, 1, r)
#define RDD_PARSER_RESULT_TUNNEL_WRITE(v, p)                                FIELD_MWRITE_8((uint8_t *)p + 2, 1, 1, v)
#define RDD_PARSER_RESULT_NON_L4_FAST_PROTOCOL_READ_G(r, g, idx)            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 0, 1, r)
#define RDD_PARSER_RESULT_NON_L4_FAST_PROTOCOL_WRITE_G(v, g, idx)           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 2, 0, 1, v)
#define RDD_PARSER_RESULT_NON_L4_FAST_PROTOCOL_READ(r, p)                   FIELD_MREAD_8((uint8_t *)p + 2, 0, 1, r)
#define RDD_PARSER_RESULT_NON_L4_FAST_PROTOCOL_WRITE(v, p)                  FIELD_MWRITE_8((uint8_t *)p + 2, 0, 1, v)
#define RDD_PARSER_RESULT_GRE_PROTOCOL_ERROR_READ_G(r, g, idx)              GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 3, 7, 1, r)
#define RDD_PARSER_RESULT_GRE_PROTOCOL_ERROR_WRITE_G(v, g, idx)             GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 3, 7, 1, v)
#define RDD_PARSER_RESULT_GRE_PROTOCOL_ERROR_READ(r, p)                     FIELD_MREAD_8((uint8_t *)p + 3, 7, 1, r)
#define RDD_PARSER_RESULT_GRE_PROTOCOL_ERROR_WRITE(v, p)                    FIELD_MWRITE_8((uint8_t *)p + 3, 7, 1, v)
#define RDD_PARSER_RESULT_FREE_READ_G(r, g, idx)                            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 3, 6, 1, r)
#define RDD_PARSER_RESULT_FREE_WRITE_G(v, g, idx)                           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 3, 6, 1, v)
#define RDD_PARSER_RESULT_FREE_READ(r, p)                                   FIELD_MREAD_8((uint8_t *)p + 3, 6, 1, r)
#define RDD_PARSER_RESULT_FREE_WRITE(v, p)                                  FIELD_MWRITE_8((uint8_t *)p + 3, 6, 1, v)
#define RDD_PARSER_RESULT_DNS_READ_G(r, g, idx)                             GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 3, 5, 1, r)
#define RDD_PARSER_RESULT_DNS_WRITE_G(v, g, idx)                            GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 3, 5, 1, v)
#define RDD_PARSER_RESULT_DNS_READ(r, p)                                    FIELD_MREAD_8((uint8_t *)p + 3, 5, 1, r)
#define RDD_PARSER_RESULT_DNS_WRITE(v, p)                                   FIELD_MWRITE_8((uint8_t *)p + 3, 5, 1, v)
#define RDD_PARSER_RESULT_FIRST_IP_FRAGMENT_READ_G(r, g, idx)               GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 3, 4, 1, r)
#define RDD_PARSER_RESULT_FIRST_IP_FRAGMENT_WRITE_G(v, g, idx)              GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 3, 4, 1, v)
#define RDD_PARSER_RESULT_FIRST_IP_FRAGMENT_READ(r, p)                      FIELD_MREAD_8((uint8_t *)p + 3, 4, 1, r)
#define RDD_PARSER_RESULT_FIRST_IP_FRAGMENT_WRITE(v, p)                     FIELD_MWRITE_8((uint8_t *)p + 3, 4, 1, v)
#define RDD_PARSER_RESULT_L2_PROTOCOL_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 3, 0, 4, r)
#define RDD_PARSER_RESULT_L2_PROTOCOL_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 3, 0, 4, v)
#define RDD_PARSER_RESULT_L2_PROTOCOL_READ(r, p)                            FIELD_MREAD_8((uint8_t *)p + 3, 0, 4, r)
#define RDD_PARSER_RESULT_L2_PROTOCOL_WRITE(v, p)                           FIELD_MWRITE_8((uint8_t *)p + 3, 0, 4, v)
#define RDD_PARSER_RESULT_L4_PROTOCOL_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 4, 4, 4, r) /*defined by rdd_parser_l4_protocol enumeration*/
#define RDD_PARSER_RESULT_L4_PROTOCOL_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 4, 4, 4, v) /*defined by rdd_parser_l4_protocol enumeration*/
#define RDD_PARSER_RESULT_L4_PROTOCOL_READ(r, p)                            FIELD_MREAD_8((uint8_t *)p + 4, 4, 4, r) /*defined by rdd_parser_l4_protocol enumeration*/
#define RDD_PARSER_RESULT_L4_PROTOCOL_WRITE(v, p)                           FIELD_MWRITE_8((uint8_t *)p + 4, 4, 4, v) /*defined by rdd_parser_l4_protocol enumeration*/
#define RDD_PARSER_RESULT_V6_AH_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 4, 3, 1, r)
#define RDD_PARSER_RESULT_V6_AH_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 4, 3, 1, v)
#define RDD_PARSER_RESULT_V6_AH_READ(r, p)                                  FIELD_MREAD_8((uint8_t *)p + 4, 3, 1, r)
#define RDD_PARSER_RESULT_V6_AH_WRITE(v, p)                                 FIELD_MWRITE_8((uint8_t *)p + 4, 3, 1, v)
#define RDD_PARSER_RESULT_V6_DEST_OPT_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 4, 2, 1, r)
#define RDD_PARSER_RESULT_V6_DEST_OPT_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 4, 2, 1, v)
#define RDD_PARSER_RESULT_V6_DEST_OPT_READ(r, p)                            FIELD_MREAD_8((uint8_t *)p + 4, 2, 1, r)
#define RDD_PARSER_RESULT_V6_DEST_OPT_WRITE(v, p)                           FIELD_MWRITE_8((uint8_t *)p + 4, 2, 1, v)
#define RDD_PARSER_RESULT_V6_ROUTE_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 4, 1, 1, r)
#define RDD_PARSER_RESULT_V6_ROUTE_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 4, 1, 1, v)
#define RDD_PARSER_RESULT_V6_ROUTE_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p + 4, 1, 1, r)
#define RDD_PARSER_RESULT_V6_ROUTE_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p + 4, 1, 1, v)
#define RDD_PARSER_RESULT_V6_HOP_READ_G(r, g, idx)                          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 4, 0, 1, r)
#define RDD_PARSER_RESULT_V6_HOP_WRITE_G(v, g, idx)                         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 4, 0, 1, v)
#define RDD_PARSER_RESULT_V6_HOP_READ(r, p)                                 FIELD_MREAD_8((uint8_t *)p + 4, 0, 1, r)
#define RDD_PARSER_RESULT_V6_HOP_WRITE(v, p)                                FIELD_MWRITE_8((uint8_t *)p + 4, 0, 1, v)
#define RDD_PARSER_RESULT_TCP_FLAGS_READ_G(r, g, idx)                       GROUP_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 5, r)
#define RDD_PARSER_RESULT_TCP_FLAGS_WRITE_G(v, g, idx)                      GROUP_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 5, v)
#define RDD_PARSER_RESULT_TCP_FLAGS_READ(r, p)                              MREAD_8((uint8_t *)p + 5, r)
#define RDD_PARSER_RESULT_TCP_FLAGS_WRITE(v, p)                             MWRITE_8((uint8_t *)p + 5, v)
#define RDD_PARSER_RESULT_LAYER3_OFFSET_READ_G(r, g, idx)                   GROUP_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 6, r)
#define RDD_PARSER_RESULT_LAYER3_OFFSET_WRITE_G(v, g, idx)                  GROUP_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 6, v)
#define RDD_PARSER_RESULT_LAYER3_OFFSET_READ(r, p)                          MREAD_8((uint8_t *)p + 6, r)
#define RDD_PARSER_RESULT_LAYER3_OFFSET_WRITE(v, p)                         MWRITE_8((uint8_t *)p + 6, v)
#define RDD_PARSER_RESULT_LAYER4_OFFSET_READ_G(r, g, idx)                   GROUP_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 7, r)
#define RDD_PARSER_RESULT_LAYER4_OFFSET_WRITE_G(v, g, idx)                  GROUP_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 7, v)
#define RDD_PARSER_RESULT_LAYER4_OFFSET_READ(r, p)                          MREAD_8((uint8_t *)p + 7, r)
#define RDD_PARSER_RESULT_LAYER4_OFFSET_WRITE(v, p)                         MWRITE_8((uint8_t *)p + 7, v)
...
#define RDD_PARSER_RESULT_INNER_VLAN_READ_G(r, g, idx)                      GROUP_MREAD_16(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 10, r)
#define RDD_PARSER_RESULT_INNER_VLAN_WRITE_G(v, g, idx)                     GROUP_MWRITE_16(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 10, v)
#define RDD_PARSER_RESULT_INNER_VLAN_READ(r, p)                             MREAD_16((uint8_t *)p + 10, r)
#define RDD_PARSER_RESULT_INNER_VLAN_WRITE(v, p)                            MWRITE_16((uint8_t *)p + 10, v)
#define RDD_PARSER_RESULT_ETHENRNET_VERSION_READ_G(r, g, idx)               GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 12, 6, 2, r)
#define RDD_PARSER_RESULT_ETHENRNET_VERSION_WRITE_G(v, g, idx)              GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 12, 6, 2, v)
#define RDD_PARSER_RESULT_ETHENRNET_VERSION_READ(r, p)                      FIELD_MREAD_8((uint8_t *)p + 12, 6, 2, r)
#define RDD_PARSER_RESULT_ETHENRNET_VERSION_WRITE(v, p)                     FIELD_MWRITE_8((uint8_t *)p + 12, 6, 2, v)
#define RDD_PARSER_RESULT_P_TAG_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 12, 5, 1, r)
#define RDD_PARSER_RESULT_P_TAG_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 12, 5, 1, v)
#define RDD_PARSER_RESULT_P_TAG_READ(r, p)                                  FIELD_MREAD_8((uint8_t *)p + 12, 5, 1, r)
#define RDD_PARSER_RESULT_P_TAG_WRITE(v, p)                                 FIELD_MWRITE_8((uint8_t *)p + 12, 5, 1, v)
#define RDD_PARSER_RESULT_VID_FILTER_HIT_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 12, 4, 1, r)
#define RDD_PARSER_RESULT_VID_FILTER_HIT_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 12, 4, 1, v)
#define RDD_PARSER_RESULT_VID_FILTER_HIT_READ(r, p)                         FIELD_MREAD_8((uint8_t *)p + 12, 4, 1, r)
#define RDD_PARSER_RESULT_VID_FILTER_HIT_WRITE(v, p)                        FIELD_MWRITE_8((uint8_t *)p + 12, 4, 1, v)
#define RDD_PARSER_RESULT_VID_FILTER_MATCH_READ_G(r, g, idx)                GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 12, 0, 4, r)
#define RDD_PARSER_RESULT_VID_FILTER_MATCH_WRITE_G(v, g, idx)               GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 12, 0, 4, v)
#define RDD_PARSER_RESULT_VID_FILTER_MATCH_READ(r, p)                       FIELD_MREAD_8((uint8_t *)p + 12, 0, 4, r)
#define RDD_PARSER_RESULT_VID_FILTER_MATCH_WRITE(v, p)                      FIELD_MWRITE_8((uint8_t *)p + 12, 0, 4, v)
#define RDD_PARSER_RESULT_TAG_TYPE_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 13, 6, 2, r)
#define RDD_PARSER_RESULT_TAG_TYPE_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 13, 6, 2, v)
#define RDD_PARSER_RESULT_TAG_TYPE_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p + 13, 6, 2, r)
#define RDD_PARSER_RESULT_TAG_TYPE_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p + 13, 6, 2, v)
#define RDD_PARSER_RESULT_TPID_VLAN_0_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 13, 3, 3, r)
#define RDD_PARSER_RESULT_TPID_VLAN_0_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 13, 3, 3, v)
#define RDD_PARSER_RESULT_TPID_VLAN_0_READ(r, p)                            FIELD_MREAD_8((uint8_t *)p + 13, 3, 3, r)
#define RDD_PARSER_RESULT_TPID_VLAN_0_WRITE(v, p)                           FIELD_MWRITE_8((uint8_t *)p + 13, 3, 3, v)
#define RDD_PARSER_RESULT_TPID_VLAN_1_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 13, 0, 3, r)
#define RDD_PARSER_RESULT_TPID_VLAN_1_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 13, 0, 3, v)
#define RDD_PARSER_RESULT_TPID_VLAN_1_READ(r, p)                            FIELD_MREAD_8((uint8_t *)p + 13, 0, 3, r)
#define RDD_PARSER_RESULT_TPID_VLAN_1_WRITE(v, p)                           FIELD_MWRITE_8((uint8_t *)p + 13, 0, 3, v)
#define RDD_PARSER_RESULT_DA_FILTER_NUMBER_READ_G(r, g, idx)                GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 14, 4, 4, r)
#define RDD_PARSER_RESULT_DA_FILTER_NUMBER_WRITE_G(v, g, idx)               GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 14, 4, 4, v)
#define RDD_PARSER_RESULT_DA_FILTER_NUMBER_READ(r, p)                       FIELD_MREAD_8((uint8_t *)p + 14, 4, 4, r)
#define RDD_PARSER_RESULT_DA_FILTER_NUMBER_WRITE(v, p)                      FIELD_MWRITE_8((uint8_t *)p + 14, 4, 4, v)
#define RDD_PARSER_RESULT_UNUSED_READ_G(r, g, idx)                          GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 14, 0, 4, r)
#define RDD_PARSER_RESULT_UNUSED_WRITE_G(v, g, idx)                         GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 14, 0, 4, v)
#define RDD_PARSER_RESULT_UNUSED_READ(r, p)                                 FIELD_MREAD_8((uint8_t *)p + 14, 0, 4, r)
#define RDD_PARSER_RESULT_UNUSED_WRITE(v, p)                                FIELD_MWRITE_8((uint8_t *)p + 14, 0, 4, v)
#define RDD_PARSER_RESULT_LAYER2_OFFSET_READ_G(r, g, idx)                   GROUP_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 15, r)
#define RDD_PARSER_RESULT_LAYER2_OFFSET_WRITE_G(v, g, idx)                  GROUP_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 15, v)
#define RDD_PARSER_RESULT_LAYER2_OFFSET_READ(r, p)                          MREAD_8((uint8_t *)p + 15, r)
#define RDD_PARSER_RESULT_LAYER2_OFFSET_WRITE(v, p)                         MWRITE_8((uint8_t *)p + 15, v)
#define RDD_PARSER_RESULT_IP_FILTER_MATCH_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 16, 7, 1, r)
#define RDD_PARSER_RESULT_IP_FILTER_MATCH_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 16, 7, 1, v)
#define RDD_PARSER_RESULT_IP_FILTER_MATCH_READ(r, p)                        FIELD_MREAD_8((uint8_t *)p + 16, 7, 1, r)
#define RDD_PARSER_RESULT_IP_FILTER_MATCH_WRITE(v, p)                       FIELD_MWRITE_8((uint8_t *)p + 16, 7, 1, v)
#define RDD_PARSER_RESULT_IP_FILTER_NUM_READ_G(r, g, idx)                   GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 16, 6, 1, r)
#define RDD_PARSER_RESULT_IP_FILTER_NUM_WRITE_G(v, g, idx)                  GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 16, 6, 1, v)
#define RDD_PARSER_RESULT_IP_FILTER_NUM_READ(r, p)                          FIELD_MREAD_8((uint8_t *)p + 16, 6, 1, r)
#define RDD_PARSER_RESULT_IP_FILTER_NUM_WRITE(v, p)                         FIELD_MWRITE_8((uint8_t *)p + 16, 6, 1, v)
#define RDD_PARSER_RESULT_UNUSED1_READ_G(r, g, idx)                         GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 16, 1, 5, r)
#define RDD_PARSER_RESULT_UNUSED1_WRITE_G(v, g, idx)                        GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 16, 1, 5, v)
#define RDD_PARSER_RESULT_UNUSED1_READ(r, p)                                FIELD_MREAD_8((uint8_t *)p + 16, 1, 5, r)
#define RDD_PARSER_RESULT_UNUSED1_WRITE(v, p)                               FIELD_MWRITE_8((uint8_t *)p + 16, 1, 5, v)
#define RDD_PARSER_RESULT_IPV6_READ_G(r, g, idx)                            GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 16, 0, 1, r)
#define RDD_PARSER_RESULT_IPV6_WRITE_G(v, g, idx)                           GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 16, 0, 1, v)
#define RDD_PARSER_RESULT_IPV6_READ(r, p)                                   FIELD_MREAD_8((uint8_t *)p + 16, 0, 1, r)
#define RDD_PARSER_RESULT_IPV6_WRITE(v, p)                                  FIELD_MWRITE_8((uint8_t *)p + 16, 0, 1, v)
#define RDD_PARSER_RESULT_PROTOCOL_READ_G(r, g, idx)                        GROUP_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 17, r)
#define RDD_PARSER_RESULT_PROTOCOL_WRITE_G(v, g, idx)                       GROUP_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 17, v)
#define RDD_PARSER_RESULT_PROTOCOL_READ(r, p)                               MREAD_8((uint8_t *)p + 17, r)
#define RDD_PARSER_RESULT_PROTOCOL_WRITE(v, p)                              MWRITE_8((uint8_t *)p + 17, v)
#define RDD_PARSER_RESULT_FRAGMENT_HEADER_OFFSET_READ_G(r, g, idx)          GROUP_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 18, r)
#define RDD_PARSER_RESULT_FRAGMENT_HEADER_OFFSET_WRITE_G(v, g, idx)         GROUP_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 18, v)
#define RDD_PARSER_RESULT_FRAGMENT_HEADER_OFFSET_READ(r, p)                 MREAD_8((uint8_t *)p + 18, r)
#define RDD_PARSER_RESULT_FRAGMENT_HEADER_OFFSET_WRITE(v, p)                MWRITE_8((uint8_t *)p + 18, v)
#define RDD_PARSER_RESULT_UNUSED3_READ_G(r, g, idx)                         GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 19, 4, 4, r)
#define RDD_PARSER_RESULT_UNUSED3_WRITE_G(v, g, idx)                        GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 19, 4, 4, v)
#define RDD_PARSER_RESULT_UNUSED3_READ(r, p)                                FIELD_MREAD_8((uint8_t *)p + 19, 4, 4, r)
#define RDD_PARSER_RESULT_UNUSED3_WRITE(v, p)                               FIELD_MWRITE_8((uint8_t *)p + 19, 4, 4, v)
#define RDD_PARSER_RESULT_DOS_ATTACK_REASON_READ_G(r, g, idx)               GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 19, 0, 4, r)
#define RDD_PARSER_RESULT_DOS_ATTACK_REASON_WRITE_G(v, g, idx)              GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 19, 0, 4, v)
#define RDD_PARSER_RESULT_DOS_ATTACK_REASON_READ(r, p)                      FIELD_MREAD_8((uint8_t *)p + 19, 0, 4, r)
#define RDD_PARSER_RESULT_DOS_ATTACK_REASON_WRITE(v, p)                     FIELD_MWRITE_8((uint8_t *)p + 19, 0, 4, v)
#define RDD_PARSER_RESULT_ICMPV6_TYPE_READ_G(r, g, idx)                     GROUP_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 20, r)
#define RDD_PARSER_RESULT_ICMPV6_TYPE_WRITE_G(v, g, idx)                    GROUP_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 20, v)
#define RDD_PARSER_RESULT_ICMPV6_TYPE_READ(r, p)                            MREAD_8((uint8_t *)p + 20, r)
#define RDD_PARSER_RESULT_ICMPV6_TYPE_WRITE(v, p)                           MWRITE_8((uint8_t *)p + 20, v)
#define RDD_PARSER_RESULT_IP_TTL_READ_G(r, g, idx)                          GROUP_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 21, r)
#define RDD_PARSER_RESULT_IP_TTL_WRITE_G(v, g, idx)                         GROUP_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 21, v)
#define RDD_PARSER_RESULT_IP_TTL_READ(r, p)                                 MREAD_8((uint8_t *)p + 21, r)
#define RDD_PARSER_RESULT_IP_TTL_WRITE(v, p)                                MWRITE_8((uint8_t *)p + 21, v)
#define RDD_PARSER_RESULT_IP_LENGTH_READ_G(r, g, idx)                       GROUP_MREAD_16(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 22, r)
#define RDD_PARSER_RESULT_IP_LENGTH_WRITE_G(v, g, idx)                      GROUP_MWRITE_16(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 22, v)
#define RDD_PARSER_RESULT_IP_LENGTH_READ(r, p)                              MREAD_16((uint8_t *)p + 22, r)
#define RDD_PARSER_RESULT_IP_LENGTH_WRITE(v, p)                             MWRITE_16((uint8_t *)p + 22, v)
#define RDD_PARSER_RESULT_NOT_WRITTEN_READ_G(r, g, idx)                     GROUP_MREAD_32(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 24, r)
#define RDD_PARSER_RESULT_NOT_WRITTEN_WRITE_G(v, g, idx)                    GROUP_MWRITE_32(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 24, v)
#define RDD_PARSER_RESULT_NOT_WRITTEN_READ(r, p)                            MREAD_32((uint8_t *)p + 24, r)
#define RDD_PARSER_RESULT_NOT_WRITTEN_WRITE(v, p)                           MWRITE_32((uint8_t *)p + 24, v)
#define RDD_PARSER_RESULT_DA_CRC_READ_G(r, g, idx)                          GROUP_MREAD_32(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 28, r)
#define RDD_PARSER_RESULT_DA_CRC_WRITE_G(v, g, idx)                         GROUP_MWRITE_32(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 28, v)
#define RDD_PARSER_RESULT_DA_CRC_READ(r, p)                                 MREAD_32((uint8_t *)p + 28, r)
#define RDD_PARSER_RESULT_DA_CRC_WRITE(v, p)                                MWRITE_32((uint8_t *)p + 28, v)
#define RDD_PARSER_RESULT_SA_CRC_READ_G(r, g, idx)                          GROUP_MREAD_32(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 32, r)
#define RDD_PARSER_RESULT_SA_CRC_WRITE_G(v, g, idx)                         GROUP_MWRITE_32(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 32, v)
#define RDD_PARSER_RESULT_SA_CRC_READ(r, p)                                 MREAD_32((uint8_t *)p + 32, r)
#define RDD_PARSER_RESULT_SA_CRC_WRITE(v, p)                                MWRITE_32((uint8_t *)p + 32, v)
#define RDD_PARSER_RESULT_VLAN_ETH_TYPE_CRC_READ_G(r, g, idx)               GROUP_MREAD_32(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 36, r)
#define RDD_PARSER_RESULT_VLAN_ETH_TYPE_CRC_WRITE_G(v, g, idx)              GROUP_MWRITE_32(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 36, v)
#define RDD_PARSER_RESULT_VLAN_ETH_TYPE_CRC_READ(r, p)                      MREAD_32((uint8_t *)p + 36, r)
#define RDD_PARSER_RESULT_VLAN_ETH_TYPE_CRC_WRITE(v, p)                     MWRITE_32((uint8_t *)p + 36, v)
#define RDD_PARSER_RESULT_TOS_L2_READ_G(r, g, idx)                          GROUP_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 40, r)
#define RDD_PARSER_RESULT_TOS_L2_WRITE_G(v, g, idx)                         GROUP_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 40, v)
#define RDD_PARSER_RESULT_TOS_L2_READ(r, p)                                 MREAD_8((uint8_t *)p + 40, r)
#define RDD_PARSER_RESULT_TOS_L2_WRITE(v, p)                                MWRITE_8((uint8_t *)p + 40, v)
#define RDD_PARSER_RESULT_LOOKUP_PORT_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 41, 3, 5, r)
#define RDD_PARSER_RESULT_LOOKUP_PORT_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 41, 3, 5, v)
#define RDD_PARSER_RESULT_LOOKUP_PORT_READ(r, p)                            FIELD_MREAD_8((uint8_t *)p + 41, 3, 5, r)
#define RDD_PARSER_RESULT_LOOKUP_PORT_WRITE(v, p)                           FIELD_MWRITE_8((uint8_t *)p + 41, 3, 5, v)
#define RDD_PARSER_RESULT_VLANS_NUM_READ_G(r, g, idx)                       GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 41, 0, 3, r)
#define RDD_PARSER_RESULT_VLANS_NUM_WRITE_G(v, g, idx)                      GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 41, 0, 3, v)
#define RDD_PARSER_RESULT_VLANS_NUM_READ(r, p)                              FIELD_MREAD_8((uint8_t *)p + 41, 0, 3, r)
#define RDD_PARSER_RESULT_VLANS_NUM_WRITE(v, p)                             FIELD_MWRITE_8((uint8_t *)p + 41, 0, 3, v)
#define RDD_PARSER_RESULT_VALID_READ_G(r, g, idx)                           GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 42, 7, 1, r)
#define RDD_PARSER_RESULT_VALID_WRITE_G(v, g, idx)                          GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 42, 7, 1, v)
#define RDD_PARSER_RESULT_VALID_READ(r, p)                                  FIELD_MREAD_8((uint8_t *)p + 42, 7, 1, r)
#define RDD_PARSER_RESULT_VALID_WRITE(v, p)                                 FIELD_MWRITE_8((uint8_t *)p + 42, 7, 1, v)
#define RDD_PARSER_RESULT_TCP_PURE_ACK_READ_G(r, g, idx)                    GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 42, 6, 1, r)
#define RDD_PARSER_RESULT_TCP_PURE_ACK_WRITE_G(v, g, idx)                   GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 42, 6, 1, v)
#define RDD_PARSER_RESULT_TCP_PURE_ACK_READ(r, p)                           FIELD_MREAD_8((uint8_t *)p + 42, 6, 1, r)
#define RDD_PARSER_RESULT_TCP_PURE_ACK_WRITE(v, p)                          FIELD_MWRITE_8((uint8_t *)p + 42, 6, 1, v)
#define RDD_PARSER_RESULT_LLC_SNAP_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 42, 5, 1, r)
#define RDD_PARSER_RESULT_LLC_SNAP_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 42, 5, 1, v)
#define RDD_PARSER_RESULT_LLC_SNAP_READ(r, p)                               FIELD_MREAD_8((uint8_t *)p + 42, 5, 1, r)
#define RDD_PARSER_RESULT_LLC_SNAP_WRITE(v, p)                              FIELD_MWRITE_8((uint8_t *)p + 42, 5, 1, v)
#define RDD_PARSER_RESULT_UNUSED2_READ_G(r, g, idx)                         GROUP_FIELD_MREAD_16(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 42, 4, 9, r)
#define RDD_PARSER_RESULT_UNUSED2_WRITE_G(v, g, idx)                        GROUP_FIELD_MWRITE_16(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 42, 4, 9, v)
#define RDD_PARSER_RESULT_UNUSED2_READ(r, p)                                FIELD_MREAD_16((uint8_t *)p + 42, 4, 9, r)
#define RDD_PARSER_RESULT_UNUSED2_WRITE(v, p)                               FIELD_MWRITE_16((uint8_t *)p + 42, 4, 9, v)
#define RDD_PARSER_RESULT_VAR_LEN_CTX_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 43, 0, 4, r)
#define RDD_PARSER_RESULT_VAR_LEN_CTX_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 43, 0, 4, v)
#define RDD_PARSER_RESULT_VAR_LEN_CTX_READ(r, p)                            FIELD_MREAD_8((uint8_t *)p + 43, 0, 4, r)
#define RDD_PARSER_RESULT_VAR_LEN_CTX_WRITE(v, p)                           FIELD_MWRITE_8((uint8_t *)p + 43, 0, 4, v)
#define RDD_PARSER_RESULT_SOURCE_IP_READ_G(r, g, idx)                       GROUP_MREAD_32(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 44, r)
#define RDD_PARSER_RESULT_SOURCE_IP_WRITE_G(v, g, idx)                      GROUP_MWRITE_32(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 44, v)
#define RDD_PARSER_RESULT_SOURCE_IP_READ(r, p)                              MREAD_32((uint8_t *)p + 44, r)
#define RDD_PARSER_RESULT_SOURCE_IP_WRITE(v, p)                             MWRITE_32((uint8_t *)p + 44, v)
#define RDD_PARSER_RESULT_DESTINATION_IP_READ_G(r, g, idx)                  GROUP_MREAD_32(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 48, r)
#define RDD_PARSER_RESULT_DESTINATION_IP_WRITE_G(v, g, idx)                 GROUP_MWRITE_32(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 48, v)
#define RDD_PARSER_RESULT_DESTINATION_IP_READ(r, p)                         MREAD_32((uint8_t *)p + 48, r)
#define RDD_PARSER_RESULT_DESTINATION_IP_WRITE(v, p)                        MWRITE_32((uint8_t *)p + 48, v)
#define RDD_PARSER_RESULT_SOURCE_PORT_READ_G(r, g, idx)                     GROUP_MREAD_16(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 52, r)
#define RDD_PARSER_RESULT_SOURCE_PORT_WRITE_G(v, g, idx)                    GROUP_MWRITE_16(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 52, v)
#define RDD_PARSER_RESULT_SOURCE_PORT_READ(r, p)                            MREAD_16((uint8_t *)p + 52, r)
#define RDD_PARSER_RESULT_SOURCE_PORT_WRITE(v, p)                           MWRITE_16((uint8_t *)p + 52, v)
#define RDD_PARSER_RESULT_DESTINATION_PORT_READ_G(r, g, idx)                GROUP_MREAD_16(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 54, r)
#define RDD_PARSER_RESULT_DESTINATION_PORT_WRITE_G(v, g, idx)               GROUP_MWRITE_16(g, idx*sizeof(RDD_PARSER_RESULT_DTS) + 54, v)
#define RDD_PARSER_RESULT_DESTINATION_PORT_READ(r, p)                       MREAD_16((uint8_t *)p + 54, r)
#define RDD_PARSER_RESULT_DESTINATION_PORT_WRITE(v, p)                      MWRITE_16((uint8_t *)p + 54, v)
/* <<<RDD_PARSER_RESULT_DTS */
...
typedef struct
{
	...
	union{
		...
		struct{
			...
			uint32_t	reserved3                         	:4	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of cpu_rx_src_union union */
			uint32_t	wan_flow_id                       	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of cpu_rx_src_union union */
		...
		struct{
			...
			uint32_t	reserved4                         	:12	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of cpu_rx_src_union union */
		...
		struct{
			...
			uint32_t	reserved5                         	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of cpu_rx_src_union union */
	...
	union{
		...
		struct{
			...
			uint32_t	reserved6                         	:10	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of mcast_tx_prio_union union */
		...
		struct{
			...
			uint32_t	reserved7                         	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of mcast_tx_prio_union union */
			uint32_t	metadata_0                        	:5	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of mcast_tx_prio_union union */
			uint32_t	reserved8                         	:5	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of mcast_tx_prio_union union */
		...
		struct{
			...
			uint32_t	reserved9                         	:11	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of mcast_tx_prio_union union */
...
#define RDD_CPU_RX_DESCRIPTOR_WAN_FLOW_ID_READ_G(r, g, idx)                       GROUP_FIELD_MREAD_32(g, idx*sizeof(RDD_CPU_RX_DESCRIPTOR_DTS) + 8, 13, 8, r)
#define RDD_CPU_RX_DESCRIPTOR_WAN_FLOW_ID_WRITE_G(v, g, idx)                      GROUP_FIELD_MWRITE_32(g, idx*sizeof(RDD_CPU_RX_DESCRIPTOR_DTS) + 8, 13, 8, v)
#define RDD_CPU_RX_DESCRIPTOR_WAN_FLOW_ID_READ(r, p)                              FIELD_MREAD_32((uint8_t *)p + 8, 13, 8, r)
#define RDD_CPU_RX_DESCRIPTOR_WAN_FLOW_ID_WRITE(v, p)                             FIELD_MWRITE_32((uint8_t *)p + 8, 13, 8, v)
