...
{
    uint32_t reg_led_pwm_cntrl=0;

#ifdef VALIDATE_PARMS
    if((pwm_enable >= _1BITS_MAX_VAL_))
    {
        pr_err("ERROR driver %s:%u|(%d)\n", __FILE__, __LINE__, 0);
        return 0;
    }
    ...
    reg_led_pwm_cntrl = RU_FIELD_SET(0, XPORT_REG, LED_PWM_CNTRL, PWM_ENABLE, reg_led_pwm_cntrl, pwm_enable);

    RU_REG_WRITE(0, XPORT_REG, LED_PWM_CNTRL, reg_led_pwm_cntrl);
...
int ag_drv_xport_reg_led_pwm_cntrl_get(uint8_t *pwm_enable)
{
    ...
    RU_REG_READ(0, XPORT_REG, LED_PWM_CNTRL, reg_led_pwm_cntrl);

    *pwm_enable = RU_FIELD_GET(0, XPORT_REG, LED_PWM_CNTRL, PWM_ENABLE, reg_led_pwm_cntrl);
...
{
    uint32_t reg_led_intensity_cntrl=0;

#ifdef VALIDATE_PARMS
#endif

    reg_led_intensity_cntrl = RU_FIELD_SET(0, XPORT_REG, LED_INTENSITY_CNTRL, LED_ON_LOW, reg_led_intensity_cntrl, led_on_low);
    reg_led_intensity_cntrl = RU_FIELD_SET(0, XPORT_REG, LED_INTENSITY_CNTRL, LED_ON_HIGH, reg_led_intensity_cntrl, led_on_high);

    RU_REG_WRITE(0, XPORT_REG, LED_INTENSITY_CNTRL, reg_led_intensity_cntrl);
...
int ag_drv_xport_reg_led_intensity_cntrl_get(uint16_t *led_on_low, uint16_t *led_on_high)
{
    ...
    RU_REG_READ(0, XPORT_REG, LED_INTENSITY_CNTRL, reg_led_intensity_cntrl);

    *led_on_low = RU_FIELD_GET(0, XPORT_REG, LED_INTENSITY_CNTRL, LED_ON_LOW, reg_led_intensity_cntrl);
    *led_on_high = RU_FIELD_GET(0, XPORT_REG, LED_INTENSITY_CNTRL, LED_ON_HIGH, reg_led_intensity_cntrl);
