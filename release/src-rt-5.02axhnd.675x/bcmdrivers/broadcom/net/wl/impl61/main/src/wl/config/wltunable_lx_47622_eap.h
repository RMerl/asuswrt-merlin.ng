 ...
 *
 * $Id: wltunable_lx_47622.h 772733 2019-03-04 01:50:03Z $
 *
 * wl driver tunables
 */
...
#define D11CONF2	0x00000400	/* D11 Core Rev > 31, Rev 42(4360b0) */
#define D11CONF3	0x0		/* D11 Core Rev > 63 */
#define D11CONF5	0x00000004	/* D11 Core Rev > 127, 130(63178a0) */
#define ACCONF		0x00000002	/* AC-Phy Rev 1(4360b0) */
#define ACCONF2		0x00080000	/* AC-Phy Rev > 31, 51(63178a0) */
#define ACCONF5		0x00000000	/* AC-Phy Rev > 127 */
#else /* __CONFIG_DHDAP__ */
#define D11CONF2	0x00030400	/* D11 Core Rev > 31, Rev 42(4360b0), Rev 48 (43570),
					 * 49 (43602a3)
					 */
#define D11CONF3	0x00000002	/* D11 Core Rev > 63, 65(4365c0) */
#define D11CONF5	0x0000000e	/* D11 Core Rev > 127, 129(43684b0),
					 * 130(63178a0), 131(6710a0)
					 */
#define ACCONF		0x00060002	/* AC-Phy Rev 1(4360b0), 18 (43602a3), 17 (43570) */
#define ACCONF2		0x00088002	/* AC-Phy Rev > 31, Rev 33(4365c0),
					 * 47(43684a0/b0), 51(63178a0)
					 */
