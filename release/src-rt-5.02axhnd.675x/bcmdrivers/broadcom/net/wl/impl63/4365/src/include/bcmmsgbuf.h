 ...
 *
 * $Id: bcmmsgbuf.h 708017 2017-06-29 14:11:45Z $
 */
...
typedef struct bcmpcie_soft_doorbell {
	...
	addr64_t haddr; /* host address, eg thread wakeup register address */
...
typedef union ctrl_completion_item {
	...
	unsigned char		pcie_ctrl_response[D2HRING_CTRL_CMPLT_ITEMSIZE];
