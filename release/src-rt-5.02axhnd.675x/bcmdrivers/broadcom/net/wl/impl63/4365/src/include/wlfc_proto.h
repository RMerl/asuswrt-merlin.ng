...
* $Id: wlfc_proto.h 713758 2017-08-01 12:55:09Z $
*
*/
...
/* To support max 64 STA's */
#define WLFC_BITMAP_NDWORD		2
/* b[7:6] -reuse guard, b[5:0] -value */
#define WLFC_MAC_DESC_GET_LOOKUP_INDEX(x) ((x) & 0x3f)
