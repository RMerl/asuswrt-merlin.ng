...
WLAN_StdIncDirs = src/include components/shared components/shared/devctrl_if src/wl/mbo_oce/include
WLAN_StdIncDirs += $(PHY_MOD_INC_DIRS)
WLAN_SrcIncDirs = src/shared src/wl/sys src/wl/phy src/bcmcrypto
WLAN_SrcIncDirs += src/wl/keymgmt/src src/wl/iocv/src src/wl/ndis/src src/wl/shim/src src/wl/mbo_oce/src
