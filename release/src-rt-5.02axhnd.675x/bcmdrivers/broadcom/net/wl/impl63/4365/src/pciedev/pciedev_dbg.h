...
#define	PCI_ERROR(args)		EVENT_LOG_COMPACT_CAST_PAREN_ARGS(EVENT_LOG_TAG_PCI_ERROR, args)
#else
...
#if defined(EVENT_PCI_INFO) && defined(EVENT_LOG_COMPILE)
#define PCI_INFO_TEMP(fmts, ...) EVENT_LOG_COMPACT(EVENT_LOG_TAG_PCI_INFO, fmts , ## __VA_ARGS__)
#define PCI_INFO(fmts) PCI_INFO_TEMP fmts
#else
#define PCI_INFO(args)
#endif /* defined(EVENT_PCI_INFO) && defined(EVENT_LOG_COMPILE) */
