...
#define CH_MIN_2G_CHANNEL		1	/* Min channel in 2G band */
#define CH_MAX_2G_CHANNEL		14	/* Max channel in 2G band */
#define CH_MIN_5G_CHANNEL		36	/* Min channel in 5G band */
...
/* set (/change) bandwidth of a chanspec (chspec) with given bandwidth (bw) */
#define CHSPEC_SET_BW(chspec, bw) (((chspec) & ~(WL_CHANSPEC_BW_MASK)) | (bw))
...
#define CHSPEC_IS20(chspec)	(CHSPEC_ISLE20(chspec))
...
#define CHSPEC_BW_LE20(chspec)	(CHSPEC_IS10(CHSPEC_BW(chspec)) || CHSPEC_IS20(CHSPEC_BW(chspec)))
