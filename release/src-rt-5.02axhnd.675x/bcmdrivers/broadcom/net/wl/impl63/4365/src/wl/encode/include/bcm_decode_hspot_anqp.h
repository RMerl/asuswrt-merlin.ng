...
#define BCM_DECODE_HSPOT_ANQP_MAX_NON_TRANS_PROFILE_LENGTH	256
#define BCM_DECODE_HSPOT_ANQP_MAX_LEGACY_OSU_SSID_LENGTH	255
#define BCM_DECODE_HSPOT_ANQP_MAX_OSU_PROVIDER				16
typedef struct
{
	uint16 nonTransProfileLength;
	uint8 nonTransProfile[BCM_DECODE_HSPOT_ANQP_MAX_NON_TRANS_PROFILE_LENGTH];
	uint8 legacyOsuSsidLength;
	uint8 legacyOsuSsid[
		BCM_DECODE_HSPOT_ANQP_MAX_LEGACY_OSU_SSID_LENGTH + 1];	/* null terminated */
