/*
 * HTPHY PHYTblInit module implementation - iovar handlers & registration
 *
...
static int
phy_ht_tbl_doiovar(void *ctx, uint32 aid,
...
int
BCMATTACHFN(phy_ht_tbl_register_iovt)(phy_info_t *pi, wlc_iocv_info_t *ii)
{
