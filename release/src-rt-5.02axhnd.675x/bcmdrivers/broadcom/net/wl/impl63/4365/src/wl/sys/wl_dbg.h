 ...
 *
 * $Id: wl_dbg.h 726281 2017-10-12 02:19:32Z $
 */
...
#define WL_AIRIQ(args)		do {if (wl_msg_level2 & WL_ACI_VAL) WL_PRINT(args);} while (0)
...
#define   WL_ERRORP(args)          WL_PRINT(args) /* for ROM/autopatching compatibility */
...
#define _WL_ATTACH_ERROR(args, ...) do {static const char BCMATTACHDATA(rstr)[] = (args); \
...
#if !defined(WL_ERRORP)
/* prevents ioctl patching errors with event log build */
#define WL_ERRORP WL_ERROR
#endif /* WL_ERRORP */
