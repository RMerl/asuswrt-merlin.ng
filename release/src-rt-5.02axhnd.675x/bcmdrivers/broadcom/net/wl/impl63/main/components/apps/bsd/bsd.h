...
#define BSD_BLOCK_STA_TIMEOUT	-1 /* not removing STA in block list */
...
/* Phytypes */
typedef enum {
	BSD_DOT11_PHYTYPE_DSSS		= 2,
	BSD_DOT11_PHYTYPE_OFDM		= 4,
	BSD_DOT11_PHYTYPE_HRDSSS	= 5,
	BSD_DOT11_PHYTYPE_ERP		= 6,
	BSD_DOT11_PHYTYPE_HT		= 7,
	BSD_DOT11_PHYTYPE_DMG		= 8,
	BSD_DOT11_PHYTYPE_VHT		= 9,
	BSD_DOT11_PHYTYPE_TVHT		= 10
} bsd_dot11_phytype_t;
...
#define BSD_STEERING_POLICY_FLAG_ACTIVE			0x10000000	/* for RDK log info */
...
struct bsd_info {
    ...
    int block_sta_timeout; /* timer for blocking STA, unblock STA if timeout */
};
