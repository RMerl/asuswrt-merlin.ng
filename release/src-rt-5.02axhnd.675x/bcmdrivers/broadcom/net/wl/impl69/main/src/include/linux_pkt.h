 ...
 *
 * $Id: linux_pkt.h 793358 2020-11-24 11:25:24Z $
 */
...
#ifdef BPM_BULK_FREE
extern void linux_pktfree_slow(osl_t *osh, void *skb, bool send, int line, const char *caller);
#endif /* BPM_BULK_FREE */
#else
extern void linux_pktfree(osl_t *osh, void *skb, bool send);
#ifdef BPM_BULK_FREE
extern void linux_pktfree_slow(osl_t *osh, void *skb, bool send);
#endif /* BPM_BULK_FREE */
#endif /* BCM_OBJECT_TRACE */
...
#ifdef BPM_BULK_FREE
extern void dev_kfree_skb_thread_wait(void);
#endif /* BPM_BULK_FREE */
#else	/* BINOSL */
