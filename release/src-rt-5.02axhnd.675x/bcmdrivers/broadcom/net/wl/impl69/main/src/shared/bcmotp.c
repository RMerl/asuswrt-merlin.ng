 ...
 *
 * $Id: bcmotp.c 788814 2020-07-13 09:46:46Z $
 */
...
#define OTP_PCIE_HWHDR_SZ_COREREV26	224	/* 43684/6710/6715 PCIE HW Header Size */
...
BCMNMIATTACHFN(ipxotp_writable)(otpinfo_t *oi, otpregs_t *otpregs)
{
	...
	OR_REG(oi->osh, otpregs->otpcontrol,
		(((OTPWRTYPE(otpwt) == OTPL_WRAP_TYPE_28NM) ||
		(OTPWRTYPE(otpwt) == OTPL_WRAP_TYPE_16NM))? OTPC_PROGEN_28NM :
		OTPC_PROGEN));
	return 0;
}
