 ...
 *
 * $Id: bcmwifi_channels.h 792734 2020-11-03 06:21:18Z $
 */
...
#define __WL_CHANSPEC_BW_5		0x0000u /* reserved */
#define __WL_CHANSPEC_BW_10		0x0800u /* reserved */
...
#define __WL_CHANSPEC_BW_2P5		0x3800u /* reserved */
...
#define CH20MHZ_CHSPEC(channel)	\
	(chanspec_t)((channel) | WL_CHANSPEC_BW_20 | WL_CHANNEL_2G5G_BAND(channel))
#define CH20MHZ_CHSPEC2(channel, band)	(chanspec_t)((chanspec_t)(channel) | WL_CHANSPEC_BW_20 | \
						(band))
#define NEXT_20MHZ_CHAN(channel)	(((channel) < (MAXCHANNEL - CH_20MHZ_APART)) ? \
						((channel) + CH_20MHZ_APART) : 0)
#define CH40MHZ_CHSPEC(band, channel, ctlsb) \
		(chanspec_t)((channel) | (ctlsb) | WL_CHANSPEC_BW_40 | (band))
#define CH80MHZ_CHSPEC(band, channel, ctlsb) \
		(chanspec_t)((channel) | (ctlsb) | WL_CHANSPEC_BW_80 | (band))
#define CH160MHZ_CHSPEC(band, channel, ctlsb) \
		(chanspec_t)((channel) | (ctlsb) | WL_CHANSPEC_BW_160 | (band))
/* TODO:6GHZ:CHBW_CHSPEC() does not return 6GHz chanspecs. Convert it to CHBW_CHSPEC2() */
#define CHBW_CHSPEC(bw, channel) \
		(chanspec_t)((chanspec_t)(channel) | (bw) | WL_CHANNEL_2G5G_BAND(channel))
#define CHBW_CHSPEC2(bw, channel, band) (chanspec_t)((chanspec_t)(channel) | (bw) | (band))
...
/**
 * Retrun 6G center channel given primary 20MHz channel, bandwidth.
 */
uint wf_6G_primary20_ch_to_center_ch(uint primary_channel, chanspec_bw_t bw);
