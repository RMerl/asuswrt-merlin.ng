 ...
 *
 * $Id: hndpmu.c 790521 2020-08-26 15:32:51Z $
 */
...
#if defined(DONGLEBUILD) && defined(BCMHWA) && defined(HWA_TXSTAT_BUILD)
static const char BCMATTACHDATA(rstr_txs_m2mdma)[] = "txs_m2mdma";
#endif // endif
...
void si_pmu_avbtimer_enable(si_t *sih, osl_t *osh, bool set_flag)
{
	...
	if (((CHIPID(sih->chip) == BCM4366_CHIP_ID) &&
		...
		CHIPID(sih->chip) == BCM6715_CHIP_ID ||
		CHIPID(sih->chip) == BCM6710_CHIP_ID) {
		/*
		For Rev C0 4365 (chiprev 0x4) and 43684, 6715 chips, bits 13:12 of chipcontrol_data
...
static const pmu1_xtaltab0_t BCMINITDATA(pmu1_xtaltab0_bcm6756_2952)[] = {
/*	fref      xf       p1div   p2div  ndiv_int  ndiv_frac */
	{50000,   0,       1,      1,     0x3b,     0xA3D8 }, /**< 50 Mhz xtal */
	{0,	  0,       0,      0,     0,        0	    }
};
...
BCMINITFN(si_pmu1_xtaltab0)(si_t *sih)
{
	...
	CASE_EMBEDDED_2x2AX_160MHZ_CORE:
		return pmu1_xtaltab0_bcm6756_2952;
	CASE_BCM6715_CHIP:
...
BCMINITFN(si_pmu1_xtaldef0)(si_t *sih)
{
	...
	CASE_EMBEDDED_2x2AX_160MHZ_CORE:
		return &pmu1_xtaltab0_bcm6756_2952[0];
	CASE_BCM6715_CHIP:
...
BCMATTACHFN(si_pmu_chip_init)(si_t *sih, osl_t *osh)
{
	...
	case BCM6715_CHIP_ID:
#if defined(DONGLEBUILD) && defined(BCMHWA) && defined(HWA_TXSTAT_BUILD)
		/* txstatus_ack_sel: by default is 0.  NIC mode use m2mdma.
		 * 0: txstatus_ack from m2mdma
		 * 1: txstatus_ack from hwa
		 */
		if (getvar(NULL, rstr_txs_m2mdma) == NULL) {
			/* Not M2MDMA then use HWA */
			si_pmu_chipcontrol(sih, PMU_6715_CHIPCTL3,
				PMU_6715_CC3_TXSTATUS_ACK_SEL_MASK,
