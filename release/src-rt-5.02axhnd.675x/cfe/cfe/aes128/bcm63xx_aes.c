 ...
 **********************************************************************/
static void aesExpandCipherKey(uint32_t *rk, const unsigned char *key)
{
  int i,j;
 ...
 **********************************************************************/
static void aesInvertRoundKeys(uint32_t *rk)
{
  int i, j, k;
  uint32_t temp;
 ...
 *        rk  - Pointer to the expanded round key
 **********************************************************************/
static void aesInverseTransform(uint32_t *rk)
{
  int i, j;
  uint8_t nTeElem;
