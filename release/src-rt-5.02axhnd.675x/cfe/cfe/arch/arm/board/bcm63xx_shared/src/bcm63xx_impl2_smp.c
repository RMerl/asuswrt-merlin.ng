...
{
#if defined(_BCM96846_) || defined(_BCM963138_) || defined(_BCM963148_) || defined(_BCM963178_) || defined(_BCM947622_) || defined(_BCM96878_)
    *(volatile uint32_t*)(BOOTLUT_BASE+0x20) = vector;
...
#if defined(_BCM96858_) || defined(_BCM963158_) || defined(_BCM96856_) || defined(_BCM96846_) || defined(_BCM963178_) || defined(_BCM947622_) || defined(_BCM96878_)
    ARM_CONTROL_REG ctrl_reg;
#endif
#if defined(_BCM96858_)
    uint32_t rvbar = (uint32_t)vector;
#elif  defined(_BCM963158_) || defined(_BCM96856_) || defined(_BCM963178_) || defined(_BCM947622_) || defined(_BCM96878_)
    ...
    while (cpu < nr_cpus)
    {
#if defined (_BCM96858_) || defined (_BCM963158_) || defined(_BCM96856_) || defined(_BCM963178_) || defined(_BCM947622_) || defined(_BCM96878_)
