...
ifeq ($(strip $(BRCM_USE_ALT_TOOLCHAIN)),y)
   TOOLS :=$(ALT_AARCH64_TOOLCHAIN_TOP)/$(TOOLCHAIN_USR_DIR)/bin/
   TOOLPREFIX :=$(ALT_AARCH64_TOOLCHAIN_PREFIX)-
else
...
ifeq ($(strip $(BRCM_USE_ALT_TOOLCHAIN)),y)
   TOOLS :=$(ALT_ARM_TOOLCHAIN_TOP)/$(TOOLCHAIN_USR_DIR)/bin/
   TOOLPREFIX :=$(ALT_ARM_TOOLCHAIN_PREFIX)-
else
