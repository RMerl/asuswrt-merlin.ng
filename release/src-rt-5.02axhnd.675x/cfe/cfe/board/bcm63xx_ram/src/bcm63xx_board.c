...
#if defined(_BCM96858_) || defined(_BCM94908_) || defined(_BCM963158_) || defined(_BCM96846_) || defined(_BCM96856_) || defined(_BCM963178_) || defined(_BCM947622_) || defined(_BCM96878_)
#include "bcm_otp.h"
#endif
...
static int parseAuxFSSize(char *);
#else
...
#if (NONETWORK==0) && (defined(_CFE_REDUCED_XRDP_) || defined(LEGACY_RDP) || defined(DUMMY_RDP))
...
#ifdef DISABLE_NOR_RAW_PARTITION
    {"Auxillary FS Size(uint 4KB)       :", AUXFS_SIZE_PROMPT,
        "", "", 3, parseAuxFSSize, TRUE},
#else
...
static int gNumAllocBoardParams = (sizeof(gAllocBoardParam) / sizeof(PARAMETER_SETTING))-1;
#elif (defined(_BCM96858_) || defined(_BCM96846_) || defined(_BCM96856_) || defined(_BCM96878_) || defined(_BCM963158_)) && (NONETWORK==0)
static PARAMETER_SETTING gAllocBoardParam[] =
{
    {"RNR_TBLS memory allocation (" xstr(MIN_RDP_PARAM2_SIZE) "-" xstr(MAX_RDP_PARAM2_SIZE) ") (MB) :", NULL,
        "", "", 3, parseParam2Size, TRUE},
...
#ifdef DISABLE_NOR_RAW_PARTITION
static int parseAuxFSSize(char *ctStr)
{
    int size = atoi(ctStr);
    
    if (size >= 0 && size <= MAX_NOR_AUXFS_SIZE)
        return 0;
    else
        return 1;
}
...
#if defined(_BCM96858_) || defined(_BCM94908_) || defined(_BCM96846_) || defined(_BCM96856_) || defined(_BCM96878_)
...
#if defined(_BCM963138_) || defined(_BCM963148_) || defined(_BCM94908_) || defined(_BCM963158_) || defined(_BCM96846_) || defined(_BCM963178_) || defined(_BCM947622_) || defined(_BCM947189_) || defined(_BCM96878_)
...
#ifdef DISABLE_NOR_RAW_PARTITION
    if (ucAuxFSPercent != nvramData->ucAuxFSPercent)
#else
...
#if defined(_BCM963138_) || defined(_BCM963148_) || defined(_BCM94908_) || defined(_BCM96848_) || defined(_BCM963158_) || defined(_BCM96846_) || defined(_BCM963178_) || defined(_BCM947622_) || defined(_BCM96878_)
