...
int validateNandPartTbl(uint32_t frcUpdt, uint32_t numBtBlks)
{
         ...
         (frcUpdt) )
    {
...
#if defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM963158_) ||  defined(_BCM96878_) || \
        ...
        defined (_BCM963148_) || defined(_BCM94908_) || defined(_BCM96858_) ||  defined(_BCM96878_) || \
        defined(_BCM963158_) || defined(_BCM96846_) || defined(_BCM96856_)  || defined(_BCM963178_)  || defined(_BCM947622_)
