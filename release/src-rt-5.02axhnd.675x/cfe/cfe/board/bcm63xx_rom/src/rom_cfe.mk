...
BOARD_ARCH_MCB_SRC  = ${ARCH_TOP}/board/${BOARD}_rom/src/mcb/63138
else
BOARD_ARCH_MCB_SRC  = ${ARCH_TOP}/board/${BOARD}_rom/src/mcb/${BRCM_CHIP}
endif
...
# paths and VPATH
#
SRCDIRS = ${ARCH_SRC} ${CPU_SRC} ${BOARD_SRC} $(BOARD_ARCH_SRC) $(BOARD_ARCH_MCB_SRC) $(BOARD_ARCH_SHR_SRC) ${TOP}/main ${TOP}/vendor ${TOP}/include ${TOP}/net ${TOP}/dev ${TOP}/pci ${TOP}/ui ${TOP}/lib ${TOP}/common ${TOP}/verif ${TOP}/lzma ${TOP}/board/common/src
...
# Voltage regular initialization
CFG_VREG_INIT=0
ifneq ($(findstring _$(strip $(BRCM_CHIP))_,_6846_6856_6858_47622_63178_),)
CFG_VREG_INIT=1
endif
...
ifneq ($(findstring _$(strip $(BRCM_CHIP))_,_63138_4908_6858_63158_6856_47622_),)
...
ifneq ($(findstring _$(strip $(BRCM_CHIP))_,_63138_63148_4908_6858_63158_6846_6856_63178_47622_6878_),)
INC_MEMSYS_INIT=1
endif
...
CFLAGS += -DCFG_VREG_INIT=$(CFG_VREG_INIT)
