...
extern int otp_map_write(void* data, key_store_data_type_t data_type);
extern int otp_map_read(void* data, key_store_data_type_t data_type);
                                ...
                                sec_state_t cur_state)
{
        ...
        switch(cur_state) {
				...
				mid[0] = ntohs(mid[0]);
                                ...
                                if (otp_map_read(&mid[0], KEY_STORE_DATA_TYPE_MID)) {
                                        PRINT4CH(EOTP);
                                        goto err;
                                }
                                if (memcmp(&mid[0], &mid[1], sizeof(uint16_t))) {
