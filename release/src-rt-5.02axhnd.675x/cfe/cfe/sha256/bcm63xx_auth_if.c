...
#include "bcm_map.h"
    ...
    ((defined(_BCM963138_) || defined(_BCM963148_) || \
     ...
     defined(_BCM963158_)) || defined(_BCM96846_) || \
     defined(_BCM96856_))  || defined(_BCM96846_) || \
     defined(_BCM96856_) || defined(_BCM963178_) || \
...
void die(void) 
{
    ...
    defined(_BCM963158_) || defined(_BCM963178_) || defined(_BCM947622_) || defined(_BCM96846_) || \
    defined(_BCM96856_) 
    // disable SOTP and PKA blocks
    *(uint32_t *)(SOTP_BASE + SOTP_PERM) = 0;
#if (!defined(_BCM963158_)) && (!defined(_BCM96846_)) && (!defined(_BCM96856_)) && \
	(!defined(_BCM963178_)) && (!defined(_BCM947622_)) && (!defined(_BCM96878_))  
...
#if (INC_BTRM_BUILD==1) && \
    (defined(_BCM94908_) || defined(_BCM96858_) || defined(_BCM963158_) || defined(_BCM96846_) || \
 ...
 */
    ...
    (! defined(_BCM96856_)) && (! defined(_BCM963158_)) && (! defined(_BCM96846_)) && \
    (!defined(_BCM963178_)) && (!defined(_BCM947622_)) && (!defined(_BCM96878_)) && (INC_BTRM_BOOT==0)
