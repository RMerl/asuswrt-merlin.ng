...
#include "bcm_intr.h"
#else
#define INTERRUPT_ID_RUNNER_0 0
#define INTERRUPT_ID_RUNNER_1 1
#endif
...
/* DSL_FIXME: Double check interrupt assignments! */

#define RDPA_IC_CPU_RX_IRQ    INTERRUPT_ID_RUNNER_0 	 /**< CPU rx IRQ in IC */
#define RDPA_IC_WLAN0_IRQ     INTERRUPT_ID_RUNNER_1     /**< Wlan0 IRQ in IC */
#define RDPA_IC_WLAN1_IRQ     INTERRUPT_ID_RUNNER_1     /**< Wlan1 IRQ in IC */
#if 0
