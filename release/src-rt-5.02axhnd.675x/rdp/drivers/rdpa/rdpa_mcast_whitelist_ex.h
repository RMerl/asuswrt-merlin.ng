...
#ifndef _RDPA_MCAST_WHITELIST_EX_H_
#define _RDPA_MCAST_WHITELIST_EX_H_

#include <rdpa_flow_idx_pool.h>

/* mcast_whitelist private data */
typedef struct {
    rdpa_flow_idx_pool_t *flow_idx_pool_p;
} mcast_whitelist_drv_priv_t;
...
int mcast_attr_whitelist_global_stat_read_ex(struct bdmf_object *mo, struct bdmf_attr *ad,
                                             bdmf_index index, void *val, uint32_t size);
#endif /* _RDPA_MCAST_WHITELIST_EX_H_ */
