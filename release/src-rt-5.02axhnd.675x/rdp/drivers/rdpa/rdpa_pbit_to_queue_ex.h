...
#ifndef _RDPA_PBIT_TO_QUEUE_EX_H_
#define _RDPA_PBIT_TO_QUEUE_EX_H_

/* pbit_to_queue object private data */
typedef struct {
    bdmf_index index;
    uint32_t pbit[8];
} pbit_to_queue_drv_priv_t;

int pbit_to_queue_set_single_entry_ex(struct bdmf_object *mo, bdmf_boolean set_to_rdd,
    bdmf_object_handle port_obj, bdmf_index pbit, bdmf_index queue, bdmf_boolean link);
