...
#ifndef _RDPA_TCPSPDTEST_EX_H_
#define _RDPA_TCPSPDTEST_EX_H_

#include "rdpa_spdtest_common_ex.h"

/* tcpspdtest object private data */
typedef struct {
    rdpa_tcpspdtest_engine_global_info_t  engine_global_info;
    rdpa_tcpspdtest_engine_conn_info_t    engine_conn_info;
    rdpa_tcpspdtest_engine_tcb_t          engine_tcb;
    rdpa_tcpspdtest_engine_ref_pkt_hdr_t  engine_ref_pkt_hdr;
    rdpa_tcpspdtest_engine_pkt_drop_t     engine_pkt_drop;
    spdt_ref_pkt_container_t engine_ref_pkt;
    int num_of_active_streams;
    bdmf_boolean is_on;
} tcpspdtest_drv_priv_t;
