                            ...
                            bdmf_boolean  enable)
{
    ...
    bdmf_trace("******************************************************************************************\n");
    bdmf_trace("rdpa_us_wan_flow_config : wan_flow=%d, wan_channel=%d, fstat=%x, crc_calc=%d, enable=%d\n",
               wan_flow, wan_channel, (unsigned int)wan_port_or_fstat, crc_calc, enable);
    bdmf_trace("******************************************************************************************\n");
