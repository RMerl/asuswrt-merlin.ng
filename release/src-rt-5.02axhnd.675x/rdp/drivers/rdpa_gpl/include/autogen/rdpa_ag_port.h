...
typedef enum {
    ...
    rdpa_port_attr_uninit = 23, /* uninit : W : bool : Port uninit: disable port and flush port related packets */
    rdpa_port_attr_mac = 24, /* mac : RW : ether_addr : PORT MAC address  */
    rdpa_port_attr_pkt_size_stat_en = 25, /* pkt_size_stat_en : RW : bool : Enable debug statistics */
    rdpa_port_attr_pbit_to_dp_map = 26, /* pbit_to_dp_map : RWF : enum[] : Pbit to Discard Priority map for Ingress QoS (low/high) */
    rdpa_port_attr_options = 27, /* options : RW : number : reserved */
    rdpa_port_attr_pfc_tx_enable = 28, /* pfc_tx_enable : RW : bool : reserved */
    rdpa_port_attr_pfc_tx_timer = 29, /* pfc_tx_timer : RWF : number[] : reserved */
