    ...
    uint8_t *int_ctx, uint8_t *ext_ctx)
{
    ...
    ext_ctx[4] = (bridge_and_vlan_lkp_result->protocol_filters_dis << BRIDGE_AND_VLAN_LKP_RESULT_PROTOCOL_FILTERS_DIS_F_OFFSET);
    ...
    uint8_t *int_ctx, uint8_t *ext_ctx)
{
    ...
    bridge_and_vlan_lkp_result->anti_spoofing_bypass = FIELD_GET(ext_ctx[5],
