...
bdmf_error_t rdd_tcpspdtest_engine_conn_info_set(RDD_TCPSPDTEST_ENGINE_CONN_INFO_DTS *conn_info, uint8_t stream_idx)
{
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_CONN_INFO_L2_HDR_LEN_WRITE_G(conn_info->l2_hdr_len, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_CONN_INFO_L3_HDR_LEN_WRITE_G(conn_info->l3_hdr_len, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_CONN_INFO_L3_PROTOCOL_WRITE_G(conn_info->l3_protocol, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_CONN_INFO_TX_HDR_LEN_WRITE_G(conn_info->tx_hdr_len, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
    ...
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_CONN_INFO_WAN_FLOW_WRITE_G(conn_info->wan_flow, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
	RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_CONN_INFO_TX_QM_QUEUE_WRITE_G(conn_info->tx_qm_queue, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
    ...
    rdd_ag_pktgen_tx_pktgen_tx_stream_table_set(stream_idx, conn_info->wan_flow, conn_info->tx_qm_queue);
...
bdmf_error_t rdd_tcpspdtest_engine_conn_info_get(RDD_TCPSPDTEST_ENGINE_CONN_INFO_DTS *conn_info, uint8_t stream_idx)
{
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_CONN_INFO_L2_HDR_LEN_READ_G(conn_info->l2_hdr_len, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_CONN_INFO_L3_HDR_LEN_READ_G(conn_info->l3_hdr_len, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_CONN_INFO_L3_PROTOCOL_READ_G(conn_info->l3_protocol, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_CONN_INFO_TX_HDR_LEN_READ_G(conn_info->tx_hdr_len, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
    ...
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_CONN_INFO_WAN_FLOW_READ_G(conn_info->wan_flow, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_CONN_INFO_TX_QM_QUEUE_READ_G(conn_info->tx_qm_queue, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
...
bdmf_error_t rdd_tcpspdtest_engine_ref_pkt_hdr_set(uint16_t size, uint16_t offset, uint8_t *hdr, uint8_t stream_idx)
{
	...
	RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_REF_PKT_HDR_SIZE_WRITE_G(size, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_REF_PKT_HDR_OFFSET_WRITE_G(offset, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);


    /* BUG_ARRAY_NOT_ALLOWED_IN_MIDDLE_OF_TABLE - use array when bug is fixed */
    entry = NULL;
    addr_arr = RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR;
    addr = stream_idx * sizeof(RDD_TCPSPDTEST_STREAM_DTS) + TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_REF_PKT_HDR_HDR_OFFSET + offset;
...
bdmf_error_t rdd_tcpspdtest_engine_ref_pkt_hdr_get(uint16_t *size, uint16_t *offset, uint8_t *hdr, uint8_t stream_idx, uint16_t read_size)
{
	...
	RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_REF_PKT_HDR_SIZE_READ_G(*size, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
    RDD_TCPSPDTEST_STREAM_TCPSPDTEST_ENGINE_REF_PKT_HDR_OFFSET_READ_G(*offset, RDD_TCPSPDTEST_STREAM_TABLE_ADDRESS_ARR, stream_idx);
...
#ifndef CONFIG_BCM_SPDT_FC_SUPPORT
            /* Set spdsvc task off */
            RDD_SPDTEST_GEN_CFG_IS_ON_WRITE_G(0, RDD_SPDTEST_GEN_PARAM_ADDRESS_ARR, 0); /* Set spdsvc task off */
#endif
