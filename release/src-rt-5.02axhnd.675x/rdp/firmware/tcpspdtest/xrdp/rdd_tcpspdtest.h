...
bdmf_error_t rdd_tcpspdtest_engine_conn_info_set(RDD_TCPSPDTEST_ENGINE_CONN_INFO_DTS *params, uint8_t stream_idx);
bdmf_error_t rdd_tcpspdtest_engine_conn_info_get(RDD_TCPSPDTEST_ENGINE_CONN_INFO_DTS *params, uint8_t stream_idx);
