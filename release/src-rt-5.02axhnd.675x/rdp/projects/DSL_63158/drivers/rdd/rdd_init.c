...
static void image_0_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_0_DS_TM_UPDATE_FIFO_THREAD_NUMBER][reg_id[13]] = IMAGE_0_DS_TM_EGRESS_PORT_RR_TABLE_ADDRESS;
...
static void image_1_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    {
      local_regs[IMAGE_1_IMAGE_1_CPU_RX_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_1, c_cpu_rx_wakeup_request) << 16;
      ...
      local_regs[IMAGE_1_IMAGE_1_CPU_RX_THREAD_NUMBER][reg_id[30]] = IMAGE_1_CPU_RX_TASK_STACK_ADDRESS;
    }
