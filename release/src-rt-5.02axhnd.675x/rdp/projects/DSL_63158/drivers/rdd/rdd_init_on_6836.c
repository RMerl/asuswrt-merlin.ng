...
int rdd_broadcom_switch_ports_mapping_table_config(rdd_vport_id_t vport, uint8_t broadcom_switch_port)
{
    ...
    RDD_BROADCOM_SWITCH_PORT_MAPPING_RX_FLOW_TABLE_INDEX_WRITE_G(vport + RDD_NUM_OF_WAN_FLOWS, RDD_BROADCOM_SWITCH_PORT_TO_RX_FLOW_MAPPING_TABLE_ADDRESS_ARR, broadcom_switch_port);
