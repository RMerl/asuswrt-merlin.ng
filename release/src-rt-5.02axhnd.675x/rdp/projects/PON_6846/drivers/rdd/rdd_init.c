...
static void image_0_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_0_TM_WAN_DIRECT_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_0, gpon_control_wakeup_request) << 16 | IMAGE_0_DIRECT_PROCESSING_PD_TABLE_ADDRESS;
    ...
    local_regs[IMAGE_0_TM_TIMER_COMMON_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_0, timer_common_task_wakeup_request) << 16;
...
static void image_1_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_1_PROCESSING_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_1, dhd_tx_complete_wakeup_request) << 16;
    ...
    local_regs[IMAGE_1_PROCESSING_DHD_RX_COMPLETE_0_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_1, dhd_rx_complete_wakeup_request) << 16;
...
static void image_2_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    /* DHD_MCAST: thread 15 */
    local_regs[IMAGE_2_IMAGE_2_DHD_MCAST_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_2, dhd_mcast_wakeup_request) << 16;
