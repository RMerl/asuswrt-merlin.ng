...
#define runner_b_start_task_timer_scheduler_set		(0x349C)
#define runner_b_timer_scheduler_set		(0x349C)
#define runner_b_start_task_cpu_rx_wakeup_request		(0x12D8)
#define runner_b_cpu_rx_wakeup_request		(0x12D8)
#define runner_b_start_task_rx_buffer_copy_wakeup_request		(0x2B48)
#define runner_b_rx_buffer_copy_wakeup_request		(0x2B48)
#define runner_b_start_task_cpu_tx_wakeup_request		(0x2DCC)
#define runner_b_cpu_tx_wakeup_request		(0x2DCC)
#define runner_b_start_task_policer_budget_allocator_1st_wakeup_request		(0x39E8)
#define runner_b_policer_budget_allocator_1st_wakeup_request		(0x39E8)
#define runner_b_start_task_rate_control_budget_allocator_1st_wakeup_request		(0x233C)
#define runner_b_rate_control_budget_allocator_1st_wakeup_request		(0x233C)
...
#define runner_b_start_task_timer_7_1st_wakeup_request		(0x36A4)
#define runner_b_timer_7_1st_wakeup_request		(0x36A4)
#define runner_b_start_task_free_skb_index_wakeup_request		(0x3630)
#define runner_b_free_skb_index_wakeup_request		(0x3630)
...
#define runner_b_spdsvc_timer_wakeup_request		(0x3408)
#define runner_b_cpu_rx_meter_budget_allocate		(0x351C)
#define runner_b_upstream_rate_limiter_budget_allocate		(0x3568)
#define runner_b_schedule_free_skb_index		(0x3614)
#define runner_b_pps_rate_limiter_timer_wakeup_request		(0x3708)
