...
#define OTP_BRCM_BTRM_BOOT_ENABLE_ROW	        OTP_SHADOW_ADDR_BTRM_ENABLE_BTRM_ROW
...
#define OTP_CUST_BTRM_BOOT_ENABLE_ROW           OTP_SHADOW_ADDR_BTRM_ENABLE_BTRM_ROW
...
#define OTP_CUST_MFG_MRKTID_ROW      		OTP_SHADOW_ADDR_MARKET_ID_CUST_ROW
#define OTP_CUST_MFG_MRKTID_SHIFT    		0
#define OTP_CUST_MFG_MRKTID_MASK		(0xffff << OTP_CUST_MFG_MRKTID_SHIFT)
#define OTP_CUST_OP_MRKTID_ROW      		OTP_SHADOW_ADDR_MARKET_ID_CUST_ROW
