...
/** Path to BEEP persistent storage dir.
 *  Note: Binary released software shall not directly or in-directly refer to
 *        this macro. Instead, beeputil library function beepParam_getDataDirName()
 *        shall be used to get the value of this macro.
 */
#define BEEP_PERSISTENT_STORAGE_DIR    "/data"

/** Path to CMS data storage dir.
 *  Note: Binary released software shall not directly or in-directly refer to
 *        this macro. Instead, beeputil library function beepParam_getPersistentDirName()
 *        shall be used to get the value of this macro.
 */
...
#define MODSW_PREINSTALLED_EE_DU_DIR      "/du"
#define MODSW_PREINSTALLED_HOSTEE_DIR     MODSW_PREINSTALLED_EE_DIR"/HOSTEE"
#define MODSW_PREINSTALLED_HOSTEE_DU_DIR  MODSW_PREINSTALLED_HOSTEE_DIR"/du"
 ...
 *
 */
#define MODSW_DU_DIR        "/modsw/tr157du"
...
#define CMS_MODSW_TMP_DU_DIR   "/var/modsw/tmp/du"

#define CMS_MODSW_TMP_EE_DIR   "/var/modsw/tmp/ee"
