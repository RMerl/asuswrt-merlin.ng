...
{
	if (isHTTPDServer == 1) {
		urlGetDevTypePriority = window.location.protocol + '//' + window.location.host +'/iQoS.cgi?Req=GetDevTypePrio';
		urlSetDevTypePriority = window.location.protocol + '//' + window.location.host +'/iQoS.cgi?Req=SetDevTypePrio';
		urlGetAppCatPriority = window.location.protocol + '//' + window.location.host +'/iQoS.cgi?Req=GetAppCatPrio';
		urlSetAppCatPriority = window.location.protocol + '//' + window.location.host +'/iQoS.cgi?Req=SetAppCatPrio';
		urlGetMacPriority = window.location.protocol + '//' + window.location.host +'/iQoS.cgi?Req=GetMacPrio';
		urlSetMacPriority = window.location.protocol + '//' + window.location.host +'/iQoS.cgi?Req=SetMacPrio';
		urlSetDefaultPrio = window.location.protocol + '//' + window.location.host +'/iQoS.cgi?Req=SetDefaultPrio';
		urlSetAllPriority = window.location.protocol + '//' + window.location.host +'/iQoS.cgi?Req=SetAllPrio';
		urlGetConfig  = window.location.protocol + '//' + window.location.host +'/iQoS.cgi?Req=GetConfig';
		urlNetworkSummary = window.location.protocol + '//' + window.location.host +'/iQoSNetworkSummary.asp';
	} else {
