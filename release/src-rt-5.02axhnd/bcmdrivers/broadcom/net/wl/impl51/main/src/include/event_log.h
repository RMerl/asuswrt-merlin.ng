...
#define _EVENT_LOGG(tag, fmt_num, ...) event_logn(16, tag, fmt_num, __VA_ARGS__)
...
#define _EVENT_LOG_CASTG(tag, fmt_num, ...) _EVENT_LOGG(tag, fmt_num, __VA_ARGS__)
