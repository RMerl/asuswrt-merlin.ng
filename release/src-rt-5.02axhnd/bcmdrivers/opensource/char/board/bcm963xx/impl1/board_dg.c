...
void kerSysEnableDyingGaspInterrupt( void )
{
    ...
    /* Set BgBias and Afe regs for 63158B0 via BPCM */
    pmc_dgasp_init(0x00EF, 0x04cd);
...
#elif defined(CONFIG_BCM94908) || defined(CONFIG_BCM96858) || defined(CONFIG_BCM96836) || (defined(CONFIG_BCM963158) && (CONFIG_BRCM_CHIP_REV==0x63158A0))
