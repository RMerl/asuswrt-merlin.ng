...
/*****************************************************************************/
#ifndef RDPA_MTU
#if (defined(DSL_63138) || defined(DSL_63148)) && defined(CONFIG_BCM_JUMBO_FRAME)
/* defined in bcm_pkt_lengths.h
 * ENET_MAX_MTU_PAYLOAD_SIZE = 2048 (mini jumbo)
 * ENET_MAX_MTU_EXTRA_SIZE   = 32 (EH_SIZE(14) + VLANTAG(4) + VLANTAG(4) + BRCMTAG(6) + FCS(4))
 * RDPA_MTU = 2048 + 32 = 2080
 */
#define RDPA_MTU 2080
#else
