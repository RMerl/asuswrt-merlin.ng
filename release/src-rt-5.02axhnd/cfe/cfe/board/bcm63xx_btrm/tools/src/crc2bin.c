...
/*  *********************************************************************
    *  main()
    *      Perform a crc on an SBI
    *  
    *  Input parameters: 
    *      pSbiImage - pointer to the start of the SBI image
    *        sbiLien - length of the SBI image
    *      
    *  Return value:
    *      SEC_S_SUCCESS -  
    *      SEC_S_MISMATCH- 
...
int main(int argc, char* argv[])
{
   ...
   fp = fopen("./unsigned_cfesbi.tmp","rb"); // read mode
   if( fp == NULL )
      exit(EXIT_FAILURE);

   fread(buf, MAX_FILE_SIZE, 1, fp);
