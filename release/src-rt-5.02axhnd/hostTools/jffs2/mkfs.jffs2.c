...
// Note: jffs2-user.h no longer exists in the new kernel.  These functions have been 
// moved to nodelist.h, however, this file seems to be very user-unfriendly.
// Because it is the only file required from the kernel itself, it's contents were
// were simply cut and paste into this file directly.
