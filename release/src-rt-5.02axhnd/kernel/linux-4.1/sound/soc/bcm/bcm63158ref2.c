/*********************************************************************
 * bcm63158ref2-cs4354.c -- ALSA SoC machine driver for BCM963158REF2 board 
 *
...
static int cs4354_hw_params(struct snd_pcm_substream *substream,
...
static struct snd_soc_ops cs4354_ops = {
   .hw_params = cs4354_hw_params,
};
...
static struct snd_soc_card snd_soc_bcm63xx_cs4354 = 
{
   .name      = "BCM63158REF2",	
   .owner     = THIS_MODULE,
...
static int __init bcm63xx_audio_init(void)
{
   ...
   platform_set_drvdata(bcm63xx_snd_device, &snd_soc_bcm63xx_cs4354);
...
MODULE_DESCRIPTION("ALSA SoC BCM 63158REF-CS4354");
MODULE_LICENSE("GPL");
