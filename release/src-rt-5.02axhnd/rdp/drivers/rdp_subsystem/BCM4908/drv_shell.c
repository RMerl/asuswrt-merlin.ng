...
{
    pi_bl_initialize_drv_bbh_shell(driver_dir);
    pi_bl_initialize_drv_bpm_shell(driver_dir);
    pi_bl_initialize_drv_ih_shell(driver_dir);
    pi_bl_initialize_drv_sbpm_shell(driver_dir);
}

void drv_cli_exit(bdmfmon_handle_t driver_dir)
{
    pi_bl_exit_drv_bbh_shell();
    pi_bl_exit_drv_bpm_shell();
    pi_bl_exit_drv_ih_shell();
    pi_bl_exit_drv_sbpm_shell();
}
