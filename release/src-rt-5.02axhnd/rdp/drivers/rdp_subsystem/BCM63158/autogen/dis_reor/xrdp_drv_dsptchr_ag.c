...
bdmf_error_t ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_set(const dsptchr_reorder_cfg_dsptchr_reordr_cfg *reorder_cfg_dsptchr_reordr_cfg)
{
    ...
    if((reorder_cfg_dsptchr_reordr_cfg->disp_enable >= _1BITS_MAX_VAL_) ||
       ...
       (reorder_cfg_dsptchr_reordr_cfg->dsptchr_per_enh_pod >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_reorder_cfg_dsptchr_reordr_cfg = RU_FIELD_SET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, DSPTCHR_PER_ENH_POD, reg_reorder_cfg_dsptchr_reordr_cfg, reorder_cfg_dsptchr_reordr_cfg->dsptchr_per_enh_pod);
...
bdmf_error_t ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_get(dsptchr_reorder_cfg_dsptchr_reordr_cfg *reorder_cfg_dsptchr_reordr_cfg)
{
    ...
    reorder_cfg_dsptchr_reordr_cfg->dsptchr_per_enh_pod = RU_FIELD_GET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, DSPTCHR_PER_ENH_POD, reg_reorder_cfg_dsptchr_reordr_cfg);
...
bdmf_error_t ag_drv_dsptchr_congestion_congstn_status_get(uint8_t *glbl_congstn, uint8_t *glbl_egrs_congstn, uint8_t *sbpm_congstn)
{
    uint32_t reg_congestion_congstn_status;

#ifdef VALIDATE_PARMS
    if(!glbl_congstn || !glbl_egrs_congstn || !sbpm_congstn)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    *glbl_congstn = RU_FIELD_GET(0, DSPTCHR, CONGESTION_CONGSTN_STATUS, GLBL_CONGSTN, reg_congestion_congstn_status);
    *glbl_egrs_congstn = RU_FIELD_GET(0, DSPTCHR, CONGESTION_CONGSTN_STATUS, GLBL_EGRS_CONGSTN, reg_congestion_congstn_status);
    *sbpm_congstn = RU_FIELD_GET(0, DSPTCHR, CONGESTION_CONGSTN_STATUS, SBPM_CONGSTN, reg_congestion_congstn_status);
...
static int bcm_dsptchr_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        dsptchr_reorder_cfg_dsptchr_reordr_cfg reorder_cfg_dsptchr_reordr_cfg = { .disp_enable=parm[1].value.unumber, .rdy=parm[2].value.unumber, .reordr_par_mod=parm[3].value.unumber, .per_q_egrs_congst_en=parm[4].value.unumber, .dsptchr_per_enh_pod=parm[5].value.unumber};
...
int bcm_dsptchr_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_dsptchr_reorder_cfg_dsptchr_reordr_cfg:
    {
        ...
        bdmf_session_print(session, "dsptchr_per_enh_pod = %u (0x%x)\n", reorder_cfg_dsptchr_reordr_cfg.dsptchr_per_enh_pod, reorder_cfg_dsptchr_reordr_cfg.dsptchr_per_enh_pod);
        break;
    }
    case cli_dsptchr_reorder_cfg_vq_en:
    {
    ...
    case cli_dsptchr_congestion_congstn_status:
    {
        ...
        err = ag_drv_dsptchr_congestion_congstn_status_get(&glbl_congstn, &glbl_egrs_congstn, &sbpm_congstn);
        bdmf_session_print(session, "glbl_congstn = %u (0x%x)\n", glbl_congstn, glbl_congstn);
        bdmf_session_print(session, "glbl_egrs_congstn = %u (0x%x)\n", glbl_egrs_congstn, glbl_egrs_congstn);
        bdmf_session_print(session, "sbpm_congstn = %u (0x%x)\n", sbpm_congstn, sbpm_congstn);
        break;
    }
...
static int bcm_dsptchr_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        dsptchr_reorder_cfg_dsptchr_reordr_cfg reorder_cfg_dsptchr_reordr_cfg = {.disp_enable=gtmv(m, 1), .rdy=gtmv(m, 1), .reordr_par_mod=gtmv(m, 1), .per_q_egrs_congst_en=gtmv(m, 1), .dsptchr_per_enh_pod=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_set( %u %u %u %u %u)\n", reorder_cfg_dsptchr_reordr_cfg.disp_enable, reorder_cfg_dsptchr_reordr_cfg.rdy, reorder_cfg_dsptchr_reordr_cfg.reordr_par_mod, reorder_cfg_dsptchr_reordr_cfg.per_q_egrs_congst_en, reorder_cfg_dsptchr_reordr_cfg.dsptchr_per_enh_pod);
        ...
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_get( %u %u %u %u %u)\n", reorder_cfg_dsptchr_reordr_cfg.disp_enable, reorder_cfg_dsptchr_reordr_cfg.rdy, reorder_cfg_dsptchr_reordr_cfg.reordr_par_mod, reorder_cfg_dsptchr_reordr_cfg.per_q_egrs_congst_en, reorder_cfg_dsptchr_reordr_cfg.dsptchr_per_enh_pod);
        if(err || reorder_cfg_dsptchr_reordr_cfg.disp_enable!=gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.rdy!=gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.reordr_par_mod!=gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.per_q_egrs_congst_en!=gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.dsptchr_per_enh_pod!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        uint8_t glbl_congstn=gtmv(m, 2);
        uint8_t glbl_egrs_congstn=gtmv(m, 2);
        uint8_t sbpm_congstn=gtmv(m, 2);
        if(!err) ag_drv_dsptchr_congestion_congstn_status_get( &glbl_congstn, &glbl_egrs_congstn, &sbpm_congstn);
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_congestion_congstn_status_get( %u %u %u)\n", glbl_congstn, glbl_egrs_congstn, sbpm_congstn);
    }
    {
...
bdmfmon_handle_t ag_drv_dsptchr_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_reorder_cfg_dsptchr_reordr_cfg[]={
            ...
            BDMFMON_MAKE_PARM("dsptchr_per_enh_pod", "dsptchr_per_enh_pod", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
