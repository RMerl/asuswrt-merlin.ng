...
/*                       ng                                                                       */
/* dsptchr_per_enh_pod: DISPATCHER_SM_PERFORMANCE_ENH_MODE_ - Enables Enhanced performance mode o */
/*                      f Dispatcher Load balancing and Dispatcher SM.This allows Disptach of PD  */
/*                      to RNR instead of every 14 clocks, every 11 clocks.                       */
/**************************************************************************************************/
typedef struct
{
    ...
    bdmf_boolean dsptchr_per_enh_pod;
