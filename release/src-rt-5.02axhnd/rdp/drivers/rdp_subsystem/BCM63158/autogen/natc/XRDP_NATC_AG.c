...
/******************************************************************************
 * Field: NATC_CONTROL_STATUS_UNUSED7
 ******************************************************************************/
const ru_field_rec NATC_CONTROL_STATUS_UNUSED7_FIELD =
{
    "UNUSED7",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    NATC_CONTROL_STATUS_UNUSED7_FIELD_MASK,
    0,
    NATC_CONTROL_STATUS_UNUSED7_FIELD_WIDTH,
    NATC_CONTROL_STATUS_UNUSED7_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: NATC_CONTROL_STATUS_DDR_OUTSTANDING_REQUEST_FIFO_SIZE
 ******************************************************************************/
const ru_field_rec NATC_CONTROL_STATUS_DDR_OUTSTANDING_REQUEST_FIFO_SIZE_FIELD =
{
    "DDR_OUTSTANDING_REQUEST_FIFO_SIZE",
#if RU_INCLUDE_DESC
    "",
    "It controls the number of DDR outstanding requests."
    "0h: 16 requests."
    "1h: 8 requests.",
#endif
    NATC_CONTROL_STATUS_DDR_OUTSTANDING_REQUEST_FIFO_SIZE_FIELD_MASK,
    0,
    NATC_CONTROL_STATUS_DDR_OUTSTANDING_REQUEST_FIFO_SIZE_FIELD_WIDTH,
    NATC_CONTROL_STATUS_DDR_OUTSTANDING_REQUEST_FIFO_SIZE_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
const ru_field_rec NATC_CONTROL_STATUS_NAT_HASH_MODE_FIELD =
{
    ...
    "1h: CRC32 hash is used as cache hash function. CRC32 is reduced to 16-bit using"
    "the same method as in 32-bit rolling XOR hash."
    "2h: CRC32 hash is used as cache hash function. CRC32[15:0] is used as hash value"
    "3h: CRC32 hash is used as cache hash function. CRC32[31:16] is used as hash value.",
#endif
...
static const ru_field_rec *NATC_CONTROL_STATUS_FIELDS[] =
{
    ...
    &NATC_CONTROL_STATUS_UNUSED7_FIELD,
