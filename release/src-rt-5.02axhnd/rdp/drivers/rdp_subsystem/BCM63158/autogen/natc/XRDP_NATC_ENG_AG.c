...
const ru_field_rec NATC_ENG_COMMAND_STATUS_DEL_CMD_MODE_FIELD =
{
    ...
    "This bit is used for NAT0, but not used for NAT1, NAT2 and NAT3."
...
const ru_field_rec NATC_ENG_COMMAND_STATUS_CACHE_FLUSH_FIELD =
{
    ...
    "",
    "Cache Flush enable"
    "This bit is used as CACHE_FLUSH for NAT0."
    "This bit is used as both DEL_CMD_MODE and CACHE_FLUSH for NAT1, NAT2 and NAT3."
    "For NAT1, NAT2 and NAT3, this bit is used as CACHE_FLUSH for Lookup command."
    "For NAT1, NAT2 and NAT3, this bit is used as DEL_CMD_MODE for Delete command."
...
const ru_field_rec NATC_ENG_HASH_HASH_FIELD =
{
    ...
    "For cache miss, DDR_ENABLE is 1 and DDR is a hit, 16-bit DDR hash value + DDR bin count is returned."
    "For cache miss, DDR_ENABLE is 1 and DDR is a miss, 16-bit DDR hash value is returned.",
#endif
