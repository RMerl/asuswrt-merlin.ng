...
bdmf_error_t ag_drv_natc_ctrl_status_set(const natc_ctrl_status *ctrl_status)
{
    ...
    if((ctrl_status->ddr_enable >= _1BITS_MAX_VAL_) ||
       ...
       (ctrl_status->unused7 >= _5BITS_MAX_VAL_) ||
       (ctrl_status->ddr_disable_on_reg_lookup >= _1BITS_MAX_VAL_) ||
       (ctrl_status->ddr_outstanding_request_fifo_size >= _1BITS_MAX_VAL_) ||
       ...
       (ctrl_status->unused0 >= _2BITS_MAX_VAL_) ||
       ...
       (ctrl_status->unused2 >= _1BITS_MAX_VAL_) ||
    ...
    reg_control_status = RU_FIELD_SET(0, NATC, CONTROL_STATUS, UNUSED7, reg_control_status, ctrl_status->unused7);
    ...
    reg_control_status = RU_FIELD_SET(0, NATC, CONTROL_STATUS, DDR_OUTSTANDING_REQUEST_FIFO_SIZE, reg_control_status, ctrl_status->ddr_outstanding_request_fifo_size);
...
bdmf_error_t ag_drv_natc_ctrl_status_get(natc_ctrl_status *ctrl_status)
{
    ...
    ctrl_status->unused7 = RU_FIELD_GET(0, NATC, CONTROL_STATUS, UNUSED7, reg_control_status);
    ctrl_status->ddr_disable_on_reg_lookup = RU_FIELD_GET(0, NATC, CONTROL_STATUS, DDR_DISABLE_ON_REG_LOOKUP, reg_control_status);
    ctrl_status->ddr_outstanding_request_fifo_size = RU_FIELD_GET(0, NATC, CONTROL_STATUS, DDR_OUTSTANDING_REQUEST_FIFO_SIZE, reg_control_status);
...
bdmf_error_t ag_drv_natc_table_control_set(const natc_table_control *table_control)
{
    ...
    if((table_control->var_context_len_en_tbl7 >= _1BITS_MAX_VAL_) ||
...
static int bcm_natc_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        natc_ctrl_status ctrl_status = { .ddr_enable=parm[1].value.unumber, .natc_add_command_speedup_mode=parm[2].value.unumber, .unused4=parm[3].value.unumber, .ddr_64bit_in_128bit_swap_control=parm[4].value.unumber, .smem_32bit_in_64bit_swap_control=parm[5].value.unumber, .smem_8bit_in_32bit_swap_control=parm[6].value.unumber, .ddr_swap_all_control=parm[7].value.unumber, .unused3=parm[8].value.unumber, .reg_32bit_in_64bit_swap_control=parm[9].value.unumber, .reg_8bit_in_32bit_swap_control=parm[10].value.unumber, .unused7=parm[11].value.unumber, .ddr_disable_on_reg_lookup=parm[12].value.unumber, .ddr_outstanding_request_fifo_size=parm[13].value.unumber, .nat_hash_mode=parm[14].value.unumber, .multi_hash_limit=parm[15].value.unumber, .decr_count_wraparound_enable=parm[16].value.unumber, .nat_arb_st=parm[17].value.unumber, .natc_smem_increment_on_reg_lookup=parm[18].value.unumber, .natc_smem_clear_by_update_disable=parm[19].value.unumber, .natc_smem_disable=parm[20].value.unumber, .natc_enable=parm[21].value.unumber, .natc_reset=parm[22].value.unumber, .ddr_hash_swap=parm[23].value.unumber, .ddr_hash_mode=parm[24].value.unumber, .ddr_32bit_in_64bit_swap_control=parm[25].value.unumber, .ddr_8bit_in_32bit_swap_control=parm[26].value.unumber, .cache_lookup_blocking_mode=parm[27].value.unumber, .age_timer_tick=parm[28].value.unumber, .age_timer=parm[29].value.unumber, .cache_algo=parm[30].value.unumber, .unused1=parm[31].value.unumber, .unused0=parm[32].value.unumber, .cache_update_on_reg_ddr_lookup=parm[33].value.unumber, .ddr_counter_8bit_in_32bit_swap_control=parm[34].value.unumber, .unused2=parm[35].value.unumber, .ddr_replace_duplicated_cached_entry_enable=parm[36].value.unumber, .ddr_lookup_pending_fifo_mode_disable=parm[37].value.unumber, .eviction_disable=parm[38].value.unumber};
        err = ag_drv_natc_ctrl_status_set(&ctrl_status);
        break;
    }
    case cli_natc_table_control:
    {
        natc_table_control table_control = { .var_context_len_en_tbl7=parm[1].value.unumber, .var_context_len_en_tbl6=parm[2].value.unumber, .var_context_len_en_tbl5=parm[3].value.unumber, .var_context_len_en_tbl4=parm[4].value.unumber, .var_context_len_en_tbl3=parm[5].value.unumber, .var_context_len_en_tbl2=parm[6].value.unumber, .var_context_len_en_tbl1=parm[7].value.unumber, .var_context_len_en_tbl0=parm[8].value.unumber, .key_len_tbl7=parm[9].value.unumber, .non_cacheable_tbl7=parm[10].value.unumber, .key_len_tbl6=parm[11].value.unumber, .non_cacheable_tbl6=parm[12].value.unumber, .key_len_tbl5=parm[13].value.unumber, .non_cacheable_tbl5=parm[14].value.unumber, .key_len_tbl4=parm[15].value.unumber, .non_cacheable_tbl4=parm[16].value.unumber, .key_len_tbl3=parm[17].value.unumber, .non_cacheable_tbl3=parm[18].value.unumber, .key_len_tbl2=parm[19].value.unumber, .non_cacheable_tbl2=parm[20].value.unumber, .key_len_tbl1=parm[21].value.unumber, .non_cacheable_tbl1=parm[22].value.unumber, .key_len_tbl0=parm[23].value.unumber, .non_cacheable_tbl0=parm[24].value.unumber};
        err = ag_drv_natc_table_control_set(&table_control);
        break;
    }
    default:
...
int bcm_natc_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_natc_ctrl_status:
    {
        ...
        bdmf_session_print(session, "unused7 = %u (0x%x)\n", ctrl_status.unused7, ctrl_status.unused7);
        ...
        bdmf_session_print(session, "ddr_outstanding_request_fifo_size = %u (0x%x)\n", ctrl_status.ddr_outstanding_request_fifo_size, ctrl_status.ddr_outstanding_request_fifo_size);
    ...
    {
        natc_table_control table_control;
        err = ag_drv_natc_table_control_get(&table_control);
...
bdmfmon_handle_t ag_drv_natc_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        static bdmfmon_cmd_parm_t set_ctrl_status[]={
            ...
            BDMFMON_MAKE_PARM("unused7", "unused7", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("ddr_disable_on_reg_lookup", "ddr_disable_on_reg_lookup", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("ddr_outstanding_request_fifo_size", "ddr_outstanding_request_fifo_size", BDMFMON_PARM_NUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_table_control[]={
            BDMFMON_MAKE_PARM("var_context_len_en_tbl7", "var_context_len_en_tbl7", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("var_context_len_en_tbl6", "var_context_len_en_tbl6", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("var_context_len_en_tbl5", "var_context_len_en_tbl5", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("var_context_len_en_tbl4", "var_context_len_en_tbl4", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("var_context_len_en_tbl3", "var_context_len_en_tbl3", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("var_context_len_en_tbl2", "var_context_len_en_tbl2", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("var_context_len_en_tbl1", "var_context_len_en_tbl1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("var_context_len_en_tbl0", "var_context_len_en_tbl0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("key_len_tbl7", "key_len_tbl7", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("non_cacheable_tbl7", "non_cacheable_tbl7", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("key_len_tbl6", "key_len_tbl6", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("non_cacheable_tbl6", "non_cacheable_tbl6", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("key_len_tbl5", "key_len_tbl5", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("non_cacheable_tbl5", "non_cacheable_tbl5", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("key_len_tbl4", "key_len_tbl4", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("non_cacheable_tbl4", "non_cacheable_tbl4", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("key_len_tbl3", "key_len_tbl3", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("non_cacheable_tbl3", "non_cacheable_tbl3", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("key_len_tbl2", "key_len_tbl2", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("non_cacheable_tbl2", "non_cacheable_tbl2", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("key_len_tbl1", "key_len_tbl1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("non_cacheable_tbl1", "non_cacheable_tbl1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("key_len_tbl0", "key_len_tbl0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("non_cacheable_tbl0", "non_cacheable_tbl0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
