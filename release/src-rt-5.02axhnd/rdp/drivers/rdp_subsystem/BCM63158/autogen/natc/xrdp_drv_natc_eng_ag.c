...
bdmf_error_t ag_drv_natc_eng_key_result_set(uint8_t eng_idx, uint8_t zero, const natc_eng_key_result *key_result)
{
    ...
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 0, NATC_ENG, KEY_RESULT, key_result->data[0]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 1, NATC_ENG, KEY_RESULT, key_result->data[1]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 2, NATC_ENG, KEY_RESULT, key_result->data[2]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 3, NATC_ENG, KEY_RESULT, key_result->data[3]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 4, NATC_ENG, KEY_RESULT, key_result->data[4]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 5, NATC_ENG, KEY_RESULT, key_result->data[5]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 6, NATC_ENG, KEY_RESULT, key_result->data[6]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 7, NATC_ENG, KEY_RESULT, key_result->data[7]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 8, NATC_ENG, KEY_RESULT, key_result->data[8]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 9, NATC_ENG, KEY_RESULT, key_result->data[9]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 10, NATC_ENG, KEY_RESULT, key_result->data[10]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 11, NATC_ENG, KEY_RESULT, key_result->data[11]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 12, NATC_ENG, KEY_RESULT, key_result->data[12]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 13, NATC_ENG, KEY_RESULT, key_result->data[13]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 14, NATC_ENG, KEY_RESULT, key_result->data[14]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 15, NATC_ENG, KEY_RESULT, key_result->data[15]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 16, NATC_ENG, KEY_RESULT, key_result->data[16]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 17, NATC_ENG, KEY_RESULT, key_result->data[17]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 18, NATC_ENG, KEY_RESULT, key_result->data[18]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 19, NATC_ENG, KEY_RESULT, key_result->data[19]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 20, NATC_ENG, KEY_RESULT, key_result->data[20]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 21, NATC_ENG, KEY_RESULT, key_result->data[21]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 22, NATC_ENG, KEY_RESULT, key_result->data[22]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 23, NATC_ENG, KEY_RESULT, key_result->data[23]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 24, NATC_ENG, KEY_RESULT, key_result->data[24]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 25, NATC_ENG, KEY_RESULT, key_result->data[25]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 26, NATC_ENG, KEY_RESULT, key_result->data[26]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 27, NATC_ENG, KEY_RESULT, key_result->data[27]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 28, NATC_ENG, KEY_RESULT, key_result->data[28]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 29, NATC_ENG, KEY_RESULT, key_result->data[29]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 30, NATC_ENG, KEY_RESULT, key_result->data[30]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 31, NATC_ENG, KEY_RESULT, key_result->data[31]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 32, NATC_ENG, KEY_RESULT, key_result->data[32]);
    RU_REG_RAM_WRITE(eng_idx, zero *34 + 33, NATC_ENG, KEY_RESULT, key_result->data[33]);
...
bdmf_error_t ag_drv_natc_eng_key_result_get(uint8_t eng_idx, uint8_t zero, natc_eng_key_result *key_result)
{
    ...
    RU_REG_RAM_READ(eng_idx, zero *34 + 0, NATC_ENG, KEY_RESULT, key_result->data[0]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 1, NATC_ENG, KEY_RESULT, key_result->data[1]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 2, NATC_ENG, KEY_RESULT, key_result->data[2]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 3, NATC_ENG, KEY_RESULT, key_result->data[3]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 4, NATC_ENG, KEY_RESULT, key_result->data[4]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 5, NATC_ENG, KEY_RESULT, key_result->data[5]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 6, NATC_ENG, KEY_RESULT, key_result->data[6]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 7, NATC_ENG, KEY_RESULT, key_result->data[7]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 8, NATC_ENG, KEY_RESULT, key_result->data[8]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 9, NATC_ENG, KEY_RESULT, key_result->data[9]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 10, NATC_ENG, KEY_RESULT, key_result->data[10]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 11, NATC_ENG, KEY_RESULT, key_result->data[11]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 12, NATC_ENG, KEY_RESULT, key_result->data[12]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 13, NATC_ENG, KEY_RESULT, key_result->data[13]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 14, NATC_ENG, KEY_RESULT, key_result->data[14]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 15, NATC_ENG, KEY_RESULT, key_result->data[15]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 16, NATC_ENG, KEY_RESULT, key_result->data[16]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 17, NATC_ENG, KEY_RESULT, key_result->data[17]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 18, NATC_ENG, KEY_RESULT, key_result->data[18]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 19, NATC_ENG, KEY_RESULT, key_result->data[19]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 20, NATC_ENG, KEY_RESULT, key_result->data[20]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 21, NATC_ENG, KEY_RESULT, key_result->data[21]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 22, NATC_ENG, KEY_RESULT, key_result->data[22]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 23, NATC_ENG, KEY_RESULT, key_result->data[23]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 24, NATC_ENG, KEY_RESULT, key_result->data[24]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 25, NATC_ENG, KEY_RESULT, key_result->data[25]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 26, NATC_ENG, KEY_RESULT, key_result->data[26]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 27, NATC_ENG, KEY_RESULT, key_result->data[27]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 28, NATC_ENG, KEY_RESULT, key_result->data[28]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 29, NATC_ENG, KEY_RESULT, key_result->data[29]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 30, NATC_ENG, KEY_RESULT, key_result->data[30]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 31, NATC_ENG, KEY_RESULT, key_result->data[31]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 32, NATC_ENG, KEY_RESULT, key_result->data[32]);
    RU_REG_RAM_READ(eng_idx, zero *34 + 33, NATC_ENG, KEY_RESULT, key_result->data[33]);
...
static int bcm_natc_eng_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        natc_eng_command_status command_status = { .del_cmd_ddr_bin=parm[2].value.unumber, .del_cmd_mode=parm[3].value.unumber, .cache_flush=parm[4].value.unumber, .decr_count=parm[5].value.unumber, .nat_tbl=parm[6].value.unumber, .multihash_count=parm[7].value.unumber, .cache_hit=parm[8].value.unumber, .miss=parm[9].value.unumber, .error=parm[10].value.unumber, .busy=parm[11].value.unumber, .unused0=parm[12].value.unumber, .command=parm[13].value.unumber};
    ...
    {
        natc_eng_key_result key_result = { .data = { parm[3].value.unumber, parm[4].value.unumber, parm[5].value.unumber, parm[6].value.unumber, parm[7].value.unumber, parm[8].value.unumber, parm[9].value.unumber, parm[10].value.unumber, parm[11].value.unumber, parm[12].value.unumber, parm[13].value.unumber, parm[14].value.unumber, parm[15].value.unumber, parm[16].value.unumber, parm[17].value.unumber, parm[18].value.unumber, parm[19].value.unumber, parm[20].value.unumber, parm[21].value.unumber, parm[22].value.unumber, parm[23].value.unumber, parm[24].value.unumber, parm[25].value.unumber, parm[26].value.unumber, parm[27].value.unumber, parm[28].value.unumber, parm[29].value.unumber, parm[30].value.unumber, parm[31].value.unumber, parm[32].value.unumber, parm[33].value.unumber, parm[34].value.unumber, parm[35].value.unumber, parm[36].value.unumber}};
...
static int bcm_natc_eng_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        natc_eng_command_status command_status = {.del_cmd_ddr_bin=gtmv(m, 8), .del_cmd_mode=gtmv(m, 1), .cache_flush=gtmv(m, 1), .decr_count=gtmv(m, 1), .nat_tbl=gtmv(m, 3), .multihash_count=gtmv(m, 4), .cache_hit=gtmv(m, 1), .miss=gtmv(m, 1), .error=gtmv(m, 1), .busy=gtmv(m, 1), .unused0=gtmv(m, 1), .command=gtmv(m, 3)};
        if(!err) bdmf_session_print(session, "ag_drv_natc_eng_command_status_set(%u %u %u %u %u %u %u %u %u %u %u %u %u)\n", eng_idx, command_status.del_cmd_ddr_bin, command_status.del_cmd_mode, command_status.cache_flush, command_status.decr_count, command_status.nat_tbl, command_status.multihash_count, command_status.cache_hit, command_status.miss, command_status.error, command_status.busy, command_status.unused0, command_status.command);
        ...
        if(!err) bdmf_session_print(session, "ag_drv_natc_eng_command_status_get(%u %u %u %u %u %u %u %u %u %u %u %u %u)\n", eng_idx, command_status.del_cmd_ddr_bin, command_status.del_cmd_mode, command_status.cache_flush, command_status.decr_count, command_status.nat_tbl, command_status.multihash_count, command_status.cache_hit, command_status.miss, command_status.error, command_status.busy, command_status.unused0, command_status.command);
        if(err || command_status.del_cmd_ddr_bin!=gtmv(m, 8) || command_status.del_cmd_mode!=gtmv(m, 1) || command_status.cache_flush!=gtmv(m, 1) || command_status.decr_count!=gtmv(m, 1) || command_status.nat_tbl!=gtmv(m, 3) || command_status.multihash_count!=gtmv(m, 4) || command_status.cache_hit!=gtmv(m, 1) || command_status.miss!=gtmv(m, 1) || command_status.error!=gtmv(m, 1) || command_status.busy!=gtmv(m, 1) || command_status.unused0!=gtmv(m, 1) || command_status.command!=gtmv(m, 3))
    ...
    }
    {
        ...
        natc_eng_key_result key_result = {.data={gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32)}};
        if(!err) bdmf_session_print(session, "ag_drv_natc_eng_key_result_set(%u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", eng_idx, zero, key_result.data[0], key_result.data[1], key_result.data[2], key_result.data[3], key_result.data[4], key_result.data[5], key_result.data[6], key_result.data[7], key_result.data[8], key_result.data[9], key_result.data[10], key_result.data[11], key_result.data[12], key_result.data[13], key_result.data[14], key_result.data[15], key_result.data[16], key_result.data[17], key_result.data[18], key_result.data[19], key_result.data[20], key_result.data[21], key_result.data[22], key_result.data[23], key_result.data[24], key_result.data[25], key_result.data[26], key_result.data[27], key_result.data[28], key_result.data[29], key_result.data[30], key_result.data[31], key_result.data[32], key_result.data[33]);
        ...
        if(!err) bdmf_session_print(session, "ag_drv_natc_eng_key_result_get(%u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", eng_idx, zero, key_result.data[0], key_result.data[1], key_result.data[2], key_result.data[3], key_result.data[4], key_result.data[5], key_result.data[6], key_result.data[7], key_result.data[8], key_result.data[9], key_result.data[10], key_result.data[11], key_result.data[12], key_result.data[13], key_result.data[14], key_result.data[15], key_result.data[16], key_result.data[17], key_result.data[18], key_result.data[19], key_result.data[20], key_result.data[21], key_result.data[22], key_result.data[23], key_result.data[24], key_result.data[25], key_result.data[26], key_result.data[27], key_result.data[28], key_result.data[29], key_result.data[30], key_result.data[31], key_result.data[32], key_result.data[33]);
        if(err || key_result.data[0]!=gtmv(m, 32) || key_result.data[1]!=gtmv(m, 32) || key_result.data[2]!=gtmv(m, 32) || key_result.data[3]!=gtmv(m, 32) || key_result.data[4]!=gtmv(m, 32) || key_result.data[5]!=gtmv(m, 32) || key_result.data[6]!=gtmv(m, 32) || key_result.data[7]!=gtmv(m, 32) || key_result.data[8]!=gtmv(m, 32) || key_result.data[9]!=gtmv(m, 32) || key_result.data[10]!=gtmv(m, 32) || key_result.data[11]!=gtmv(m, 32) || key_result.data[12]!=gtmv(m, 32) || key_result.data[13]!=gtmv(m, 32) || key_result.data[14]!=gtmv(m, 32) || key_result.data[15]!=gtmv(m, 32) || key_result.data[16]!=gtmv(m, 32) || key_result.data[17]!=gtmv(m, 32) || key_result.data[18]!=gtmv(m, 32) || key_result.data[19]!=gtmv(m, 32) || key_result.data[20]!=gtmv(m, 32) || key_result.data[21]!=gtmv(m, 32) || key_result.data[22]!=gtmv(m, 32) || key_result.data[23]!=gtmv(m, 32) || key_result.data[24]!=gtmv(m, 32) || key_result.data[25]!=gtmv(m, 32) || key_result.data[26]!=gtmv(m, 32) || key_result.data[27]!=gtmv(m, 32) || key_result.data[28]!=gtmv(m, 32) || key_result.data[29]!=gtmv(m, 32) || key_result.data[30]!=gtmv(m, 32) || key_result.data[31]!=gtmv(m, 32) || key_result.data[32]!=gtmv(m, 32) || key_result.data[33]!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    return err;
}
