...
enum
{
    ...
    cli_qm_bbh_tx_qm_bbhtx_common_configurations_perqtask,
    ...
    cli_qm_bbh_tx_qm_bbhtx_debug_counters_unifiedpkt,
    cli_qm_bbh_tx_qm_bbhtx_debug_counters_unifiedbyte,
