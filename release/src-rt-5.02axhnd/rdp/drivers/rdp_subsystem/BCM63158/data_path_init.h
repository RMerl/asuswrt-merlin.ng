...
#define BBH_RX_TOTAL_BUFFER_NUM  48
#define BBH_TX_TOTAL_BUFFER_NUM  64
#define NUM_OF_DMA 1
#define NUM_OF_SDMA 2
#define NUM_OF_UNIMAC 3
#define RNR0 0
#define RNR1 1
...
#define BBH_TX_AE10_LAN_DDR_THRESHOLD 0x100 /* 256*8 = 2048 Bytes */
#define BBH_TX_AE10_LAN_SRAM_THRESHOLD 0x40 /* 64*8  = 512 Bytes */
