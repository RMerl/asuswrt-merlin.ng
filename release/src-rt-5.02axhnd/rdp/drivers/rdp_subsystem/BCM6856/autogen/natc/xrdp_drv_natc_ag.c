...
bdmf_error_t ag_drv_natc_ctrl_status_set(const natc_ctrl_status *ctrl_status)
{
    ...
    if((ctrl_status->ddr_enable >= _1BITS_MAX_VAL_) ||
       ...
       (ctrl_status->unused2 >= _3BITS_MAX_VAL_) ||
       ...
       (ctrl_status->unused20 >= _1BITS_MAX_VAL_) ||
    ...
    reg_control_status2 = RU_FIELD_SET(0, NATC, CONTROL_STATUS2, UNUSED20, reg_control_status2, ctrl_status->unused20);
...
bdmf_error_t ag_drv_natc_ctrl_status_get(natc_ctrl_status *ctrl_status)
{
    ...
    ctrl_status->unused20 = RU_FIELD_GET(0, NATC, CONTROL_STATUS2, UNUSED20, reg_control_status2);
...
static int bcm_natc_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        natc_ctrl_status ctrl_status = { .ddr_enable=parm[1].value.unumber, .natc_add_command_speedup_mode=parm[2].value.unumber, .unused4=parm[3].value.unumber, .ddr_64bit_in_128bit_swap_control=parm[4].value.unumber, .smem_32bit_in_64bit_swap_control=parm[5].value.unumber, .smem_8bit_in_32bit_swap_control=parm[6].value.unumber, .ddr_swap_all_control=parm[7].value.unumber, .unused3=parm[8].value.unumber, .reg_32bit_in_64bit_swap_control=parm[9].value.unumber, .reg_8bit_in_32bit_swap_control=parm[10].value.unumber, .unused2=parm[11].value.unumber, .pending_fifo_entry_check_enable=parm[12].value.unumber, .cache_update_on_ddr_miss=parm[13].value.unumber, .ddr_disable_on_reg_lookup=parm[14].value.unumber, .regfile_fifo_reset=parm[15].value.unumber, .nat_hash_mode=parm[16].value.unumber, .multi_hash_limit=parm[17].value.unumber, .decr_count_wraparound_enable=parm[18].value.unumber, .nat_arb_st=parm[19].value.unumber, .natc_smem_increment_on_reg_lookup=parm[20].value.unumber, .natc_smem_clear_by_update_disable=parm[21].value.unumber, .natc_smem_disable=parm[22].value.unumber, .natc_enable=parm[23].value.unumber, .natc_reset=parm[24].value.unumber, .ddr_hash_swap=parm[25].value.unumber, .ddr_hash_mode=parm[26].value.unumber, .ddr_32bit_in_64bit_swap_control=parm[27].value.unumber, .ddr_8bit_in_32bit_swap_control=parm[28].value.unumber, .cache_lookup_blocking_mode=parm[29].value.unumber, .age_timer_tick=parm[30].value.unumber, .age_timer=parm[31].value.unumber, .cache_algo=parm[32].value.unumber, .unused1=parm[33].value.unumber, .unused0=parm[34].value.unumber, .cache_update_on_reg_ddr_lookup=parm[35].value.unumber, .ddr_counter_8bit_in_32bit_swap_control=parm[36].value.unumber, .unused20=parm[37].value.unumber, .ddr_replace_duplicated_cached_entry_enable=parm[38].value.unumber, .ddr_lookup_pending_fifo_mode_disable=parm[39].value.unumber, .eviction_disable=parm[40].value.unumber};
...
int bcm_natc_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_natc_ctrl_status:
    {
        ...
        bdmf_session_print(session, "unused20 = %u (0x%x)\n", ctrl_status.unused20, ctrl_status.unused20);
...
bdmfmon_handle_t ag_drv_natc_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        static bdmfmon_cmd_parm_t set_ctrl_status[]={
            ...
            BDMFMON_MAKE_PARM("unused20", "unused20", BDMFMON_PARM_NUMBER, 0),
