...
bdmf_error_t ag_drv_natc_cfg_key_addr_set(uint8_t tbl_idx, uint32_t key_lo, uint8_t key_hi)
{
    ...
    RU_REG_READ(tbl_idx, NATC_CFG, DDR_KEY_BASE_ADDRESS_LOWER, reg_ddr_key_base_address_lower);
    RU_REG_READ(tbl_idx, NATC_CFG, DDR_KEY_BASE_ADDRESS_UPPER, reg_ddr_key_base_address_upper);

    reg_ddr_key_base_address_lower = RU_FIELD_SET(tbl_idx, NATC_CFG, DDR_KEY_BASE_ADDRESS_LOWER, BAR, reg_ddr_key_base_address_lower, key_lo);
    reg_ddr_key_base_address_upper = RU_FIELD_SET(tbl_idx, NATC_CFG, DDR_KEY_BASE_ADDRESS_UPPER, BAR, reg_ddr_key_base_address_upper, key_hi);

    RU_REG_WRITE(tbl_idx, NATC_CFG, DDR_KEY_BASE_ADDRESS_LOWER, reg_ddr_key_base_address_lower);
    RU_REG_WRITE(tbl_idx, NATC_CFG, DDR_KEY_BASE_ADDRESS_UPPER, reg_ddr_key_base_address_upper);
...
bdmf_error_t ag_drv_natc_cfg_key_addr_get(uint8_t tbl_idx, uint32_t *key_lo, uint8_t *key_hi)
{
    ...
    *key_lo = RU_FIELD_GET(tbl_idx, NATC_CFG, DDR_KEY_BASE_ADDRESS_LOWER, BAR, reg_ddr_key_base_address_lower);
    *key_hi = RU_FIELD_GET(tbl_idx, NATC_CFG, DDR_KEY_BASE_ADDRESS_UPPER, BAR, reg_ddr_key_base_address_upper);
...
bdmf_error_t ag_drv_natc_cfg_res_addr_set(uint8_t tbl_idx, uint32_t res_lo, uint8_t res_hi)
{
    ...
    RU_REG_READ(tbl_idx, NATC_CFG, DDR_RESULT_BASE_ADDRESS_LOWER, reg_ddr_result_base_address_lower);
    RU_REG_READ(tbl_idx, NATC_CFG, DDR_RESULT_BASE_ADDRESS_UPPER, reg_ddr_result_base_address_upper);

    reg_ddr_result_base_address_lower = RU_FIELD_SET(tbl_idx, NATC_CFG, DDR_RESULT_BASE_ADDRESS_LOWER, BAR, reg_ddr_result_base_address_lower, res_lo);
    reg_ddr_result_base_address_upper = RU_FIELD_SET(tbl_idx, NATC_CFG, DDR_RESULT_BASE_ADDRESS_UPPER, BAR, reg_ddr_result_base_address_upper, res_hi);

    RU_REG_WRITE(tbl_idx, NATC_CFG, DDR_RESULT_BASE_ADDRESS_LOWER, reg_ddr_result_base_address_lower);
    RU_REG_WRITE(tbl_idx, NATC_CFG, DDR_RESULT_BASE_ADDRESS_UPPER, reg_ddr_result_base_address_upper);
...
bdmf_error_t ag_drv_natc_cfg_res_addr_get(uint8_t tbl_idx, uint32_t *res_lo, uint8_t *res_hi)
{
    ...
    *res_lo = RU_FIELD_GET(tbl_idx, NATC_CFG, DDR_RESULT_BASE_ADDRESS_LOWER, BAR, reg_ddr_result_base_address_lower);
    *res_hi = RU_FIELD_GET(tbl_idx, NATC_CFG, DDR_RESULT_BASE_ADDRESS_UPPER, BAR, reg_ddr_result_base_address_upper);
...
static int bcm_natc_cfg_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    switch (parm[0].value.unumber)
    {
    case bdmf_address_ddr_key_base_address_lower : reg = &RU_REG(NATC_CFG, DDR_KEY_BASE_ADDRESS_LOWER); blk = &RU_BLK(NATC_CFG); break;
    case bdmf_address_ddr_key_base_address_upper : reg = &RU_REG(NATC_CFG, DDR_KEY_BASE_ADDRESS_UPPER); blk = &RU_BLK(NATC_CFG); break;
    case bdmf_address_ddr_result_base_address_lower : reg = &RU_REG(NATC_CFG, DDR_RESULT_BASE_ADDRESS_LOWER); blk = &RU_BLK(NATC_CFG); break;
    case bdmf_address_ddr_result_base_address_upper : reg = &RU_REG(NATC_CFG, DDR_RESULT_BASE_ADDRESS_UPPER); blk = &RU_BLK(NATC_CFG); break;
    default :
