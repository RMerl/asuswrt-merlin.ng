...
#if RU_INCLUDE_DESC
    "",
    "Illegal token request interrupt. This will be active when index memory is fully "
    "allocated and there is a request for new token. Along with interrupt being sent "
...
const ru_field_rec FPM_POOL1_INTR_STS_MULTI_TOKEN_INDEX_OUT_OF_RANGE_STS_FIELD =
{
    ...
    "This is determined by checking the pool select field (bits[29:28]) in the incoming "
    "multi-cast token is greater than zero. There is no associated count for this error. \n",
#endif
...
const ru_field_rec FPM_POOL1_INTR_STS_MULTI_TOKEN_NO_VALID_STS_FIELD =
{
    ...
    "2. Incoming multi-cast request token has pool select field (bit[29:28) is not equal to 2'b00 \n"
    "3. Incoming multi-cast request token has use count field (bit[3:0]) set to zero \n"
    "4. Incoming multi-cast request update type (bit[11]) is set to \"increment type\" and use count "
    "field (bit[6:0]) is set to 0xF \n"
    "5. Incoming multi-cast request token entry in the usage array indicates it is not an allocated "
    "token, i.e., associated use count value for this count in the usage array is zero \n"
    "6. After updating the use count value, the new use count value exceeds 0xF \n",
#endif
...
const ru_field_rec FPM_POOL1_INTR_STS_FREE_TOKEN_INDEX_OUT_OF_RANGE_STS_FIELD =
{
    ...
    "This is determined by checking the pool select field (bits[29:28]) in the incoming free token "
    "is greater than zero. There is no associated count for this error. \n",
#endif
...
const ru_field_rec FPM_POOL1_INTR_STS_FREE_TOKEN_NO_VALID_STS_FIELD =
{
    ...
    "2. Incoming free request token has pool select field (bit[29:28) is not equal to 2'b00 \n"
...
/******************************************************************************
 * Field: FPM_POOL1_CFG1_FPM_BUF_SIZE
 ******************************************************************************/
const ru_field_rec FPM_POOL1_CFG1_FPM_BUF_SIZE_FIELD =
{
    "FPM_BUF_SIZE",
#if RU_INCLUDE_DESC
    "",
...
#endif
    FPM_POOL1_CFG1_FPM_BUF_SIZE_FIELD_MASK,
    0,
    FPM_POOL1_CFG1_FPM_BUF_SIZE_FIELD_WIDTH,
    FPM_POOL1_CFG1_FPM_BUF_SIZE_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
const ru_field_rec FPM_POOL1_STAT7_INVALID_MCAST_TOKEN_FIELD =
{
    ...
    "Bit[29:12] - Token \n"
    "Bit[11:5]  - Reserved \n"
    "Bit[4]     - Mcast update type (refer to register 0x214[4]) \n"
    "Bit[3:0]   - Mcast value \n",
#endif
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_HIGH_RESERVED0
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_HIGH_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    FPM_SEARCH_MEMORY_HIGH_RESERVED0_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_HIGH_RESERVED0_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_HIGH_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_HIGH_SEARCHDATA15
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_HIGH_SEARCHDATA15_FIELD =
{
    "SEARCHDATA15",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA15_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA15_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA15_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_HIGH_SEARCHDATA14
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_HIGH_SEARCHDATA14_FIELD =
{
    "SEARCHDATA14",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA14_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA14_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA14_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_HIGH_SEARCHDATA13
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_HIGH_SEARCHDATA13_FIELD =
{
    "SEARCHDATA13",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA13_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA13_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA13_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_HIGH_SEARCHDATA12
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_HIGH_SEARCHDATA12_FIELD =
{
    "SEARCHDATA12",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA12_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA12_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA12_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_HIGH_SEARCHDATA11
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_HIGH_SEARCHDATA11_FIELD =
{
    "SEARCHDATA11",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA11_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA11_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA11_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_HIGH_SEARCHDATA10
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_HIGH_SEARCHDATA10_FIELD =
{
    "SEARCHDATA10",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA10_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA10_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_HIGH_SEARCHDATA10_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_LOW_SEARCHDATA10
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_LOW_SEARCHDATA10_FIELD =
{
    "SEARCHDATA10",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA10_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA10_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA10_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_LOW_SEARCHDATA9
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_LOW_SEARCHDATA9_FIELD =
{
    "SEARCHDATA9",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA9_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA9_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA9_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_LOW_SEARCHDATA8
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_LOW_SEARCHDATA8_FIELD =
{
    "SEARCHDATA8",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA8_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA8_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA8_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_LOW_SEARCHDATA7
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_LOW_SEARCHDATA7_FIELD =
{
    "SEARCHDATA7",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA7_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA7_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA7_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_LOW_SEARCHDATA6
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_LOW_SEARCHDATA6_FIELD =
{
    "SEARCHDATA6",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA6_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA6_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA6_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_LOW_SEARCHDATA5
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_LOW_SEARCHDATA5_FIELD =
{
    "SEARCHDATA5",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA5_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA5_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA5_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_LOW_SEARCHDATA4
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_LOW_SEARCHDATA4_FIELD =
{
    "SEARCHDATA4",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA4_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA4_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA4_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_LOW_SEARCHDATA3
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_LOW_SEARCHDATA3_FIELD =
{
    "SEARCHDATA3",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA3_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA3_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA3_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_LOW_SEARCHDATA2
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_LOW_SEARCHDATA2_FIELD =
{
    "SEARCHDATA2",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA2_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA2_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA2_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_LOW_SEARCHDATA1
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_LOW_SEARCHDATA1_FIELD =
{
    "SEARCHDATA1",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA1_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA1_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA1_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_SEARCH_MEMORY_LOW_SEARCHDATA0
 ******************************************************************************/
const ru_field_rec FPM_SEARCH_MEMORY_LOW_SEARCHDATA0_FIELD =
{
    "SEARCHDATA0",
#if RU_INCLUDE_DESC
    "",
    "Search Tree",
#endif
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA0_FIELD_MASK,
    0,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA0_FIELD_WIDTH,
    FPM_SEARCH_MEMORY_LOW_SEARCHDATA0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_HIGH_TOKENMARK7
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_HIGH_TOKENMARK7_FIELD =
{
    "TOKENMARK7",
#if RU_INCLUDE_DESC
    "",
    "Token Aging Mark 7",
#endif
    FPM_MCAST_MEMORY_HIGH_TOKENMARK7_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_HIGH_TOKENMARK7_FIELD_WIDTH,
    FPM_MCAST_MEMORY_HIGH_TOKENMARK7_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_HIGH_MULTICAST7
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_HIGH_MULTICAST7_FIELD =
{
    "MULTICAST7",
#if RU_INCLUDE_DESC
    "",
    "Multicast Value 7",
#endif
    FPM_MCAST_MEMORY_HIGH_MULTICAST7_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_HIGH_MULTICAST7_FIELD_WIDTH,
    FPM_MCAST_MEMORY_HIGH_MULTICAST7_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_HIGH_TOKENMARK6
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_HIGH_TOKENMARK6_FIELD =
{
    "TOKENMARK6",
#if RU_INCLUDE_DESC
    "",
    "Token Aging Mark 6",
#endif
    FPM_MCAST_MEMORY_HIGH_TOKENMARK6_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_HIGH_TOKENMARK6_FIELD_WIDTH,
    FPM_MCAST_MEMORY_HIGH_TOKENMARK6_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_HIGH_MULTICAST6
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_HIGH_MULTICAST6_FIELD =
{
    "MULTICAST6",
#if RU_INCLUDE_DESC
    "",
    "Multicast Value 6",
#endif
    FPM_MCAST_MEMORY_HIGH_MULTICAST6_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_HIGH_MULTICAST6_FIELD_WIDTH,
    FPM_MCAST_MEMORY_HIGH_MULTICAST6_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_HIGH_TOKENMARK5
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_HIGH_TOKENMARK5_FIELD =
{
    "TOKENMARK5",
#if RU_INCLUDE_DESC
    "",
    "Token Aging Mark 5",
#endif
    FPM_MCAST_MEMORY_HIGH_TOKENMARK5_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_HIGH_TOKENMARK5_FIELD_WIDTH,
    FPM_MCAST_MEMORY_HIGH_TOKENMARK5_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_HIGH_MULTICAST5
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_HIGH_MULTICAST5_FIELD =
{
    "MULTICAST5",
#if RU_INCLUDE_DESC
    "",
    "Multicast Value 5",
#endif
    FPM_MCAST_MEMORY_HIGH_MULTICAST5_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_HIGH_MULTICAST5_FIELD_WIDTH,
    FPM_MCAST_MEMORY_HIGH_MULTICAST5_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_HIGH_TOKENMARK4
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_HIGH_TOKENMARK4_FIELD =
{
    "TOKENMARK4",
#if RU_INCLUDE_DESC
    "",
    "Token Aging Mark 4",
#endif
    FPM_MCAST_MEMORY_HIGH_TOKENMARK4_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_HIGH_TOKENMARK4_FIELD_WIDTH,
    FPM_MCAST_MEMORY_HIGH_TOKENMARK4_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_HIGH_MULTICAST4
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_HIGH_MULTICAST4_FIELD =
{
    "MULTICAST4",
#if RU_INCLUDE_DESC
    "",
    "Multicast Value 4",
#endif
    FPM_MCAST_MEMORY_HIGH_MULTICAST4_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_HIGH_MULTICAST4_FIELD_WIDTH,
    FPM_MCAST_MEMORY_HIGH_MULTICAST4_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_LOW_TOKENMARK3
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_LOW_TOKENMARK3_FIELD =
{
    "TOKENMARK3",
#if RU_INCLUDE_DESC
    "",
    "Token Aging Mark 3",
#endif
    FPM_MCAST_MEMORY_LOW_TOKENMARK3_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_LOW_TOKENMARK3_FIELD_WIDTH,
    FPM_MCAST_MEMORY_LOW_TOKENMARK3_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_LOW_MULTICAST3
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_LOW_MULTICAST3_FIELD =
{
    "MULTICAST3",
#if RU_INCLUDE_DESC
    "",
    "Multicast Value 3",
#endif
    FPM_MCAST_MEMORY_LOW_MULTICAST3_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_LOW_MULTICAST3_FIELD_WIDTH,
    FPM_MCAST_MEMORY_LOW_MULTICAST3_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_LOW_TOKENMARK2
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_LOW_TOKENMARK2_FIELD =
{
    "TOKENMARK2",
#if RU_INCLUDE_DESC
    "",
    "Token Aging Mark 2",
#endif
    FPM_MCAST_MEMORY_LOW_TOKENMARK2_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_LOW_TOKENMARK2_FIELD_WIDTH,
    FPM_MCAST_MEMORY_LOW_TOKENMARK2_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_LOW_MULTICAST2
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_LOW_MULTICAST2_FIELD =
{
    "MULTICAST2",
#if RU_INCLUDE_DESC
    "",
    "Multicast Value 2",
#endif
    FPM_MCAST_MEMORY_LOW_MULTICAST2_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_LOW_MULTICAST2_FIELD_WIDTH,
    FPM_MCAST_MEMORY_LOW_MULTICAST2_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_LOW_TOKENMARK1
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_LOW_TOKENMARK1_FIELD =
{
    "TOKENMARK1",
#if RU_INCLUDE_DESC
    "",
    "Token Aging Mark 1",
#endif
    FPM_MCAST_MEMORY_LOW_TOKENMARK1_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_LOW_TOKENMARK1_FIELD_WIDTH,
    FPM_MCAST_MEMORY_LOW_TOKENMARK1_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_LOW_MULTICAST1
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_LOW_MULTICAST1_FIELD =
{
    "MULTICAST1",
#if RU_INCLUDE_DESC
    "",
    "Multicast Value 1",
#endif
    FPM_MCAST_MEMORY_LOW_MULTICAST1_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_LOW_MULTICAST1_FIELD_WIDTH,
    FPM_MCAST_MEMORY_LOW_MULTICAST1_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_LOW_TOKENMARK0
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_LOW_TOKENMARK0_FIELD =
{
    "TOKENMARK0",
#if RU_INCLUDE_DESC
    "",
    "Token Aging Mark 0",
#endif
    FPM_MCAST_MEMORY_LOW_TOKENMARK0_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_LOW_TOKENMARK0_FIELD_WIDTH,
    FPM_MCAST_MEMORY_LOW_TOKENMARK0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: FPM_MCAST_MEMORY_LOW_MULTICAST0
 ******************************************************************************/
const ru_field_rec FPM_MCAST_MEMORY_LOW_MULTICAST0_FIELD =
{
    "MULTICAST0",
#if RU_INCLUDE_DESC
    "",
    "Multicast Value 0",
#endif
    FPM_MCAST_MEMORY_LOW_MULTICAST0_FIELD_MASK,
    0,
    FPM_MCAST_MEMORY_LOW_MULTICAST0_FIELD_WIDTH,
    FPM_MCAST_MEMORY_LOW_MULTICAST0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
static const ru_field_rec *FPM_POOL1_CFG1_FIELDS[] =
{
    ...
    &FPM_POOL1_CFG1_FPM_BUF_SIZE_FIELD,
...
/******************************************************************************
 * Register: FPM_SEARCH_MEMORY_HIGH
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *FPM_SEARCH_MEMORY_HIGH_FIELDS[] =
{
    &FPM_SEARCH_MEMORY_HIGH_RESERVED0_FIELD,
    &FPM_SEARCH_MEMORY_HIGH_SEARCHDATA15_FIELD,
    &FPM_SEARCH_MEMORY_HIGH_SEARCHDATA14_FIELD,
    &FPM_SEARCH_MEMORY_HIGH_SEARCHDATA13_FIELD,
    &FPM_SEARCH_MEMORY_HIGH_SEARCHDATA12_FIELD,
...
const ru_reg_rec FPM_SEARCH_MEMORY_HIGH_REG = 
{
    "SEARCH_MEMORY_HIGH",
#if RU_INCLUDE_DESC
    "SEARCH_MEMORY_ENTRY_HIGH Register",
...
#endif
    FPM_SEARCH_MEMORY_HIGH_REG_OFFSET,
    FPM_SEARCH_MEMORY_HIGH_REG_RAM_CNT,
    8,
    449,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
...
#if RU_INCLUDE_FIELD_DB
    7,
    FPM_SEARCH_MEMORY_HIGH_FIELDS
#endif /* RU_INCLUDE_FIELD_DB */
};

/******************************************************************************
 * Register: FPM_SEARCH_MEMORY_LOW
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *FPM_SEARCH_MEMORY_LOW_FIELDS[] =
{
    &FPM_SEARCH_MEMORY_LOW_SEARCHDATA10_FIELD,
    &FPM_SEARCH_MEMORY_LOW_SEARCHDATA9_FIELD,
    &FPM_SEARCH_MEMORY_LOW_SEARCHDATA8_FIELD,
    &FPM_SEARCH_MEMORY_LOW_SEARCHDATA7_FIELD,
    &FPM_SEARCH_MEMORY_LOW_SEARCHDATA6_FIELD,
    &FPM_SEARCH_MEMORY_LOW_SEARCHDATA5_FIELD,
    &FPM_SEARCH_MEMORY_LOW_SEARCHDATA4_FIELD,
    &FPM_SEARCH_MEMORY_LOW_SEARCHDATA3_FIELD,
    &FPM_SEARCH_MEMORY_LOW_SEARCHDATA2_FIELD,
    &FPM_SEARCH_MEMORY_LOW_SEARCHDATA1_FIELD,
    &FPM_SEARCH_MEMORY_LOW_SEARCHDATA0_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec FPM_SEARCH_MEMORY_LOW_REG = 
{
    "SEARCH_MEMORY_LOW",
#if RU_INCLUDE_DESC
    "SEARCH_MEMORY_ENTRY_LOW Register",
    "Search Tree Branch Status Values ( Index 15 )\n"
    "3'b111 = No tokens available\n"
    "3'b011 = 256byte tokens available\n"
    "3'b010 = 512byte tokens or smaller available\n"
    ...
    "3'b000 = 2Kbyte tokens or smaller available\n",
#endif
    FPM_SEARCH_MEMORY_LOW_REG_OFFSET,
    FPM_SEARCH_MEMORY_LOW_REG_RAM_CNT,
    8,
    450,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
...
#if RU_INCLUDE_FIELD_DB
    11,
    FPM_SEARCH_MEMORY_LOW_FIELDS
#endif /* RU_INCLUDE_FIELD_DB */
};

/******************************************************************************
 * Register: FPM_MCAST_MEMORY_HIGH
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *FPM_MCAST_MEMORY_HIGH_FIELDS[] =
{
    &FPM_MCAST_MEMORY_HIGH_TOKENMARK7_FIELD,
    &FPM_MCAST_MEMORY_HIGH_MULTICAST7_FIELD,
    &FPM_MCAST_MEMORY_HIGH_TOKENMARK6_FIELD,
    &FPM_MCAST_MEMORY_HIGH_MULTICAST6_FIELD,
    &FPM_MCAST_MEMORY_HIGH_TOKENMARK5_FIELD,
    &FPM_MCAST_MEMORY_HIGH_MULTICAST5_FIELD,
    &FPM_MCAST_MEMORY_HIGH_TOKENMARK4_FIELD,
    &FPM_MCAST_MEMORY_HIGH_MULTICAST4_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec FPM_MCAST_MEMORY_HIGH_REG = 
{
    "MCAST_MEMORY_HIGH",
#if RU_INCLUDE_DESC
    "MCAST_MEMORY_ENTRY_HIGH Register",
    " ",
#endif
    FPM_MCAST_MEMORY_HIGH_REG_OFFSET,
    FPM_MCAST_MEMORY_HIGH_REG_RAM_CNT,
    8,
    451,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
...
#if RU_INCLUDE_FIELD_DB
    8,
    FPM_MCAST_MEMORY_HIGH_FIELDS
#endif /* RU_INCLUDE_FIELD_DB */
};

/******************************************************************************
 * Register: FPM_MCAST_MEMORY_LOW
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *FPM_MCAST_MEMORY_LOW_FIELDS[] =
{
    &FPM_MCAST_MEMORY_LOW_TOKENMARK3_FIELD,
    &FPM_MCAST_MEMORY_LOW_MULTICAST3_FIELD,
    &FPM_MCAST_MEMORY_LOW_TOKENMARK2_FIELD,
    &FPM_MCAST_MEMORY_LOW_MULTICAST2_FIELD,
    &FPM_MCAST_MEMORY_LOW_TOKENMARK1_FIELD,
    &FPM_MCAST_MEMORY_LOW_MULTICAST1_FIELD,
    &FPM_MCAST_MEMORY_LOW_TOKENMARK0_FIELD,
    &FPM_MCAST_MEMORY_LOW_MULTICAST0_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec FPM_MCAST_MEMORY_LOW_REG = 
{
    "MCAST_MEMORY_LOW",
#if RU_INCLUDE_DESC
    "MCAST_MEMORY_ENTRY_LOW Register",
    " ",
#endif
    FPM_MCAST_MEMORY_LOW_REG_OFFSET,
    FPM_MCAST_MEMORY_LOW_REG_RAM_CNT,
    8,
    452,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
...
static const ru_reg_rec *FPM_REGS[] =
{
    ...
    &FPM_SPARE_REG,
    &FPM_POOL_MULTI_REG,
    &FPM_SEARCH_MEMORY_HIGH_REG,
    &FPM_SEARCH_MEMORY_LOW_REG,
    &FPM_MCAST_MEMORY_HIGH_REG,
    &FPM_MCAST_MEMORY_LOW_REG,
