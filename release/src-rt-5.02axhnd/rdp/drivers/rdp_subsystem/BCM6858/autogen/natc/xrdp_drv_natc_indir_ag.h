...
/*        by {nat_ddr_bin, nat_tbl}then followed by a write to Indirect Address Register to set u */
/*       pNAT Cache Entry Number and W_R bit to 1, this will initiate the write operation.------- */
/*       -------------------------------------------------For NAT Cache Memory and statics Memory */
/*        read operation,first, write to Indirect Address Register to set upNAT Cache Entry Numbe */
/*       r and W_R bit to 0, this will initiate the read operation.the read data from NAT Cache M */
/*       emory and statics Memory will be loaded into Indirect Data Registers[N-1:0].then followe */
/*       d by read from Indirect Data Registers[N-1:0] for all data.                              */
/**************************************************************************************************/
typedef struct
{
    uint32_t data[21];
