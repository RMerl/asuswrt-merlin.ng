...
#define MGET_16(a)              (read16(a))
#define MGET_32(a)              (read32(a))
...
#else
#define MWRITE_16(a, r)       (write16(a, swap2bytes((uint16_t)(r)), 0))
#endif
#if !defined(BCM6858) && !defined(BCM6856)
#define MWRITE_32(a, r)       (write32(a, swap4bytes((uint32_t)(r)), 0))
#else
#define MWRITE_32(a, r)       (write32(a, r, 0))
#endif

#define MGET_I_8(a, i)         ((i) = read8((uint32_t)a + i))
#define MGET_I_16(a, i)         ((i) = read16((uint32_t)a + 2*i))
#define MGET_I_32(a, i)         ((i) = read32((uint32_t)a + 4*i))
