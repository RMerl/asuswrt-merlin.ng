...
int drv_dis_reor_cli_viq_cfg_get(bdmf_session_handle session, bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    bdmf_session_print(session, "------------------------------------------------------------------------------\n\r");
    bdmf_session_print(session, "queue | cmmn | grntd | crdt |egress|   cong ingress     |   cong egress      |\n\r");
    bdmf_session_print(session, "      | max  | max   | cntr | cntr | frst | scnd | hyst | frst | scnd | hyst |\n\r");
    bdmf_session_print(session, "------------------------------------------------------------------------------\n\r");
