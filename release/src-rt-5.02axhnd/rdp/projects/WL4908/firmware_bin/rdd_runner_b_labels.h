...
#define runner_b_start_task_timer_scheduler_set		(0x2D20)
#define runner_b_timer_scheduler_set		(0x2D20)
#define runner_b_start_task_cpu_rx_wakeup_request		(0x12D8)
#define runner_b_cpu_rx_wakeup_request		(0x12D8)
#define runner_b_start_task_rx_buffer_copy_wakeup_request		(0x2470)
#define runner_b_rx_buffer_copy_wakeup_request		(0x2470)
#define runner_b_start_task_cpu_tx_wakeup_request		(0x2634)
#define runner_b_cpu_tx_wakeup_request		(0x2634)
#define runner_b_start_task_policer_budget_allocator_1st_wakeup_request		(0x31D8)
#define runner_b_policer_budget_allocator_1st_wakeup_request		(0x31D8)
#define runner_b_start_task_rate_control_budget_allocator_1st_wakeup_request		(0x2350)
#define runner_b_rate_control_budget_allocator_1st_wakeup_request		(0x2350)
...
#define runner_b_start_task_spdsvc_timer_1st_wakeup_request		(0x2C70)
#define runner_b_spdsvc_timer_1st_wakeup_request		(0x2C70)
#define runner_b_start_task_free_skb_index_wakeup_request		(0x2EB4)
#define runner_b_free_skb_index_wakeup_request		(0x2EB4)
#define runner_b_start_task_dhd_tx_post		(0x3334)
#define runner_b_dhd_tx_post		(0x3334)
...
#define runner_b_cpu_rx_meter_budget_allocate		(0x2DA0)
#define runner_b_upstream_rate_limiter_budget_allocate		(0x2DEC)
#define runner_b_schedule_free_skb_index		(0x2E98)
