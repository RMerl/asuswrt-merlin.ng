...
ifneq ($(wildcard ../../bcmdrivers/broadcom/net/wl/bcm94908/main/components/router-sysdep/dpsta),)
    DPSTASRC := $(SRCBASE_OFFSET)/router-sysdep/dpsta
else
    DPSTASRC := $(SRCBASE_OFFSET)/../components/router-sysdep/dpsta
endif
...
# BCMINTERNAL and BCMDBG are getting enabled by default. Disabling here till actual fix is found.
    ...
    ifeq ($(WLAUTOD11SHM),1)
        ...
        D11SHM_TEMPDIR2 := $(src)/../hnd_shared/../../../src/wl
