...
#ifndef MERLIN_MPTWO_API_FUNCTIONS_H
#define MERLIN_MPTWO_API_FUNCTIONS_H
 ...
 */
#define _error(err_code) _print_err_msg(err_code, __FUNCTION__, __LINE__)
...
/**
 * This build includes register access macros for the MERLIN/MPTWO core.
 */
#include "merlin_mptwo_fields.h"
...
/************************************************************************//**
 * @name Core RAM Variable Offset Limits
 *
 * Cores/chips without a built-in miccrocontroller receive lane-variable RAM
 * sizes from an API dependency call and presume the same core-variable RAM
 * size as their build-in-microcontroller counterparts.  Since the only means
 * to access RAM variables in these devices is via a service provided by UC,
 * base addresses aren't provided.
 *//*************************************************************************/
/**@{*/
