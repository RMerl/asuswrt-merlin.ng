 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_get_uc_core_config(merlin_access_t *ma, struct merlin_mptwo_uc_core_config_st *struct_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_get_uc_lane_cfg(merlin_access_t *ma, struct merlin_mptwo_uc_lane_config_st *struct_val);
 ...
 */
err_code_t merlin_mptwo_config_tx_hpf(merlin_access_t *ma, uint8_t hpf_val);
 ...
 * @return Error Code generated by invalid settings (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_rd_tx_hpf_config(merlin_access_t *ma, uint8_t *hpf_val);
