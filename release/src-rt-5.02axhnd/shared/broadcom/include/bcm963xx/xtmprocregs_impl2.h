...
#define SAR_CLOCK    333000000L  /* 333MHz */
...
#if defined(CONFIG_BCM963138) || defined(CONFIG_BCM63381) || defined(CONFIG_BCM963148) || defined(CONFIG_BCM963158)
...
#if defined(CONFIG_BCM963158)
//#define RP_MIN_FRAG_PKT_SIZE                32
...
#if defined(CONFIG_BCM963158)
    UINT32 ulSstMpPriArb03;                                         /* 0200 */
    UINT32 ulSstMpPriArb47;                                         /* 0204 */
#else
...
#if defined(CONFIG_BCM963158)
    UINT32 ulSsForceMpArbRR03;                                      /*       / 0274 */
    UINT32 ulSsForceMpArbRR47;                                      /*       / 0278 */
#else
