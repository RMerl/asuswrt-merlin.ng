...
#define MST_PORT_NODE_DMA1_BASE     	BCM_IO_MAP(MST_PORT_NODE_DMA1_IDX, MST_PORT_NODE_DMA0_PHYS_BASE, 0)
...
BCM_IO_BLOCKS bcm_io_blocks[] = 
{
    ...
    {MST_PORT_NODE_DMA0_IDX, MST_PORT_NODE_DMA_SIZE, MST_PORT_NODE_DMA0_PHYS_BASE},
    {MST_PORT_NODE_DMA1_IDX, MST_PORT_NODE_DMA_SIZE, MST_PORT_NODE_DMA1_PHYS_BASE},
    {MST_PORT_NODE_RQ0_IDX, MST_PORT_NODE_RQ_SIZE, MST_PORT_NODE_RQ0_PHYS_BASE},
    {MST_PORT_NODE_RQ1_IDX, MST_PORT_NODE_RQ_SIZE, MST_PORT_NODE_RQ1_PHYS_BASE},
...
typedef struct AXIInterface {
   uint32 CFG;				/* 0x00 */
#define MEMC_AXI_WRITE_ACK_MODE_SHIFT		9
#define MEMC_AXI_FAST_ACK_MODE_MASK			(1 << MEMC_AXI_WRITE_ACK_MODE_SHIFT)
...
#define MEMC_CHN_TIM_CLKS_REF_MAX_DELAY_SHIFT     24
...
#define MEMC_ARB_CFG_BURST_MODE_MASK    (0x1<<MEMC_ARB_CFG_BURST_MODE_SHIFT)
   ...
   uint32 unused26[157];             /* 0xb8c-0xdff */
