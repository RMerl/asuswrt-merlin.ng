...
/* Sets the owner id of a particular object instance.
 *
 * @param oid (IN) The oid of the object node above the instance node
 *                 where the instance is created.
 * @param iidStack (IN) The instance information for the instance.
 * @param ownerId (IN) owner id to set.
 * @return CmsRet enum.
 */  
CmsRet cmsObj_setInstanceOwnerId(const MdmObjectId oid,
                                 const InstanceIdStack *iidStack,
                                 UINT16 ownerId);


/* Gets the owner id of a particular object instance.
 *
 * @param oid (IN) The oid of the object node above the instance node
 *                 where the instance is created.
 * @param iidStack (IN) The instance information for the instance.
 * @param ownerId (OUT) owner id of the object instance.
 * @return CmsRet enum.
 */  
CmsRet cmsObj_getInstanceOwnerId(const MdmObjectId oid,
                                 const InstanceIdStack *iidStack,
                                 UINT16 *ownerId);
