...
**
*******************************************************************/
CmsRet dalVoice_GetRtcpEnabled(DAL_VOICE_PARMS *parms, char *getVal, unsigned int length );
...
**
*******************************************************************/
CmsRet dalVoice_GetRtcpInterval(DAL_VOICE_PARMS *parms, char *getVal, unsigned int length );
...
**
**  PUROPOSE:       Sets max no. of lines that can be configured, as int
**
**  INPUT PARMS:    
**
**  OUTPUT PARMS:   
...
**
**  PUROPOSE:       Sets max no. of extensions that can be configured, as int
**
**  INPUT PARMS:    
**
**  OUTPUT PARMS:   
...
**
**  PUROPOSE:       Sets max no. of sessions per line, as int
**
**  INPUT PARMS:    
**
**  OUTPUT PARMS:   
...
**
**  PUROPOSE:       Sets max no. of sessions per extension, as int
**
**  INPUT PARMS:    
**
**  OUTPUT PARMS:   
...
**
**  PUROPOSE:       Sets max no. of sessions supported across all lines, as int
**
**  INPUT PARMS:    
**
**  OUTPUT PARMS:   
...
**
**  PUROPOSE:       Returns the name of the codec in codec profile
**
**  INPUT PARMS:    length - size of string buffer
**
**  OUTPUT PARMS:   value - codec name
...
**
**  PUROPOSE:       Returns the packetization period of the codec in codec profile
**
**  INPUT PARMS:    length - size of string buffer
**
**  OUTPUT PARMS:   value - codec packetization period(s), comma separated
...
CmsRet dalVoice_SetCcLineStatsInCallTotalTime( DAL_VOICE_PARMS *parms, UINT32 value );
...
CmsRet dalVoice_SetCcLineStatsOutCallTotalTime( DAL_VOICE_PARMS *parms, UINT32 value );
