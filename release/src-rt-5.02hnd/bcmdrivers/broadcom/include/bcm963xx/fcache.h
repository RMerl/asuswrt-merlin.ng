...
/*
 *------------------------------------------------------------------------------
 * Function     : fc_enable_hw_support
 * Description  : Enable hw_support for active flows.
 * Design Note  : Invoked by fhw_bind_hw() in fcachedrv.c
 *------------------------------------------------------------------------------
 */
extern void fc_enable_hw_support(void);
