 ...
 *
 * $Id: bcmdefs.h 627751 2016-03-28 09:56:17Z $
 */
...
extern bool postattach_part_reclaimed;
extern bool ucodes_reclaimed;
...
#if defined(BCM_HOST_MEM_UCODE) && !defined(BCMROMBUILD)
#define BCMUCODEDATA(_data)	__attribute__ ((__section__ (".dataucode." #_data))) _data
#define BCMUCODEFN(_fn)		__attribute__ ((__section__ (".textucode." #_fn), noinline)) _fn
#else
#define BCMUCODEDATA(_data)	BCMINITDATA(_data)
#define BCMUCODEFN(_fn)		BCMINITFN(_fn)
#endif /* BCM_HOST_MEM_UCODE && !BCMROMBUILD */
...
/* SROM13 changes */
#define	MAXSZ_NVRAM_VARS	8192*2
#endif

#ifdef ATE_BUILD
#define ATE_NVRAM_MAXSIZE (8192*4)
#endif
