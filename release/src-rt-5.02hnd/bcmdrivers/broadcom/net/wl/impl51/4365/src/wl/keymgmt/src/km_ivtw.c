 ...
 * $Id: km_ivtw.c 639461 2016-05-23 21:30:05Z $
 */
...
static bool
ivtw_is_replay(ivtw_t *ivtw, ivtw_seq_info_t *seq_info, uint8 *rx_seq)
{
	bool replay = FALSE;
...
static void
ivtw_update(ivtw_t *ivtw, ivtw_seq_info_t *seq_info, uint8 *rx_seq)
{
	bool in_tw;
	km_uint64_t lb = seq_info->wstart;
	km_uint64_t hb = lb + IVTW_TWSIZE - 1;
