		...
		<table class="logotable">
			<tr>
				<td width="100%" valign="top">
					<br>
					<span id="TextHeading">Advanced Trouble Shooting</span><br>
					<span id="TextHeadingDesc">Advanced trouble shooting will insight most of the counters like AMPDU(if available), Glitch, Chanim and Packet Queue Statistics.</span>
				</td>
			</tr>
		</table>
