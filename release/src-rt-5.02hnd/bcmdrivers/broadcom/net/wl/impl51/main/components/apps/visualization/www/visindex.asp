...
<!--
 ...
 $Id: visindex.asp 603186 2015-12-01 07:49:11Z $
-->
		...
		<table class="logotable">
			<tr>
				<td width="100%" valign="top">
					<br>
					<span id="TextHeading">WiFi Site Survey</span><br>
					<span id="TextHeadingDesc">WiFi Site Survey will discover all wireless access point in your environment</span>
				</td>
			</tr>
		</table>
