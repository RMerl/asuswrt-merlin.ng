...
/* HP-UX systems version 9, 10 and 11 lack sys/select.h and so does oldish
   ...
   require it! */
	...
	|| defined(__ANDROID__) || defined(__OpenBSD__) || (defined(__FreeBSD_version) && \
...
#if defined(__GNUC__) && defined(__GNUC_MINOR__) && ((__GNUC__ > 4) || (__GNUC__ == 4 \
	&& __GNUC_MINOR__ >= 3)) && !defined(__cplusplus) && !defined(CURL_DISABLE_TYPECHECK)
