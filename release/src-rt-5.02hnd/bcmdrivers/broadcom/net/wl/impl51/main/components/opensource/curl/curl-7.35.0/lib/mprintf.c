...
#if (defined(__BORLANDC__) && (__BORLANDC__ >= 0x520)) || (defined(__WATCOMC__) && \
	defined(__386__)) || (defined(__POCC__) && defined(_MSC_VER)) || (defined(_WIN32_WCE)) \
	|| (defined(__MINGW32__)) || (defined(_MSC_VER) && (_MSC_VER >= 900) && \
