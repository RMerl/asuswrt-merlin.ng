...
#if   __ide_target("Standalone TestResponder")           || __ide_target("Standalone \
	TestSearcher")           || __ide_target("Standalone SubTypeTester")
#define TARGET_API_MAC_CARBON 1
#define OTCARBONAPPLICATION 1
#define MDNS_ONLYSYSTEMTASK 0
#define MDNS_DEBUGMSGS 0

#elif __ide_target("Standalone TestResponder Debug")   || __ide_target("Standalone \
	TestSearcher Debug")
#define TARGET_API_MAC_CARBON 1
#define OTCARBONAPPLICATION 1
...
#elif __ide_target("Standalone TestResponder Classic") || __ide_target("Standalone \
	TestSearcher Classic")
#define MDNS_ONLYSYSTEMTASK 0
#define MDNS_DEBUGMSGS 0
