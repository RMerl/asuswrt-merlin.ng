...
// VxWorks
	...
	#if( !macintosh && !__MACH__  && !defined( __FreeBSD__ ) && !defined( __linux__ ) && \
	!defined ( __SVR4 ) && !defined ( __sun ) && !defined( __PALMOS_TRAPS__ ) && !defined( \
	__PALMOS_ARMLET__ ) && !defined( _WIN32 ) )
...
// PowerPC
	...
	#if( defined( __ppc__ ) || defined( __PPC__ ) || defined( powerpc ) || defined( ppc ) \
	|| defined( _M_MPPC ) )
...
// MIPS
	...
	#if( __MIPS__ || defined( MIPS32 ) || defined( R3000 ) || defined( R4000 ) || defined( \
	R4650 ) || defined( _M_MRX000 ) )
...
#if( !defined( TARGET_CPU_PPC ) && !defined( TARGET_CPU_X86 ) && !defined( \
	TARGET_CPU_MIPS ) )
...
// TARGET_RT_LITTLE_ENDIAN
	...
	defined(   BYTE_ORDER ) && defined(   LITTLE_ENDIAN ) && (   BYTE_ORDER == \
	LITTLE_ENDIAN ) )	|| ( defined(  _BYTE_ORDER ) && defined(  _LITTLE_ENDIAN ) && ( \
	_BYTE_ORDER ==  _LITTLE_ENDIAN ) )	|| ( defined( __BYTE_ORDER ) && defined( \
	__LITTLE_ENDIAN ) && ( __BYTE_ORDER == __LITTLE_ENDIAN ) )	|| TARGET_CPU_X86 || ( \
...
// TARGET_RT_BIG_ENDIAN
	...
	#if( MIPSEB || IL_BIG_ENDIAN || defined( __BIG_ENDIAN__ ) 										|| ( defined( \
	BYTE_ORDER ) && defined(   BIG_ENDIAN ) && (   BYTE_ORDER ==   BIG_ENDIAN ) )	|| ( \
	defined(  _BYTE_ORDER ) && defined(  _BIG_ENDIAN ) && (  _BYTE_ORDER ==  _BIG_ENDIAN ) \
	)	|| ( defined( __BYTE_ORDER ) && defined( __BIG_ENDIAN ) && ( __BYTE_ORDER == \
	__BIG_ENDIAN ) )	|| ( defined( TARGET_RT_LITTLE_ENDIAN ) && !TARGET_RT_LITTLE_ENDIAN ) \
	)
		#define	TARGET_RT_BIG_ENDIAN		1
	#else
...
#if( TARGET_LANGUAGE_C_LIKE )
	#if( ( TARGET_OS_MAC && !defined( SO_NOADDRERR ) ) || ( TARGET_OS_WIN32 && !defined( \
	EAI_AGAIN ) ) || TARGET_OS_VXWORKS )
...
// - Windows
	...
	!TARGET_OS_FREEBSD && !TARGET_OS_LINUX && !TARGET_OS_VXWORKS && !TARGET_OS_MAC)
		typedef int						ssize_t;
	#endif
#endif
