...
#include "mcb/mcb_6858A_1067MHz_32b_dev1Gx16_DDR3-2133N.h"
...
#include "mcb/mcb_6858A_800MHz_32b_dev1Gx16_DDR3-1600K.h"
...
mcbindex MCB[]  = {
    ...
    // 800 MHz
    {
        ...
        BP_DDR_SPEED_MASK | BP_DDR_TOTAL_SIZE_MASK | BP_DDR_DEVICE_WIDTH_MASK | BP_DDR_TOTAL_WIDTH_MASK,
        mcb_6858A_800MHz_16b_dev2Gx16_DDR3_1600K
    },
    {
        BP_DDR_SPEED_800_11_11_11 | BP_DDR_TOTAL_SIZE_512MB| BP_DDR_DEVICE_WIDTH_16 | BP_DDR_TOTAL_WIDTH_16BIT,
        BP_DDR_SPEED_MASK | BP_DDR_TOTAL_SIZE_MASK | BP_DDR_DEVICE_WIDTH_MASK | BP_DDR_TOTAL_WIDTH_MASK,
        mcb_6858A_800MHz_16b_dev4Gx16_DDR3_1600K
    },
    {
        BP_DDR_SPEED_800_11_11_11 | BP_DDR_TOTAL_SIZE_512MB| BP_DDR_DEVICE_WIDTH_16 | BP_DDR_TOTAL_WIDTH_32BIT,
        BP_DDR_SPEED_MASK | BP_DDR_TOTAL_SIZE_MASK | BP_DDR_DEVICE_WIDTH_MASK | BP_DDR_TOTAL_WIDTH_MASK,
        mcb_6858A_800MHz_32b_dev2Gx16_DDR3_1600K
    },
    {
        BP_DDR_SPEED_800_11_11_11 | BP_DDR_TOTAL_SIZE_1024MB| BP_DDR_DEVICE_WIDTH_16 | BP_DDR_TOTAL_WIDTH_32BIT,
        BP_DDR_SPEED_MASK | BP_DDR_TOTAL_SIZE_MASK | BP_DDR_DEVICE_WIDTH_MASK | BP_DDR_TOTAL_WIDTH_MASK,
        mcb_6858A_800MHz_32b_dev4Gx16_DDR3_1600K
    },
