...
# meaning if ((BRCM_CHIP == 63138) || (BRCM_CHIP == 63148) || (BRCM_CHIP == 63381) || (BRCM_CHIP == 6858) || (BRCM_CHIP == 4908) || (BRCM_CHIP == 68360))
ifneq ($(findstring _$(strip $(BRCM_CHIP))_,_63138_63148_63381_6858_4908_68360_),) 
INC_PMC_DRIVER=1
endif
...
# supported chips are 6328, 6362, 6368, 6818, 63268, 6828, 6838, 63138, 63381, 63148, 4908, 6858, 47189, 68360
ifneq ($(findstring _$(strip $(BRCM_CHIP))_,_6328_6362_6368_6818_63268_6828_6838_63138_63381_63148_6848__4908_6858_47189_68360_),)
INC_NAND_FLASH_DRIVER=1
ifneq ($(findstring _$(strip $(BRCM_CHIP))_,_6838_63381_63138_6848_4908_6858_68360_),)
INC_SPI_NAND_DRIVER=1
endif
endif
else
# BUILD NOR flash boot loader
# supported chips are 6328, 6362, 6368, 6818, 63268, 6828, 6318, 60333, 6838, 63138, 63381, 63148, 4908, 6858, 47189, 68360
ifneq ($(findstring _$(strip $(BRCM_CHIP))_,_6328_6362_6368_6818_63268_6828_6318_60333_6838_63138_63381_63148_6848__4908_6858_47189_68360_),)
...
# Enable cfe abort key for all devices except 6368, 47189
ifeq ($(findstring _$(strip $(BRCM_CHIP))_,_6368_47189_),)
