...
void  __init soc_l2_cache_init(void)
{
	...
	auxctl_val |= L310_AUX_CTRL_ASSOCIATIVITY_16;	/* 16-way cache */
	auxctl_msk &= ~(L310_AUX_CTRL_ASSOCIATIVITY_16);
	auxctl_val |= (2 << L2C_AUX_CTRL_WAY_SIZE_SHIFT);	/* 32KB */
	auxctl_msk &= ~(L2C_AUX_CTRL_WAY_SIZE_MASK);
	 ...
	 */
	auxctl_val |= (L2C_AUX_CTRL_SHARED_OVERRIDE  |
			L310_AUX_CTRL_NS_INT_CTRL    |	/* Allow non-secure access */ 
			L310_AUX_CTRL_INSTR_PREFETCH |	/* Instruction prefetch */
			L310_AUX_CTRL_EARLY_BRESP);	/* Early BRESP */

	auxctl_msk &= ~(L2C_AUX_CTRL_SHARED_OVERRIDE |
			L310_AUX_CTRL_NS_INT_CTRL    |	/* Allow non-secure access */ 
			L310_AUX_CTRL_INSTR_PREFETCH |	/* Instruction prefetch */
			L310_AUX_CTRL_EARLY_BRESP);	/* Early BRESP */
	...
	auxctl_val |= L310_AUX_CTRL_DATA_PREFETCH; */	/* Data prefetch */
