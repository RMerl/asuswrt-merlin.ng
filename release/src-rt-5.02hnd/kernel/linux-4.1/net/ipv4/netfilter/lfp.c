...
static ssize_t lfp_ctrl(struct file *file, const char __user *buffer, size_t length, loff_t *data)
#else
...
#if LINUX_VERSION_CODE > KERNEL_VERSION(3,10,13)
static ssize_t lfp_read_proc(struct file *file, __user char *buffer, size_t count, loff_t *data)
#else
...
#if LINUX_VERSION_CODE > KERNEL_VERSION(3,10,13)
static ssize_t lfp_port_write_proc(struct file *file, const char __user *buffer, size_t length, loff_t *data)
#else
...
#if LINUX_VERSION_CODE > KERNEL_VERSION(3,10,13)
static ssize_t lfp_port_read_proc(struct file *file, __user char *buffer, size_t count, loff_t *data)
#else
