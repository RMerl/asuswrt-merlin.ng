...
static const uint32_t hash_polynom[HASH_NUM_OF_ENGINES] = {0x1021, 0x8bb7, 0xc867, 0x0589};
...
#if defined(CM3390) || defined(XRDP) || defined(WL4908)
...
void rdd_crc_ipv6_addr_calc(bdmf_ip_t *ip_addr, uint32_t *ipv6_ip_crc)
{
