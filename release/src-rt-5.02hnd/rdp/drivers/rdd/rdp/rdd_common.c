...
#endif
#ifdef CM3390
uint32_t g_runner_psram_base_addr;
#else
...
void rdd_psram_packet_headroom_size_cfg(uint32_t psram_packet_headroom_size)
{
    ...
    addr = (void *)(DEVICE_ADDRESS(RUNNER_PRIVATE_1_OFFSET) + US_PSRAM_CFG_PACKET_HEADROOM_SIZE_ADDRESS);
    MWRITE_16(addr, psram_packet_headroom_size);
#endif
}
