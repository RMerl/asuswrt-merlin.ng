...
int rdd_cpu_rx_meter_drop_counter_get(rdd_cpu_rx_meter cpu_meter, rdpa_traffic_dir dir, uint16_t *drop_counter)
{
    int rdd_error;

    rdd_error = rdd_2_bytes_counter_get(CPU_RX_METERS_DROPPED_PACKETS_GROUP, dir * CPU_RX_METERS_DROPPED_PACKETS_UPSTREAM_OFFSET + cpu_meter, drop_counter);
