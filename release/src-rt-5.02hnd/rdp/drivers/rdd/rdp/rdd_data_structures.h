...
#ifdef CM3390
#define IPTV_TABLE_PTR              g_runner_ddr0_iptv_lookup_ptr
#define IPTV_CONTEXT_TABLE_PTR      g_runner_ddr0_iptv_context_ptr
#define IPTV_SSM_CONTEXT_TABLE_PTR  g_runner_ddr0_iptv_ssm_context_ptr
#define NAT_CACHE_TABLE_PTR         g_runner_nat_cache_key_ptr
#define CONTEXT_TABLE_PTR           g_runner_nat_cache_context_ptr
#endif
...
typedef enum
{
    RDD_CPU_MESSAGE_RX_FLOW_PM_COUNTERS_GET     = 1,
    RDD_CPU_MESSAGE_TX_FLOW_PM_COUNTERS_GET     = 2,
    RDD_CPU_MESSAGE_BRIDGE_PORT_PM_COUNTERS_GET = 4,
    RDD_CPU_MESSAGE_PM_COUNTER_GET              = 5,
    RDD_CPU_MESSAGE_IPV6_CRC_GET                = 6,
    RDD_CPU_MESSAGE_IPTV_COUNTER_GET            = 7,
    RDD_CPU_MESSAGE_FLUSH_WAN_TX_QUEUE          = 9,
    RDD_CPU_MESSAGE_FLUSH_LAN_TX_QUEUE          = 10,
    RDD_CPU_MESSAGE_DHD                         = 14,
} rdd_cpu_message_type_t;
#endif
