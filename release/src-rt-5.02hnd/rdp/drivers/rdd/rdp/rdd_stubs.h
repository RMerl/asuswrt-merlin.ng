...
static inline int rdd_subnet_counters_get(rdd_subnet_id_t subnet, rdd_subnet_pm_counters_t *counters)
{
    return 0;
}
...
static inline int rdd_mac_entry_add(rdd_mac_params_t *mac_params, uint32_t *entry_idx)
{
    return 0;
}
...
static inline int rdd_mac_entry_modify(rdd_mac_params_t *mac_params)
{
    return 0;
}

static inline int rdd_mac_entry_search(rdd_mac_params_t *mac_params, uint32_t *entry_idx)
{
    return 0;
}

static inline int rdd_mac_entry_get(uint32_t entry_idx, rdd_mac_params_t *mac_params, uint32_t *valid_bit,
    uint32_t *skip_bit, uint32_t *aging_bit)
{
    return 0;
}

static inline int rdd_mac_entry_aging_set(uint32_t entry_idx, uint32_t *activity_status)
{
    return 0;
}

static inline void rdd_mac_table_clear(void)
{
}
