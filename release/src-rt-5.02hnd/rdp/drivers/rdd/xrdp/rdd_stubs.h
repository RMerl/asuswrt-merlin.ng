...
#define RDD_DS_INGRESS_CLASSIFICATION_CONTEXT_TABLE_SIZE        128
#define RDD_US_IC_CONTEXT_TABLE_SIZE                            128
...
{
    RDD_BTRACE("mac_params = %p, entry_idx = %p\n", mac_params, entry_idx);
