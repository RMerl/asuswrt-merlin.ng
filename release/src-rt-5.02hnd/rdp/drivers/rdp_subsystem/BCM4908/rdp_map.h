...
#else
// FIXME!! temporary keep for compile 4908 into 3390
#define BBH_TX_3_OFFSET	(0xf4000)
#define BBH_TX_4_OFFSET	(0xf6000)
#endif
...
#else
// FIXME!! temporary keep for compile 4908 into 3390
#define BBH_RX_3_OFFSET	(0xe1000)
#define BBH_RX_4_OFFSET	(0xe2000)
#endif
