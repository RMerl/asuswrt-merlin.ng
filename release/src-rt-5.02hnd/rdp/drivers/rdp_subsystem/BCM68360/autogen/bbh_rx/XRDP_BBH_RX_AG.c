...
/******************************************************************************
 * Field: BBH_RX_DEBUG_COHERENCYCNT2_CDSENT0
 ******************************************************************************/
const ru_field_rec BBH_RX_DEBUG_COHERENCYCNT2_CDSENT0_FIELD =
{
    "CDSENT0",
#if RU_INCLUDE_DESC
    "CD_sent0",
    "CD sent flow 0",
#endif
    BBH_RX_DEBUG_COHERENCYCNT2_CDSENT0_FIELD_MASK,
    0,
    BBH_RX_DEBUG_COHERENCYCNT2_CDSENT0_FIELD_WIDTH,
    BBH_RX_DEBUG_COHERENCYCNT2_CDSENT0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: BBH_RX_DEBUG_COHERENCYCNT2_CDSENT1
 ******************************************************************************/
const ru_field_rec BBH_RX_DEBUG_COHERENCYCNT2_CDSENT1_FIELD =
{
    "CDSENT1",
#if RU_INCLUDE_DESC
    "CD_sent1",
    "CD sent flow 1",
#endif
    BBH_RX_DEBUG_COHERENCYCNT2_CDSENT1_FIELD_MASK,
    0,
    BBH_RX_DEBUG_COHERENCYCNT2_CDSENT1_FIELD_WIDTH,
    BBH_RX_DEBUG_COHERENCYCNT2_CDSENT1_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: BBH_RX_DEBUG_COHERENCYCNT2_ACKRECEIVED0
 ******************************************************************************/
const ru_field_rec BBH_RX_DEBUG_COHERENCYCNT2_ACKRECEIVED0_FIELD =
{
    "ACKRECEIVED0",
#if RU_INCLUDE_DESC
    "ACK_received0",
    "EOP ACK received 0",
#endif
    BBH_RX_DEBUG_COHERENCYCNT2_ACKRECEIVED0_FIELD_MASK,
    0,
    BBH_RX_DEBUG_COHERENCYCNT2_ACKRECEIVED0_FIELD_WIDTH,
    BBH_RX_DEBUG_COHERENCYCNT2_ACKRECEIVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: BBH_RX_DEBUG_COHERENCYCNT2_RESERVED2
 ******************************************************************************/
const ru_field_rec BBH_RX_DEBUG_COHERENCYCNT2_RESERVED2_FIELD =
{
    "RESERVED2",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    BBH_RX_DEBUG_COHERENCYCNT2_RESERVED2_FIELD_MASK,
    0,
    BBH_RX_DEBUG_COHERENCYCNT2_RESERVED2_FIELD_WIDTH,
    BBH_RX_DEBUG_COHERENCYCNT2_RESERVED2_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: BBH_RX_DEBUG_COHERENCYCNT2_ACKRECEIVED1
 ******************************************************************************/
const ru_field_rec BBH_RX_DEBUG_COHERENCYCNT2_ACKRECEIVED1_FIELD =
{
    "ACKRECEIVED1",
#if RU_INCLUDE_DESC
    "ACK_received1",
    "EOP ACK received 1",
#endif
    BBH_RX_DEBUG_COHERENCYCNT2_ACKRECEIVED1_FIELD_MASK,
    0,
    BBH_RX_DEBUG_COHERENCYCNT2_ACKRECEIVED1_FIELD_WIDTH,
    BBH_RX_DEBUG_COHERENCYCNT2_ACKRECEIVED1_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: BBH_RX_DEBUG_COHERENCYCNT2_RESERVED3
 ******************************************************************************/
const ru_field_rec BBH_RX_DEBUG_COHERENCYCNT2_RESERVED3_FIELD =
{
    "RESERVED3",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    BBH_RX_DEBUG_COHERENCYCNT2_RESERVED3_FIELD_MASK,
    0,
    BBH_RX_DEBUG_COHERENCYCNT2_RESERVED3_FIELD_WIDTH,
    BBH_RX_DEBUG_COHERENCYCNT2_RESERVED3_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
{
    &BBH_RX_DEBUG_COHERENCYCNT2_CDSENT0_FIELD,
    &BBH_RX_DEBUG_COHERENCYCNT2_RESERVED0_FIELD,
    &BBH_RX_DEBUG_COHERENCYCNT2_CDSENT1_FIELD,
    &BBH_RX_DEBUG_COHERENCYCNT2_RESERVED1_FIELD,
    &BBH_RX_DEBUG_COHERENCYCNT2_ACKRECEIVED0_FIELD,
    &BBH_RX_DEBUG_COHERENCYCNT2_RESERVED2_FIELD,
    &BBH_RX_DEBUG_COHERENCYCNT2_ACKRECEIVED1_FIELD,
    &BBH_RX_DEBUG_COHERENCYCNT2_RESERVED3_FIELD,
};
