...
bdmf_error_t ag_drv_bbh_rx_min_pkt_sel_flows_0_31_set(uint8_t bbh_id, uint8_t flow_id, uint8_t sel_id)
{
...
bdmf_error_t ag_drv_bbh_rx_min_pkt_sel_flows_0_31_get(uint8_t bbh_id, uint8_t flow_id, uint8_t *sel_id)
{
...
bdmf_error_t ag_drv_bbh_rx_general_configuration_minpktsel1_set(uint8_t bbh_id, uint32_t minpktsel)
{
    ...
    reg_general_configuration_minpktsel1 = RU_FIELD_SET(bbh_id, BBH_RX, GENERAL_CONFIGURATION_MINPKTSEL1, MINPKTSEL, reg_general_configuration_minpktsel1, minpktsel);
...
bdmf_error_t ag_drv_bbh_rx_general_configuration_minpktsel1_get(uint8_t bbh_id, uint32_t *minpktsel)
{
    ...
    *minpktsel = RU_FIELD_GET(bbh_id, BBH_RX, GENERAL_CONFIGURATION_MINPKTSEL1, MINPKTSEL, reg_general_configuration_minpktsel1);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_bbh_rx_max_pkt_sel_flows_0_31_set(uint8_t bbh_id, uint8_t flow_id, uint8_t sel_id)
{
    /* Identical to min_pkt_sel_flows_0_31 */
    uint32_t reg_general_configuration_minpktsel0=0;
...
bdmf_error_t ag_drv_bbh_rx_max_pkt_sel_flows_0_31_get(uint8_t bbh_id, uint8_t flow_id, uint8_t *sel_id)
{
    /* Identical to min_pkt_sel_flows_0_31 */
    uint32_t reg_general_configuration_minpktsel0;
...
bdmf_error_t ag_drv_bbh_rx_general_configuration_maxpktsel1_set(uint8_t bbh_id, uint32_t maxpktsel)
{
    uint32_t reg_general_configuration_maxpktsel1=0;
    ...
    reg_general_configuration_maxpktsel1 = RU_FIELD_SET(bbh_id, BBH_RX, GENERAL_CONFIGURATION_MAXPKTSEL1, MAXPKTSEL, reg_general_configuration_maxpktsel1, maxpktsel);

    RU_REG_WRITE(bbh_id, BBH_RX, GENERAL_CONFIGURATION_MAXPKTSEL1, reg_general_configuration_maxpktsel1);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_bbh_rx_general_configuration_maxpktsel1_get(uint8_t bbh_id, uint32_t *maxpktsel)
{
    uint32_t reg_general_configuration_maxpktsel1;
    ...
    RU_REG_READ(bbh_id, BBH_RX, GENERAL_CONFIGURATION_MAXPKTSEL1, reg_general_configuration_maxpktsel1);

    *maxpktsel = RU_FIELD_GET(bbh_id, BBH_RX, GENERAL_CONFIGURATION_MAXPKTSEL1, MAXPKTSEL, reg_general_configuration_maxpktsel1);
...
bdmf_error_t ag_drv_bbh_rx_debug_coherencycnt2_get(uint8_t bbh_id, uint8_t *cdsent0, uint8_t *cdsent1, uint8_t *ackreceived0, uint8_t *ackreceived1)
{
    uint32_t reg_debug_coherencycnt2;

#ifdef VALIDATE_PARMS
    if(!cdsent0 || !cdsent1 || !ackreceived0 || !ackreceived1)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    *cdsent0 = RU_FIELD_GET(bbh_id, BBH_RX, DEBUG_COHERENCYCNT2, CDSENT0, reg_debug_coherencycnt2);
    *cdsent1 = RU_FIELD_GET(bbh_id, BBH_RX, DEBUG_COHERENCYCNT2, CDSENT1, reg_debug_coherencycnt2);
    *ackreceived0 = RU_FIELD_GET(bbh_id, BBH_RX, DEBUG_COHERENCYCNT2, ACKRECEIVED0, reg_debug_coherencycnt2);
    *ackreceived1 = RU_FIELD_GET(bbh_id, BBH_RX, DEBUG_COHERENCYCNT2, ACKRECEIVED1, reg_debug_coherencycnt2);
...
static int bcm_bbh_rx_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_bbh_rx_mac_mode:
        err = ag_drv_bbh_rx_mac_mode_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    ...
    case cli_bbh_rx_general_configuration_perflowth:
        ...
        break;
    case cli_bbh_rx_min_pkt_sel_flows_0_31:
        err = ag_drv_bbh_rx_min_pkt_sel_flows_0_31_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_bbh_rx_general_configuration_minpktsel1:
        err = ag_drv_bbh_rx_general_configuration_minpktsel1_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_bbh_rx_max_pkt_sel_flows_0_31:
        err = ag_drv_bbh_rx_max_pkt_sel_flows_0_31_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_bbh_rx_general_configuration_maxpktsel1:
        err = ag_drv_bbh_rx_general_configuration_maxpktsel1_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
...
int bcm_bbh_rx_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_bbh_rx_mac_mode:
    {
        ...
        err = ag_drv_bbh_rx_mac_mode_get(parm[1].value.unumber, &macmode, &gponmode);
    ...
    {
        uint8_t sel_id;
        err = ag_drv_bbh_rx_min_pkt_sel_flows_0_31_get(parm[1].value.unumber, parm[2].value.unumber, &sel_id);
    ...
    {
        uint32_t minpktsel;
        err = ag_drv_bbh_rx_general_configuration_minpktsel1_get(parm[1].value.unumber, &minpktsel);
        bdmf_session_print(session, "minpktsel = %u (0x%x)\n", minpktsel, minpktsel);
        break;
    }
    case cli_bbh_rx_max_pkt_sel_flows_0_31:
    {
        uint8_t sel_id;
        err = ag_drv_bbh_rx_max_pkt_sel_flows_0_31_get(parm[1].value.unumber, parm[2].value.unumber, &sel_id);
        bdmf_session_print(session, "sel_id = %u (0x%x)\n", sel_id, sel_id);
        break;
    }
    case cli_bbh_rx_general_configuration_maxpktsel1:
    {
        uint32_t maxpktsel;
        err = ag_drv_bbh_rx_general_configuration_maxpktsel1_get(parm[1].value.unumber, &maxpktsel);
        bdmf_session_print(session, "maxpktsel = %u (0x%x)\n", maxpktsel, maxpktsel);
        break;
    }
    case cli_bbh_rx_general_configuration_sbpmcfg:
    {
    ...
    case cli_bbh_rx_debug_coherencycnt2:
    {
        uint8_t cdsent0;
        uint8_t cdsent1;
        uint8_t ackreceived0;
        uint8_t ackreceived1;
        err = ag_drv_bbh_rx_debug_coherencycnt2_get(parm[1].value.unumber, &cdsent0, &cdsent1, &ackreceived0, &ackreceived1);
        bdmf_session_print(session, "cdsent0 = %u (0x%x)\n", cdsent0, cdsent0);
        bdmf_session_print(session, "cdsent1 = %u (0x%x)\n", cdsent1, cdsent1);
        bdmf_session_print(session, "ackreceived0 = %u (0x%x)\n", ackreceived0, ackreceived0);
        bdmf_session_print(session, "ackreceived1 = %u (0x%x)\n", ackreceived1, ackreceived1);
        break;
    }
    default:
        err = BDMF_ERR_NOT_SUPPORTED;
...
static int bcm_bbh_rx_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_mac_mode_set(%u %u %u)\n", bbh_id, macmode, gponmode);
        if(!err) ag_drv_bbh_rx_mac_mode_set(bbh_id, macmode, gponmode);
        if(!err) ag_drv_bbh_rx_mac_mode_get( bbh_id, &macmode, &gponmode);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_mac_mode_get(%u %u %u)\n", bbh_id, macmode, gponmode);
        if(err || macmode!=gtmv(m, 1) || gponmode!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_min_pkt_sel_flows_0_31_set(%u %u %u)\n", bbh_id, flow_id, sel_id);
        if(!err) ag_drv_bbh_rx_min_pkt_sel_flows_0_31_set(bbh_id, flow_id, sel_id);
        if(!err) ag_drv_bbh_rx_min_pkt_sel_flows_0_31_get( bbh_id, flow_id, &sel_id);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_min_pkt_sel_flows_0_31_get(%u %u %u)\n", bbh_id, flow_id, sel_id);
        if(err || sel_id!=gtmv(m, 2))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t minpktsel=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_general_configuration_minpktsel1_set(%u %u)\n", bbh_id, minpktsel);
        if(!err) ag_drv_bbh_rx_general_configuration_minpktsel1_set(bbh_id, minpktsel);
        if(!err) ag_drv_bbh_rx_general_configuration_minpktsel1_get( bbh_id, &minpktsel);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_general_configuration_minpktsel1_get(%u %u)\n", bbh_id, minpktsel);
        if(err || minpktsel!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t flow_id=gtmv(m, 4);
        uint8_t sel_id=gtmv(m, 2);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_max_pkt_sel_flows_0_31_set(%u %u %u)\n", bbh_id, flow_id, sel_id);
        if(!err) ag_drv_bbh_rx_max_pkt_sel_flows_0_31_set(bbh_id, flow_id, sel_id);
        if(!err) ag_drv_bbh_rx_max_pkt_sel_flows_0_31_get( bbh_id, flow_id, &sel_id);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_max_pkt_sel_flows_0_31_get(%u %u %u)\n", bbh_id, flow_id, sel_id);
        if(err || sel_id!=gtmv(m, 2))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t maxpktsel=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_general_configuration_maxpktsel1_set(%u %u)\n", bbh_id, maxpktsel);
        if(!err) ag_drv_bbh_rx_general_configuration_maxpktsel1_set(bbh_id, maxpktsel);
        if(!err) ag_drv_bbh_rx_general_configuration_maxpktsel1_get( bbh_id, &maxpktsel);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_general_configuration_maxpktsel1_get(%u %u)\n", bbh_id, maxpktsel);
        if(err || maxpktsel!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        uint8_t cdsent0=gtmv(m, 7);
        uint8_t cdsent1=gtmv(m, 7);
        uint8_t ackreceived0=gtmv(m, 7);
        uint8_t ackreceived1=gtmv(m, 7);
        if(!err) ag_drv_bbh_rx_debug_coherencycnt2_get( bbh_id, &cdsent0, &cdsent1, &ackreceived0, &ackreceived1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_debug_coherencycnt2_get(%u %u %u %u %u)\n", bbh_id, cdsent0, cdsent1, ackreceived0, ackreceived1);
    }
    return err;
}
...
bdmfmon_handle_t ag_drv_bbh_rx_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_min_pkt_sel_flows_0_31[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id", "bbh_id", bbh_id_enum_table, 0),
            BDMFMON_MAKE_PARM("flow_id", "flow_id", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("sel_id", "sel_id", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_general_configuration_minpktsel1[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id", "bbh_id", bbh_id_enum_table, 0),
            BDMFMON_MAKE_PARM("minpktsel", "minpktsel", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_general_configuration_maxpktsel1[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id", "bbh_id", bbh_id_enum_table, 0),
            BDMFMON_MAKE_PARM("maxpktsel", "maxpktsel", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="min_pkt_sel_flows_0_31", .val=cli_bbh_rx_min_pkt_sel_flows_0_31, .parms=set_min_pkt_sel_flows_0_31 },
            { .name="general_configuration_minpktsel1", .val=cli_bbh_rx_general_configuration_minpktsel1, .parms=set_general_configuration_minpktsel1 },
            { .name="max_pkt_sel_flows_0_31", .val=cli_bbh_rx_max_pkt_sel_flows_0_31, .parms=set_min_pkt_sel_flows_0_31 },
            { .name="general_configuration_maxpktsel1", .val=cli_bbh_rx_general_configuration_maxpktsel1, .parms=set_general_configuration_maxpktsel1 },
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="min_pkt_sel_flows_0_31", .val=cli_bbh_rx_min_pkt_sel_flows_0_31, .parms=set_default },
            { .name="general_configuration_minpktsel1", .val=cli_bbh_rx_general_configuration_minpktsel1, .parms=set_default },
            { .name="max_pkt_sel_flows_0_31", .val=cli_bbh_rx_max_pkt_sel_flows_0_31, .parms=set_default },
            { .name="general_configuration_maxpktsel1", .val=cli_bbh_rx_general_configuration_maxpktsel1, .parms=set_default },
