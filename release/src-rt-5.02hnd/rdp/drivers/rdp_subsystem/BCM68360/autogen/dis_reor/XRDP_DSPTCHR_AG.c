...
/******************************************************************************
 * Field: DSPTCHR_CONGESTION_CONGSTN_STATUS_INGRS_CONGSTN
 ******************************************************************************/
const ru_field_rec DSPTCHR_CONGESTION_CONGSTN_STATUS_INGRS_CONGSTN_FIELD =
{
    "INGRS_CONGSTN",
#if RU_INCLUDE_DESC
    "INGRESS_CONGESTION",
    "Ingress congestion levels (according to the last VIQ dispatcher)"
    "",
#endif
    DSPTCHR_CONGESTION_CONGSTN_STATUS_INGRS_CONGSTN_FIELD_MASK,
    0,
    DSPTCHR_CONGESTION_CONGSTN_STATUS_INGRS_CONGSTN_FIELD_WIDTH,
    DSPTCHR_CONGESTION_CONGSTN_STATUS_INGRS_CONGSTN_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: DSPTCHR_CONGESTION_CONGSTN_STATUS_EGRS_CONGSTN
 ******************************************************************************/
const ru_field_rec DSPTCHR_CONGESTION_CONGSTN_STATUS_EGRS_CONGSTN_FIELD =
{
    "EGRS_CONGSTN",
#if RU_INCLUDE_DESC
    "EGRESS_CONGESTION",
    "Egress congestion levels",
#endif
    DSPTCHR_CONGESTION_CONGSTN_STATUS_EGRS_CONGSTN_FIELD_MASK,
    0,
    DSPTCHR_CONGESTION_CONGSTN_STATUS_EGRS_CONGSTN_FIELD_WIDTH,
    DSPTCHR_CONGESTION_CONGSTN_STATUS_EGRS_CONGSTN_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: DSPTCHR_CONGESTION_CONGSTN_STATUS_PER_Q_EGRS_CONGSTN
 ******************************************************************************/
const ru_field_rec DSPTCHR_CONGESTION_CONGSTN_STATUS_PER_Q_EGRS_CONGSTN_FIELD =
{
    "PER_Q_EGRS_CONGSTN",
#if RU_INCLUDE_DESC
    "PEQ_Q_EGRESS_CONGESTION",
    "Egress congestion levels",
#endif
    DSPTCHR_CONGESTION_CONGSTN_STATUS_PER_Q_EGRS_CONGSTN_FIELD_MASK,
    0,
    DSPTCHR_CONGESTION_CONGSTN_STATUS_PER_Q_EGRS_CONGSTN_FIELD_WIDTH,
    DSPTCHR_CONGESTION_CONGSTN_STATUS_PER_Q_EGRS_CONGSTN_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: DSPTCHR_CONGESTION_CONGSTN_STATUS_RESERVED4
 ******************************************************************************/
const ru_field_rec DSPTCHR_CONGESTION_CONGSTN_STATUS_RESERVED4_FIELD =
{
    "RESERVED4",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    DSPTCHR_CONGESTION_CONGSTN_STATUS_RESERVED4_FIELD_MASK,
    0,
    DSPTCHR_CONGESTION_CONGSTN_STATUS_RESERVED4_FIELD_WIDTH,
    DSPTCHR_CONGESTION_CONGSTN_STATUS_RESERVED4_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: DSPTCHR_QDES_RESERVED_RESERVED0
 ******************************************************************************/
const ru_field_rec DSPTCHR_QDES_RESERVED_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    DSPTCHR_QDES_RESERVED_RESERVED0_FIELD_MASK,
    0,
    DSPTCHR_QDES_RESERVED_RESERVED0_FIELD_WIDTH,
    DSPTCHR_QDES_RESERVED_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
{
    &DSPTCHR_CONGESTION_CONGSTN_STATUS_INGRS_CONGSTN_FIELD,
    &DSPTCHR_CONGESTION_CONGSTN_STATUS_RESERVED0_FIELD,
    &DSPTCHR_CONGESTION_CONGSTN_STATUS_EGRS_CONGSTN_FIELD,
    &DSPTCHR_CONGESTION_CONGSTN_STATUS_RESERVED1_FIELD,
    &DSPTCHR_CONGESTION_CONGSTN_STATUS_PER_Q_EGRS_CONGSTN_FIELD,
    ...
    &DSPTCHR_CONGESTION_CONGSTN_STATUS_RESERVED4_FIELD,
};
...
/******************************************************************************
 * Register: DSPTCHR_QDES_RESERVED
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *DSPTCHR_QDES_RESERVED_FIELDS[] =
{
    &DSPTCHR_QDES_RESERVED_RESERVED0_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec DSPTCHR_QDES_RESERVED_REG = 
{
    "QDES_RESERVED",
#if RU_INCLUDE_DESC
    "RESERVED Register",
    "reserved",
#endif
    DSPTCHR_QDES_RESERVED_REG_OFFSET,
    DSPTCHR_QDES_RESERVED_REG_RAM_CNT,
    32,
    546,
#if RU_INCLUDE_ACCESS
    ru_access_read,
