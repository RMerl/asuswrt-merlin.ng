...
/**************************************************************************************************/
/* ingrs_congstn: INGRESS_CONGESTION - Ingress congestion levels (according to the last VIQ dispa */
/*                tcher)                                                                          */
/* egrs_congstn: EGRESS_CONGESTION - Egress congestion levels                                     */
/* per_q_egrs_congstn: PEQ_Q_EGRESS_CONGESTION - Egress congestion levels                         */
...
typedef struct
{
    uint8_t ingrs_congstn;
    uint8_t egrs_congstn;
    uint8_t per_q_egrs_congstn;
