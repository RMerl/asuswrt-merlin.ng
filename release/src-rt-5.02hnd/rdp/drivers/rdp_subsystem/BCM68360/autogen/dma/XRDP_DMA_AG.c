...
/******************************************************************************
 * Field: DMA_CONFIG_DBG_SEL_SEL
 ******************************************************************************/
const ru_field_rec DMA_CONFIG_DBG_SEL_SEL_FIELD =
{
    "SEL",
#if RU_INCLUDE_DESC
    "select",
    "select",
#endif
    DMA_CONFIG_DBG_SEL_SEL_FIELD_MASK,
    0,
    DMA_CONFIG_DBG_SEL_SEL_FIELD_WIDTH,
    DMA_CONFIG_DBG_SEL_SEL_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
