...
bdmf_error_t ag_drv_hash_mask_set(const hash_mask *mask)
{
    ...
    if((mask->maskh >= _28BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    RU_REG_WRITE(0, HASH, LKUP_TBL_CFG_KEY_MASK_LOW, reg_lkup_tbl_cfg_key_mask_low);
    RU_REG_WRITE(0, HASH, LKUP_TBL_CFG_KEY_MASK_HIGH, reg_lkup_tbl_cfg_key_mask_high);
...
bdmf_error_t ag_drv_hash_mask_get(hash_mask *mask)
{
    ...
    RU_REG_READ(0, HASH, LKUP_TBL_CFG_KEY_MASK_LOW, reg_lkup_tbl_cfg_key_mask_low);
    RU_REG_READ(0, HASH, LKUP_TBL_CFG_KEY_MASK_HIGH, reg_lkup_tbl_cfg_key_mask_high);
...
bdmf_error_t ag_drv_hash_lkup_tbl_cfg_tbl_cfg_set(const hash_lkup_tbl_cfg_tbl_cfg *lkup_tbl_cfg_tbl_cfg)
{
    ...
    if((lkup_tbl_cfg_tbl_cfg->hash_base_addr >= _11BITS_MAX_VAL_) ||
    ...
    RU_REG_WRITE(0, HASH, LKUP_TBL_CFG_TBL_CFG, reg_lkup_tbl_cfg_tbl_cfg);
...
bdmf_error_t ag_drv_hash_lkup_tbl_cfg_tbl_cfg_get(hash_lkup_tbl_cfg_tbl_cfg *lkup_tbl_cfg_tbl_cfg)
{
    ...
    RU_REG_READ(0, HASH, LKUP_TBL_CFG_TBL_CFG, reg_lkup_tbl_cfg_tbl_cfg);
...
bdmf_error_t ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_set(const hash_lkup_tbl_cfg_cntxt_cfg *lkup_tbl_cfg_cntxt_cfg)
{
    ...
    if((lkup_tbl_cfg_cntxt_cfg->base_address >= _12BITS_MAX_VAL_) ||
    ...
    RU_REG_WRITE(0, HASH, LKUP_TBL_CFG_CNTXT_CFG, reg_lkup_tbl_cfg_cntxt_cfg);
...
bdmf_error_t ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_get(hash_lkup_tbl_cfg_cntxt_cfg *lkup_tbl_cfg_cntxt_cfg)
{
    ...
    RU_REG_READ(0, HASH, LKUP_TBL_CFG_CNTXT_CFG, reg_lkup_tbl_cfg_cntxt_cfg);
...
static int bcm_hash_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_hash_mask:
    {
        hash_mask mask = { .maskl=parm[1].value.unumber, .maskh=parm[2].value.unumber};
        err = ag_drv_hash_mask_set(&mask);
        break;
    }
    ...
    {
        hash_lkup_tbl_cfg_tbl_cfg lkup_tbl_cfg_tbl_cfg = { .hash_base_addr=parm[1].value.unumber, .tbl_size=parm[2].value.unumber, .max_hop=parm[3].value.unumber, .cam_en=parm[4].value.unumber, .direct_lkup_en=parm[5].value.unumber, .hash_type=parm[6].value.unumber, .int_ctx_size=parm[7].value.unumber};
        err = ag_drv_hash_lkup_tbl_cfg_tbl_cfg_set(&lkup_tbl_cfg_tbl_cfg);
        break;
    }
    case cli_hash_lkup_tbl_cfg_cntxt_cfg:
    {
        hash_lkup_tbl_cfg_cntxt_cfg lkup_tbl_cfg_cntxt_cfg = { .base_address=parm[1].value.unumber, .first_hash_idx=parm[2].value.unumber, .ext_ctx_size=parm[3].value.unumber};
        err = ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_set(&lkup_tbl_cfg_cntxt_cfg);
        break;
    }
...
int bcm_hash_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_hash_lkup_tbl_cfg_tbl_cfg:
    {
        ...
        err = ag_drv_hash_lkup_tbl_cfg_tbl_cfg_get(&lkup_tbl_cfg_tbl_cfg);
    ...
    case cli_hash_lkup_tbl_cfg_cntxt_cfg:
    {
        ...
        err = ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_get(&lkup_tbl_cfg_cntxt_cfg);
...
static int bcm_hash_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_hash_mask_set( %u %u)\n", mask.maskl, mask.maskh);
        if(!err) ag_drv_hash_mask_set(&mask);
        if(!err) ag_drv_hash_mask_get( &mask);
        if(!err) bdmf_session_print(session, "ag_drv_hash_mask_get( %u %u)\n", mask.maskl, mask.maskh);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_hash_lkup_tbl_cfg_tbl_cfg_set( %u %u %u %u %u %u %u)\n", lkup_tbl_cfg_tbl_cfg.hash_base_addr, lkup_tbl_cfg_tbl_cfg.tbl_size, lkup_tbl_cfg_tbl_cfg.max_hop, lkup_tbl_cfg_tbl_cfg.cam_en, lkup_tbl_cfg_tbl_cfg.direct_lkup_en, lkup_tbl_cfg_tbl_cfg.hash_type, lkup_tbl_cfg_tbl_cfg.int_ctx_size);
        if(!err) ag_drv_hash_lkup_tbl_cfg_tbl_cfg_set(&lkup_tbl_cfg_tbl_cfg);
        if(!err) ag_drv_hash_lkup_tbl_cfg_tbl_cfg_get( &lkup_tbl_cfg_tbl_cfg);
        if(!err) bdmf_session_print(session, "ag_drv_hash_lkup_tbl_cfg_tbl_cfg_get( %u %u %u %u %u %u %u)\n", lkup_tbl_cfg_tbl_cfg.hash_base_addr, lkup_tbl_cfg_tbl_cfg.tbl_size, lkup_tbl_cfg_tbl_cfg.max_hop, lkup_tbl_cfg_tbl_cfg.cam_en, lkup_tbl_cfg_tbl_cfg.direct_lkup_en, lkup_tbl_cfg_tbl_cfg.hash_type, lkup_tbl_cfg_tbl_cfg.int_ctx_size);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_set( %u %u %u)\n", lkup_tbl_cfg_cntxt_cfg.base_address, lkup_tbl_cfg_cntxt_cfg.first_hash_idx, lkup_tbl_cfg_cntxt_cfg.ext_ctx_size);
        if(!err) ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_set(&lkup_tbl_cfg_cntxt_cfg);
        if(!err) ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_get( &lkup_tbl_cfg_cntxt_cfg);
        if(!err) bdmf_session_print(session, "ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_get( %u %u %u)\n", lkup_tbl_cfg_cntxt_cfg.base_address, lkup_tbl_cfg_cntxt_cfg.first_hash_idx, lkup_tbl_cfg_cntxt_cfg.ext_ctx_size);
...
bdmfmon_handle_t ag_drv_hash_cli_init(bdmfmon_handle_t driver_dir)
{
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="mask", .val=cli_hash_mask, .parms=set_default },
            ...
            { .name="lkup_tbl_cfg_tbl_cfg", .val=cli_hash_lkup_tbl_cfg_tbl_cfg, .parms=set_default },
            { .name="lkup_tbl_cfg_cntxt_cfg", .val=cli_hash_lkup_tbl_cfg_cntxt_cfg, .parms=set_default },
