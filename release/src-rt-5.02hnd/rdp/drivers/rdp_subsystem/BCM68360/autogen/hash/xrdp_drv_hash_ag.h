...
bdmf_error_t ag_drv_hash_mask_set(const hash_mask *mask);
bdmf_error_t ag_drv_hash_mask_get(hash_mask *mask);
...
bdmf_error_t ag_drv_hash_lkup_tbl_cfg_tbl_cfg_set(const hash_lkup_tbl_cfg_tbl_cfg *lkup_tbl_cfg_tbl_cfg);
bdmf_error_t ag_drv_hash_lkup_tbl_cfg_tbl_cfg_get(hash_lkup_tbl_cfg_tbl_cfg *lkup_tbl_cfg_tbl_cfg);
bdmf_error_t ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_set(const hash_lkup_tbl_cfg_cntxt_cfg *lkup_tbl_cfg_cntxt_cfg);
bdmf_error_t ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_get(hash_lkup_tbl_cfg_cntxt_cfg *lkup_tbl_cfg_cntxt_cfg);
