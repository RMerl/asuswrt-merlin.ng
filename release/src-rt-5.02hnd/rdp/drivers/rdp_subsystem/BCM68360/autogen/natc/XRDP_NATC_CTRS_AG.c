...
#if RU_INCLUDE_DESC
    "",
    "32-bit ddr request count value.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "32-bit ddr blocked access count value.",
#endif
