...
/**************************************************************************************************/
/* cache_hit_count:  - 32-bit cache hit count value.                                              */
/* cache_miss_count:  - 32-bit cache miss count value.                                            */
/* ddr_request_count:  - 32-bit ddr request count value.                                          */
/* ddr_evict_count:  - 32-bit ddr evict count value.                                              */
/* ddr_block_count:  - 32-bit ddr blocked access count value.                                     */
/**************************************************************************************************/
typedef struct
{
