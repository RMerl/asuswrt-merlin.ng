...
bdmf_error_t ag_drv_qm_aggr_context_get(uint16_t idx, uint32_t *data, uint32_t *context_valid);
...
bdmf_error_t ag_drv_qm_global_cfg_qm_fpm_buffer_gbl_thr_set(uint8_t res_thr_global);
bdmf_error_t ag_drv_qm_global_cfg_qm_fpm_buffer_gbl_thr_get(uint8_t *res_thr_global);
...
bdmf_error_t ag_drv_qm_dma_qm_dma_config_dbg_sel_set(uint8_t sel);
bdmf_error_t ag_drv_qm_dma_qm_dma_config_dbg_sel_get(uint8_t *sel);
