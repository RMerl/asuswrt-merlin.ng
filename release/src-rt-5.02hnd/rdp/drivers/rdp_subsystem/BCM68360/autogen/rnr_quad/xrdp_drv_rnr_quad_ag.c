...
bdmf_error_t ag_drv_rnr_quad_parser_da_filter_set(uint8_t quad_idx, const rnr_quad_parser_da_filter *parser_da_filter)
{
    ...
    reg_parser_core_configuration_da_filt0_mask_l = RU_FIELD_SET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT0_MASK_L, DA_FILT0_MASK_L, reg_parser_core_configuration_da_filt0_mask_l, parser_da_filter->da_filt_mask_l);
...
bdmf_error_t ag_drv_rnr_quad_parser_da_filter_get(uint8_t quad_idx, rnr_quad_parser_da_filter *parser_da_filter)
{
    ...
    parser_da_filter->da_filt_mask_l = RU_FIELD_GET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT0_MASK_L, DA_FILT0_MASK_L, reg_parser_core_configuration_da_filt0_mask_l);
