...
bdmf_error_t ag_drv_bbh_rx_general_configuration_g9991en_set(uint8_t bbh_id, bdmf_boolean enable)
{
...
bdmf_error_t ag_drv_bbh_rx_general_configuration_g9991en_get(uint8_t bbh_id, bdmf_boolean *enable)
{
...
static int bcm_bbh_rx_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_bbh_rx_general_configuration_g9991en:
        err = ag_drv_bbh_rx_general_configuration_g9991en_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
...
int bcm_bbh_rx_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        bdmf_boolean enable;
        err = ag_drv_bbh_rx_general_configuration_g9991en_get(parm[1].value.unumber, &enable);
...
static int bcm_bbh_rx_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_general_configuration_g9991en_set(%u %u)\n", bbh_id, enable);
        if(!err) ag_drv_bbh_rx_general_configuration_g9991en_set(bbh_id, enable);
        if(!err) ag_drv_bbh_rx_general_configuration_g9991en_get( bbh_id, &enable);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_rx_general_configuration_g9991en_get(%u %u)\n", bbh_id, enable);
