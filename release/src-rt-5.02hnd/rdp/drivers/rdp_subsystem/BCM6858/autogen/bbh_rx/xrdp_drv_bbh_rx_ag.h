...
enum
{
    ...
    cli_bbh_rx_min_pkt_sel_flows_0_31,
    cli_bbh_rx_general_configuration_minpktsel1,
    cli_bbh_rx_max_pkt_sel_flows_0_31,
    cli_bbh_rx_general_configuration_maxpktsel1,
