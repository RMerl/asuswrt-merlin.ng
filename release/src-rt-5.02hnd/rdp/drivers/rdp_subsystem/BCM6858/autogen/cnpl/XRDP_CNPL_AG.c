...
#if RU_INCLUDE_DESC
    "PL_RDX %i Register",
    "rdata register - policer read command result. 2 register for 2 buckets",
#endif
...
#if RU_INCLUDE_DESC
    "CNT_RDX %i Register",
    "rdata register - counters read command result. 8 register for 32B batch",
#endif
...
const ru_reg_rec CNPL_PM_COUNTERS_GNT_CYC_REG = 
{
    ...
    "Number of cycles that there was gnt from arbiter",
#endif
