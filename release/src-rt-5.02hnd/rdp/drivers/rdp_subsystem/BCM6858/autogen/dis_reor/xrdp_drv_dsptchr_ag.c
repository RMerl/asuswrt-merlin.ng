...
bdmf_error_t ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_set(bdmf_boolean disp_enable, bdmf_boolean rdy)
{
    uint32_t reg_reorder_cfg_dsptchr_reordr_cfg=0;

#ifdef VALIDATE_PARMS
    if((disp_enable >= _1BITS_MAX_VAL_) ||
       (rdy >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    ...
    reg_reorder_cfg_dsptchr_reordr_cfg = RU_FIELD_SET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, EN, reg_reorder_cfg_dsptchr_reordr_cfg, disp_enable);
    reg_reorder_cfg_dsptchr_reordr_cfg = RU_FIELD_SET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, RDY, reg_reorder_cfg_dsptchr_reordr_cfg, rdy);
...
bdmf_error_t ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_get(bdmf_boolean *disp_enable, bdmf_boolean *rdy)
{
    ...
    *disp_enable = RU_FIELD_GET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, EN, reg_reorder_cfg_dsptchr_reordr_cfg);
    *rdy = RU_FIELD_GET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, RDY, reg_reorder_cfg_dsptchr_reordr_cfg);
...
bdmf_error_t ag_drv_dsptchr_congestion_glbl_congstn_set(uint8_t viq_idx, const dsptchr_cngs_params *cngs_params)
{
    /* Identical to cngs_params */
    uint32_t reg_congestion_ingrs_congstn=0;
    ...
    RU_REG_RAM_WRITE(0, viq_idx, DSPTCHR, CONGESTION_GLBL_CONGSTN, reg_congestion_ingrs_congstn);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_dsptchr_congestion_glbl_congstn_get(uint8_t viq_idx, dsptchr_cngs_params *cngs_params)
{
    /* Identical to cngs_params */
    uint32_t reg_congestion_ingrs_congstn;
    ...
    RU_REG_RAM_READ(0, viq_idx, DSPTCHR, CONGESTION_GLBL_CONGSTN, reg_congestion_ingrs_congstn);
...
bdmf_error_t ag_drv_dsptchr_egrs_queues_q_egrs_size_set(uint16_t egrs_size)
{
    uint32_t reg_egrs_queues_q_egrs_size=0;

#ifdef VALIDATE_PARMS
    if((egrs_size >= _10BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_egrs_queues_q_egrs_size = RU_FIELD_SET(0, DSPTCHR, EGRS_QUEUES_Q_EGRS_SIZE, EGRS_SIZE, reg_egrs_queues_q_egrs_size, egrs_size);

    RU_REG_WRITE(0, DSPTCHR, EGRS_QUEUES_Q_EGRS_SIZE, reg_egrs_queues_q_egrs_size);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_dsptchr_egrs_queues_q_egrs_size_get(uint16_t *egrs_size)
{
    uint32_t reg_egrs_queues_q_egrs_size;
    ...
    RU_REG_READ(0, DSPTCHR, EGRS_QUEUES_Q_EGRS_SIZE, reg_egrs_queues_q_egrs_size);

    *egrs_size = RU_FIELD_GET(0, DSPTCHR, EGRS_QUEUES_Q_EGRS_SIZE, EGRS_SIZE, reg_egrs_queues_q_egrs_size);
...
bdmf_error_t ag_drv_dsptchr_load_balancing_lb_cfg_set(bdmf_boolean lb_mode, uint8_t lb_thrshld)
{
    uint32_t reg_load_balancing_lb_cfg=0;

#ifdef VALIDATE_PARMS
    if((lb_mode >= _1BITS_MAX_VAL_) ||
       (lb_thrshld >= _4BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_load_balancing_lb_cfg = RU_FIELD_SET(0, DSPTCHR, LOAD_BALANCING_LB_CFG, LB_THRSHLD, reg_load_balancing_lb_cfg, lb_thrshld);
...
bdmf_error_t ag_drv_dsptchr_load_balancing_lb_cfg_get(bdmf_boolean *lb_mode, uint8_t *lb_thrshld)
{
    uint32_t reg_load_balancing_lb_cfg;

#ifdef VALIDATE_PARMS
    if(!lb_mode || !lb_thrshld)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    *lb_thrshld = RU_FIELD_GET(0, DSPTCHR, LOAD_BALANCING_LB_CFG, LB_THRSHLD, reg_load_balancing_lb_cfg);
...
bdmf_error_t ag_drv_dsptchr_bdram_data_set(uint16_t temp_index, uint16_t data)
{
    ...
    reg_bdram_data = RU_FIELD_SET(0, DSPTCHR, BDRAM_DATA, DATA, reg_bdram_data, data);

    RU_REG_RAM_WRITE(0, temp_index, DSPTCHR, BDRAM_DATA, reg_bdram_data);
...
bdmf_error_t ag_drv_dsptchr_bdram_data_get(uint16_t temp_index, uint16_t *data)
{
    ...
    RU_REG_RAM_READ(0, temp_index, DSPTCHR, BDRAM_DATA, reg_bdram_data);

    *data = RU_FIELD_GET(0, DSPTCHR, BDRAM_DATA, DATA, reg_bdram_data);
...
typedef enum
{
    ...
    bdmf_address_egrs_queues_q_egrs_size,
...
static int bcm_dsptchr_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_dsptchr_reorder_cfg_dsptchr_reordr_cfg:
        err = ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    ...
    case cli_dsptchr_congestion_glbl_congstn:
    {
        dsptchr_cngs_params cngs_params = { .frst_lvl=parm[2].value.unumber, .scnd_lvl=parm[3].value.unumber, .hyst_thrs=parm[4].value.unumber};
        err = ag_drv_dsptchr_congestion_glbl_congstn_set(parm[1].value.unumber, &cngs_params);
        break;
    }
    ...
    case cli_dsptchr_egrs_queues_egrs_non_dly_qm_crdt:
        ...
        break;
    case cli_dsptchr_egrs_queues_q_egrs_size:
        err = ag_drv_dsptchr_egrs_queues_q_egrs_size_set(parm[1].value.unumber);
        break;
    ...
    case cli_dsptchr_flldes_flldrop:
        ...
        break;
    case cli_dsptchr_bdram_data:
        err = ag_drv_dsptchr_bdram_data_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
...
int bcm_dsptchr_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_dsptchr_reorder_cfg_dsptchr_reordr_cfg:
    {
        ...
        bdmf_boolean rdy;
        err = ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_get(&disp_enable, &rdy);
    ...
    {
        dsptchr_cngs_params cngs_params;
        err = ag_drv_dsptchr_congestion_glbl_congstn_get(parm[1].value.unumber, &cngs_params);
        bdmf_session_print(session, "frst_lvl = %u (0x%x)\n", cngs_params.frst_lvl, cngs_params.frst_lvl);
        bdmf_session_print(session, "scnd_lvl = %u (0x%x)\n", cngs_params.scnd_lvl, cngs_params.scnd_lvl);
        bdmf_session_print(session, "hyst_thrs = %u (0x%x)\n", cngs_params.hyst_thrs, cngs_params.hyst_thrs);
        break;
    ...
    {
        uint16_t egrs_size;
        err = ag_drv_dsptchr_egrs_queues_q_egrs_size_get(&egrs_size);
        bdmf_session_print(session, "egrs_size = %u (0x%x)\n", egrs_size, egrs_size);
        break;
    }
    case cli_dsptchr_wakeup_control_wkup_req:
    {
    ...
    case cli_dsptchr_load_balancing_lb_cfg:
    {
        ...
        uint8_t lb_thrshld;
        err = ag_drv_dsptchr_load_balancing_lb_cfg_get(&lb_mode, &lb_thrshld);
        bdmf_session_print(session, "lb_mode = %u (0x%x)\n", lb_mode, lb_mode);
        bdmf_session_print(session, "lb_thrshld = %u (0x%x)\n", lb_thrshld, lb_thrshld);
        break;
    }
    case cli_dsptchr_load_balancing_free_task_0_1:
    {
    ...
    {
        uint16_t data;
        err = ag_drv_dsptchr_bdram_data_get(parm[1].value.unumber, &data);
...
static int bcm_dsptchr_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        bdmf_boolean disp_enable=gtmv(m, 1);
        bdmf_boolean rdy=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_set( %u %u)\n", disp_enable, rdy);
        if(!err) ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_set(disp_enable, rdy);
        if(!err) ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_get( &disp_enable, &rdy);
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_get( %u %u)\n", disp_enable, rdy);
        if(err || disp_enable!=gtmv(m, 1) || rdy!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    }
    {
        uint8_t viq_idx=gtmv(m, 5);
        dsptchr_cngs_params cngs_params = {.frst_lvl=gtmv(m, 12), .scnd_lvl=gtmv(m, 12), .hyst_thrs=gtmv(m, 8)};
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_congestion_glbl_congstn_set( %u %u %u %u)\n", viq_idx, cngs_params.frst_lvl, cngs_params.scnd_lvl, cngs_params.hyst_thrs);
        if(!err) ag_drv_dsptchr_congestion_glbl_congstn_set(viq_idx, &cngs_params);
        if(!err) ag_drv_dsptchr_congestion_glbl_congstn_get( viq_idx, &cngs_params);
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_congestion_glbl_congstn_get( %u %u %u %u)\n", viq_idx, cngs_params.frst_lvl, cngs_params.scnd_lvl, cngs_params.hyst_thrs);
        if(err || cngs_params.frst_lvl!=gtmv(m, 12) || cngs_params.scnd_lvl!=gtmv(m, 12) || cngs_params.hyst_thrs!=gtmv(m, 8))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        uint16_t egrs_size=gtmv(m, 10);
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_egrs_queues_q_egrs_size_set( %u)\n", egrs_size);
        if(!err) ag_drv_dsptchr_egrs_queues_q_egrs_size_set(egrs_size);
        if(!err) ag_drv_dsptchr_egrs_queues_q_egrs_size_get( &egrs_size);
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_egrs_queues_q_egrs_size_get( %u)\n", egrs_size);
        if(err || egrs_size!=gtmv(m, 10))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    }
    {
        ...
        uint8_t lb_thrshld=gtmv(m, 4);
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_lb_cfg_set( %u %u)\n", lb_mode, lb_thrshld);
        if(!err) ag_drv_dsptchr_load_balancing_lb_cfg_set(lb_mode, lb_thrshld);
        if(!err) ag_drv_dsptchr_load_balancing_lb_cfg_get( &lb_mode, &lb_thrshld);
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_lb_cfg_get( %u %u)\n", lb_mode, lb_thrshld);
        if(err || lb_mode!=gtmv(m, 1) || lb_thrshld!=gtmv(m, 4))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_bdram_data_set( %u %u)\n", temp_index, data);
        if(!err) ag_drv_dsptchr_bdram_data_set(temp_index, data);
        if(!err) ag_drv_dsptchr_bdram_data_get( temp_index, &data);
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_bdram_data_get( %u %u)\n", temp_index, data);
...
static int bcm_dsptchr_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case bdmf_address_egrs_queues_q_egrs_size : reg = &RU_REG(DSPTCHR, EGRS_QUEUES_Q_EGRS_SIZE); blk = &RU_BLK(DSPTCHR); break;
    ...
    case bdmf_address_bdram_data : reg = &RU_REG(DSPTCHR, BDRAM_DATA); blk = &RU_BLK(DSPTCHR); break;
...
bdmfmon_handle_t ag_drv_dsptchr_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_egrs_queues_q_egrs_size[]={
            BDMFMON_MAKE_PARM("egrs_size", "egrs_size", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_load_balancing_lb_cfg[]={
            ...
            BDMFMON_MAKE_PARM("lb_thrshld", "lb_thrshld", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_bdram_data[]={
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="congestion_glbl_congstn", .val=cli_dsptchr_congestion_glbl_congstn, .parms=set_cngs_params },
            ...
            { .name="egrs_queues_q_egrs_size", .val=cli_dsptchr_egrs_queues_q_egrs_size, .parms=set_egrs_queues_q_egrs_size },
            ...
            { .name="bdram_data", .val=cli_dsptchr_bdram_data, .parms=set_bdram_data },
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="egrs_queues_q_egrs_size", .val=cli_dsptchr_egrs_queues_q_egrs_size, .parms=set_default },
    ...
    }
    {
        static bdmfmon_enum_val_t enum_table_address[] = {
            ...
            { .name="EGRS_QUEUES_Q_EGRS_SIZE" , .val=bdmf_address_egrs_queues_q_egrs_size },
            ...
            { .name="BDRAM_DATA" , .val=bdmf_address_bdram_data },
