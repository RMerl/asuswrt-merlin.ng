...
/******************************************************************************
 * Field: DQM_DQMOL_CFGC_RESERVED0
 ******************************************************************************/
const ru_field_rec DQM_DQMOL_CFGC_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    DQM_DQMOL_CFGC_RESERVED0_FIELD_MASK,
    0,
    DQM_DQMOL_CFGC_RESERVED0_FIELD_WIDTH,
    DQM_DQMOL_CFGC_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Register: DQM_DQMOL_CFGC
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *DQM_DQMOL_CFGC_FIELDS[] =
{
...
const ru_reg_rec DQM_DQMOL_CFGC_REG = 
{
    "DQMOL_CFGC",
#if RU_INCLUDE_DESC
    "Queue Config C Register",
    "high watermark setting ",
#endif
    DQM_DQMOL_CFGC_REG_OFFSET,
    DQM_DQMOL_CFGC_REG_RAM_CNT,
    32,
    248,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
