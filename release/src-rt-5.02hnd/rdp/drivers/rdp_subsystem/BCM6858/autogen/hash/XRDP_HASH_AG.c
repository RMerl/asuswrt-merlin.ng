...
/******************************************************************************
 * Field: HASH_CONTEXT_RAM_CONTEXT_3B_data_DATA
 ******************************************************************************/
const ru_field_rec HASH_CONTEXT_RAM_CONTEXT_3B_data_DATA_FIELD =
{
    "DATA",
#if RU_INCLUDE_DESC
    "DATA",
    ".",
#endif
    HASH_CONTEXT_RAM_CONTEXT_3B_data_DATA_FIELD_MASK,
    0,
    HASH_CONTEXT_RAM_CONTEXT_3B_data_DATA_FIELD_WIDTH,
    HASH_CONTEXT_RAM_CONTEXT_3B_data_DATA_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: HASH_CONTEXT_RAM_CONTEXT_3B_data_RESERVED0
 ******************************************************************************/
const ru_field_rec HASH_CONTEXT_RAM_CONTEXT_3B_data_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    HASH_CONTEXT_RAM_CONTEXT_3B_data_RESERVED0_FIELD_MASK,
    0,
    HASH_CONTEXT_RAM_CONTEXT_3B_data_RESERVED0_FIELD_WIDTH,
    HASH_CONTEXT_RAM_CONTEXT_3B_data_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Register: HASH_CONTEXT_RAM_CONTEXT_3B_data
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *HASH_CONTEXT_RAM_CONTEXT_3B_data_FIELDS[] =
{
    &HASH_CONTEXT_RAM_CONTEXT_3B_data_DATA_FIELD,
    &HASH_CONTEXT_RAM_CONTEXT_3B_data_RESERVED0_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec HASH_CONTEXT_RAM_CONTEXT_3B_data_REG = 
{
    "CONTEXT_RAM_CONTEXT_3B_data",
#if RU_INCLUDE_DESC
    "CONTEXT_3B_data Register",
    "3B of extarnal context data",
#endif
    HASH_CONTEXT_RAM_CONTEXT_3B_data_REG_OFFSET,
    HASH_CONTEXT_RAM_CONTEXT_3B_data_REG_RAM_CNT,
    4,
    788,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
...
#if RU_INCLUDE_FIELD_DB
    2,
    HASH_CONTEXT_RAM_CONTEXT_3B_data_FIELDS
#endif /* RU_INCLUDE_FIELD_DB */
};
...
const ru_reg_rec HASH_RAM_ENG_HIGH_REG = 
{
    "RAM_ENG_HIGH",
#if RU_INCLUDE_DESC
    "ENG0_BITS_63_32 Register",
    "Includes the MSB field of the entry",
#endif
...
static const ru_reg_rec *HASH_REGS[] =
{
    ...
    &HASH_CONTEXT_RAM_CONTEXT_3B_data_REG,
