...
bdmf_error_t ag_drv_qm_ddr_cong_ctrl_set(const qm_ddr_cong_ctrl *ddr_cong_ctrl)
{
    ...
    if((ddr_cong_ctrl->ddr_byte_congestion_drop_enabl >= _1BITS_MAX_VAL_) ||
       (ddr_cong_ctrl->ddr_bytes_lower_thr >= _28BITS_MAX_VAL_) ||
       (ddr_cong_ctrl->ddr_bytes_mid_thr >= _28BITS_MAX_VAL_) ||
       (ddr_cong_ctrl->ddr_bytes_higher_thr >= _28BITS_MAX_VAL_) ||
    ...
    reg_global_cfg_ddr_byte_congestion_control = RU_FIELD_SET(0, QM, GLOBAL_CFG_DDR_BYTE_CONGESTION_CONTROL, DDR_BYTE_CONGESTION_DROP_ENABL, reg_global_cfg_ddr_byte_congestion_control, ddr_cong_ctrl->ddr_byte_congestion_drop_enabl);
...
bdmf_error_t ag_drv_qm_ddr_cong_ctrl_get(qm_ddr_cong_ctrl *ddr_cong_ctrl)
{
    ...
    ddr_cong_ctrl->ddr_byte_congestion_drop_enabl = RU_FIELD_GET(0, QM, GLOBAL_CFG_DDR_BYTE_CONGESTION_CONTROL, DDR_BYTE_CONGESTION_DROP_ENABL, reg_global_cfg_ddr_byte_congestion_control);
...
bdmf_error_t ag_drv_qm_aggr_context_get(uint16_t idx, uint32_t *data, uint32_t *context_valid)
{
    ...
    RU_REG_RAM_READ(0, idx, QM, CONTEXT_DATA, reg_context_data);
    RU_REG_RAM_READ(0, idx, QM, GLOBAL_CFG_AGGREGATION_CONTEXT_VALID, reg_global_cfg_aggregation_context_valid);

    *data = RU_FIELD_GET(0, QM, CONTEXT_DATA, DATA, reg_context_data);
...
bdmf_error_t ag_drv_qm_wred_profile_cfg_set(uint8_t profile_idx, const qm_wred_profile_cfg *wred_profile_cfg)
{
    ...
    if((profile_idx >= 16) ||
       (wred_profile_cfg->min_thr0 >= _22BITS_MAX_VAL_) ||
       (wred_profile_cfg->min_thr1 >= _22BITS_MAX_VAL_) ||
       (wred_profile_cfg->max_thr0 >= _22BITS_MAX_VAL_) ||
       (wred_profile_cfg->max_thr1 >= _22BITS_MAX_VAL_) ||
...
bdmf_error_t ag_drv_qm_debug_info_set(const qm_debug_info *debug_info)
{
    ...
    if((debug_info->eth0rxne >= _1BITS_MAX_VAL_) ||
    ...
    reg_dma_qm_dma_debug_nempty = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH0RXNE, reg_dma_qm_dma_debug_nempty, debug_info->eth0rxne);
    reg_dma_qm_dma_debug_nempty = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH1RXNE, reg_dma_qm_dma_debug_nempty, debug_info->eth1rxne);
    reg_dma_qm_dma_debug_nempty = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH2RXNE, reg_dma_qm_dma_debug_nempty, debug_info->eth2rxne);
    reg_dma_qm_dma_debug_nempty = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH3RXNE, reg_dma_qm_dma_debug_nempty, debug_info->eth3rxne);
    reg_dma_qm_dma_debug_nempty = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH4RXNE, reg_dma_qm_dma_debug_nempty, debug_info->eth4rxne);
    reg_dma_qm_dma_debug_nempty = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, GPONRXNE, reg_dma_qm_dma_debug_nempty, debug_info->gponrxne);
    reg_dma_qm_dma_debug_nempty = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH0TXNE, reg_dma_qm_dma_debug_nempty, debug_info->eth0txne);
    reg_dma_qm_dma_debug_nempty = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH1TXNE, reg_dma_qm_dma_debug_nempty, debug_info->eth1txne);
    reg_dma_qm_dma_debug_nempty = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH2TXNE, reg_dma_qm_dma_debug_nempty, debug_info->eth2txne);
    reg_dma_qm_dma_debug_nempty = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH3TXNE, reg_dma_qm_dma_debug_nempty, debug_info->eth3txne);
    reg_dma_qm_dma_debug_nempty = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH4TXNE, reg_dma_qm_dma_debug_nempty, debug_info->eth4txne);
    reg_dma_qm_dma_debug_nempty = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, GPONTXNE, reg_dma_qm_dma_debug_nempty, debug_info->gpontxne);
    reg_dma_qm_dma_debug_urgnt = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH0RXU, reg_dma_qm_dma_debug_urgnt, debug_info->eth0rxu);
    reg_dma_qm_dma_debug_urgnt = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH1RXU, reg_dma_qm_dma_debug_urgnt, debug_info->eth1rxu);
    reg_dma_qm_dma_debug_urgnt = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH2RXU, reg_dma_qm_dma_debug_urgnt, debug_info->eth2rxu);
    reg_dma_qm_dma_debug_urgnt = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH3RXU, reg_dma_qm_dma_debug_urgnt, debug_info->eth3rxu);
    reg_dma_qm_dma_debug_urgnt = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH4RXU, reg_dma_qm_dma_debug_urgnt, debug_info->eth4rxu);
    reg_dma_qm_dma_debug_urgnt = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_URGNT, GPONRXU, reg_dma_qm_dma_debug_urgnt, debug_info->gponrxu);
    reg_dma_qm_dma_debug_urgnt = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH0TXU, reg_dma_qm_dma_debug_urgnt, debug_info->eth0txu);
    reg_dma_qm_dma_debug_urgnt = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH1TXU, reg_dma_qm_dma_debug_urgnt, debug_info->eth1txu);
    reg_dma_qm_dma_debug_urgnt = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH2TXU, reg_dma_qm_dma_debug_urgnt, debug_info->eth2txu);
    reg_dma_qm_dma_debug_urgnt = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH3TXU, reg_dma_qm_dma_debug_urgnt, debug_info->eth3txu);
    reg_dma_qm_dma_debug_urgnt = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH4TXU, reg_dma_qm_dma_debug_urgnt, debug_info->eth4txu);
    reg_dma_qm_dma_debug_urgnt = RU_FIELD_SET(0, QM, DMA_QM_DMA_DEBUG_URGNT, GPONTXU, reg_dma_qm_dma_debug_urgnt, debug_info->gpontxu);
...
bdmf_error_t ag_drv_qm_debug_info_get(qm_debug_info *debug_info)
{
    ...
    debug_info->eth0rxne = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH0RXNE, reg_dma_qm_dma_debug_nempty);
    debug_info->eth1rxne = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH1RXNE, reg_dma_qm_dma_debug_nempty);
    debug_info->eth2rxne = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH2RXNE, reg_dma_qm_dma_debug_nempty);
    debug_info->eth3rxne = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH3RXNE, reg_dma_qm_dma_debug_nempty);
    debug_info->eth4rxne = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH4RXNE, reg_dma_qm_dma_debug_nempty);
    debug_info->gponrxne = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, GPONRXNE, reg_dma_qm_dma_debug_nempty);
    debug_info->eth0txne = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH0TXNE, reg_dma_qm_dma_debug_nempty);
    debug_info->eth1txne = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH1TXNE, reg_dma_qm_dma_debug_nempty);
    debug_info->eth2txne = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH2TXNE, reg_dma_qm_dma_debug_nempty);
    debug_info->eth3txne = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH3TXNE, reg_dma_qm_dma_debug_nempty);
    debug_info->eth4txne = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, ETH4TXNE, reg_dma_qm_dma_debug_nempty);
    debug_info->gpontxne = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_NEMPTY, GPONTXNE, reg_dma_qm_dma_debug_nempty);
    debug_info->eth0rxu = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH0RXU, reg_dma_qm_dma_debug_urgnt);
    debug_info->eth1rxu = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH1RXU, reg_dma_qm_dma_debug_urgnt);
    debug_info->eth2rxu = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH2RXU, reg_dma_qm_dma_debug_urgnt);
    debug_info->eth3rxu = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH3RXU, reg_dma_qm_dma_debug_urgnt);
    debug_info->eth4rxu = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH4RXU, reg_dma_qm_dma_debug_urgnt);
    debug_info->gponrxu = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_URGNT, GPONRXU, reg_dma_qm_dma_debug_urgnt);
    debug_info->eth0txu = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH0TXU, reg_dma_qm_dma_debug_urgnt);
    debug_info->eth1txu = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH1TXU, reg_dma_qm_dma_debug_urgnt);
    debug_info->eth2txu = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH2TXU, reg_dma_qm_dma_debug_urgnt);
    debug_info->eth3txu = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH3TXU, reg_dma_qm_dma_debug_urgnt);
    debug_info->eth4txu = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_URGNT, ETH4TXU, reg_dma_qm_dma_debug_urgnt);
    debug_info->gpontxu = RU_FIELD_GET(0, QM, DMA_QM_DMA_DEBUG_URGNT, GPONTXU, reg_dma_qm_dma_debug_urgnt);
...
bdmf_error_t ag_drv_qm_drop_counters_ctrl_set(const qm_drop_counters_ctrl *drop_counters_ctrl)
{
    ...
    if((drop_counters_ctrl->read_clear_pkts >= _1BITS_MAX_VAL_) ||
       ...
       (drop_counters_ctrl->queue_occupancy_ddr_copy_decis >= _1BITS_MAX_VAL_) ||
       (drop_counters_ctrl->psram_occupancy_ddr_copy_decis >= _1BITS_MAX_VAL_) ||
       (drop_counters_ctrl->dont_send_mc_bit_to_bbh >= _1BITS_MAX_VAL_) ||
       (drop_counters_ctrl->close_aggregation_on_empty_que >= _1BITS_MAX_VAL_) ||
       (drop_counters_ctrl->fpm_congestion_buf_release_mec >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_global_cfg_qm_general_ctrl = RU_FIELD_SET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, DROP_CNT_PKTS_READ_CLEAR_ENABL, reg_global_cfg_qm_general_ctrl, drop_counters_ctrl->read_clear_pkts);
    reg_global_cfg_qm_general_ctrl = RU_FIELD_SET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, DROP_CNT_BYTES_READ_CLEAR_ENAB, reg_global_cfg_qm_general_ctrl, drop_counters_ctrl->read_clear_bytes);
    reg_global_cfg_qm_general_ctrl = RU_FIELD_SET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, DROP_CNT_MAX_OCCUPANCY_PKTS_SE, reg_global_cfg_qm_general_ctrl, drop_counters_ctrl->disable_wrap_around_pkts);
    reg_global_cfg_qm_general_ctrl = RU_FIELD_SET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, DROP_CNT_MAX_OCCUPANCY_BYTES_S, reg_global_cfg_qm_general_ctrl, drop_counters_ctrl->disable_wrap_around_bytes);
    ...
    reg_global_cfg_qm_general_ctrl = RU_FIELD_SET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, QUEUE_OCCUPANCY_DDR_COPY_DECIS, reg_global_cfg_qm_general_ctrl, drop_counters_ctrl->queue_occupancy_ddr_copy_decis);
    reg_global_cfg_qm_general_ctrl = RU_FIELD_SET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, PSRAM_OCCUPANCY_DDR_COPY_DECIS, reg_global_cfg_qm_general_ctrl, drop_counters_ctrl->psram_occupancy_ddr_copy_decis);
    ...
    reg_global_cfg_qm_general_ctrl = RU_FIELD_SET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, CLOSE_AGGREGATION_ON_EMPTY_QUE, reg_global_cfg_qm_general_ctrl, drop_counters_ctrl->close_aggregation_on_empty_que);
    reg_global_cfg_qm_general_ctrl = RU_FIELD_SET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, FPM_CONGESTION_BUF_RELEASE_MEC, reg_global_cfg_qm_general_ctrl, drop_counters_ctrl->fpm_congestion_buf_release_mec);
...
bdmf_error_t ag_drv_qm_drop_counters_ctrl_get(qm_drop_counters_ctrl *drop_counters_ctrl)
{
    ...
    drop_counters_ctrl->read_clear_pkts = RU_FIELD_GET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, DROP_CNT_PKTS_READ_CLEAR_ENABL, reg_global_cfg_qm_general_ctrl);
    drop_counters_ctrl->read_clear_bytes = RU_FIELD_GET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, DROP_CNT_BYTES_READ_CLEAR_ENAB, reg_global_cfg_qm_general_ctrl);
    drop_counters_ctrl->disable_wrap_around_pkts = RU_FIELD_GET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, DROP_CNT_MAX_OCCUPANCY_PKTS_SE, reg_global_cfg_qm_general_ctrl);
    drop_counters_ctrl->disable_wrap_around_bytes = RU_FIELD_GET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, DROP_CNT_MAX_OCCUPANCY_BYTES_S, reg_global_cfg_qm_general_ctrl);
    ...
    drop_counters_ctrl->queue_occupancy_ddr_copy_decis = RU_FIELD_GET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, QUEUE_OCCUPANCY_DDR_COPY_DECIS, reg_global_cfg_qm_general_ctrl);
    drop_counters_ctrl->psram_occupancy_ddr_copy_decis = RU_FIELD_GET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, PSRAM_OCCUPANCY_DDR_COPY_DECIS, reg_global_cfg_qm_general_ctrl);
    ...
    drop_counters_ctrl->close_aggregation_on_empty_que = RU_FIELD_GET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, CLOSE_AGGREGATION_ON_EMPTY_QUE, reg_global_cfg_qm_general_ctrl);
    drop_counters_ctrl->fpm_congestion_buf_release_mec = RU_FIELD_GET(0, QM, GLOBAL_CFG_QM_GENERAL_CTRL, FPM_CONGESTION_BUF_RELEASE_MEC, reg_global_cfg_qm_general_ctrl);
...
bdmf_error_t ag_drv_qm_intr_ctrl_isr_set(const qm_intr_ctrl_isr *intr_ctrl_isr)
{
    ...
    if((intr_ctrl_isr->qm_dqm_pop_on_empty >= _1BITS_MAX_VAL_) ||
       ...
       (intr_ctrl_isr->qm_non_delayed_queue_pd_no_cre >= _1BITS_MAX_VAL_) ||
       ...
       (intr_ctrl_isr->qm_target_mem_abs_contradictio >= _1BITS_MAX_VAL_) ||
       (intr_ctrl_isr->qm_target_mem_force_copy_contr >= _1BITS_MAX_VAL_) ||
       (intr_ctrl_isr->qm_1588_multicast_contradictio >= _1BITS_MAX_VAL_) ||
    ...
    reg_intr_ctrl_isr = RU_FIELD_SET(0, QM, INTR_CTRL_ISR, QM_NON_DELAYED_QUEUE_PD_NO_CRE, reg_intr_ctrl_isr, intr_ctrl_isr->qm_non_delayed_queue_pd_no_cre);
    ...
    reg_intr_ctrl_isr = RU_FIELD_SET(0, QM, INTR_CTRL_ISR, QM_TARGET_MEM_ABS_CONTRADICTIO, reg_intr_ctrl_isr, intr_ctrl_isr->qm_target_mem_abs_contradictio);
    reg_intr_ctrl_isr = RU_FIELD_SET(0, QM, INTR_CTRL_ISR, QM_TARGET_MEM_FORCE_COPY_CONTR, reg_intr_ctrl_isr, intr_ctrl_isr->qm_target_mem_force_copy_contr);
    reg_intr_ctrl_isr = RU_FIELD_SET(0, QM, INTR_CTRL_ISR, QM_1588_MULTICAST_CONTRADICTIO, reg_intr_ctrl_isr, intr_ctrl_isr->qm_1588_multicast_contradictio);
...
bdmf_error_t ag_drv_qm_intr_ctrl_isr_get(qm_intr_ctrl_isr *intr_ctrl_isr)
{
    ...
    intr_ctrl_isr->qm_non_delayed_queue_pd_no_cre = RU_FIELD_GET(0, QM, INTR_CTRL_ISR, QM_NON_DELAYED_QUEUE_PD_NO_CRE, reg_intr_ctrl_isr);
    ...
    intr_ctrl_isr->qm_target_mem_abs_contradictio = RU_FIELD_GET(0, QM, INTR_CTRL_ISR, QM_TARGET_MEM_ABS_CONTRADICTIO, reg_intr_ctrl_isr);
    intr_ctrl_isr->qm_target_mem_force_copy_contr = RU_FIELD_GET(0, QM, INTR_CTRL_ISR, QM_TARGET_MEM_FORCE_COPY_CONTR, reg_intr_ctrl_isr);
    intr_ctrl_isr->qm_1588_multicast_contradictio = RU_FIELD_GET(0, QM, INTR_CTRL_ISR, QM_1588_MULTICAST_CONTRADICTIO, reg_intr_ctrl_isr);
...
bdmf_error_t ag_drv_qm_q_context_set(uint16_t q_idx, const qm_q_context *q_context)
{
    ...
    if((q_idx >= 288) ||
       ...
       (q_context->fpm_ug >= _2BITS_MAX_VAL_) ||
...
#ifdef VALIDATE_PARMS
    if((profile_idx >= 8) ||
       (queue_occupancy_thr >= _28BITS_MAX_VAL_) ||
...
bdmf_error_t ag_drv_qm_fpm_pool_drop_cnt_get(uint32_t *fpm_drop)
{
    ...
    RU_REG_READ(0, QM, FPM_POOL_DROP_CNT, reg_fpm_pool_drop_cnt);
...
bdmf_error_t ag_drv_qm_fpm_grp_drop_cnt_get(uint32_t *fpm_grp_drop)
{
    ...
    RU_REG_READ(0, QM, FPM_GRP_DROP_CNT, reg_fpm_grp_drop_cnt);
...
bdmf_error_t ag_drv_qm_dma_qm_dma_config_ptrrst_set(const qm_dma_qm_dma_config_ptrrst *dma_qm_dma_config_ptrrst)
{
    uint32_t reg_dma_qm_dma_config_ptrrst=0;

#ifdef VALIDATE_PARMS
    if(!dma_qm_dma_config_ptrrst)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    if((dma_qm_dma_config_ptrrst->eth0rx >= _1BITS_MAX_VAL_) ||
       (dma_qm_dma_config_ptrrst->eth0tx >= _1BITS_MAX_VAL_) ||
       (dma_qm_dma_config_ptrrst->eth1rx >= _1BITS_MAX_VAL_) ||
       (dma_qm_dma_config_ptrrst->eth1tx >= _1BITS_MAX_VAL_) ||
       (dma_qm_dma_config_ptrrst->eth2rx >= _1BITS_MAX_VAL_) ||
       (dma_qm_dma_config_ptrrst->eth2tx >= _1BITS_MAX_VAL_) ||
       (dma_qm_dma_config_ptrrst->eth3rx >= _1BITS_MAX_VAL_) ||
       (dma_qm_dma_config_ptrrst->eth3tx >= _1BITS_MAX_VAL_) ||
       (dma_qm_dma_config_ptrrst->eth4rx >= _1BITS_MAX_VAL_) ||
       (dma_qm_dma_config_ptrrst->eth4tx >= _1BITS_MAX_VAL_) ||
       (dma_qm_dma_config_ptrrst->gponrx >= _1BITS_MAX_VAL_) ||
       (dma_qm_dma_config_ptrrst->gpontx >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_dma_qm_dma_config_ptrrst = RU_FIELD_SET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH0RX, reg_dma_qm_dma_config_ptrrst, dma_qm_dma_config_ptrrst->eth0rx);
    reg_dma_qm_dma_config_ptrrst = RU_FIELD_SET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH0TX, reg_dma_qm_dma_config_ptrrst, dma_qm_dma_config_ptrrst->eth0tx);
    reg_dma_qm_dma_config_ptrrst = RU_FIELD_SET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH1RX, reg_dma_qm_dma_config_ptrrst, dma_qm_dma_config_ptrrst->eth1rx);
    reg_dma_qm_dma_config_ptrrst = RU_FIELD_SET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH1TX, reg_dma_qm_dma_config_ptrrst, dma_qm_dma_config_ptrrst->eth1tx);
    reg_dma_qm_dma_config_ptrrst = RU_FIELD_SET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH2RX, reg_dma_qm_dma_config_ptrrst, dma_qm_dma_config_ptrrst->eth2rx);
    reg_dma_qm_dma_config_ptrrst = RU_FIELD_SET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH2TX, reg_dma_qm_dma_config_ptrrst, dma_qm_dma_config_ptrrst->eth2tx);
    reg_dma_qm_dma_config_ptrrst = RU_FIELD_SET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH3RX, reg_dma_qm_dma_config_ptrrst, dma_qm_dma_config_ptrrst->eth3rx);
    reg_dma_qm_dma_config_ptrrst = RU_FIELD_SET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH3TX, reg_dma_qm_dma_config_ptrrst, dma_qm_dma_config_ptrrst->eth3tx);
    reg_dma_qm_dma_config_ptrrst = RU_FIELD_SET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH4RX, reg_dma_qm_dma_config_ptrrst, dma_qm_dma_config_ptrrst->eth4rx);
    reg_dma_qm_dma_config_ptrrst = RU_FIELD_SET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH4TX, reg_dma_qm_dma_config_ptrrst, dma_qm_dma_config_ptrrst->eth4tx);
    reg_dma_qm_dma_config_ptrrst = RU_FIELD_SET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, GPONRX, reg_dma_qm_dma_config_ptrrst, dma_qm_dma_config_ptrrst->gponrx);
    reg_dma_qm_dma_config_ptrrst = RU_FIELD_SET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, GPONTX, reg_dma_qm_dma_config_ptrrst, dma_qm_dma_config_ptrrst->gpontx);
...
bdmf_error_t ag_drv_qm_dma_qm_dma_config_ptrrst_get(qm_dma_qm_dma_config_ptrrst *dma_qm_dma_config_ptrrst)
{
    ...
    dma_qm_dma_config_ptrrst->eth0rx = RU_FIELD_GET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH0RX, reg_dma_qm_dma_config_ptrrst);
    dma_qm_dma_config_ptrrst->eth0tx = RU_FIELD_GET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH0TX, reg_dma_qm_dma_config_ptrrst);
    dma_qm_dma_config_ptrrst->eth1rx = RU_FIELD_GET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH1RX, reg_dma_qm_dma_config_ptrrst);
    dma_qm_dma_config_ptrrst->eth1tx = RU_FIELD_GET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH1TX, reg_dma_qm_dma_config_ptrrst);
    dma_qm_dma_config_ptrrst->eth2rx = RU_FIELD_GET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH2RX, reg_dma_qm_dma_config_ptrrst);
    dma_qm_dma_config_ptrrst->eth2tx = RU_FIELD_GET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH2TX, reg_dma_qm_dma_config_ptrrst);
    dma_qm_dma_config_ptrrst->eth3rx = RU_FIELD_GET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH3RX, reg_dma_qm_dma_config_ptrrst);
    dma_qm_dma_config_ptrrst->eth3tx = RU_FIELD_GET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH3TX, reg_dma_qm_dma_config_ptrrst);
    dma_qm_dma_config_ptrrst->eth4rx = RU_FIELD_GET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH4RX, reg_dma_qm_dma_config_ptrrst);
    dma_qm_dma_config_ptrrst->eth4tx = RU_FIELD_GET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, ETH4TX, reg_dma_qm_dma_config_ptrrst);
    dma_qm_dma_config_ptrrst->gponrx = RU_FIELD_GET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, GPONRX, reg_dma_qm_dma_config_ptrrst);
    dma_qm_dma_config_ptrrst->gpontx = RU_FIELD_GET(0, QM, DMA_QM_DMA_CONFIG_PTRRST, GPONTX, reg_dma_qm_dma_config_ptrrst);
...
static int bcm_qm_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        qm_ddr_cong_ctrl ddr_cong_ctrl = { .ddr_byte_congestion_drop_enabl=parm[1].value.unumber, .ddr_bytes_lower_thr=parm[2].value.unumber, .ddr_bytes_mid_thr=parm[3].value.unumber, .ddr_bytes_higher_thr=parm[4].value.unumber, .ddr_pd_congestion_drop_enable=parm[5].value.unumber, .ddr_pipe_lower_thr=parm[6].value.unumber, .ddr_pipe_higher_thr=parm[7].value.unumber};
    ...
    {
        qm_wred_profile_cfg wred_profile_cfg = { .min_thr0=parm[2].value.unumber, .min_thr1=parm[3].value.unumber, .max_thr0=parm[4].value.unumber, .max_thr1=parm[5].value.unumber, .slope_mantissa0=parm[6].value.unumber, .slope_exp0=parm[7].value.unumber, .slope_mantissa1=parm[8].value.unumber, .slope_exp1=parm[9].value.unumber};
    ...
    {
        qm_debug_info debug_info = { .eth0rxne=parm[1].value.unumber, .eth1rxne=parm[2].value.unumber, .eth2rxne=parm[3].value.unumber, .eth3rxne=parm[4].value.unumber, .eth4rxne=parm[5].value.unumber, .gponrxne=parm[6].value.unumber, .eth0txne=parm[7].value.unumber, .eth1txne=parm[8].value.unumber, .eth2txne=parm[9].value.unumber, .eth3txne=parm[10].value.unumber, .eth4txne=parm[11].value.unumber, .gpontxne=parm[12].value.unumber, .eth0rxu=parm[13].value.unumber, .eth1rxu=parm[14].value.unumber, .eth2rxu=parm[15].value.unumber, .eth3rxu=parm[16].value.unumber, .eth4rxu=parm[17].value.unumber, .gponrxu=parm[18].value.unumber, .eth0txu=parm[19].value.unumber, .eth1txu=parm[20].value.unumber, .eth2txu=parm[21].value.unumber, .eth3txu=parm[22].value.unumber, .eth4txu=parm[23].value.unumber, .gpontxu=parm[24].value.unumber, .sel_src=parm[25].value.unumber, .address=parm[26].value.unumber, .datacs=parm[27].value.unumber, .cdcs=parm[28].value.unumber, .rrcs=parm[29].value.unumber, .valid=parm[30].value.unumber, .ready=parm[31].value.unumber};
    ...
    {
        qm_epon_overhead_ctrl epon_overhead_ctrl = { .epon_line_rate=parm[1].value.unumber, .epon_crc_add_disable=parm[2].value.unumber, .fec_ipg_length=parm[3].value.unumber};
    ...
    {
        qm_intr_ctrl_isr intr_ctrl_isr = { .qm_dqm_pop_on_empty=parm[1].value.unumber, .qm_dqm_push_on_full=parm[2].value.unumber, .qm_cpu_pop_on_empty=parm[3].value.unumber, .qm_cpu_push_on_full=parm[4].value.unumber, .qm_normal_queue_pd_no_credit=parm[5].value.unumber, .qm_non_delayed_queue_pd_no_cre=parm[6].value.unumber, .qm_non_valid_queue=parm[7].value.unumber, .qm_agg_coherent_inconsistency=parm[8].value.unumber, .qm_force_copy_on_non_delayed=parm[9].value.unumber, .qm_fpm_pool_size_nonexistent=parm[10].value.unumber, .qm_target_mem_abs_contradictio=parm[11].value.unumber, .qm_target_mem_force_copy_contr=parm[12].value.unumber, .qm_1588_multicast_contradictio=parm[13].value.unumber, .qm_byte_drop_cnt_overrun=parm[14].value.unumber, .qm_pkt_drop_cnt_overrun=parm[15].value.unumber, .qm_total_byte_cnt_underrun=parm[16].value.unumber, .qm_total_pkt_cnt_underrun=parm[17].value.unumber, .qm_fpm_ug0_underrun=parm[18].value.unumber, .qm_fpm_ug1_underrun=parm[19].value.unumber, .qm_fpm_ug2_underrun=parm[20].value.unumber, .qm_fpm_ug3_underrun=parm[21].value.unumber};
    ...
    {
        qm_dma_qm_dma_config_ptrrst dma_qm_dma_config_ptrrst = { .eth0rx=parm[1].value.unumber, .eth0tx=parm[2].value.unumber, .eth1rx=parm[3].value.unumber, .eth1tx=parm[4].value.unumber, .eth2rx=parm[5].value.unumber, .eth2tx=parm[6].value.unumber, .eth3rx=parm[7].value.unumber, .eth3tx=parm[8].value.unumber, .eth4rx=parm[9].value.unumber, .eth4tx=parm[10].value.unumber, .gponrx=parm[11].value.unumber, .gpontx=parm[12].value.unumber};
        err = ag_drv_qm_dma_qm_dma_config_ptrrst_set(&dma_qm_dma_config_ptrrst);
        break;
    }
...
int bcm_qm_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_qm_ddr_cong_ctrl:
    {
        ...
        bdmf_session_print(session, "ddr_byte_congestion_drop_enabl = %u (0x%x)\n", ddr_cong_ctrl.ddr_byte_congestion_drop_enabl, ddr_cong_ctrl.ddr_byte_congestion_drop_enabl);
    ...
    case cli_qm_aggr_context:
    {
        ...
        err = ag_drv_qm_aggr_context_get(parm[1].value.unumber, &data, &context_valid);
        bdmf_session_print(session, "data = %u (0x%x)\n", data, data);
    ...
    case cli_qm_drop_counters_ctrl:
    {
        ...
        bdmf_session_print(session, "queue_occupancy_ddr_copy_decis = %u (0x%x)\n", drop_counters_ctrl.queue_occupancy_ddr_copy_decis, drop_counters_ctrl.queue_occupancy_ddr_copy_decis);
        bdmf_session_print(session, "psram_occupancy_ddr_copy_decis = %u (0x%x)\n", drop_counters_ctrl.psram_occupancy_ddr_copy_decis, drop_counters_ctrl.psram_occupancy_ddr_copy_decis);
        ...
        bdmf_session_print(session, "close_aggregation_on_empty_que = %u (0x%x)\n", drop_counters_ctrl.close_aggregation_on_empty_que, drop_counters_ctrl.close_aggregation_on_empty_que);
        bdmf_session_print(session, "fpm_congestion_buf_release_mec = %u (0x%x)\n", drop_counters_ctrl.fpm_congestion_buf_release_mec, drop_counters_ctrl.fpm_congestion_buf_release_mec);
        break;
    }
    case cli_qm_fpm_ctrl:
    {
    ...
    case cli_qm_intr_ctrl_isr:
    {
        ...
        bdmf_session_print(session, "qm_non_delayed_queue_pd_no_cre = %u (0x%x)\n", intr_ctrl_isr.qm_non_delayed_queue_pd_no_cre, intr_ctrl_isr.qm_non_delayed_queue_pd_no_cre);
        ...
        bdmf_session_print(session, "qm_target_mem_abs_contradictio = %u (0x%x)\n", intr_ctrl_isr.qm_target_mem_abs_contradictio, intr_ctrl_isr.qm_target_mem_abs_contradictio);
        bdmf_session_print(session, "qm_target_mem_force_copy_contr = %u (0x%x)\n", intr_ctrl_isr.qm_target_mem_force_copy_contr, intr_ctrl_isr.qm_target_mem_force_copy_contr);
        bdmf_session_print(session, "qm_1588_multicast_contradictio = %u (0x%x)\n", intr_ctrl_isr.qm_1588_multicast_contradictio, intr_ctrl_isr.qm_1588_multicast_contradictio);
    ...
    {
        uint32_t fpm_drop;
        err = ag_drv_qm_fpm_pool_drop_cnt_get(&fpm_drop);
    ...
    case cli_qm_fpm_grp_drop_cnt:
    {
        ...
        err = ag_drv_qm_fpm_grp_drop_cnt_get(&fpm_grp_drop);
    ...
    case cli_qm_dma_qm_dma_config_ptrrst:
    {
        qm_dma_qm_dma_config_ptrrst dma_qm_dma_config_ptrrst;
        err = ag_drv_qm_dma_qm_dma_config_ptrrst_get(&dma_qm_dma_config_ptrrst);
        bdmf_session_print(session, "eth0rx = %u (0x%x)\n", dma_qm_dma_config_ptrrst.eth0rx, dma_qm_dma_config_ptrrst.eth0rx);
        bdmf_session_print(session, "eth0tx = %u (0x%x)\n", dma_qm_dma_config_ptrrst.eth0tx, dma_qm_dma_config_ptrrst.eth0tx);
        bdmf_session_print(session, "eth1rx = %u (0x%x)\n", dma_qm_dma_config_ptrrst.eth1rx, dma_qm_dma_config_ptrrst.eth1rx);
        bdmf_session_print(session, "eth1tx = %u (0x%x)\n", dma_qm_dma_config_ptrrst.eth1tx, dma_qm_dma_config_ptrrst.eth1tx);
        bdmf_session_print(session, "eth2rx = %u (0x%x)\n", dma_qm_dma_config_ptrrst.eth2rx, dma_qm_dma_config_ptrrst.eth2rx);
        bdmf_session_print(session, "eth2tx = %u (0x%x)\n", dma_qm_dma_config_ptrrst.eth2tx, dma_qm_dma_config_ptrrst.eth2tx);
        bdmf_session_print(session, "eth3rx = %u (0x%x)\n", dma_qm_dma_config_ptrrst.eth3rx, dma_qm_dma_config_ptrrst.eth3rx);
        bdmf_session_print(session, "eth3tx = %u (0x%x)\n", dma_qm_dma_config_ptrrst.eth3tx, dma_qm_dma_config_ptrrst.eth3tx);
        bdmf_session_print(session, "eth4rx = %u (0x%x)\n", dma_qm_dma_config_ptrrst.eth4rx, dma_qm_dma_config_ptrrst.eth4rx);
        bdmf_session_print(session, "eth4tx = %u (0x%x)\n", dma_qm_dma_config_ptrrst.eth4tx, dma_qm_dma_config_ptrrst.eth4tx);
        bdmf_session_print(session, "gponrx = %u (0x%x)\n", dma_qm_dma_config_ptrrst.gponrx, dma_qm_dma_config_ptrrst.gponrx);
        bdmf_session_print(session, "gpontx = %u (0x%x)\n", dma_qm_dma_config_ptrrst.gpontx, dma_qm_dma_config_ptrrst.gpontx);
        break;
    }
    case cli_qm_dma_qm_dma_config_max_otf:
    {
...
static int bcm_qm_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        qm_ddr_cong_ctrl ddr_cong_ctrl = {.ddr_byte_congestion_drop_enabl=gtmv(m, 1), .ddr_bytes_lower_thr=gtmv(m, 28), .ddr_bytes_mid_thr=gtmv(m, 28), .ddr_bytes_higher_thr=gtmv(m, 28), .ddr_pd_congestion_drop_enable=gtmv(m, 1), .ddr_pipe_lower_thr=gtmv(m, 8), .ddr_pipe_higher_thr=gtmv(m, 8)};
        if(!err) bdmf_session_print(session, "ag_drv_qm_ddr_cong_ctrl_set( %u %u %u %u %u %u %u)\n", ddr_cong_ctrl.ddr_byte_congestion_drop_enabl, ddr_cong_ctrl.ddr_bytes_lower_thr, ddr_cong_ctrl.ddr_bytes_mid_thr, ddr_cong_ctrl.ddr_bytes_higher_thr, ddr_cong_ctrl.ddr_pd_congestion_drop_enable, ddr_cong_ctrl.ddr_pipe_lower_thr, ddr_cong_ctrl.ddr_pipe_higher_thr);
        ...
        if(err || ddr_cong_ctrl.ddr_byte_congestion_drop_enabl!=gtmv(m, 1) || ddr_cong_ctrl.ddr_bytes_lower_thr!=gtmv(m, 28) || ddr_cong_ctrl.ddr_bytes_mid_thr!=gtmv(m, 28) || ddr_cong_ctrl.ddr_bytes_higher_thr!=gtmv(m, 28) || ddr_cong_ctrl.ddr_pd_congestion_drop_enable!=gtmv(m, 1) || ddr_cong_ctrl.ddr_pipe_lower_thr!=gtmv(m, 8) || ddr_cong_ctrl.ddr_pipe_higher_thr!=gtmv(m, 8))
    ...
    {
        uint16_t idx=gtmv(m, 7);
        uint32_t data=gtmv(m, 32);
        uint32_t context_valid=gtmv(m, 32);
        if(!err) ag_drv_qm_aggr_context_get( idx, &data, &context_valid);
        if(!err) bdmf_session_print(session, "ag_drv_qm_aggr_context_get( %u %u %u)\n", idx, data, context_valid);
    }
    {
        uint8_t profile_idx=gtmv(m, 4);
        qm_wred_profile_cfg wred_profile_cfg = {.min_thr0=gtmv(m, 22), .min_thr1=gtmv(m, 22), .max_thr0=gtmv(m, 22), .max_thr1=gtmv(m, 22), .slope_mantissa0=gtmv(m, 8), .slope_exp0=gtmv(m, 5), .slope_mantissa1=gtmv(m, 8), .slope_exp1=gtmv(m, 5)};
        if(!err) bdmf_session_print(session, "ag_drv_qm_wred_profile_cfg_set( %u %u %u %u %u %u %u %u %u)\n", profile_idx, wred_profile_cfg.min_thr0, wred_profile_cfg.min_thr1, wred_profile_cfg.max_thr0, wred_profile_cfg.max_thr1, wred_profile_cfg.slope_mantissa0, wred_profile_cfg.slope_exp0, wred_profile_cfg.slope_mantissa1, wred_profile_cfg.slope_exp1);
        ...
        if(!err) bdmf_session_print(session, "ag_drv_qm_wred_profile_cfg_get( %u %u %u %u %u %u %u %u %u)\n", profile_idx, wred_profile_cfg.min_thr0, wred_profile_cfg.min_thr1, wred_profile_cfg.max_thr0, wred_profile_cfg.max_thr1, wred_profile_cfg.slope_mantissa0, wred_profile_cfg.slope_exp0, wred_profile_cfg.slope_mantissa1, wred_profile_cfg.slope_exp1);
        if(err || wred_profile_cfg.min_thr0!=gtmv(m, 22) || wred_profile_cfg.min_thr1!=gtmv(m, 22) || wred_profile_cfg.max_thr0!=gtmv(m, 22) || wred_profile_cfg.max_thr1!=gtmv(m, 22) || wred_profile_cfg.slope_mantissa0!=gtmv(m, 8) || wred_profile_cfg.slope_exp0!=gtmv(m, 5) || wred_profile_cfg.slope_mantissa1!=gtmv(m, 8) || wred_profile_cfg.slope_exp1!=gtmv(m, 5))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        qm_debug_info debug_info = {.eth0rxne=gtmv(m, 1), .eth1rxne=gtmv(m, 1), .eth2rxne=gtmv(m, 1), .eth3rxne=gtmv(m, 1), .eth4rxne=gtmv(m, 1), .gponrxne=gtmv(m, 1), .eth0txne=gtmv(m, 1), .eth1txne=gtmv(m, 1), .eth2txne=gtmv(m, 1), .eth3txne=gtmv(m, 1), .eth4txne=gtmv(m, 1), .gpontxne=gtmv(m, 1), .eth0rxu=gtmv(m, 1), .eth1rxu=gtmv(m, 1), .eth2rxu=gtmv(m, 1), .eth3rxu=gtmv(m, 1), .eth4rxu=gtmv(m, 1), .gponrxu=gtmv(m, 1), .eth0txu=gtmv(m, 1), .eth1txu=gtmv(m, 1), .eth2txu=gtmv(m, 1), .eth3txu=gtmv(m, 1), .eth4txu=gtmv(m, 1), .gpontxu=gtmv(m, 1), .sel_src=gtmv(m, 6), .address=gtmv(m, 10), .datacs=gtmv(m, 1), .cdcs=gtmv(m, 1), .rrcs=gtmv(m, 1), .valid=gtmv(m, 1), .ready=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_qm_debug_info_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", debug_info.eth0rxne, debug_info.eth1rxne, debug_info.eth2rxne, debug_info.eth3rxne, debug_info.eth4rxne, debug_info.gponrxne, debug_info.eth0txne, debug_info.eth1txne, debug_info.eth2txne, debug_info.eth3txne, debug_info.eth4txne, debug_info.gpontxne, debug_info.eth0rxu, debug_info.eth1rxu, debug_info.eth2rxu, debug_info.eth3rxu, debug_info.eth4rxu, debug_info.gponrxu, debug_info.eth0txu, debug_info.eth1txu, debug_info.eth2txu, debug_info.eth3txu, debug_info.eth4txu, debug_info.gpontxu, debug_info.sel_src, debug_info.address, debug_info.datacs, debug_info.cdcs, debug_info.rrcs, debug_info.valid, debug_info.ready);
        if(!err) ag_drv_qm_debug_info_set(&debug_info);
        if(!err) ag_drv_qm_debug_info_get( &debug_info);
        if(!err) bdmf_session_print(session, "ag_drv_qm_debug_info_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", debug_info.eth0rxne, debug_info.eth1rxne, debug_info.eth2rxne, debug_info.eth3rxne, debug_info.eth4rxne, debug_info.gponrxne, debug_info.eth0txne, debug_info.eth1txne, debug_info.eth2txne, debug_info.eth3txne, debug_info.eth4txne, debug_info.gpontxne, debug_info.eth0rxu, debug_info.eth1rxu, debug_info.eth2rxu, debug_info.eth3rxu, debug_info.eth4rxu, debug_info.gponrxu, debug_info.eth0txu, debug_info.eth1txu, debug_info.eth2txu, debug_info.eth3txu, debug_info.eth4txu, debug_info.gpontxu, debug_info.sel_src, debug_info.address, debug_info.datacs, debug_info.cdcs, debug_info.rrcs, debug_info.valid, debug_info.ready);
    ...
    {
        qm_epon_overhead_ctrl epon_overhead_ctrl = {.epon_line_rate=gtmv(m, 1), .epon_crc_add_disable=gtmv(m, 1), .fec_ipg_length=gtmv(m, 11)};
        if(!err) bdmf_session_print(session, "ag_drv_qm_epon_overhead_ctrl_set( %u %u %u)\n", epon_overhead_ctrl.epon_line_rate, epon_overhead_ctrl.epon_crc_add_disable, epon_overhead_ctrl.fec_ipg_length);
        if(!err) ag_drv_qm_epon_overhead_ctrl_set(&epon_overhead_ctrl);
        if(!err) ag_drv_qm_epon_overhead_ctrl_get( &epon_overhead_ctrl);
        if(!err) bdmf_session_print(session, "ag_drv_qm_epon_overhead_ctrl_get( %u %u %u)\n", epon_overhead_ctrl.epon_line_rate, epon_overhead_ctrl.epon_crc_add_disable, epon_overhead_ctrl.fec_ipg_length);
        if(err || epon_overhead_ctrl.epon_line_rate!=gtmv(m, 1) || epon_overhead_ctrl.epon_crc_add_disable!=gtmv(m, 1) || epon_overhead_ctrl.fec_ipg_length!=gtmv(m, 11))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        qm_intr_ctrl_isr intr_ctrl_isr = {.qm_dqm_pop_on_empty=gtmv(m, 1), .qm_dqm_push_on_full=gtmv(m, 1), .qm_cpu_pop_on_empty=gtmv(m, 1), .qm_cpu_push_on_full=gtmv(m, 1), .qm_normal_queue_pd_no_credit=gtmv(m, 1), .qm_non_delayed_queue_pd_no_cre=gtmv(m, 1), .qm_non_valid_queue=gtmv(m, 1), .qm_agg_coherent_inconsistency=gtmv(m, 1), .qm_force_copy_on_non_delayed=gtmv(m, 1), .qm_fpm_pool_size_nonexistent=gtmv(m, 1), .qm_target_mem_abs_contradictio=gtmv(m, 1), .qm_target_mem_force_copy_contr=gtmv(m, 1), .qm_1588_multicast_contradictio=gtmv(m, 1), .qm_byte_drop_cnt_overrun=gtmv(m, 1), .qm_pkt_drop_cnt_overrun=gtmv(m, 1), .qm_total_byte_cnt_underrun=gtmv(m, 1), .qm_total_pkt_cnt_underrun=gtmv(m, 1), .qm_fpm_ug0_underrun=gtmv(m, 1), .qm_fpm_ug1_underrun=gtmv(m, 1), .qm_fpm_ug2_underrun=gtmv(m, 1), .qm_fpm_ug3_underrun=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_qm_intr_ctrl_isr_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", intr_ctrl_isr.qm_dqm_pop_on_empty, intr_ctrl_isr.qm_dqm_push_on_full, intr_ctrl_isr.qm_cpu_pop_on_empty, intr_ctrl_isr.qm_cpu_push_on_full, intr_ctrl_isr.qm_normal_queue_pd_no_credit, intr_ctrl_isr.qm_non_delayed_queue_pd_no_cre, intr_ctrl_isr.qm_non_valid_queue, intr_ctrl_isr.qm_agg_coherent_inconsistency, intr_ctrl_isr.qm_force_copy_on_non_delayed, intr_ctrl_isr.qm_fpm_pool_size_nonexistent, intr_ctrl_isr.qm_target_mem_abs_contradictio, intr_ctrl_isr.qm_target_mem_force_copy_contr, intr_ctrl_isr.qm_1588_multicast_contradictio, intr_ctrl_isr.qm_byte_drop_cnt_overrun, intr_ctrl_isr.qm_pkt_drop_cnt_overrun, intr_ctrl_isr.qm_total_byte_cnt_underrun, intr_ctrl_isr.qm_total_pkt_cnt_underrun, intr_ctrl_isr.qm_fpm_ug0_underrun, intr_ctrl_isr.qm_fpm_ug1_underrun, intr_ctrl_isr.qm_fpm_ug2_underrun, intr_ctrl_isr.qm_fpm_ug3_underrun);
        if(!err) ag_drv_qm_intr_ctrl_isr_set(&intr_ctrl_isr);
        if(!err) ag_drv_qm_intr_ctrl_isr_get( &intr_ctrl_isr);
        if(!err) bdmf_session_print(session, "ag_drv_qm_intr_ctrl_isr_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", intr_ctrl_isr.qm_dqm_pop_on_empty, intr_ctrl_isr.qm_dqm_push_on_full, intr_ctrl_isr.qm_cpu_pop_on_empty, intr_ctrl_isr.qm_cpu_push_on_full, intr_ctrl_isr.qm_normal_queue_pd_no_credit, intr_ctrl_isr.qm_non_delayed_queue_pd_no_cre, intr_ctrl_isr.qm_non_valid_queue, intr_ctrl_isr.qm_agg_coherent_inconsistency, intr_ctrl_isr.qm_force_copy_on_non_delayed, intr_ctrl_isr.qm_fpm_pool_size_nonexistent, intr_ctrl_isr.qm_target_mem_abs_contradictio, intr_ctrl_isr.qm_target_mem_force_copy_contr, intr_ctrl_isr.qm_1588_multicast_contradictio, intr_ctrl_isr.qm_byte_drop_cnt_overrun, intr_ctrl_isr.qm_pkt_drop_cnt_overrun, intr_ctrl_isr.qm_total_byte_cnt_underrun, intr_ctrl_isr.qm_total_pkt_cnt_underrun, intr_ctrl_isr.qm_fpm_ug0_underrun, intr_ctrl_isr.qm_fpm_ug1_underrun, intr_ctrl_isr.qm_fpm_ug2_underrun, intr_ctrl_isr.qm_fpm_ug3_underrun);
        if(err || intr_ctrl_isr.qm_dqm_pop_on_empty!=gtmv(m, 1) || intr_ctrl_isr.qm_dqm_push_on_full!=gtmv(m, 1) || intr_ctrl_isr.qm_cpu_pop_on_empty!=gtmv(m, 1) || intr_ctrl_isr.qm_cpu_push_on_full!=gtmv(m, 1) || intr_ctrl_isr.qm_normal_queue_pd_no_credit!=gtmv(m, 1) || intr_ctrl_isr.qm_non_delayed_queue_pd_no_cre!=gtmv(m, 1) || intr_ctrl_isr.qm_non_valid_queue!=gtmv(m, 1) || intr_ctrl_isr.qm_agg_coherent_inconsistency!=gtmv(m, 1) || intr_ctrl_isr.qm_force_copy_on_non_delayed!=gtmv(m, 1) || intr_ctrl_isr.qm_fpm_pool_size_nonexistent!=gtmv(m, 1) || intr_ctrl_isr.qm_target_mem_abs_contradictio!=gtmv(m, 1) || intr_ctrl_isr.qm_target_mem_force_copy_contr!=gtmv(m, 1) || intr_ctrl_isr.qm_1588_multicast_contradictio!=gtmv(m, 1) || intr_ctrl_isr.qm_byte_drop_cnt_overrun!=gtmv(m, 1) || intr_ctrl_isr.qm_pkt_drop_cnt_overrun!=gtmv(m, 1) || intr_ctrl_isr.qm_total_byte_cnt_underrun!=gtmv(m, 1) || intr_ctrl_isr.qm_total_pkt_cnt_underrun!=gtmv(m, 1) || intr_ctrl_isr.qm_fpm_ug0_underrun!=gtmv(m, 1) || intr_ctrl_isr.qm_fpm_ug1_underrun!=gtmv(m, 1) || intr_ctrl_isr.qm_fpm_ug2_underrun!=gtmv(m, 1) || intr_ctrl_isr.qm_fpm_ug3_underrun!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        uint16_t q_idx=gtmv(m, 5);
        qm_q_context q_context = {.wred_profile=gtmv(m, 4), .copy_dec_profile=gtmv(m, 3), .copy_to_ddr=gtmv(m, 1), .ddr_copy_disable=gtmv(m, 1), .aggregation_disable=gtmv(m, 1), .fpm_ug=gtmv(m, 2), .exclusive_priority=gtmv(m, 1), .q_802_1ae=gtmv(m, 1), .sci=gtmv(m, 1), .fec_enable=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_qm_q_context_set( %u %u %u %u %u %u %u %u %u %u %u)\n", q_idx, q_context.wred_profile, q_context.copy_dec_profile, q_context.copy_to_ddr, q_context.ddr_copy_disable, q_context.aggregation_disable, q_context.fpm_ug, q_context.exclusive_priority, q_context.q_802_1ae, q_context.sci, q_context.fec_enable);
        if(!err) ag_drv_qm_q_context_set(q_idx, &q_context);
        if(!err) ag_drv_qm_q_context_get( q_idx, &q_context);
        if(!err) bdmf_session_print(session, "ag_drv_qm_q_context_get( %u %u %u %u %u %u %u %u %u %u %u)\n", q_idx, q_context.wred_profile, q_context.copy_dec_profile, q_context.copy_to_ddr, q_context.ddr_copy_disable, q_context.aggregation_disable, q_context.fpm_ug, q_context.exclusive_priority, q_context.q_802_1ae, q_context.sci, q_context.fec_enable);
        if(err || q_context.wred_profile!=gtmv(m, 4) || q_context.copy_dec_profile!=gtmv(m, 3) || q_context.copy_to_ddr!=gtmv(m, 1) || q_context.ddr_copy_disable!=gtmv(m, 1) || q_context.aggregation_disable!=gtmv(m, 1) || q_context.fpm_ug!=gtmv(m, 2) || q_context.exclusive_priority!=gtmv(m, 1) || q_context.q_802_1ae!=gtmv(m, 1) || q_context.sci!=gtmv(m, 1) || q_context.fec_enable!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t profile_idx=gtmv(m, 3);
        uint32_t queue_occupancy_thr=gtmv(m, 28);
        ...
        if(err || queue_occupancy_thr!=gtmv(m, 28) || psram_thr!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    }
    {
        ...
        if(!err) ag_drv_qm_fpm_pool_drop_cnt_get( &fpm_drop);
        if(!err) bdmf_session_print(session, "ag_drv_qm_fpm_pool_drop_cnt_get( %u)\n", fpm_drop);
    }
    {
    ...
    }
    {
        ...
        if(!err) ag_drv_qm_fpm_grp_drop_cnt_get( &fpm_grp_drop);
        if(!err) bdmf_session_print(session, "ag_drv_qm_fpm_grp_drop_cnt_get( %u)\n", fpm_grp_drop);
    }
    {
    ...
    {
        qm_dma_qm_dma_config_ptrrst dma_qm_dma_config_ptrrst = {.eth0rx=gtmv(m, 1), .eth0tx=gtmv(m, 1), .eth1rx=gtmv(m, 1), .eth1tx=gtmv(m, 1), .eth2rx=gtmv(m, 1), .eth2tx=gtmv(m, 1), .eth3rx=gtmv(m, 1), .eth3tx=gtmv(m, 1), .eth4rx=gtmv(m, 1), .eth4tx=gtmv(m, 1), .gponrx=gtmv(m, 1), .gpontx=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_qm_dma_qm_dma_config_ptrrst_set( %u %u %u %u %u %u %u %u %u %u %u %u)\n", dma_qm_dma_config_ptrrst.eth0rx, dma_qm_dma_config_ptrrst.eth0tx, dma_qm_dma_config_ptrrst.eth1rx, dma_qm_dma_config_ptrrst.eth1tx, dma_qm_dma_config_ptrrst.eth2rx, dma_qm_dma_config_ptrrst.eth2tx, dma_qm_dma_config_ptrrst.eth3rx, dma_qm_dma_config_ptrrst.eth3tx, dma_qm_dma_config_ptrrst.eth4rx, dma_qm_dma_config_ptrrst.eth4tx, dma_qm_dma_config_ptrrst.gponrx, dma_qm_dma_config_ptrrst.gpontx);
        if(!err) ag_drv_qm_dma_qm_dma_config_ptrrst_set(&dma_qm_dma_config_ptrrst);
        if(!err) ag_drv_qm_dma_qm_dma_config_ptrrst_get( &dma_qm_dma_config_ptrrst);
        if(!err) bdmf_session_print(session, "ag_drv_qm_dma_qm_dma_config_ptrrst_get( %u %u %u %u %u %u %u %u %u %u %u %u)\n", dma_qm_dma_config_ptrrst.eth0rx, dma_qm_dma_config_ptrrst.eth0tx, dma_qm_dma_config_ptrrst.eth1rx, dma_qm_dma_config_ptrrst.eth1tx, dma_qm_dma_config_ptrrst.eth2rx, dma_qm_dma_config_ptrrst.eth2tx, dma_qm_dma_config_ptrrst.eth3rx, dma_qm_dma_config_ptrrst.eth3tx, dma_qm_dma_config_ptrrst.eth4rx, dma_qm_dma_config_ptrrst.eth4tx, dma_qm_dma_config_ptrrst.gponrx, dma_qm_dma_config_ptrrst.gpontx);
        if(err || dma_qm_dma_config_ptrrst.eth0rx!=gtmv(m, 1) || dma_qm_dma_config_ptrrst.eth0tx!=gtmv(m, 1) || dma_qm_dma_config_ptrrst.eth1rx!=gtmv(m, 1) || dma_qm_dma_config_ptrrst.eth1tx!=gtmv(m, 1) || dma_qm_dma_config_ptrrst.eth2rx!=gtmv(m, 1) || dma_qm_dma_config_ptrrst.eth2tx!=gtmv(m, 1) || dma_qm_dma_config_ptrrst.eth3rx!=gtmv(m, 1) || dma_qm_dma_config_ptrrst.eth3tx!=gtmv(m, 1) || dma_qm_dma_config_ptrrst.eth4rx!=gtmv(m, 1) || dma_qm_dma_config_ptrrst.eth4tx!=gtmv(m, 1) || dma_qm_dma_config_ptrrst.gponrx!=gtmv(m, 1) || dma_qm_dma_config_ptrrst.gpontx!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
...
bdmfmon_handle_t ag_drv_qm_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        static bdmfmon_cmd_parm_t set_ddr_cong_ctrl[]={
            BDMFMON_MAKE_PARM("ddr_byte_congestion_drop_enabl", "ddr_byte_congestion_drop_enabl", BDMFMON_PARM_NUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_drop_counters_ctrl[]={
            ...
            BDMFMON_MAKE_PARM("queue_occupancy_ddr_copy_decis", "queue_occupancy_ddr_copy_decis", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("psram_occupancy_ddr_copy_decis", "psram_occupancy_ddr_copy_decis", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("dont_send_mc_bit_to_bbh", "dont_send_mc_bit_to_bbh", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("close_aggregation_on_empty_que", "close_aggregation_on_empty_que", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("fpm_congestion_buf_release_mec", "fpm_congestion_buf_release_mec", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_intr_ctrl_isr[]={
            ...
            BDMFMON_MAKE_PARM("qm_non_delayed_queue_pd_no_cre", "qm_non_delayed_queue_pd_no_cre", BDMFMON_PARM_NUMBER, 0),
            ...
            BDMFMON_MAKE_PARM("qm_target_mem_abs_contradictio", "qm_target_mem_abs_contradictio", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("qm_target_mem_force_copy_contr", "qm_target_mem_force_copy_contr", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("qm_1588_multicast_contradictio", "qm_1588_multicast_contradictio", BDMFMON_PARM_NUMBER, 0),
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="fpm_pool_drop_cnt", .val=cli_qm_fpm_pool_drop_cnt, .parms=set_default },
            { .name="fpm_congestion_drop_cnt", .val=cli_qm_fpm_congestion_drop_cnt, .parms=set_default },
            { .name="fpm_grp_drop_cnt", .val=cli_qm_fpm_grp_drop_cnt, .parms=set_default },
