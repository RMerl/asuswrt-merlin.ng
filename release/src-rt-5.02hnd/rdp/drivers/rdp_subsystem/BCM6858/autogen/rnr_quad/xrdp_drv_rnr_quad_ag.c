...
bdmf_error_t ag_drv_rnr_quad_parser_ip2_set(uint8_t quad_idx, const rnr_quad_parser_ip0 *parser_ip0)
{
    /* Identical to parser_ip0 */
    uint32_t reg_parser_core_configuration_ip_filter0_cfg=0;
    uint32_t reg_parser_core_configuration_ip_filter0_mask_cfg=0;
    ...
    RU_REG_WRITE(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTER2_CFG, reg_parser_core_configuration_ip_filter0_cfg);
    RU_REG_WRITE(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTER2_MASK_CFG, reg_parser_core_configuration_ip_filter0_mask_cfg);
    RU_REG_WRITE(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTERS_CFG, reg_parser_core_configuration_ip_filters_cfg);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_rnr_quad_parser_ip2_get(uint8_t quad_idx, rnr_quad_parser_ip0 *parser_ip0)
{
    /* Identical to parser_ip0 */
    uint32_t reg_parser_core_configuration_ip_filter0_cfg;
    uint32_t reg_parser_core_configuration_ip_filter0_mask_cfg;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTER2_CFG, reg_parser_core_configuration_ip_filter0_cfg);
    RU_REG_READ(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTER2_MASK_CFG, reg_parser_core_configuration_ip_filter0_mask_cfg);
    RU_REG_READ(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTERS_CFG, reg_parser_core_configuration_ip_filters_cfg);
...
bdmf_error_t ag_drv_rnr_quad_parser_ip3_set(uint8_t quad_idx, const rnr_quad_parser_ip0 *parser_ip0)
{
    /* Identical to parser_ip0 */
    uint32_t reg_parser_core_configuration_ip_filter0_cfg=0;
    uint32_t reg_parser_core_configuration_ip_filter0_mask_cfg=0;
    ...
    RU_REG_WRITE(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTER3_CFG, reg_parser_core_configuration_ip_filter0_cfg);
    RU_REG_WRITE(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTER3_MASK_CFG, reg_parser_core_configuration_ip_filter0_mask_cfg);
    RU_REG_WRITE(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTERS_CFG, reg_parser_core_configuration_ip_filters_cfg);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_rnr_quad_parser_ip3_get(uint8_t quad_idx, rnr_quad_parser_ip0 *parser_ip0)
{
    /* Identical to parser_ip0 */
    uint32_t reg_parser_core_configuration_ip_filter0_cfg;
    uint32_t reg_parser_core_configuration_ip_filter0_mask_cfg;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTER3_CFG, reg_parser_core_configuration_ip_filter0_cfg);
    RU_REG_READ(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTER3_MASK_CFG, reg_parser_core_configuration_ip_filter0_mask_cfg);
    RU_REG_READ(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTERS_CFG, reg_parser_core_configuration_ip_filters_cfg);
...
bdmf_error_t ag_drv_rnr_quad_parser_hardcoded_ethtype0_set(uint8_t quad_idx, const rnr_quad_parser_hardcoded_ethtype0 *parser_hardcoded_ethtype0)
{
    uint32_t reg_parser_core_configuration_qtag_hard_nest_0=0;
    uint32_t reg_parser_core_configuration_qtag_nest=0;

#ifdef VALIDATE_PARMS
    if(!parser_hardcoded_ethtype0)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    if((quad_idx >= BLOCK_ADDR_COUNT) ||
       (parser_hardcoded_ethtype0->hard_nest_profile >= _12BITS_MAX_VAL_) ||
       (parser_hardcoded_ethtype0->qtag_nest_0_profile_0 >= _3BITS_MAX_VAL_) ||
       (parser_hardcoded_ethtype0->qtag_nest_1_profile_0 >= _3BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_parser_core_configuration_qtag_hard_nest_0 = RU_FIELD_SET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_QTAG_HARD_NEST_0, HARD_NEST_PROFILE, reg_parser_core_configuration_qtag_hard_nest_0, parser_hardcoded_ethtype0->hard_nest_profile);
    reg_parser_core_configuration_qtag_nest = RU_FIELD_SET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_QTAG_NEST, QTAG_NEST_0_PROFILE_0, reg_parser_core_configuration_qtag_nest, parser_hardcoded_ethtype0->qtag_nest_0_profile_0);
    reg_parser_core_configuration_qtag_nest = RU_FIELD_SET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_QTAG_NEST, QTAG_NEST_1_PROFILE_0, reg_parser_core_configuration_qtag_nest, parser_hardcoded_ethtype0->qtag_nest_1_profile_0);
...
bdmf_error_t ag_drv_rnr_quad_parser_hardcoded_ethtype0_get(uint8_t quad_idx, rnr_quad_parser_hardcoded_ethtype0 *parser_hardcoded_ethtype0)
{
    ...
    parser_hardcoded_ethtype0->hard_nest_profile = RU_FIELD_GET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_QTAG_HARD_NEST_0, HARD_NEST_PROFILE, reg_parser_core_configuration_qtag_hard_nest_0);
    parser_hardcoded_ethtype0->qtag_nest_0_profile_0 = RU_FIELD_GET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_QTAG_NEST, QTAG_NEST_0_PROFILE_0, reg_parser_core_configuration_qtag_nest);
    parser_hardcoded_ethtype0->qtag_nest_1_profile_0 = RU_FIELD_GET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_QTAG_NEST, QTAG_NEST_1_PROFILE_0, reg_parser_core_configuration_qtag_nest);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_rnr_quad_parser_hardcoded_ethtype1_set(uint8_t quad_idx, const rnr_quad_parser_hardcoded_ethtype0 *parser_hardcoded_ethtype0)
{
    /* Identical to parser_hardcoded_ethtype0 */
    uint32_t reg_parser_core_configuration_qtag_hard_nest_0=0;
    uint32_t reg_parser_core_configuration_qtag_nest=0;
...
bdmf_error_t ag_drv_rnr_quad_parser_hardcoded_ethtype1_get(uint8_t quad_idx, rnr_quad_parser_hardcoded_ethtype0 *parser_hardcoded_ethtype0)
{
    /* Identical to parser_hardcoded_ethtype0 */
    uint32_t reg_parser_core_configuration_qtag_hard_nest_0;
    uint32_t reg_parser_core_configuration_qtag_nest;
...
bdmf_error_t ag_drv_rnr_quad_parser_hardcoded_ethtype2_set(uint8_t quad_idx, const rnr_quad_parser_hardcoded_ethtype0 *parser_hardcoded_ethtype0)
{
    /* Identical to parser_hardcoded_ethtype0 */
    uint32_t reg_parser_core_configuration_qtag_hard_nest_0=0;
    uint32_t reg_parser_core_configuration_qtag_nest=0;
...
bdmf_error_t ag_drv_rnr_quad_parser_hardcoded_ethtype2_get(uint8_t quad_idx, rnr_quad_parser_hardcoded_ethtype0 *parser_hardcoded_ethtype0)
{
    /* Identical to parser_hardcoded_ethtype0 */
    uint32_t reg_parser_core_configuration_qtag_hard_nest_0;
    uint32_t reg_parser_core_configuration_qtag_nest;
...
bdmf_error_t ag_drv_rnr_quad_parser_da_filter9_set(uint8_t quad_idx, uint16_t da_filt_msb, uint32_t da_filt_lsb)
{
    uint32_t reg_parser_core_configuration_da_filt9_val_h=0;
    uint32_t reg_parser_core_configuration_da_filt9_val_l=0;
    ...
    reg_parser_core_configuration_da_filt9_val_h = RU_FIELD_SET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT9_VAL_H, DA_FILT_MSB, reg_parser_core_configuration_da_filt9_val_h, da_filt_msb);
    reg_parser_core_configuration_da_filt9_val_l = RU_FIELD_SET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT9_VAL_L, DA_FILT_LSB, reg_parser_core_configuration_da_filt9_val_l, da_filt_lsb);

    RU_REG_WRITE(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT9_VAL_H, reg_parser_core_configuration_da_filt9_val_h);
    RU_REG_WRITE(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT9_VAL_L, reg_parser_core_configuration_da_filt9_val_l);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_rnr_quad_parser_da_filter9_get(uint8_t quad_idx, uint16_t *da_filt_msb, uint32_t *da_filt_lsb)
{
    uint32_t reg_parser_core_configuration_da_filt9_val_h;
    uint32_t reg_parser_core_configuration_da_filt9_val_l;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT9_VAL_H, reg_parser_core_configuration_da_filt9_val_h);
    RU_REG_READ(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT9_VAL_L, reg_parser_core_configuration_da_filt9_val_l);

    *da_filt_msb = RU_FIELD_GET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT9_VAL_H, DA_FILT_MSB, reg_parser_core_configuration_da_filt9_val_h);
    *da_filt_lsb = RU_FIELD_GET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT9_VAL_L, DA_FILT_LSB, reg_parser_core_configuration_da_filt9_val_l);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_rnr_quad_parser_da_filter10_set(uint8_t quad_idx, uint16_t da_filt_msb, uint32_t da_filt_lsb)
{
    uint32_t reg_parser_core_configuration_da_filt10_val_h=0;
    uint32_t reg_parser_core_configuration_da_filt10_val_l=0;
    ...
    reg_parser_core_configuration_da_filt10_val_h = RU_FIELD_SET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT10_VAL_H, DA_FILT_MSB, reg_parser_core_configuration_da_filt10_val_h, da_filt_msb);
    reg_parser_core_configuration_da_filt10_val_l = RU_FIELD_SET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT10_VAL_L, DA_FILT_LSB, reg_parser_core_configuration_da_filt10_val_l, da_filt_lsb);

    RU_REG_WRITE(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT10_VAL_H, reg_parser_core_configuration_da_filt10_val_h);
    RU_REG_WRITE(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT10_VAL_L, reg_parser_core_configuration_da_filt10_val_l);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_rnr_quad_parser_da_filter10_get(uint8_t quad_idx, uint16_t *da_filt_msb, uint32_t *da_filt_lsb)
{
    uint32_t reg_parser_core_configuration_da_filt10_val_h;
    uint32_t reg_parser_core_configuration_da_filt10_val_l;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT10_VAL_H, reg_parser_core_configuration_da_filt10_val_h);
    RU_REG_READ(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT10_VAL_L, reg_parser_core_configuration_da_filt10_val_l);

    *da_filt_msb = RU_FIELD_GET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT10_VAL_H, DA_FILT_MSB, reg_parser_core_configuration_da_filt10_val_h);
    *da_filt_lsb = RU_FIELD_GET(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT10_VAL_L, DA_FILT_LSB, reg_parser_core_configuration_da_filt10_val_l);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_rnr_quad_da_filter_profile_0_set(uint8_t quad_idx, uint8_t filter_idx, bdmf_boolean data)
{
    uint32_t reg_parser_core_configuration_da_filt_valid_cfg_0=0;

#ifdef VALIDATE_PARMS
    if((quad_idx >= BLOCK_ADDR_COUNT) ||
       (data >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    FIELD_SET(reg_parser_core_configuration_da_filt_valid_cfg_0, (filter_idx % 32) *1, 0x1, data);
...
bdmf_error_t ag_drv_rnr_quad_da_filter_profile_0_get(uint8_t quad_idx, uint8_t filter_idx, bdmf_boolean *data)
{
    ...
    *data = FIELD_GET(reg_parser_core_configuration_da_filt_valid_cfg_0, (filter_idx % 32) *1, 0x1);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_rnr_quad_da_filter_profile_1_set(uint8_t quad_idx, uint8_t filter_idx, bdmf_boolean data)
{
    uint32_t reg_parser_core_configuration_da_filt_valid_cfg_1=0;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT_VALID_CFG_1, reg_parser_core_configuration_da_filt_valid_cfg_1);

    FIELD_SET(reg_parser_core_configuration_da_filt_valid_cfg_1, (filter_idx % 32) *1, 0x1, data);

    RU_REG_WRITE(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT_VALID_CFG_1, reg_parser_core_configuration_da_filt_valid_cfg_1);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_rnr_quad_da_filter_profile_1_get(uint8_t quad_idx, uint8_t filter_idx, bdmf_boolean *data)
{
    uint32_t reg_parser_core_configuration_da_filt_valid_cfg_1;
    ...
    *data = FIELD_GET(reg_parser_core_configuration_da_filt_valid_cfg_1, (filter_idx % 32) *1, 0x1);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_rnr_quad_da_filter_profile_2_set(uint8_t quad_idx, uint8_t filter_idx, bdmf_boolean data)
{
    uint32_t reg_parser_core_configuration_da_filt_valid_cfg_2=0;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT_VALID_CFG_2, reg_parser_core_configuration_da_filt_valid_cfg_2);

    FIELD_SET(reg_parser_core_configuration_da_filt_valid_cfg_2, (filter_idx % 32) *1, 0x1, data);

    RU_REG_WRITE(quad_idx, RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT_VALID_CFG_2, reg_parser_core_configuration_da_filt_valid_cfg_2);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_rnr_quad_da_filter_profile_2_get(uint8_t quad_idx, uint8_t filter_idx, bdmf_boolean *data)
{
    uint32_t reg_parser_core_configuration_da_filt_valid_cfg_2;
    ...
    *data = FIELD_GET(reg_parser_core_configuration_da_filt_valid_cfg_2, (filter_idx % 32) *1, 0x1);
...
{
    uint32_t reg_ubus_slv_res_cntrl=0;

#ifdef VALIDATE_PARMS
    if(!ubus_slv_res_cntrl)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    if((quad_idx >= BLOCK_ADDR_COUNT) ||
       (ubus_slv_res_cntrl->repin_eswap >= _1BITS_MAX_VAL_) ||
       (ubus_slv_res_cntrl->reqout_eswap >= _1BITS_MAX_VAL_) ||
       (ubus_slv_res_cntrl->dev_clken >= _1BITS_MAX_VAL_) ||
       (ubus_slv_res_cntrl->dev_err >= _1BITS_MAX_VAL_) ||
       (ubus_slv_res_cntrl->dev_timeout_en >= _1BITS_MAX_VAL_) ||
       (ubus_slv_res_cntrl->dev_timeout >= _11BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_ubus_slv_res_cntrl = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, MASK_ID, reg_ubus_slv_res_cntrl, ubus_slv_res_cntrl->mask_id);
    reg_ubus_slv_res_cntrl = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, REPIN_ESWAP, reg_ubus_slv_res_cntrl, ubus_slv_res_cntrl->repin_eswap);
    reg_ubus_slv_res_cntrl = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, REQOUT_ESWAP, reg_ubus_slv_res_cntrl, ubus_slv_res_cntrl->reqout_eswap);
    reg_ubus_slv_res_cntrl = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, DEV_CLKEN, reg_ubus_slv_res_cntrl, ubus_slv_res_cntrl->dev_clken);
    reg_ubus_slv_res_cntrl = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, DEV_ERR, reg_ubus_slv_res_cntrl, ubus_slv_res_cntrl->dev_err);
    reg_ubus_slv_res_cntrl = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, DEV_TIMEOUT_EN, reg_ubus_slv_res_cntrl, ubus_slv_res_cntrl->dev_timeout_en);
    reg_ubus_slv_res_cntrl = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, DEV_TIMEOUT, reg_ubus_slv_res_cntrl, ubus_slv_res_cntrl->dev_timeout);

    RU_REG_WRITE(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, reg_ubus_slv_res_cntrl);
...
{
    uint32_t reg_ubus_slv_res_cntrl;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, reg_ubus_slv_res_cntrl);

    ubus_slv_res_cntrl->mask_id = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, MASK_ID, reg_ubus_slv_res_cntrl);
    ubus_slv_res_cntrl->repin_eswap = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, REPIN_ESWAP, reg_ubus_slv_res_cntrl);
    ubus_slv_res_cntrl->reqout_eswap = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, REQOUT_ESWAP, reg_ubus_slv_res_cntrl);
    ubus_slv_res_cntrl->dev_clken = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, DEV_CLKEN, reg_ubus_slv_res_cntrl);
    ubus_slv_res_cntrl->dev_err = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, DEV_ERR, reg_ubus_slv_res_cntrl);
    ubus_slv_res_cntrl->dev_timeout_en = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, DEV_TIMEOUT_EN, reg_ubus_slv_res_cntrl);
    ubus_slv_res_cntrl->dev_timeout = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_RES_CNTRL, DEV_TIMEOUT, reg_ubus_slv_res_cntrl);
...
{
    uint32_t reg_ubus_slv_vpb_base=0;
    ...
    reg_ubus_slv_vpb_base = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_VPB_BASE, BASE, reg_ubus_slv_vpb_base, base);

    RU_REG_WRITE(quad_idx, RNR_QUAD, UBUS_SLV_VPB_BASE, reg_ubus_slv_vpb_base);
...
{
    uint32_t reg_ubus_slv_vpb_base;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, UBUS_SLV_VPB_BASE, reg_ubus_slv_vpb_base);

    *base = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_VPB_BASE, BASE, reg_ubus_slv_vpb_base);
...
{
    uint32_t reg_ubus_slv_vpb_mask=0;
    ...
    reg_ubus_slv_vpb_mask = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_VPB_MASK, MASK, reg_ubus_slv_vpb_mask, mask);

    RU_REG_WRITE(quad_idx, RNR_QUAD, UBUS_SLV_VPB_MASK, reg_ubus_slv_vpb_mask);
...
{
    uint32_t reg_ubus_slv_vpb_mask;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, UBUS_SLV_VPB_MASK, reg_ubus_slv_vpb_mask);

    *mask = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_VPB_MASK, MASK, reg_ubus_slv_vpb_mask);
...
{
    uint32_t reg_ubus_slv_apb_base=0;
    ...
    reg_ubus_slv_apb_base = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_APB_BASE, BASE, reg_ubus_slv_apb_base, base);

    RU_REG_WRITE(quad_idx, RNR_QUAD, UBUS_SLV_APB_BASE, reg_ubus_slv_apb_base);
...
{
    uint32_t reg_ubus_slv_apb_base;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, UBUS_SLV_APB_BASE, reg_ubus_slv_apb_base);

    *base = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_APB_BASE, BASE, reg_ubus_slv_apb_base);
...
{
    uint32_t reg_ubus_slv_apb_mask=0;
    ...
    reg_ubus_slv_apb_mask = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_APB_MASK, MASK, reg_ubus_slv_apb_mask, mask);

    RU_REG_WRITE(quad_idx, RNR_QUAD, UBUS_SLV_APB_MASK, reg_ubus_slv_apb_mask);
...
{
    uint32_t reg_ubus_slv_apb_mask;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, UBUS_SLV_APB_MASK, reg_ubus_slv_apb_mask);

    *mask = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_APB_MASK, MASK, reg_ubus_slv_apb_mask);
...
{
    uint32_t reg_ubus_slv_dqm_base=0;
    ...
    reg_ubus_slv_dqm_base = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_DQM_BASE, BASE, reg_ubus_slv_dqm_base, base);

    RU_REG_WRITE(quad_idx, RNR_QUAD, UBUS_SLV_DQM_BASE, reg_ubus_slv_dqm_base);
...
{
    uint32_t reg_ubus_slv_dqm_base;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, UBUS_SLV_DQM_BASE, reg_ubus_slv_dqm_base);

    *base = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_DQM_BASE, BASE, reg_ubus_slv_dqm_base);
...
{
    uint32_t reg_ubus_slv_dqm_mask=0;
    ...
    reg_ubus_slv_dqm_mask = RU_FIELD_SET(quad_idx, RNR_QUAD, UBUS_SLV_DQM_MASK, MASK, reg_ubus_slv_dqm_mask, mask);

    RU_REG_WRITE(quad_idx, RNR_QUAD, UBUS_SLV_DQM_MASK, reg_ubus_slv_dqm_mask);
...
{
    uint32_t reg_ubus_slv_dqm_mask;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, UBUS_SLV_DQM_MASK, reg_ubus_slv_dqm_mask);

    *mask = RU_FIELD_GET(quad_idx, RNR_QUAD, UBUS_SLV_DQM_MASK, MASK, reg_ubus_slv_dqm_mask);
...
bdmf_error_t ag_drv_rnr_quad_general_config_profiling_counter_get(uint8_t quad_idx, uint32_t *counter_lsb_val)
{
    uint32_t reg_general_config_profiling_counter;
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, GENERAL_CONFIG_PROFILING_COUNTER, reg_general_config_profiling_counter);

    *counter_lsb_val = RU_FIELD_GET(quad_idx, RNR_QUAD, GENERAL_CONFIG_PROFILING_COUNTER, COUNTER_LSB_VAL, reg_general_config_profiling_counter);
...
bdmf_error_t ag_drv_rnr_quad_general_config_powersave_status_get(uint8_t quad_idx, bdmf_boolean *core_0_status, bdmf_boolean *core_1_status, bdmf_boolean *core_2_status, bdmf_boolean *core_3_status)
{
...
#ifdef VALIDATE_PARMS
    if(!core_0_status || !core_1_status || !core_2_status || !core_3_status)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    *core_0_status = RU_FIELD_GET(quad_idx, RNR_QUAD, GENERAL_CONFIG_POWERSAVE_STATUS, CORE_0_STATUS, reg_general_config_powersave_status);
    *core_1_status = RU_FIELD_GET(quad_idx, RNR_QUAD, GENERAL_CONFIG_POWERSAVE_STATUS, CORE_1_STATUS, reg_general_config_powersave_status);
    *core_2_status = RU_FIELD_GET(quad_idx, RNR_QUAD, GENERAL_CONFIG_POWERSAVE_STATUS, CORE_2_STATUS, reg_general_config_powersave_status);
    *core_3_status = RU_FIELD_GET(quad_idx, RNR_QUAD, GENERAL_CONFIG_POWERSAVE_STATUS, CORE_3_STATUS, reg_general_config_powersave_status);
...
typedef enum
{
    bdmf_address_ubus_slv_res_cntrl,
    bdmf_address_ubus_slv_vpb_base,
    bdmf_address_ubus_slv_vpb_mask,
    bdmf_address_ubus_slv_apb_base,
    bdmf_address_ubus_slv_apb_mask,
    bdmf_address_ubus_slv_dqm_base,
    bdmf_address_ubus_slv_dqm_mask,
    ...
    bdmf_address_parser_core_configuration_ip_filter2_cfg,
    bdmf_address_parser_core_configuration_ip_filter3_cfg,
    bdmf_address_parser_core_configuration_ip_filter0_mask_cfg,
    bdmf_address_parser_core_configuration_ip_filter1_mask_cfg,
    bdmf_address_parser_core_configuration_ip_filter2_mask_cfg,
    bdmf_address_parser_core_configuration_ip_filter3_mask_cfg,
    ...
    bdmf_address_parser_core_configuration_da_filt9_val_l,
    bdmf_address_parser_core_configuration_da_filt9_val_h,
    bdmf_address_parser_core_configuration_da_filt10_val_l,
    bdmf_address_parser_core_configuration_da_filt10_val_h,
    ...
    bdmf_address_general_config_profiling_counter,
...
static int bcm_rnr_quad_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_rnr_quad_parser_ip2:
    {
        rnr_quad_parser_ip0 parser_ip0 = { .ip_address=parm[2].value.unumber, .ip_address_mask=parm[3].value.unumber, .ip_filter0_dip_en=parm[4].value.unumber, .ip_filter0_valid=parm[5].value.unumber};
        err = ag_drv_rnr_quad_parser_ip2_set(parm[1].value.unumber, &parser_ip0);
        break;
    }
    case cli_rnr_quad_parser_ip3:
    {
        rnr_quad_parser_ip0 parser_ip0 = { .ip_address=parm[2].value.unumber, .ip_address_mask=parm[3].value.unumber, .ip_filter0_dip_en=parm[4].value.unumber, .ip_filter0_valid=parm[5].value.unumber};
        err = ag_drv_rnr_quad_parser_ip3_set(parm[1].value.unumber, &parser_ip0);
        break;
    }
    case cli_rnr_quad_parser_hardcoded_ethtype0:
    {
        rnr_quad_parser_hardcoded_ethtype0 parser_hardcoded_ethtype0 = { .hard_nest_profile=parm[2].value.unumber, .qtag_nest_0_profile_0=parm[3].value.unumber, .qtag_nest_1_profile_0=parm[4].value.unumber};
        err = ag_drv_rnr_quad_parser_hardcoded_ethtype0_set(parm[1].value.unumber, &parser_hardcoded_ethtype0);
        break;
    }
    case cli_rnr_quad_parser_hardcoded_ethtype1:
    {
        rnr_quad_parser_hardcoded_ethtype0 parser_hardcoded_ethtype0 = { .hard_nest_profile=parm[2].value.unumber, .qtag_nest_0_profile_0=parm[3].value.unumber, .qtag_nest_1_profile_0=parm[4].value.unumber};
        err = ag_drv_rnr_quad_parser_hardcoded_ethtype1_set(parm[1].value.unumber, &parser_hardcoded_ethtype0);
        break;
    }
    case cli_rnr_quad_parser_hardcoded_ethtype2:
    {
        rnr_quad_parser_hardcoded_ethtype0 parser_hardcoded_ethtype0 = { .hard_nest_profile=parm[2].value.unumber, .qtag_nest_0_profile_0=parm[3].value.unumber, .qtag_nest_1_profile_0=parm[4].value.unumber};
        err = ag_drv_rnr_quad_parser_hardcoded_ethtype2_set(parm[1].value.unumber, &parser_hardcoded_ethtype0);
        break;
    }
    ...
    case cli_rnr_quad_parser_da_filter8:
        ...
        break;
    case cli_rnr_quad_parser_da_filter9:
        err = ag_drv_rnr_quad_parser_da_filter9_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_rnr_quad_parser_da_filter10:
        err = ag_drv_rnr_quad_parser_da_filter10_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_rnr_quad_da_filter_profile_0:
        err = ag_drv_rnr_quad_da_filter_profile_0_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_rnr_quad_da_filter_profile_1:
        err = ag_drv_rnr_quad_da_filter_profile_1_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_rnr_quad_da_filter_profile_2:
        err = ag_drv_rnr_quad_da_filter_profile_2_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    ...
    case cli_rnr_quad_ubus_slv_res_cntrl:
    {
        rnr_quad_ubus_slv_res_cntrl ubus_slv_res_cntrl = { .mask_id=parm[2].value.unumber, .repin_eswap=parm[3].value.unumber, .reqout_eswap=parm[4].value.unumber, .dev_clken=parm[5].value.unumber, .dev_err=parm[6].value.unumber, .dev_timeout_en=parm[7].value.unumber, .dev_timeout=parm[8].value.unumber};
        err = ag_drv_rnr_quad_ubus_slv_res_cntrl_set(parm[1].value.unumber, &ubus_slv_res_cntrl);
        break;
    }
    case cli_rnr_quad_ubus_slv_vpb_base:
        err = ag_drv_rnr_quad_ubus_slv_vpb_base_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_rnr_quad_ubus_slv_vpb_mask:
        err = ag_drv_rnr_quad_ubus_slv_vpb_mask_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_rnr_quad_ubus_slv_apb_base:
        err = ag_drv_rnr_quad_ubus_slv_apb_base_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_rnr_quad_ubus_slv_apb_mask:
        err = ag_drv_rnr_quad_ubus_slv_apb_mask_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_rnr_quad_ubus_slv_dqm_base:
        err = ag_drv_rnr_quad_ubus_slv_dqm_base_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_rnr_quad_ubus_slv_dqm_mask:
        err = ag_drv_rnr_quad_ubus_slv_dqm_mask_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    ...
    {
        rnr_quad_general_config_profiling_config general_config_profiling_config = { .counter_lsb_sel=parm[2].value.unumber, .enable_trace_core_0=parm[3].value.unumber, .enable_trace_core_1=parm[4].value.unumber, .enable_trace_core_2=parm[5].value.unumber, .enable_trace_core_3=parm[6].value.unumber};
    ...
    {
        rnr_quad_general_config_powersave_config general_config_powersave_config = { .time_counter=parm[2].value.unumber, .enable_powersave_core_0=parm[3].value.unumber, .enable_powersave_core_1=parm[4].value.unumber, .enable_powersave_core_2=parm[5].value.unumber, .enable_powersave_core_3=parm[6].value.unumber};
...
int bcm_rnr_quad_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        rnr_quad_parser_ip0 parser_ip0;
        err = ag_drv_rnr_quad_parser_ip2_get(parm[1].value.unumber, &parser_ip0);
        bdmf_session_print(session, "ip_address = %u (0x%x)\n", parser_ip0.ip_address, parser_ip0.ip_address);
        bdmf_session_print(session, "ip_address_mask = %u (0x%x)\n", parser_ip0.ip_address_mask, parser_ip0.ip_address_mask);
        bdmf_session_print(session, "ip_filter0_dip_en = %u (0x%x)\n", parser_ip0.ip_filter0_dip_en, parser_ip0.ip_filter0_dip_en);
        bdmf_session_print(session, "ip_filter0_valid = %u (0x%x)\n", parser_ip0.ip_filter0_valid, parser_ip0.ip_filter0_valid);
    ...
    {
        rnr_quad_parser_ip0 parser_ip0;
        err = ag_drv_rnr_quad_parser_ip3_get(parm[1].value.unumber, &parser_ip0);
        bdmf_session_print(session, "ip_address = %u (0x%x)\n", parser_ip0.ip_address, parser_ip0.ip_address);
        bdmf_session_print(session, "ip_address_mask = %u (0x%x)\n", parser_ip0.ip_address_mask, parser_ip0.ip_address_mask);
        bdmf_session_print(session, "ip_filter0_dip_en = %u (0x%x)\n", parser_ip0.ip_filter0_dip_en, parser_ip0.ip_filter0_dip_en);
        bdmf_session_print(session, "ip_filter0_valid = %u (0x%x)\n", parser_ip0.ip_filter0_valid, parser_ip0.ip_filter0_valid);
    ...
    case cli_rnr_quad_parser_hardcoded_ethtype0:
    {
        rnr_quad_parser_hardcoded_ethtype0 parser_hardcoded_ethtype0;
        err = ag_drv_rnr_quad_parser_hardcoded_ethtype0_get(parm[1].value.unumber, &parser_hardcoded_ethtype0);
        bdmf_session_print(session, "hard_nest_profile = %u (0x%x)\n", parser_hardcoded_ethtype0.hard_nest_profile, parser_hardcoded_ethtype0.hard_nest_profile);
        bdmf_session_print(session, "qtag_nest_0_profile_0 = %u (0x%x)\n", parser_hardcoded_ethtype0.qtag_nest_0_profile_0, parser_hardcoded_ethtype0.qtag_nest_0_profile_0);
        bdmf_session_print(session, "qtag_nest_1_profile_0 = %u (0x%x)\n", parser_hardcoded_ethtype0.qtag_nest_1_profile_0, parser_hardcoded_ethtype0.qtag_nest_1_profile_0);
        break;
    }
    case cli_rnr_quad_parser_hardcoded_ethtype1:
    {
        rnr_quad_parser_hardcoded_ethtype0 parser_hardcoded_ethtype0;
        err = ag_drv_rnr_quad_parser_hardcoded_ethtype1_get(parm[1].value.unumber, &parser_hardcoded_ethtype0);
        bdmf_session_print(session, "hard_nest_profile = %u (0x%x)\n", parser_hardcoded_ethtype0.hard_nest_profile, parser_hardcoded_ethtype0.hard_nest_profile);
        bdmf_session_print(session, "qtag_nest_0_profile_0 = %u (0x%x)\n", parser_hardcoded_ethtype0.qtag_nest_0_profile_0, parser_hardcoded_ethtype0.qtag_nest_0_profile_0);
        bdmf_session_print(session, "qtag_nest_1_profile_0 = %u (0x%x)\n", parser_hardcoded_ethtype0.qtag_nest_1_profile_0, parser_hardcoded_ethtype0.qtag_nest_1_profile_0);
        break;
    ...
    {
        rnr_quad_parser_hardcoded_ethtype0 parser_hardcoded_ethtype0;
        err = ag_drv_rnr_quad_parser_hardcoded_ethtype2_get(parm[1].value.unumber, &parser_hardcoded_ethtype0);
        bdmf_session_print(session, "hard_nest_profile = %u (0x%x)\n", parser_hardcoded_ethtype0.hard_nest_profile, parser_hardcoded_ethtype0.hard_nest_profile);
        bdmf_session_print(session, "qtag_nest_0_profile_0 = %u (0x%x)\n", parser_hardcoded_ethtype0.qtag_nest_0_profile_0, parser_hardcoded_ethtype0.qtag_nest_0_profile_0);
        bdmf_session_print(session, "qtag_nest_1_profile_0 = %u (0x%x)\n", parser_hardcoded_ethtype0.qtag_nest_1_profile_0, parser_hardcoded_ethtype0.qtag_nest_1_profile_0);
        break;
    ...
    case cli_rnr_quad_parser_da_filter9:
    {
        uint16_t da_filt_msb;
        uint32_t da_filt_lsb;
        err = ag_drv_rnr_quad_parser_da_filter9_get(parm[1].value.unumber, &da_filt_msb, &da_filt_lsb);
        bdmf_session_print(session, "da_filt_msb = %u (0x%x)\n", da_filt_msb, da_filt_msb);
        bdmf_session_print(session, "da_filt_lsb = %u (0x%x)\n", da_filt_lsb, da_filt_lsb);
        break;
    }
    case cli_rnr_quad_parser_da_filter10:
    {
        uint16_t da_filt_msb;
        uint32_t da_filt_lsb;
        err = ag_drv_rnr_quad_parser_da_filter10_get(parm[1].value.unumber, &da_filt_msb, &da_filt_lsb);
        bdmf_session_print(session, "da_filt_msb = %u (0x%x)\n", da_filt_msb, da_filt_msb);
        bdmf_session_print(session, "da_filt_lsb = %u (0x%x)\n", da_filt_lsb, da_filt_lsb);
        break;
    }
    ...
    {
        bdmf_boolean data;
        err = ag_drv_rnr_quad_da_filter_profile_0_get(parm[1].value.unumber, parm[2].value.unumber, &data);
    ...
    {
        bdmf_boolean data;
        err = ag_drv_rnr_quad_da_filter_profile_1_get(parm[1].value.unumber, parm[2].value.unumber, &data);
        bdmf_session_print(session, "data = %u (0x%x)\n", data, data);
        break;
    }
    case cli_rnr_quad_da_filter_profile_2:
    {
        bdmf_boolean data;
        err = ag_drv_rnr_quad_da_filter_profile_2_get(parm[1].value.unumber, parm[2].value.unumber, &data);
        bdmf_session_print(session, "data = %u (0x%x)\n", data, data);
        break;
    }
    case cli_rnr_quad_exception_bits:
    ...
    case cli_rnr_quad_ubus_slv_res_cntrl:
    {
        rnr_quad_ubus_slv_res_cntrl ubus_slv_res_cntrl;
        err = ag_drv_rnr_quad_ubus_slv_res_cntrl_get(parm[1].value.unumber, &ubus_slv_res_cntrl);
        bdmf_session_print(session, "mask_id = %u (0x%x)\n", ubus_slv_res_cntrl.mask_id, ubus_slv_res_cntrl.mask_id);
        bdmf_session_print(session, "repin_eswap = %u (0x%x)\n", ubus_slv_res_cntrl.repin_eswap, ubus_slv_res_cntrl.repin_eswap);
        bdmf_session_print(session, "reqout_eswap = %u (0x%x)\n", ubus_slv_res_cntrl.reqout_eswap, ubus_slv_res_cntrl.reqout_eswap);
        bdmf_session_print(session, "dev_clken = %u (0x%x)\n", ubus_slv_res_cntrl.dev_clken, ubus_slv_res_cntrl.dev_clken);
        bdmf_session_print(session, "dev_err = %u (0x%x)\n", ubus_slv_res_cntrl.dev_err, ubus_slv_res_cntrl.dev_err);
        bdmf_session_print(session, "dev_timeout_en = %u (0x%x)\n", ubus_slv_res_cntrl.dev_timeout_en, ubus_slv_res_cntrl.dev_timeout_en);
        bdmf_session_print(session, "dev_timeout = %u (0x%x)\n", ubus_slv_res_cntrl.dev_timeout, ubus_slv_res_cntrl.dev_timeout);
        break;
    }
    case cli_rnr_quad_ubus_slv_vpb_base:
    {
        uint32_t base;
        err = ag_drv_rnr_quad_ubus_slv_vpb_base_get(parm[1].value.unumber, &base);
    ...
    {
        uint32_t mask;
        err = ag_drv_rnr_quad_ubus_slv_vpb_mask_get(parm[1].value.unumber, &mask);
    ...
    {
        uint32_t base;
        err = ag_drv_rnr_quad_ubus_slv_apb_base_get(parm[1].value.unumber, &base);
        bdmf_session_print(session, "base = %u (0x%x)\n", base, base);
        break;
    }
    case cli_rnr_quad_ubus_slv_apb_mask:
    {
        uint32_t mask;
        err = ag_drv_rnr_quad_ubus_slv_apb_mask_get(parm[1].value.unumber, &mask);
        bdmf_session_print(session, "mask = %u (0x%x)\n", mask, mask);
        break;
    }
    case cli_rnr_quad_ubus_slv_dqm_base:
    {
        uint32_t base;
        err = ag_drv_rnr_quad_ubus_slv_dqm_base_get(parm[1].value.unumber, &base);
        bdmf_session_print(session, "base = %u (0x%x)\n", base, base);
        break;
    }
    case cli_rnr_quad_ubus_slv_dqm_mask:
    {
        uint32_t mask;
        err = ag_drv_rnr_quad_ubus_slv_dqm_mask_get(parm[1].value.unumber, &mask);
        bdmf_session_print(session, "mask = %u (0x%x)\n", mask, mask);
        break;
    }
    case cli_rnr_quad_parser_core_configuration_eng:
    ...
    case cli_rnr_quad_general_config_profiling_counter:
    {
        uint32_t counter_lsb_val;
        err = ag_drv_rnr_quad_general_config_profiling_counter_get(parm[1].value.unumber, &counter_lsb_val);
        bdmf_session_print(session, "counter_lsb_val = %u (0x%x)\n", counter_lsb_val, counter_lsb_val);
        break;
    }
    case cli_rnr_quad_general_config_bkpt_0_cfg:
    {
    ...
    {
        bdmf_boolean core_0_status;
        bdmf_boolean core_1_status;
        bdmf_boolean core_2_status;
        bdmf_boolean core_3_status;
        err = ag_drv_rnr_quad_general_config_powersave_status_get(parm[1].value.unumber, &core_0_status, &core_1_status, &core_2_status, &core_3_status);
        bdmf_session_print(session, "core_0_status = %u (0x%x)\n", core_0_status, core_0_status);
        bdmf_session_print(session, "core_1_status = %u (0x%x)\n", core_1_status, core_1_status);
        bdmf_session_print(session, "core_2_status = %u (0x%x)\n", core_2_status, core_2_status);
        bdmf_session_print(session, "core_3_status = %u (0x%x)\n", core_3_status, core_3_status);
        break;
    }
    case cli_rnr_quad_debug_fifo_config:
    {
...
static int bcm_rnr_quad_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        rnr_quad_parser_ip0 parser_ip0 = {.ip_address=gtmv(m, 32), .ip_address_mask=gtmv(m, 32), .ip_filter0_dip_en=gtmv(m, 1), .ip_filter0_valid=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_ip2_set(%u %u %u %u %u)\n", quad_idx, parser_ip0.ip_address, parser_ip0.ip_address_mask, parser_ip0.ip_filter0_dip_en, parser_ip0.ip_filter0_valid);
        if(!err) ag_drv_rnr_quad_parser_ip2_set(quad_idx, &parser_ip0);
        if(!err) ag_drv_rnr_quad_parser_ip2_get( quad_idx, &parser_ip0);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_ip2_get(%u %u %u %u %u)\n", quad_idx, parser_ip0.ip_address, parser_ip0.ip_address_mask, parser_ip0.ip_filter0_dip_en, parser_ip0.ip_filter0_valid);
        if(err || parser_ip0.ip_address!=gtmv(m, 32) || parser_ip0.ip_address_mask!=gtmv(m, 32) || parser_ip0.ip_filter0_dip_en!=gtmv(m, 1) || parser_ip0.ip_filter0_valid!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        rnr_quad_parser_ip0 parser_ip0 = {.ip_address=gtmv(m, 32), .ip_address_mask=gtmv(m, 32), .ip_filter0_dip_en=gtmv(m, 1), .ip_filter0_valid=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_ip3_set(%u %u %u %u %u)\n", quad_idx, parser_ip0.ip_address, parser_ip0.ip_address_mask, parser_ip0.ip_filter0_dip_en, parser_ip0.ip_filter0_valid);
        if(!err) ag_drv_rnr_quad_parser_ip3_set(quad_idx, &parser_ip0);
        if(!err) ag_drv_rnr_quad_parser_ip3_get( quad_idx, &parser_ip0);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_ip3_get(%u %u %u %u %u)\n", quad_idx, parser_ip0.ip_address, parser_ip0.ip_address_mask, parser_ip0.ip_filter0_dip_en, parser_ip0.ip_filter0_valid);
        if(err || parser_ip0.ip_address!=gtmv(m, 32) || parser_ip0.ip_address_mask!=gtmv(m, 32) || parser_ip0.ip_filter0_dip_en!=gtmv(m, 1) || parser_ip0.ip_filter0_valid!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        rnr_quad_parser_hardcoded_ethtype0 parser_hardcoded_ethtype0 = {.hard_nest_profile=gtmv(m, 12), .qtag_nest_0_profile_0=gtmv(m, 3), .qtag_nest_1_profile_0=gtmv(m, 3)};
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_hardcoded_ethtype0_set(%u %u %u %u)\n", quad_idx, parser_hardcoded_ethtype0.hard_nest_profile, parser_hardcoded_ethtype0.qtag_nest_0_profile_0, parser_hardcoded_ethtype0.qtag_nest_1_profile_0);
        if(!err) ag_drv_rnr_quad_parser_hardcoded_ethtype0_set(quad_idx, &parser_hardcoded_ethtype0);
        if(!err) ag_drv_rnr_quad_parser_hardcoded_ethtype0_get( quad_idx, &parser_hardcoded_ethtype0);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_hardcoded_ethtype0_get(%u %u %u %u)\n", quad_idx, parser_hardcoded_ethtype0.hard_nest_profile, parser_hardcoded_ethtype0.qtag_nest_0_profile_0, parser_hardcoded_ethtype0.qtag_nest_1_profile_0);
        if(err || parser_hardcoded_ethtype0.hard_nest_profile!=gtmv(m, 12) || parser_hardcoded_ethtype0.qtag_nest_0_profile_0!=gtmv(m, 3) || parser_hardcoded_ethtype0.qtag_nest_1_profile_0!=gtmv(m, 3))
            return err ? err : BDMF_ERR_IO;
    }
    {
        rnr_quad_parser_hardcoded_ethtype0 parser_hardcoded_ethtype0 = {.hard_nest_profile=gtmv(m, 12), .qtag_nest_0_profile_0=gtmv(m, 3), .qtag_nest_1_profile_0=gtmv(m, 3)};
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_hardcoded_ethtype1_set(%u %u %u %u)\n", quad_idx, parser_hardcoded_ethtype0.hard_nest_profile, parser_hardcoded_ethtype0.qtag_nest_0_profile_0, parser_hardcoded_ethtype0.qtag_nest_1_profile_0);
        if(!err) ag_drv_rnr_quad_parser_hardcoded_ethtype1_set(quad_idx, &parser_hardcoded_ethtype0);
        if(!err) ag_drv_rnr_quad_parser_hardcoded_ethtype1_get( quad_idx, &parser_hardcoded_ethtype0);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_hardcoded_ethtype1_get(%u %u %u %u)\n", quad_idx, parser_hardcoded_ethtype0.hard_nest_profile, parser_hardcoded_ethtype0.qtag_nest_0_profile_0, parser_hardcoded_ethtype0.qtag_nest_1_profile_0);
        if(err || parser_hardcoded_ethtype0.hard_nest_profile!=gtmv(m, 12) || parser_hardcoded_ethtype0.qtag_nest_0_profile_0!=gtmv(m, 3) || parser_hardcoded_ethtype0.qtag_nest_1_profile_0!=gtmv(m, 3))
            return err ? err : BDMF_ERR_IO;
    }
    {
        rnr_quad_parser_hardcoded_ethtype0 parser_hardcoded_ethtype0 = {.hard_nest_profile=gtmv(m, 12), .qtag_nest_0_profile_0=gtmv(m, 3), .qtag_nest_1_profile_0=gtmv(m, 3)};
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_hardcoded_ethtype2_set(%u %u %u %u)\n", quad_idx, parser_hardcoded_ethtype0.hard_nest_profile, parser_hardcoded_ethtype0.qtag_nest_0_profile_0, parser_hardcoded_ethtype0.qtag_nest_1_profile_0);
        if(!err) ag_drv_rnr_quad_parser_hardcoded_ethtype2_set(quad_idx, &parser_hardcoded_ethtype0);
        if(!err) ag_drv_rnr_quad_parser_hardcoded_ethtype2_get( quad_idx, &parser_hardcoded_ethtype0);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_hardcoded_ethtype2_get(%u %u %u %u)\n", quad_idx, parser_hardcoded_ethtype0.hard_nest_profile, parser_hardcoded_ethtype0.qtag_nest_0_profile_0, parser_hardcoded_ethtype0.qtag_nest_1_profile_0);
        if(err || parser_hardcoded_ethtype0.hard_nest_profile!=gtmv(m, 12) || parser_hardcoded_ethtype0.qtag_nest_0_profile_0!=gtmv(m, 3) || parser_hardcoded_ethtype0.qtag_nest_1_profile_0!=gtmv(m, 3))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    }
    {
        uint16_t da_filt_msb=gtmv(m, 16);
        uint32_t da_filt_lsb=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_da_filter9_set(%u %u %u)\n", quad_idx, da_filt_msb, da_filt_lsb);
        if(!err) ag_drv_rnr_quad_parser_da_filter9_set(quad_idx, da_filt_msb, da_filt_lsb);
        if(!err) ag_drv_rnr_quad_parser_da_filter9_get( quad_idx, &da_filt_msb, &da_filt_lsb);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_da_filter9_get(%u %u %u)\n", quad_idx, da_filt_msb, da_filt_lsb);
        if(err || da_filt_msb!=gtmv(m, 16) || da_filt_lsb!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t da_filt_msb=gtmv(m, 16);
        uint32_t da_filt_lsb=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_da_filter10_set(%u %u %u)\n", quad_idx, da_filt_msb, da_filt_lsb);
        if(!err) ag_drv_rnr_quad_parser_da_filter10_set(quad_idx, da_filt_msb, da_filt_lsb);
        if(!err) ag_drv_rnr_quad_parser_da_filter10_get( quad_idx, &da_filt_msb, &da_filt_lsb);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_parser_da_filter10_get(%u %u %u)\n", quad_idx, da_filt_msb, da_filt_lsb);
        if(err || da_filt_msb!=gtmv(m, 16) || da_filt_lsb!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t filter_idx=gtmv(m, 5);
        bdmf_boolean data=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_da_filter_profile_0_set(%u %u %u)\n", quad_idx, filter_idx, data);
        if(!err) ag_drv_rnr_quad_da_filter_profile_0_set(quad_idx, filter_idx, data);
        if(!err) ag_drv_rnr_quad_da_filter_profile_0_get( quad_idx, filter_idx, &data);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_da_filter_profile_0_get(%u %u %u)\n", quad_idx, filter_idx, data);
    ...
    }
    {
        uint8_t filter_idx=gtmv(m, 5);
        bdmf_boolean data=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_da_filter_profile_1_set(%u %u %u)\n", quad_idx, filter_idx, data);
        if(!err) ag_drv_rnr_quad_da_filter_profile_1_set(quad_idx, filter_idx, data);
        if(!err) ag_drv_rnr_quad_da_filter_profile_1_get( quad_idx, filter_idx, &data);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_da_filter_profile_1_get(%u %u %u)\n", quad_idx, filter_idx, data);
        if(err || data!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t filter_idx=gtmv(m, 5);
        bdmf_boolean data=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_da_filter_profile_2_set(%u %u %u)\n", quad_idx, filter_idx, data);
        if(!err) ag_drv_rnr_quad_da_filter_profile_2_set(quad_idx, filter_idx, data);
        if(!err) ag_drv_rnr_quad_da_filter_profile_2_get( quad_idx, filter_idx, &data);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_da_filter_profile_2_get(%u %u %u)\n", quad_idx, filter_idx, data);
        if(err || data!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        rnr_quad_ubus_slv_res_cntrl ubus_slv_res_cntrl = {.mask_id=gtmv(m, 8), .repin_eswap=gtmv(m, 1), .reqout_eswap=gtmv(m, 1), .dev_clken=gtmv(m, 1), .dev_err=gtmv(m, 1), .dev_timeout_en=gtmv(m, 1), .dev_timeout=gtmv(m, 11)};
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_res_cntrl_set(%u %u %u %u %u %u %u %u)\n", quad_idx, ubus_slv_res_cntrl.mask_id, ubus_slv_res_cntrl.repin_eswap, ubus_slv_res_cntrl.reqout_eswap, ubus_slv_res_cntrl.dev_clken, ubus_slv_res_cntrl.dev_err, ubus_slv_res_cntrl.dev_timeout_en, ubus_slv_res_cntrl.dev_timeout);
        if(!err) ag_drv_rnr_quad_ubus_slv_res_cntrl_set(quad_idx, &ubus_slv_res_cntrl);
        if(!err) ag_drv_rnr_quad_ubus_slv_res_cntrl_get( quad_idx, &ubus_slv_res_cntrl);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_res_cntrl_get(%u %u %u %u %u %u %u %u)\n", quad_idx, ubus_slv_res_cntrl.mask_id, ubus_slv_res_cntrl.repin_eswap, ubus_slv_res_cntrl.reqout_eswap, ubus_slv_res_cntrl.dev_clken, ubus_slv_res_cntrl.dev_err, ubus_slv_res_cntrl.dev_timeout_en, ubus_slv_res_cntrl.dev_timeout);
        if(err || ubus_slv_res_cntrl.mask_id!=gtmv(m, 8) || ubus_slv_res_cntrl.repin_eswap!=gtmv(m, 1) || ubus_slv_res_cntrl.reqout_eswap!=gtmv(m, 1) || ubus_slv_res_cntrl.dev_clken!=gtmv(m, 1) || ubus_slv_res_cntrl.dev_err!=gtmv(m, 1) || ubus_slv_res_cntrl.dev_timeout_en!=gtmv(m, 1) || ubus_slv_res_cntrl.dev_timeout!=gtmv(m, 11))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t base=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_vpb_base_set(%u %u)\n", quad_idx, base);
        if(!err) ag_drv_rnr_quad_ubus_slv_vpb_base_set(quad_idx, base);
        if(!err) ag_drv_rnr_quad_ubus_slv_vpb_base_get( quad_idx, &base);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_vpb_base_get(%u %u)\n", quad_idx, base);
        if(err || base!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t mask=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_vpb_mask_set(%u %u)\n", quad_idx, mask);
        if(!err) ag_drv_rnr_quad_ubus_slv_vpb_mask_set(quad_idx, mask);
        if(!err) ag_drv_rnr_quad_ubus_slv_vpb_mask_get( quad_idx, &mask);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_vpb_mask_get(%u %u)\n", quad_idx, mask);
        if(err || mask!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t base=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_apb_base_set(%u %u)\n", quad_idx, base);
        if(!err) ag_drv_rnr_quad_ubus_slv_apb_base_set(quad_idx, base);
        if(!err) ag_drv_rnr_quad_ubus_slv_apb_base_get( quad_idx, &base);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_apb_base_get(%u %u)\n", quad_idx, base);
        if(err || base!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t mask=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_apb_mask_set(%u %u)\n", quad_idx, mask);
        if(!err) ag_drv_rnr_quad_ubus_slv_apb_mask_set(quad_idx, mask);
        if(!err) ag_drv_rnr_quad_ubus_slv_apb_mask_get( quad_idx, &mask);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_apb_mask_get(%u %u)\n", quad_idx, mask);
        if(err || mask!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t base=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_dqm_base_set(%u %u)\n", quad_idx, base);
        if(!err) ag_drv_rnr_quad_ubus_slv_dqm_base_set(quad_idx, base);
        if(!err) ag_drv_rnr_quad_ubus_slv_dqm_base_get( quad_idx, &base);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_dqm_base_get(%u %u)\n", quad_idx, base);
        if(err || base!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t mask=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_dqm_mask_set(%u %u)\n", quad_idx, mask);
        if(!err) ag_drv_rnr_quad_ubus_slv_dqm_mask_set(quad_idx, mask);
        if(!err) ag_drv_rnr_quad_ubus_slv_dqm_mask_get( quad_idx, &mask);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_ubus_slv_dqm_mask_get(%u %u)\n", quad_idx, mask);
        if(err || mask!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        rnr_quad_general_config_profiling_config general_config_profiling_config = {.counter_lsb_sel=gtmv(m, 5), .enable_trace_core_0=gtmv(m, 1), .enable_trace_core_1=gtmv(m, 1), .enable_trace_core_2=gtmv(m, 1), .enable_trace_core_3=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_general_config_profiling_config_set(%u %u %u %u %u %u)\n", quad_idx, general_config_profiling_config.counter_lsb_sel, general_config_profiling_config.enable_trace_core_0, general_config_profiling_config.enable_trace_core_1, general_config_profiling_config.enable_trace_core_2, general_config_profiling_config.enable_trace_core_3);
        ...
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_general_config_profiling_config_get(%u %u %u %u %u %u)\n", quad_idx, general_config_profiling_config.counter_lsb_sel, general_config_profiling_config.enable_trace_core_0, general_config_profiling_config.enable_trace_core_1, general_config_profiling_config.enable_trace_core_2, general_config_profiling_config.enable_trace_core_3);
        if(err || general_config_profiling_config.counter_lsb_sel!=gtmv(m, 5) || general_config_profiling_config.enable_trace_core_0!=gtmv(m, 1) || general_config_profiling_config.enable_trace_core_1!=gtmv(m, 1) || general_config_profiling_config.enable_trace_core_2!=gtmv(m, 1) || general_config_profiling_config.enable_trace_core_3!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t counter_lsb_val=gtmv(m, 32);
        if(!err) ag_drv_rnr_quad_general_config_profiling_counter_get( quad_idx, &counter_lsb_val);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_general_config_profiling_counter_get(%u %u)\n", quad_idx, counter_lsb_val);
    }
    {
    ...
    {
        rnr_quad_general_config_powersave_config general_config_powersave_config = {.time_counter=gtmv(m, 8), .enable_powersave_core_0=gtmv(m, 1), .enable_powersave_core_1=gtmv(m, 1), .enable_powersave_core_2=gtmv(m, 1), .enable_powersave_core_3=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_general_config_powersave_config_set(%u %u %u %u %u %u)\n", quad_idx, general_config_powersave_config.time_counter, general_config_powersave_config.enable_powersave_core_0, general_config_powersave_config.enable_powersave_core_1, general_config_powersave_config.enable_powersave_core_2, general_config_powersave_config.enable_powersave_core_3);
        ...
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_general_config_powersave_config_get(%u %u %u %u %u %u)\n", quad_idx, general_config_powersave_config.time_counter, general_config_powersave_config.enable_powersave_core_0, general_config_powersave_config.enable_powersave_core_1, general_config_powersave_config.enable_powersave_core_2, general_config_powersave_config.enable_powersave_core_3);
    ...
    {
        bdmf_boolean core_0_status=gtmv(m, 1);
        bdmf_boolean core_1_status=gtmv(m, 1);
        bdmf_boolean core_2_status=gtmv(m, 1);
        bdmf_boolean core_3_status=gtmv(m, 1);
        if(!err) ag_drv_rnr_quad_general_config_powersave_status_get( quad_idx, &core_0_status, &core_1_status, &core_2_status, &core_3_status);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_quad_general_config_powersave_status_get(%u %u %u %u %u)\n", quad_idx, core_0_status, core_1_status, core_2_status, core_3_status);
    }
    {
...
static int bcm_rnr_quad_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    switch (parm[0].value.unumber)
    {
    case bdmf_address_ubus_slv_res_cntrl : reg = &RU_REG(RNR_QUAD, UBUS_SLV_RES_CNTRL); blk = &RU_BLK(RNR_QUAD); break;
    case bdmf_address_ubus_slv_vpb_base : reg = &RU_REG(RNR_QUAD, UBUS_SLV_VPB_BASE); blk = &RU_BLK(RNR_QUAD); break;
    case bdmf_address_ubus_slv_vpb_mask : reg = &RU_REG(RNR_QUAD, UBUS_SLV_VPB_MASK); blk = &RU_BLK(RNR_QUAD); break;
    case bdmf_address_ubus_slv_apb_base : reg = &RU_REG(RNR_QUAD, UBUS_SLV_APB_BASE); blk = &RU_BLK(RNR_QUAD); break;
    case bdmf_address_ubus_slv_apb_mask : reg = &RU_REG(RNR_QUAD, UBUS_SLV_APB_MASK); blk = &RU_BLK(RNR_QUAD); break;
    case bdmf_address_ubus_slv_dqm_base : reg = &RU_REG(RNR_QUAD, UBUS_SLV_DQM_BASE); blk = &RU_BLK(RNR_QUAD); break;
    case bdmf_address_ubus_slv_dqm_mask : reg = &RU_REG(RNR_QUAD, UBUS_SLV_DQM_MASK); blk = &RU_BLK(RNR_QUAD); break;
    ...
    case bdmf_address_parser_core_configuration_ip_filter2_cfg : reg = &RU_REG(RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTER2_CFG); blk = &RU_BLK(RNR_QUAD); break;
    case bdmf_address_parser_core_configuration_ip_filter3_cfg : reg = &RU_REG(RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTER3_CFG); blk = &RU_BLK(RNR_QUAD); break;
    ...
    case bdmf_address_parser_core_configuration_ip_filter2_mask_cfg : reg = &RU_REG(RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTER2_MASK_CFG); blk = &RU_BLK(RNR_QUAD); break;
    case bdmf_address_parser_core_configuration_ip_filter3_mask_cfg : reg = &RU_REG(RNR_QUAD, PARSER_CORE_CONFIGURATION_IP_FILTER3_MASK_CFG); blk = &RU_BLK(RNR_QUAD); break;
    ...
    case bdmf_address_parser_core_configuration_da_filt9_val_l : reg = &RU_REG(RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT9_VAL_L); blk = &RU_BLK(RNR_QUAD); break;
    case bdmf_address_parser_core_configuration_da_filt9_val_h : reg = &RU_REG(RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT9_VAL_H); blk = &RU_BLK(RNR_QUAD); break;
    case bdmf_address_parser_core_configuration_da_filt10_val_l : reg = &RU_REG(RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT10_VAL_L); blk = &RU_BLK(RNR_QUAD); break;
    case bdmf_address_parser_core_configuration_da_filt10_val_h : reg = &RU_REG(RNR_QUAD, PARSER_CORE_CONFIGURATION_DA_FILT10_VAL_H); blk = &RU_BLK(RNR_QUAD); break;
    ...
    case bdmf_address_general_config_profiling_counter : reg = &RU_REG(RNR_QUAD, GENERAL_CONFIG_PROFILING_COUNTER); blk = &RU_BLK(RNR_QUAD); break;
...
bdmfmon_handle_t ag_drv_rnr_quad_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_parser_hardcoded_ethtype0[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
        ...
        static bdmfmon_cmd_parm_t set_parser_da_filter9[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
            BDMFMON_MAKE_PARM("da_filt_msb", "da_filt_msb", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("da_filt_lsb", "da_filt_lsb", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_parser_da_filter10[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
            BDMFMON_MAKE_PARM("da_filt_msb", "da_filt_msb", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("da_filt_lsb", "da_filt_lsb", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_da_filter_profile_0[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
            BDMFMON_MAKE_PARM("filter_idx", "filter_idx", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("data", "data", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_da_filter_profile_1[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
            BDMFMON_MAKE_PARM("filter_idx", "filter_idx", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("data", "data", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_da_filter_profile_2[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
            BDMFMON_MAKE_PARM("filter_idx", "filter_idx", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("data", "data", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        ...
        static bdmfmon_cmd_parm_t set_ubus_slv_res_cntrl[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
            BDMFMON_MAKE_PARM("mask_id", "mask_id", BDMFMON_PARM_NUMBER, 0),
            ...
            BDMFMON_MAKE_PARM("dev_clken", "dev_clken", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("dev_err", "dev_err", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("dev_timeout_en", "dev_timeout_en", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("dev_timeout", "dev_timeout", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_ubus_slv_vpb_base[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
            BDMFMON_MAKE_PARM("base", "base", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_ubus_slv_vpb_mask[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
            BDMFMON_MAKE_PARM("mask", "mask", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_ubus_slv_apb_base[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
            BDMFMON_MAKE_PARM("base", "base", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_ubus_slv_apb_mask[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
            BDMFMON_MAKE_PARM("mask", "mask", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_ubus_slv_dqm_base[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
            BDMFMON_MAKE_PARM("base", "base", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_ubus_slv_dqm_mask[]={
            BDMFMON_MAKE_PARM_ENUM("quad_idx", "quad_idx", quad_idx_enum_table, 0),
            BDMFMON_MAKE_PARM("mask", "mask", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="parser_ip2", .val=cli_rnr_quad_parser_ip2, .parms=set_parser_ip0 },
            { .name="parser_ip3", .val=cli_rnr_quad_parser_ip3, .parms=set_parser_ip0 },
            { .name="parser_hardcoded_ethtype0", .val=cli_rnr_quad_parser_hardcoded_ethtype0, .parms=set_parser_hardcoded_ethtype0 },
            { .name="parser_hardcoded_ethtype1", .val=cli_rnr_quad_parser_hardcoded_ethtype1, .parms=set_parser_hardcoded_ethtype0 },
            { .name="parser_hardcoded_ethtype2", .val=cli_rnr_quad_parser_hardcoded_ethtype2, .parms=set_parser_hardcoded_ethtype0 },
            ...
            { .name="parser_da_filter9", .val=cli_rnr_quad_parser_da_filter9, .parms=set_parser_da_filter9 },
            { .name="parser_da_filter10", .val=cli_rnr_quad_parser_da_filter10, .parms=set_parser_da_filter10 },
            { .name="da_filter_profile_0", .val=cli_rnr_quad_da_filter_profile_0, .parms=set_da_filter_profile_0 },
            { .name="da_filter_profile_1", .val=cli_rnr_quad_da_filter_profile_1, .parms=set_da_filter_profile_1 },
            { .name="da_filter_profile_2", .val=cli_rnr_quad_da_filter_profile_2, .parms=set_da_filter_profile_2 },
            ...
            { .name="ubus_slv_res_cntrl", .val=cli_rnr_quad_ubus_slv_res_cntrl, .parms=set_ubus_slv_res_cntrl },
            { .name="ubus_slv_vpb_base", .val=cli_rnr_quad_ubus_slv_vpb_base, .parms=set_ubus_slv_vpb_base },
            { .name="ubus_slv_vpb_mask", .val=cli_rnr_quad_ubus_slv_vpb_mask, .parms=set_ubus_slv_vpb_mask },
            { .name="ubus_slv_apb_base", .val=cli_rnr_quad_ubus_slv_apb_base, .parms=set_ubus_slv_apb_base },
            { .name="ubus_slv_apb_mask", .val=cli_rnr_quad_ubus_slv_apb_mask, .parms=set_ubus_slv_apb_mask },
            { .name="ubus_slv_dqm_base", .val=cli_rnr_quad_ubus_slv_dqm_base, .parms=set_ubus_slv_dqm_base },
            { .name="ubus_slv_dqm_mask", .val=cli_rnr_quad_ubus_slv_dqm_mask, .parms=set_ubus_slv_dqm_mask },
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="parser_ip2", .val=cli_rnr_quad_parser_ip2, .parms=set_default },
            { .name="parser_ip3", .val=cli_rnr_quad_parser_ip3, .parms=set_default },
            { .name="parser_hardcoded_ethtype0", .val=cli_rnr_quad_parser_hardcoded_ethtype0, .parms=set_default },
            { .name="parser_hardcoded_ethtype1", .val=cli_rnr_quad_parser_hardcoded_ethtype1, .parms=set_default },
            { .name="parser_hardcoded_ethtype2", .val=cli_rnr_quad_parser_hardcoded_ethtype2, .parms=set_default },
            ...
            { .name="parser_da_filter9", .val=cli_rnr_quad_parser_da_filter9, .parms=set_default },
            { .name="parser_da_filter10", .val=cli_rnr_quad_parser_da_filter10, .parms=set_default },
            { .name="da_filter_profile_0", .val=cli_rnr_quad_da_filter_profile_0, .parms=set_default },
            { .name="da_filter_profile_1", .val=cli_rnr_quad_da_filter_profile_1, .parms=set_default },
            { .name="da_filter_profile_2", .val=cli_rnr_quad_da_filter_profile_2, .parms=set_default },
            ...
            { .name="ubus_slv_res_cntrl", .val=cli_rnr_quad_ubus_slv_res_cntrl, .parms=set_default },
            { .name="ubus_slv_vpb_base", .val=cli_rnr_quad_ubus_slv_vpb_base, .parms=set_default },
            { .name="ubus_slv_vpb_mask", .val=cli_rnr_quad_ubus_slv_vpb_mask, .parms=set_default },
            { .name="ubus_slv_apb_base", .val=cli_rnr_quad_ubus_slv_apb_base, .parms=set_default },
            { .name="ubus_slv_apb_mask", .val=cli_rnr_quad_ubus_slv_apb_mask, .parms=set_default },
            { .name="ubus_slv_dqm_base", .val=cli_rnr_quad_ubus_slv_dqm_base, .parms=set_default },
            { .name="ubus_slv_dqm_mask", .val=cli_rnr_quad_ubus_slv_dqm_mask, .parms=set_default },
            ...
            { .name="general_config_profiling_counter", .val=cli_rnr_quad_general_config_profiling_counter, .parms=set_default },
    ...
    }
    {
        static bdmfmon_enum_val_t enum_table_address[] = {
            { .name="UBUS_SLV_RES_CNTRL" , .val=bdmf_address_ubus_slv_res_cntrl },
            { .name="UBUS_SLV_VPB_BASE" , .val=bdmf_address_ubus_slv_vpb_base },
            { .name="UBUS_SLV_VPB_MASK" , .val=bdmf_address_ubus_slv_vpb_mask },
            { .name="UBUS_SLV_APB_BASE" , .val=bdmf_address_ubus_slv_apb_base },
            { .name="UBUS_SLV_APB_MASK" , .val=bdmf_address_ubus_slv_apb_mask },
            { .name="UBUS_SLV_DQM_BASE" , .val=bdmf_address_ubus_slv_dqm_base },
            { .name="UBUS_SLV_DQM_MASK" , .val=bdmf_address_ubus_slv_dqm_mask },
            ...
            { .name="PARSER_CORE_CONFIGURATION_IP_FILTER2_CFG" , .val=bdmf_address_parser_core_configuration_ip_filter2_cfg },
            { .name="PARSER_CORE_CONFIGURATION_IP_FILTER3_CFG" , .val=bdmf_address_parser_core_configuration_ip_filter3_cfg },
            ...
            { .name="PARSER_CORE_CONFIGURATION_IP_FILTER2_MASK_CFG" , .val=bdmf_address_parser_core_configuration_ip_filter2_mask_cfg },
            { .name="PARSER_CORE_CONFIGURATION_IP_FILTER3_MASK_CFG" , .val=bdmf_address_parser_core_configuration_ip_filter3_mask_cfg },
            ...
            { .name="PARSER_CORE_CONFIGURATION_DA_FILT9_VAL_L" , .val=bdmf_address_parser_core_configuration_da_filt9_val_l },
            { .name="PARSER_CORE_CONFIGURATION_DA_FILT9_VAL_H" , .val=bdmf_address_parser_core_configuration_da_filt9_val_h },
            { .name="PARSER_CORE_CONFIGURATION_DA_FILT10_VAL_L" , .val=bdmf_address_parser_core_configuration_da_filt10_val_l },
            { .name="PARSER_CORE_CONFIGURATION_DA_FILT10_VAL_H" , .val=bdmf_address_parser_core_configuration_da_filt10_val_h },
            ...
            { .name="GENERAL_CONFIG_PROFILING_COUNTER" , .val=bdmf_address_general_config_profiling_counter },
