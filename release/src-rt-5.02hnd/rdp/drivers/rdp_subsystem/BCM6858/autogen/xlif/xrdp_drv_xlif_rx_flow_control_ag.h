...
#ifndef _XRDP_DRV_XLIF_RX_FLOW_CONTROL_AG_H_
#define _XRDP_DRV_XLIF_RX_FLOW_CONTROL_AG_H_
...
enum
{
    cli_xlif_rx_flow_control_cosmap_en,
    cli_xlif_rx_flow_control_cosmap,
};
