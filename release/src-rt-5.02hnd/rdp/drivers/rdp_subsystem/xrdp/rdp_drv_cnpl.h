...
#define CNPL_PERIODIC_UPDATE_QUANTA_NS          16382
#define CNPL_PERIODIC_UPDATE_HALF_QUANTA_NS     8192
...
bdmf_error_t drv_cnpl_counter_read_command_get(uint32_t *counters, uint8_t num_of_counters, bdmf_boolean cn_double, uint8_t cn0_byts);
