...
bdmf_error_t drv_sbpm_thr_ug0_set(const sbpm_thr_ug *thr_ug)
{
    ...
    if ((thr_ug->bn_hyst >= _10BITS_MAX_VAL_) ||
       (thr_ug->bn_thr >= _10BITS_MAX_VAL_) ||
       (thr_ug->excl_high_hyst >= _10BITS_MAX_VAL_) ||
       (thr_ug->excl_high_thr >= _10BITS_MAX_VAL_) ||
       (thr_ug->excl_low_hyst >= _10BITS_MAX_VAL_) ||
       (thr_ug->excl_low_thr >= _10BITS_MAX_VAL_))
    {
...
static bdmf_error_t drv_sbpm_thr_ug1_get(sbpm_thr_ug *thr_ug)
{
    uint32_t reg_regs_sbpm_ug0_trsh;
    uint32_t reg_regs_sbpm_ug0_excl_high_trsh;
    uint32_t reg_regs_sbpm_ug0_excl_low_trsh;
