...
#define B15_CTRL_BASE               (REG_BASE + 0x00020000)
#define B15_BASE                    (REG_BASE + 0x00030000)
...
#define APM_BASE                    (REG_BASE + 0x00100000)  /* APM control registers - APM logic core not present in 63148 */
