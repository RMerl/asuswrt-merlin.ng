...
#define NAND_INTR_BASE              (REG_BASE + 0x00000100)  /* nand interrupt control */
#define BROM_SEC_BASE               (REG_BASE + 0x00000140)  /* bootrom secure registers */
...
#define UART1_BASE                  (REG_BASE + 0x000002a0)  /* uart registers */
...
#define MEMC_BASE                   (REG_BASE + 0x0000a000)
#define SDRAM_CTRL_BASE             (REG_BASE + 0x0000b000)
...
#ifdef __KERNEL__
#define USB_XHCI_BASE               0x10035000  /* USB host registers */
#endif
...
#define DSLLMEM_BASE                (REG_BASE + 0x00500000)  /* VDSL PHY Memory */
