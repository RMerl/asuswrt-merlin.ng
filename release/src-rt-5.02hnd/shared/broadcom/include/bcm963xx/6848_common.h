...
#define INT1_BASE                   (REG_BASE + 0x00800200)  /* set1 interrupt */
#define INT2_BASE                   (REG_BASE + 0x00800300)  /* set2 interrupt */
...
#define NAND_CACHE_BASE             (REG_BASE + 0x00801C00)  /* NAND cache */
#define NAND_INTR_BASE              (REG_BASE + 0x00802000)  /* nand interrupt control */

#define MDIO_BASE   		        (REG_BASE + 0x008020c0)  /* MDIO Registers PER */
