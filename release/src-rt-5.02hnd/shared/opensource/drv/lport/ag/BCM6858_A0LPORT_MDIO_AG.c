...
/******************************************************************************
 * Field: LPORT_MDIO_CFG_RESERVED1
 ******************************************************************************/
const ru_field_rec LPORT_MDIO_CFG_RESERVED1_FIELD =
{
    "RESERVED1",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    LPORT_MDIO_CFG_RESERVED1_FIELD_MASK,
    0,
    LPORT_MDIO_CFG_RESERVED1_FIELD_WIDTH,
    LPORT_MDIO_CFG_RESERVED1_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
#if RU_INCLUDE_DESC
    "",
    "MDIO clock divider[5:0], Reference clock (typically 250 MHz) is divided by 2x(MDIO_CLK_DIVIDER+1) to generate MDIO clock(MDC).",
#endif
...
static const ru_field_rec *LPORT_MDIO_CFG_FIELDS[] =
{
    ...
    &LPORT_MDIO_CFG_RESERVED1_FIELD,
