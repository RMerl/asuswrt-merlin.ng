...
int ag_drv_lport_mdio_cfg_set(uint8_t supress_preamble, uint8_t mdio_clk_divider, uint8_t mdio_clause)
{
    uint32_t reg_cfg=0;
...
int ag_drv_lport_mdio_cfg_get(uint8_t *supress_preamble, uint8_t *mdio_clk_divider, uint8_t *mdio_clause)
{
    uint32_t reg_cfg=0;
