...
#define EMMC_HOSTIF_PHYS_BASE   (PERF1_PHYS_BASE+EMMC_HOSTIF_OFFSET)
#define EMMC_TOP_CFG_PHYS_BASE  (PERF1_PHYS_BASE+EMMC_TOP_CFG_OFFSET)
#define EMMC_BOOT_PHYS_BASE     (PERF1_PHYS_BASE+EMMC_BOOT_OFFSET)
#define AHBSS_CTRL_PHYS_BASE    (PERF1_PHYS_BASE+AHBSS_CTRL_OFFSET)

/* PL081 block base address and size */
#define PL081_DMA_PHYS_BASE   0xff859000
#define PL081_DMA_SIZE        0x1000
/* PL081 block offset */
#define PL081_DMA_OFFSET      0x0000

/* TopControl block base address and size */
#define TOP_CONTROL_PHYS_BASE   0xff85a000
#define TOP_CONTROL_SIZE        0x1000
...
#define PDC_PHYS_BASE           0x8001c000
#define PDC_OFFSET              0
#define PDC_SIZE                0x448
#define SPU_PHYS_BASE           0x8001d000
#define SPU_OFFSET              0
#define SPU_SIZE                0x1010
...
#define TOP_CONTROL_BASE   BCM_IO_MAP(TOPCTRL_IDX, TOP_CONTROL_PHYS_BASE, TOP_CONTROL_OFFSET)
...
#define PDC_BASE           BCM_IO_MAP(PDC_IDX, PDC_PHYS_BASE, PDC_OFFSET)
#define SPU_BASE           BCM_IO_MAP(SPU_IDX, SPU_PHYS_BASE, SPU_OFFSET)
...
BCM_IO_BLOCKS bcm_io_blocks[] = 
{
    ...
    {TOPCTRL_IDX, TOP_CONTROL_SIZE, TOP_CONTROL_PHYS_BASE},
