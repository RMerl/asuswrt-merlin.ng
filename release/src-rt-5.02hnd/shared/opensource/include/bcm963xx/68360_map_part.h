...
#ifndef __BCM68360_MAP_PART_H
#define __BCM68360_MAP_PART_H
...
#define CHIP_FAMILY_ID_HEX	        0x68360
...
#define PCIE0_MEM_PHYS_BASE         0xb0000000
...
#define CHN_CFG_DRAM_SZ_CHK_SHIFT				4
#define CHN_CFG_DRAM_SZ_CHK_MASK				(0xf<<CHN_CFG_DRAM_SZ_CHK_SHIFT)
...
{
  uint32 config;
#define BCM68360_IUDMA_CONFIG_ENDMA       0x0001
#define BCM68360_IUDMA_CONFIG_PKTHALT     0x0002
#define BCM68360_IUDMA_CONFIG_BURSTHALT   0x0004

  uint32 intStat;
#define BCM68360_IUDMA_INTSTAT_BDONE   0x0001
#define BCM68360_IUDMA_INTSTAT_PDONE   0x0002
#define BCM68360_IUDMA_INTSTAT_NOTVLD  0x0004
#define BCM68360_IUDMA_INTSTAT_MASK    0x0007
#define BCM68360_IUDMA_INTSTAT_ALL     BCM68360_IUDMA_INTSTAT_MASK

  uint32 intMask;
#define BCM68360_IUDMA_INTMASK_BDONE   0x0001
#define BCM68360_IUDMA_INTMASK_PDONE   0x0002
#define BCM68360_IUDMA_INTMASK_NOTVLD  0x0004

  uint32 maxBurst;
#define BCM68360_IUDMA_MAXBURST_SIZE 16 /* 32-bit words */
...
#define BCM68360_IUDMA_STRAM_DESC_RING_OFFSET 0x3fff
...
#define BCM68360_MAX_APM_PCM_DMA_CHANNELS 6

typedef struct ApmPcmIudma
{
   ApmPcmIudmaRegisters regs;                                        //
   uint32 reserved1[110];                                             //
   ApmPcmIudmaChannelCtrl ctrl[BCM68360_MAX_APM_PCM_DMA_CHANNELS];    //
   uint32 reserved2[104];                                             //
   ApmPcmIudmaStateRam stram[BCM68360_MAX_APM_PCM_DMA_CHANNELS];      //
