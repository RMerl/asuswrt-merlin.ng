...
#define udelay(X)                        \
    ...
    defined(_BCM963138_) || defined(CONFIG_BCM963138) || \
    defined(_BCM96838_) || defined(CONFIG_BCM96838) || \
    ...
    defined(_BCM968360_) || defined(CONFIG_BCM968360)
...
static void hsSpiSetGlobalState(unsigned int ctrlState)
{
   ...
   else
   {
    ...
    || defined(_BCM963381_) || defined(CONFIG_BCM963381) \
    || defined(_BCM963148_) || defined(CONFIG_BCM963148) \
    || defined(_BCM96848_) || defined(CONFIG_BCM96848) \
    || defined(_BCM94908_) || defined(CONFIG_BCM94908) \
    || defined(_BCM96858_) || defined(CONFIG_BCM96858) \
    || defined(_BCM963158_) || defined(CONFIG_BCM963158) \
    || defined(_BCM968360_) || defined(CONFIG_BCM968360)
