...
#if defined(SUPPORT_DM_LEGACY98)
#define dalPortTriggering_deleteEntry(dWIf,tPro,tPS,tPE)  dalPortTriggering_deleteEntry_igd((dWIf),(tPro),(tPS),(tPE))
#elif defined(SUPPORT_DM_HYBRID)
#define dalPortTriggering_deleteEntry(dWIf,tPro,tPS,tPE)  dalPortTriggering_deleteEntry_igd((dWIf),(tPro),(tPS),(tPE))
#elif defined(SUPPORT_DM_PURE181)
#define dalPortTriggering_deleteEntry(dWIf,tPro,tPS,tPE)  dalPortTriggering_deleteEntry_dev2((dWIf),(tPro),(tPS),(tPE))
#elif defined(SUPPORT_DM_DETECT)
#define dalPortTriggering_deleteEntry(dWIf,tPro,tPS,tPE)  (cmsMdm_isDataModelDevice2() ? \
                               dalPortTriggering_deleteEntry_dev2((dWIf),(tPro),(tPS),(tPE)) : \
                               dalPortTriggering_deleteEntry_igd((dWIf),(tPro),(tPS),(tPE)))
#endif
...
CmsRet dalPMap_addBridge_igd(const char *bridgeName);
CmsRet dalBridge_addBridge_dev2(const char *bridgeName);

#if defined(SUPPORT_DM_LEGACY98)
#define dalPMap_addBridge(g)  dalPMap_addBridge_igd((g))
#elif defined(SUPPORT_DM_HYBRID)
#define dalPMap_addBridge(g)  dalPMap_addBridge_igd((g))
#elif defined(SUPPORT_DM_PURE181)
#define dalPMap_addBridge(g)  dalBridge_addBridge_dev2((g))
#elif defined(SUPPORT_DM_DETECT)
#define dalPMap_addBridge(g)  (cmsMdm_isDataModelDevice2() ? \
                               dalBridge_addBridge_dev2((g)) : \
                               dalPMap_addBridge_igd((g)))
#endif
...
CmsRet dalDsl_deleteAtmInterface_igd(const WEB_NTWK_VAR *webVar);
CmsRet dalDsl_deleteAtmInterface_dev2(const WEB_NTWK_VAR *webVar);
 ...
 */
 ...
 CmsRet dalDsl_deletePtmInterface_igd(const WEB_NTWK_VAR *webVar);
 CmsRet dalDsl_deletePtmInterface_dev2(const WEB_NTWK_VAR *webVar);
