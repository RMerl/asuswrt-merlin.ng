...
#ifndef _HOMEPLUGD_H_
#define _HOMEPLUGD_H_

#define HOMEPLUGD_MESSAGE_PORT 48912
#define HOMEPLUGD_MESSAGE_MAX_SIZE 128
#define HOMEPLUGD_MESSAGE_MAX_LEN  (HOMEPLUGD_MESSAGE_MAX_SIZE-sizeof(homeplug_msg_header))
#define HOMEPLUGD_DEFAULT_EXTENDED_PERIODIC_INTERVAL 20
#define HOMEPLUGD_REMOVE_ASSOCDEV_INSTANCES_TIMEOUT 60
