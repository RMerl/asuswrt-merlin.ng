 ...
 * $Change: 121810 $
 ***********************************************************************/
/** \file apcm_sta_restart.h
 *
 * \brief APCM_STA_RESTART primitive
 *
 **************************************************/
#ifndef APCM_STA_RESTART_
#define APCM_STA_RESTART_
...
typedef struct
{
    ...
    tE_OpResult            cnf;      //!< APCM_STA_RESTART.CNF
} tS_APCM_STA_RESTART_Result;
...
/**
 * \brief Execute APCM_STA_RESTART
 *
 *  The APCM_STA_RESTART.REQ message is used by the HLE to restart the STA.
 *  Upon restarting, the STA initiates the power-on network procedure.
 *
 * \param p_result   (out) Transaction result
*/
void Exec_APCM_STA_RESTART(tS_APCM_STA_RESTART_Result* p_result);

#endif /*APCM_STA_RESTART_*/
