...
#if defined(SUPPORT_DM_LEGACY98)
#define qdmIntf_getIntfKeyByGroupName(a, b)  qdmIntf_getIntfKeyByGroupName_igd((a), (b))
#elif defined(SUPPORT_DM_HYBRID)
#define qdmIntf_getIntfKeyByGroupName(a, b)  qdmIntf_getIntfKeyByGroupName_igd((a), (b))
#elif defined(SUPPORT_DM_PURE181)
#define qdmIntf_getIntfKeyByGroupName(a, b)  qdmIntf_getIntfKeyByGroupName_dev2((a), (b))
#elif defined(SUPPORT_DM_DETECT)
#define qdmIntf_getIntfKeyByGroupName(a, b)  (cmsMdm_isDataModelDevice2() ? \
                  qdmIntf_getIntfKeyByGroupName_dev2((a), (b)) : \
                  qdmIntf_getIntfKeyByGroupName_igd((a), (b)))
#endif
