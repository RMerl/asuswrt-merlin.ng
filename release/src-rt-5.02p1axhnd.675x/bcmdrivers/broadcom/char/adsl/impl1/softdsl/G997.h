...
extern void		G997UpdateTimer(void *gDslVars, uint timeMs);
extern void		G997Timer(void *gDslVars);
...
extern  Boolean G997SetTxBuffer(void *gDslVars, int len, void *bufPtr);
