...
/******************************************************************************
 * Field: LIF_PON_CONTROL_CFP2PMODEADAPTIVESHORTPRE
 ******************************************************************************/
const ru_field_rec LIF_PON_CONTROL_CFP2PMODEADAPTIVESHORTPRE_FIELD =
{
...
#endif
    LIF_PON_CONTROL_CFP2PMODEADAPTIVESHORTPRE_FIELD_MASK,
    0,
    LIF_PON_CONTROL_CFP2PMODEADAPTIVESHORTPRE_FIELD_WIDTH,
    LIF_PON_CONTROL_CFP2PMODEADAPTIVESHORTPRE_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
static const ru_field_rec *LIF_PON_CONTROL_FIELDS[] =
{
    ...
    &LIF_PON_CONTROL_CFP2PMODEADAPTIVESHORTPRE_FIELD,
