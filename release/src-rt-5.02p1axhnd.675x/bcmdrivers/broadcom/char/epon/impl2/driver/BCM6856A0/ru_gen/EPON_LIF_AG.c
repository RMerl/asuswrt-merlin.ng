...
/******************************************************************************
 * Field: LIF_SEC_CONTROL_RESERVED1
 ******************************************************************************/
const ru_field_rec LIF_SEC_CONTROL_RESERVED1_FIELD =
{
    "RESERVED1",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    LIF_SEC_CONTROL_RESERVED1_FIELD_MASK,
    0,
    LIF_SEC_CONTROL_RESERVED1_FIELD_WIDTH,
    LIF_SEC_CONTROL_RESERVED1_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: LIF_P2P_AE_SCI_EN_RESERVED0
 ******************************************************************************/
const ru_field_rec LIF_P2P_AE_SCI_EN_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    LIF_P2P_AE_SCI_EN_RESERVED0_FIELD_MASK,
    0,
    LIF_P2P_AE_SCI_EN_RESERVED0_FIELD_WIDTH,
    LIF_P2P_AE_SCI_EN_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
const ru_field_rec LIF_P2P_AE_SCI_EN_CFGP2PSCIEN_FIELD =
{
    ...
    "LIF_P2P_AE_SCI_LO_[0:15]/LIF_P2P_AE_SCI_HI[0:15] registers. Each bit"
...
/******************************************************************************
 * Field: LIF_SEC_UP_KEY_STAT_1_KEYUPSEL_HI
 ******************************************************************************/
const ru_field_rec LIF_SEC_UP_KEY_STAT_1_KEYUPSEL_HI_FIELD =
{
    "KEYUPSEL_HI",
#if RU_INCLUDE_DESC
    "",
    ...
    "lower bit is provided by LIF_SEC_UP_KEY_STAT.",
#endif
    LIF_SEC_UP_KEY_STAT_1_KEYUPSEL_HI_FIELD_MASK,
    0,
    LIF_SEC_UP_KEY_STAT_1_KEYUPSEL_HI_FIELD_WIDTH,
    LIF_SEC_UP_KEY_STAT_1_KEYUPSEL_HI_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
const ru_field_rec LIF_SEC_KEY_SEL_1_KEYSEL_HI_FIELD =
{
    ...
    "In 802.1ae P2P mode, the number of key supported per LLID is 4."
    "This register provides the upper bit of the 2-bits key number.  The"
    "lower bit is provided by LIF_SEC_KEY_SEL.",
#endif
...
static const ru_field_rec *LIF_SEC_CONTROL_FIELDS[] =
{
    ...
    &LIF_SEC_CONTROL_RESERVED1_FIELD,
...
{
    &LIF_P2P_AE_SCI_EN_RESERVED0_FIELD,
...
/******************************************************************************
 * Register: LIF_SEC_UP_KEY_STAT_1
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *LIF_SEC_UP_KEY_STAT_1_FIELDS[] =
{
    &LIF_SEC_UP_KEY_STAT_1_KEYUPSEL_HI_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec LIF_SEC_UP_KEY_STAT_1_REG = 
{
    "SEC_UP_KEY_STAT_1",
#if RU_INCLUDE_DESC
    "LIF_SEC_UP_KEY_STAT_1 Register",
    "Provides additon per-LLID status of upstream security key for 802.1ae"
    "P2P.",
#endif
    LIF_SEC_UP_KEY_STAT_1_REG_OFFSET,
    0,
    0,
    518,
#if RU_INCLUDE_ACCESS
