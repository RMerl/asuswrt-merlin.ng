...
bdmf_error_t ag_drv_lif_pon_inter_op_control_set(const lif_pon_inter_op_control *pon_inter_op_control)
{
    ...
    if((pon_inter_op_control->cfdisableloslaserblock >= _1BITS_MAX_VAL_) ||
...
bdmf_error_t ag_drv_lif_int_status_set(const lif_int_status *int_status)
{
    ...
    if((int_status->laseronmax >= _1BITS_MAX_VAL_) ||
...
bdmf_error_t ag_drv_lif_int_mask_set(const lif_int_mask *int_mask)
{
    ...
    if((int_mask->laseronmaxmask >= _1BITS_MAX_VAL_) ||
...
static int bcm_lif_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        lif_pon_inter_op_control pon_inter_op_control = { .cfdisableloslaserblock=parm[1].value.unumber, .cfgllidpromiscuousmode=parm[2].value.unumber, .cfgllidmodmsk=parm[3].value.unumber, .cfusefecipg=parm[4].value.unumber, .cfrxcrc8invchk=parm[5].value.unumber, .cfrxcrc8bitswap=parm[6].value.unumber, .cfrxcrc8msb2lsb=parm[7].value.unumber, .cfrxcrc8disable=parm[8].value.unumber, .cftxllidbit15set=parm[9].value.unumber, .cftxcrc8inv=parm[10].value.unumber, .cftxcrc8bad=parm[11].value.unumber, .cftxcrc8bitswap=parm[12].value.unumber, .cftxcrc8msb2lsb=parm[13].value.unumber, .cftxshortpre=parm[14].value.unumber, .cftxipgcnt=parm[15].value.unumber, .cftxaasynclen=parm[16].value.unumber, .cftxpipedelay=parm[17].value.unumber};
    ...
    {
        lif_int_status int_status = { .laseronmax=parm[1].value.unumber, .laseroff=parm[2].value.unumber, .secdnreplayprotctabort=parm[3].value.unumber, .secuppktnumoverflow=parm[4].value.unumber, .intlaseroffdurburst=parm[5].value.unumber, .intrxberthreshexc=parm[6].value.unumber, .intfecrxfecrecvstatus=parm[7].value.unumber, .intfecrxcorerrfifofullstatus=parm[8].value.unumber, .intfecrxcorerrfifounexpempty=parm[9].value.unumber, .intfecbufpopemptypush=parm[10].value.unumber, .intfecbufpopemptynopush=parm[11].value.unumber, .intfecbufpushfull=parm[12].value.unumber, .intuptimefullupdstat=parm[13].value.unumber, .intfroutofalignstat=parm[14].value.unumber, .intgrntstarttimelagstat=parm[15].value.unumber, .intabortrxfrmstat=parm[16].value.unumber, .intnorxclkstat=parm[17].value.unumber, .intrxmaxlenerrstat=parm[18].value.unumber, .intrxerraftalignstat=parm[19].value.unumber, .intrxsynchacqstat=parm[20].value.unumber, .intrxoutofsynchstat=parm[21].value.unumber};
        err = ag_drv_lif_int_status_set(&int_status);
        break;
    }
    case BDMF_int_mask:
    {
        lif_int_mask int_mask = { .laseronmaxmask=parm[1].value.unumber, .laseroffmask=parm[2].value.unumber, .secdnreplayprotctabortmsk=parm[3].value.unumber, .secuppktnumoverflowmsk=parm[4].value.unumber, .intlaseroffdurburstmask=parm[5].value.unumber, .intrxberthreshexcmask=parm[6].value.unumber, .intfecrxfecrecvmask=parm[7].value.unumber, .intfecrxcorerrfifofullmask=parm[8].value.unumber, .intfecrxcorerrfifounexpemptymask=parm[9].value.unumber, .intfecbufpopemptypushmask=parm[10].value.unumber, .intfecbufpopemptynopushmask=parm[11].value.unumber, .intfecbufpushfullmask=parm[12].value.unumber, .intuptimefullupdmask=parm[13].value.unumber, .intfroutofalignmask=parm[14].value.unumber, .intgrntstarttimelagmask=parm[15].value.unumber, .intabortrxfrmmask=parm[16].value.unumber, .intnorxclkmask=parm[17].value.unumber, .intrxmaxlenerrmask=parm[18].value.unumber, .intrxerraftalignmask=parm[19].value.unumber, .intrxsynchacqmask=parm[20].value.unumber, .intrxoutofsynchmask=parm[21].value.unumber};
...
static int bcm_lif_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_lif_pon_inter_op_control_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", pon_inter_op_control.cfdisableloslaserblock, pon_inter_op_control.cfgllidpromiscuousmode, pon_inter_op_control.cfgllidmodmsk, pon_inter_op_control.cfusefecipg, pon_inter_op_control.cfrxcrc8invchk, pon_inter_op_control.cfrxcrc8bitswap, pon_inter_op_control.cfrxcrc8msb2lsb, pon_inter_op_control.cfrxcrc8disable, pon_inter_op_control.cftxllidbit15set, pon_inter_op_control.cftxcrc8inv, pon_inter_op_control.cftxcrc8bad, pon_inter_op_control.cftxcrc8bitswap, pon_inter_op_control.cftxcrc8msb2lsb, pon_inter_op_control.cftxshortpre, pon_inter_op_control.cftxipgcnt, pon_inter_op_control.cftxaasynclen, pon_inter_op_control.cftxpipedelay);
        if(err || pon_inter_op_control.cfdisableloslaserblock!=gtmv(m, 1) || pon_inter_op_control.cfgllidpromiscuousmode!=gtmv(m, 1) || pon_inter_op_control.cfgllidmodmsk!=gtmv(m, 1) || pon_inter_op_control.cfusefecipg!=gtmv(m, 1) || pon_inter_op_control.cfrxcrc8invchk!=gtmv(m, 1) || pon_inter_op_control.cfrxcrc8bitswap!=gtmv(m, 1) || pon_inter_op_control.cfrxcrc8msb2lsb!=gtmv(m, 1) || pon_inter_op_control.cfrxcrc8disable!=gtmv(m, 1) || pon_inter_op_control.cftxllidbit15set!=gtmv(m, 1) || pon_inter_op_control.cftxcrc8inv!=gtmv(m, 1) || pon_inter_op_control.cftxcrc8bad!=gtmv(m, 1) || pon_inter_op_control.cftxcrc8bitswap!=gtmv(m, 1) || pon_inter_op_control.cftxcrc8msb2lsb!=gtmv(m, 1) || pon_inter_op_control.cftxshortpre!=gtmv(m, 1) || pon_inter_op_control.cftxipgcnt!=gtmv(m, 4) || pon_inter_op_control.cftxaasynclen!=gtmv(m, 4) || pon_inter_op_control.cftxpipedelay!=gtmv(m, 4))
            return err ? err : BDMF_ERR_IO;
    }
    {
