...
static int bcm_xif_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        xif_ctl ctl = {.rxencrypten=gtmv(m, 1), .cfgdisrxdasaencrpt=gtmv(m, 1), .rxencryptmode=gtmv(m, 2), .txencrypten=gtmv(m, 1), .cfgdistxdasaencrpt=gtmv(m, 1), .txencryptmode=gtmv(m, 2), .cfgllidmodemsk=gtmv(m, 1), .cfgxpnbadcrc32=gtmv(m, 1), .cfgdisdiscinfo=gtmv(m, 1), .cfgpmctx2rxlpbk=gtmv(m, 1), .cfgpmctxencrc8bad=gtmv(m, 1), .cfgenp2p=gtmv(m, 1), .cfgpmcrxencrc8chk=gtmv(m, 1), .cfgfecen=gtmv(m, 1), .cfgxpnencrcpassthru=gtmv(m, 1), .cfgxpndistimestampmod=gtmv(m, 1), .xifnotrdy=gtmv(m, 1), .xifdtportrstn=gtmv(m, 1), .xpntxrstn=gtmv(m, 1), .pmctxrstn=gtmv(m, 1), .sectxrstn=gtmv(m, 1), .cfgdistxoamencrpt=gtmv(m, 1), .cfgdistxmpcpencrpt=gtmv(m, 1), .pmcrxrstn=gtmv(m, 1), .secrxrstn=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_xif_ctl_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", ctl.rxencrypten, ctl.cfgdisrxdasaencrpt, ctl.rxencryptmode, ctl.txencrypten, ctl.cfgdistxdasaencrpt, ctl.txencryptmode, ctl.cfgllidmodemsk, ctl.cfgxpnbadcrc32, ctl.cfgdisdiscinfo, ctl.cfgpmctx2rxlpbk, ctl.cfgpmctxencrc8bad, ctl.cfgenp2p, ctl.cfgpmcrxencrc8chk, ctl.cfgfecen, ctl.cfgxpnencrcpassthru, ctl.cfgxpndistimestampmod, ctl.xifnotrdy, ctl.xifdtportrstn, ctl.xpntxrstn, ctl.pmctxrstn, ctl.sectxrstn, ctl.cfgdistxoamencrpt, ctl.cfgdistxmpcpencrpt, ctl.pmcrxrstn, ctl.secrxrstn);
        if(!err) ag_drv_xif_ctl_set(&ctl);
        if(!err) ag_drv_xif_ctl_get( &ctl);
        if(!err) bdmf_session_print(session, "ag_drv_xif_ctl_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", ctl.rxencrypten, ctl.cfgdisrxdasaencrpt, ctl.rxencryptmode, ctl.txencrypten, ctl.cfgdistxdasaencrpt, ctl.txencryptmode, ctl.cfgllidmodemsk, ctl.cfgxpnbadcrc32, ctl.cfgdisdiscinfo, ctl.cfgpmctx2rxlpbk, ctl.cfgpmctxencrc8bad, ctl.cfgenp2p, ctl.cfgpmcrxencrc8chk, ctl.cfgfecen, ctl.cfgxpnencrcpassthru, ctl.cfgxpndistimestampmod, ctl.xifnotrdy, ctl.xifdtportrstn, ctl.xpntxrstn, ctl.pmctxrstn, ctl.sectxrstn, ctl.cfgdistxoamencrpt, ctl.cfgdistxmpcpencrpt, ctl.pmcrxrstn, ctl.secrxrstn);
        if(err || ctl.rxencrypten!=gtmv(m, 1) || ctl.cfgdisrxdasaencrpt!=gtmv(m, 1) || ctl.rxencryptmode!=gtmv(m, 2) || ctl.txencrypten!=gtmv(m, 1) || ctl.cfgdistxdasaencrpt!=gtmv(m, 1) || ctl.txencryptmode!=gtmv(m, 2) || ctl.cfgllidmodemsk!=gtmv(m, 1) || ctl.cfgxpnbadcrc32!=gtmv(m, 1) || ctl.cfgdisdiscinfo!=gtmv(m, 1) || ctl.cfgpmctx2rxlpbk!=gtmv(m, 1) || ctl.cfgpmctxencrc8bad!=gtmv(m, 1) || ctl.cfgenp2p!=gtmv(m, 1) || ctl.cfgpmcrxencrc8chk!=gtmv(m, 1) || ctl.cfgfecen!=gtmv(m, 1) || ctl.cfgxpnencrcpassthru!=gtmv(m, 1) || ctl.cfgxpndistimestampmod!=gtmv(m, 1) || ctl.xifnotrdy!=gtmv(m, 1) || ctl.xifdtportrstn!=gtmv(m, 1) || ctl.xpntxrstn!=gtmv(m, 1) || ctl.pmctxrstn!=gtmv(m, 1) || ctl.sectxrstn!=gtmv(m, 1) || ctl.cfgdistxoamencrpt!=gtmv(m, 1) || ctl.cfgdistxmpcpencrpt!=gtmv(m, 1) || ctl.pmcrxrstn!=gtmv(m, 1) || ctl.secrxrstn!=gtmv(m, 1))
