...
/******************************************************************************
 * Field: LIF_LLID_CFGLLID
 ******************************************************************************/
const ru_field_rec LIF_LLID_CFGLLID_FIELD =
{
    "CFGLLID",
#if RU_INCLUDE_DESC
    "",
    ...
    "1: Enable LLID i",
#endif
    LIF_LLID_CFGLLID_FIELD_MASK,
    0,
    LIF_LLID_CFGLLID_FIELD_WIDTH,
    LIF_LLID_CFGLLID_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
