...
/******************************************************************************
 * Field: XIF_CTL_RESERVED3
 ******************************************************************************/
const ru_field_rec XIF_CTL_RESERVED3_FIELD =
{
    "RESERVED3",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    XIF_CTL_RESERVED3_FIELD_MASK,
    0,
    XIF_CTL_RESERVED3_FIELD_WIDTH,
    XIF_CTL_RESERVED3_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
