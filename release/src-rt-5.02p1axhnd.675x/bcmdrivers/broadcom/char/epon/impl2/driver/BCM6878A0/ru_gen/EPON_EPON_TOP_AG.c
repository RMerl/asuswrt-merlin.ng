...
/******************************************************************************
 * Field: EPON_TOP_INTERRUPT_RESERVED2
 ******************************************************************************/
const ru_field_rec EPON_TOP_INTERRUPT_RESERVED2_FIELD =
{
    "RESERVED2",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    EPON_TOP_INTERRUPT_RESERVED2_FIELD_MASK,
    0,
    EPON_TOP_INTERRUPT_RESERVED2_FIELD_WIDTH,
    EPON_TOP_INTERRUPT_RESERVED2_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: EPON_TOP_INTERRUPT_MASK_RESERVED2
 ******************************************************************************/
const ru_field_rec EPON_TOP_INTERRUPT_MASK_RESERVED2_FIELD =
{
    "RESERVED2",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    EPON_TOP_INTERRUPT_MASK_RESERVED2_FIELD_MASK,
    0,
    EPON_TOP_INTERRUPT_MASK_RESERVED2_FIELD_WIDTH,
    EPON_TOP_INTERRUPT_MASK_RESERVED2_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
const ru_field_rec EPON_TOP_TOD_CONFIG_CFG_TOD_READ_SEL_FIELD =
{
    ...
    "2:Reserved. 3: AE. This field should not be changed while"
    "cfg_tod_read is set.",
#endif
...
static const ru_field_rec *EPON_TOP_INTERRUPT_FIELDS[] =
{
    ...
    &EPON_TOP_INTERRUPT_RESERVED2_FIELD,
...
static const ru_field_rec *EPON_TOP_INTERRUPT_MASK_FIELDS[] =
{
    ...
    &EPON_TOP_INTERRUPT_MASK_RESERVED2_FIELD,
