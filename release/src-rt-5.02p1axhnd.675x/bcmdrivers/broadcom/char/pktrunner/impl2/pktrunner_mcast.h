#ifndef __PKT_RUNNER_MCAST_H_INCLUDED__
#define __PKT_RUNNER_MCAST_H_INCLUDED__
...
int __init runnerMcast_construct(void *, void *);
void __exit_refok runnerMcast_destruct(void);

#endif  /* defined(__PKT_RUNNER_MCAST_H_INCLUDED__) */
