...
#ifndef __PKT_RUNNER_WLAN_MCAST_H_INCLUDED__
#define __PKT_RUNNER_WLAN_MCAST_H_INCLUDED__


#include <rdpa_wlan_mcast.h>
#include <rdpa_ag_wlan_mcast.h>

int pktrunner_wlan_mcast_add(Blog_t *blog_p, bdmf_index *fwd_table_index);
...
#endif  /* defined(__PKT_RUNNER_WLAN_MCAST_H_INCLUDED__) */
