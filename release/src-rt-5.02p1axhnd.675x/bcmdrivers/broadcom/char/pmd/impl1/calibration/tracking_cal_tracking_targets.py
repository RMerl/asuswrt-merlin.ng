...
def main(log_file, board_serial_number="", configuration_data=''):
    ...
    log_file_header( log_file, "tracking_cal_tracking_targets_log" )
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    board_type = int( configuration_data.board )

    # starting calibration
    echo( "$$$ tracking cal tracking targets starts  $$$############### ", 1 )

    # start DUT bursts transmission
    start_burst(board_type,)

    # Run laser driver - tracking targets calibration
    send2shell( "laser msg --set ae 2 0005" )
    ...
    echo( "$$$ tracking cal tracking targets complete  $$$############### ", 1 )
