...
/** @file eagle_onu10g_field_access.h
 * Registers and field access
 */

#ifndef EAGLE_ONU10G_API_FIELD_ACCESS_H
#define EAGLE_ONU10G_API_FIELD_ACCESS_H
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _eagle_onu10g_pmd_rdt_field_byte(uint16_t addr, uint8_t shift_left, uint8_t shift_right, uint8_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _eagle_onu10g_pmd_rdt_field_signed_byte(uint16_t addr, uint8_t shift_left, uint8_t shift_right, int8_t *val_p);
