...
/** @file eagle_onu10g_internal.h
 * Internal API functions
 */

#ifndef EAGLE_ONU10G_API_INTERNAL_H
#define EAGLE_ONU10G_API_INTERNAL_H
 ...
 * as part of eagle_onu10g_display_core_state_line()
...
/*-----------------------------*/
/** Read current eagle_onu10g core status.
 * @param *istate Current eagle_onu10g core status read back and populated by the API
...
/*-----------------------------*/
/** Read current eagle_onu10g lane status.
 * @param *istate Current eagle_onu10g lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *pll_lock Current eagle_onu10g lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current eagle_onu10g lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *pmd_lock Current eagle_onu10g lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current eagle_onu10g lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param *sig_det Current eagle_onu10g lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current eagle_onu10g lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _eagle_onu10g_get_osr_mode(eagle_onu10g_osr_mode_st *mode);
 ...
 * Along with eagle_onu10g_core_clkgate(), all lanes should also be clock gated using eagle_onu10g_lane_clkgate() to complete a Core Clockgate
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in eagle_onu10g_functions.c.
 *
