...
static int bcm_ten_g_gearbox_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    bdmf_error_t err;
...
bdmfmon_handle_t ag_drv_ten_g_gearbox_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            { .name="gearbox", .val=BDMF_gearbox, .parms=set_gearbox },
            BDMFMON_ENUM_LAST
        };
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            { .name="gearbox", .val=BDMF_gearbox, .parms=set_default },
            BDMFMON_ENUM_LAST
        };
