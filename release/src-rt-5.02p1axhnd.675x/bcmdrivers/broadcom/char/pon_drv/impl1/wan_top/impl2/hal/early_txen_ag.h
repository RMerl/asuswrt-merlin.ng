...
typedef struct
{
    uint8_t cr_xgwan_top_wan_misc_early_txen_cfg_early_txen_bypass;
    uint8_t cr_xgwan_top_wan_misc_early_txen_cfg_input_txen_polarity;
    uint8_t cr_xgwan_top_wan_misc_early_txen_cfg_output_txen_polarity;
