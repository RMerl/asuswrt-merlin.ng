...
int ag_drv_misc_misc_3_set(const misc_misc_3 *misc_3)
{
    ...
    if((misc_3->cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi >= _3BITS_MAX_VAL_) ||
       (misc_3->cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode >= _1BITS_MAX_VAL_) ||
       (misc_3->cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode >= _1BITS_MAX_VAL_) ||
    ...
    reg_3 = RU_FIELD_SET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_HI, reg_3, misc_3->cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi);
    reg_3 = RU_FIELD_SET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_AE_2P5_FULL_RATE_MODE, reg_3, misc_3->cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode);
    reg_3 = RU_FIELD_SET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_PON_RX_WIDTH_MODE, reg_3, misc_3->cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode);
...
int ag_drv_misc_misc_3_get(misc_misc_3 *misc_3)
{
    ...
    misc_3->cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi = RU_FIELD_GET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_HI, reg_3);
    misc_3->cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode = RU_FIELD_GET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_AE_2P5_FULL_RATE_MODE, reg_3);
    misc_3->cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode = RU_FIELD_GET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_PON_RX_WIDTH_MODE, reg_3);
