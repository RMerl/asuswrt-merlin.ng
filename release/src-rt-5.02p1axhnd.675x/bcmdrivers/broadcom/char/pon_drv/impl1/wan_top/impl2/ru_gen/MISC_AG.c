...
/******************************************************************************
 * Field: MISC_0_CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF
 ******************************************************************************/
const ru_field_rec MISC_0_CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_FIELD =
{
...
#endif
    MISC_0_CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_FIELD_MASK,
    0,
    MISC_0_CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_FIELD_WIDTH,
    MISC_0_CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_HI
 ******************************************************************************/
const ru_field_rec MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_HI_FIELD =
{
    "CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_HI",
#if RU_INCLUDE_DESC
    "",
    "Additional higher order TXFIFO OFF LOAD bits for EPON's gearbox:"
    "cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi[5:3]"
    "cr_xgwan_top_wan_misc_epon_tx_fifo_off[2:0]",
#endif
    MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_HI_FIELD_MASK,
    0,
    MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_HI_FIELD_WIDTH,
    MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_HI_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_AE_2P5_FULL_RATE_MODE
 ******************************************************************************/
const ru_field_rec MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_AE_2P5_FULL_RATE_MODE_FIELD =
{
...
#endif
    MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_AE_2P5_FULL_RATE_MODE_FIELD_MASK,
    0,
    MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_AE_2P5_FULL_RATE_MODE_FIELD_WIDTH,
    MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_AE_2P5_FULL_RATE_MODE_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_PON_RX_WIDTH_MODE
 ******************************************************************************/
const ru_field_rec MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_PON_RX_WIDTH_MODE_FIELD =
{
...
#endif
    MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_PON_RX_WIDTH_MODE_FIELD_MASK,
    0,
    MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_PON_RX_WIDTH_MODE_FIELD_WIDTH,
    MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_PON_RX_WIDTH_MODE_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
#if RU_INCLUDE_DESC
    "",
    "The lower bit selects the speed, and the upper bit selects the"
    "technology. 0: EPON. 1: 10G EPON. 2: GPON. 3: NGPON.",
#endif
...
static const ru_field_rec *MISC_0_FIELDS[] =
{
    ...
    &MISC_0_CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_FIELD,
...
static const ru_field_rec *MISC_3_FIELDS[] =
{
    ...
    &MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF_HI_FIELD,
    &MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_AE_2P5_FULL_RATE_MODE_FIELD,
    &MISC_3_CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_PON_RX_WIDTH_MODE_FIELD,
