...
int ag_drv_misc_misc_0_set(const misc_misc_0 *misc_0)
{
    ...
    if((misc_0->cr_xgwan_top_wan_misc_wan_cfg_reserved_01 >= _1BITS_MAX_VAL_) ||
       (misc_0->cr_xgwan_top_wan_misc_epon_ae_2p5_full_rate_mode >= _1BITS_MAX_VAL_) ||
    ...
    reg_0 = RU_FIELD_SET(0, MISC, 0, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_RESERVED_01, reg_0, misc_0->cr_xgwan_top_wan_misc_wan_cfg_reserved_01);
    reg_0 = RU_FIELD_SET(0, MISC, 0, CR_XGWAN_TOP_WAN_MISC_EPON_AE_2P5_FULL_RATE_MODE, reg_0, misc_0->cr_xgwan_top_wan_misc_epon_ae_2p5_full_rate_mode);
...
int ag_drv_misc_misc_0_get(misc_misc_0 *misc_0)
{
    ...
    misc_0->cr_xgwan_top_wan_misc_wan_cfg_reserved_01 = RU_FIELD_GET(0, MISC, 0, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_RESERVED_01, reg_0);
    misc_0->cr_xgwan_top_wan_misc_epon_ae_2p5_full_rate_mode = RU_FIELD_GET(0, MISC, 0, CR_XGWAN_TOP_WAN_MISC_EPON_AE_2P5_FULL_RATE_MODE, reg_0);
...
int ag_drv_misc_misc_3_set(const misc_misc_3 *misc_3)
{
    ...
    if((misc_3->cr_xgwan_top_wan_misc_wan_cfg_epon_tx_fifo_off >= _6BITS_MAX_VAL_) ||
       (misc_3->cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel >= _4BITS_MAX_VAL_) ||
       ...
       (misc_3->cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select >= _1BITS_MAX_VAL_) ||
       (misc_3->cr_xgwan_top_wan_misc_wan_cfg_reserved_31 >= _1BITS_MAX_VAL_) ||
    ...
    reg_3 = RU_FIELD_SET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_EPON_TX_FIFO_OFF, reg_3, misc_3->cr_xgwan_top_wan_misc_wan_cfg_epon_tx_fifo_off);
    ...
    reg_3 = RU_FIELD_SET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_RESERVED_31, reg_3, misc_3->cr_xgwan_top_wan_misc_wan_cfg_reserved_31);
...
int ag_drv_misc_misc_3_get(misc_misc_3 *misc_3)
{
    ...
    misc_3->cr_xgwan_top_wan_misc_wan_cfg_epon_tx_fifo_off = RU_FIELD_GET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_EPON_TX_FIFO_OFF, reg_3);
    ...
    misc_3->cr_xgwan_top_wan_misc_wan_cfg_reserved_31 = RU_FIELD_GET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_RESERVED_31, reg_3);
