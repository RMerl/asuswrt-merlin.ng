...
int ag_drv_wan_serdes_pram_val_low_set(uint32_t cfg_pram_datain_0)
{
    ...
    reg_pram_val_low = RU_FIELD_SET(0, WAN_SERDES, PRAM_VAL_LOW, CFG_PRAM_DATAIN_0, reg_pram_val_low, cfg_pram_datain_0);
...
int ag_drv_wan_serdes_pram_val_low_get(uint32_t *cfg_pram_datain_0)
{
    ...
    *cfg_pram_datain_0 = RU_FIELD_GET(0, WAN_SERDES, PRAM_VAL_LOW, CFG_PRAM_DATAIN_0, reg_pram_val_low);
...
int ag_drv_wan_serdes_pram_val_high_set(uint32_t cfg_pram_datain_1)
{
    ...
    reg_pram_val_high = RU_FIELD_SET(0, WAN_SERDES, PRAM_VAL_HIGH, CFG_PRAM_DATAIN_1, reg_pram_val_high, cfg_pram_datain_1);
...
int ag_drv_wan_serdes_pram_val_high_get(uint32_t *cfg_pram_datain_1)
{
    ...
    *cfg_pram_datain_1 = RU_FIELD_GET(0, WAN_SERDES, PRAM_VAL_HIGH, CFG_PRAM_DATAIN_1, reg_pram_val_high);
