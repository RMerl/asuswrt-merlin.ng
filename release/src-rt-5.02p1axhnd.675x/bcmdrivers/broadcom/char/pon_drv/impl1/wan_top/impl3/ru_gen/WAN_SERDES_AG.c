...
/******************************************************************************
 * Field: WAN_SERDES_PRAM_VAL_LOW_CFG_PRAM_DATAIN_0
 ******************************************************************************/
const ru_field_rec WAN_SERDES_PRAM_VAL_LOW_CFG_PRAM_DATAIN_0_FIELD =
{
    "CFG_PRAM_DATAIN_0",
#if RU_INCLUDE_DESC
    "",
...
#endif
    WAN_SERDES_PRAM_VAL_LOW_CFG_PRAM_DATAIN_0_FIELD_MASK,
    0,
    WAN_SERDES_PRAM_VAL_LOW_CFG_PRAM_DATAIN_0_FIELD_WIDTH,
    WAN_SERDES_PRAM_VAL_LOW_CFG_PRAM_DATAIN_0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: WAN_SERDES_PRAM_VAL_HIGH_CFG_PRAM_DATAIN_1
 ******************************************************************************/
const ru_field_rec WAN_SERDES_PRAM_VAL_HIGH_CFG_PRAM_DATAIN_1_FIELD =
{
    "CFG_PRAM_DATAIN_1",
#if RU_INCLUDE_DESC
    "",
...
#endif
    WAN_SERDES_PRAM_VAL_HIGH_CFG_PRAM_DATAIN_1_FIELD_MASK,
    0,
    WAN_SERDES_PRAM_VAL_HIGH_CFG_PRAM_DATAIN_1_FIELD_WIDTH,
    WAN_SERDES_PRAM_VAL_HIGH_CFG_PRAM_DATAIN_1_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
{
    &WAN_SERDES_PRAM_VAL_LOW_CFG_PRAM_DATAIN_0_FIELD,
};
...
const ru_reg_rec WAN_SERDES_PRAM_VAL_LOW_REG = 
{
    "PRAM_VAL_LOW",
#if RU_INCLUDE_DESC
    "WAN_SERDES_PRAM_VAL_LOW Register",
    "Register used for PRAM control.",
#endif
...
{
    &WAN_SERDES_PRAM_VAL_HIGH_CFG_PRAM_DATAIN_1_FIELD,
};
...
const ru_reg_rec WAN_SERDES_PRAM_VAL_HIGH_REG = 
{
    "PRAM_VAL_HIGH",
#if RU_INCLUDE_DESC
    "WAN_SERDES_PRAM_VAL_HIGH Register",
    "Register used for PRAM control.",
#endif
...
unsigned long WAN_SERDES_ADDRS[] =
{
    ...
    0x80144038,
#else
    #error "WAN_SERDES base address not defined"
#endif
};
