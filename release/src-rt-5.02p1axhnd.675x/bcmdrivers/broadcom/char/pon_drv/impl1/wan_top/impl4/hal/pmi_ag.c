...
#include "pmi_ag.h"
int ag_drv_pmi_lp_0_set(uint8_t cr_xgwan_top_wan_pcs_pmi_lp_en, uint8_t cr_xgwan_top_wan_misc_pmi_lp_en, uint8_t cr_xgwan_top_wan_misc_pmi_lp_write)
{
    uint32_t reg_lp_0=0;
...
int ag_drv_pmi_lp_0_get(uint8_t *cr_xgwan_top_wan_pcs_pmi_lp_en, uint8_t *cr_xgwan_top_wan_misc_pmi_lp_en, uint8_t *cr_xgwan_top_wan_misc_pmi_lp_write)
{
    uint32_t reg_lp_0=0;
...
int ag_drv_pmi_lp_4_get(uint8_t *pcs_pmi_lp_err, uint8_t *pcs_pmi_lp_ack, uint16_t *pcs_pmi_lp_rddata)
{
    uint32_t reg_lp_4=0;
