...
bdmf_error_t ag_drv_misc_misc_0_set(const misc_misc_0 *misc_0)
{
    ...
    if((misc_0->onu2g_pmd_status_sel >= _1BITS_MAX_VAL_) ||
       ...
       (misc_0->epon_gbox_pon_rx_width_mode >= _1BITS_MAX_VAL_) ||
    ...
    reg_0 = RU_FIELD_SET(0, MISC, 0, EPON_GBOX_PON_RX_WIDTH_MODE, reg_0, misc_0->epon_gbox_pon_rx_width_mode);
...
bdmf_error_t ag_drv_misc_misc_0_get(misc_misc_0 *misc_0)
{
    ...
    misc_0->epon_gbox_pon_rx_width_mode = RU_FIELD_GET(0, MISC, 0, EPON_GBOX_PON_RX_WIDTH_MODE, reg_0);
...
bdmf_error_t ag_drv_misc_misc_3_set(const misc_misc_3 *misc_3)
{
    ...
    if((misc_3->mem_reb >= _1BITS_MAX_VAL_) ||
       ...
       (misc_3->wan_interface_select_hs >= _1BITS_MAX_VAL_) ||
       ...
       (misc_3->epon_power_zone_sel >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_3 = RU_FIELD_SET(0, MISC, 3, WAN_INTERFACE_SELECT_HS, reg_3, misc_3->wan_interface_select_hs);
    ...
    reg_3 = RU_FIELD_SET(0, MISC, 3, EPON_POWER_ZONE_SEL, reg_3, misc_3->epon_power_zone_sel);
...
bdmf_error_t ag_drv_misc_misc_3_get(misc_misc_3 *misc_3)
{
    ...
    misc_3->wan_interface_select_hs = RU_FIELD_GET(0, MISC, 3, WAN_INTERFACE_SELECT_HS, reg_3);
    ...
    misc_3->epon_power_zone_sel = RU_FIELD_GET(0, MISC, 3, EPON_POWER_ZONE_SEL, reg_3);
