...
/******************************************************************************
 * Field: MISC_0_EPON_GBOX_PON_RX_WIDTH_MODE
 ******************************************************************************/
const ru_field_rec MISC_0_EPON_GBOX_PON_RX_WIDTH_MODE_FIELD =
{
...
#endif
    MISC_0_EPON_GBOX_PON_RX_WIDTH_MODE_FIELD_MASK,
    0,
    MISC_0_EPON_GBOX_PON_RX_WIDTH_MODE_FIELD_WIDTH,
    MISC_0_EPON_GBOX_PON_RX_WIDTH_MODE_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
const ru_field_rec MISC_3_LASER_MODE_FIELD =
{
    ...
    "laser_mode",
    "Selects laser mode"
    "0 - Use 1G EPON laser_en"
    "1 - Use 10G EPON laser_en"
    "2 - Use GPON laser_en"
    "3 - User NGPON/XGPON laser_en",
#endif
...
/******************************************************************************
 * Field: MISC_3_WAN_INTERFACE_SELECT_HS
 ******************************************************************************/
const ru_field_rec MISC_3_WAN_INTERFACE_SELECT_HS_FIELD =
{
    "WAN_INTERFACE_SELECT_HS",
#if RU_INCLUDE_DESC
    "wan_interface_select_hs",
    "Select WAN mode.  Used together with bit [5], wan_interface_select."
    ""
    "[6] [5]"
    "0    0 : EPON"
    "0    1 : 10G EPON"
    ...
    "1    1 : NGPON/XGPON",
#endif
    MISC_3_WAN_INTERFACE_SELECT_HS_FIELD_MASK,
    0,
    MISC_3_WAN_INTERFACE_SELECT_HS_FIELD_WIDTH,
    MISC_3_WAN_INTERFACE_SELECT_HS_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: MISC_3_EPON_POWER_ZONE_SEL
 ******************************************************************************/
const ru_field_rec MISC_3_EPON_POWER_ZONE_SEL_FIELD =
{
    "EPON_POWER_ZONE_SEL",
#if RU_INCLUDE_DESC
    "EPON_POWER_ZONE_SEL",
    "EPON power zone select.",
#endif
    MISC_3_EPON_POWER_ZONE_SEL_FIELD_MASK,
    0,
    MISC_3_EPON_POWER_ZONE_SEL_FIELD_WIDTH,
    MISC_3_EPON_POWER_ZONE_SEL_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
static const ru_field_rec *MISC_0_FIELDS[] =
{
    ...
    &MISC_0_EPON_GBOX_PON_RX_WIDTH_MODE_FIELD,
...
static const ru_field_rec *MISC_3_FIELDS[] =
{
    ...
    &MISC_3_WAN_INTERFACE_SELECT_HS_FIELD,
    ...
    &MISC_3_EPON_POWER_ZONE_SEL_FIELD,
