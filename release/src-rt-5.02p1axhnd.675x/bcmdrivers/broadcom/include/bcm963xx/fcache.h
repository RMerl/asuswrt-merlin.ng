 ...
 *------------------------------------------------------------------------------
 */
#define FCACHE_MAX_FLOW_ENTRIES     (128*1024)  /* Max # of Flow entries  */
...
#define FCACHE_MAX_NPE_ENTRIES      (256*1024)  /* Max # of npe entries*/

#define FCACHE_MIN_FLOW_ENTRIES     (1024)      /* Min # of Flow entries  */
