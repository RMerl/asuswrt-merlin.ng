...
#if defined(BCM6858) || defined(BCM6856) || defined(BCM6846) || defined(BCM63158) || defined(BCM6878)
...
#if defined(BCM6858) || defined(BCM6856) || defined(BCM6846) || defined(BCM63158) || defined(BCM6878)
    uint32_t mem_pred_byte_num = drv_rnr_get_inst_word_size(core_idx) / 8;
...
int rdp_drv_bkpt_cfg(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        bdmf_session_print(session, "\n########################\ncore %d bkpt configurations:\n", rnr_idx + (quad_idx * 4));

        rc = ag_drv_rnr_regs_cfg_bkpt_cfg_get( rnr_idx + (quad_idx * 4), &cfg_bkpt_cfg);
        if (rc)
            return rc;
        bdmf_trace("bkpt_0_en = %d\n", cfg_bkpt_cfg.bkpt_0_en);
        bdmf_trace("bkpt_0_use_thread = %d\n", cfg_bkpt_cfg.bkpt_0_use_thread);
        bdmf_trace("bkpt_1_en = %d\n", cfg_bkpt_cfg.bkpt_1_en);
        bdmf_trace("bkpt_1_use_thread = %d\n", cfg_bkpt_cfg.bkpt_1_use_thread);
        bdmf_trace("bkpt_2_en = %d\n", cfg_bkpt_cfg.bkpt_2_en);
        bdmf_trace("bkpt_2_use_thread = %d\n", cfg_bkpt_cfg.bkpt_2_use_thread);
        bdmf_trace("bkpt_3_en = %d\n", cfg_bkpt_cfg.bkpt_3_en);
        bdmf_trace("bkpt_3_use_thread = %d\n", cfg_bkpt_cfg.bkpt_3_use_thread);
        bdmf_trace("bkpt_4_en = %d\n", cfg_bkpt_cfg.bkpt_4_en);
        bdmf_trace("bkpt_4_use_thread = %d\n", cfg_bkpt_cfg.bkpt_4_use_thread);
        bdmf_trace("bkpt_5_en = %d\n", cfg_bkpt_cfg.bkpt_5_en);
        bdmf_trace("bkpt_5_use_thread = %d\n", cfg_bkpt_cfg.bkpt_5_use_thread);
        bdmf_trace("bkpt_6_en = %d\n", cfg_bkpt_cfg.bkpt_6_en);
        bdmf_trace("bkpt_6_use_thread = %d\n", cfg_bkpt_cfg.bkpt_6_use_thread);
        bdmf_trace("bkpt_7_en = %d\n", cfg_bkpt_cfg.bkpt_7_en);
        bdmf_trace("bkpt_7_use_thread = %d\n", cfg_bkpt_cfg.bkpt_7_use_thread);

        bdmf_trace("\nstep_mode = %d\n", cfg_bkpt_cfg.step_mode);
        bdmf_trace("new_flags_val = %d\n", cfg_bkpt_cfg.new_flags_val);
    }
