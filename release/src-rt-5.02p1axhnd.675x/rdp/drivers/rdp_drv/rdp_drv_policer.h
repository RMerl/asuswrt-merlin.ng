...
#define NUM_OF_PROFILES 8
typedef struct {
    uint8_t ref_count[NUM_OF_PROFILES];  /* profile ref count */
    uint16_t bkt_size[NUM_OF_PROFILES];  /* profile rvalue (same as register) */
} policer_priv_bkt_size_profile;
#endif
...
typedef struct {
    struct
    {
        ...
        unsigned int bkt0_size_shiftr: 2;
        unsigned int bkt0_size_mult: 4;
        unsigned int bkt0_rate: 24;
    } bucket_0;

    struct
    {
        unsigned int rsv: 1;
        unsigned int bkt1_rate_sel: 1;
        unsigned int bkt1_size_shiftr: 2;
        unsigned int bkt1_size_mult: 4;
        unsigned int bkt1_rate: 24;
    } bucket_1;
