...
/******************************************************************************
 * Field: NATC_CONTROL_STATUS2_UNUSED5
 ******************************************************************************/
const ru_field_rec NATC_CONTROL_STATUS2_UNUSED5_FIELD =
{
    "UNUSED5",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    NATC_CONTROL_STATUS2_UNUSED5_FIELD_MASK,
    0,
    NATC_CONTROL_STATUS2_UNUSED5_FIELD_WIDTH,
    NATC_CONTROL_STATUS2_UNUSED5_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
static const ru_field_rec *NATC_CONTROL_STATUS2_FIELDS[] =
{
    ...
    &NATC_CONTROL_STATUS2_UNUSED5_FIELD,
