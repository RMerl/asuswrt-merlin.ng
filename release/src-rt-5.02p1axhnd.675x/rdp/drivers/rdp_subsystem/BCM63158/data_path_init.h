...
#define DISP_REOR_XRDP_VIQ_EN(viq_num)      ((((1 << viq_num) - 1) & ~(1 << DISP_REOR_VIQ_BBH_PON_RX_NORMAL)) & ~(1 << DISP_REOR_VIQ_BBH_PON_RX_EXCL))
#define DISP_REOR_WAN_BBH_VIQ_EN(viq_en)    ((viq_en | (1 << DISP_REOR_VIQ_BBH_PON_RX_NORMAL)) | (1 << DISP_REOR_VIQ_BBH_PON_RX_EXCL))
