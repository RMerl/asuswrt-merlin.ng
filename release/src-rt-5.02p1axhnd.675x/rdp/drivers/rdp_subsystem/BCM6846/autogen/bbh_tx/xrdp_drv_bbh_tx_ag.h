...
bdmf_error_t ag_drv_bbh_tx_common_configurations_q2rnr_set(uint8_t bbh_id_tx, uint8_t q_2_rnr_index, bdmf_boolean q0, bdmf_boolean q1);
bdmf_error_t ag_drv_bbh_tx_common_configurations_q2rnr_get(uint8_t bbh_id_tx, uint8_t q_2_rnr_index, bdmf_boolean *q0, bdmf_boolean *q1);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdbase_set(uint8_t bbh_id_tx, uint8_t wan_pd_base_index, uint16_t fifobase0, uint16_t fifobase1);
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdbase_get(uint8_t bbh_id_tx, uint8_t wan_pd_base_index, uint16_t *fifobase0, uint16_t *fifobase1);
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdsize_set(uint8_t bbh_id_tx, uint8_t wan_pd_size_index, uint16_t fifosize0, uint16_t fifosize1);
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdsize_get(uint8_t bbh_id_tx, uint8_t wan_pd_size_index, uint16_t *fifosize0, uint16_t *fifosize1);
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdwkuph_set(uint8_t bbh_id_tx, uint8_t wan_pd_wkup_index, uint8_t wkupthresh0, uint8_t wkupthresh1);
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdwkuph_get(uint8_t bbh_id_tx, uint8_t wan_pd_wkup_index, uint8_t *wkupthresh0, uint8_t *wkupthresh1);
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pd_byte_th_set(uint8_t bbh_id_tx, uint8_t wan_pd_byte_th_index, uint16_t pdlimit0, uint16_t pdlimit1);
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pd_byte_th_get(uint8_t bbh_id_tx, uint8_t wan_pd_byte_th_index, uint16_t *pdlimit0, uint16_t *pdlimit1);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_epncfg_set(uint8_t bbh_id_tx, bdmf_boolean stplenerr, bdmf_boolean cmp_width, bdmf_boolean considerfull, bdmf_boolean addcrc);
bdmf_error_t ag_drv_bbh_tx_wan_configurations_epncfg_get(uint8_t bbh_id_tx, bdmf_boolean *stplenerr, bdmf_boolean *cmp_width, bdmf_boolean *considerfull, bdmf_boolean *addcrc);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pdbase_set(uint8_t bbh_id_tx, uint16_t fifobase0, uint16_t fifobase1);
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pdbase_get(uint8_t bbh_id_tx, uint16_t *fifobase0, uint16_t *fifobase1);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdbase_set(uint8_t bbh_id_tx, uint8_t unified_pd_base_index, uint16_t fifobase0, uint16_t fifobase1);
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdbase_get(uint8_t bbh_id_tx, uint8_t unified_pd_base_index, uint16_t *fifobase0, uint16_t *fifobase1);
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdsize_set(uint8_t bbh_id_tx, uint8_t unified_pd_size_index, uint16_t fifosize0, uint16_t fifosize1);
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdsize_get(uint8_t bbh_id_tx, uint8_t unified_pd_size_index, uint16_t *fifosize0, uint16_t *fifosize1);
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdwkuph_set(uint8_t bbh_id_tx, uint8_t unified_pd_wkup_index, uint8_t wkupthresh0, uint8_t wkupthresh1);
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdwkuph_get(uint8_t bbh_id_tx, uint8_t unified_pd_wkup_index, uint8_t *wkupthresh0, uint8_t *wkupthresh1);
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pd_byte_th_set(uint8_t bbh_id_tx, uint8_t unified_pd_byte_th_index, uint16_t pdlimit0, uint16_t pdlimit1);
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pd_byte_th_get(uint8_t bbh_id_tx, uint8_t unified_pd_byte_th_index, uint16_t *pdlimit0, uint16_t *pdlimit1);
...
enum
{
    ...
    cli_bbh_tx_unified_configurations_pdbase,
