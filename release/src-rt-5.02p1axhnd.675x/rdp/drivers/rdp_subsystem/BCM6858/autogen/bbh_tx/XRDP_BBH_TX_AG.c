...
/******************************************************************************
 * Field: BBH_TX_DEBUG_COUNTERS_DBGOUTREG_RESERVED0
 ******************************************************************************/
const ru_field_rec BBH_TX_DEBUG_COUNTERS_DBGOUTREG_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    BBH_TX_DEBUG_COUNTERS_DBGOUTREG_RESERVED0_FIELD_MASK,
    0,
    BBH_TX_DEBUG_COUNTERS_DBGOUTREG_RESERVED0_FIELD_WIDTH,
    BBH_TX_DEBUG_COUNTERS_DBGOUTREG_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
static const ru_field_rec *BBH_TX_DEBUG_COUNTERS_DBGOUTREG_FIELDS[] =
{
    ...
    &BBH_TX_DEBUG_COUNTERS_DBGOUTREG_RESERVED0_FIELD,
};
