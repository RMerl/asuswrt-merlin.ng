...
/******************************************************************************
 * Field: RNR_REGS_CFG_IDLE_CNT1_RESERVED0
 ******************************************************************************/
const ru_field_rec RNR_REGS_CFG_IDLE_CNT1_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    RNR_REGS_CFG_IDLE_CNT1_RESERVED0_FIELD_MASK,
    0,
    RNR_REGS_CFG_IDLE_CNT1_RESERVED0_FIELD_WIDTH,
    RNR_REGS_CFG_IDLE_CNT1_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
static const ru_field_rec *RNR_REGS_CFG_IDLE_CNT1_FIELDS[] =
{
    ...
    &RNR_REGS_CFG_IDLE_CNT1_RESERVED0_FIELD,
};
