...
/******************************************************************************
 * Field: SBPM_REGS_SBPM_DBG_VEC0_RESERVED0
 ******************************************************************************/
const ru_field_rec SBPM_REGS_SBPM_DBG_VEC0_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    SBPM_REGS_SBPM_DBG_VEC0_RESERVED0_FIELD_MASK,
    0,
    SBPM_REGS_SBPM_DBG_VEC0_RESERVED0_FIELD_WIDTH,
    SBPM_REGS_SBPM_DBG_VEC0_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
static const ru_field_rec *SBPM_REGS_SBPM_DBG_VEC0_FIELDS[] =
{
    ...
    &SBPM_REGS_SBPM_DBG_VEC0_RESERVED0_FIELD,
};
