...
{
    uint32_t reg_common_configurations_ds_dma_sup=0;

#ifdef VALIDATE_PARMS
    if((bbh_id_tx >= BLOCK_ADDR_COUNT) ||
       (dsdma >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_common_configurations_ds_dma_sup = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DS_DMA_SUP, DSDMA, reg_common_configurations_ds_dma_sup, dsdma);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DS_DMA_SUP, reg_common_configurations_ds_dma_sup);
...
{
    uint32_t reg_common_configurations_ds_dma_sup;
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DS_DMA_SUP, reg_common_configurations_ds_dma_sup);

    *dsdma = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DS_DMA_SUP, DSDMA, reg_common_configurations_ds_dma_sup);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_q2rnr_set(uint8_t bbh_id_tx, uint8_t wan_q_2_rnr_index, bdmf_boolean q0, bdmf_boolean q1)
{
    ...
    reg_wan_configurations_q2rnr = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_Q2RNR, Q0, reg_wan_configurations_q2rnr, q0);
    reg_wan_configurations_q2rnr = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_Q2RNR, Q1, reg_wan_configurations_q2rnr, q1);

    RU_REG_RAM_WRITE(bbh_id_tx, wan_q_2_rnr_index, BBH_TX, WAN_CONFIGURATIONS_Q2RNR, reg_wan_configurations_q2rnr);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_q2rnr_get(uint8_t bbh_id_tx, uint8_t wan_q_2_rnr_index, bdmf_boolean *q0, bdmf_boolean *q1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, wan_q_2_rnr_index, BBH_TX, WAN_CONFIGURATIONS_Q2RNR, reg_wan_configurations_q2rnr);

    *q0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_Q2RNR, Q0, reg_wan_configurations_q2rnr);
    *q1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_Q2RNR, Q1, reg_wan_configurations_q2rnr);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_qprof_set(uint8_t bbh_id_tx, uint8_t wan_qarof_size_index, bdmf_boolean q0, bdmf_boolean q1)
{
    ...
    reg_wan_configurations_qprof = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_QPROF, Q0, reg_wan_configurations_qprof, q0);
    reg_wan_configurations_qprof = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_QPROF, Q1, reg_wan_configurations_qprof, q1);

    RU_REG_RAM_WRITE(bbh_id_tx, wan_qarof_size_index, BBH_TX, WAN_CONFIGURATIONS_QPROF, reg_wan_configurations_qprof);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_qprof_get(uint8_t bbh_id_tx, uint8_t wan_qarof_size_index, bdmf_boolean *q0, bdmf_boolean *q1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, wan_qarof_size_index, BBH_TX, WAN_CONFIGURATIONS_QPROF, reg_wan_configurations_qprof);

    *q0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_QPROF, Q0, reg_wan_configurations_qprof);
    *q1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_QPROF, Q1, reg_wan_configurations_qprof);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdsize_set(uint8_t bbh_id_tx, uint16_t fifosize0, uint16_t fifosize1)
{
    ...
    RU_REG_WRITE(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDSIZE, reg_wan_configurations_pdsize);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdsize_get(uint8_t bbh_id_tx, uint16_t *fifosize0, uint16_t *fifosize1)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDSIZE, reg_wan_configurations_pdsize);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdwkuph_set(uint8_t bbh_id_tx, uint8_t wkupthresh0, uint8_t wkupthresh1)
{
    ...
    RU_REG_WRITE(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDWKUPH, reg_wan_configurations_pdwkuph);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdwkuph_get(uint8_t bbh_id_tx, uint8_t *wkupthresh0, uint8_t *wkupthresh1)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDWKUPH, reg_wan_configurations_pdwkuph);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pd_byte_th_set(uint8_t bbh_id_tx, uint16_t pdlimit0, uint16_t pdlimit1)
{
    ...
    RU_REG_WRITE(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PD_BYTE_TH, reg_wan_configurations_pd_byte_th);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pd_byte_th_get(uint8_t bbh_id_tx, uint16_t *pdlimit0, uint16_t *pdlimit1)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PD_BYTE_TH, reg_wan_configurations_pd_byte_th);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_qmq_set(uint8_t bbh_id_tx, uint8_t wan_qmq_size_index, bdmf_boolean q0, bdmf_boolean q1)
{
    ...
    reg_wan_configurations_qmq = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_QMQ, Q0, reg_wan_configurations_qmq, q0);
    reg_wan_configurations_qmq = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_QMQ, Q1, reg_wan_configurations_qmq, q1);

    RU_REG_RAM_WRITE(bbh_id_tx, wan_qmq_size_index, BBH_TX, WAN_CONFIGURATIONS_QMQ, reg_wan_configurations_qmq);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_qmq_get(uint8_t bbh_id_tx, uint8_t wan_qmq_size_index, bdmf_boolean *q0, bdmf_boolean *q1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, wan_qmq_size_index, BBH_TX, WAN_CONFIGURATIONS_QMQ, reg_wan_configurations_qmq);

    *q0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_QMQ, Q0, reg_wan_configurations_qmq);
    *q1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_QMQ, Q1, reg_wan_configurations_qmq);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_epncfg_set(uint8_t bbh_id_tx, const bbh_tx_wan_configurations_epncfg *wan_configurations_epncfg)
{
    ...
    reg_wan_configurations_epncfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, STPLENERR, reg_wan_configurations_epncfg, wan_configurations_epncfg->stplenerr);
    reg_wan_configurations_epncfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, CMP_WIDTH, reg_wan_configurations_epncfg, wan_configurations_epncfg->cmp_width);
    reg_wan_configurations_epncfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, CONSIDERFULL, reg_wan_configurations_epncfg, wan_configurations_epncfg->considerfull);
    reg_wan_configurations_epncfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, ADDCRC, reg_wan_configurations_epncfg, wan_configurations_epncfg->addcrc);
    reg_wan_configurations_epncfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, REQ_FULL, reg_wan_configurations_epncfg, wan_configurations_epncfg->req_full);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_epncfg_get(uint8_t bbh_id_tx, bbh_tx_wan_configurations_epncfg *wan_configurations_epncfg)
{
    ...
    wan_configurations_epncfg->stplenerr = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, STPLENERR, reg_wan_configurations_epncfg);
    wan_configurations_epncfg->cmp_width = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, CMP_WIDTH, reg_wan_configurations_epncfg);
    wan_configurations_epncfg->considerfull = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, CONSIDERFULL, reg_wan_configurations_epncfg);
    wan_configurations_epncfg->addcrc = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, ADDCRC, reg_wan_configurations_epncfg);
    wan_configurations_epncfg->req_full = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, REQ_FULL, reg_wan_configurations_epncfg);
...
{
    uint32_t reg_lan_configurations_q2rnr=0;
    ...
    reg_lan_configurations_q2rnr = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_Q2RNR, Q0, reg_lan_configurations_q2rnr, q0);
    reg_lan_configurations_q2rnr = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_Q2RNR, Q1, reg_lan_configurations_q2rnr, q1);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_Q2RNR, reg_lan_configurations_q2rnr);
...
{
    uint32_t reg_lan_configurations_q2rnr;
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_Q2RNR, reg_lan_configurations_q2rnr);

    *q0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_Q2RNR, Q0, reg_lan_configurations_q2rnr);
    *q1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_Q2RNR, Q1, reg_lan_configurations_q2rnr);
...
{
    uint32_t reg_lan_configurations_qprof=0;
    ...
    reg_lan_configurations_qprof = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_QPROF, Q0, reg_lan_configurations_qprof, q0);
    reg_lan_configurations_qprof = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_QPROF, Q1, reg_lan_configurations_qprof, q1);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_QPROF, reg_lan_configurations_qprof);
...
{
    uint32_t reg_lan_configurations_qprof;
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_QPROF, reg_lan_configurations_qprof);

    *q0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_QPROF, Q0, reg_lan_configurations_qprof);
    *q1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_QPROF, Q1, reg_lan_configurations_qprof);
...
{
    uint32_t reg_lan_configurations_qmq=0;
    ...
    reg_lan_configurations_qmq = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_QMQ, Q0, reg_lan_configurations_qmq, q0);
    reg_lan_configurations_qmq = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_QMQ, Q1, reg_lan_configurations_qmq, q1);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_QMQ, reg_lan_configurations_qmq);
...
{
    uint32_t reg_lan_configurations_qmq;
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_QMQ, reg_lan_configurations_qmq);

    *q0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_QMQ, Q0, reg_lan_configurations_qmq);
    *q1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_QMQ, Q1, reg_lan_configurations_qmq);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_q2rnr_set(uint8_t bbh_id_tx, uint8_t unified_q2rnr_size_index, bdmf_boolean q0, bdmf_boolean q1)
{
    ...
    reg_unified_configurations_q2rnr = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_Q2RNR, Q0, reg_unified_configurations_q2rnr, q0);
    reg_unified_configurations_q2rnr = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_Q2RNR, Q1, reg_unified_configurations_q2rnr, q1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_q2rnr_size_index, BBH_TX, UNIFIED_CONFIGURATIONS_Q2RNR, reg_unified_configurations_q2rnr);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_q2rnr_get(uint8_t bbh_id_tx, uint8_t unified_q2rnr_size_index, bdmf_boolean *q0, bdmf_boolean *q1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_q2rnr_size_index, BBH_TX, UNIFIED_CONFIGURATIONS_Q2RNR, reg_unified_configurations_q2rnr);

    *q0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_Q2RNR, Q0, reg_unified_configurations_q2rnr);
    *q1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_Q2RNR, Q1, reg_unified_configurations_q2rnr);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_qprof_set(uint8_t bbh_id_tx, uint8_t unified_qprof_size_index, bdmf_boolean q0, bdmf_boolean q1)
{
    ...
    reg_unified_configurations_qprof = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_QPROF, Q0, reg_unified_configurations_qprof, q0);
    reg_unified_configurations_qprof = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_QPROF, Q1, reg_unified_configurations_qprof, q1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_qprof_size_index, BBH_TX, UNIFIED_CONFIGURATIONS_QPROF, reg_unified_configurations_qprof);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_qprof_get(uint8_t bbh_id_tx, uint8_t unified_qprof_size_index, bdmf_boolean *q0, bdmf_boolean *q1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_qprof_size_index, BBH_TX, UNIFIED_CONFIGURATIONS_QPROF, reg_unified_configurations_qprof);

    *q0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_QPROF, Q0, reg_unified_configurations_qprof);
    *q1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_QPROF, Q1, reg_unified_configurations_qprof);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdsize_set(uint8_t bbh_id_tx, uint16_t fifosize0, uint16_t fifosize1)
{
    ...
    RU_REG_WRITE(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDSIZE, reg_unified_configurations_pdsize);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdsize_get(uint8_t bbh_id_tx, uint16_t *fifosize0, uint16_t *fifosize1)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDSIZE, reg_unified_configurations_pdsize);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdwkuph_set(uint8_t bbh_id_tx, uint8_t wkupthresh0, uint8_t wkupthresh1)
{
    ...
    RU_REG_WRITE(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDWKUPH, reg_unified_configurations_pdwkuph);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdwkuph_get(uint8_t bbh_id_tx, uint8_t *wkupthresh0, uint8_t *wkupthresh1)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDWKUPH, reg_unified_configurations_pdwkuph);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pd_byte_th_set(uint8_t bbh_id_tx, uint16_t pdlimit0, uint16_t pdlimit1)
{
    ...
    RU_REG_WRITE(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PD_BYTE_TH, reg_unified_configurations_pd_byte_th);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pd_byte_th_get(uint8_t bbh_id_tx, uint16_t *pdlimit0, uint16_t *pdlimit1)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PD_BYTE_TH, reg_unified_configurations_pd_byte_th);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_qmq_set(uint8_t bbh_id_tx, uint8_t unified_qmq_size_index, bdmf_boolean q0, bdmf_boolean q1)
{
    ...
    reg_unified_configurations_qmq = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_QMQ, Q0, reg_unified_configurations_qmq, q0);
    reg_unified_configurations_qmq = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_QMQ, Q1, reg_unified_configurations_qmq, q1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_qmq_size_index, BBH_TX, UNIFIED_CONFIGURATIONS_QMQ, reg_unified_configurations_qmq);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_qmq_get(uint8_t bbh_id_tx, uint8_t unified_qmq_size_index, bdmf_boolean *q0, bdmf_boolean *q1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_qmq_size_index, BBH_TX, UNIFIED_CONFIGURATIONS_QMQ, reg_unified_configurations_qmq);

    *q0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_QMQ, Q0, reg_unified_configurations_qmq);
    *q1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_QMQ, Q1, reg_unified_configurations_qmq);
...
typedef enum
{
    ...
    bdmf_address_common_configurations_ds_dma_sup,
...
static int bcm_bbh_tx_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_bbh_tx_common_configurations_gpr:
        ...
        break;
    case cli_bbh_tx_common_configurations_ds_dma_sup:
        err = ag_drv_bbh_tx_common_configurations_ds_dma_sup_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_bbh_tx_wan_configurations_q2rnr:
        err = ag_drv_bbh_tx_wan_configurations_q2rnr_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    case cli_bbh_tx_wan_configurations_qprof:
        err = ag_drv_bbh_tx_wan_configurations_qprof_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    case cli_bbh_tx_wan_configurations_pdsize:
        err = ag_drv_bbh_tx_wan_configurations_pdsize_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_bbh_tx_wan_configurations_pdwkuph:
        err = ag_drv_bbh_tx_wan_configurations_pdwkuph_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_bbh_tx_wan_configurations_pd_byte_th:
        err = ag_drv_bbh_tx_wan_configurations_pd_byte_th_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_bbh_tx_wan_configurations_qmq:
        err = ag_drv_bbh_tx_wan_configurations_qmq_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    ...
    {
        bbh_tx_wan_configurations_epncfg wan_configurations_epncfg = { .stplenerr=parm[2].value.unumber, .cmp_width=parm[3].value.unumber, .considerfull=parm[4].value.unumber, .addcrc=parm[5].value.unumber, .req_full=parm[6].value.unumber};
        err = ag_drv_bbh_tx_wan_configurations_epncfg_set(parm[1].value.unumber, &wan_configurations_epncfg);
        break;
    }
    ...
    case cli_bbh_tx_wan_configurations_flush:
        ...
        break;
    case cli_bbh_tx_lan_configurations_q2rnr:
        err = ag_drv_bbh_tx_lan_configurations_q2rnr_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_bbh_tx_lan_configurations_qprof:
        err = ag_drv_bbh_tx_lan_configurations_qprof_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    ...
    case cli_bbh_tx_lan_configurations_pd_byte_th:
        ...
        break;
    case cli_bbh_tx_lan_configurations_qmq:
        err = ag_drv_bbh_tx_lan_configurations_qmq_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    ...
    case cli_bbh_tx_unified_configurations_q2rnr:
        err = ag_drv_bbh_tx_unified_configurations_q2rnr_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    case cli_bbh_tx_unified_configurations_qprof:
        err = ag_drv_bbh_tx_unified_configurations_qprof_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    case cli_bbh_tx_unified_configurations_pdsize:
        err = ag_drv_bbh_tx_unified_configurations_pdsize_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_bbh_tx_unified_configurations_pdwkuph:
        err = ag_drv_bbh_tx_unified_configurations_pdwkuph_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_bbh_tx_unified_configurations_pd_byte_th:
        err = ag_drv_bbh_tx_unified_configurations_pd_byte_th_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_bbh_tx_unified_configurations_qmq:
        err = ag_drv_bbh_tx_unified_configurations_qmq_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
...
int bcm_bbh_tx_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        bdmf_boolean dsdma;
        err = ag_drv_bbh_tx_common_configurations_ds_dma_sup_get(parm[1].value.unumber, &dsdma);
    ...
    case cli_bbh_tx_wan_configurations_q2rnr:
    {
        bdmf_boolean q0;
        bdmf_boolean q1;
        err = ag_drv_bbh_tx_wan_configurations_q2rnr_get(parm[1].value.unumber, parm[2].value.unumber, &q0, &q1);
    ...
    case cli_bbh_tx_wan_configurations_qprof:
    {
        bdmf_boolean q0;
        bdmf_boolean q1;
        err = ag_drv_bbh_tx_wan_configurations_qprof_get(parm[1].value.unumber, parm[2].value.unumber, &q0, &q1);
        bdmf_session_print(session, "q0 = %u (0x%x)\n", q0, q0);
        bdmf_session_print(session, "q1 = %u (0x%x)\n", q1, q1);
        break;
    }
    case cli_bbh_tx_wan_configurations_pdsize:
    {
        uint16_t fifosize0;
        uint16_t fifosize1;
        err = ag_drv_bbh_tx_wan_configurations_pdsize_get(parm[1].value.unumber, &fifosize0, &fifosize1);
    ...
    case cli_bbh_tx_wan_configurations_pdwkuph:
    {
        uint8_t wkupthresh0;
        uint8_t wkupthresh1;
        err = ag_drv_bbh_tx_wan_configurations_pdwkuph_get(parm[1].value.unumber, &wkupthresh0, &wkupthresh1);
    ...
    case cli_bbh_tx_wan_configurations_pd_byte_th:
    {
        uint16_t pdlimit0;
        uint16_t pdlimit1;
        err = ag_drv_bbh_tx_wan_configurations_pd_byte_th_get(parm[1].value.unumber, &pdlimit0, &pdlimit1);
    ...
    case cli_bbh_tx_wan_configurations_qmq:
    {
        bdmf_boolean q0;
        bdmf_boolean q1;
        err = ag_drv_bbh_tx_wan_configurations_qmq_get(parm[1].value.unumber, parm[2].value.unumber, &q0, &q1);
        bdmf_session_print(session, "q0 = %u (0x%x)\n", q0, q0);
        bdmf_session_print(session, "q1 = %u (0x%x)\n", q1, q1);
        break;
    }
    ...
    case cli_bbh_tx_wan_configurations_epncfg:
    {
        ...
        err = ag_drv_bbh_tx_wan_configurations_epncfg_get(parm[1].value.unumber, &wan_configurations_epncfg);
    ...
    case cli_bbh_tx_lan_configurations_q2rnr:
    {
        bdmf_boolean q0;
        bdmf_boolean q1;
        err = ag_drv_bbh_tx_lan_configurations_q2rnr_get(parm[1].value.unumber, &q0, &q1);
        bdmf_session_print(session, "q0 = %u (0x%x)\n", q0, q0);
        bdmf_session_print(session, "q1 = %u (0x%x)\n", q1, q1);
        break;
    }
    case cli_bbh_tx_lan_configurations_qprof:
    {
        bdmf_boolean q0;
        bdmf_boolean q1;
        err = ag_drv_bbh_tx_lan_configurations_qprof_get(parm[1].value.unumber, &q0, &q1);
        bdmf_session_print(session, "q0 = %u (0x%x)\n", q0, q0);
        bdmf_session_print(session, "q1 = %u (0x%x)\n", q1, q1);
        break;
    }
    ...
    case cli_bbh_tx_lan_configurations_qmq:
    {
        bdmf_boolean q0;
        bdmf_boolean q1;
        err = ag_drv_bbh_tx_lan_configurations_qmq_get(parm[1].value.unumber, &q0, &q1);
        bdmf_session_print(session, "q0 = %u (0x%x)\n", q0, q0);
        bdmf_session_print(session, "q1 = %u (0x%x)\n", q1, q1);
        break;
    }
    ...
    case cli_bbh_tx_unified_configurations_q2rnr:
    {
        bdmf_boolean q0;
        bdmf_boolean q1;
        err = ag_drv_bbh_tx_unified_configurations_q2rnr_get(parm[1].value.unumber, parm[2].value.unumber, &q0, &q1);
        bdmf_session_print(session, "q0 = %u (0x%x)\n", q0, q0);
        bdmf_session_print(session, "q1 = %u (0x%x)\n", q1, q1);
        break;
    }
    case cli_bbh_tx_unified_configurations_qprof:
    {
        bdmf_boolean q0;
        bdmf_boolean q1;
        err = ag_drv_bbh_tx_unified_configurations_qprof_get(parm[1].value.unumber, parm[2].value.unumber, &q0, &q1);
        bdmf_session_print(session, "q0 = %u (0x%x)\n", q0, q0);
        bdmf_session_print(session, "q1 = %u (0x%x)\n", q1, q1);
        break;
    }
    case cli_bbh_tx_unified_configurations_pdsize:
    {
        uint16_t fifosize0;
        uint16_t fifosize1;
        err = ag_drv_bbh_tx_unified_configurations_pdsize_get(parm[1].value.unumber, &fifosize0, &fifosize1);
        bdmf_session_print(session, "fifosize0 = %u (0x%x)\n", fifosize0, fifosize0);
        bdmf_session_print(session, "fifosize1 = %u (0x%x)\n", fifosize1, fifosize1);
        break;
    }
    case cli_bbh_tx_unified_configurations_pdwkuph:
    {
        uint8_t wkupthresh0;
        uint8_t wkupthresh1;
        err = ag_drv_bbh_tx_unified_configurations_pdwkuph_get(parm[1].value.unumber, &wkupthresh0, &wkupthresh1);
        bdmf_session_print(session, "wkupthresh0 = %u (0x%x)\n", wkupthresh0, wkupthresh0);
        bdmf_session_print(session, "wkupthresh1 = %u (0x%x)\n", wkupthresh1, wkupthresh1);
        break;
    }
    case cli_bbh_tx_unified_configurations_pd_byte_th:
    {
        uint16_t pdlimit0;
        uint16_t pdlimit1;
        err = ag_drv_bbh_tx_unified_configurations_pd_byte_th_get(parm[1].value.unumber, &pdlimit0, &pdlimit1);
        bdmf_session_print(session, "pdlimit0 = %u (0x%x)\n", pdlimit0, pdlimit0);
        bdmf_session_print(session, "pdlimit1 = %u (0x%x)\n", pdlimit1, pdlimit1);
        break;
    }
    case cli_bbh_tx_unified_configurations_qmq:
    {
        bdmf_boolean q0;
        bdmf_boolean q1;
        err = ag_drv_bbh_tx_unified_configurations_qmq_get(parm[1].value.unumber, parm[2].value.unumber, &q0, &q1);
        bdmf_session_print(session, "q0 = %u (0x%x)\n", q0, q0);
        bdmf_session_print(session, "q1 = %u (0x%x)\n", q1, q1);
        break;
    }
...
static int bcm_bbh_tx_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        bdmf_boolean dsdma=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_common_configurations_ds_dma_sup_set(%u %u)\n", bbh_id_tx, dsdma);
        if(!err) ag_drv_bbh_tx_common_configurations_ds_dma_sup_set(bbh_id_tx, dsdma);
        if(!err) ag_drv_bbh_tx_common_configurations_ds_dma_sup_get( bbh_id_tx, &dsdma);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_common_configurations_ds_dma_sup_get(%u %u)\n", bbh_id_tx, dsdma);
        if(err || dsdma!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t wan_q_2_rnr_index=gtmv(m, 2);
        bdmf_boolean q0=gtmv(m, 1);
        bdmf_boolean q1=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_q2rnr_set(%u %u %u %u)\n", bbh_id_tx, wan_q_2_rnr_index, q0, q1);
        if(!err) ag_drv_bbh_tx_wan_configurations_q2rnr_set(bbh_id_tx, wan_q_2_rnr_index, q0, q1);
        if(!err) ag_drv_bbh_tx_wan_configurations_q2rnr_get( bbh_id_tx, wan_q_2_rnr_index, &q0, &q1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_q2rnr_get(%u %u %u %u)\n", bbh_id_tx, wan_q_2_rnr_index, q0, q1);
        if(err || q0!=gtmv(m, 1) || q1!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t wan_qarof_size_index=gtmv(m, 2);
        bdmf_boolean q0=gtmv(m, 1);
        bdmf_boolean q1=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_qprof_set(%u %u %u %u)\n", bbh_id_tx, wan_qarof_size_index, q0, q1);
        if(!err) ag_drv_bbh_tx_wan_configurations_qprof_set(bbh_id_tx, wan_qarof_size_index, q0, q1);
        if(!err) ag_drv_bbh_tx_wan_configurations_qprof_get( bbh_id_tx, wan_qarof_size_index, &q0, &q1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_qprof_get(%u %u %u %u)\n", bbh_id_tx, wan_qarof_size_index, q0, q1);
        if(err || q0!=gtmv(m, 1) || q1!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_pdsize_set(%u %u %u)\n", bbh_id_tx, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pdsize_set(bbh_id_tx, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pdsize_get( bbh_id_tx, &fifosize0, &fifosize1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_pdsize_get(%u %u %u)\n", bbh_id_tx, fifosize0, fifosize1);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_pdwkuph_set(%u %u %u)\n", bbh_id_tx, wkupthresh0, wkupthresh1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pdwkuph_set(bbh_id_tx, wkupthresh0, wkupthresh1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pdwkuph_get( bbh_id_tx, &wkupthresh0, &wkupthresh1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_pdwkuph_get(%u %u %u)\n", bbh_id_tx, wkupthresh0, wkupthresh1);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_pd_byte_th_set(%u %u %u)\n", bbh_id_tx, pdlimit0, pdlimit1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pd_byte_th_set(bbh_id_tx, pdlimit0, pdlimit1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pd_byte_th_get( bbh_id_tx, &pdlimit0, &pdlimit1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_pd_byte_th_get(%u %u %u)\n", bbh_id_tx, pdlimit0, pdlimit1);
        if(err || pdlimit0!=gtmv(m, 16) || pdlimit1!=gtmv(m, 16))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t wan_qmq_size_index=gtmv(m, 2);
        bdmf_boolean q0=gtmv(m, 1);
        bdmf_boolean q1=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_qmq_set(%u %u %u %u)\n", bbh_id_tx, wan_qmq_size_index, q0, q1);
        if(!err) ag_drv_bbh_tx_wan_configurations_qmq_set(bbh_id_tx, wan_qmq_size_index, q0, q1);
        if(!err) ag_drv_bbh_tx_wan_configurations_qmq_get( bbh_id_tx, wan_qmq_size_index, &q0, &q1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_qmq_get(%u %u %u %u)\n", bbh_id_tx, wan_qmq_size_index, q0, q1);
        if(err || q0!=gtmv(m, 1) || q1!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        bbh_tx_wan_configurations_epncfg wan_configurations_epncfg = {.stplenerr=gtmv(m, 1), .cmp_width=gtmv(m, 1), .considerfull=gtmv(m, 1), .addcrc=gtmv(m, 1), .req_full=gtmv(m, 4)};
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_epncfg_set(%u %u %u %u %u %u)\n", bbh_id_tx, wan_configurations_epncfg.stplenerr, wan_configurations_epncfg.cmp_width, wan_configurations_epncfg.considerfull, wan_configurations_epncfg.addcrc, wan_configurations_epncfg.req_full);
        if(!err) ag_drv_bbh_tx_wan_configurations_epncfg_set(bbh_id_tx, &wan_configurations_epncfg);
        if(!err) ag_drv_bbh_tx_wan_configurations_epncfg_get( bbh_id_tx, &wan_configurations_epncfg);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_epncfg_get(%u %u %u %u %u %u)\n", bbh_id_tx, wan_configurations_epncfg.stplenerr, wan_configurations_epncfg.cmp_width, wan_configurations_epncfg.considerfull, wan_configurations_epncfg.addcrc, wan_configurations_epncfg.req_full);
        if(err || wan_configurations_epncfg.stplenerr!=gtmv(m, 1) || wan_configurations_epncfg.cmp_width!=gtmv(m, 1) || wan_configurations_epncfg.considerfull!=gtmv(m, 1) || wan_configurations_epncfg.addcrc!=gtmv(m, 1) || wan_configurations_epncfg.req_full!=gtmv(m, 4))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    }
    {
        bdmf_boolean q0=gtmv(m, 1);
        bdmf_boolean q1=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_lan_configurations_q2rnr_set(%u %u %u)\n", bbh_id_tx, q0, q1);
        if(!err) ag_drv_bbh_tx_lan_configurations_q2rnr_set(bbh_id_tx, q0, q1);
        if(!err) ag_drv_bbh_tx_lan_configurations_q2rnr_get( bbh_id_tx, &q0, &q1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_lan_configurations_q2rnr_get(%u %u %u)\n", bbh_id_tx, q0, q1);
        if(err || q0!=gtmv(m, 1) || q1!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        bdmf_boolean q0=gtmv(m, 1);
        bdmf_boolean q1=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_lan_configurations_qprof_set(%u %u %u)\n", bbh_id_tx, q0, q1);
        if(!err) ag_drv_bbh_tx_lan_configurations_qprof_set(bbh_id_tx, q0, q1);
        if(!err) ag_drv_bbh_tx_lan_configurations_qprof_get( bbh_id_tx, &q0, &q1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_lan_configurations_qprof_get(%u %u %u)\n", bbh_id_tx, q0, q1);
        if(err || q0!=gtmv(m, 1) || q1!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    }
    {
        bdmf_boolean q0=gtmv(m, 1);
        bdmf_boolean q1=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_lan_configurations_qmq_set(%u %u %u)\n", bbh_id_tx, q0, q1);
        if(!err) ag_drv_bbh_tx_lan_configurations_qmq_set(bbh_id_tx, q0, q1);
        if(!err) ag_drv_bbh_tx_lan_configurations_qmq_get( bbh_id_tx, &q0, &q1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_lan_configurations_qmq_get(%u %u %u)\n", bbh_id_tx, q0, q1);
        if(err || q0!=gtmv(m, 1) || q1!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        uint8_t unified_q2rnr_size_index=gtmv(m, 2);
        bdmf_boolean q0=gtmv(m, 1);
        bdmf_boolean q1=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_q2rnr_set(%u %u %u %u)\n", bbh_id_tx, unified_q2rnr_size_index, q0, q1);
        if(!err) ag_drv_bbh_tx_unified_configurations_q2rnr_set(bbh_id_tx, unified_q2rnr_size_index, q0, q1);
        if(!err) ag_drv_bbh_tx_unified_configurations_q2rnr_get( bbh_id_tx, unified_q2rnr_size_index, &q0, &q1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_q2rnr_get(%u %u %u %u)\n", bbh_id_tx, unified_q2rnr_size_index, q0, q1);
        if(err || q0!=gtmv(m, 1) || q1!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t unified_qprof_size_index=gtmv(m, 2);
        bdmf_boolean q0=gtmv(m, 1);
        bdmf_boolean q1=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_qprof_set(%u %u %u %u)\n", bbh_id_tx, unified_qprof_size_index, q0, q1);
        if(!err) ag_drv_bbh_tx_unified_configurations_qprof_set(bbh_id_tx, unified_qprof_size_index, q0, q1);
        if(!err) ag_drv_bbh_tx_unified_configurations_qprof_get( bbh_id_tx, unified_qprof_size_index, &q0, &q1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_qprof_get(%u %u %u %u)\n", bbh_id_tx, unified_qprof_size_index, q0, q1);
        if(err || q0!=gtmv(m, 1) || q1!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t fifosize0=gtmv(m, 9);
        uint16_t fifosize1=gtmv(m, 9);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_pdsize_set(%u %u %u)\n", bbh_id_tx, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pdsize_set(bbh_id_tx, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pdsize_get( bbh_id_tx, &fifosize0, &fifosize1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_pdsize_get(%u %u %u)\n", bbh_id_tx, fifosize0, fifosize1);
        if(err || fifosize0!=gtmv(m, 9) || fifosize1!=gtmv(m, 9))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t wkupthresh0=gtmv(m, 8);
        uint8_t wkupthresh1=gtmv(m, 8);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_pdwkuph_set(%u %u %u)\n", bbh_id_tx, wkupthresh0, wkupthresh1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pdwkuph_set(bbh_id_tx, wkupthresh0, wkupthresh1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pdwkuph_get( bbh_id_tx, &wkupthresh0, &wkupthresh1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_pdwkuph_get(%u %u %u)\n", bbh_id_tx, wkupthresh0, wkupthresh1);
        if(err || wkupthresh0!=gtmv(m, 8) || wkupthresh1!=gtmv(m, 8))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t pdlimit0=gtmv(m, 16);
        uint16_t pdlimit1=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_pd_byte_th_set(%u %u %u)\n", bbh_id_tx, pdlimit0, pdlimit1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pd_byte_th_set(bbh_id_tx, pdlimit0, pdlimit1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pd_byte_th_get( bbh_id_tx, &pdlimit0, &pdlimit1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_pd_byte_th_get(%u %u %u)\n", bbh_id_tx, pdlimit0, pdlimit1);
        if(err || pdlimit0!=gtmv(m, 16) || pdlimit1!=gtmv(m, 16))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t unified_qmq_size_index=gtmv(m, 2);
        bdmf_boolean q0=gtmv(m, 1);
        bdmf_boolean q1=gtmv(m, 1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_qmq_set(%u %u %u %u)\n", bbh_id_tx, unified_qmq_size_index, q0, q1);
        if(!err) ag_drv_bbh_tx_unified_configurations_qmq_set(bbh_id_tx, unified_qmq_size_index, q0, q1);
        if(!err) ag_drv_bbh_tx_unified_configurations_qmq_get( bbh_id_tx, unified_qmq_size_index, &q0, &q1);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_qmq_get(%u %u %u %u)\n", bbh_id_tx, unified_qmq_size_index, q0, q1);
        if(err || q0!=gtmv(m, 1) || q1!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
...
static int bcm_bbh_tx_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case bdmf_address_common_configurations_ds_dma_sup : reg = &RU_REG(BBH_TX, COMMON_CONFIGURATIONS_DS_DMA_SUP); blk = &RU_BLK(BBH_TX); break;
    ...
    case bdmf_address_lan_configurations_q2rnr : reg = &RU_REG(BBH_TX, LAN_CONFIGURATIONS_Q2RNR); blk = &RU_BLK(BBH_TX); break;
    case bdmf_address_lan_configurations_qprof : reg = &RU_REG(BBH_TX, LAN_CONFIGURATIONS_QPROF); blk = &RU_BLK(BBH_TX); break;
    ...
    case bdmf_address_lan_configurations_qmq : reg = &RU_REG(BBH_TX, LAN_CONFIGURATIONS_QMQ); blk = &RU_BLK(BBH_TX); break;
...
bdmfmon_handle_t ag_drv_bbh_tx_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_common_configurations_ds_dma_sup[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id_tx", "bbh_id_tx", bbh_id_tx_enum_table, 0),
            BDMFMON_MAKE_PARM("dsdma", "dsdma", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_wan_configurations_q2rnr[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id_tx", "bbh_id_tx", bbh_id_tx_enum_table, 0),
            BDMFMON_MAKE_PARM("wan_q_2_rnr_index", "wan_q_2_rnr_index", BDMFMON_PARM_NUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_wan_configurations_qprof[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id_tx", "bbh_id_tx", bbh_id_tx_enum_table, 0),
            BDMFMON_MAKE_PARM("wan_qarof_size_index", "wan_qarof_size_index", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q0", "q0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q1", "q1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_wan_configurations_qmq[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id_tx", "bbh_id_tx", bbh_id_tx_enum_table, 0),
            BDMFMON_MAKE_PARM("wan_qmq_size_index", "wan_qmq_size_index", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q0", "q0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q1", "q1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_wan_configurations_epncfg[]={
            ...
            BDMFMON_MAKE_PARM("req_full", "req_full", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_lan_configurations_q2rnr[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id_tx", "bbh_id_tx", bbh_id_tx_enum_table, 0),
            BDMFMON_MAKE_PARM("q0", "q0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q1", "q1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_lan_configurations_qprof[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id_tx", "bbh_id_tx", bbh_id_tx_enum_table, 0),
            BDMFMON_MAKE_PARM("q0", "q0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q1", "q1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        ...
        static bdmfmon_cmd_parm_t set_lan_configurations_qmq[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id_tx", "bbh_id_tx", bbh_id_tx_enum_table, 0),
            BDMFMON_MAKE_PARM("q0", "q0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q1", "q1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        ...
        static bdmfmon_cmd_parm_t set_unified_configurations_q2rnr[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id_tx", "bbh_id_tx", bbh_id_tx_enum_table, 0),
            BDMFMON_MAKE_PARM("unified_q2rnr_size_index", "unified_q2rnr_size_index", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q0", "q0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q1", "q1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_unified_configurations_qprof[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id_tx", "bbh_id_tx", bbh_id_tx_enum_table, 0),
            BDMFMON_MAKE_PARM("unified_qprof_size_index", "unified_qprof_size_index", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q0", "q0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q1", "q1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_unified_configurations_qmq[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id_tx", "bbh_id_tx", bbh_id_tx_enum_table, 0),
            BDMFMON_MAKE_PARM("unified_qmq_size_index", "unified_qmq_size_index", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q0", "q0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("q1", "q1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="common_configurations_ds_dma_sup", .val=cli_bbh_tx_common_configurations_ds_dma_sup, .parms=set_common_configurations_ds_dma_sup },
            ...
            { .name="lan_configurations_q2rnr", .val=cli_bbh_tx_lan_configurations_q2rnr, .parms=set_lan_configurations_q2rnr },
            { .name="lan_configurations_qprof", .val=cli_bbh_tx_lan_configurations_qprof, .parms=set_lan_configurations_qprof },
            ...
            { .name="lan_configurations_qmq", .val=cli_bbh_tx_lan_configurations_qmq, .parms=set_lan_configurations_qmq },
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="common_configurations_ds_dma_sup", .val=cli_bbh_tx_common_configurations_ds_dma_sup, .parms=set_default },
            { .name="wan_configurations_q2rnr", .val=cli_bbh_tx_wan_configurations_q2rnr, .parms=set_wan_configurations_q2rnr },
            { .name="wan_configurations_qprof", .val=cli_bbh_tx_wan_configurations_qprof, .parms=set_wan_configurations_qprof },
            { .name="wan_configurations_pdsize", .val=cli_bbh_tx_wan_configurations_pdsize, .parms=set_default },
            { .name="wan_configurations_pdwkuph", .val=cli_bbh_tx_wan_configurations_pdwkuph, .parms=set_default },
            { .name="wan_configurations_pd_byte_th", .val=cli_bbh_tx_wan_configurations_pd_byte_th, .parms=set_default },
            { .name="wan_configurations_qmq", .val=cli_bbh_tx_wan_configurations_qmq, .parms=set_wan_configurations_qmq },
            ...
            { .name="lan_configurations_q2rnr", .val=cli_bbh_tx_lan_configurations_q2rnr, .parms=set_default },
            { .name="lan_configurations_qprof", .val=cli_bbh_tx_lan_configurations_qprof, .parms=set_default },
            ...
            { .name="lan_configurations_qmq", .val=cli_bbh_tx_lan_configurations_qmq, .parms=set_default },
            ...
            { .name="unified_configurations_q2rnr", .val=cli_bbh_tx_unified_configurations_q2rnr, .parms=set_unified_configurations_q2rnr },
            { .name="unified_configurations_qprof", .val=cli_bbh_tx_unified_configurations_qprof, .parms=set_unified_configurations_qprof },
            { .name="unified_configurations_pdsize", .val=cli_bbh_tx_unified_configurations_pdsize, .parms=set_default },
            { .name="unified_configurations_pdwkuph", .val=cli_bbh_tx_unified_configurations_pdwkuph, .parms=set_default },
            { .name="unified_configurations_pd_byte_th", .val=cli_bbh_tx_unified_configurations_pd_byte_th, .parms=set_default },
            { .name="unified_configurations_qmq", .val=cli_bbh_tx_unified_configurations_qmq, .parms=set_unified_configurations_qmq },
    ...
    }
    {
        static bdmfmon_enum_val_t enum_table_address[] = {
            ...
            { .name="COMMON_CONFIGURATIONS_DS_DMA_SUP" , .val=bdmf_address_common_configurations_ds_dma_sup },
            ...
            { .name="LAN_CONFIGURATIONS_Q2RNR" , .val=bdmf_address_lan_configurations_q2rnr },
            { .name="LAN_CONFIGURATIONS_QPROF" , .val=bdmf_address_lan_configurations_qprof },
            ...
            { .name="LAN_CONFIGURATIONS_QMQ" , .val=bdmf_address_lan_configurations_qmq },
