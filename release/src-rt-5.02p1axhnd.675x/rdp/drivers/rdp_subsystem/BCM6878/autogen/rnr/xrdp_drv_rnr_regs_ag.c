...
bdmf_error_t ag_drv_rnr_regs_prediction_overrun_set(uint8_t rnr_id, bdmf_boolean prediction_overrun_status)
{
...
#ifdef VALIDATE_PARMS
    if((rnr_id >= BLOCK_ADDR_COUNT) ||
       (prediction_overrun_status >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_cfg_global_ctrl = RU_FIELD_SET(rnr_id, RNR_REGS, CFG_GLOBAL_CTRL, PREDICTION_OVERRUN_STATUS, reg_cfg_global_ctrl, prediction_overrun_status);
...
bdmf_error_t ag_drv_rnr_regs_trace_config_set(uint8_t rnr_id, const rnr_regs_trace_config *trace_config)
{
    ...
    if((rnr_id >= BLOCK_ADDR_COUNT) ||
       ...
       (trace_config->en_prof_on_selected_pc >= _1BITS_MAX_VAL_) ||
       (trace_config->trigger_on_second >= _1BITS_MAX_VAL_) ||
       (trace_config->pc_start >= _13BITS_MAX_VAL_) ||
       (trace_config->pc_stop >= _13BITS_MAX_VAL_) ||
       (trace_config->disable_nops_and_uncond >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_cfg_profiling_cfg_2 = RU_FIELD_SET(rnr_id, RNR_REGS, CFG_PROFILING_CFG_2, EN_PROF_ON_SELECTED_PC, reg_cfg_profiling_cfg_2, trace_config->en_prof_on_selected_pc);
    ...
    reg_cfg_profiling_cfg_2 = RU_FIELD_SET(rnr_id, RNR_REGS, CFG_PROFILING_CFG_2, PC_STOP, reg_cfg_profiling_cfg_2, trace_config->pc_stop);
    reg_cfg_profiling_cfg_2 = RU_FIELD_SET(rnr_id, RNR_REGS, CFG_PROFILING_CFG_2, DISABLE_NOPS_AND_UNCOND, reg_cfg_profiling_cfg_2, trace_config->disable_nops_and_uncond);
...
bdmf_error_t ag_drv_rnr_regs_trace_config_get(uint8_t rnr_id, rnr_regs_trace_config *trace_config)
{
    ...
    trace_config->en_prof_on_selected_pc = RU_FIELD_GET(rnr_id, RNR_REGS, CFG_PROFILING_CFG_2, EN_PROF_ON_SELECTED_PC, reg_cfg_profiling_cfg_2);
    ...
    trace_config->pc_stop = RU_FIELD_GET(rnr_id, RNR_REGS, CFG_PROFILING_CFG_2, PC_STOP, reg_cfg_profiling_cfg_2);
    trace_config->disable_nops_and_uncond = RU_FIELD_GET(rnr_id, RNR_REGS, CFG_PROFILING_CFG_2, DISABLE_NOPS_AND_UNCOND, reg_cfg_profiling_cfg_2);
...
bdmf_error_t ag_drv_rnr_regs_rnr_core_cntrs_get(uint8_t rnr_id, rnr_regs_rnr_core_cntrs *rnr_core_cntrs)
{
    ...
    rnr_core_cntrs->stall_on_jmp_full_cnt = RU_FIELD_GET(rnr_id, RNR_REGS, CFG_STALL_CNT1, STALL_ON_JMP_FULL_CNT, reg_cfg_stall_cnt1);
    ...
    rnr_core_cntrs->active_cycles_cnt = RU_FIELD_GET(rnr_id, RNR_REGS, CFG_STALL_CNT4, ACTIVE_CYCLES_CNT, reg_cfg_stall_cnt4);
...
bdmf_error_t ag_drv_rnr_regs_cfg_ext_acc_cfg_set(uint8_t rnr_id, uint16_t addr_base, uint8_t addr_step, uint8_t start_thread)
{
    ...
    reg_cfg_ext_acc_cfg = RU_FIELD_SET(rnr_id, RNR_REGS, CFG_EXT_ACC_CFG, ADDR_STEP, reg_cfg_ext_acc_cfg, addr_step);
...
bdmf_error_t ag_drv_rnr_regs_cfg_ext_acc_cfg_get(uint8_t rnr_id, uint16_t *addr_base, uint8_t *addr_step, uint8_t *start_thread)
{
...
#ifdef VALIDATE_PARMS
    if(!addr_base || !addr_step || !start_thread)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    *addr_step = RU_FIELD_GET(rnr_id, RNR_REGS, CFG_EXT_ACC_CFG, ADDR_STEP, reg_cfg_ext_acc_cfg);
...
static int bcm_rnr_regs_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_rnr_regs_prediction_overrun:
        err = ag_drv_rnr_regs_prediction_overrun_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    ...
    {
        rnr_regs_trace_config trace_config = { .trace_wraparound=parm[2].value.unumber, .trace_mode=parm[3].value.unumber, .trace_disable_idle_in=parm[4].value.unumber, .trace_disable_wakeup_log=parm[5].value.unumber, .trace_task=parm[6].value.unumber, .idle_counter_source_sel=parm[7].value.unumber, .counters_selected_task_mode=parm[8].value.unumber, .counters_task=parm[9].value.unumber, .trace_reset_event_fifo=parm[10].value.unumber, .trace_clear_fifo_overrun=parm[11].value.unumber, .en_prof_on_selected_pc=parm[12].value.unumber, .trigger_on_second=parm[13].value.unumber, .pc_start=parm[14].value.unumber, .pc_stop=parm[15].value.unumber, .disable_nops_and_uncond=parm[16].value.unumber};
    ...
    case cli_rnr_regs_cfg_ext_acc_cfg:
        err = ag_drv_rnr_regs_cfg_ext_acc_cfg_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
...
int bcm_rnr_regs_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_rnr_regs_prediction_overrun:
    {
        ...
        err = ag_drv_rnr_regs_prediction_overrun_get(parm[1].value.unumber, &prediction_overrun_status);
    ...
    case cli_rnr_regs_trace_config:
    {
        ...
        bdmf_session_print(session, "en_prof_on_selected_pc = %u (0x%x)\n", trace_config.en_prof_on_selected_pc, trace_config.en_prof_on_selected_pc);
        ...
        bdmf_session_print(session, "pc_stop = %u (0x%x)\n", trace_config.pc_stop, trace_config.pc_stop);
        bdmf_session_print(session, "disable_nops_and_uncond = %u (0x%x)\n", trace_config.disable_nops_and_uncond, trace_config.disable_nops_and_uncond);
        break;
    }
    case cli_rnr_regs_reset_trace_fifo:
    {
    ...
    case cli_rnr_regs_cfg_ext_acc_cfg:
    {
        ...
        err = ag_drv_rnr_regs_cfg_ext_acc_cfg_get(parm[1].value.unumber, &addr_base, &addr_step, &start_thread);
        bdmf_session_print(session, "addr_base = %u (0x%x)\n", addr_base, addr_base);
        bdmf_session_print(session, "addr_step = %u (0x%x)\n", addr_step, addr_step);
...
static int bcm_rnr_regs_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_rnr_regs_prediction_overrun_set(%u %u)\n", rnr_id, prediction_overrun_status);
        if(!err) ag_drv_rnr_regs_prediction_overrun_set(rnr_id, prediction_overrun_status);
        if(!err) ag_drv_rnr_regs_prediction_overrun_get( rnr_id, &prediction_overrun_status);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_regs_prediction_overrun_get(%u %u)\n", rnr_id, prediction_overrun_status);
        if(err || prediction_overrun_status!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        rnr_regs_trace_config trace_config = {.trace_wraparound=gtmv(m, 1), .trace_mode=gtmv(m, 1), .trace_disable_idle_in=gtmv(m, 1), .trace_disable_wakeup_log=gtmv(m, 1), .trace_task=gtmv(m, 4), .idle_counter_source_sel=gtmv(m, 1), .counters_selected_task_mode=gtmv(m, 1), .counters_task=gtmv(m, 4), .trace_reset_event_fifo=gtmv(m, 1), .trace_clear_fifo_overrun=gtmv(m, 1), .en_prof_on_selected_pc=gtmv(m, 1), .trigger_on_second=gtmv(m, 1), .pc_start=gtmv(m, 13), .pc_stop=gtmv(m, 13), .disable_nops_and_uncond=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_rnr_regs_trace_config_set(%u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", rnr_id, trace_config.trace_wraparound, trace_config.trace_mode, trace_config.trace_disable_idle_in, trace_config.trace_disable_wakeup_log, trace_config.trace_task, trace_config.idle_counter_source_sel, trace_config.counters_selected_task_mode, trace_config.counters_task, trace_config.trace_reset_event_fifo, trace_config.trace_clear_fifo_overrun, trace_config.en_prof_on_selected_pc, trace_config.trigger_on_second, trace_config.pc_start, trace_config.pc_stop, trace_config.disable_nops_and_uncond);
        if(!err) ag_drv_rnr_regs_trace_config_set(rnr_id, &trace_config);
        if(!err) ag_drv_rnr_regs_trace_config_get( rnr_id, &trace_config);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_regs_trace_config_get(%u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", rnr_id, trace_config.trace_wraparound, trace_config.trace_mode, trace_config.trace_disable_idle_in, trace_config.trace_disable_wakeup_log, trace_config.trace_task, trace_config.idle_counter_source_sel, trace_config.counters_selected_task_mode, trace_config.counters_task, trace_config.trace_reset_event_fifo, trace_config.trace_clear_fifo_overrun, trace_config.en_prof_on_selected_pc, trace_config.trigger_on_second, trace_config.pc_start, trace_config.pc_stop, trace_config.disable_nops_and_uncond);
        if(err || trace_config.trace_wraparound!=gtmv(m, 1) || trace_config.trace_mode!=gtmv(m, 1) || trace_config.trace_disable_idle_in!=gtmv(m, 1) || trace_config.trace_disable_wakeup_log!=gtmv(m, 1) || trace_config.trace_task!=gtmv(m, 4) || trace_config.idle_counter_source_sel!=gtmv(m, 1) || trace_config.counters_selected_task_mode!=gtmv(m, 1) || trace_config.counters_task!=gtmv(m, 4) || trace_config.trace_reset_event_fifo!=gtmv(m, 1) || trace_config.trace_clear_fifo_overrun!=gtmv(m, 1) || trace_config.en_prof_on_selected_pc!=gtmv(m, 1) || trace_config.trigger_on_second!=gtmv(m, 1) || trace_config.pc_start!=gtmv(m, 13) || trace_config.pc_stop!=gtmv(m, 13) || trace_config.disable_nops_and_uncond!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        rnr_regs_rnr_core_cntrs rnr_core_cntrs = {.stall_on_jmp_full_cnt=gtmv(m, 16), .total_stall_cnt=gtmv(m, 16), .stall_on_alu_b_full_cnt=gtmv(m, 16), .stall_on_alu_a_full_cnt=gtmv(m, 16), .stall_on_jmpreg=gtmv(m, 16), .stall_on_memio_full_cnt=gtmv(m, 16), .stall_on_waw_cnt=gtmv(m, 16), .active_cycles_cnt=gtmv(m, 16), .exec_counter=gtmv(m, 32), .idle_cnt=gtmv(m, 32), .jmp_taken_predicted_untaken_cnt=gtmv(m, 16), .jmp_untaken_predicted_taken_cnt=gtmv(m, 16)};
        if(!err) ag_drv_rnr_regs_rnr_core_cntrs_get( rnr_id, &rnr_core_cntrs);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_regs_rnr_core_cntrs_get(%u %u %u %u %u %u %u %u %u %u %u %u %u)\n", rnr_id, rnr_core_cntrs.stall_on_jmp_full_cnt, rnr_core_cntrs.total_stall_cnt, rnr_core_cntrs.stall_on_alu_b_full_cnt, rnr_core_cntrs.stall_on_alu_a_full_cnt, rnr_core_cntrs.stall_on_jmpreg, rnr_core_cntrs.stall_on_memio_full_cnt, rnr_core_cntrs.stall_on_waw_cnt, rnr_core_cntrs.active_cycles_cnt, rnr_core_cntrs.exec_counter, rnr_core_cntrs.idle_cnt, rnr_core_cntrs.jmp_taken_predicted_untaken_cnt, rnr_core_cntrs.jmp_untaken_predicted_taken_cnt);
    }
    {
    ...
    }
    {
        ...
        uint8_t addr_step=gtmv(m, 4);
        uint8_t start_thread=gtmv(m, 4);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_regs_cfg_ext_acc_cfg_set(%u %u %u %u)\n", rnr_id, addr_base, addr_step, start_thread);
        if(!err) ag_drv_rnr_regs_cfg_ext_acc_cfg_set(rnr_id, addr_base, addr_step, start_thread);
        if(!err) ag_drv_rnr_regs_cfg_ext_acc_cfg_get( rnr_id, &addr_base, &addr_step, &start_thread);
        if(!err) bdmf_session_print(session, "ag_drv_rnr_regs_cfg_ext_acc_cfg_get(%u %u %u %u)\n", rnr_id, addr_base, addr_step, start_thread);
        if(err || addr_base!=gtmv(m, 13) || addr_step!=gtmv(m, 4) || start_thread!=gtmv(m, 4))
            return err ? err : BDMF_ERR_IO;
    }
    {
...
bdmfmon_handle_t ag_drv_rnr_regs_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_prediction_overrun[]={
            BDMFMON_MAKE_PARM_ENUM("rnr_id", "rnr_id", rnr_id_enum_table, 0),
            BDMFMON_MAKE_PARM("prediction_overrun_status", "prediction_overrun_status", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_trace_config[]={
            ...
            BDMFMON_MAKE_PARM("counters_selected_task_mode", "counters_selected_task_mode", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("counters_task", "counters_task", BDMFMON_PARM_NUMBER, 0),
            ...
            BDMFMON_MAKE_PARM("en_prof_on_selected_pc", "en_prof_on_selected_pc", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("trigger_on_second", "trigger_on_second", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("pc_start", "pc_start", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("pc_stop", "pc_stop", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("disable_nops_and_uncond", "disable_nops_and_uncond", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_cfg_ext_acc_cfg[]={
            BDMFMON_MAKE_PARM_ENUM("rnr_id", "rnr_id", rnr_id_enum_table, 0),
            BDMFMON_MAKE_PARM("addr_base", "addr_base", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("addr_step", "addr_step", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("start_thread", "start_thread", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="prediction_overrun", .val=cli_rnr_regs_prediction_overrun, .parms=set_prediction_overrun },
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="prediction_overrun", .val=cli_rnr_regs_prediction_overrun, .parms=set_default },
            ...
            { .name="cfg_ext_acc_cfg", .val=cli_rnr_regs_cfg_ext_acc_cfg, .parms=set_default },
