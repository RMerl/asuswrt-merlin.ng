...
bdmf_error_t ag_drv_ubus_slv_device_0_base_set(uint32_t base)
{
    uint32_t reg_device_0_base=0;

#ifdef VALIDATE_PARMS
#endif

    reg_device_0_base = RU_FIELD_SET(0, UBUS_SLV, DEVICE_0_BASE, BASE, reg_device_0_base, base);

    RU_REG_WRITE(0, UBUS_SLV, DEVICE_0_BASE, reg_device_0_base);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv_device_0_base_get(uint32_t *base)
{
    uint32_t reg_device_0_base;
    ...
    RU_REG_READ(0, UBUS_SLV, DEVICE_0_BASE, reg_device_0_base);

    *base = RU_FIELD_GET(0, UBUS_SLV, DEVICE_0_BASE, BASE, reg_device_0_base);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv_device_0_mask_set(uint32_t mask)
{
    uint32_t reg_device_0_mask=0;

#ifdef VALIDATE_PARMS
#endif

    reg_device_0_mask = RU_FIELD_SET(0, UBUS_SLV, DEVICE_0_MASK, MASK, reg_device_0_mask, mask);

    RU_REG_WRITE(0, UBUS_SLV, DEVICE_0_MASK, reg_device_0_mask);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv_device_0_mask_get(uint32_t *mask)
{
    uint32_t reg_device_0_mask;
    ...
    RU_REG_READ(0, UBUS_SLV, DEVICE_0_MASK, reg_device_0_mask);

    *mask = RU_FIELD_GET(0, UBUS_SLV, DEVICE_0_MASK, MASK, reg_device_0_mask);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv_device_1_base_set(uint32_t base)
{
    uint32_t reg_device_1_base=0;

#ifdef VALIDATE_PARMS
#endif

    reg_device_1_base = RU_FIELD_SET(0, UBUS_SLV, DEVICE_1_BASE, BASE, reg_device_1_base, base);

    RU_REG_WRITE(0, UBUS_SLV, DEVICE_1_BASE, reg_device_1_base);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv_device_1_base_get(uint32_t *base)
{
    uint32_t reg_device_1_base;
    ...
    RU_REG_READ(0, UBUS_SLV, DEVICE_1_BASE, reg_device_1_base);

    *base = RU_FIELD_GET(0, UBUS_SLV, DEVICE_1_BASE, BASE, reg_device_1_base);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv_device_1_mask_set(uint32_t mask)
{
    uint32_t reg_device_1_mask=0;

#ifdef VALIDATE_PARMS
#endif

    reg_device_1_mask = RU_FIELD_SET(0, UBUS_SLV, DEVICE_1_MASK, MASK, reg_device_1_mask, mask);

    RU_REG_WRITE(0, UBUS_SLV, DEVICE_1_MASK, reg_device_1_mask);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv_device_1_mask_get(uint32_t *mask)
{
    uint32_t reg_device_1_mask;
    ...
    RU_REG_READ(0, UBUS_SLV, DEVICE_1_MASK, reg_device_1_mask);

    *mask = RU_FIELD_GET(0, UBUS_SLV, DEVICE_1_MASK, MASK, reg_device_1_mask);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv_device_2_base_set(uint32_t base)
{
    uint32_t reg_device_2_base=0;

#ifdef VALIDATE_PARMS
#endif

    reg_device_2_base = RU_FIELD_SET(0, UBUS_SLV, DEVICE_2_BASE, BASE, reg_device_2_base, base);

    RU_REG_WRITE(0, UBUS_SLV, DEVICE_2_BASE, reg_device_2_base);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv_device_2_base_get(uint32_t *base)
{
    uint32_t reg_device_2_base;
    ...
    RU_REG_READ(0, UBUS_SLV, DEVICE_2_BASE, reg_device_2_base);

    *base = RU_FIELD_GET(0, UBUS_SLV, DEVICE_2_BASE, BASE, reg_device_2_base);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv_device_2_mask_set(uint32_t mask)
{
    uint32_t reg_device_2_mask=0;

#ifdef VALIDATE_PARMS
#endif

    reg_device_2_mask = RU_FIELD_SET(0, UBUS_SLV, DEVICE_2_MASK, MASK, reg_device_2_mask, mask);

    RU_REG_WRITE(0, UBUS_SLV, DEVICE_2_MASK, reg_device_2_mask);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv_device_2_mask_get(uint32_t *mask)
{
    uint32_t reg_device_2_mask;
    ...
    RU_REG_READ(0, UBUS_SLV, DEVICE_2_MASK, reg_device_2_mask);

    *mask = RU_FIELD_GET(0, UBUS_SLV, DEVICE_2_MASK, MASK, reg_device_2_mask);
...
bdmf_error_t ag_drv_ubus_slv__led_cntrl_set(const ubus_slv__led_cntrl *_led_cntrl)
{
    uint32_t reg__led_cntrl=0;
    ...
    if((_led_cntrl->rx_act_en >= _1BITS_MAX_VAL_) ||
       (_led_cntrl->tx_act_en >= _1BITS_MAX_VAL_) ||
       (_led_cntrl->spdlnk_led0_act_sel >= _1BITS_MAX_VAL_) ||
       (_led_cntrl->spdlnk_led1_act_sel >= _1BITS_MAX_VAL_) ||
       (_led_cntrl->spdlnk_led2_act_sel >= _1BITS_MAX_VAL_) ||
       (_led_cntrl->act_led_act_sel >= _1BITS_MAX_VAL_) ||
       (_led_cntrl->spdlnk_led0_act_pol_sel >= _1BITS_MAX_VAL_) ||
       (_led_cntrl->spdlnk_led1_act_pol_sel >= _1BITS_MAX_VAL_) ||
       (_led_cntrl->spdlnk_led2_act_pol_sel >= _1BITS_MAX_VAL_) ||
       (_led_cntrl->act_led_pol_sel >= _1BITS_MAX_VAL_) ||
       (_led_cntrl->led_spd_ovrd >= _3BITS_MAX_VAL_) ||
       (_led_cntrl->lnk_status_ovrd >= _1BITS_MAX_VAL_) ||
       (_led_cntrl->spd_ovrd_en >= _1BITS_MAX_VAL_) ||
       (_led_cntrl->lnk_ovrd_en >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, RX_ACT_EN, reg__led_cntrl, _led_cntrl->rx_act_en);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, TX_ACT_EN, reg__led_cntrl, _led_cntrl->tx_act_en);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, SPDLNK_LED0_ACT_SEL, reg__led_cntrl, _led_cntrl->spdlnk_led0_act_sel);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, SPDLNK_LED1_ACT_SEL, reg__led_cntrl, _led_cntrl->spdlnk_led1_act_sel);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, SPDLNK_LED2_ACT_SEL, reg__led_cntrl, _led_cntrl->spdlnk_led2_act_sel);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, ACT_LED_ACT_SEL, reg__led_cntrl, _led_cntrl->act_led_act_sel);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, SPDLNK_LED0_ACT_POL_SEL, reg__led_cntrl, _led_cntrl->spdlnk_led0_act_pol_sel);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, SPDLNK_LED1_ACT_POL_SEL, reg__led_cntrl, _led_cntrl->spdlnk_led1_act_pol_sel);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, SPDLNK_LED2_ACT_POL_SEL, reg__led_cntrl, _led_cntrl->spdlnk_led2_act_pol_sel);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, ACT_LED_POL_SEL, reg__led_cntrl, _led_cntrl->act_led_pol_sel);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, LED_SPD_OVRD, reg__led_cntrl, _led_cntrl->led_spd_ovrd);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, LNK_STATUS_OVRD, reg__led_cntrl, _led_cntrl->lnk_status_ovrd);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, SPD_OVRD_EN, reg__led_cntrl, _led_cntrl->spd_ovrd_en);
    reg__led_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_CNTRL, LNK_OVRD_EN, reg__led_cntrl, _led_cntrl->lnk_ovrd_en);

    RU_REG_WRITE(0, UBUS_SLV, _LED_CNTRL, reg__led_cntrl);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv__led_cntrl_get(ubus_slv__led_cntrl *_led_cntrl)
{
    uint32_t reg__led_cntrl;
    ...
    RU_REG_READ(0, UBUS_SLV, _LED_CNTRL, reg__led_cntrl);

    _led_cntrl->rx_act_en = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, RX_ACT_EN, reg__led_cntrl);
    _led_cntrl->tx_act_en = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, TX_ACT_EN, reg__led_cntrl);
    _led_cntrl->spdlnk_led0_act_sel = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, SPDLNK_LED0_ACT_SEL, reg__led_cntrl);
    _led_cntrl->spdlnk_led1_act_sel = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, SPDLNK_LED1_ACT_SEL, reg__led_cntrl);
    _led_cntrl->spdlnk_led2_act_sel = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, SPDLNK_LED2_ACT_SEL, reg__led_cntrl);
    _led_cntrl->act_led_act_sel = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, ACT_LED_ACT_SEL, reg__led_cntrl);
    _led_cntrl->spdlnk_led0_act_pol_sel = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, SPDLNK_LED0_ACT_POL_SEL, reg__led_cntrl);
    _led_cntrl->spdlnk_led1_act_pol_sel = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, SPDLNK_LED1_ACT_POL_SEL, reg__led_cntrl);
    _led_cntrl->spdlnk_led2_act_pol_sel = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, SPDLNK_LED2_ACT_POL_SEL, reg__led_cntrl);
    _led_cntrl->act_led_pol_sel = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, ACT_LED_POL_SEL, reg__led_cntrl);
    _led_cntrl->led_spd_ovrd = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, LED_SPD_OVRD, reg__led_cntrl);
    _led_cntrl->lnk_status_ovrd = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, LNK_STATUS_OVRD, reg__led_cntrl);
    _led_cntrl->spd_ovrd_en = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, SPD_OVRD_EN, reg__led_cntrl);
    _led_cntrl->lnk_ovrd_en = RU_FIELD_GET(0, UBUS_SLV, _LED_CNTRL, LNK_OVRD_EN, reg__led_cntrl);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv__led_link_and_speed_encoding_sel_set(const ubus_slv__led_link_and_speed_encoding_sel *_led_link_and_speed_encoding_sel)
{
    uint32_t reg__led_link_and_speed_encoding_sel=0;

#ifdef VALIDATE_PARMS
    if(!_led_link_and_speed_encoding_sel)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    if((_led_link_and_speed_encoding_sel->sel_no_link_encode >= _3BITS_MAX_VAL_) ||
       (_led_link_and_speed_encoding_sel->sel_10m_encode >= _3BITS_MAX_VAL_) ||
       (_led_link_and_speed_encoding_sel->sel_100m_encode >= _3BITS_MAX_VAL_) ||
       (_led_link_and_speed_encoding_sel->sel_1000m_encode >= _3BITS_MAX_VAL_) ||
       (_led_link_and_speed_encoding_sel->sel_2500m_encode >= _3BITS_MAX_VAL_) ||
       (_led_link_and_speed_encoding_sel->sel_10g_encode >= _3BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg__led_link_and_speed_encoding_sel = RU_FIELD_SET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, SEL_NO_LINK_ENCODE, reg__led_link_and_speed_encoding_sel, _led_link_and_speed_encoding_sel->sel_no_link_encode);
    reg__led_link_and_speed_encoding_sel = RU_FIELD_SET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, SEL_10M_ENCODE, reg__led_link_and_speed_encoding_sel, _led_link_and_speed_encoding_sel->sel_10m_encode);
    reg__led_link_and_speed_encoding_sel = RU_FIELD_SET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, SEL_100M_ENCODE, reg__led_link_and_speed_encoding_sel, _led_link_and_speed_encoding_sel->sel_100m_encode);
    reg__led_link_and_speed_encoding_sel = RU_FIELD_SET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, SEL_1000M_ENCODE, reg__led_link_and_speed_encoding_sel, _led_link_and_speed_encoding_sel->sel_1000m_encode);
    reg__led_link_and_speed_encoding_sel = RU_FIELD_SET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, SEL_2500M_ENCODE, reg__led_link_and_speed_encoding_sel, _led_link_and_speed_encoding_sel->sel_2500m_encode);
    reg__led_link_and_speed_encoding_sel = RU_FIELD_SET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, SEL_10G_ENCODE, reg__led_link_and_speed_encoding_sel, _led_link_and_speed_encoding_sel->sel_10g_encode);

    RU_REG_WRITE(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, reg__led_link_and_speed_encoding_sel);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv__led_link_and_speed_encoding_sel_get(ubus_slv__led_link_and_speed_encoding_sel *_led_link_and_speed_encoding_sel)
{
    uint32_t reg__led_link_and_speed_encoding_sel;
    ...
    RU_REG_READ(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, reg__led_link_and_speed_encoding_sel);

    _led_link_and_speed_encoding_sel->sel_no_link_encode = RU_FIELD_GET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, SEL_NO_LINK_ENCODE, reg__led_link_and_speed_encoding_sel);
    _led_link_and_speed_encoding_sel->sel_10m_encode = RU_FIELD_GET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, SEL_10M_ENCODE, reg__led_link_and_speed_encoding_sel);
    _led_link_and_speed_encoding_sel->sel_100m_encode = RU_FIELD_GET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, SEL_100M_ENCODE, reg__led_link_and_speed_encoding_sel);
    _led_link_and_speed_encoding_sel->sel_1000m_encode = RU_FIELD_GET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, SEL_1000M_ENCODE, reg__led_link_and_speed_encoding_sel);
    _led_link_and_speed_encoding_sel->sel_2500m_encode = RU_FIELD_GET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, SEL_2500M_ENCODE, reg__led_link_and_speed_encoding_sel);
    _led_link_and_speed_encoding_sel->sel_10g_encode = RU_FIELD_GET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL, SEL_10G_ENCODE, reg__led_link_and_speed_encoding_sel);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv__led_link_and_speed_encoding_set(const ubus_slv__led_link_and_speed_encoding *_led_link_and_speed_encoding)
{
    uint32_t reg__led_link_and_speed_encoding=0;

#ifdef VALIDATE_PARMS
    if(!_led_link_and_speed_encoding)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    if((_led_link_and_speed_encoding->no_link_encode >= _3BITS_MAX_VAL_) ||
       (_led_link_and_speed_encoding->m10_encode >= _3BITS_MAX_VAL_) ||
       (_led_link_and_speed_encoding->m100_encode >= _3BITS_MAX_VAL_) ||
       (_led_link_and_speed_encoding->m1000_encode >= _3BITS_MAX_VAL_) ||
       (_led_link_and_speed_encoding->m2500_encode >= _3BITS_MAX_VAL_) ||
       (_led_link_and_speed_encoding->m10g_encode >= _3BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg__led_link_and_speed_encoding = RU_FIELD_SET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, NO_LINK_ENCODE, reg__led_link_and_speed_encoding, _led_link_and_speed_encoding->no_link_encode);
    reg__led_link_and_speed_encoding = RU_FIELD_SET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, M10_ENCODE, reg__led_link_and_speed_encoding, _led_link_and_speed_encoding->m10_encode);
    reg__led_link_and_speed_encoding = RU_FIELD_SET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, M100_ENCODE, reg__led_link_and_speed_encoding, _led_link_and_speed_encoding->m100_encode);
    reg__led_link_and_speed_encoding = RU_FIELD_SET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, M1000_ENCODE, reg__led_link_and_speed_encoding, _led_link_and_speed_encoding->m1000_encode);
    reg__led_link_and_speed_encoding = RU_FIELD_SET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, M2500_ENCODE, reg__led_link_and_speed_encoding, _led_link_and_speed_encoding->m2500_encode);
    reg__led_link_and_speed_encoding = RU_FIELD_SET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, M10G_ENCODE, reg__led_link_and_speed_encoding, _led_link_and_speed_encoding->m10g_encode);

    RU_REG_WRITE(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, reg__led_link_and_speed_encoding);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv__led_link_and_speed_encoding_get(ubus_slv__led_link_and_speed_encoding *_led_link_and_speed_encoding)
{
    uint32_t reg__led_link_and_speed_encoding;
    ...
    RU_REG_READ(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, reg__led_link_and_speed_encoding);

    _led_link_and_speed_encoding->no_link_encode = RU_FIELD_GET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, NO_LINK_ENCODE, reg__led_link_and_speed_encoding);
    _led_link_and_speed_encoding->m10_encode = RU_FIELD_GET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, M10_ENCODE, reg__led_link_and_speed_encoding);
    _led_link_and_speed_encoding->m100_encode = RU_FIELD_GET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, M100_ENCODE, reg__led_link_and_speed_encoding);
    _led_link_and_speed_encoding->m1000_encode = RU_FIELD_GET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, M1000_ENCODE, reg__led_link_and_speed_encoding);
    _led_link_and_speed_encoding->m2500_encode = RU_FIELD_GET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, M2500_ENCODE, reg__led_link_and_speed_encoding);
    _led_link_and_speed_encoding->m10g_encode = RU_FIELD_GET(0, UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING, M10G_ENCODE, reg__led_link_and_speed_encoding);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv__led_blink_rate_cntrl_set(uint16_t led_off_time, uint16_t led_on_time)
{
    uint32_t reg__led_blink_rate_cntrl=0;

#ifdef VALIDATE_PARMS
#endif

    reg__led_blink_rate_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_BLINK_RATE_CNTRL, LED_OFF_TIME, reg__led_blink_rate_cntrl, led_off_time);
    reg__led_blink_rate_cntrl = RU_FIELD_SET(0, UBUS_SLV, _LED_BLINK_RATE_CNTRL, LED_ON_TIME, reg__led_blink_rate_cntrl, led_on_time);

    RU_REG_WRITE(0, UBUS_SLV, _LED_BLINK_RATE_CNTRL, reg__led_blink_rate_cntrl);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_ubus_slv__led_blink_rate_cntrl_get(uint16_t *led_off_time, uint16_t *led_on_time)
{
    uint32_t reg__led_blink_rate_cntrl;
    ...
    RU_REG_READ(0, UBUS_SLV, _LED_BLINK_RATE_CNTRL, reg__led_blink_rate_cntrl);

    *led_off_time = RU_FIELD_GET(0, UBUS_SLV, _LED_BLINK_RATE_CNTRL, LED_OFF_TIME, reg__led_blink_rate_cntrl);
    *led_on_time = RU_FIELD_GET(0, UBUS_SLV, _LED_BLINK_RATE_CNTRL, LED_ON_TIME, reg__led_blink_rate_cntrl);
...
typedef enum
{
    ...
    bdmf_address_device_0_base,
    bdmf_address_device_0_mask,
    bdmf_address_device_1_base,
    bdmf_address_device_1_mask,
    bdmf_address_device_2_base,
    bdmf_address_device_2_mask,
    ...
    bdmf_address__led_cntrl,
    bdmf_address__led_link_and_speed_encoding_sel,
    bdmf_address__led_link_and_speed_encoding,
    bdmf_address__led_blink_rate_cntrl,
    bdmf_address__cntrl,
...
static int bcm_ubus_slv_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_ubus_slv_apb_mask:
        ...
        break;
    case cli_ubus_slv_device_0_base:
        err = ag_drv_ubus_slv_device_0_base_set(parm[1].value.unumber);
        break;
    case cli_ubus_slv_device_0_mask:
        err = ag_drv_ubus_slv_device_0_mask_set(parm[1].value.unumber);
        break;
    case cli_ubus_slv_device_1_base:
        err = ag_drv_ubus_slv_device_1_base_set(parm[1].value.unumber);
        break;
    case cli_ubus_slv_device_1_mask:
        err = ag_drv_ubus_slv_device_1_mask_set(parm[1].value.unumber);
        break;
    case cli_ubus_slv_device_2_base:
        err = ag_drv_ubus_slv_device_2_base_set(parm[1].value.unumber);
        break;
    case cli_ubus_slv_device_2_mask:
        err = ag_drv_ubus_slv_device_2_mask_set(parm[1].value.unumber);
        break;
    ...
    case cli_ubus_slv_profiling_cycle_num:
        ...
        break;
    case cli_ubus_slv__led_cntrl:
    {
        ubus_slv__led_cntrl _led_cntrl = { .rx_act_en=parm[1].value.unumber, .tx_act_en=parm[2].value.unumber, .spdlnk_led0_act_sel=parm[3].value.unumber, .spdlnk_led1_act_sel=parm[4].value.unumber, .spdlnk_led2_act_sel=parm[5].value.unumber, .act_led_act_sel=parm[6].value.unumber, .spdlnk_led0_act_pol_sel=parm[7].value.unumber, .spdlnk_led1_act_pol_sel=parm[8].value.unumber, .spdlnk_led2_act_pol_sel=parm[9].value.unumber, .act_led_pol_sel=parm[10].value.unumber, .led_spd_ovrd=parm[11].value.unumber, .lnk_status_ovrd=parm[12].value.unumber, .spd_ovrd_en=parm[13].value.unumber, .lnk_ovrd_en=parm[14].value.unumber};
        err = ag_drv_ubus_slv__led_cntrl_set(&_led_cntrl);
        break;
    }
    case cli_ubus_slv__led_link_and_speed_encoding_sel:
    {
        ubus_slv__led_link_and_speed_encoding_sel _led_link_and_speed_encoding_sel = { .sel_no_link_encode=parm[1].value.unumber, .sel_10m_encode=parm[2].value.unumber, .sel_100m_encode=parm[3].value.unumber, .sel_1000m_encode=parm[4].value.unumber, .sel_2500m_encode=parm[5].value.unumber, .sel_10g_encode=parm[6].value.unumber};
        err = ag_drv_ubus_slv__led_link_and_speed_encoding_sel_set(&_led_link_and_speed_encoding_sel);
        break;
    }
    case cli_ubus_slv__led_link_and_speed_encoding:
    {
        ubus_slv__led_link_and_speed_encoding _led_link_and_speed_encoding = { .no_link_encode=parm[1].value.unumber, .m10_encode=parm[2].value.unumber, .m100_encode=parm[3].value.unumber, .m1000_encode=parm[4].value.unumber, .m2500_encode=parm[5].value.unumber, .m10g_encode=parm[6].value.unumber};
        err = ag_drv_ubus_slv__led_link_and_speed_encoding_set(&_led_link_and_speed_encoding);
        break;
    }
    case cli_ubus_slv__led_blink_rate_cntrl:
        err = ag_drv_ubus_slv__led_blink_rate_cntrl_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
...
int bcm_ubus_slv_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        uint32_t base;
        err = ag_drv_ubus_slv_device_0_base_get(&base);
        bdmf_session_print(session, "base = %u (0x%x)\n", base, base);
        break;
    }
    case cli_ubus_slv_device_0_mask:
    {
        uint32_t mask;
        err = ag_drv_ubus_slv_device_0_mask_get(&mask);
        bdmf_session_print(session, "mask = %u (0x%x)\n", mask, mask);
        break;
    }
    case cli_ubus_slv_device_1_base:
    {
        uint32_t base;
        err = ag_drv_ubus_slv_device_1_base_get(&base);
        bdmf_session_print(session, "base = %u (0x%x)\n", base, base);
        break;
    }
    case cli_ubus_slv_device_1_mask:
    {
        uint32_t mask;
        err = ag_drv_ubus_slv_device_1_mask_get(&mask);
        bdmf_session_print(session, "mask = %u (0x%x)\n", mask, mask);
        break;
    }
    case cli_ubus_slv_device_2_base:
    {
        uint32_t base;
        err = ag_drv_ubus_slv_device_2_base_get(&base);
        bdmf_session_print(session, "base = %u (0x%x)\n", base, base);
        break;
    }
    case cli_ubus_slv_device_2_mask:
    {
        uint32_t mask;
        err = ag_drv_ubus_slv_device_2_mask_get(&mask);
        bdmf_session_print(session, "mask = %u (0x%x)\n", mask, mask);
        break;
    }
    case cli_ubus_slv_rnr_intr_ctrl_isr:
    ...
    case cli_ubus_slv__led_cntrl:
    {
        ubus_slv__led_cntrl _led_cntrl;
        err = ag_drv_ubus_slv__led_cntrl_get(&_led_cntrl);
        bdmf_session_print(session, "rx_act_en = %u (0x%x)\n", _led_cntrl.rx_act_en, _led_cntrl.rx_act_en);
        bdmf_session_print(session, "tx_act_en = %u (0x%x)\n", _led_cntrl.tx_act_en, _led_cntrl.tx_act_en);
        bdmf_session_print(session, "spdlnk_led0_act_sel = %u (0x%x)\n", _led_cntrl.spdlnk_led0_act_sel, _led_cntrl.spdlnk_led0_act_sel);
        bdmf_session_print(session, "spdlnk_led1_act_sel = %u (0x%x)\n", _led_cntrl.spdlnk_led1_act_sel, _led_cntrl.spdlnk_led1_act_sel);
        bdmf_session_print(session, "spdlnk_led2_act_sel = %u (0x%x)\n", _led_cntrl.spdlnk_led2_act_sel, _led_cntrl.spdlnk_led2_act_sel);
        bdmf_session_print(session, "act_led_act_sel = %u (0x%x)\n", _led_cntrl.act_led_act_sel, _led_cntrl.act_led_act_sel);
        bdmf_session_print(session, "spdlnk_led0_act_pol_sel = %u (0x%x)\n", _led_cntrl.spdlnk_led0_act_pol_sel, _led_cntrl.spdlnk_led0_act_pol_sel);
        bdmf_session_print(session, "spdlnk_led1_act_pol_sel = %u (0x%x)\n", _led_cntrl.spdlnk_led1_act_pol_sel, _led_cntrl.spdlnk_led1_act_pol_sel);
        bdmf_session_print(session, "spdlnk_led2_act_pol_sel = %u (0x%x)\n", _led_cntrl.spdlnk_led2_act_pol_sel, _led_cntrl.spdlnk_led2_act_pol_sel);
        bdmf_session_print(session, "act_led_pol_sel = %u (0x%x)\n", _led_cntrl.act_led_pol_sel, _led_cntrl.act_led_pol_sel);
        bdmf_session_print(session, "led_spd_ovrd = %u (0x%x)\n", _led_cntrl.led_spd_ovrd, _led_cntrl.led_spd_ovrd);
        bdmf_session_print(session, "lnk_status_ovrd = %u (0x%x)\n", _led_cntrl.lnk_status_ovrd, _led_cntrl.lnk_status_ovrd);
        bdmf_session_print(session, "spd_ovrd_en = %u (0x%x)\n", _led_cntrl.spd_ovrd_en, _led_cntrl.spd_ovrd_en);
        bdmf_session_print(session, "lnk_ovrd_en = %u (0x%x)\n", _led_cntrl.lnk_ovrd_en, _led_cntrl.lnk_ovrd_en);
        break;
    }
    case cli_ubus_slv__led_link_and_speed_encoding_sel:
    {
        ubus_slv__led_link_and_speed_encoding_sel _led_link_and_speed_encoding_sel;
        err = ag_drv_ubus_slv__led_link_and_speed_encoding_sel_get(&_led_link_and_speed_encoding_sel);
        bdmf_session_print(session, "sel_no_link_encode = %u (0x%x)\n", _led_link_and_speed_encoding_sel.sel_no_link_encode, _led_link_and_speed_encoding_sel.sel_no_link_encode);
        bdmf_session_print(session, "sel_10m_encode = %u (0x%x)\n", _led_link_and_speed_encoding_sel.sel_10m_encode, _led_link_and_speed_encoding_sel.sel_10m_encode);
        bdmf_session_print(session, "sel_100m_encode = %u (0x%x)\n", _led_link_and_speed_encoding_sel.sel_100m_encode, _led_link_and_speed_encoding_sel.sel_100m_encode);
        bdmf_session_print(session, "sel_1000m_encode = %u (0x%x)\n", _led_link_and_speed_encoding_sel.sel_1000m_encode, _led_link_and_speed_encoding_sel.sel_1000m_encode);
        bdmf_session_print(session, "sel_2500m_encode = %u (0x%x)\n", _led_link_and_speed_encoding_sel.sel_2500m_encode, _led_link_and_speed_encoding_sel.sel_2500m_encode);
        bdmf_session_print(session, "sel_10g_encode = %u (0x%x)\n", _led_link_and_speed_encoding_sel.sel_10g_encode, _led_link_and_speed_encoding_sel.sel_10g_encode);
        break;
    }
    case cli_ubus_slv__led_link_and_speed_encoding:
    {
        ubus_slv__led_link_and_speed_encoding _led_link_and_speed_encoding;
        err = ag_drv_ubus_slv__led_link_and_speed_encoding_get(&_led_link_and_speed_encoding);
        bdmf_session_print(session, "no_link_encode = %u (0x%x)\n", _led_link_and_speed_encoding.no_link_encode, _led_link_and_speed_encoding.no_link_encode);
        bdmf_session_print(session, "m10_encode = %u (0x%x)\n", _led_link_and_speed_encoding.m10_encode, _led_link_and_speed_encoding.m10_encode);
        bdmf_session_print(session, "m100_encode = %u (0x%x)\n", _led_link_and_speed_encoding.m100_encode, _led_link_and_speed_encoding.m100_encode);
        bdmf_session_print(session, "m1000_encode = %u (0x%x)\n", _led_link_and_speed_encoding.m1000_encode, _led_link_and_speed_encoding.m1000_encode);
        bdmf_session_print(session, "m2500_encode = %u (0x%x)\n", _led_link_and_speed_encoding.m2500_encode, _led_link_and_speed_encoding.m2500_encode);
        bdmf_session_print(session, "m10g_encode = %u (0x%x)\n", _led_link_and_speed_encoding.m10g_encode, _led_link_and_speed_encoding.m10g_encode);
        break;
    }
    case cli_ubus_slv__led_blink_rate_cntrl:
    {
        ...
        err = ag_drv_ubus_slv__led_blink_rate_cntrl_get(&led_off_time, &led_on_time);
...
static int bcm_ubus_slv_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        uint32_t base=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv_device_0_base_set( %u)\n", base);
        if(!err) ag_drv_ubus_slv_device_0_base_set(base);
        if(!err) ag_drv_ubus_slv_device_0_base_get( &base);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv_device_0_base_get( %u)\n", base);
        if(err || base!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t mask=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv_device_0_mask_set( %u)\n", mask);
        if(!err) ag_drv_ubus_slv_device_0_mask_set(mask);
        if(!err) ag_drv_ubus_slv_device_0_mask_get( &mask);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv_device_0_mask_get( %u)\n", mask);
        if(err || mask!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t base=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv_device_1_base_set( %u)\n", base);
        if(!err) ag_drv_ubus_slv_device_1_base_set(base);
        if(!err) ag_drv_ubus_slv_device_1_base_get( &base);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv_device_1_base_get( %u)\n", base);
        if(err || base!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t mask=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv_device_1_mask_set( %u)\n", mask);
        if(!err) ag_drv_ubus_slv_device_1_mask_set(mask);
        if(!err) ag_drv_ubus_slv_device_1_mask_get( &mask);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv_device_1_mask_get( %u)\n", mask);
        if(err || mask!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t base=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv_device_2_base_set( %u)\n", base);
        if(!err) ag_drv_ubus_slv_device_2_base_set(base);
        if(!err) ag_drv_ubus_slv_device_2_base_get( &base);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv_device_2_base_get( %u)\n", base);
        if(err || base!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t mask=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv_device_2_mask_set( %u)\n", mask);
        if(!err) ag_drv_ubus_slv_device_2_mask_set(mask);
        if(!err) ag_drv_ubus_slv_device_2_mask_get( &mask);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv_device_2_mask_get( %u)\n", mask);
        if(err || mask!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        ubus_slv__led_cntrl _led_cntrl = {.rx_act_en=gtmv(m, 1), .tx_act_en=gtmv(m, 1), .spdlnk_led0_act_sel=gtmv(m, 1), .spdlnk_led1_act_sel=gtmv(m, 1), .spdlnk_led2_act_sel=gtmv(m, 1), .act_led_act_sel=gtmv(m, 1), .spdlnk_led0_act_pol_sel=gtmv(m, 1), .spdlnk_led1_act_pol_sel=gtmv(m, 1), .spdlnk_led2_act_pol_sel=gtmv(m, 1), .act_led_pol_sel=gtmv(m, 1), .led_spd_ovrd=gtmv(m, 3), .lnk_status_ovrd=gtmv(m, 1), .spd_ovrd_en=gtmv(m, 1), .lnk_ovrd_en=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv__led_cntrl_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", _led_cntrl.rx_act_en, _led_cntrl.tx_act_en, _led_cntrl.spdlnk_led0_act_sel, _led_cntrl.spdlnk_led1_act_sel, _led_cntrl.spdlnk_led2_act_sel, _led_cntrl.act_led_act_sel, _led_cntrl.spdlnk_led0_act_pol_sel, _led_cntrl.spdlnk_led1_act_pol_sel, _led_cntrl.spdlnk_led2_act_pol_sel, _led_cntrl.act_led_pol_sel, _led_cntrl.led_spd_ovrd, _led_cntrl.lnk_status_ovrd, _led_cntrl.spd_ovrd_en, _led_cntrl.lnk_ovrd_en);
        if(!err) ag_drv_ubus_slv__led_cntrl_set(&_led_cntrl);
        if(!err) ag_drv_ubus_slv__led_cntrl_get( &_led_cntrl);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv__led_cntrl_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", _led_cntrl.rx_act_en, _led_cntrl.tx_act_en, _led_cntrl.spdlnk_led0_act_sel, _led_cntrl.spdlnk_led1_act_sel, _led_cntrl.spdlnk_led2_act_sel, _led_cntrl.act_led_act_sel, _led_cntrl.spdlnk_led0_act_pol_sel, _led_cntrl.spdlnk_led1_act_pol_sel, _led_cntrl.spdlnk_led2_act_pol_sel, _led_cntrl.act_led_pol_sel, _led_cntrl.led_spd_ovrd, _led_cntrl.lnk_status_ovrd, _led_cntrl.spd_ovrd_en, _led_cntrl.lnk_ovrd_en);
        if(err || _led_cntrl.rx_act_en!=gtmv(m, 1) || _led_cntrl.tx_act_en!=gtmv(m, 1) || _led_cntrl.spdlnk_led0_act_sel!=gtmv(m, 1) || _led_cntrl.spdlnk_led1_act_sel!=gtmv(m, 1) || _led_cntrl.spdlnk_led2_act_sel!=gtmv(m, 1) || _led_cntrl.act_led_act_sel!=gtmv(m, 1) || _led_cntrl.spdlnk_led0_act_pol_sel!=gtmv(m, 1) || _led_cntrl.spdlnk_led1_act_pol_sel!=gtmv(m, 1) || _led_cntrl.spdlnk_led2_act_pol_sel!=gtmv(m, 1) || _led_cntrl.act_led_pol_sel!=gtmv(m, 1) || _led_cntrl.led_spd_ovrd!=gtmv(m, 3) || _led_cntrl.lnk_status_ovrd!=gtmv(m, 1) || _led_cntrl.spd_ovrd_en!=gtmv(m, 1) || _led_cntrl.lnk_ovrd_en!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        ubus_slv__led_link_and_speed_encoding_sel _led_link_and_speed_encoding_sel = {.sel_no_link_encode=gtmv(m, 3), .sel_10m_encode=gtmv(m, 3), .sel_100m_encode=gtmv(m, 3), .sel_1000m_encode=gtmv(m, 3), .sel_2500m_encode=gtmv(m, 3), .sel_10g_encode=gtmv(m, 3)};
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv__led_link_and_speed_encoding_sel_set( %u %u %u %u %u %u)\n", _led_link_and_speed_encoding_sel.sel_no_link_encode, _led_link_and_speed_encoding_sel.sel_10m_encode, _led_link_and_speed_encoding_sel.sel_100m_encode, _led_link_and_speed_encoding_sel.sel_1000m_encode, _led_link_and_speed_encoding_sel.sel_2500m_encode, _led_link_and_speed_encoding_sel.sel_10g_encode);
        if(!err) ag_drv_ubus_slv__led_link_and_speed_encoding_sel_set(&_led_link_and_speed_encoding_sel);
        if(!err) ag_drv_ubus_slv__led_link_and_speed_encoding_sel_get( &_led_link_and_speed_encoding_sel);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv__led_link_and_speed_encoding_sel_get( %u %u %u %u %u %u)\n", _led_link_and_speed_encoding_sel.sel_no_link_encode, _led_link_and_speed_encoding_sel.sel_10m_encode, _led_link_and_speed_encoding_sel.sel_100m_encode, _led_link_and_speed_encoding_sel.sel_1000m_encode, _led_link_and_speed_encoding_sel.sel_2500m_encode, _led_link_and_speed_encoding_sel.sel_10g_encode);
        if(err || _led_link_and_speed_encoding_sel.sel_no_link_encode!=gtmv(m, 3) || _led_link_and_speed_encoding_sel.sel_10m_encode!=gtmv(m, 3) || _led_link_and_speed_encoding_sel.sel_100m_encode!=gtmv(m, 3) || _led_link_and_speed_encoding_sel.sel_1000m_encode!=gtmv(m, 3) || _led_link_and_speed_encoding_sel.sel_2500m_encode!=gtmv(m, 3) || _led_link_and_speed_encoding_sel.sel_10g_encode!=gtmv(m, 3))
            return err ? err : BDMF_ERR_IO;
    }
    {
        ubus_slv__led_link_and_speed_encoding _led_link_and_speed_encoding = {.no_link_encode=gtmv(m, 3), .m10_encode=gtmv(m, 3), .m100_encode=gtmv(m, 3), .m1000_encode=gtmv(m, 3), .m2500_encode=gtmv(m, 3), .m10g_encode=gtmv(m, 3)};
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv__led_link_and_speed_encoding_set( %u %u %u %u %u %u)\n", _led_link_and_speed_encoding.no_link_encode, _led_link_and_speed_encoding.m10_encode, _led_link_and_speed_encoding.m100_encode, _led_link_and_speed_encoding.m1000_encode, _led_link_and_speed_encoding.m2500_encode, _led_link_and_speed_encoding.m10g_encode);
        if(!err) ag_drv_ubus_slv__led_link_and_speed_encoding_set(&_led_link_and_speed_encoding);
        if(!err) ag_drv_ubus_slv__led_link_and_speed_encoding_get( &_led_link_and_speed_encoding);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv__led_link_and_speed_encoding_get( %u %u %u %u %u %u)\n", _led_link_and_speed_encoding.no_link_encode, _led_link_and_speed_encoding.m10_encode, _led_link_and_speed_encoding.m100_encode, _led_link_and_speed_encoding.m1000_encode, _led_link_and_speed_encoding.m2500_encode, _led_link_and_speed_encoding.m10g_encode);
        if(err || _led_link_and_speed_encoding.no_link_encode!=gtmv(m, 3) || _led_link_and_speed_encoding.m10_encode!=gtmv(m, 3) || _led_link_and_speed_encoding.m100_encode!=gtmv(m, 3) || _led_link_and_speed_encoding.m1000_encode!=gtmv(m, 3) || _led_link_and_speed_encoding.m2500_encode!=gtmv(m, 3) || _led_link_and_speed_encoding.m10g_encode!=gtmv(m, 3))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t led_off_time=gtmv(m, 16);
        uint16_t led_on_time=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv__led_blink_rate_cntrl_set( %u %u)\n", led_off_time, led_on_time);
        if(!err) ag_drv_ubus_slv__led_blink_rate_cntrl_set(led_off_time, led_on_time);
        if(!err) ag_drv_ubus_slv__led_blink_rate_cntrl_get( &led_off_time, &led_on_time);
        if(!err) bdmf_session_print(session, "ag_drv_ubus_slv__led_blink_rate_cntrl_get( %u %u)\n", led_off_time, led_on_time);
...
static int bcm_ubus_slv_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case bdmf_address_device_0_base : reg = &RU_REG(UBUS_SLV, DEVICE_0_BASE); blk = &RU_BLK(UBUS_SLV); break;
    case bdmf_address_device_0_mask : reg = &RU_REG(UBUS_SLV, DEVICE_0_MASK); blk = &RU_BLK(UBUS_SLV); break;
    case bdmf_address_device_1_base : reg = &RU_REG(UBUS_SLV, DEVICE_1_BASE); blk = &RU_BLK(UBUS_SLV); break;
    case bdmf_address_device_1_mask : reg = &RU_REG(UBUS_SLV, DEVICE_1_MASK); blk = &RU_BLK(UBUS_SLV); break;
    case bdmf_address_device_2_base : reg = &RU_REG(UBUS_SLV, DEVICE_2_BASE); blk = &RU_BLK(UBUS_SLV); break;
    case bdmf_address_device_2_mask : reg = &RU_REG(UBUS_SLV, DEVICE_2_MASK); blk = &RU_BLK(UBUS_SLV); break;
    ...
    case bdmf_address__led_cntrl : reg = &RU_REG(UBUS_SLV, _LED_CNTRL); blk = &RU_BLK(UBUS_SLV); break;
    case bdmf_address__led_link_and_speed_encoding_sel : reg = &RU_REG(UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING_SEL); blk = &RU_BLK(UBUS_SLV); break;
    case bdmf_address__led_link_and_speed_encoding : reg = &RU_REG(UBUS_SLV, _LED_LINK_AND_SPEED_ENCODING); blk = &RU_BLK(UBUS_SLV); break;
    case bdmf_address__led_blink_rate_cntrl : reg = &RU_REG(UBUS_SLV, _LED_BLINK_RATE_CNTRL); blk = &RU_BLK(UBUS_SLV); break;
...
bdmfmon_handle_t ag_drv_ubus_slv_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_device_0_base[]={
            BDMFMON_MAKE_PARM("base", "base", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_device_0_mask[]={
            BDMFMON_MAKE_PARM("mask", "mask", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_device_1_base[]={
            BDMFMON_MAKE_PARM("base", "base", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_device_1_mask[]={
            BDMFMON_MAKE_PARM("mask", "mask", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_device_2_base[]={
            BDMFMON_MAKE_PARM("base", "base", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_device_2_mask[]={
            BDMFMON_MAKE_PARM("mask", "mask", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set__led_cntrl[]={
        ...
        static bdmfmon_cmd_parm_t set__led_link_and_speed_encoding_sel[]={
        ...
        static bdmfmon_cmd_parm_t set__led_link_and_speed_encoding[]={
        ...
        static bdmfmon_cmd_parm_t set__led_blink_rate_cntrl[]={
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="device_0_base", .val=cli_ubus_slv_device_0_base, .parms=set_device_0_base },
            { .name="device_0_mask", .val=cli_ubus_slv_device_0_mask, .parms=set_device_0_mask },
            { .name="device_1_base", .val=cli_ubus_slv_device_1_base, .parms=set_device_1_base },
            { .name="device_1_mask", .val=cli_ubus_slv_device_1_mask, .parms=set_device_1_mask },
            { .name="device_2_base", .val=cli_ubus_slv_device_2_base, .parms=set_device_2_base },
            { .name="device_2_mask", .val=cli_ubus_slv_device_2_mask, .parms=set_device_2_mask },
            ...
            { .name="_led_cntrl", .val=cli_ubus_slv__led_cntrl, .parms=set__led_cntrl },
            { .name="_led_link_and_speed_encoding_sel", .val=cli_ubus_slv__led_link_and_speed_encoding_sel, .parms=set__led_link_and_speed_encoding_sel },
            { .name="_led_link_and_speed_encoding", .val=cli_ubus_slv__led_link_and_speed_encoding, .parms=set__led_link_and_speed_encoding },
            { .name="_led_blink_rate_cntrl", .val=cli_ubus_slv__led_blink_rate_cntrl, .parms=set__led_blink_rate_cntrl },
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="device_0_base", .val=cli_ubus_slv_device_0_base, .parms=set_default },
            { .name="device_0_mask", .val=cli_ubus_slv_device_0_mask, .parms=set_default },
            { .name="device_1_base", .val=cli_ubus_slv_device_1_base, .parms=set_default },
            { .name="device_1_mask", .val=cli_ubus_slv_device_1_mask, .parms=set_default },
            { .name="device_2_base", .val=cli_ubus_slv_device_2_base, .parms=set_default },
            { .name="device_2_mask", .val=cli_ubus_slv_device_2_mask, .parms=set_default },
            ...
            { .name="_led_cntrl", .val=cli_ubus_slv__led_cntrl, .parms=set_default },
            { .name="_led_link_and_speed_encoding_sel", .val=cli_ubus_slv__led_link_and_speed_encoding_sel, .parms=set_default },
            { .name="_led_link_and_speed_encoding", .val=cli_ubus_slv__led_link_and_speed_encoding, .parms=set_default },
            { .name="_led_blink_rate_cntrl", .val=cli_ubus_slv__led_blink_rate_cntrl, .parms=set_default },
    ...
    }
    {
        static bdmfmon_enum_val_t enum_table_address[] = {
            ...
            { .name="DEVICE_0_BASE" , .val=bdmf_address_device_0_base },
            { .name="DEVICE_0_MASK" , .val=bdmf_address_device_0_mask },
            { .name="DEVICE_1_BASE" , .val=bdmf_address_device_1_base },
            { .name="DEVICE_1_MASK" , .val=bdmf_address_device_1_mask },
            { .name="DEVICE_2_BASE" , .val=bdmf_address_device_2_base },
            { .name="DEVICE_2_MASK" , .val=bdmf_address_device_2_mask },
            ...
            { .name="_LED_CNTRL" , .val=bdmf_address__led_cntrl },
            { .name="_LED_LINK_AND_SPEED_ENCODING_SEL" , .val=bdmf_address__led_link_and_speed_encoding_sel },
            { .name="_LED_LINK_AND_SPEED_ENCODING" , .val=bdmf_address__led_link_and_speed_encoding },
            { .name="_LED_BLINK_RATE_CNTRL" , .val=bdmf_address__led_blink_rate_cntrl },
