 ...
 */
#ifndef RDP_SIM
extern int BcmMemReserveGetByName(char *name, void **virt, uint32_t* phys, uint32_t *size);
...
//TODO:replace the config by something else
    rc = BcmMemReserveGetByName(TM_BASE_ADDR_STR, &tm_ddr_base, NULL, &tm_ddr_size);
