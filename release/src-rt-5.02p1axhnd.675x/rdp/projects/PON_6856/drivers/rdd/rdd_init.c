...
static void image_1_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_1_IMAGE_1_CPU_RX_COPY_THREAD_NUMBER][reg_id[13]] = IMAGE_1_CPU_RX_COPY_UPDATE_FIFO_TABLE_ADDRESS | (IMAGE_1_WAN_LOOPBACK_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
...
static void image_3_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_3_US_TM_WAN_THREAD_NUMBER][reg_id[11]] = (IMAGE_3_COMPLEX_SCHEDULER_TABLE_ADDRESS << 16); /* low register used dynamically */
...
static void image_4_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_COMPLETE_0_THREAD_NUMBER][reg_id[12]] = (IMAGE_4_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS + sizeof(RDD_DHD_COMPLETE_COMMON_RADIO_ENTRY_DTS)*0) | (IMAGE_4_DHD_TX_COMPLETE_0_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
    ...
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_COMPLETE_1_THREAD_NUMBER][reg_id[12]] = (IMAGE_4_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS + sizeof(RDD_DHD_COMPLETE_COMMON_RADIO_ENTRY_DTS)*1) | (IMAGE_4_DHD_TX_COMPLETE_1_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
    ...
    local_regs[IMAGE_4_IMAGE_4_DHD_TX_COMPLETE_2_THREAD_NUMBER][reg_id[12]] = (IMAGE_4_DHD_COMPLETE_COMMON_RADIO_DATA_ADDRESS + sizeof(RDD_DHD_COMPLETE_COMMON_RADIO_ENTRY_DTS)*2) | (IMAGE_4_DHD_TX_COMPLETE_2_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
...
static void image_5_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_5_PROCESSING_SERVICE_QUEUES_UPDATE_FIFO_THREAD_NUMBER][reg_id[14]] = IMAGE_5_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS | (IMAGE_5_SERVICE_QUEUES_SCHEDULING_QUEUE_AGING_VECTOR_ADDRESS << 16);
    ...
    local_regs[IMAGE_5_PROCESSING_SERVICE_QUEUES_TX_THREAD_NUMBER][reg_id[11]] = (IMAGE_5_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS << 16) | IMAGE_5_SERVICE_QUEUES_PD_FIFO_TABLE_ADDRESS;
    ...
    local_regs[IMAGE_5_PROCESSING_SERVICE_QUEUES_TX_THREAD_NUMBER][reg_id[9]]  = (IMAGE_5_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS << 16) | (BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_SERVICE_QUEUES << 6)) ;
    ...
    local_regs[IMAGE_5_PROCESSING_BUDGET_ALLOCATION_SERVICE_QUEUES_THREAD_NUMBER][reg_id[13]] = FFI_32_SIZE * sizeof(RDD_BASIC_RATE_LIMITER_DESCRIPTOR_DTS);
    local_regs[IMAGE_5_PROCESSING_BUDGET_ALLOCATION_SERVICE_QUEUES_THREAD_NUMBER][reg_id[12]] = IMAGE_5_SERVICE_QUEUES_SCHEDULING_QUEUE_TABLE_ADDRESS | (IMAGE_5_SERVICE_QUEUES_COMPLEX_SCHEDULER_TABLE_ADDRESS << 16);
...
static void image_6_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_0_THREAD_NUMBER][reg_id[13]] = 0 | ((IMAGE_6_DHD_POST_COMMON_RADIO_DATA_ADDRESS + sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS)*0)) << 16;
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_0_THREAD_NUMBER][reg_id[12]] = 0;
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_0_THREAD_NUMBER][reg_id[11]] = IMAGE_6_DHD_TX_POST_PD_FIFO_TABLE_ADDRESS + sizeof(RDD_PROCESSING_TX_DESCRIPTOR_DTS)*0;
    ...
    /* high = post_common_radio_ptr , low =radio_idx */
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_1_THREAD_NUMBER][reg_id[13]] = 1 | ((IMAGE_6_DHD_POST_COMMON_RADIO_DATA_ADDRESS + sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS)*1)) << 16;
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_1_THREAD_NUMBER][reg_id[12]] = 0;
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_1_THREAD_NUMBER][reg_id[11]] = IMAGE_6_DHD_TX_POST_PD_FIFO_TABLE_ADDRESS + sizeof(RDD_PROCESSING_TX_DESCRIPTOR_DTS)*4;
    ...
    /* high = post_common_radio_ptr , low =radio_idx */
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_2_THREAD_NUMBER][reg_id[13]] = 2 | ((IMAGE_6_DHD_POST_COMMON_RADIO_DATA_ADDRESS + sizeof(RDD_DHD_POST_COMMON_RADIO_ENTRY_DTS)*2)) << 16;
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_2_THREAD_NUMBER][reg_id[12]] = 0;
    local_regs[IMAGE_6_IMAGE_6_DHD_TX_POST_2_THREAD_NUMBER][reg_id[11]] = IMAGE_6_DHD_TX_POST_PD_FIFO_TABLE_ADDRESS + sizeof(RDD_PROCESSING_TX_DESCRIPTOR_DTS)*8;
    ...
    /* DHD_MCAST: thread 6 */
    local_regs[IMAGE_6_IMAGE_6_DHD_MCAST_THREAD_NUMBER][reg_id[16]] = ADDRESS_OF(image_6, dhd_mcast_wakeup_request) << 16;
    /* high = PD fifo bit ( = 0), low = DHD TX Post update fifo task number */
    local_regs[IMAGE_6_IMAGE_6_DHD_MCAST_THREAD_NUMBER][reg_id[12]] = (((IMAGE_6_IMAGE_6_DHD_TX_POST_UPDATE_FIFO_THREAD_NUMBER) << 4) + 9);
    local_regs[IMAGE_6_IMAGE_6_DHD_MCAST_THREAD_NUMBER][reg_id[11]] = IMAGE_6_DHD_MCAST_PD_FIFO_TABLE_ADDRESS | (IMAGE_6_DHD_MCAST_DISPATCHER_CREDIT_TABLE_ADDRESS << 16);
    local_regs[IMAGE_6_IMAGE_6_DHD_MCAST_THREAD_NUMBER][reg_id[10]] = (BB_ID_DISPATCHER_REORDER + (DISP_REOR_VIQ_DHD_MCAST << 6)) | (IMAGE_6_DHD_MCAST_UPDATE_FIFO_TABLE_ADDRESS << 16);
    ...
    {
        local_regs[task][reg_id[9]] = IMAGE_6_RX_FLOW_TABLE_ADDRESS << 16 | task;
...
static void image_7_context_set(uint32_t core_index, rdd_init_params_t *init_params)
{
    ...
    {
        local_regs[task][reg_id[9]] = IMAGE_7_RX_FLOW_TABLE_ADDRESS << 16 | task;
...
static void rdd_layer2_header_copy_ptr_init(void)
{
    ...
    for (core_index = 0; core_index < GROUPED_EN_SEGMENTS_NUM; core_index++)
    {
        ...
        {
            for (i = 0; i < RDD_LAYER2_HEADER_COPY_MAPPING_TABLE_SIZE; i++)
                RDD_LAYER2_HEADER_COPY_MAPPING_ENTRY_ROUTINE_WRITE(processing4_layer2_header_copy_routine_arr[i], (entry + (sizeof(RDD_LAYER2_HEADER_COPY_MAPPING_ENTRY_DTS) * i)));
        }
        else if (rdp_core_to_image_map[core_index] == processing5_runner_image)
        {
            for (i = 0; i < RDD_LAYER2_HEADER_COPY_MAPPING_TABLE_SIZE; i++)
                RDD_LAYER2_HEADER_COPY_MAPPING_ENTRY_ROUTINE_WRITE(processing5_layer2_header_copy_routine_arr[i], (entry + (sizeof(RDD_LAYER2_HEADER_COPY_MAPPING_ENTRY_DTS) * i)));
        }
    }
}
...
static void rdd_service_queues_actions_proj_init(void)
{
    ...
    uint16_t sq_actions_arr[] = {
        [0]  = ADDRESS_OF(image_5, scheduling_service_queues_action_not_valid),
        [1]  = ADDRESS_OF(image_5, complex_scheduler_update_dwrr_queues),
        [2]  = ADDRESS_OF(image_5, complex_scheduler_update_dwrr_basic_schedulers),
        [3]  = ADDRESS_OF(image_5, complex_scheduler_update_dwrr_complex_schedulers),
        [4]  = ADDRESS_OF(image_5, scheduling_service_queues_action_not_valid),
        [5]  = ADDRESS_OF(image_5, scheduling_service_queues_action_not_valid),
        [6]  = ADDRESS_OF(image_5, complex_rate_limiter_queue_sir),
        [7]  = ADDRESS_OF(image_5, complex_rate_limiter_queue_pir),
        [8]  = ADDRESS_OF(image_5, scheduling_service_queues_action_not_valid),
        [9]  = ADDRESS_OF(image_5, scheduling_service_queues_action_not_valid),
        [10] = ADDRESS_OF(image_5, scheduling_service_queues_action_not_valid),
        [11] = ADDRESS_OF(image_5, basic_rate_limiter_complex_scheduler),
        [12] = ADDRESS_OF(image_5, scheduling_service_queues_action_not_valid),
        [13 ... 15] = ADDRESS_OF(image_5, scheduling_service_queues_action_not_valid),
        [16] = ADDRESS_OF(image_5, scheduling_service_queues_update_status)
    };
    ...
    for (core_index = 0; core_index < GROUPED_EN_SEGMENTS_NUM; core_index++)
    {
        ...
        else if (rdp_core_to_image_map[core_index] == processing4_runner_image)
        {
            rdd_write_action(core_index, processing4_vlan_actions_arr, sizeof(processing4_vlan_actions_arr)/sizeof(processing4_vlan_actions_arr[0]),
                (uint8_t *)RDD_VLAN_ACTION_GPE_HANDLER_PTR_TABLE_PTR(core_index), RDD_VLAN_ACTION_GPE_HANDLER_PTR_TABLE_SIZE, image_6_action_exception);
        }
        else if (rdp_core_to_image_map[core_index] == processing5_runner_image)
        {
            rdd_write_action(core_index, processing5_vlan_actions_arr, sizeof(processing5_vlan_actions_arr)/sizeof(processing5_vlan_actions_arr[0]),
                (uint8_t *)RDD_VLAN_ACTION_GPE_HANDLER_PTR_TABLE_PTR(core_index), RDD_VLAN_ACTION_GPE_HANDLER_PTR_TABLE_SIZE, image_7_action_exception);
        }
    }
}
