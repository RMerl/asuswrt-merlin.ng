 ...
 *******************************************************************************
 * File Name  : blogctl.h
 * Description: Command line parsing for the Broadcom blog Control Utility
 *******************************************************************************
 */
...
/* Return codes. */
#define BLOGCTL_GENERAL_ERROR                 100
#define BLOGCTL_NOT_FOUND                     101
#define BLOGCTL_ALLOC_ERROR                   102
#define BLOGCTL_INVALID_COMMAND               103

#define BLOGCTL_INVALID_OPTION                104
#define BLOGCTL_INVALID_PARAMETER             105
#define BLOGCTL_INVALID_NUMBER_OF_OPTIONS     106
#define BLOGCTL_INVALID_NUMBER_OF_PARAMETERS  107
