...
#endif
{
    ...
    while ( argc && nExitCode == 0 )
    {
        ...
        {
            nExitCode = BLOGCTL_INVALID_COMMAND;
...
{
    int nRet = BLOG_SUCCESS, nNumOptInfo = 0, nArgType = 0;
    ...
    *pnArgNext = 0;
    ...
    do
    {
        ...
        case ARG_TYPE_OPTION:
            ...
            {
                nRet = BLOGCTL_INVALID_NUMBER_OF_OPTIONS;
    ...
    } while ( (nRet == BLOG_SUCCESS) && (nArgType!=ARG_TYPE_COMMAND) );

    if ( nRet == BLOG_SUCCESS )
