...
#endif
{
    ...
    while ( argc && nExitCode == 0 )
    {
        ...
        {
            nExitCode = BPMCTL_INVALID_COMMAND;
...
{
    int nRet = BPMCTL_SUCCESS, nNumOptInfo = 0, nArgType = 0;
    ...
    *pnArgNext = 0;
    ...
    do
    {
        ...
        case ARG_TYPE_OPTION:
            ...
            {
                nRet = BPMCTL_INVALID_NUMBER_OF_OPTIONS;
    ...
    } while ( (nRet == BPMCTL_SUCCESS) && (nArgType!=ARG_TYPE_COMMAND) );

    if ( nRet == BPMCTL_SUCCESS )
