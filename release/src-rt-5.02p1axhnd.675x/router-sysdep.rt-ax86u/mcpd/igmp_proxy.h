 ...
 *
 * Description: API for igmp proxy operations
 *              
 ***************************************************************************/
#ifndef __IGMP_PROXY_H__
#define __IGMP_PROXY_H__

/** initialize igmp proxy params
 *
 *
...
/** process ssm source list into a array
 *
 * @param nsources   (IN) # of sources
 *
 * @param *in_addr   (IN) pointer to source list
 *
 * @return None
 *
 */
 ...
 *
 * @param **ptr_ssm_info (IN) pointer to SSM info
 *
 ...
 *
 */
t_MCPD_RET_CODE mcpd_igmp_update_upstream_ssm(t_MCPD_GROUP_OBJ *gp, 
                                              UINT8 *ptr_ssm_info);

/** update the kernel SSM silters
 *
 ...
 *
 */
t_MCPD_RET_CODE mcpd_igmp_krnl_update_ssm_filters(t_MCPD_INTERFACE_OBJ *ifp,
                                                  t_MCPD_GROUP_OBJ *gp,
                                                  UINT8 *ptr_ssm_info,
