...
#ifndef SHARED_OPENSOURCE_DRV_LPORT_LPORT_STATS_H_
#define SHARED_OPENSOURCE_DRV_LPORT_LPORT_STATS_H_
...
/*PFC are not in use in this platform */
#if 0
    RXPFCOFF0   /*< Receive PFC Frame Priority 0 XON to XOFF*/
    RXPFCOFF1   /*< Receive PFC Frame Priority 1*/
    RXPFCOFF2   /*< Receive PFC Frame Priority 2*/
    RXPFCOFF3   /*< Receive PFC Frame Priority 3*/
    RXPFCOFF4   /*< Receive PFC Frame Priority 4*/
    RXPFCOFF5   /*< Receive PFC Frame Priority 5*/
    RXPFCOFF6   /*< Receive PFC Frame Priority 6*/
    RXPFCOFF7   /*< Receive PFC Frame Priority 7*/
    RXPFCP0     /*< Receive PFC Frame Priority 0*/
    RXPFCP1     /*< Receive PFC Frame Priority 1*/
    RXPFCP2     /*< Receive PFC Frame Priority 2*/
    RXPFCP3     /*< Receive PFC Frame Priority 3*/
    RXPFCP4     /*< Receive PFC Frame Priority 4*/
    RXPFCP5     /*< Receive PFC Frame Priority 5*/
    RXPFCP6     /*< Receive PFC Frame Priority 6*/
    RXPFCP7     /*< Receive PFC Frame Priority 7*/
#endif
...
#if 0
    STAT_GTXPFCP0, /*< Transmit PFC Frame Priority 0*/
    STAT_GTXPFCP1, /*< Transmit PFC Frame Priority 1*/
    STAT_GTXPFCP2, /*< Transmit PFC Frame Priority 2*/
    STAT_GTXPFCP3, /*< Transmit PFC Frame Priority 3*/
    STAT_GTXPFCP4, /*< Transmit PFC Frame Priority 4*/
    STAT_GTXPFCP5, /*< Transmit PFC Frame Priority 5*/
    STAT_GTXPFCP6 /*< Transmit PFC Frame Priority 6*/
    STAT_GTXPFCP7, /*< Transmit PFC Frame Priority 7*/
#endif
...
/*PFC are not in use in this platform */
#if 0
    uint64_t    RXPFCOFF0   /*< Receive PFC Frame Priority 0 XON to XOFF*/
    uint64_t    RXPFCOFF1   /*< Receive PFC Frame Priority 1*/
    uint64_t    RXPFCOFF2   /*< Receive PFC Frame Priority 2*/
    uint64_t    RXPFCOFF3   /*< Receive PFC Frame Priority 3*/
    uint64_t    RXPFCOFF4   /*< Receive PFC Frame Priority 4*/
    uint64_t    RXPFCOFF5   /*< Receive PFC Frame Priority 5*/
    uint64_t    RXPFCOFF6   /*< Receive PFC Frame Priority 6*/
    uint64_t    RXPFCOFF7   /*< Receive PFC Frame Priority 7*/
    uint64_t    RXPFCP0     /*< Receive PFC Frame Priority 0*/
    uint64_t    RXPFCP1     /*< Receive PFC Frame Priority 1*/
    uint64_t    RXPFCP2     /*< Receive PFC Frame Priority 2*/
    uint64_t    RXPFCP3     /*< Receive PFC Frame Priority 3*/
    uint64_t    RXPFCP4     /*< Receive PFC Frame Priority 4*/
    uint64_t    RXPFCP5     /*< Receive PFC Frame Priority 5*/
    uint64_t    RXPFCP6     /*< Receive PFC Frame Priority 6*/
    uint64_t    RXPFCP7     /*< Receive PFC Frame Priority 7*/
#endif
...
#if 0
    uint64_t    GTXPFCP0; /*< Transmit PFC Frame Priority 0*/
    uint64_t    GTXPFCP1; /*< Transmit PFC Frame Priority 1*/
    uint64_t    GTXPFCP2; /*< Transmit PFC Frame Priority 2*/
    uint64_t    GTXPFCP3; /*< Transmit PFC Frame Priority 3*/
    uint64_t    GTXPFCP4; /*< Transmit PFC Frame Priority 4*/
    uint64_t    GTXPFCP5; /*< Transmit PFC Frame Priority 5*/
    uint64_t    GTXPFCP6 /*< Transmit PFC Frame Priority 6*/
    uint64_t    GTXPFCP7; /*< Transmit PFC Frame Priority 7*/
#endif
...
#endif /* SHARED_OPENSOURCE_DRV_LPORT_LPORT_STATS_H_ */
