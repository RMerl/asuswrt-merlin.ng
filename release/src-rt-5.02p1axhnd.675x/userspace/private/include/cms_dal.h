...
#elif defined(SUPPORT_DM_PURE181)
#define dalWan_editeSafe(ifName,IPv4Enable,IPv6Enable)  dalWan_editeSafe_dev2((ifName),(IPv4Enable),(IPv6Enable))
#define dalWan_geteSafe(ifName,IPv4Enable,IPv6Enable)   dalWan_geteSafe_dev2((ifName),(IPv4Enable),(IPv6Enable))
#endif
