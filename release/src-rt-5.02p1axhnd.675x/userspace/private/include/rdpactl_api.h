...
int rdpaCtl_set_port_param(rdpa_if rdpaIf, rdpa_drv_ioctl_port_param_t *portParam);
int rdpaCtl_get_port_param(rdpa_if rdpaIf, rdpa_drv_ioctl_port_param_t *portParam);
