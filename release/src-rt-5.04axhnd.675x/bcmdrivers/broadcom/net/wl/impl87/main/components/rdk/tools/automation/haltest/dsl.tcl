...
#UTF::Power::Synaccess utf25npc1 -lan_ip 172.16.1.44 -relay 10.19.87.245 -rev 1
#UTF::Power::Synaccess utf25npc2 -lan_ip 172.16.1.45 -relay 10.19.87.245 -rev 1
#UTF::Power::Synaccess utf25npc3 -lan_ip 172.16.1.46 -relay 10.19.87.245
...
#    }
    ...
    foreach dev "10.19.87.245 svt-utf25-sta1" {
        catch {
...
UTF::Linux 10.19.87.245 -lan_ip 10.19.87.245 \
    -sta {lan enp0s26u1u2}
...
UTF::Linux utf25-sta1 -lan_ip 10.19.87.234 -sta {4360sta1 enp0s26u1u2}
4360sta1 configure -ipaddr 10.0.0.86
...
UTF::CableModem 3390 -sta {3390_4366 wl0 3390_4366.%7 wl0.% 3390_4366 wl1 3390_4366.%7 wl1.%} \
    -lan_ip 10.0.0.1 \
    -relay "10.19.87.245" -lanpeer {lan} \
    -tag "4366" \
    -date "2019.04.01" \
    -console "10.19.87.245:40000" \
