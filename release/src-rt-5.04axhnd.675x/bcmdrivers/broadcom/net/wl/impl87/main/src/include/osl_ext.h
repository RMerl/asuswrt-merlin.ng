 ...
 *
 * $Id: osl_ext.h 791379 2020-09-24 16:49:51Z $
 */
...
bool osl_ext_in_isr(void);
void osl_ext_check_os_stack(void);
osl_ext_status_t osl_ext_preempt_disable(uint *previous_threshold);
osl_ext_status_t osl_ext_preempt_restore(uint threshold);
void osl_ext_reentrancy_check_start(uint* count, const char* file, uint line);
void osl_ext_reentrancy_check_end(uint* count);
