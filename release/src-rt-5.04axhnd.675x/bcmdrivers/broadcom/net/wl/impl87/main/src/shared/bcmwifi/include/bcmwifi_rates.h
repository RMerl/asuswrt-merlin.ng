 ...
 *
 * $Id: bcmwifi_rates.h 802975 2021-09-12 19:57:42Z $
 */
...
#define HE_CAP_MAX_MCS_NSS_GET_MCS(nss, mcs_nss_map) \
	(((mcs_nss_map) >> HE_CAP_MAX_MCS_NSS_GET_SS_IDX(nss)) & HE_CAP_MAX_MCS_MASK)
