 ...
 *
 * $Id: bcmwifi_channels.c 802977 2021-09-12 20:34:48Z $
 */
...
static const uint16 wf_chspec_bw_half_mhz[] = {
	0,	/*   5MHz (__WL_CHANSPEC_BW_5) */
	0,	/*  10MHz (__WL_CHANSPEC_BW_10) */
 ...
 */
uint
wf_6G_primary20_ch_to_center_ch(uint primary_channel, chanspec_bw_t bw)
{
	uint delta, i;
