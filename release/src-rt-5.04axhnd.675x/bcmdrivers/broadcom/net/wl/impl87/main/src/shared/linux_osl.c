 ...
 *
 * $Id: linux_osl.c 806648 2021-12-24 14:33:40Z $
 */
...
#if defined(STS_XFER_PHYRXS) || defined(STS_FIFO_RXEN) || defined(WLC_OFFLOADS_RXSTS)
 ...
 */
	...
	if (va)
#if !(defined(STB) || defined(STBAP)) && !(0 && (LINUX_VERSION_CODE >= \
...
{
#ifndef BCM_SECURE_DMA
#if ((defined(STB) || defined(STBAP)) && !defined(DHD_USE_COHERENT_MEM_FOR_RING)) || (0 \
...
#if defined(TS_XFER_PHYRXS) || defined(STS_FIFO_RXEN) || defined(WLC_OFFLOADS_RXSTS)
...
#if defined(STS_XFER_PHYRXS) || defined(STS_XFER_TXS) || defined(STS_FIFO_RXEN) || \
	defined(WLC_OFFLOADS_RXSTS)
void
