 ...
 *
 * $Id: hnd_pktpool.h 794080 2020-12-21 03:36:52Z $
 */
...
#if defined(BCMHWA) && defined(HNDPQP)
	uint32 pad; /* fastdma requeirement 8 bytes alignment */
#endif
} lfrag_buf_t;
...
#ifdef HNDPQP
#define PQP_HEAP_BUF_POOL	(pqp_heap_buf_pool)
extern lfrag_buf_pool_t *pqp_heap_buf_pool;
#define PQP_HEAPBUF_POOL_AVAIL() lfbufpool_avail(PQP_HEAP_BUF_POOL)
#endif /* HNDPQP */
#else
