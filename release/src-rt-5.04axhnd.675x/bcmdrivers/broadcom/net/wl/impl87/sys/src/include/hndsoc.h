 ...
 *
 * $Id: hndsoc.h 787307 2020-05-26 09:41:31Z $
 */
...
/** returns physical addr of chipcommon wrapper from the AXI backplane (eg, BME) perspective */
 ...
 */
/** returns physical addr of chipcommon core from AXI backplane (eg, BME) perspective */
#define SI_ENUM_BASE_BP(sih)	((sih)->enum_base_bp)
/** returns physical addr of chipcommon wrapper from the backplane (eg, BME) perspective */
