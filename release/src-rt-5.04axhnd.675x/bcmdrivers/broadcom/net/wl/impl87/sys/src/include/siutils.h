 ...
 *
 * $Id: siutils.h 801365 2021-07-21 02:47:58Z $
 */
...
/* reset/disable function for D11 RSDB cores */
void si_d11rsdb_core_reset(si_t *sih, uint32 bits, uint32 resetbits);
void si_d11rsdb_core_disable(si_t *sih, uint32 bits);
