 ...
 *
 * $Id: wldev_common.h 790704 2020-09-01 08:26:52Z $
 */
...
s32 wldev_xtlv_getbuf(struct net_device *dev, s8 *iovar_name, u16 id,
	const void *param, s32 paramlen, void *buf, s32 buflen, struct mutex* buf_sync);
s32 wldev_xtlv_setbuf(struct net_device *dev, s8 *iovar_name, u16 id,
	const void *param, s32 paramlen, void *buf, s32 buflen, struct mutex* buf_sync);
s32 wldev_xtlv_setint(struct net_device *dev, s8 *iovar, u16 id, s32 val);
s32 wldev_xtlv_getint(struct net_device *dev, s8 *iovar, u16 id, s32 *pval, s32 mask);
