...
static long rdpa_cmdIoctl(struct file *filep, unsigned int command, unsigned long arg)
{
    ...
    switch( cmd )
    {
        ...
        case RDPA_IOC_IPTV:
        {
#if defined(CONFIG_BCM_DSL_RDP) || defined(CONFIG_BCM_DSL_XRDP) || defined (CONFIG_BCM96855)
...
#if defined(CONFIG_BCM_DSL_RDP) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912) || defined(CONFIG_BCM96813)  /* TBD_6813 */
