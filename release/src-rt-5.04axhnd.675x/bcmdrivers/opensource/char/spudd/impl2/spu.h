...
/* For AEAD, 4000 is used due to the fact that 
 * kernel would add the sum of cra_priority of all ciphers
 * involved in the aead case, hence aead cipher supported
 * by hw must have cra_priority much higher than the sum
 * of all possible sw and sw+hw combinations.
 */
 #define SPU_CRA_AEAD_PRIORITY     4000
