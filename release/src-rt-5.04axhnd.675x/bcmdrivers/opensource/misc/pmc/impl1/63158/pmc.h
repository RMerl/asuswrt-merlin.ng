...
typedef struct {
   ...
   uint32_t reserved;     // 0x104
   uint32_t cfg_lo;       // 0x108
   uint32_t reserved1;    // 0x10c
   uint32_t adc_data;     // 0x110
   uint32_t vref_data;    // 0x114
   uint32_t reserved2[2]; // 0x118
   uint32_t ascan_config; // 0x120
...
typedef struct Pmc {
   ...
   uint32_t unused12[126528];  /* 0x4800-0x80100 */
