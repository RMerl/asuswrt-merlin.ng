...
#define BCM_PHYID_M      0xFFF0
    ...
    #define REG_PORT_FORWARD                              0x21
        ...
        #define REG_PORT_FORWARD_INRANGEERR_DISCARD       0X04
        #define REG_PORT_FORWARD_OUTRANGEERR_DISCARD      0x02
    ...
    #define REG_PORT_STATE                                0x58  // 63158: move to E4-00
        ...
        #define REG_PORT_STATE_2500                       0x0c  /* 6756 */
        #define REG_PORT_STATE_10000                      0x80  /* 6756 */
        #define REG_PORT_STATE_5000                       0x84  /* 6756 */
        #define REG_PORT_STATE_EXT_SPD_MSK                0x8c
        #define REG_PORT_STATE_IMP_SPD_MSK                0x0c
...
#define PAGE_MANAGEMENT                                   0x02
    ...
    #define REG_GLOBAL_CONFIG                             0x00
        ...
        #define ENABLE_DUAL_IMP_PORTS                     0xc0
...
#define PAGE_QOS                                          0x30
 ...
 /* The per port DSCP QOS Enable Register */
    ...
    #define REG_QOS_PID2TC                                (0x48+QOS_REG_SHIFT)
    #define REG_QOS_TC_SEL_TBL_P0                         (0x50+QOS_REG_SHIFT)
    #define REG_QOS_CPU2COS_MAP                           (0x64+QOS_REG_SHIFT)
    #define REG_QOS_TC2OS_MAP_P0                          0x70
