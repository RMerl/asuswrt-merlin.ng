...
#define DDRPHY_VREF_DAC_CTRL_DAC0_MASK             (0x3f << DDRPHY_VREF_DAC_CTRL_DAC0_SHIFT)
	...
	uint32_t ZQ_CAL2;		/* 0x1b4 */
	uint32_t unused6[14];		/* 0x1b8-0x1ef */
	uint32_t CLOCK_IDLE;		/* 0x1f0 */
	uint32_t unused7[131];		/* 0x1f4-0x3ff */
} DDRPhyControl;
...
#define MC_CHN_TIM_TIM3_TIM3_TZQCS_DEFAULT                         0x00000040
	...
	uint32_t ARB_RATE_FAIL_WEIGHT[2];/* 0x3f8 */

	uint32_t unused12[48];		/* 0x400 */
...
#define MEMC_STATS_FILTER_CFG_INTF_EDIS1       MEMC_STATS_FILTER_CFG_INTF_UNUSED
	...
	uint32_t unused23[567];		/* 0xf24-0x17ff */

	SecureRangeCheckers SEC_RANGE_CHK;/* 0x1800-0x18ff */
	uint32_t unused24[31168];	/* 0x1900-0x1ffff */
