...
#define MEMC_ARB_CFG_BURST_MODE_MASK    (0x1<<MEMC_ARB_CFG_BURST_MODE_SHIFT)
   ...
   uint32_t unused12[48];              /* 0x400-0x4bf */
   ...
   uint32_t unused16[2];               /* 0xa88 - 0xa8f */
   ...
   uint32_t unused17[2];               /* 0xaa8 - 0xaaf */
   ...
   uint32_t unused27[58];              /* 0xe18-0xeff */
   ...
   uint32_t unused28[567];            /* 0xf24-0x17ff */

   SecureRangeCheckers SEC_RANGE_CHK; /* 0x1800-0x18ff */
   uint32_t unused29[31168];            /* 0x1900-0x200000 */
