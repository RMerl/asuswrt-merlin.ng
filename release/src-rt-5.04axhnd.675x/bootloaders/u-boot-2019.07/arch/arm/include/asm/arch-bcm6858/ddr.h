...
#define UBUSIF_CFG_OOB_ERR_MASK_MASK        (0x1<< UBUSIF_CFG_OOB_ERR_MASK_SHIFT)
	uint32_t SRC_QUEUE_CTRL[4];	/* 0x08 - 0x14 */
...
#define UBUSIF_REP_ARB_MODE_FIFO_MODE_MASK  (0x1<<UBUSIF_REP_ARB_MODE_FIFO_MODE_SHIFT)
	...
	uint32_t DEBUG_R0;	/* 0x20 */
	uint32_t unused[7];	/* 0x24-0x3f */
} UBUSInterface;

typedef struct AXIInterface {
	uint32_t CFG;		/* 0x00 */
	uint32_t REP_ARB_MODE;	/* 0x04 */
	uint32_t SCRATCH;	/* 0x08 */
...
#define MEMC_ARB_CFG_BURST_MODE_MASK    (0x1<<MEMC_ARB_CFG_BURST_MODE_SHIFT)
	...
	uint32_t unused12[16];	/* 0x440-0x47f */

	uint32_t unused12a[16];	/* 0x480-0x4bf */
	AXIInterface AXIWIF;	/* 0x4c0-0x4ff */

	uint32_t unused13[192];	/* 0x500-0x7ff */

	EDISEngine EDIS_0;	/* 0x800 */
	uint32_t unused13a[64];	/* 0x900 */
...
#define MEMC_STATS_FILTER_CFG_INTF_EDIS1       MEMC_STATS_FILTER_CFG_INTF_UNUSED
	...
	uint32_t unused15[2];	/* 0xa88 - 0xa8f */
	...
	uint32_t unused16[2];	/* 0xaa8 - 0xaaf */
	...
	uint32_t unused24[58];	/* 0xe18-0xeff */

	uint32_t UBUSIF0_PERMCTL;	/* 0xf00 */
	uint32_t UBUSIF0_ACCCTL;	/* 0xf04 */
	uint32_t UBUSIF1_PERMCTL;	/* 0xf08 */
	uint32_t UBUSIF1_ACCCTL;	/* 0xf0c */
	uint32_t AXIRIF_PERMCTL;	/* 0xf10 */
	uint32_t AXIRIF_ACCCTL;	/* 0xf14 */
	uint32_t AXIWIF_PERMCTL;	/* 0xf18 */
	uint32_t AXIWIF_ACCCTL;	/* 0xf1c */
	uint32_t CHNCFG_PERMCTL;	/* 0xf20 */
	uint32_t CHNCFG_ACCCTL;	/* 0xf24 */
	uint32_t MCCAP_PERMCTL;	/* 0xf28 */
	uint32_t MCCAP_ACCCTL;	/* 0xf2c */
	uint32_t SCRAM_PERMCTL;	/* 0xf30 */
	uint32_t SCRAM_ACCCTL;	/* 0xf34 */
	uint32_t RNG_PERMCTL;	/* 0xf38 */
	uint32_t RNG_ACCCTL;	/* 0xf3c */
	uint32_t RNGCHK_PERMCTL;	/* 0xf40 */
	uint32_t RNGCHK_ACCCTL;	/* 0xf44 */
	uint32_t unused25[558];	/* 0xf48-0x17ff */

	SecureRangeCheckers SEC_RANGE_CHK;	/* 0x1800-0x18ff */
	uint32_t unused26[31168];	/* 0x1900-0x1ffff */
