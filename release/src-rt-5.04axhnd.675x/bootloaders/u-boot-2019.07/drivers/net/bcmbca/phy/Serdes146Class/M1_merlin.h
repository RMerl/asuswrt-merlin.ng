...
// in uboot strings are packed so least 2 bits of pointer can be non-zero
// move mask from lsb 2 bits to bit 32,33
enum {SEQ_TYPE_REG, SEQ_TYPE_FUN=1UL<<32, SEQ_TYPE_NEST_SEQ=2UL<<32, SEQ_TYPE_MASK=3UL<<32};
