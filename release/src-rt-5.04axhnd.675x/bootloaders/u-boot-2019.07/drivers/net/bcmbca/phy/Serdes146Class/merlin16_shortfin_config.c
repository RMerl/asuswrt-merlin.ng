...
void merlin_reg_prog(prog_seq_tbl *prog_seq_tbl_ptr, uint32 CoreNum, uint32 PortNum)
{
    ...
    log_level = 0;
//printk("@@@@ %s(): line %d  BEGIN\n", __FUNCTION__, __LINE__);
    for(;(SEQ_TYPE_GET(prog_seq_tbl_ptr->reg_desc) != SEQ_TYPE_REG) || strcmp(prog_seq_tbl_ptr->reg_desc, ""); prog_seq_tbl_ptr++) {
//printk("@@@@ %s(): line %d ptr = %lx  seq_type_get=%x\n", __FUNCTION__, __LINE__,prog_seq_tbl_ptr->reg_desc, SEQ_TYPE_GET(prog_seq_tbl_ptr->reg_desc));
...
//printk("@@@@ %s(): line %d  SEQ_TYPE_NEST_SEQ\n", __FUNCTION__, __LINE__);
            merlin_reg_prog(SEQ_TYPE_NSEQ_GET(prog_seq_tbl_ptr->reg_desc), CoreNum, PortNum);
            continue;
        }

//printk("@@@@ %s(): line %d [%s]\n", __FUNCTION__, __LINE__, prog_seq_tbl_ptr->reg_desc);
