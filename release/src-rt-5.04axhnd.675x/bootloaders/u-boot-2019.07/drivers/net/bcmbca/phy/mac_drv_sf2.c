...
#define MDIO_RD(addr,reg,val) mdio_read_c22_register(MDIO_SF2, addr, reg, val)
#define MDIO_WR(addr,reg,val) mdio_write_c22_register(MDIO_SF2, addr, reg, val)
...
static int port_sf2mac_cfg_set(mac_dev_t *mac_dev, mac_cfg_t *mac_cfg)
{
    ...
    case MAC_SPEED_10:      v8 |= REG_PORT_STATE_LNK; break;
    case MAC_SPEED_100:     v8 |= REG_PORT_STATE_LNK | REG_PORT_STATE_100; break;
    case MAC_SPEED_1000:    v8 |= REG_PORT_STATE_LNK | REG_PORT_STATE_1000; break;
#if defined(CONFIG_BCM96756)
    case MAC_SPEED_2500:    v8 |= REG_PORT_STATE_LNK | REG_PORT_STATE_2500; break;
    case MAC_SPEED_5000:    v8 |= REG_PORT_STATE_LNK | REG_PORT_STATE_5000; break;
    case MAC_SPEED_10000:   v8 |= REG_PORT_STATE_LNK | REG_PORT_STATE_10000; break;
#else
    case MAC_SPEED_2500:    v8 |= REG_PORT_STATE_LNK | REG_PORT_STATE_1000 | REG_PORT_GMII_SPEED_UP_2G; break;
#endif
    }
