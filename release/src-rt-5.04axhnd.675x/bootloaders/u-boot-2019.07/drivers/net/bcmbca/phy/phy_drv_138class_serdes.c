...
static phy_serdes_t serdes_138class[], serdes_138class_extsw[];
int phy_drv_serdes_138class_init_lock(phy_dev_t *phy_dev)
{
    uint16_t v16;
    ...
    if (PhyIsPortConnectedToExternalSwitch(phy_dev))
    {
        ...
        phy_serdes = phy_dev->priv = serdes_138class_extsw;
    }
...
static phy_serdes_t serdes_138class_extsw[] =
{
    {
        .phy_type = PHY_TYPE_138CLASS_SERDES,
#if defined(CONFIG_BP_PHYS_INTF)
        ...
        .inter_phy_types = INTER_PHY_TYPE_2500BASE_X_M,
        .link_stats = dsl_2p5g_serdes_link_stats,
