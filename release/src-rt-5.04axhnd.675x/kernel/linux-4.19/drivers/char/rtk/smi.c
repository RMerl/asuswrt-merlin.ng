...
#define MDC_MDIO_WRITE(preamableLength, phyID, regID, data) mdio_write_c22_register(MDIO_SF2, phyID, regID, data)
...
{
     mdio_read_c22_register(MDIO_SF2, phyID, regID,(uint16_t*) pData);
     *pData = *pData & 0x0ffff;
}
