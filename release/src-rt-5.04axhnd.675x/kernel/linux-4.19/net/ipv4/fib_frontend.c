			...
			struct in_device *idev, u32 *itag)
{
	...
	/* Ignore rp_filter for packets translated by MAP-T/MAP-E too. */
	int r = secpath_exists(skb) ? 0 : (skbuff_bcm_ext_map_get(skb, map_forward) != MAP_FORWARD_NONE ? 0 : IN_DEV_RPFILTER(idev));
#else
