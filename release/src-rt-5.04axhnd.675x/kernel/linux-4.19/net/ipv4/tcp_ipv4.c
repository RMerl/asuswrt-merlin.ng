...
#if defined(CONFIG_BCM_KF_BLOG) && defined(CONFIG_BLOG_LOCALIN_TCP)
extern int bcm_tcp_v4_blog_emit(struct sk_buff *skb, struct sock *sk);
#endif
/*
 *	From tcp_input.c
 */
...
#if defined(CONFIG_BCM_KF_BLOG) && defined(CONFIG_BLOG_LOCALIN_TCP)
		/*learn local terminated tcp traffic */
		bcm_tcp_v4_blog_emit(skb, sk);
#endif
