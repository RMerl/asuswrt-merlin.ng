...
/* Memory Barrier */
/******************/
#if !defined(RDP_SIM) && (defined(LINUX_KERNEL) || defined(__KERNEL__)) && !defined(__UBOOT__)
...
#endif /* defined(_CFE_) || defined(RDP_SIM) || defined(__UBOOT__) */
#else /* XRDP_EMULATION */
