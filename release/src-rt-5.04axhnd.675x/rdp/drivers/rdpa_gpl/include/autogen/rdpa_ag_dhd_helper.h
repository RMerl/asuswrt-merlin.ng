...
typedef enum {
    ...
    rdpa_dhd_helper_attr_int_coalescing_amount = 18, /* int_coalescing_amount : RW : number : Amount of interrupt to coalesce (0 - disable) */
    rdpa_dhd_helper_attr_int_coalescing_timeout = 19, /* int_coalescing_timeout : RW : number : Coalescing timeout in msec */
    rdpa_dhd_helper_attr_codel_enable = 20, /* codel_enable : RW : bool : CoDel management switch */
