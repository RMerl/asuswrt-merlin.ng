...
typedef enum
{
    ...
    rdpa_cpu_rx_reason_mcast_fwd_and_trap  = 23, /**< Multicast forward-and-trap (either forward and trap, TTL expiry, MTU exceed, etc.) \XRDP_LIMITED */
    rdpa_cpu_rx_reason_mcast_exception     = 24, /**< Multicast forwarding exception, packet was not forwarded to any port (TTL expiry, MTU exceed, etc.) */
...
#ifdef XRDP
    rdpa_cpu_rx_reason_reserved0           = 38, /**< For future use \XRDP_LIMITED*/
...
typedef struct
{
    ...
    union{
        ...
        struct {
            ...
            uint8_t fpm_forced:1; /**< Debug flag to forced FPM */ 
            uint8_t reserved:5;
            } bits;
         uint8_t flags; 
    };
