...
#if defined(XRDP) || defined(BCM_XRDP)
    RDPA_IC_MASK_GENERIC_3       = (1 << RDPA_IC_GENERIC_3),       /**< Generic key 3 (type L2/L3/L4, offset, mask */
    RDPA_IC_MASK_GENERIC_4       = (1 << RDPA_IC_GENERIC_4),       /**< Generic key 4 (type L2/L3/L4, offset, mask */
#endif
...
#if defined(XRDP) || defined(BCM_XRDP)
    RDPA_IC_MASK_OUTER_CFI      = (1 << RDPA_IC_OUTER_CFI),        /**< Outer CFI */
    RDPA_IC_MASK_INNER_CFI      = (1 << RDPA_IC_INNER_CFI),        /**< Inner CFI */
#endif
} rdpa_ic_fields;
