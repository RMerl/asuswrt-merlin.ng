...
#if (defined(BCM4912) || defined(BCM6813)) && !defined(BCM4912_A0)
    rdpa_if_lan8,           /**< LAN8 port */
    rdpa_if_lan9,           /**< LAN9 port */
    rdpa_if_lan10,           /**< LAN10 port */
    rdpa_if_lan_max = rdpa_if_lan10,
#else
...
#elif defined(WL4908) || defined(CHIP_4908) || defined(BCM4912) || defined(CHIP_4912) || defined(BCM6813)
   switch (__wan) {
      case rdpa_wan_gbe       :
         return (rdpa_if_wan0);
      default                 :
...
#else /* PON Platforms */
   /* TBD_6813 */ /* Determine if 6813 needs its own section here? */
   switch (__wan) {
      case rdpa_wan_gpon      :
      case rdpa_wan_xgpon     :
      case rdpa_wan_epon      :
...
#if defined(BCM4912) && !defined(BCM4912_A0)
#define RDPA_PORT_ALL_LAN_MACS \
    (rdpa_if_id(rdpa_if_lan0) | rdpa_if_id(rdpa_if_lan1) | rdpa_if_id(rdpa_if_lan2) | \
     rdpa_if_id(rdpa_if_lan3) | rdpa_if_id(rdpa_if_lan4) | rdpa_if_id(rdpa_if_lan5) | \
     rdpa_if_id(rdpa_if_lan6) | rdpa_if_id(rdpa_if_lan7) | rdpa_if_id(rdpa_if_lan8) | \
     rdpa_if_id(rdpa_if_lan9) | rdpa_if_id(rdpa_if_lan10))
#else
#define RDPA_PORT_ALL_LAN_MACS \
    (rdpa_if_id(rdpa_if_lan0) | rdpa_if_id(rdpa_if_lan1) | rdpa_if_id(rdpa_if_lan2) | \
     rdpa_if_id(rdpa_if_lan3) | rdpa_if_id(rdpa_if_lan4) | rdpa_if_id(rdpa_if_lan5) | \
