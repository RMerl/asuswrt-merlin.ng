...
#define DS_VLAN_CMDS_NUM (rdpa_if_wlan2 - rdpa_if_lan0 + 1)
#else
#define DS_VLAN_CMDS_NUM (rdpa_if_cpu_last - rdpa_if_lan0 + 1)
#endif
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            uint8_t ds_vlan_command[DS_VLAN_CMDS_NUM];
            uint8_t ds_vlan_command_flow_default;
            bdmf_boolean ds_vlan_command_per_port_set[DS_VLAN_CMDS_NUM];
        };
    } vlan_command_id;
