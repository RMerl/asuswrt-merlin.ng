...
int rdd_ag_service_queues_codel_drop_descriptor_get(rdd_codel_drop_descriptor_t *codel_drop_descriptor)
{
    ...
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_PACKET_COUNTER_READ_G(codel_drop_descriptor->flush_packet_counter, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0);
...
int rdd_ag_service_queues_codel_drop_descriptor_set(rdd_codel_drop_descriptor_t *codel_drop_descriptor)
{
    ...
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_PACKET_COUNTER_WRITE_G(codel_drop_descriptor->flush_packet_counter, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0);
...
{
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_PACKET_COUNTER_WRITE_G(flush_packet_counter, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0);
...
{
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_PACKET_COUNTER_READ_G(*flush_packet_counter, RDD_SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0);
