...
/** val_to_s function prototype type.
*/

typedef int (*F_val_to_s_t)(struct bdmf_object *mo, struct bdmf_attr *ad, const void *val, char *sbuf, uint32_t size);
typedef int (*F_s_to_val_t)(struct bdmf_object *mo, struct bdmf_attr *ad, const char *sbuf, void *index, uint32_t size);
...
struct bdmf_attr
{
     ...
     */
    F_s_to_val_t s_to_val;

    /** Optional callback that converts value from internal to string format.
     * returns 0 on success or error code <0
     */
    F_val_to_s_t val_to_s;

    /** This callback supposed to server bdmf history when defailt val_to_s is re-defined.
     * returns 0 on success or error code <0
     */
    F_val_to_s_t hist_val_to_s;
     ...
     * returns 0 on success or error code <0
     */
    F_s_to_val_t s_to_index;

    /** Optional callback that converts index from internal to string format.
     * returns 0 on success or error code <0
     */
    F_val_to_s_t index_to_s;

    /** This callback used for history that converts index from internal to string format.
     * returns 0 on success or error code <0
     */
    F_val_to_s_t hist_index_to_s;
...
#define BDMF_ATTR_CLASS_STAT    0x00002000  /**< Attribute class: Statistics */
#define BDMF_ATTR_STAT          0x00006000  /**< Attribute class: Statistics (implicitly unsigned) */
...
#define BDMF_DRV_FLAG_NOLOCK_ON_CREATE 0x00000008 /**< Don't lock object on creation. */
    /* access flags */
