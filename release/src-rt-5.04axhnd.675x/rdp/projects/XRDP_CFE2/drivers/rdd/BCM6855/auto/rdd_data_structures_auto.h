...
#define RDD_AGGREGATED_PD_DESCRIPTOR_TOTAL_PLEN_READ_G(r, g, idx)                            GROUP_FIELD_MREAD_16((g), (idx)*sizeof(AGGREGATED_PD_DESCRIPTOR_STRUCT) + 12, 3, 9, (r))
#define RDD_AGGREGATED_PD_DESCRIPTOR_TOTAL_PLEN_WRITE_G(v, g, idx)                           GROUP_FIELD_MWRITE_16((g), (idx)*sizeof(AGGREGATED_PD_DESCRIPTOR_STRUCT) + 12, 3, 9, (v))
#define RDD_AGGREGATED_PD_DESCRIPTOR_TOTAL_PLEN_READ(r, p)                                   FIELD_MREAD_16((uint8_t *)(p) + 12, 3, 9, (r))
#define RDD_AGGREGATED_PD_DESCRIPTOR_TOTAL_PLEN_WRITE(v, p)                                  FIELD_MWRITE_16((uint8_t *)(p) + 12, 3, 9, (v))
#define RDD_AGGREGATED_PD_DESCRIPTOR_TOTAL_PLEN_L_READ( wv )                                 FIELD_GET( wv, 19, 9 )
#define RDD_AGGREGATED_PD_DESCRIPTOR_TOTAL_PLEN_L_WRITE( v, wv )                             FIELD_SET( v, 19, 9, wv )
#define RDD_AGGREGATED_PD_DESCRIPTOR_BUFFER_NUMBER_0_READ_G(r, g, idx)                       GROUP_FIELD_MREAD_32((g), (idx)*sizeof(AGGREGATED_PD_DESCRIPTOR_STRUCT) + 12, 0, 19, (r))
#define RDD_AGGREGATED_PD_DESCRIPTOR_BUFFER_NUMBER_0_WRITE_G(v, g, idx)                      GROUP_FIELD_MWRITE_32((g), (idx)*sizeof(AGGREGATED_PD_DESCRIPTOR_STRUCT) + 12, 0, 19, (v))
#define RDD_AGGREGATED_PD_DESCRIPTOR_BUFFER_NUMBER_0_READ(r, p)                              FIELD_MREAD_32((uint8_t *)(p) + 12, 0, 19, (r))
#define RDD_AGGREGATED_PD_DESCRIPTOR_BUFFER_NUMBER_0_WRITE(v, p)                             FIELD_MWRITE_32((uint8_t *)(p) + 12, 0, 19, (v))
#define RDD_AGGREGATED_PD_DESCRIPTOR_BUFFER_NUMBER_0_L_READ( wv )                            FIELD_GET( wv, 0, 19 )
#define RDD_AGGREGATED_PD_DESCRIPTOR_BUFFER_NUMBER_0_L_WRITE( v, wv )                        FIELD_SET( v, 0, 19, wv )
#define RDD_AGGREGATED_PD_DESCRIPTOR_FPM_READ_G(r, g, idx)                                   GROUP_FIELD_MREAD_32((g), (idx)*sizeof(AGGREGATED_PD_DESCRIPTOR_STRUCT) + 12, 0, 19, (r))
#define RDD_AGGREGATED_PD_DESCRIPTOR_FPM_WRITE_G(v, g, idx)                                  GROUP_FIELD_MWRITE_32((g), (idx)*sizeof(AGGREGATED_PD_DESCRIPTOR_STRUCT) + 12, 0, 19, (v))
#define RDD_AGGREGATED_PD_DESCRIPTOR_FPM_READ(r, p)                                          FIELD_MREAD_32((uint8_t *)(p) + 12, 0, 19, (r))
#define RDD_AGGREGATED_PD_DESCRIPTOR_FPM_WRITE(v, p)                                         FIELD_MWRITE_32((uint8_t *)(p) + 12, 0, 19, (v))
#define RDD_AGGREGATED_PD_DESCRIPTOR_FPM_L_READ( wv )                                        FIELD_GET( wv, 0, 19 )
#define RDD_AGGREGATED_PD_DESCRIPTOR_FPM_L_WRITE( v, wv )                                    FIELD_SET( v, 0, 19, wv )
#define RDD_AGGREGATED_PD_DESCRIPTOR_SBPM_READ_G(r, g, idx)                                  GROUP_FIELD_MREAD_32((g), (idx)*sizeof(AGGREGATED_PD_DESCRIPTOR_STRUCT) + 12, 0, 19, (r))
#define RDD_AGGREGATED_PD_DESCRIPTOR_SBPM_WRITE_G(v, g, idx)                                 GROUP_FIELD_MWRITE_32((g), (idx)*sizeof(AGGREGATED_PD_DESCRIPTOR_STRUCT) + 12, 0, 19, (v))
#define RDD_AGGREGATED_PD_DESCRIPTOR_SBPM_READ(r, p)                                         FIELD_MREAD_32((uint8_t *)(p) + 12, 0, 19, (r))
#define RDD_AGGREGATED_PD_DESCRIPTOR_SBPM_WRITE(v, p)                                        FIELD_MWRITE_32((uint8_t *)(p) + 12, 0, 19, (v))
#define RDD_AGGREGATED_PD_DESCRIPTOR_SBPM_L_READ( wv )                                       FIELD_GET( wv, 0, 19 )
#define RDD_AGGREGATED_PD_DESCRIPTOR_SBPM_L_WRITE( v, wv )                                   FIELD_SET( v, 0, 19, wv )
/* <<<AGGREGATED_PD_DESCRIPTOR_STRUCT */
...
#define RDD_NATC_COMMAND_DATA_L2_PARSER_L2_LKP_ENTRY_RESERVED1_READ_G(r, g, idx)               GROUP_FIELD_MREAD_16((g), (idx)*sizeof(NATC_COMMAND_DATA_L2_STRUCT) + 18, 4, 9, (r))
#define RDD_NATC_COMMAND_DATA_L2_PARSER_L2_LKP_ENTRY_RESERVED1_WRITE_G(v, g, idx)              GROUP_FIELD_MWRITE_16((g), (idx)*sizeof(NATC_COMMAND_DATA_L2_STRUCT) + 18, 4, 9, (v))
#define RDD_NATC_COMMAND_DATA_L2_PARSER_L2_LKP_ENTRY_RESERVED1_READ(r, p)                      FIELD_MREAD_16((uint8_t *)(p) + 18, 4, 9, (r))
#define RDD_NATC_COMMAND_DATA_L2_PARSER_L2_LKP_ENTRY_RESERVED1_WRITE(v, p)                     FIELD_MWRITE_16((uint8_t *)(p) + 18, 4, 9, (v))
...
#define RDD_PARSER_RESULTS_PARSER_L2_LKP_ENTRY_RESERVED1_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_16((g), (idx)*sizeof(PARSER_RESULTS_STRUCT) + 42, 4, 9, (r))
#define RDD_PARSER_RESULTS_PARSER_L2_LKP_ENTRY_RESERVED1_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_16((g), (idx)*sizeof(PARSER_RESULTS_STRUCT) + 42, 4, 9, (v))
#define RDD_PARSER_RESULTS_PARSER_L2_LKP_ENTRY_RESERVED1_READ(r, p)                            FIELD_MREAD_16((uint8_t *)(p) + 42, 4, 9, (r))
#define RDD_PARSER_RESULTS_PARSER_L2_LKP_ENTRY_RESERVED1_WRITE(v, p)                           FIELD_MWRITE_16((uint8_t *)(p) + 42, 4, 9, (v))
