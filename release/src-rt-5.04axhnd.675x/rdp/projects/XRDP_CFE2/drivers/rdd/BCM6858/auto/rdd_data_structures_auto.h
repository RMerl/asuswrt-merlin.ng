...
#define RDD_BBH_TX_DESCRIPTOR_BN_NUM_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 4, 14, 7, (r))
#define RDD_BBH_TX_DESCRIPTOR_BN_NUM_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 4, 14, 7, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_INGRESS_PORT_READ_G(r, g, idx)            GROUP_FIELD_MREAD_16((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 8, 2, 8, (r))
#define RDD_BBH_TX_DESCRIPTOR_INGRESS_PORT_WRITE_G(v, g, idx)           GROUP_FIELD_MWRITE_16((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 8, 2, 8, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_FLOW_READ_G(r, g, idx)                    GROUP_FIELD_MREAD_16((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 8, 2, 8, (r))
#define RDD_BBH_TX_DESCRIPTOR_FLOW_WRITE_G(v, g, idx)                   GROUP_FIELD_MWRITE_16((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 8, 2, 8, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_SOURCE_PORT_READ_G(r, g, idx)             GROUP_FIELD_MREAD_16((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 8, 2, 8, (r))
#define RDD_BBH_TX_DESCRIPTOR_SOURCE_PORT_WRITE_G(v, g, idx)            GROUP_FIELD_MWRITE_16((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 8, 2, 8, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_BUFFER_NUMBER_1_OR_ABS_2_READ_G(r, g, idx)GROUP_FIELD_MREAD_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 8, 0, 18, (r))
#define RDD_BBH_TX_DESCRIPTOR_BUFFER_NUMBER_1_OR_ABS_2_WRITE_G(v, g, idx)GROUP_FIELD_MWRITE_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 8, 0, 18, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_BN1_FIRST_READ_G(r, g, idx)               GROUP_FIELD_MREAD_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 8, 0, 18, (r))
#define RDD_BBH_TX_DESCRIPTOR_BN1_FIRST_WRITE_G(v, g, idx)              GROUP_FIELD_MWRITE_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 8, 0, 18, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_ABS3_READ_G(r, g, idx)                    GROUP_FIELD_MREAD_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 8, 0, 18, (r))
#define RDD_BBH_TX_DESCRIPTOR_ABS3_WRITE_G(v, g, idx)                   GROUP_FIELD_MWRITE_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 8, 0, 18, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_ABS_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 5, 1, (r))
#define RDD_BBH_TX_DESCRIPTOR_ABS_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 5, 1, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_PAYLOAD_OFFSET_OR_ABS_1_READ_G(r, g, idx) GROUP_FIELD_MREAD_16((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 2, 11, (r))
#define RDD_BBH_TX_DESCRIPTOR_PAYLOAD_OFFSET_OR_ABS_1_WRITE_G(v, g, idx)GROUP_FIELD_MWRITE_16((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 2, 11, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_SOP_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_16((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 2, 11, (r))
#define RDD_BBH_TX_DESCRIPTOR_SOP_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_16((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 2, 11, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_ABS1_READ_G(r, g, idx)                    GROUP_FIELD_MREAD_16((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 2, 11, (r))
#define RDD_BBH_TX_DESCRIPTOR_ABS1_WRITE_G(v, g, idx)                   GROUP_FIELD_MWRITE_16((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 2, 11, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_BUFFER_NUMBER_0_OR_ABS_0_READ_G(r, g, idx)GROUP_FIELD_MREAD_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 0, 18, (r))
#define RDD_BBH_TX_DESCRIPTOR_BUFFER_NUMBER_0_OR_ABS_0_WRITE_G(v, g, idx)GROUP_FIELD_MWRITE_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 0, 18, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_BN0_FIRST_READ_G(r, g, idx)               GROUP_FIELD_MREAD_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 0, 18, (r))
#define RDD_BBH_TX_DESCRIPTOR_BN0_FIRST_WRITE_G(v, g, idx)              GROUP_FIELD_MWRITE_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 0, 18, (v))
...
#define RDD_BBH_TX_DESCRIPTOR_ABS0_READ_G(r, g, idx)                    GROUP_FIELD_MREAD_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 0, 18, (r))
#define RDD_BBH_TX_DESCRIPTOR_ABS0_WRITE_G(v, g, idx)                   GROUP_FIELD_MWRITE_32((g), (idx)*sizeof(BBH_TX_DESCRIPTOR_STRUCT) + 12, 0, 18, (v))
...
#define RDD_PROCESSING_RX_DESCRIPTOR_CPU_TX_READ_G(r, g, idx)                      GROUP_FIELD_MREAD_8((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 4, 1, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_CPU_TX_WRITE_G(v, g, idx)                     GROUP_FIELD_MWRITE_8((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 4, 1, (v))
...
#define RDD_PROCESSING_TX_DESCRIPTOR_MCST_BCST_UNION_READ_G(r, g, idx)         GROUP_FIELD_MREAD_8((g), (idx)*sizeof(PROCESSING_TX_DESCRIPTOR_STRUCT) + 8, 4, 2, (r))
#define RDD_PROCESSING_TX_DESCRIPTOR_MCST_BCST_UNION_WRITE_G(v, g, idx)        GROUP_FIELD_MWRITE_8((g), (idx)*sizeof(PROCESSING_TX_DESCRIPTOR_STRUCT) + 8, 4, 2, (v))
...
#define RDD_CPU_RX_DESCRIPTOR_METADATA_0_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_8((g), (idx)*sizeof(CPU_RX_DESCRIPTOR_STRUCT) + 14, 2, 4, (r))
#define RDD_CPU_RX_DESCRIPTOR_METADATA_0_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_8((g), (idx)*sizeof(CPU_RX_DESCRIPTOR_STRUCT) + 14, 2, 4, (v))
...
#define RDD_CPU_RX_DESCRIPTOR_METADATA_1_READ_G(r, g, idx)                        GROUP_FIELD_MREAD_16((g), (idx)*sizeof(CPU_RX_DESCRIPTOR_STRUCT) + 14, 0, 10, (r))
#define RDD_CPU_RX_DESCRIPTOR_METADATA_1_WRITE_G(v, g, idx)                       GROUP_FIELD_MWRITE_16((g), (idx)*sizeof(CPU_RX_DESCRIPTOR_STRUCT) + 14, 0, 10, (v))
...
#define RDD_ACB_CONTROL_IMP_PORT_READ_G(r, g, idx)                 GROUP_FIELD_MREAD_8((g), (idx)*sizeof(ACB_CONTROL_STRUCT), 6, 2, (r))
#define RDD_ACB_CONTROL_IMP_PORT_WRITE_G(v, g, idx)                GROUP_FIELD_MWRITE_8((g), (idx)*sizeof(ACB_CONTROL_STRUCT), 6, 2, (v))
...
#define RDD_ACB_CONTROL_EGRESS_PORT_READ_G(r, g, idx)              GROUP_FIELD_MREAD_8((g), (idx)*sizeof(ACB_CONTROL_STRUCT), 3, 3, (r))
#define RDD_ACB_CONTROL_EGRESS_PORT_WRITE_G(v, g, idx)             GROUP_FIELD_MWRITE_8((g), (idx)*sizeof(ACB_CONTROL_STRUCT), 3, 3, (v))
...
#define RDD_ACB_CONTROL_EGRESS_QUEUE_ID_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8((g), (idx)*sizeof(ACB_CONTROL_STRUCT), 0, 3, (r))
#define RDD_ACB_CONTROL_EGRESS_QUEUE_ID_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8((g), (idx)*sizeof(ACB_CONTROL_STRUCT), 0, 3, (v))
