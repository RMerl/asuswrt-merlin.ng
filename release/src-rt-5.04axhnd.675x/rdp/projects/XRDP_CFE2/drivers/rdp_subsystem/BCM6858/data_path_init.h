...
#define FPM_XON_THRESHOLD                   (4*1024)
#define FPM_XOFF_THRESHOLD                  (FPM_XON_THRESHOLD + 64)
...
/* DQM cannot host exactly 16K PDs, b/c some of the space is usef for it's internal logic ('next-pointers').
