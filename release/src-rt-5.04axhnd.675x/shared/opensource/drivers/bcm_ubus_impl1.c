...
ub_mst_addr_map_t ub_mst_addr_map_tbl[] =
{
    ...
    {UBUS_PORT_ID_DSLCPU,    MST_PORT_NODE_DSLCPU_PHYS_BASE},
    {UBUS_PORT_ID_PCIE0,     MST_PORT_NODE_PCIE0_PHYS_BASE},
    {UBUS_PORT_ID_PCIE1,     MST_PORT_NODE_PCIE1_PHYS_BASE},
    {UBUS_PORT_ID_PCIE2,     MST_PORT_NODE_PCIE2_PHYS_BASE},
    {UBUS_PORT_ID_DMA0,      MST_PORT_NODE_DMA0_PHYS_BASE},
    {UBUS_PORT_ID_DMA1,      MST_PORT_NODE_DMA1_PHYS_BASE},
    {UBUS_PORT_ID_RQ0,       MST_PORT_NODE_RQ0_PHYS_BASE},
    ...
    {UBUS_PORT_ID_MPM,       MST_PORT_NODE_MPM_PHYS_BASE},
#endif
...
static int ubus_master_decode_wnd_cfg(int master_port_id, int win, phys_addr_t phys_addr, unsigned int size_power_of_2, int port_id, unsigned int cache_bit_en)
{
    ...
    if(master_addr)
    {
#if IS_BCMCHIP(63158) || IS_BCMCHIP(63178) || IS_BCMCHIP(47622) || IS_BCMCHIP(63146) || IS_BCMCHIP(6756) || IS_BCMCHIP(6855)
...
#if !IS_BCMCHIP(63158) && !IS_BCMCHIP(63178) && !IS_BCMCHIP(47622) && !IS_BCMCHIP(63146) && !IS_BCMCHIP(4912) && !IS_BCMCHIP(6813) && !IS_BCMCHIP(6756)
...
static int ubus_tokens_show(struct seq_file *m, void *v)
{
    ...
    seq_printf(m, "%9s | %s", " ", enum_val_to_str(ub_mst_addr_map_tbl[0].port_id, ubus_port_id_to_str));
    while (ub_mst_addr_map_tbl[i].port_id != -1)
        seq_printf(m, " | %s", enum_val_to_str(ub_mst_addr_map_tbl[i++].port_id, ubus_port_id_to_str));
...
#endif
#if IS_BCMCHIP(6858) || IS_BCMCHIP(6856) || IS_BCMCHIP(6846) || IS_BCMCHIP(6855) || IS_BCMCHIP(63158)
