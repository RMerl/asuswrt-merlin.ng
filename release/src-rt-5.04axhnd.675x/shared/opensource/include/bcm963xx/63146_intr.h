...
#ifndef __63146_INTR_H
#define __63146_INTR_H
...
/*  ------------- CHIP_IRQS[95-64] ----------------------------*/
#define INTERRUPT_VDSL                    (SPI_TABLE_OFFSET + 67)
#define INTERRUPT_SARC                    (SPI_TABLE_OFFSET + 68)
#define INTERRUPT_PCIE_0_CPU_INTR         (SPI_TABLE_OFFSET + 69)
#define INTERRUPT_PCIE_1_CPU_INTR         (SPI_TABLE_OFFSET + 70)
#define INTERRUPT_PCIE_2_CPU_INTR         (SPI_TABLE_OFFSET + 71)
