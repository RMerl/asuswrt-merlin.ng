...
#define INTERRUPT_WDTIMER0 INTERRUPT_PER_TIMER_IRQ5
#define INTERRUPT_WDTIMER1 INTERRUPT_PER_TIMER_IRQ4
...
/*  ------------- CHIP_IRQS[127-96] ----------------------------*/
#define INTERRUPT_WAN_TOP                 (SPI_TABLE_OFFSET + 96)
...
/*  ------------- CHIP_IRQS[191-160] ----------------------------*/
#if defined(CONFIG_BCM963158) && (CONFIG_BRCM_CHIP_REV != 0x63158A0)
#define INTERRUPT_WAN_XGTX_INTR0          (SPI_TABLE_OFFSET + 160)
#define INTERRUPT_WAN_XGTX_INTR1          (SPI_TABLE_OFFSET + 161)
#define INTERRUPT_WAN_XGTX_INTR2          (SPI_TABLE_OFFSET + 162)
#define INTERRUPT_WAN_XGTX_INTR3          (SPI_TABLE_OFFSET + 163)
#define INTERRUPT_WAN_XGRX                (SPI_TABLE_OFFSET + 164)
#define INTERRUPT_WAN_EPON_TOP            (SPI_TABLE_OFFSET + 165)
#endif
...
#define INTERRUPT_ID_PMC                  (bcm_legacy_irq_map[INTERRUPT_PMC_MIPS_IRQ - SPI_TABLE_OFFSET])
...
#define INTERRUPT_ID_WAN_XGTX_INTR2       (bcm_legacy_irq_map[INTERRUPT_WAN_XGTX_INTR2 - SPI_TABLE_OFFSET])
#define INTERRUPT_ID_WAN_XGTX_INTR3       (bcm_legacy_irq_map[INTERRUPT_WAN_XGTX_INTR3 - SPI_TABLE_OFFSET])
