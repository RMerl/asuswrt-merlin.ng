...
#ifndef __6756_INTR_H
#define __6756_INTR_H
#ifdef __cplusplus
    extern "C" {
#endif
...
/*sysport 54:59*/
#define INTERRUPT_SYSPORT0          (SPI_TABLE_OFFSET + 54)
#define INTERRUPT_SYSPORT1          (SPI_TABLE_OFFSET + 55)
#define INTERRUPT_SYSPORT2          (SPI_TABLE_OFFSET + 56)
#define INTERRUPT_SYSPORT3          (SPI_TABLE_OFFSET + 57)
#define INTERRUPT_SYSPORT4          (SPI_TABLE_OFFSET + 58)
#define INTERRUPT_SYSPORT5          (SPI_TABLE_OFFSET + 59)
