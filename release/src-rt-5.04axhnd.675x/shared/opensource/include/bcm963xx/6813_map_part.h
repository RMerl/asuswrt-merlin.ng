...
#define CHIP_FAMILY_ID_HEX 0x4912
...
#define LED_OFFSET            0x3000   /* led registers */
...
#define PCIE0_PHYS_BASE       0x80080000
#define PCIE0_SIZE            0x0000A000
#define PCIE1_PHYS_BASE       0x80090000
#define PCIE1_SIZE            0x0000A000
#define PCIE2_PHYS_BASE       0x800A0000
#define PCIE2_SIZE            0x0000A000
#define PCIE3_PHYS_BASE       0x800B0000
...
#define PCIE3_MEM_PHYS_BASE   0xa0000000
#define PCIE3_MEM_SIZE        0x20000000
...
#define ETH_PHYS_SERDES_0_CORE_OFFSET  0            // These three to be confirm; for compilation only now
...
#define USBH_PHYS_BASE        0x800C0000
...
#define WANBBH_PHYS_BASE      0x82890000
#define WANBBH_SIZE           0xac00
...
#define CRYPTO_PHYS_BASE     0x83800000
#define CRYPTO_SIZE          0x450000
...
#define XLIF_PHYS_BASE      0x828b2000
#define XLIF_OFFSET         0x000000
#define XLIF_SIZE           0x001000
...
#define MST_PORT_NODE_SPU_SIZE              0x4000
...
#define MST_PORT_NODE_PCIE3_SIZE            0x4000
...
#define MST_PORT_NODE_DMA2_SIZE             0x4000
...
#define MST_PORT_NODE_RQ1_SIZE              0x4000
...
#define CAPTURE_PORT_NODE_0_PHYS_BASE       0x83090000
#define CAPTURE_PORT_NODE_0_SIZE            0x0400 
#define CAPTURE_PORT_NODE_1_PHYS_BASE       0x83094000
...
BCM_IO_BLOCKS bcm_io_blocks[] = 
{
    ...
    {MST_PORT_NODE_DMA2_IDX, MST_PORT_NODE_DMA2_SIZE, MST_PORT_NODE_DMA2_PHYS_BASE},    
...
typedef struct MEMCControl {
	...
	uint8 to_be_refined1[0x20000-0xe18];	/* 0xe18 - 0x1ffff */
...
#define ETHSW_QPHY_CTRL_IDDQ_GLOBAL_PWR_MASK       (0xf<<ETHSW_QPHY_CTRL_IDDQ_GLOBAL_PWR_SHIFT)
    ...
    uint32 reserved1c[57];                  /* 0x001c - 0x00fc */

    uint32 led_pwm_ctrl;                    /* 0x0100 */
    uint32 led_intensity_ctrl;              /* 0x0104 */
    LED_CFG led_ctrl[11];                   /* 0x0108 - 0x0188 */
    uint32 reserved18c[3];

    uint32 led_blink_rate_ctrl;             /* 0x0198 */
    uint32 reserved19c[2];      
    uint32 aggr_led_pwm_ctrl;               /* 0x01a4 */
    uint32 aggr_led_intensity_ctrl;         /* 0x01a8 */
    uint32 aggr_led_ctrl;                   /* 0x01ac */
...
#define ETHSW_AGGREGATE_LED_CTRL_LNK_POL_SEL_MASK        0x40000
    uint32 aggr_led_blink_rate_ctrl;        /* 0x01b0 */
    uint32 rgmii_ctrl;                      /* 0x01b4 */
...
#define ETHSW_RC_RGMII_EN                    (1<<0)
    uint32 rgmii_ib_status;                 /* 0x01b8 */
    uint32 rgmii_rx_clk_delay_ctrl;         /* 0x01bc */
...
{
    uint8 dummy[4];                                 //TODO: incorrect definitions
...
#define ETH_SERDES_0_MISC_REG   ((volatile eth_serdes_0_misc_reg *)ETH_SERDES_0_MISC_BASE)
...
#define MPM_COMMON_CONTROL_MPM_EN_SHIFT    1
#define MPM_COMMON_CONTROL_MPM_EN_MASK     (0x1 << MPM_COMMON_CONTROL_MPM_EN_SHIFT)
...
#if (CONFIG_BRCM_CHIP_REV == 0x4912A0)
	uint32 MPM_CORE_TP_RD_CTRL;//0x800230E4
	uint32 MPM_CORE_TP_RD_DATA;//0x800230E8
#else
...
#define MPM_DMA_BFREE_TIER1_ARB_CFG_ARB_MODE_MASK    (0x3 << MPM_DMA_BFREE_TIER1_ARB_CFG_ARB_MODE_SHIFT)
        /* below T2 weight configuration is removed from B0 */
...
typedef struct Ubus4ModuleClientRegistration {
    ...
    uint32 MstStatus[ 8];    	/* 0x40 */
    uint32 RegCntl;    		/* 0x60 */
    uint32 SlvStopProgDelay;	/* 0x64 */
...
typedef struct
{
    ...
    WanBBHTxLanConfig unified_config;// 0x700 - 0x9FF
...
typedef struct
{
    WanBBHTxRegs txBlk[4];   // 0x82890000 
    WanBBHRxRegs rxBlk[11];   // 0x82898000
