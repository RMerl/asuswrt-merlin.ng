...
typedef enum
{
   ...
   BCMRET_OBJECT_ALREADY_EXISTS = 9839,    /** The object already exists */
   ...
   BCMRET_INVALID_URL_FORMAT = 9872,/**< Invalid URL Format
                                      * (associated with ChangeDUState)
                                      */
   BCMRET_INVALID_PACKAGE_FILE = 9873, /**<Invalid openplat package file*/
   BCMRET_EE_START_ERROR = 9874, /**<Fail to start EE*/
   BCMRET_EU_START_ERROR = 9875, /**<Fail to start EU*/
   BCMRET_EE_MANIFEST = 9876, /**<Found EE manifest*/
   BCMRET_MANIFEST_NO_PRIVILEGE_INFO = 9877, /**<Manifest without privilege information*/
   BCMRET_UNINSTALL_IN_PROCESS = 9878,    /**<Uninstall operation is still in process. */
   BCMRET_UPGRADE_IN_PROCESS = 9879,    /**<Upgrade operation is still in process. */
   BCMRET_UNKNOWN_ERROR = 9899,  /**< Can't figure out the real cause.  Use sparingly. */
} BcmRet;


/** Return if the BcmRet code is not SUCCESS. */
#define BCM_RETURN_IF_NOT_SUCCESS(r) if ((r) != BCMRET_SUCCESS) return (r);
