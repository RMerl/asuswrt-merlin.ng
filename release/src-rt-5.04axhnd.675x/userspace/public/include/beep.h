...
#define BEEP_ADDRESS_LEN_MAX     64    /* for a list of 4 ipv4 addrs separated by comma */
#define BEEP_IPV6_ADDRESS_LEN_MAX 184  /* for a list of 4 ipv6 addrs separated by comma */
...
#define HOST_USER_STRING   "Host User"
...
#define BEEP_USB_DRIVE_0    "/mnt/usb0"

#define BEEP_VERSION_6_0  "6.0"
/* Features in BEEP Version 6.0:
 * - Distributed data model (change in CMS_CORE_LIBS)
 * - Support running application without container
 * - Support new methods: GetScratchPad and SetScratchPad
 */
...
#define BEEP_HOSTEE_VERSION_6_0  "6.0"
/* Features in BEEP HOSTEE Version 6.0:
 * - Support running application without container
 * - Support new methods: GetScratchPad and SetScratchPad
 */
...
/******************************************************
 * From 5.04L01, the enum value needs to match BcmRet *
 ******************************************************/
typedef enum
{
   SPDRET_SUCCESS = 0,
   SPDRET_INTERNAL_ERROR = 9002,
   SPDRET_INVALID_ARGUMENT = 9003,
   SPDRET_SYSTEM_RESOURCE_EXCEEDED = 9004,
   SPDRET_FILE_TRANSFER_AUTH_FAILURE = 9012,
   SPDRET_UNSUPPORTED_FILE_TRANSFER_PROTOCOL = 9013,
   SPDRET_FILE_TRANSFER_UNABLE_CONTACT_FILE_SERVER = 9015,
   SPDRET_FILE_TRANSFER_UNABLE_ACCESS_FILE = 9016,
   SPDRET_FILE_TRANSFER_UNABLE_COMPLETE = 9017,
   SPDRET_FILE_TRANSFER_FILE_AUTHENTICATION_ERROR = 9019,
   SPDRET_FILE_TRANSFER_FILE_TIMEOUT = 9020,
   SPDRET_DB_UNKNOWN_EE = 9023,
   SPDRET_DU_EE_MISMATCH = 9025,
   SPDRET_DB_DU_DUPLICATE = 9026,
   SPDRET_SW_MODULE_SYSTEM_RESOURCE_EXCEEDED = 9027,
   SPDRET_DB_UNKNOWN_DU = 9028,
   SPDRET_DU_UPDATE_DOWNGRADE_NOT_ALLOWED = 9030,
   SPDRET_DU_UPDATE_VERSION_EXISTED = 9032,
   SPDRET_ACCESS_DENIED = 9814,
   SPDRET_OPERATION_NOT_PERMITTED = 9815,
   SPDRET_FILE_OPEN_ERROR = 9818,
   SPDRET_DB_EE_DUPLICATE = 9857,
   SPDRET_EE_UPDATE_DOWNGRADE_NOT_ALLOWED = 9858,
   SPDRET_EE_UPDATE_VERSION_EXISTED = 9860,
   SPDRET_MANIFEST_PARSE_ERROR = 9863,
   SPDRET_USERNAME_IN_USE = 9864,
   SPDRET_ADD_USER_ERROR = 9865,
   SPDRET_DELETE_USER_ERROR = 9866,
   SPDRET_USER_NOT_FOUND = 9867,
   SPDRET_SET_BUSGATE_POLICY_ERROR = 9868,
   SPDRET_BEEP_EE_VERSION_MISMATCH = 9871,
   SPDRET_INVALID_URL_FORMAT = 9872,
   SPDRET_FILE_INVALID = 9873,
   SPDRET_EE_START_ERROR = 9874,
   SPDRET_EU_START_ERROR = 9875,
   SPDRET_EE_MANIFEST = 9876,
   SPDRET_MANIFEST_NO_PRIVILEGE_INFO = 9877,
   SPDRET_UNINSTALL_IN_PROCESS = 9878,
   SPDRET_UPGRADE_IN_PROCESS = 9879,
} SpdRet;
...
#define BEEP_DEBUG_MAX_LINES     512
