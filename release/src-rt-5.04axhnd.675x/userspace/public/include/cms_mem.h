 ...
 *
 * @param keyOffset (IN) Offset to semaphore key.
 ...
 *
 * The memory code assumes this value is 16, so you'll need to modify
 * memory.c if you change this constant.
 * What is put in the 16 header bytes is also defined below.
 */
#define CMS_MEM_HEADER_LENGTH   16

#define CMS_MEM_HEADER_OFFSET_FLAGS    0
#define CMS_MEM_HEADER_OFFSET_RESERVED 1
#define CMS_MEM_HEADER_OFFSET_SIZE     2
#define CMS_MEM_HEADER_OFFSET_SIZE_XOR 3
#define CMS_MEM_HEADER_OFFSET_USER_BUF 4
