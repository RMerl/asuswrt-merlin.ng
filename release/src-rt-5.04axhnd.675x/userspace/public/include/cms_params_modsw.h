...
#define MODSW_PREINSTALLED_TMP_DU_DIR     "preinstallPkg"
...
#define CMS_VAR_MODSW_TMP_DIR  "/var/modsw/tmp"
#define CMS_MODSW_TMP_DU_DIR   CMS_VAR_MODSW_TMP_DIR"/du"
#define CMS_MODSW_TMP_EE_DIR   CMS_VAR_MODSW_TMP_DIR"/ee"
