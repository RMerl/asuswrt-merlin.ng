...
bdmf_error_t ag_drv_xpcstx_tx_control_set(const xpcstx_tx_control *tx_control)
{
    ...
    if((tx_control->cfg_test_pat_gen_vld_dis_125 >= _1BITS_MAX_VAL_) ||
       (tx_control->cfg_test_pat_gen_en_125 >= _1BITS_MAX_VAL_) ||
       (tx_control->cfgenrmtfaultdet125 >= _1BITS_MAX_VAL_) ||
    ...
    reg_tx_control = RU_FIELD_SET(0, XPCSTX, TX_CONTROL, CFG_TEST_PAT_GEN_VLD_DIS_125, reg_tx_control, tx_control->cfg_test_pat_gen_vld_dis_125);
    reg_tx_control = RU_FIELD_SET(0, XPCSTX, TX_CONTROL, CFG_TEST_PAT_GEN_EN_125, reg_tx_control, tx_control->cfg_test_pat_gen_en_125);
...
bdmf_error_t ag_drv_xpcstx_tx_control_get(xpcstx_tx_control *tx_control)
{
    ...
    tx_control->cfg_test_pat_gen_vld_dis_125 = RU_FIELD_GET(0, XPCSTX, TX_CONTROL, CFG_TEST_PAT_GEN_VLD_DIS_125, reg_tx_control);
    tx_control->cfg_test_pat_gen_en_125 = RU_FIELD_GET(0, XPCSTX, TX_CONTROL, CFG_TEST_PAT_GEN_EN_125, reg_tx_control);
...
{
    uint32_t reg_tx_test_pattern_seed_31_0=0;

#ifdef VALIDATE_PARMS
#endif

    reg_tx_test_pattern_seed_31_0 = RU_FIELD_SET(0, XPCSTX, TX_TEST_PATTERN_SEED_31_0, CFG_TEST_PAT_SEED_31_0, reg_tx_test_pattern_seed_31_0, cfg_test_pat_seed_31_0);

    RU_REG_WRITE(0, XPCSTX, TX_TEST_PATTERN_SEED_31_0, reg_tx_test_pattern_seed_31_0);
...
bdmf_error_t ag_drv_xpcstx_tx_test_pattern_seed_31_0_get(uint32_t *cfg_test_pat_seed_31_0)
{
    ...
    RU_REG_READ(0, XPCSTX, TX_TEST_PATTERN_SEED_31_0, reg_tx_test_pattern_seed_31_0);

    *cfg_test_pat_seed_31_0 = RU_FIELD_GET(0, XPCSTX, TX_TEST_PATTERN_SEED_31_0, CFG_TEST_PAT_SEED_31_0, reg_tx_test_pattern_seed_31_0);
...
{
    uint32_t reg_tx_test_pattern_seed_63_32=0;

#ifdef VALIDATE_PARMS
#endif

    reg_tx_test_pattern_seed_63_32 = RU_FIELD_SET(0, XPCSTX, TX_TEST_PATTERN_SEED_63_32, CFG_TEST_PAT_SEED_63_32, reg_tx_test_pattern_seed_63_32, cfg_test_pat_seed_63_32);

    RU_REG_WRITE(0, XPCSTX, TX_TEST_PATTERN_SEED_63_32, reg_tx_test_pattern_seed_63_32);
...
bdmf_error_t ag_drv_xpcstx_tx_test_pattern_seed_63_32_get(uint32_t *cfg_test_pat_seed_63_32)
{
    ...
    RU_REG_READ(0, XPCSTX, TX_TEST_PATTERN_SEED_63_32, reg_tx_test_pattern_seed_63_32);

    *cfg_test_pat_seed_63_32 = RU_FIELD_GET(0, XPCSTX, TX_TEST_PATTERN_SEED_63_32, CFG_TEST_PAT_SEED_63_32, reg_tx_test_pattern_seed_63_32);
...
{
    uint32_t reg_tx_test_pattern_data_31_0=0;

#ifdef VALIDATE_PARMS
#endif

    reg_tx_test_pattern_data_31_0 = RU_FIELD_SET(0, XPCSTX, TX_TEST_PATTERN_DATA_31_0, CFG_TEST_PAT_DATA_31_0, reg_tx_test_pattern_data_31_0, cfg_test_pat_data_31_0);

    RU_REG_WRITE(0, XPCSTX, TX_TEST_PATTERN_DATA_31_0, reg_tx_test_pattern_data_31_0);
...
bdmf_error_t ag_drv_xpcstx_tx_test_pattern_data_31_0_get(uint32_t *cfg_test_pat_data_31_0)
{
    ...
    RU_REG_READ(0, XPCSTX, TX_TEST_PATTERN_DATA_31_0, reg_tx_test_pattern_data_31_0);

    *cfg_test_pat_data_31_0 = RU_FIELD_GET(0, XPCSTX, TX_TEST_PATTERN_DATA_31_0, CFG_TEST_PAT_DATA_31_0, reg_tx_test_pattern_data_31_0);
...
{
    uint32_t reg_tx_test_pattern_data_63_32=0;

#ifdef VALIDATE_PARMS
#endif

    reg_tx_test_pattern_data_63_32 = RU_FIELD_SET(0, XPCSTX, TX_TEST_PATTERN_DATA_63_32, CFG_TEST_PAT_DATA_63_32, reg_tx_test_pattern_data_63_32, cfg_test_pat_data_63_32);

    RU_REG_WRITE(0, XPCSTX, TX_TEST_PATTERN_DATA_63_32, reg_tx_test_pattern_data_63_32);
...
bdmf_error_t ag_drv_xpcstx_tx_test_pattern_data_63_32_get(uint32_t *cfg_test_pat_data_63_32)
{
    ...
    RU_REG_READ(0, XPCSTX, TX_TEST_PATTERN_DATA_63_32, reg_tx_test_pattern_data_63_32);

    *cfg_test_pat_data_63_32 = RU_FIELD_GET(0, XPCSTX, TX_TEST_PATTERN_DATA_63_32, CFG_TEST_PAT_DATA_63_32, reg_tx_test_pattern_data_63_32);
...
{
    uint32_t reg_tx_test_pattern_sh=0;

#ifdef VALIDATE_PARMS
    if((cfg_test_pat_sh >= _2BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_tx_test_pattern_sh = RU_FIELD_SET(0, XPCSTX, TX_TEST_PATTERN_SH, CFG_TEST_PAT_SH, reg_tx_test_pattern_sh, cfg_test_pat_sh);

    RU_REG_WRITE(0, XPCSTX, TX_TEST_PATTERN_SH, reg_tx_test_pattern_sh);
...
bdmf_error_t ag_drv_xpcstx_tx_test_pattern_sh_get(uint8_t *cfg_test_pat_sh)
{
    ...
    RU_REG_READ(0, XPCSTX, TX_TEST_PATTERN_SH, reg_tx_test_pattern_sh);

    *cfg_test_pat_sh = RU_FIELD_GET(0, XPCSTX, TX_TEST_PATTERN_SH, CFG_TEST_PAT_SH, reg_tx_test_pattern_sh);
...
enum
{
    ...
    BDMF_tx_test_pattern_seed_31_0,
    BDMF_tx_test_pattern_seed_63_32,
    BDMF_tx_test_pattern_data_31_0,
    BDMF_tx_test_pattern_data_63_32,
    BDMF_tx_test_pattern_sh,
};
...
typedef enum
{
    ...
    bdmf_address_tx_test_pattern_seed_31_0,
    bdmf_address_tx_test_pattern_seed_63_32,
    bdmf_address_tx_test_pattern_data_31_0,
    bdmf_address_tx_test_pattern_data_63_32,
    bdmf_address_tx_test_pattern_sh,
}
bdmf_address;
...
static int bcm_xpcstx_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        xpcstx_tx_control tx_control = { .cfg_test_pat_gen_vld_dis_125=parm[1].value.unumber, .cfg_test_pat_gen_en_125=parm[2].value.unumber, .cfgenrmtfaultdet125=parm[3].value.unumber, .cfglsrtristateen125=parm[4].value.unumber, .cfgenseqnum125=parm[5].value.unumber, .cfgenscrmbcont125=parm[6].value.unumber, .cfglsrenacthi125=parm[7].value.unumber, .cfgenlsralways125=parm[8].value.unumber, .cfgenlsrtilendslot125=parm[9].value.unumber, .cfgtxoutbyteflip125=parm[10].value.unumber, .cfgentxout125=parm[11].value.unumber, .cfgentxscrb125=parm[12].value.unumber, .cfgentxfec125=parm[13].value.unumber, .pcstxnotrdy=parm[14].value.unumber, .pcstxdtportrstn=parm[15].value.unumber, .pcstxrstn=parm[16].value.unumber};
    ...
    case BDMF_tx_laser_monitor_max_thresh:
        ...
        break;
    case BDMF_tx_test_pattern_seed_31_0:
        err = ag_drv_xpcstx_tx_test_pattern_seed_31_0_set(parm[1].value.unumber);
        break;
    case BDMF_tx_test_pattern_seed_63_32:
        err = ag_drv_xpcstx_tx_test_pattern_seed_63_32_set(parm[1].value.unumber);
        break;
    case BDMF_tx_test_pattern_data_31_0:
        err = ag_drv_xpcstx_tx_test_pattern_data_31_0_set(parm[1].value.unumber);
        break;
    case BDMF_tx_test_pattern_data_63_32:
        err = ag_drv_xpcstx_tx_test_pattern_data_63_32_set(parm[1].value.unumber);
        break;
    case BDMF_tx_test_pattern_sh:
        err = ag_drv_xpcstx_tx_test_pattern_sh_set(parm[1].value.unumber);
        break;
    default:
...
static int bcm_xpcstx_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case BDMF_tx_control:
    {
        ...
        bdmf_session_print(session, "cfg_test_pat_gen_vld_dis_125 = %u = 0x%x\n", tx_control.cfg_test_pat_gen_vld_dis_125, tx_control.cfg_test_pat_gen_vld_dis_125);
        bdmf_session_print(session, "cfg_test_pat_gen_en_125 = %u = 0x%x\n", tx_control.cfg_test_pat_gen_en_125, tx_control.cfg_test_pat_gen_en_125);
    ...
    case BDMF_tx_test_pattern_seed_31_0:
    {
        uint32_t cfg_test_pat_seed_31_0;
        err = ag_drv_xpcstx_tx_test_pattern_seed_31_0_get(&cfg_test_pat_seed_31_0);
        bdmf_session_print(session, "cfg_test_pat_seed_31_0 = %u = 0x%x\n", cfg_test_pat_seed_31_0, cfg_test_pat_seed_31_0);
        break;
    }
    case BDMF_tx_test_pattern_seed_63_32:
    {
        uint32_t cfg_test_pat_seed_63_32;
        err = ag_drv_xpcstx_tx_test_pattern_seed_63_32_get(&cfg_test_pat_seed_63_32);
        bdmf_session_print(session, "cfg_test_pat_seed_63_32 = %u = 0x%x\n", cfg_test_pat_seed_63_32, cfg_test_pat_seed_63_32);
        break;
    }
    case BDMF_tx_test_pattern_data_31_0:
    {
        uint32_t cfg_test_pat_data_31_0;
        err = ag_drv_xpcstx_tx_test_pattern_data_31_0_get(&cfg_test_pat_data_31_0);
        bdmf_session_print(session, "cfg_test_pat_data_31_0 = %u = 0x%x\n", cfg_test_pat_data_31_0, cfg_test_pat_data_31_0);
        break;
    }
    case BDMF_tx_test_pattern_data_63_32:
    {
        uint32_t cfg_test_pat_data_63_32;
        err = ag_drv_xpcstx_tx_test_pattern_data_63_32_get(&cfg_test_pat_data_63_32);
        bdmf_session_print(session, "cfg_test_pat_data_63_32 = %u = 0x%x\n", cfg_test_pat_data_63_32, cfg_test_pat_data_63_32);
        break;
    }
    case BDMF_tx_test_pattern_sh:
    {
        uint8_t cfg_test_pat_sh;
        err = ag_drv_xpcstx_tx_test_pattern_sh_get(&cfg_test_pat_sh);
        bdmf_session_print(session, "cfg_test_pat_sh = %u = 0x%x\n", cfg_test_pat_sh, cfg_test_pat_sh);
        break;
    }
    default:
        err = BDMF_ERR_NOT_SUPPORTED;
...
static int bcm_xpcstx_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        uint32_t cfg_test_pat_seed_31_0=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xpcstx_tx_test_pattern_seed_31_0_set( %u)\n", cfg_test_pat_seed_31_0);
        if(!err) ag_drv_xpcstx_tx_test_pattern_seed_31_0_set(cfg_test_pat_seed_31_0);
        if(!err) ag_drv_xpcstx_tx_test_pattern_seed_31_0_get( &cfg_test_pat_seed_31_0);
        if(!err) bdmf_session_print(session, "ag_drv_xpcstx_tx_test_pattern_seed_31_0_get( %u)\n", cfg_test_pat_seed_31_0);
        if(err || cfg_test_pat_seed_31_0!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_test_pat_seed_63_32=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xpcstx_tx_test_pattern_seed_63_32_set( %u)\n", cfg_test_pat_seed_63_32);
        if(!err) ag_drv_xpcstx_tx_test_pattern_seed_63_32_set(cfg_test_pat_seed_63_32);
        if(!err) ag_drv_xpcstx_tx_test_pattern_seed_63_32_get( &cfg_test_pat_seed_63_32);
        if(!err) bdmf_session_print(session, "ag_drv_xpcstx_tx_test_pattern_seed_63_32_get( %u)\n", cfg_test_pat_seed_63_32);
        if(err || cfg_test_pat_seed_63_32!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_test_pat_data_31_0=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xpcstx_tx_test_pattern_data_31_0_set( %u)\n", cfg_test_pat_data_31_0);
        if(!err) ag_drv_xpcstx_tx_test_pattern_data_31_0_set(cfg_test_pat_data_31_0);
        if(!err) ag_drv_xpcstx_tx_test_pattern_data_31_0_get( &cfg_test_pat_data_31_0);
        if(!err) bdmf_session_print(session, "ag_drv_xpcstx_tx_test_pattern_data_31_0_get( %u)\n", cfg_test_pat_data_31_0);
        if(err || cfg_test_pat_data_31_0!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_test_pat_data_63_32=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xpcstx_tx_test_pattern_data_63_32_set( %u)\n", cfg_test_pat_data_63_32);
        if(!err) ag_drv_xpcstx_tx_test_pattern_data_63_32_set(cfg_test_pat_data_63_32);
        if(!err) ag_drv_xpcstx_tx_test_pattern_data_63_32_get( &cfg_test_pat_data_63_32);
        if(!err) bdmf_session_print(session, "ag_drv_xpcstx_tx_test_pattern_data_63_32_get( %u)\n", cfg_test_pat_data_63_32);
        if(err || cfg_test_pat_data_63_32!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint8_t cfg_test_pat_sh=gtmv(m, 2);
        if(!err) bdmf_session_print(session, "ag_drv_xpcstx_tx_test_pattern_sh_set( %u)\n", cfg_test_pat_sh);
        if(!err) ag_drv_xpcstx_tx_test_pattern_sh_set(cfg_test_pat_sh);
        if(!err) ag_drv_xpcstx_tx_test_pattern_sh_get( &cfg_test_pat_sh);
        if(!err) bdmf_session_print(session, "ag_drv_xpcstx_tx_test_pattern_sh_get( %u)\n", cfg_test_pat_sh);
        if(err || cfg_test_pat_sh!=gtmv(m, 2))
            return err ? err : BDMF_ERR_IO;
    }
    return err;
}
...
static int bcm_xpcstx_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case bdmf_address_tx_test_pattern_seed_31_0 : reg = &RU_REG(XPCSTX, TX_TEST_PATTERN_SEED_31_0); blk = &RU_BLK(XPCSTX); break;
    case bdmf_address_tx_test_pattern_seed_63_32 : reg = &RU_REG(XPCSTX, TX_TEST_PATTERN_SEED_63_32); blk = &RU_BLK(XPCSTX); break;
    case bdmf_address_tx_test_pattern_data_31_0 : reg = &RU_REG(XPCSTX, TX_TEST_PATTERN_DATA_31_0); blk = &RU_BLK(XPCSTX); break;
    case bdmf_address_tx_test_pattern_data_63_32 : reg = &RU_REG(XPCSTX, TX_TEST_PATTERN_DATA_63_32); blk = &RU_BLK(XPCSTX); break;
    case bdmf_address_tx_test_pattern_sh : reg = &RU_REG(XPCSTX, TX_TEST_PATTERN_SH); blk = &RU_BLK(XPCSTX); break;
    default :
...
bdmfmon_handle_t ag_drv_xpcstx_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        static bdmfmon_cmd_parm_t set_tx_control[]={
            BDMFMON_MAKE_PARM("cfg_test_pat_gen_vld_dis_125", "cfg_test_pat_gen_vld_dis_125", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfg_test_pat_gen_en_125", "cfg_test_pat_gen_en_125", BDMFMON_PARM_NUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_tx_test_pattern_seed_31_0[]={
            BDMFMON_MAKE_PARM("cfg_test_pat_seed_31_0", "cfg_test_pat_seed_31_0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_tx_test_pattern_seed_63_32[]={
            BDMFMON_MAKE_PARM("cfg_test_pat_seed_63_32", "cfg_test_pat_seed_63_32", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_tx_test_pattern_data_31_0[]={
            BDMFMON_MAKE_PARM("cfg_test_pat_data_31_0", "cfg_test_pat_data_31_0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_tx_test_pattern_data_63_32[]={
            BDMFMON_MAKE_PARM("cfg_test_pat_data_63_32", "cfg_test_pat_data_63_32", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_tx_test_pattern_sh[]={
            BDMFMON_MAKE_PARM("cfg_test_pat_sh", "cfg_test_pat_sh", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="tx_test_pattern_seed_31_0", .val=BDMF_tx_test_pattern_seed_31_0, .parms=set_tx_test_pattern_seed_31_0 },
            { .name="tx_test_pattern_seed_63_32", .val=BDMF_tx_test_pattern_seed_63_32, .parms=set_tx_test_pattern_seed_63_32 },
            { .name="tx_test_pattern_data_31_0", .val=BDMF_tx_test_pattern_data_31_0, .parms=set_tx_test_pattern_data_31_0 },
            { .name="tx_test_pattern_data_63_32", .val=BDMF_tx_test_pattern_data_63_32, .parms=set_tx_test_pattern_data_63_32 },
            { .name="tx_test_pattern_sh", .val=BDMF_tx_test_pattern_sh, .parms=set_tx_test_pattern_sh },
            BDMFMON_ENUM_LAST
        };
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="tx_test_pattern_seed_31_0", .val=BDMF_tx_test_pattern_seed_31_0, .parms=set_default },
            { .name="tx_test_pattern_seed_63_32", .val=BDMF_tx_test_pattern_seed_63_32, .parms=set_default },
            { .name="tx_test_pattern_data_31_0", .val=BDMF_tx_test_pattern_data_31_0, .parms=set_default },
            { .name="tx_test_pattern_data_63_32", .val=BDMF_tx_test_pattern_data_63_32, .parms=set_default },
            { .name="tx_test_pattern_sh", .val=BDMF_tx_test_pattern_sh, .parms=set_default },
            BDMFMON_ENUM_LAST
        };
    ...
    }
    {
        static bdmfmon_enum_val_t enum_table_address[] = {
            ...
            { .name="TX_TEST_PATTERN_SEED_31_0" , .val=bdmf_address_tx_test_pattern_seed_31_0 },
            { .name="TX_TEST_PATTERN_SEED_63_32" , .val=bdmf_address_tx_test_pattern_seed_63_32 },
            { .name="TX_TEST_PATTERN_DATA_31_0" , .val=bdmf_address_tx_test_pattern_data_31_0 },
            { .name="TX_TEST_PATTERN_DATA_63_32" , .val=bdmf_address_tx_test_pattern_data_63_32 },
            { .name="TX_TEST_PATTERN_SH" , .val=bdmf_address_tx_test_pattern_sh },
            BDMFMON_ENUM_LAST
        };
