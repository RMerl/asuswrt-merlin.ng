...
bdmf_error_t ag_drv_lif_pon_inter_op_control_set(const lif_pon_inter_op_control *pon_inter_op_control)
{
    ...
    if((pon_inter_op_control->cf_tx_lif_allow_overlp_b2b >= _1BITS_MAX_VAL_) ||
       (pon_inter_op_control->cfipgfilter >= _4BITS_MAX_VAL_) ||
    ...
    reg_pon_inter_op_control = RU_FIELD_SET(0, LIF, PON_INTER_OP_CONTROL, CF_TX_LIF_ALLOW_OVERLP_B2B, reg_pon_inter_op_control, pon_inter_op_control->cf_tx_lif_allow_overlp_b2b);
...
bdmf_error_t ag_drv_lif_pon_inter_op_control_get(lif_pon_inter_op_control *pon_inter_op_control)
{
    ...
    pon_inter_op_control->cf_tx_lif_allow_overlp_b2b = RU_FIELD_GET(0, LIF, PON_INTER_OP_CONTROL, CF_TX_LIF_ALLOW_OVERLP_B2B, reg_pon_inter_op_control);
...
bdmf_error_t ag_drv_lif_data_port_data_0_set(uint32_t pbiportdata0)
{
    ...
    reg_data_port_data_0 = RU_FIELD_SET(0, LIF, DATA_PORT_DATA_0, PBIPORTDATA0, reg_data_port_data_0, pbiportdata0);

    RU_REG_WRITE(0, LIF, DATA_PORT_DATA_0, reg_data_port_data_0);
...
bdmf_error_t ag_drv_lif_data_port_data_0_get(uint32_t *pbiportdata0)
{
    ...
    RU_REG_READ(0, LIF, DATA_PORT_DATA_0, reg_data_port_data_0);

    *pbiportdata0 = RU_FIELD_GET(0, LIF, DATA_PORT_DATA_0, PBIPORTDATA0, reg_data_port_data_0);
...
{
    uint32_t reg_data_port_data_1=0;

#ifdef VALIDATE_PARMS
#endif

    reg_data_port_data_1 = RU_FIELD_SET(0, LIF, DATA_PORT_DATA_1, PBIPORTDATA1, reg_data_port_data_1, pbiportdata1);

    RU_REG_WRITE(0, LIF, DATA_PORT_DATA_1, reg_data_port_data_1);
...
bdmf_error_t ag_drv_lif_data_port_data_1_get(uint32_t *pbiportdata1)
{
    ...
    RU_REG_READ(0, LIF, DATA_PORT_DATA_1, reg_data_port_data_1);

    *pbiportdata1 = RU_FIELD_GET(0, LIF, DATA_PORT_DATA_1, PBIPORTDATA1, reg_data_port_data_1);
...
{
    uint32_t reg_data_port_data_2=0;

#ifdef VALIDATE_PARMS
#endif

    reg_data_port_data_2 = RU_FIELD_SET(0, LIF, DATA_PORT_DATA_2, PBIPORTDATA2, reg_data_port_data_2, pbiportdata2);

    RU_REG_WRITE(0, LIF, DATA_PORT_DATA_2, reg_data_port_data_2);
...
bdmf_error_t ag_drv_lif_data_port_data_2_get(uint32_t *pbiportdata2)
{
    ...
    RU_REG_READ(0, LIF, DATA_PORT_DATA_2, reg_data_port_data_2);

    *pbiportdata2 = RU_FIELD_GET(0, LIF, DATA_PORT_DATA_2, PBIPORTDATA2, reg_data_port_data_2);
...
{
    uint32_t reg_data_port_data_3=0;

#ifdef VALIDATE_PARMS
#endif

    reg_data_port_data_3 = RU_FIELD_SET(0, LIF, DATA_PORT_DATA_3, PBIPORTDATA3, reg_data_port_data_3, pbiportdata3);

    RU_REG_WRITE(0, LIF, DATA_PORT_DATA_3, reg_data_port_data_3);
...
bdmf_error_t ag_drv_lif_data_port_data_3_get(uint32_t *pbiportdata3)
{
    ...
    RU_REG_READ(0, LIF, DATA_PORT_DATA_3, reg_data_port_data_3);

    *pbiportdata3 = RU_FIELD_GET(0, LIF, DATA_PORT_DATA_3, PBIPORTDATA3, reg_data_port_data_3);
...
{
    uint32_t reg_data_port_data_4=0;

#ifdef VALIDATE_PARMS
#endif

    reg_data_port_data_4 = RU_FIELD_SET(0, LIF, DATA_PORT_DATA_4, PBIPORTDATA4, reg_data_port_data_4, pbiportdata4);

    RU_REG_WRITE(0, LIF, DATA_PORT_DATA_4, reg_data_port_data_4);
...
bdmf_error_t ag_drv_lif_data_port_data_4_get(uint32_t *pbiportdata4)
{
    ...
    RU_REG_READ(0, LIF, DATA_PORT_DATA_4, reg_data_port_data_4);

    *pbiportdata4 = RU_FIELD_GET(0, LIF, DATA_PORT_DATA_4, PBIPORTDATA4, reg_data_port_data_4);
...
{
    uint32_t reg_data_port_data_5=0;

#ifdef VALIDATE_PARMS
#endif

    reg_data_port_data_5 = RU_FIELD_SET(0, LIF, DATA_PORT_DATA_5, PBIPORTDATA5, reg_data_port_data_5, pbiportdata5);

    RU_REG_WRITE(0, LIF, DATA_PORT_DATA_5, reg_data_port_data_5);
...
bdmf_error_t ag_drv_lif_data_port_data_5_get(uint32_t *pbiportdata5)
{
    ...
    RU_REG_READ(0, LIF, DATA_PORT_DATA_5, reg_data_port_data_5);

    *pbiportdata5 = RU_FIELD_GET(0, LIF, DATA_PORT_DATA_5, PBIPORTDATA5, reg_data_port_data_5);
...
{
    uint32_t reg_data_port_data_6=0;

#ifdef VALIDATE_PARMS
#endif

    reg_data_port_data_6 = RU_FIELD_SET(0, LIF, DATA_PORT_DATA_6, PBIPORTDATA6, reg_data_port_data_6, pbiportdata6);

    RU_REG_WRITE(0, LIF, DATA_PORT_DATA_6, reg_data_port_data_6);
...
bdmf_error_t ag_drv_lif_data_port_data_6_get(uint32_t *pbiportdata6)
{
    ...
    RU_REG_READ(0, LIF, DATA_PORT_DATA_6, reg_data_port_data_6);

    *pbiportdata6 = RU_FIELD_GET(0, LIF, DATA_PORT_DATA_6, PBIPORTDATA6, reg_data_port_data_6);
...
{
    uint32_t reg_data_port_data_7=0;

#ifdef VALIDATE_PARMS
#endif

    reg_data_port_data_7 = RU_FIELD_SET(0, LIF, DATA_PORT_DATA_7, PBIPORTDATA7, reg_data_port_data_7, pbiportdata7);

    RU_REG_WRITE(0, LIF, DATA_PORT_DATA_7, reg_data_port_data_7);
...
bdmf_error_t ag_drv_lif_data_port_data_7_get(uint32_t *pbiportdata7)
{
    ...
    RU_REG_READ(0, LIF, DATA_PORT_DATA_7, reg_data_port_data_7);

    *pbiportdata7 = RU_FIELD_GET(0, LIF, DATA_PORT_DATA_7, PBIPORTDATA7, reg_data_port_data_7);
...
bdmf_error_t ag_drv_lif_p2p_inter_op_control_set(bdmf_boolean cfp2pmaskoneprecidle, bdmf_boolean cfp2pmodetransmitremfault, bdmf_boolean cfp2pmodetransmitdeficitidleenable, bdmf_boolean cfp2pmodeadaptiveshortpre)
{
...
#ifdef VALIDATE_PARMS
    if((cfp2pmaskoneprecidle >= _1BITS_MAX_VAL_) ||
       (cfp2pmodetransmitremfault >= _1BITS_MAX_VAL_) ||
    ...
    reg_p2p_inter_op_control = RU_FIELD_SET(0, LIF, P2P_INTER_OP_CONTROL, CFP2PMASKONEPRECIDLE, reg_p2p_inter_op_control, cfp2pmaskoneprecidle);
...
bdmf_error_t ag_drv_lif_p2p_inter_op_control_get(bdmf_boolean *cfp2pmaskoneprecidle, bdmf_boolean *cfp2pmodetransmitremfault, bdmf_boolean *cfp2pmodetransmitdeficitidleenable, bdmf_boolean *cfp2pmodeadaptiveshortpre)
{
...
#ifdef VALIDATE_PARMS
    if(!cfp2pmaskoneprecidle || !cfp2pmodetransmitremfault || !cfp2pmodetransmitdeficitidleenable || !cfp2pmodeadaptiveshortpre)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    *cfp2pmaskoneprecidle = RU_FIELD_GET(0, LIF, P2P_INTER_OP_CONTROL, CFP2PMASKONEPRECIDLE, reg_p2p_inter_op_control);
...
bdmf_error_t ag_drv_lif_sec_control_2_set(const lif_sec_control_2 *sec_control_2)
{
    ...
    if((sec_control_2->cfgensecoutffprime >= _1BITS_MAX_VAL_) ||
       (sec_control_2->cfgenaes_256_up >= _1BITS_MAX_VAL_) ||
       (sec_control_2->cfgenaes_256_dn >= _1BITS_MAX_VAL_) ||
       (sec_control_2->cfg_macsec_xpn_tx >= _1BITS_MAX_VAL_) ||
       (sec_control_2->cfg_macsec_xpn_rx >= _1BITS_MAX_VAL_) ||
       (sec_control_2->cfgkeynum_4_an_3 >= _1BITS_MAX_VAL_) ||
       (sec_control_2->cfgkeynum_4_an_2 >= _1BITS_MAX_VAL_) ||
       (sec_control_2->cfgkeynum_4_an_1 >= _1BITS_MAX_VAL_) ||
       (sec_control_2->cfgkeynum_4_an_0 >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_sec_control_2 = RU_FIELD_SET(0, LIF, SEC_CONTROL_2, CFGENSECOUTFFPRIME, reg_sec_control_2, sec_control_2->cfgensecoutffprime);
    reg_sec_control_2 = RU_FIELD_SET(0, LIF, SEC_CONTROL_2, CFGENAES_256_UP, reg_sec_control_2, sec_control_2->cfgenaes_256_up);
    reg_sec_control_2 = RU_FIELD_SET(0, LIF, SEC_CONTROL_2, CFGENAES_256_DN, reg_sec_control_2, sec_control_2->cfgenaes_256_dn);
    reg_sec_control_2 = RU_FIELD_SET(0, LIF, SEC_CONTROL_2, CFG_MACSEC_XPN_TX, reg_sec_control_2, sec_control_2->cfg_macsec_xpn_tx);
    reg_sec_control_2 = RU_FIELD_SET(0, LIF, SEC_CONTROL_2, CFG_MACSEC_XPN_RX, reg_sec_control_2, sec_control_2->cfg_macsec_xpn_rx);
    reg_sec_control_2 = RU_FIELD_SET(0, LIF, SEC_CONTROL_2, CFGKEYNUM_4_AN_3, reg_sec_control_2, sec_control_2->cfgkeynum_4_an_3);
    reg_sec_control_2 = RU_FIELD_SET(0, LIF, SEC_CONTROL_2, CFGKEYNUM_4_AN_2, reg_sec_control_2, sec_control_2->cfgkeynum_4_an_2);
    reg_sec_control_2 = RU_FIELD_SET(0, LIF, SEC_CONTROL_2, CFGKEYNUM_4_AN_1, reg_sec_control_2, sec_control_2->cfgkeynum_4_an_1);
    reg_sec_control_2 = RU_FIELD_SET(0, LIF, SEC_CONTROL_2, CFGKEYNUM_4_AN_0, reg_sec_control_2, sec_control_2->cfgkeynum_4_an_0);
...
bdmf_error_t ag_drv_lif_sec_control_2_get(lif_sec_control_2 *sec_control_2)
{
    ...
    sec_control_2->cfgensecoutffprime = RU_FIELD_GET(0, LIF, SEC_CONTROL_2, CFGENSECOUTFFPRIME, reg_sec_control_2);
    sec_control_2->cfgenaes_256_up = RU_FIELD_GET(0, LIF, SEC_CONTROL_2, CFGENAES_256_UP, reg_sec_control_2);
    sec_control_2->cfgenaes_256_dn = RU_FIELD_GET(0, LIF, SEC_CONTROL_2, CFGENAES_256_DN, reg_sec_control_2);
    sec_control_2->cfg_macsec_xpn_tx = RU_FIELD_GET(0, LIF, SEC_CONTROL_2, CFG_MACSEC_XPN_TX, reg_sec_control_2);
    sec_control_2->cfg_macsec_xpn_rx = RU_FIELD_GET(0, LIF, SEC_CONTROL_2, CFG_MACSEC_XPN_RX, reg_sec_control_2);
    sec_control_2->cfgkeynum_4_an_3 = RU_FIELD_GET(0, LIF, SEC_CONTROL_2, CFGKEYNUM_4_AN_3, reg_sec_control_2);
    sec_control_2->cfgkeynum_4_an_2 = RU_FIELD_GET(0, LIF, SEC_CONTROL_2, CFGKEYNUM_4_AN_2, reg_sec_control_2);
    sec_control_2->cfgkeynum_4_an_1 = RU_FIELD_GET(0, LIF, SEC_CONTROL_2, CFGKEYNUM_4_AN_1, reg_sec_control_2);
    sec_control_2->cfgkeynum_4_an_0 = RU_FIELD_GET(0, LIF, SEC_CONTROL_2, CFGKEYNUM_4_AN_0, reg_sec_control_2);
...
bdmf_error_t ag_drv_lif_1588_ts_sync_offset_set(bdmf_boolean cfg_ts48_sync_ns_increment, uint16_t cfgtssyncoffset_312, uint16_t cfgtssyncoffset_125)
{
    ...
    reg_1588_ts_sync_offset = RU_FIELD_SET(0, LIF, 1588_TS_SYNC_OFFSET, CFG_TS48_SYNC_NS_INCREMENT, reg_1588_ts_sync_offset, cfg_ts48_sync_ns_increment);
    reg_1588_ts_sync_offset = RU_FIELD_SET(0, LIF, 1588_TS_SYNC_OFFSET, CFGTSSYNCOFFSET_312, reg_1588_ts_sync_offset, cfgtssyncoffset_312);
    reg_1588_ts_sync_offset = RU_FIELD_SET(0, LIF, 1588_TS_SYNC_OFFSET, CFGTSSYNCOFFSET_125, reg_1588_ts_sync_offset, cfgtssyncoffset_125);

    RU_REG_WRITE(0, LIF, 1588_TS_SYNC_OFFSET, reg_1588_ts_sync_offset);
...
bdmf_error_t ag_drv_lif_1588_ts_sync_offset_get(bdmf_boolean *cfg_ts48_sync_ns_increment, uint16_t *cfgtssyncoffset_312, uint16_t *cfgtssyncoffset_125)
{
    ...
    RU_REG_READ(0, LIF, 1588_TS_SYNC_OFFSET, reg_1588_ts_sync_offset);

    *cfg_ts48_sync_ns_increment = RU_FIELD_GET(0, LIF, 1588_TS_SYNC_OFFSET, CFG_TS48_SYNC_NS_INCREMENT, reg_1588_ts_sync_offset);
    *cfgtssyncoffset_312 = RU_FIELD_GET(0, LIF, 1588_TS_SYNC_OFFSET, CFGTSSYNCOFFSET_312, reg_1588_ts_sync_offset);
    *cfgtssyncoffset_125 = RU_FIELD_GET(0, LIF, 1588_TS_SYNC_OFFSET, CFGTSSYNCOFFSET_125, reg_1588_ts_sync_offset);
...
{
    uint32_t reg_data_port_data_8=0;

#ifdef VALIDATE_PARMS
#endif

    reg_data_port_data_8 = RU_FIELD_SET(0, LIF, DATA_PORT_DATA_8, PBIPORTDATA8, reg_data_port_data_8, pbiportdata8);

    RU_REG_WRITE(0, LIF, DATA_PORT_DATA_8, reg_data_port_data_8);
...
bdmf_error_t ag_drv_lif_data_port_data_8_get(uint32_t *pbiportdata8)
{
    ...
    RU_REG_READ(0, LIF, DATA_PORT_DATA_8, reg_data_port_data_8);

    *pbiportdata8 = RU_FIELD_GET(0, LIF, DATA_PORT_DATA_8, PBIPORTDATA8, reg_data_port_data_8);
...
{
    uint32_t reg_data_port_data_9=0;

#ifdef VALIDATE_PARMS
#endif

    reg_data_port_data_9 = RU_FIELD_SET(0, LIF, DATA_PORT_DATA_9, PBIPORTDATA9, reg_data_port_data_9, pbiportdata9);

    RU_REG_WRITE(0, LIF, DATA_PORT_DATA_9, reg_data_port_data_9);
...
bdmf_error_t ag_drv_lif_data_port_data_9_get(uint32_t *pbiportdata9)
{
    ...
    RU_REG_READ(0, LIF, DATA_PORT_DATA_9, reg_data_port_data_9);

    *pbiportdata9 = RU_FIELD_GET(0, LIF, DATA_PORT_DATA_9, PBIPORTDATA9, reg_data_port_data_9);
...
{
    uint32_t reg_data_port_data_10=0;

#ifdef VALIDATE_PARMS
#endif

    reg_data_port_data_10 = RU_FIELD_SET(0, LIF, DATA_PORT_DATA_10, PBIPORTDATA10, reg_data_port_data_10, pbiportdata10);

    RU_REG_WRITE(0, LIF, DATA_PORT_DATA_10, reg_data_port_data_10);
...
bdmf_error_t ag_drv_lif_data_port_data_10_get(uint32_t *pbiportdata10)
{
    ...
    RU_REG_READ(0, LIF, DATA_PORT_DATA_10, reg_data_port_data_10);

    *pbiportdata10 = RU_FIELD_GET(0, LIF, DATA_PORT_DATA_10, PBIPORTDATA10, reg_data_port_data_10);
...
{
    uint32_t reg_data_port_data_11=0;

#ifdef VALIDATE_PARMS
#endif

    reg_data_port_data_11 = RU_FIELD_SET(0, LIF, DATA_PORT_DATA_11, PBIPORTDATA11, reg_data_port_data_11, pbiportdata11);

    RU_REG_WRITE(0, LIF, DATA_PORT_DATA_11, reg_data_port_data_11);
...
bdmf_error_t ag_drv_lif_data_port_data_11_get(uint32_t *pbiportdata11)
{
    ...
    RU_REG_READ(0, LIF, DATA_PORT_DATA_11, reg_data_port_data_11);

    *pbiportdata11 = RU_FIELD_GET(0, LIF, DATA_PORT_DATA_11, PBIPORTDATA11, reg_data_port_data_11);
...
{
    uint32_t reg_sec_tx_ssci=0;

#ifdef VALIDATE_PARMS
#endif

    reg_sec_tx_ssci = RU_FIELD_SET(0, LIF, SEC_TX_SSCI, CFG_MACSEC_XPN_TX_SSCI, reg_sec_tx_ssci, cfg_macsec_xpn_tx_ssci);

    RU_REG_WRITE(0, LIF, SEC_TX_SSCI, reg_sec_tx_ssci);
...
bdmf_error_t ag_drv_lif_sec_tx_ssci_get(uint32_t *cfg_macsec_xpn_tx_ssci)
{
    ...
    RU_REG_READ(0, LIF, SEC_TX_SSCI, reg_sec_tx_ssci);

    *cfg_macsec_xpn_tx_ssci = RU_FIELD_GET(0, LIF, SEC_TX_SSCI, CFG_MACSEC_XPN_TX_SSCI, reg_sec_tx_ssci);
...
{
    uint32_t reg_sec_tx_salt_0=0;

#ifdef VALIDATE_PARMS
#endif

    reg_sec_tx_salt_0 = RU_FIELD_SET(0, LIF, SEC_TX_SALT_0, CFG_MACSEC_XPN_TX_SALT_0, reg_sec_tx_salt_0, cfg_macsec_xpn_tx_salt_0);

    RU_REG_WRITE(0, LIF, SEC_TX_SALT_0, reg_sec_tx_salt_0);
...
bdmf_error_t ag_drv_lif_sec_tx_salt_0_get(uint32_t *cfg_macsec_xpn_tx_salt_0)
{
    ...
    RU_REG_READ(0, LIF, SEC_TX_SALT_0, reg_sec_tx_salt_0);

    *cfg_macsec_xpn_tx_salt_0 = RU_FIELD_GET(0, LIF, SEC_TX_SALT_0, CFG_MACSEC_XPN_TX_SALT_0, reg_sec_tx_salt_0);
...
{
    uint32_t reg_sec_tx_salt_1=0;

#ifdef VALIDATE_PARMS
#endif

    reg_sec_tx_salt_1 = RU_FIELD_SET(0, LIF, SEC_TX_SALT_1, CFG_MACSEC_XPN_TX_SALT_1, reg_sec_tx_salt_1, cfg_macsec_xpn_tx_salt_1);

    RU_REG_WRITE(0, LIF, SEC_TX_SALT_1, reg_sec_tx_salt_1);
...
bdmf_error_t ag_drv_lif_sec_tx_salt_1_get(uint32_t *cfg_macsec_xpn_tx_salt_1)
{
    ...
    RU_REG_READ(0, LIF, SEC_TX_SALT_1, reg_sec_tx_salt_1);

    *cfg_macsec_xpn_tx_salt_1 = RU_FIELD_GET(0, LIF, SEC_TX_SALT_1, CFG_MACSEC_XPN_TX_SALT_1, reg_sec_tx_salt_1);
...
{
    uint32_t reg_sec_tx_salt_2=0;

#ifdef VALIDATE_PARMS
#endif

    reg_sec_tx_salt_2 = RU_FIELD_SET(0, LIF, SEC_TX_SALT_2, CFG_MACSEC_XPN_TX_SALT_2, reg_sec_tx_salt_2, cfg_macsec_xpn_tx_salt_2);

    RU_REG_WRITE(0, LIF, SEC_TX_SALT_2, reg_sec_tx_salt_2);
...
bdmf_error_t ag_drv_lif_sec_tx_salt_2_get(uint32_t *cfg_macsec_xpn_tx_salt_2)
{
    ...
    RU_REG_READ(0, LIF, SEC_TX_SALT_2, reg_sec_tx_salt_2);

    *cfg_macsec_xpn_tx_salt_2 = RU_FIELD_GET(0, LIF, SEC_TX_SALT_2, CFG_MACSEC_XPN_TX_SALT_2, reg_sec_tx_salt_2);
...
{
    uint32_t reg_sec_rx_ssci=0;

#ifdef VALIDATE_PARMS
#endif

    reg_sec_rx_ssci = RU_FIELD_SET(0, LIF, SEC_RX_SSCI, CFG_MACSEC_XPN_RX_SSCI, reg_sec_rx_ssci, cfg_macsec_xpn_rx_ssci);

    RU_REG_WRITE(0, LIF, SEC_RX_SSCI, reg_sec_rx_ssci);
...
bdmf_error_t ag_drv_lif_sec_rx_ssci_get(uint32_t *cfg_macsec_xpn_rx_ssci)
{
    ...
    RU_REG_READ(0, LIF, SEC_RX_SSCI, reg_sec_rx_ssci);

    *cfg_macsec_xpn_rx_ssci = RU_FIELD_GET(0, LIF, SEC_RX_SSCI, CFG_MACSEC_XPN_RX_SSCI, reg_sec_rx_ssci);
...
{
    uint32_t reg_sec_rx_salt_0=0;

#ifdef VALIDATE_PARMS
#endif

    reg_sec_rx_salt_0 = RU_FIELD_SET(0, LIF, SEC_RX_SALT_0, CFG_MACSEC_XPN_RX_SALT_0, reg_sec_rx_salt_0, cfg_macsec_xpn_rx_salt_0);

    RU_REG_WRITE(0, LIF, SEC_RX_SALT_0, reg_sec_rx_salt_0);
...
bdmf_error_t ag_drv_lif_sec_rx_salt_0_get(uint32_t *cfg_macsec_xpn_rx_salt_0)
{
    ...
    RU_REG_READ(0, LIF, SEC_RX_SALT_0, reg_sec_rx_salt_0);

    *cfg_macsec_xpn_rx_salt_0 = RU_FIELD_GET(0, LIF, SEC_RX_SALT_0, CFG_MACSEC_XPN_RX_SALT_0, reg_sec_rx_salt_0);
...
{
    uint32_t reg_sec_rx_salt_1=0;

#ifdef VALIDATE_PARMS
#endif

    reg_sec_rx_salt_1 = RU_FIELD_SET(0, LIF, SEC_RX_SALT_1, CFG_MACSEC_XPN_RX_SALT_1, reg_sec_rx_salt_1, cfg_macsec_xpn_rx_salt_1);

    RU_REG_WRITE(0, LIF, SEC_RX_SALT_1, reg_sec_rx_salt_1);
...
bdmf_error_t ag_drv_lif_sec_rx_salt_1_get(uint32_t *cfg_macsec_xpn_rx_salt_1)
{
    ...
    RU_REG_READ(0, LIF, SEC_RX_SALT_1, reg_sec_rx_salt_1);

    *cfg_macsec_xpn_rx_salt_1 = RU_FIELD_GET(0, LIF, SEC_RX_SALT_1, CFG_MACSEC_XPN_RX_SALT_1, reg_sec_rx_salt_1);
...
{
    uint32_t reg_sec_rx_salt_2=0;

#ifdef VALIDATE_PARMS
#endif

    reg_sec_rx_salt_2 = RU_FIELD_SET(0, LIF, SEC_RX_SALT_2, CFG_MACSEC_XPN_RX_SALT_2, reg_sec_rx_salt_2, cfg_macsec_xpn_rx_salt_2);

    RU_REG_WRITE(0, LIF, SEC_RX_SALT_2, reg_sec_rx_salt_2);
...
bdmf_error_t ag_drv_lif_sec_rx_salt_2_get(uint32_t *cfg_macsec_xpn_rx_salt_2)
{
    ...
    RU_REG_READ(0, LIF, SEC_RX_SALT_2, reg_sec_rx_salt_2);

    *cfg_macsec_xpn_rx_salt_2 = RU_FIELD_GET(0, LIF, SEC_RX_SALT_2, CFG_MACSEC_XPN_RX_SALT_2, reg_sec_rx_salt_2);
...
enum
{
    ...
    BDMF_data_port_data_1,
    BDMF_data_port_data_2,
    BDMF_data_port_data_3,
    BDMF_data_port_data_4,
    BDMF_data_port_data_5,
    BDMF_data_port_data_6,
    BDMF_data_port_data_7,
    BDMF_llid_0,
    BDMF_llid_1,
    BDMF_llid_2,
    BDMF_llid_3,
    ...
    BDMF_data_port_data_8,
    BDMF_data_port_data_9,
    BDMF_data_port_data_10,
    BDMF_data_port_data_11,
    BDMF_sec_tx_ssci,
    BDMF_sec_tx_salt_0,
    BDMF_sec_tx_salt_1,
    BDMF_sec_tx_salt_2,
...
typedef enum
{
    ...
    bdmf_address_data_port_data_1,
    bdmf_address_data_port_data_2,
    bdmf_address_data_port_data_3,
    bdmf_address_data_port_data_4,
    bdmf_address_data_port_data_5,
    bdmf_address_data_port_data_6,
    bdmf_address_data_port_data_7,
    bdmf_address_llid_0,
    bdmf_address_llid_1,
    bdmf_address_llid_2,
    bdmf_address_llid_3,
    ...
    bdmf_address_data_port_data_8,
    bdmf_address_data_port_data_9,
    bdmf_address_data_port_data_10,
    bdmf_address_data_port_data_11,
    bdmf_address_sec_tx_ssci,
    bdmf_address_sec_tx_salt_0,
    bdmf_address_sec_tx_salt_1,
    bdmf_address_sec_tx_salt_2,
    bdmf_address_sec_rx_ssci,
    bdmf_address_sec_rx_salt_0,
    bdmf_address_sec_rx_salt_1,
    bdmf_address_sec_rx_salt_2,
}
bdmf_address;
...
static int bcm_lif_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        lif_pon_inter_op_control pon_inter_op_control = { .cf_tx_lif_allow_overlp_b2b=parm[1].value.unumber, .cfipgfilter=parm[2].value.unumber, .cfdisableloslaserblock=parm[3].value.unumber, .cfgllidpromiscuousmode=parm[4].value.unumber, .cfgllidmodmsk=parm[5].value.unumber, .cfusefecipg=parm[6].value.unumber, .cfrxcrc8invchk=parm[7].value.unumber, .cfrxcrc8bitswap=parm[8].value.unumber, .cfrxcrc8msb2lsb=parm[9].value.unumber, .cfrxcrc8disable=parm[10].value.unumber, .cftxllidbit15set=parm[11].value.unumber, .cftxcrc8inv=parm[12].value.unumber, .cftxcrc8bad=parm[13].value.unumber, .cftxcrc8bitswap=parm[14].value.unumber, .cftxcrc8msb2lsb=parm[15].value.unumber, .cftxshortpre=parm[16].value.unumber, .cftxipgcnt=parm[17].value.unumber, .cftxaasynclen=parm[18].value.unumber, .cftxpipedelay=parm[19].value.unumber};
    ...
    case BDMF_data_port_data_0:
        err = ag_drv_lif_data_port_data_0_set(parm[1].value.unumber);
        break;
    case BDMF_data_port_data_1:
        err = ag_drv_lif_data_port_data_1_set(parm[1].value.unumber);
        break;
    case BDMF_data_port_data_2:
        err = ag_drv_lif_data_port_data_2_set(parm[1].value.unumber);
        break;
    case BDMF_data_port_data_3:
        err = ag_drv_lif_data_port_data_3_set(parm[1].value.unumber);
        break;
    case BDMF_data_port_data_4:
        err = ag_drv_lif_data_port_data_4_set(parm[1].value.unumber);
        break;
    case BDMF_data_port_data_5:
        err = ag_drv_lif_data_port_data_5_set(parm[1].value.unumber);
        break;
    case BDMF_data_port_data_6:
        err = ag_drv_lif_data_port_data_6_set(parm[1].value.unumber);
        break;
    case BDMF_data_port_data_7:
        err = ag_drv_lif_data_port_data_7_set(parm[1].value.unumber);
        break;
    case BDMF_llid_0:
    ...
    case BDMF_p2p_inter_op_control:
        err = ag_drv_lif_p2p_inter_op_control_set(parm[3].value.unumber, parm[4].value.unumber, parm[5].value.unumber, parm[6].value.unumber);
        break;
    ...
    {
        lif_sec_control_2 sec_control_2 = { .cfgensecoutffprime=parm[3].value.unumber, .cfgenaes_256_up=parm[4].value.unumber, .cfgenaes_256_dn=parm[5].value.unumber, .cfg_macsec_xpn_tx=parm[6].value.unumber, .cfg_macsec_xpn_rx=parm[7].value.unumber, .cfgkeynum_4_an_3=parm[8].value.unumber, .cfgkeynum_4_an_2=parm[9].value.unumber, .cfgkeynum_4_an_1=parm[10].value.unumber, .cfgkeynum_4_an_0=parm[11].value.unumber};
        err = ag_drv_lif_sec_control_2_set(&sec_control_2);
        break;
    }
    ...
    case BDMF_1588_ts_sync_offset:
        err = ag_drv_lif_1588_ts_sync_offset_set(parm[3].value.unumber, parm[4].value.unumber, parm[5].value.unumber);
        break;
    case BDMF_data_port_data_8:
        err = ag_drv_lif_data_port_data_8_set(parm[3].value.unumber);
        break;
    case BDMF_data_port_data_9:
        err = ag_drv_lif_data_port_data_9_set(parm[3].value.unumber);
        break;
    case BDMF_data_port_data_10:
        err = ag_drv_lif_data_port_data_10_set(parm[3].value.unumber);
        break;
    case BDMF_data_port_data_11:
        err = ag_drv_lif_data_port_data_11_set(parm[3].value.unumber);
        break;
    case BDMF_sec_tx_ssci:
        err = ag_drv_lif_sec_tx_ssci_set(parm[3].value.unumber);
        break;
    case BDMF_sec_tx_salt_0:
        err = ag_drv_lif_sec_tx_salt_0_set(parm[3].value.unumber);
        break;
    case BDMF_sec_tx_salt_1:
        err = ag_drv_lif_sec_tx_salt_1_set(parm[3].value.unumber);
        break;
    case BDMF_sec_tx_salt_2:
        err = ag_drv_lif_sec_tx_salt_2_set(parm[3].value.unumber);
        break;
    case BDMF_sec_rx_ssci:
        err = ag_drv_lif_sec_rx_ssci_set(parm[3].value.unumber);
        break;
    case BDMF_sec_rx_salt_0:
        err = ag_drv_lif_sec_rx_salt_0_set(parm[3].value.unumber);
        break;
    case BDMF_sec_rx_salt_1:
        err = ag_drv_lif_sec_rx_salt_1_set(parm[3].value.unumber);
        break;
    case BDMF_sec_rx_salt_2:
        err = ag_drv_lif_sec_rx_salt_2_set(parm[3].value.unumber);
        break;
    default:
...
static int bcm_lif_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case BDMF_pon_inter_op_control:
    {
        ...
        bdmf_session_print(session, "cf_tx_lif_allow_overlp_b2b = %u = 0x%x\n", pon_inter_op_control.cf_tx_lif_allow_overlp_b2b, pon_inter_op_control.cf_tx_lif_allow_overlp_b2b);
    ...
    case BDMF_data_port_data_0:
    {
        uint32_t pbiportdata0;
        err = ag_drv_lif_data_port_data_0_get(&pbiportdata0);
        bdmf_session_print(session, "pbiportdata0 = %u = 0x%x\n", pbiportdata0, pbiportdata0);
        break;
    }
    case BDMF_data_port_data_1:
    {
        uint32_t pbiportdata1;
        err = ag_drv_lif_data_port_data_1_get(&pbiportdata1);
        bdmf_session_print(session, "pbiportdata1 = %u = 0x%x\n", pbiportdata1, pbiportdata1);
        break;
    }
    case BDMF_data_port_data_2:
    {
        uint32_t pbiportdata2;
        err = ag_drv_lif_data_port_data_2_get(&pbiportdata2);
        bdmf_session_print(session, "pbiportdata2 = %u = 0x%x\n", pbiportdata2, pbiportdata2);
        break;
    }
    case BDMF_data_port_data_3:
    {
        uint32_t pbiportdata3;
        err = ag_drv_lif_data_port_data_3_get(&pbiportdata3);
        bdmf_session_print(session, "pbiportdata3 = %u = 0x%x\n", pbiportdata3, pbiportdata3);
        break;
    }
    case BDMF_data_port_data_4:
    {
        uint32_t pbiportdata4;
        err = ag_drv_lif_data_port_data_4_get(&pbiportdata4);
        bdmf_session_print(session, "pbiportdata4 = %u = 0x%x\n", pbiportdata4, pbiportdata4);
        break;
    }
    case BDMF_data_port_data_5:
    {
        uint32_t pbiportdata5;
        err = ag_drv_lif_data_port_data_5_get(&pbiportdata5);
        bdmf_session_print(session, "pbiportdata5 = %u = 0x%x\n", pbiportdata5, pbiportdata5);
        break;
    }
    case BDMF_data_port_data_6:
    {
        uint32_t pbiportdata6;
        err = ag_drv_lif_data_port_data_6_get(&pbiportdata6);
        bdmf_session_print(session, "pbiportdata6 = %u = 0x%x\n", pbiportdata6, pbiportdata6);
        break;
    }
    case BDMF_data_port_data_7:
    {
        uint32_t pbiportdata7;
        err = ag_drv_lif_data_port_data_7_get(&pbiportdata7);
        bdmf_session_print(session, "pbiportdata7 = %u = 0x%x\n", pbiportdata7, pbiportdata7);
        break;
    }
    case BDMF_llid_0:
    {
    ...
    case BDMF_p2p_inter_op_control:
    {
        bdmf_boolean cfp2pmaskoneprecidle;
        ...
        err = ag_drv_lif_p2p_inter_op_control_get(&cfp2pmaskoneprecidle, &cfp2pmodetransmitremfault, &cfp2pmodetransmitdeficitidleenable, &cfp2pmodeadaptiveshortpre);
        bdmf_session_print(session, "cfp2pmaskoneprecidle = %u = 0x%x\n", cfp2pmaskoneprecidle, cfp2pmaskoneprecidle);
    ...
    case BDMF_sec_control_2:
    {
        lif_sec_control_2 sec_control_2;
        err = ag_drv_lif_sec_control_2_get(&sec_control_2);
        bdmf_session_print(session, "cfgensecoutffprime = %u = 0x%x\n", sec_control_2.cfgensecoutffprime, sec_control_2.cfgensecoutffprime);
        bdmf_session_print(session, "cfgenaes_256_up = %u = 0x%x\n", sec_control_2.cfgenaes_256_up, sec_control_2.cfgenaes_256_up);
        bdmf_session_print(session, "cfgenaes_256_dn = %u = 0x%x\n", sec_control_2.cfgenaes_256_dn, sec_control_2.cfgenaes_256_dn);
        bdmf_session_print(session, "cfg_macsec_xpn_tx = %u = 0x%x\n", sec_control_2.cfg_macsec_xpn_tx, sec_control_2.cfg_macsec_xpn_tx);
        bdmf_session_print(session, "cfg_macsec_xpn_rx = %u = 0x%x\n", sec_control_2.cfg_macsec_xpn_rx, sec_control_2.cfg_macsec_xpn_rx);
        bdmf_session_print(session, "cfgkeynum_4_an_3 = %u = 0x%x\n", sec_control_2.cfgkeynum_4_an_3, sec_control_2.cfgkeynum_4_an_3);
        bdmf_session_print(session, "cfgkeynum_4_an_2 = %u = 0x%x\n", sec_control_2.cfgkeynum_4_an_2, sec_control_2.cfgkeynum_4_an_2);
        bdmf_session_print(session, "cfgkeynum_4_an_1 = %u = 0x%x\n", sec_control_2.cfgkeynum_4_an_1, sec_control_2.cfgkeynum_4_an_1);
        bdmf_session_print(session, "cfgkeynum_4_an_0 = %u = 0x%x\n", sec_control_2.cfgkeynum_4_an_0, sec_control_2.cfgkeynum_4_an_0);
        break;
    }
    case BDMF_sec_mpcp_offset:
    {
    ...
    case BDMF_1588_ts_sync_offset:
    {
        ...
        err = ag_drv_lif_1588_ts_sync_offset_get(&cfg_ts48_sync_ns_increment, &cfgtssyncoffset_312, &cfgtssyncoffset_125);
    ...
    case BDMF_data_port_data_8:
    {
        uint32_t pbiportdata8;
        err = ag_drv_lif_data_port_data_8_get(&pbiportdata8);
        bdmf_session_print(session, "pbiportdata8 = %u = 0x%x\n", pbiportdata8, pbiportdata8);
        break;
    }
    case BDMF_data_port_data_9:
    {
        uint32_t pbiportdata9;
        err = ag_drv_lif_data_port_data_9_get(&pbiportdata9);
        bdmf_session_print(session, "pbiportdata9 = %u = 0x%x\n", pbiportdata9, pbiportdata9);
        break;
    }
    case BDMF_data_port_data_10:
    {
        uint32_t pbiportdata10;
        err = ag_drv_lif_data_port_data_10_get(&pbiportdata10);
        bdmf_session_print(session, "pbiportdata10 = %u = 0x%x\n", pbiportdata10, pbiportdata10);
        break;
    }
    case BDMF_data_port_data_11:
    {
        uint32_t pbiportdata11;
        err = ag_drv_lif_data_port_data_11_get(&pbiportdata11);
        bdmf_session_print(session, "pbiportdata11 = %u = 0x%x\n", pbiportdata11, pbiportdata11);
        break;
    }
    case BDMF_sec_tx_ssci:
    {
        uint32_t cfg_macsec_xpn_tx_ssci;
        err = ag_drv_lif_sec_tx_ssci_get(&cfg_macsec_xpn_tx_ssci);
        bdmf_session_print(session, "cfg_macsec_xpn_tx_ssci = %u = 0x%x\n", cfg_macsec_xpn_tx_ssci, cfg_macsec_xpn_tx_ssci);
        break;
    }
    case BDMF_sec_tx_salt_0:
    {
        uint32_t cfg_macsec_xpn_tx_salt_0;
        err = ag_drv_lif_sec_tx_salt_0_get(&cfg_macsec_xpn_tx_salt_0);
        bdmf_session_print(session, "cfg_macsec_xpn_tx_salt_0 = %u = 0x%x\n", cfg_macsec_xpn_tx_salt_0, cfg_macsec_xpn_tx_salt_0);
        break;
    }
    case BDMF_sec_tx_salt_1:
    {
        uint32_t cfg_macsec_xpn_tx_salt_1;
        err = ag_drv_lif_sec_tx_salt_1_get(&cfg_macsec_xpn_tx_salt_1);
        bdmf_session_print(session, "cfg_macsec_xpn_tx_salt_1 = %u = 0x%x\n", cfg_macsec_xpn_tx_salt_1, cfg_macsec_xpn_tx_salt_1);
        break;
    }
    case BDMF_sec_tx_salt_2:
    {
        uint32_t cfg_macsec_xpn_tx_salt_2;
        err = ag_drv_lif_sec_tx_salt_2_get(&cfg_macsec_xpn_tx_salt_2);
        bdmf_session_print(session, "cfg_macsec_xpn_tx_salt_2 = %u = 0x%x\n", cfg_macsec_xpn_tx_salt_2, cfg_macsec_xpn_tx_salt_2);
        break;
    }
    case BDMF_sec_rx_ssci:
    {
        uint32_t cfg_macsec_xpn_rx_ssci;
        err = ag_drv_lif_sec_rx_ssci_get(&cfg_macsec_xpn_rx_ssci);
        bdmf_session_print(session, "cfg_macsec_xpn_rx_ssci = %u = 0x%x\n", cfg_macsec_xpn_rx_ssci, cfg_macsec_xpn_rx_ssci);
        break;
    }
    case BDMF_sec_rx_salt_0:
    {
        uint32_t cfg_macsec_xpn_rx_salt_0;
        err = ag_drv_lif_sec_rx_salt_0_get(&cfg_macsec_xpn_rx_salt_0);
        bdmf_session_print(session, "cfg_macsec_xpn_rx_salt_0 = %u = 0x%x\n", cfg_macsec_xpn_rx_salt_0, cfg_macsec_xpn_rx_salt_0);
        break;
    }
    case BDMF_sec_rx_salt_1:
    {
        uint32_t cfg_macsec_xpn_rx_salt_1;
        err = ag_drv_lif_sec_rx_salt_1_get(&cfg_macsec_xpn_rx_salt_1);
        bdmf_session_print(session, "cfg_macsec_xpn_rx_salt_1 = %u = 0x%x\n", cfg_macsec_xpn_rx_salt_1, cfg_macsec_xpn_rx_salt_1);
        break;
    }
    case BDMF_sec_rx_salt_2:
    {
        uint32_t cfg_macsec_xpn_rx_salt_2;
        err = ag_drv_lif_sec_rx_salt_2_get(&cfg_macsec_xpn_rx_salt_2);
        bdmf_session_print(session, "cfg_macsec_xpn_rx_salt_2 = %u = 0x%x\n", cfg_macsec_xpn_rx_salt_2, cfg_macsec_xpn_rx_salt_2);
        break;
    }
    default:
        err = BDMF_ERR_NOT_SUPPORTED;
...
static int bcm_lif_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_lif_pon_inter_op_control_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", pon_inter_op_control.cf_tx_lif_allow_overlp_b2b, pon_inter_op_control.cfipgfilter, pon_inter_op_control.cfdisableloslaserblock, pon_inter_op_control.cfgllidpromiscuousmode, pon_inter_op_control.cfgllidmodmsk, pon_inter_op_control.cfusefecipg, pon_inter_op_control.cfrxcrc8invchk, pon_inter_op_control.cfrxcrc8bitswap, pon_inter_op_control.cfrxcrc8msb2lsb, pon_inter_op_control.cfrxcrc8disable, pon_inter_op_control.cftxllidbit15set, pon_inter_op_control.cftxcrc8inv, pon_inter_op_control.cftxcrc8bad, pon_inter_op_control.cftxcrc8bitswap, pon_inter_op_control.cftxcrc8msb2lsb, pon_inter_op_control.cftxshortpre, pon_inter_op_control.cftxipgcnt, pon_inter_op_control.cftxaasynclen, pon_inter_op_control.cftxpipedelay);
        if(err || pon_inter_op_control.cf_tx_lif_allow_overlp_b2b!=gtmv(m, 1) || pon_inter_op_control.cfipgfilter!=gtmv(m, 4) || pon_inter_op_control.cfdisableloslaserblock!=gtmv(m, 1) || pon_inter_op_control.cfgllidpromiscuousmode!=gtmv(m, 1) || pon_inter_op_control.cfgllidmodmsk!=gtmv(m, 1) || pon_inter_op_control.cfusefecipg!=gtmv(m, 1) || pon_inter_op_control.cfrxcrc8invchk!=gtmv(m, 1) || pon_inter_op_control.cfrxcrc8bitswap!=gtmv(m, 1) || pon_inter_op_control.cfrxcrc8msb2lsb!=gtmv(m, 1) || pon_inter_op_control.cfrxcrc8disable!=gtmv(m, 1) || pon_inter_op_control.cftxllidbit15set!=gtmv(m, 1) || pon_inter_op_control.cftxcrc8inv!=gtmv(m, 1) || pon_inter_op_control.cftxcrc8bad!=gtmv(m, 1) || pon_inter_op_control.cftxcrc8bitswap!=gtmv(m, 1) || pon_inter_op_control.cftxcrc8msb2lsb!=gtmv(m, 1) || pon_inter_op_control.cftxshortpre!=gtmv(m, 1) || pon_inter_op_control.cftxipgcnt!=gtmv(m, 4) || pon_inter_op_control.cftxaasynclen!=gtmv(m, 4) || pon_inter_op_control.cftxpipedelay!=gtmv(m, 4))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        uint32_t pbiportdata0=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_0_set( %u)\n", pbiportdata0);
        if(!err) ag_drv_lif_data_port_data_0_set(pbiportdata0);
        if(!err) ag_drv_lif_data_port_data_0_get( &pbiportdata0);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_0_get( %u)\n", pbiportdata0);
        if(err || pbiportdata0!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t pbiportdata1=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_1_set( %u)\n", pbiportdata1);
        if(!err) ag_drv_lif_data_port_data_1_set(pbiportdata1);
        if(!err) ag_drv_lif_data_port_data_1_get( &pbiportdata1);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_1_get( %u)\n", pbiportdata1);
        if(err || pbiportdata1!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t pbiportdata2=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_2_set( %u)\n", pbiportdata2);
        if(!err) ag_drv_lif_data_port_data_2_set(pbiportdata2);
        if(!err) ag_drv_lif_data_port_data_2_get( &pbiportdata2);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_2_get( %u)\n", pbiportdata2);
        if(err || pbiportdata2!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t pbiportdata3=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_3_set( %u)\n", pbiportdata3);
        if(!err) ag_drv_lif_data_port_data_3_set(pbiportdata3);
        if(!err) ag_drv_lif_data_port_data_3_get( &pbiportdata3);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_3_get( %u)\n", pbiportdata3);
        if(err || pbiportdata3!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t pbiportdata4=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_4_set( %u)\n", pbiportdata4);
        if(!err) ag_drv_lif_data_port_data_4_set(pbiportdata4);
        if(!err) ag_drv_lif_data_port_data_4_get( &pbiportdata4);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_4_get( %u)\n", pbiportdata4);
        if(err || pbiportdata4!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t pbiportdata5=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_5_set( %u)\n", pbiportdata5);
        if(!err) ag_drv_lif_data_port_data_5_set(pbiportdata5);
        if(!err) ag_drv_lif_data_port_data_5_get( &pbiportdata5);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_5_get( %u)\n", pbiportdata5);
        if(err || pbiportdata5!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t pbiportdata6=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_6_set( %u)\n", pbiportdata6);
        if(!err) ag_drv_lif_data_port_data_6_set(pbiportdata6);
        if(!err) ag_drv_lif_data_port_data_6_get( &pbiportdata6);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_6_get( %u)\n", pbiportdata6);
        if(err || pbiportdata6!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t pbiportdata7=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_7_set( %u)\n", pbiportdata7);
        if(!err) ag_drv_lif_data_port_data_7_set(pbiportdata7);
        if(!err) ag_drv_lif_data_port_data_7_get( &pbiportdata7);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_7_get( %u)\n", pbiportdata7);
        if(err || pbiportdata7!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        bdmf_boolean cfp2pmaskoneprecidle=gtmv(m, 1);
        ...
        if(!err) bdmf_session_print(session, "ag_drv_lif_p2p_inter_op_control_set( %u %u %u %u)\n", cfp2pmaskoneprecidle, cfp2pmodetransmitremfault, cfp2pmodetransmitdeficitidleenable, cfp2pmodeadaptiveshortpre);
        if(!err) ag_drv_lif_p2p_inter_op_control_set(cfp2pmaskoneprecidle, cfp2pmodetransmitremfault, cfp2pmodetransmitdeficitidleenable, cfp2pmodeadaptiveshortpre);
        if(!err) ag_drv_lif_p2p_inter_op_control_get( &cfp2pmaskoneprecidle, &cfp2pmodetransmitremfault, &cfp2pmodetransmitdeficitidleenable, &cfp2pmodeadaptiveshortpre);
        if(!err) bdmf_session_print(session, "ag_drv_lif_p2p_inter_op_control_get( %u %u %u %u)\n", cfp2pmaskoneprecidle, cfp2pmodetransmitremfault, cfp2pmodetransmitdeficitidleenable, cfp2pmodeadaptiveshortpre);
        if(err || cfp2pmaskoneprecidle!=gtmv(m, 1) || cfp2pmodetransmitremfault!=gtmv(m, 1) || cfp2pmodetransmitdeficitidleenable!=gtmv(m, 1) || cfp2pmodeadaptiveshortpre!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        lif_sec_control_2 sec_control_2 = {.cfgensecoutffprime=gtmv(m, 1), .cfgenaes_256_up=gtmv(m, 1), .cfgenaes_256_dn=gtmv(m, 1), .cfg_macsec_xpn_tx=gtmv(m, 1), .cfg_macsec_xpn_rx=gtmv(m, 1), .cfgkeynum_4_an_3=gtmv(m, 1), .cfgkeynum_4_an_2=gtmv(m, 1), .cfgkeynum_4_an_1=gtmv(m, 1), .cfgkeynum_4_an_0=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_control_2_set( %u %u %u %u %u %u %u %u %u)\n", sec_control_2.cfgensecoutffprime, sec_control_2.cfgenaes_256_up, sec_control_2.cfgenaes_256_dn, sec_control_2.cfg_macsec_xpn_tx, sec_control_2.cfg_macsec_xpn_rx, sec_control_2.cfgkeynum_4_an_3, sec_control_2.cfgkeynum_4_an_2, sec_control_2.cfgkeynum_4_an_1, sec_control_2.cfgkeynum_4_an_0);
        if(!err) ag_drv_lif_sec_control_2_set(&sec_control_2);
        if(!err) ag_drv_lif_sec_control_2_get( &sec_control_2);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_control_2_get( %u %u %u %u %u %u %u %u %u)\n", sec_control_2.cfgensecoutffprime, sec_control_2.cfgenaes_256_up, sec_control_2.cfgenaes_256_dn, sec_control_2.cfg_macsec_xpn_tx, sec_control_2.cfg_macsec_xpn_rx, sec_control_2.cfgkeynum_4_an_3, sec_control_2.cfgkeynum_4_an_2, sec_control_2.cfgkeynum_4_an_1, sec_control_2.cfgkeynum_4_an_0);
        if(err || sec_control_2.cfgensecoutffprime!=gtmv(m, 1) || sec_control_2.cfgenaes_256_up!=gtmv(m, 1) || sec_control_2.cfgenaes_256_dn!=gtmv(m, 1) || sec_control_2.cfg_macsec_xpn_tx!=gtmv(m, 1) || sec_control_2.cfg_macsec_xpn_rx!=gtmv(m, 1) || sec_control_2.cfgkeynum_4_an_3!=gtmv(m, 1) || sec_control_2.cfgkeynum_4_an_2!=gtmv(m, 1) || sec_control_2.cfgkeynum_4_an_1!=gtmv(m, 1) || sec_control_2.cfgkeynum_4_an_0!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_lif_1588_ts_sync_offset_set( %u %u %u)\n", cfg_ts48_sync_ns_increment, cfgtssyncoffset_312, cfgtssyncoffset_125);
        if(!err) ag_drv_lif_1588_ts_sync_offset_set(cfg_ts48_sync_ns_increment, cfgtssyncoffset_312, cfgtssyncoffset_125);
        if(!err) ag_drv_lif_1588_ts_sync_offset_get( &cfg_ts48_sync_ns_increment, &cfgtssyncoffset_312, &cfgtssyncoffset_125);
        if(!err) bdmf_session_print(session, "ag_drv_lif_1588_ts_sync_offset_get( %u %u %u)\n", cfg_ts48_sync_ns_increment, cfgtssyncoffset_312, cfgtssyncoffset_125);
        if(err || cfg_ts48_sync_ns_increment!=gtmv(m, 1) || cfgtssyncoffset_312!=gtmv(m, 9) || cfgtssyncoffset_125!=gtmv(m, 9))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t pbiportdata8=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_8_set( %u)\n", pbiportdata8);
        if(!err) ag_drv_lif_data_port_data_8_set(pbiportdata8);
        if(!err) ag_drv_lif_data_port_data_8_get( &pbiportdata8);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_8_get( %u)\n", pbiportdata8);
        if(err || pbiportdata8!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t pbiportdata9=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_9_set( %u)\n", pbiportdata9);
        if(!err) ag_drv_lif_data_port_data_9_set(pbiportdata9);
        if(!err) ag_drv_lif_data_port_data_9_get( &pbiportdata9);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_9_get( %u)\n", pbiportdata9);
        if(err || pbiportdata9!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t pbiportdata10=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_10_set( %u)\n", pbiportdata10);
        if(!err) ag_drv_lif_data_port_data_10_set(pbiportdata10);
        if(!err) ag_drv_lif_data_port_data_10_get( &pbiportdata10);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_10_get( %u)\n", pbiportdata10);
        if(err || pbiportdata10!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t pbiportdata11=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_11_set( %u)\n", pbiportdata11);
        if(!err) ag_drv_lif_data_port_data_11_set(pbiportdata11);
        if(!err) ag_drv_lif_data_port_data_11_get( &pbiportdata11);
        if(!err) bdmf_session_print(session, "ag_drv_lif_data_port_data_11_get( %u)\n", pbiportdata11);
        if(err || pbiportdata11!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_tx_ssci=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_tx_ssci_set( %u)\n", cfg_macsec_xpn_tx_ssci);
        if(!err) ag_drv_lif_sec_tx_ssci_set(cfg_macsec_xpn_tx_ssci);
        if(!err) ag_drv_lif_sec_tx_ssci_get( &cfg_macsec_xpn_tx_ssci);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_tx_ssci_get( %u)\n", cfg_macsec_xpn_tx_ssci);
        if(err || cfg_macsec_xpn_tx_ssci!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_tx_salt_0=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_tx_salt_0_set( %u)\n", cfg_macsec_xpn_tx_salt_0);
        if(!err) ag_drv_lif_sec_tx_salt_0_set(cfg_macsec_xpn_tx_salt_0);
        if(!err) ag_drv_lif_sec_tx_salt_0_get( &cfg_macsec_xpn_tx_salt_0);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_tx_salt_0_get( %u)\n", cfg_macsec_xpn_tx_salt_0);
        if(err || cfg_macsec_xpn_tx_salt_0!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_tx_salt_1=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_tx_salt_1_set( %u)\n", cfg_macsec_xpn_tx_salt_1);
        if(!err) ag_drv_lif_sec_tx_salt_1_set(cfg_macsec_xpn_tx_salt_1);
        if(!err) ag_drv_lif_sec_tx_salt_1_get( &cfg_macsec_xpn_tx_salt_1);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_tx_salt_1_get( %u)\n", cfg_macsec_xpn_tx_salt_1);
        if(err || cfg_macsec_xpn_tx_salt_1!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_tx_salt_2=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_tx_salt_2_set( %u)\n", cfg_macsec_xpn_tx_salt_2);
        if(!err) ag_drv_lif_sec_tx_salt_2_set(cfg_macsec_xpn_tx_salt_2);
        if(!err) ag_drv_lif_sec_tx_salt_2_get( &cfg_macsec_xpn_tx_salt_2);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_tx_salt_2_get( %u)\n", cfg_macsec_xpn_tx_salt_2);
        if(err || cfg_macsec_xpn_tx_salt_2!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_rx_ssci=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_rx_ssci_set( %u)\n", cfg_macsec_xpn_rx_ssci);
        if(!err) ag_drv_lif_sec_rx_ssci_set(cfg_macsec_xpn_rx_ssci);
        if(!err) ag_drv_lif_sec_rx_ssci_get( &cfg_macsec_xpn_rx_ssci);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_rx_ssci_get( %u)\n", cfg_macsec_xpn_rx_ssci);
        if(err || cfg_macsec_xpn_rx_ssci!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_rx_salt_0=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_rx_salt_0_set( %u)\n", cfg_macsec_xpn_rx_salt_0);
        if(!err) ag_drv_lif_sec_rx_salt_0_set(cfg_macsec_xpn_rx_salt_0);
        if(!err) ag_drv_lif_sec_rx_salt_0_get( &cfg_macsec_xpn_rx_salt_0);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_rx_salt_0_get( %u)\n", cfg_macsec_xpn_rx_salt_0);
        if(err || cfg_macsec_xpn_rx_salt_0!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_rx_salt_1=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_rx_salt_1_set( %u)\n", cfg_macsec_xpn_rx_salt_1);
        if(!err) ag_drv_lif_sec_rx_salt_1_set(cfg_macsec_xpn_rx_salt_1);
        if(!err) ag_drv_lif_sec_rx_salt_1_get( &cfg_macsec_xpn_rx_salt_1);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_rx_salt_1_get( %u)\n", cfg_macsec_xpn_rx_salt_1);
        if(err || cfg_macsec_xpn_rx_salt_1!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_rx_salt_2=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_rx_salt_2_set( %u)\n", cfg_macsec_xpn_rx_salt_2);
        if(!err) ag_drv_lif_sec_rx_salt_2_set(cfg_macsec_xpn_rx_salt_2);
        if(!err) ag_drv_lif_sec_rx_salt_2_get( &cfg_macsec_xpn_rx_salt_2);
        if(!err) bdmf_session_print(session, "ag_drv_lif_sec_rx_salt_2_get( %u)\n", cfg_macsec_xpn_rx_salt_2);
        if(err || cfg_macsec_xpn_rx_salt_2!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    return err;
}
...
static int bcm_lif_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case bdmf_address_data_port_data_0 : reg = &RU_REG(LIF, DATA_PORT_DATA_0); blk = &RU_BLK(LIF); break;
    case bdmf_address_data_port_data_1 : reg = &RU_REG(LIF, DATA_PORT_DATA_1); blk = &RU_BLK(LIF); break;
    case bdmf_address_data_port_data_2 : reg = &RU_REG(LIF, DATA_PORT_DATA_2); blk = &RU_BLK(LIF); break;
    case bdmf_address_data_port_data_3 : reg = &RU_REG(LIF, DATA_PORT_DATA_3); blk = &RU_BLK(LIF); break;
    case bdmf_address_data_port_data_4 : reg = &RU_REG(LIF, DATA_PORT_DATA_4); blk = &RU_BLK(LIF); break;
    case bdmf_address_data_port_data_5 : reg = &RU_REG(LIF, DATA_PORT_DATA_5); blk = &RU_BLK(LIF); break;
    case bdmf_address_data_port_data_6 : reg = &RU_REG(LIF, DATA_PORT_DATA_6); blk = &RU_BLK(LIF); break;
    case bdmf_address_data_port_data_7 : reg = &RU_REG(LIF, DATA_PORT_DATA_7); blk = &RU_BLK(LIF); break;
    ...
    case bdmf_address_1588_ts_sync_offset : reg = &RU_REG(LIF, 1588_TS_SYNC_OFFSET); blk = &RU_BLK(LIF); break;
    case bdmf_address_data_port_data_8 : reg = &RU_REG(LIF, DATA_PORT_DATA_8); blk = &RU_BLK(LIF); break;
    case bdmf_address_data_port_data_9 : reg = &RU_REG(LIF, DATA_PORT_DATA_9); blk = &RU_BLK(LIF); break;
    case bdmf_address_data_port_data_10 : reg = &RU_REG(LIF, DATA_PORT_DATA_10); blk = &RU_BLK(LIF); break;
    case bdmf_address_data_port_data_11 : reg = &RU_REG(LIF, DATA_PORT_DATA_11); blk = &RU_BLK(LIF); break;
    case bdmf_address_sec_tx_ssci : reg = &RU_REG(LIF, SEC_TX_SSCI); blk = &RU_BLK(LIF); break;
    case bdmf_address_sec_tx_salt_0 : reg = &RU_REG(LIF, SEC_TX_SALT_0); blk = &RU_BLK(LIF); break;
    case bdmf_address_sec_tx_salt_1 : reg = &RU_REG(LIF, SEC_TX_SALT_1); blk = &RU_BLK(LIF); break;
    case bdmf_address_sec_tx_salt_2 : reg = &RU_REG(LIF, SEC_TX_SALT_2); blk = &RU_BLK(LIF); break;
    case bdmf_address_sec_rx_ssci : reg = &RU_REG(LIF, SEC_RX_SSCI); blk = &RU_BLK(LIF); break;
    case bdmf_address_sec_rx_salt_0 : reg = &RU_REG(LIF, SEC_RX_SALT_0); blk = &RU_BLK(LIF); break;
    case bdmf_address_sec_rx_salt_1 : reg = &RU_REG(LIF, SEC_RX_SALT_1); blk = &RU_BLK(LIF); break;
    case bdmf_address_sec_rx_salt_2 : reg = &RU_REG(LIF, SEC_RX_SALT_2); blk = &RU_BLK(LIF); break;
    default :
...
bdmfmon_handle_t ag_drv_lif_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_pon_inter_op_control[]={
            BDMFMON_MAKE_PARM("cf_tx_lif_allow_overlp_b2b", "cf_tx_lif_allow_overlp_b2b", BDMFMON_PARM_NUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_data_port_data_0[]={
            BDMFMON_MAKE_PARM("pbiportdata0", "pbiportdata0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_data_port_data_1[]={
            BDMFMON_MAKE_PARM("pbiportdata1", "pbiportdata1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_data_port_data_2[]={
            BDMFMON_MAKE_PARM("pbiportdata2", "pbiportdata2", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_data_port_data_3[]={
            BDMFMON_MAKE_PARM("pbiportdata3", "pbiportdata3", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_data_port_data_4[]={
            BDMFMON_MAKE_PARM("pbiportdata4", "pbiportdata4", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_data_port_data_5[]={
            BDMFMON_MAKE_PARM("pbiportdata5", "pbiportdata5", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_data_port_data_6[]={
            BDMFMON_MAKE_PARM("pbiportdata6", "pbiportdata6", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_data_port_data_7[]={
            BDMFMON_MAKE_PARM("pbiportdata7", "pbiportdata7", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_p2p_inter_op_control[]={
            BDMFMON_MAKE_PARM("cfp2pmaskoneprecidle", "cfp2pmaskoneprecidle", BDMFMON_PARM_NUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_sec_control_2[]={
            BDMFMON_MAKE_PARM("cfgensecoutffprime", "cfgensecoutffprime", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgenaes_256_up", "cfgenaes_256_up", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgenaes_256_dn", "cfgenaes_256_dn", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfg_macsec_xpn_tx", "cfg_macsec_xpn_tx", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfg_macsec_xpn_rx", "cfg_macsec_xpn_rx", BDMFMON_PARM_NUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_data_port_data_8[]={
            BDMFMON_MAKE_PARM("pbiportdata8", "pbiportdata8", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_data_port_data_9[]={
            BDMFMON_MAKE_PARM("pbiportdata9", "pbiportdata9", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_data_port_data_10[]={
            BDMFMON_MAKE_PARM("pbiportdata10", "pbiportdata10", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_data_port_data_11[]={
            BDMFMON_MAKE_PARM("pbiportdata11", "pbiportdata11", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_sec_tx_ssci[]={
            BDMFMON_MAKE_PARM("cfg_macsec_xpn_tx_ssci", "cfg_macsec_xpn_tx_ssci", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_sec_tx_salt_0[]={
            BDMFMON_MAKE_PARM("cfg_macsec_xpn_tx_salt_0", "cfg_macsec_xpn_tx_salt_0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_sec_tx_salt_1[]={
            BDMFMON_MAKE_PARM("cfg_macsec_xpn_tx_salt_1", "cfg_macsec_xpn_tx_salt_1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_sec_tx_salt_2[]={
            BDMFMON_MAKE_PARM("cfg_macsec_xpn_tx_salt_2", "cfg_macsec_xpn_tx_salt_2", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_sec_rx_ssci[]={
            BDMFMON_MAKE_PARM("cfg_macsec_xpn_rx_ssci", "cfg_macsec_xpn_rx_ssci", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_sec_rx_salt_0[]={
            BDMFMON_MAKE_PARM("cfg_macsec_xpn_rx_salt_0", "cfg_macsec_xpn_rx_salt_0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_sec_rx_salt_1[]={
            BDMFMON_MAKE_PARM("cfg_macsec_xpn_rx_salt_1", "cfg_macsec_xpn_rx_salt_1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_sec_rx_salt_2[]={
            BDMFMON_MAKE_PARM("cfg_macsec_xpn_rx_salt_2", "cfg_macsec_xpn_rx_salt_2", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="data_port_data_1", .val=BDMF_data_port_data_1, .parms=set_data_port_data_1 },
            { .name="data_port_data_2", .val=BDMF_data_port_data_2, .parms=set_data_port_data_2 },
            { .name="data_port_data_3", .val=BDMF_data_port_data_3, .parms=set_data_port_data_3 },
            { .name="data_port_data_4", .val=BDMF_data_port_data_4, .parms=set_data_port_data_4 },
            { .name="data_port_data_5", .val=BDMF_data_port_data_5, .parms=set_data_port_data_5 },
            { .name="data_port_data_6", .val=BDMF_data_port_data_6, .parms=set_data_port_data_6 },
            { .name="data_port_data_7", .val=BDMF_data_port_data_7, .parms=set_data_port_data_7 },
            ...
            { .name="data_port_data_8", .val=BDMF_data_port_data_8, .parms=set_data_port_data_8 },
            { .name="data_port_data_9", .val=BDMF_data_port_data_9, .parms=set_data_port_data_9 },
            { .name="data_port_data_10", .val=BDMF_data_port_data_10, .parms=set_data_port_data_10 },
            { .name="data_port_data_11", .val=BDMF_data_port_data_11, .parms=set_data_port_data_11 },
            { .name="sec_tx_ssci", .val=BDMF_sec_tx_ssci, .parms=set_sec_tx_ssci },
            { .name="sec_tx_salt_0", .val=BDMF_sec_tx_salt_0, .parms=set_sec_tx_salt_0 },
            { .name="sec_tx_salt_1", .val=BDMF_sec_tx_salt_1, .parms=set_sec_tx_salt_1 },
            { .name="sec_tx_salt_2", .val=BDMF_sec_tx_salt_2, .parms=set_sec_tx_salt_2 },
            { .name="sec_rx_ssci", .val=BDMF_sec_rx_ssci, .parms=set_sec_rx_ssci },
            { .name="sec_rx_salt_0", .val=BDMF_sec_rx_salt_0, .parms=set_sec_rx_salt_0 },
            { .name="sec_rx_salt_1", .val=BDMF_sec_rx_salt_1, .parms=set_sec_rx_salt_1 },
            { .name="sec_rx_salt_2", .val=BDMF_sec_rx_salt_2, .parms=set_sec_rx_salt_2 },
            BDMFMON_ENUM_LAST
        };
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="data_port_data_1", .val=BDMF_data_port_data_1, .parms=set_default },
            { .name="data_port_data_2", .val=BDMF_data_port_data_2, .parms=set_default },
            { .name="data_port_data_3", .val=BDMF_data_port_data_3, .parms=set_default },
            { .name="data_port_data_4", .val=BDMF_data_port_data_4, .parms=set_default },
            { .name="data_port_data_5", .val=BDMF_data_port_data_5, .parms=set_default },
            { .name="data_port_data_6", .val=BDMF_data_port_data_6, .parms=set_default },
            { .name="data_port_data_7", .val=BDMF_data_port_data_7, .parms=set_default },
            ...
            { .name="data_port_data_8", .val=BDMF_data_port_data_8, .parms=set_default },
            { .name="data_port_data_9", .val=BDMF_data_port_data_9, .parms=set_default },
            { .name="data_port_data_10", .val=BDMF_data_port_data_10, .parms=set_default },
            { .name="data_port_data_11", .val=BDMF_data_port_data_11, .parms=set_default },
            { .name="sec_tx_ssci", .val=BDMF_sec_tx_ssci, .parms=set_default },
            { .name="sec_tx_salt_0", .val=BDMF_sec_tx_salt_0, .parms=set_default },
            { .name="sec_tx_salt_1", .val=BDMF_sec_tx_salt_1, .parms=set_default },
            { .name="sec_tx_salt_2", .val=BDMF_sec_tx_salt_2, .parms=set_default },
            { .name="sec_rx_ssci", .val=BDMF_sec_rx_ssci, .parms=set_default },
            { .name="sec_rx_salt_0", .val=BDMF_sec_rx_salt_0, .parms=set_default },
            { .name="sec_rx_salt_1", .val=BDMF_sec_rx_salt_1, .parms=set_default },
            { .name="sec_rx_salt_2", .val=BDMF_sec_rx_salt_2, .parms=set_default },
            BDMFMON_ENUM_LAST
        };
    ...
    }
    {
        static bdmfmon_enum_val_t enum_table_address[] = {
            ...
            { .name="DATA_PORT_DATA_1" , .val=bdmf_address_data_port_data_1 },
            { .name="DATA_PORT_DATA_2" , .val=bdmf_address_data_port_data_2 },
            { .name="DATA_PORT_DATA_3" , .val=bdmf_address_data_port_data_3 },
            { .name="DATA_PORT_DATA_4" , .val=bdmf_address_data_port_data_4 },
            { .name="DATA_PORT_DATA_5" , .val=bdmf_address_data_port_data_5 },
            { .name="DATA_PORT_DATA_6" , .val=bdmf_address_data_port_data_6 },
            { .name="DATA_PORT_DATA_7" , .val=bdmf_address_data_port_data_7 },
            ...
            { .name="DATA_PORT_DATA_8" , .val=bdmf_address_data_port_data_8 },
            { .name="DATA_PORT_DATA_9" , .val=bdmf_address_data_port_data_9 },
            { .name="DATA_PORT_DATA_10" , .val=bdmf_address_data_port_data_10 },
            { .name="DATA_PORT_DATA_11" , .val=bdmf_address_data_port_data_11 },
            { .name="SEC_TX_SSCI" , .val=bdmf_address_sec_tx_ssci },
            { .name="SEC_TX_SALT_0" , .val=bdmf_address_sec_tx_salt_0 },
            { .name="SEC_TX_SALT_1" , .val=bdmf_address_sec_tx_salt_1 },
            { .name="SEC_TX_SALT_2" , .val=bdmf_address_sec_tx_salt_2 },
            { .name="SEC_RX_SSCI" , .val=bdmf_address_sec_rx_ssci },
            { .name="SEC_RX_SALT_0" , .val=bdmf_address_sec_rx_salt_0 },
            { .name="SEC_RX_SALT_1" , .val=bdmf_address_sec_rx_salt_1 },
            { .name="SEC_RX_SALT_2" , .val=bdmf_address_sec_rx_salt_2 },
            BDMFMON_ENUM_LAST
        };
