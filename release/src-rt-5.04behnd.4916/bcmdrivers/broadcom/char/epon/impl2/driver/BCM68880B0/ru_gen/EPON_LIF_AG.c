...
/******************************************************************************
 * Field: LIF_PON_INTER_OP_CONTROL_CF_TX_LIF_ALLOW_OVERLP_B2B
 ******************************************************************************/
const ru_field_rec LIF_PON_INTER_OP_CONTROL_CF_TX_LIF_ALLOW_OVERLP_B2B_FIELD =
{
    "CF_TX_LIF_ALLOW_OVERLP_B2B",
#if RU_INCLUDE_DESC
    "",
    "0: Disable overlapping/B2B support. If EPN forwards overlapping or"
    "b2b grants for transmission to the LIF"
    "the laser will turn off and full overhead will be transmitted."
    "1: Enable overlapping/B2B support.  If EPN forwards overlapping or"
    "b2b grants for transmission to the LIF"
    "the laser will be kept on and overhead may be skipped depending"
    "on the overlap.",
#endif
    LIF_PON_INTER_OP_CONTROL_CF_TX_LIF_ALLOW_OVERLP_B2B_FIELD_MASK,
    0,
    LIF_PON_INTER_OP_CONTROL_CF_TX_LIF_ALLOW_OVERLP_B2B_FIELD_WIDTH,
    LIF_PON_INTER_OP_CONTROL_CF_TX_LIF_ALLOW_OVERLP_B2B_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
{
    &LIF_PON_INTER_OP_CONTROL_CF_TX_LIF_ALLOW_OVERLP_B2B_FIELD,
