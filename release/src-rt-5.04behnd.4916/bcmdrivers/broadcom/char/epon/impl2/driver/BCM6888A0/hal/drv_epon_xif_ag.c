...
{
    uint32_t reg_port_data_0=0;

#ifdef VALIDATE_PARMS
#endif

    reg_port_data_0 = RU_FIELD_SET(0, XIF, PORT_DATA_0, PORTDATA0, reg_port_data_0, portdata0);

    RU_REG_WRITE(0, XIF, PORT_DATA_0, reg_port_data_0);
...
bdmf_error_t ag_drv_xif_port_data_0_get(uint32_t *portdata0)
{
    ...
    RU_REG_READ(0, XIF, PORT_DATA_0, reg_port_data_0);

    *portdata0 = RU_FIELD_GET(0, XIF, PORT_DATA_0, PORTDATA0, reg_port_data_0);
...
{
    uint32_t reg_port_data_1=0;

#ifdef VALIDATE_PARMS
#endif

    reg_port_data_1 = RU_FIELD_SET(0, XIF, PORT_DATA_1, PORTDATA1, reg_port_data_1, portdata1);

    RU_REG_WRITE(0, XIF, PORT_DATA_1, reg_port_data_1);
...
bdmf_error_t ag_drv_xif_port_data_1_get(uint32_t *portdata1)
{
    ...
    RU_REG_READ(0, XIF, PORT_DATA_1, reg_port_data_1);

    *portdata1 = RU_FIELD_GET(0, XIF, PORT_DATA_1, PORTDATA1, reg_port_data_1);
...
{
    uint32_t reg_port_data_2=0;

#ifdef VALIDATE_PARMS
#endif

    reg_port_data_2 = RU_FIELD_SET(0, XIF, PORT_DATA_2, PORTDATA2, reg_port_data_2, portdata2);

    RU_REG_WRITE(0, XIF, PORT_DATA_2, reg_port_data_2);
...
bdmf_error_t ag_drv_xif_port_data_2_get(uint32_t *portdata2)
{
    ...
    RU_REG_READ(0, XIF, PORT_DATA_2, reg_port_data_2);

    *portdata2 = RU_FIELD_GET(0, XIF, PORT_DATA_2, PORTDATA2, reg_port_data_2);
...
{
    uint32_t reg_port_data_3=0;

#ifdef VALIDATE_PARMS
#endif

    reg_port_data_3 = RU_FIELD_SET(0, XIF, PORT_DATA_3, PORTDATA3, reg_port_data_3, portdata3);

    RU_REG_WRITE(0, XIF, PORT_DATA_3, reg_port_data_3);
...
bdmf_error_t ag_drv_xif_port_data_3_get(uint32_t *portdata3)
{
    ...
    RU_REG_READ(0, XIF, PORT_DATA_3, reg_port_data_3);

    *portdata3 = RU_FIELD_GET(0, XIF, PORT_DATA_3, PORTDATA3, reg_port_data_3);
...
{
    uint32_t reg_port_data_4=0;

#ifdef VALIDATE_PARMS
#endif

    reg_port_data_4 = RU_FIELD_SET(0, XIF, PORT_DATA_4, PORTDATA4, reg_port_data_4, portdata4);

    RU_REG_WRITE(0, XIF, PORT_DATA_4, reg_port_data_4);
...
bdmf_error_t ag_drv_xif_port_data_4_get(uint32_t *portdata4)
{
    ...
    RU_REG_READ(0, XIF, PORT_DATA_4, reg_port_data_4);

    *portdata4 = RU_FIELD_GET(0, XIF, PORT_DATA_4, PORTDATA4, reg_port_data_4);
...
{
    uint32_t reg_port_data_5=0;

#ifdef VALIDATE_PARMS
#endif

    reg_port_data_5 = RU_FIELD_SET(0, XIF, PORT_DATA_5, PORTDATA5, reg_port_data_5, portdata5);

    RU_REG_WRITE(0, XIF, PORT_DATA_5, reg_port_data_5);
...
bdmf_error_t ag_drv_xif_port_data_5_get(uint32_t *portdata5)
{
    ...
    RU_REG_READ(0, XIF, PORT_DATA_5, reg_port_data_5);

    *portdata5 = RU_FIELD_GET(0, XIF, PORT_DATA_5, PORTDATA5, reg_port_data_5);
...
{
    uint32_t reg_port_data_6=0;

#ifdef VALIDATE_PARMS
#endif

    reg_port_data_6 = RU_FIELD_SET(0, XIF, PORT_DATA_6, PORTDATA6, reg_port_data_6, portdata6);

    RU_REG_WRITE(0, XIF, PORT_DATA_6, reg_port_data_6);
...
bdmf_error_t ag_drv_xif_port_data_6_get(uint32_t *portdata6)
{
    ...
    RU_REG_READ(0, XIF, PORT_DATA_6, reg_port_data_6);

    *portdata6 = RU_FIELD_GET(0, XIF, PORT_DATA_6, PORTDATA6, reg_port_data_6);
...
{
    uint32_t reg_port_data_7=0;

#ifdef VALIDATE_PARMS
#endif

    reg_port_data_7 = RU_FIELD_SET(0, XIF, PORT_DATA_7, PORTDATA7, reg_port_data_7, portdata7);

    RU_REG_WRITE(0, XIF, PORT_DATA_7, reg_port_data_7);
...
bdmf_error_t ag_drv_xif_port_data_7_get(uint32_t *portdata7)
{
    ...
    RU_REG_READ(0, XIF, PORT_DATA_7, reg_port_data_7);

    *portdata7 = RU_FIELD_GET(0, XIF, PORT_DATA_7, PORTDATA7, reg_port_data_7);
...
bdmf_error_t ag_drv_xif_sec_ctl_set(const xif_sec_ctl *sec_ctl)
{
    ...
    if((sec_ctl->cfgenaes_256_rx >= _1BITS_MAX_VAL_) ||
       (sec_ctl->cfgenaes_256_tx >= _1BITS_MAX_VAL_) ||
       (sec_ctl->cfg_macsec_xpn_tx >= _1BITS_MAX_VAL_) ||
       (sec_ctl->cfg_macsec_xpn_rx >= _1BITS_MAX_VAL_) ||
       (sec_ctl->cfgkeynum_4_an_3 >= _1BITS_MAX_VAL_) ||
    ...
    reg_sec_ctl = RU_FIELD_SET(0, XIF, SEC_CTL, CFGENAES_256_RX, reg_sec_ctl, sec_ctl->cfgenaes_256_rx);
    reg_sec_ctl = RU_FIELD_SET(0, XIF, SEC_CTL, CFGENAES_256_TX, reg_sec_ctl, sec_ctl->cfgenaes_256_tx);
    reg_sec_ctl = RU_FIELD_SET(0, XIF, SEC_CTL, CFG_MACSEC_XPN_TX, reg_sec_ctl, sec_ctl->cfg_macsec_xpn_tx);
    reg_sec_ctl = RU_FIELD_SET(0, XIF, SEC_CTL, CFG_MACSEC_XPN_RX, reg_sec_ctl, sec_ctl->cfg_macsec_xpn_rx);
...
bdmf_error_t ag_drv_xif_sec_ctl_get(xif_sec_ctl *sec_ctl)
{
    ...
    sec_ctl->cfgenaes_256_rx = RU_FIELD_GET(0, XIF, SEC_CTL, CFGENAES_256_RX, reg_sec_ctl);
    sec_ctl->cfgenaes_256_tx = RU_FIELD_GET(0, XIF, SEC_CTL, CFGENAES_256_TX, reg_sec_ctl);
    sec_ctl->cfg_macsec_xpn_tx = RU_FIELD_GET(0, XIF, SEC_CTL, CFG_MACSEC_XPN_TX, reg_sec_ctl);
    sec_ctl->cfg_macsec_xpn_rx = RU_FIELD_GET(0, XIF, SEC_CTL, CFG_MACSEC_XPN_RX, reg_sec_ctl);
...
bdmf_error_t ag_drv_xif_1588_ts_sync_offset_set(bdmf_boolean cfg_ts48_sync_ns_increment, uint16_t cfgtssyncoffset_161, uint16_t cfgtssyncoffset_312, uint16_t cfgtssyncoffset_125)
{
    ...
    if((cfg_ts48_sync_ns_increment >= _1BITS_MAX_VAL_) ||
       (cfgtssyncoffset_161 >= _9BITS_MAX_VAL_) ||
    ...
    reg_1588_ts_sync_offset = RU_FIELD_SET(0, XIF, 1588_TS_SYNC_OFFSET, CFG_TS48_SYNC_NS_INCREMENT, reg_1588_ts_sync_offset, cfg_ts48_sync_ns_increment);
    reg_1588_ts_sync_offset = RU_FIELD_SET(0, XIF, 1588_TS_SYNC_OFFSET, CFGTSSYNCOFFSET_161, reg_1588_ts_sync_offset, cfgtssyncoffset_161);
    reg_1588_ts_sync_offset = RU_FIELD_SET(0, XIF, 1588_TS_SYNC_OFFSET, CFGTSSYNCOFFSET_312, reg_1588_ts_sync_offset, cfgtssyncoffset_312);
    reg_1588_ts_sync_offset = RU_FIELD_SET(0, XIF, 1588_TS_SYNC_OFFSET, CFGTSSYNCOFFSET_125, reg_1588_ts_sync_offset, cfgtssyncoffset_125);
...
bdmf_error_t ag_drv_xif_1588_ts_sync_offset_get(bdmf_boolean *cfg_ts48_sync_ns_increment, uint16_t *cfgtssyncoffset_161, uint16_t *cfgtssyncoffset_312, uint16_t *cfgtssyncoffset_125)
{
...
#ifdef VALIDATE_PARMS
    if(!cfg_ts48_sync_ns_increment || !cfgtssyncoffset_161 || !cfgtssyncoffset_312 || !cfgtssyncoffset_125)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    *cfg_ts48_sync_ns_increment = RU_FIELD_GET(0, XIF, 1588_TS_SYNC_OFFSET, CFG_TS48_SYNC_NS_INCREMENT, reg_1588_ts_sync_offset);
    *cfgtssyncoffset_161 = RU_FIELD_GET(0, XIF, 1588_TS_SYNC_OFFSET, CFGTSSYNCOFFSET_161, reg_1588_ts_sync_offset);
    *cfgtssyncoffset_312 = RU_FIELD_GET(0, XIF, 1588_TS_SYNC_OFFSET, CFGTSSYNCOFFSET_312, reg_1588_ts_sync_offset);
    *cfgtssyncoffset_125 = RU_FIELD_GET(0, XIF, 1588_TS_SYNC_OFFSET, CFGTSSYNCOFFSET_125, reg_1588_ts_sync_offset);
...
{
    uint32_t reg_port_data_8=0;

#ifdef VALIDATE_PARMS
#endif

    reg_port_data_8 = RU_FIELD_SET(0, XIF, PORT_DATA_8, PORTDATA8, reg_port_data_8, portdata8);

    RU_REG_WRITE(0, XIF, PORT_DATA_8, reg_port_data_8);
...
bdmf_error_t ag_drv_xif_port_data_8_get(uint32_t *portdata8)
{
    ...
    RU_REG_READ(0, XIF, PORT_DATA_8, reg_port_data_8);

    *portdata8 = RU_FIELD_GET(0, XIF, PORT_DATA_8, PORTDATA8, reg_port_data_8);
...
{
    uint32_t reg_port_data_9=0;

#ifdef VALIDATE_PARMS
#endif

    reg_port_data_9 = RU_FIELD_SET(0, XIF, PORT_DATA_9, PORTDATA9, reg_port_data_9, portdata9);

    RU_REG_WRITE(0, XIF, PORT_DATA_9, reg_port_data_9);
...
bdmf_error_t ag_drv_xif_port_data_9_get(uint32_t *portdata9)
{
    ...
    RU_REG_READ(0, XIF, PORT_DATA_9, reg_port_data_9);

    *portdata9 = RU_FIELD_GET(0, XIF, PORT_DATA_9, PORTDATA9, reg_port_data_9);
...
{
    uint32_t reg_port_data_10=0;

#ifdef VALIDATE_PARMS
#endif

    reg_port_data_10 = RU_FIELD_SET(0, XIF, PORT_DATA_10, PORTDATA10, reg_port_data_10, portdata10);

    RU_REG_WRITE(0, XIF, PORT_DATA_10, reg_port_data_10);
...
bdmf_error_t ag_drv_xif_port_data_10_get(uint32_t *portdata10)
{
    ...
    RU_REG_READ(0, XIF, PORT_DATA_10, reg_port_data_10);

    *portdata10 = RU_FIELD_GET(0, XIF, PORT_DATA_10, PORTDATA10, reg_port_data_10);
...
{
    uint32_t reg_port_data_11=0;

#ifdef VALIDATE_PARMS
#endif

    reg_port_data_11 = RU_FIELD_SET(0, XIF, PORT_DATA_11, PORTDATA11, reg_port_data_11, portdata11);

    RU_REG_WRITE(0, XIF, PORT_DATA_11, reg_port_data_11);
...
bdmf_error_t ag_drv_xif_port_data_11_get(uint32_t *portdata11)
{
    ...
    RU_REG_READ(0, XIF, PORT_DATA_11, reg_port_data_11);

    *portdata11 = RU_FIELD_GET(0, XIF, PORT_DATA_11, PORTDATA11, reg_port_data_11);
...
bdmf_error_t ag_drv_xif_sec_tx_ssci_set(uint32_t cfg_macsec_xpn_tx_ssci)
{
    ...
    reg_sec_tx_ssci = RU_FIELD_SET(0, XIF, SEC_TX_SSCI, CFG_MACSEC_XPN_TX_SSCI, reg_sec_tx_ssci, cfg_macsec_xpn_tx_ssci);

    RU_REG_WRITE(0, XIF, SEC_TX_SSCI, reg_sec_tx_ssci);
...
bdmf_error_t ag_drv_xif_sec_tx_ssci_get(uint32_t *cfg_macsec_xpn_tx_ssci)
{
    ...
    RU_REG_READ(0, XIF, SEC_TX_SSCI, reg_sec_tx_ssci);

    *cfg_macsec_xpn_tx_ssci = RU_FIELD_GET(0, XIF, SEC_TX_SSCI, CFG_MACSEC_XPN_TX_SSCI, reg_sec_tx_ssci);
...
bdmf_error_t ag_drv_xif_sec_tx_salt_0_set(uint32_t cfg_macsec_xpn_tx_salt_0)
{
    ...
    reg_sec_tx_salt_0 = RU_FIELD_SET(0, XIF, SEC_TX_SALT_0, CFG_MACSEC_XPN_TX_SALT_0, reg_sec_tx_salt_0, cfg_macsec_xpn_tx_salt_0);

    RU_REG_WRITE(0, XIF, SEC_TX_SALT_0, reg_sec_tx_salt_0);
...
bdmf_error_t ag_drv_xif_sec_tx_salt_0_get(uint32_t *cfg_macsec_xpn_tx_salt_0)
{
    ...
    RU_REG_READ(0, XIF, SEC_TX_SALT_0, reg_sec_tx_salt_0);

    *cfg_macsec_xpn_tx_salt_0 = RU_FIELD_GET(0, XIF, SEC_TX_SALT_0, CFG_MACSEC_XPN_TX_SALT_0, reg_sec_tx_salt_0);
...
bdmf_error_t ag_drv_xif_sec_tx_salt_1_set(uint32_t cfg_macsec_xpn_tx_salt_1)
{
    ...
    reg_sec_tx_salt_1 = RU_FIELD_SET(0, XIF, SEC_TX_SALT_1, CFG_MACSEC_XPN_TX_SALT_1, reg_sec_tx_salt_1, cfg_macsec_xpn_tx_salt_1);

    RU_REG_WRITE(0, XIF, SEC_TX_SALT_1, reg_sec_tx_salt_1);
...
bdmf_error_t ag_drv_xif_sec_tx_salt_1_get(uint32_t *cfg_macsec_xpn_tx_salt_1)
{
    ...
    RU_REG_READ(0, XIF, SEC_TX_SALT_1, reg_sec_tx_salt_1);

    *cfg_macsec_xpn_tx_salt_1 = RU_FIELD_GET(0, XIF, SEC_TX_SALT_1, CFG_MACSEC_XPN_TX_SALT_1, reg_sec_tx_salt_1);
...
bdmf_error_t ag_drv_xif_sec_tx_salt_2_set(uint32_t cfg_macsec_xpn_tx_salt_2)
{
    ...
    reg_sec_tx_salt_2 = RU_FIELD_SET(0, XIF, SEC_TX_SALT_2, CFG_MACSEC_XPN_TX_SALT_2, reg_sec_tx_salt_2, cfg_macsec_xpn_tx_salt_2);

    RU_REG_WRITE(0, XIF, SEC_TX_SALT_2, reg_sec_tx_salt_2);
...
bdmf_error_t ag_drv_xif_sec_tx_salt_2_get(uint32_t *cfg_macsec_xpn_tx_salt_2)
{
    ...
    RU_REG_READ(0, XIF, SEC_TX_SALT_2, reg_sec_tx_salt_2);

    *cfg_macsec_xpn_tx_salt_2 = RU_FIELD_GET(0, XIF, SEC_TX_SALT_2, CFG_MACSEC_XPN_TX_SALT_2, reg_sec_tx_salt_2);
...
bdmf_error_t ag_drv_xif_sec_rx_ssci_set(uint32_t cfg_macsec_xpn_rx_ssci)
{
    ...
    reg_sec_rx_ssci = RU_FIELD_SET(0, XIF, SEC_RX_SSCI, CFG_MACSEC_XPN_RX_SSCI, reg_sec_rx_ssci, cfg_macsec_xpn_rx_ssci);

    RU_REG_WRITE(0, XIF, SEC_RX_SSCI, reg_sec_rx_ssci);
...
bdmf_error_t ag_drv_xif_sec_rx_ssci_get(uint32_t *cfg_macsec_xpn_rx_ssci)
{
    ...
    RU_REG_READ(0, XIF, SEC_RX_SSCI, reg_sec_rx_ssci);

    *cfg_macsec_xpn_rx_ssci = RU_FIELD_GET(0, XIF, SEC_RX_SSCI, CFG_MACSEC_XPN_RX_SSCI, reg_sec_rx_ssci);
...
bdmf_error_t ag_drv_xif_sec_rx_salt_0_set(uint32_t cfg_macsec_xpn_rx_salt_0)
{
    ...
    reg_sec_rx_salt_0 = RU_FIELD_SET(0, XIF, SEC_RX_SALT_0, CFG_MACSEC_XPN_RX_SALT_0, reg_sec_rx_salt_0, cfg_macsec_xpn_rx_salt_0);

    RU_REG_WRITE(0, XIF, SEC_RX_SALT_0, reg_sec_rx_salt_0);
...
bdmf_error_t ag_drv_xif_sec_rx_salt_0_get(uint32_t *cfg_macsec_xpn_rx_salt_0)
{
    ...
    RU_REG_READ(0, XIF, SEC_RX_SALT_0, reg_sec_rx_salt_0);

    *cfg_macsec_xpn_rx_salt_0 = RU_FIELD_GET(0, XIF, SEC_RX_SALT_0, CFG_MACSEC_XPN_RX_SALT_0, reg_sec_rx_salt_0);
...
bdmf_error_t ag_drv_xif_sec_rx_salt_1_set(uint32_t cfg_macsec_xpn_rx_salt_1)
{
    ...
    reg_sec_rx_salt_1 = RU_FIELD_SET(0, XIF, SEC_RX_SALT_1, CFG_MACSEC_XPN_RX_SALT_1, reg_sec_rx_salt_1, cfg_macsec_xpn_rx_salt_1);

    RU_REG_WRITE(0, XIF, SEC_RX_SALT_1, reg_sec_rx_salt_1);
...
bdmf_error_t ag_drv_xif_sec_rx_salt_1_get(uint32_t *cfg_macsec_xpn_rx_salt_1)
{
    ...
    RU_REG_READ(0, XIF, SEC_RX_SALT_1, reg_sec_rx_salt_1);

    *cfg_macsec_xpn_rx_salt_1 = RU_FIELD_GET(0, XIF, SEC_RX_SALT_1, CFG_MACSEC_XPN_RX_SALT_1, reg_sec_rx_salt_1);
...
bdmf_error_t ag_drv_xif_sec_rx_salt_2_set(uint32_t cfg_macsec_xpn_rx_salt_2)
{
    ...
    reg_sec_rx_salt_2 = RU_FIELD_SET(0, XIF, SEC_RX_SALT_2, CFG_MACSEC_XPN_RX_SALT_2, reg_sec_rx_salt_2, cfg_macsec_xpn_rx_salt_2);

    RU_REG_WRITE(0, XIF, SEC_RX_SALT_2, reg_sec_rx_salt_2);
...
bdmf_error_t ag_drv_xif_sec_rx_salt_2_get(uint32_t *cfg_macsec_xpn_rx_salt_2)
{
    ...
    RU_REG_READ(0, XIF, SEC_RX_SALT_2, reg_sec_rx_salt_2);

    *cfg_macsec_xpn_rx_salt_2 = RU_FIELD_GET(0, XIF, SEC_RX_SALT_2, CFG_MACSEC_XPN_RX_SALT_2, reg_sec_rx_salt_2);
...
typedef enum
{
    ...
    bdmf_address_port_data_0,
    bdmf_address_port_data_1,
    bdmf_address_port_data_2,
    bdmf_address_port_data_3,
    bdmf_address_port_data_4,
    bdmf_address_port_data_5,
    bdmf_address_port_data_6,
    bdmf_address_port_data_7,
    bdmf_address_macsec,
    ...
    bdmf_address_port_data_8,
    bdmf_address_port_data_9,
    bdmf_address_port_data_10,
    bdmf_address_port_data_11,
...
static int bcm_xif_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case BDMF_port_command:
        ...
        break;
    case BDMF_port_data_0:
        err = ag_drv_xif_port_data_0_set(parm[1].value.unumber);
        break;
    case BDMF_port_data_1:
        err = ag_drv_xif_port_data_1_set(parm[1].value.unumber);
        break;
    case BDMF_port_data_2:
        err = ag_drv_xif_port_data_2_set(parm[1].value.unumber);
        break;
    case BDMF_port_data_3:
        err = ag_drv_xif_port_data_3_set(parm[1].value.unumber);
        break;
    case BDMF_port_data_4:
        err = ag_drv_xif_port_data_4_set(parm[1].value.unumber);
        break;
    case BDMF_port_data_5:
        err = ag_drv_xif_port_data_5_set(parm[1].value.unumber);
        break;
    case BDMF_port_data_6:
        err = ag_drv_xif_port_data_6_set(parm[1].value.unumber);
        break;
    case BDMF_port_data_7:
        err = ag_drv_xif_port_data_7_set(parm[1].value.unumber);
        break;
    case BDMF_macsec:
    ...
    case BDMF_sec_ctl:
    {
        xif_sec_ctl sec_ctl = { .cfgenaes_256_rx=parm[1].value.unumber, .cfgenaes_256_tx=parm[2].value.unumber, .cfg_macsec_xpn_tx=parm[3].value.unumber, .cfg_macsec_xpn_rx=parm[4].value.unumber, .cfgkeynum_4_an_3=parm[5].value.unumber, .cfgkeynum_4_an_2=parm[6].value.unumber, .cfgkeynum_4_an_1=parm[7].value.unumber, .cfgkeynum_4_an_0=parm[8].value.unumber, .cfgsecrxenshortlen=parm[9].value.unumber, .cfgensectxfakeaes=parm[10].value.unumber, .cfgensecrxfakeaes=parm[11].value.unumber, .cfgsecrxenpktnumrlovr=parm[12].value.unumber, .cfgsectxenpktnumrlovr=parm[13].value.unumber, .cfgenaereplayprct=parm[14].value.unumber};
    ...
    case BDMF_1588_ts_sync_offset:
        err = ag_drv_xif_1588_ts_sync_offset_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    case BDMF_sec_mpcp_offset:
        err = ag_drv_xif_sec_mpcp_offset_set(parm[1].value.unumber);
        break;
    case BDMF_port_data_8:
        err = ag_drv_xif_port_data_8_set(parm[1].value.unumber);
        break;
    case BDMF_port_data_9:
        err = ag_drv_xif_port_data_9_set(parm[1].value.unumber);
        break;
    case BDMF_port_data_10:
        err = ag_drv_xif_port_data_10_set(parm[1].value.unumber);
        break;
    case BDMF_port_data_11:
        err = ag_drv_xif_port_data_11_set(parm[1].value.unumber);
        break;
    case BDMF_sec_tx_ssci:
        err = ag_drv_xif_sec_tx_ssci_set(parm[1].value.unumber);
        break;
    case BDMF_sec_tx_salt_0:
        err = ag_drv_xif_sec_tx_salt_0_set(parm[1].value.unumber);
        break;
    case BDMF_sec_tx_salt_1:
        err = ag_drv_xif_sec_tx_salt_1_set(parm[1].value.unumber);
        break;
    case BDMF_sec_tx_salt_2:
        err = ag_drv_xif_sec_tx_salt_2_set(parm[1].value.unumber);
        break;
    case BDMF_sec_rx_ssci:
        err = ag_drv_xif_sec_rx_ssci_set(parm[1].value.unumber);
        break;
    case BDMF_sec_rx_salt_0:
        err = ag_drv_xif_sec_rx_salt_0_set(parm[1].value.unumber);
        break;
    case BDMF_sec_rx_salt_1:
        err = ag_drv_xif_sec_rx_salt_1_set(parm[1].value.unumber);
        break;
    case BDMF_sec_rx_salt_2:
        err = ag_drv_xif_sec_rx_salt_2_set(parm[1].value.unumber);
        break;
    default:
...
static int bcm_xif_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        uint32_t portdata0;
        err = ag_drv_xif_port_data_0_get(&portdata0);
    ...
    {
        uint32_t portdata1;
        err = ag_drv_xif_port_data_1_get(&portdata1);
    ...
    {
        uint32_t portdata2;
        err = ag_drv_xif_port_data_2_get(&portdata2);
    ...
    {
        uint32_t portdata3;
        err = ag_drv_xif_port_data_3_get(&portdata3);
        bdmf_session_print(session, "portdata3 = %u = 0x%x\n", portdata3, portdata3);
        break;
    }
    case BDMF_port_data_4:
    {
        uint32_t portdata4;
        err = ag_drv_xif_port_data_4_get(&portdata4);
        bdmf_session_print(session, "portdata4 = %u = 0x%x\n", portdata4, portdata4);
        break;
    }
    case BDMF_port_data_5:
    {
        uint32_t portdata5;
        err = ag_drv_xif_port_data_5_get(&portdata5);
        bdmf_session_print(session, "portdata5 = %u = 0x%x\n", portdata5, portdata5);
        break;
    }
    case BDMF_port_data_6:
    {
        uint32_t portdata6;
        err = ag_drv_xif_port_data_6_get(&portdata6);
        bdmf_session_print(session, "portdata6 = %u = 0x%x\n", portdata6, portdata6);
        break;
    }
    case BDMF_port_data_7:
    {
        uint32_t portdata7;
        err = ag_drv_xif_port_data_7_get(&portdata7);
        bdmf_session_print(session, "portdata7 = %u = 0x%x\n", portdata7, portdata7);
        break;
    }
    case BDMF_macsec:
    {
    ...
    case BDMF_sec_ctl:
    {
        ...
        bdmf_session_print(session, "cfgenaes_256_rx = %u = 0x%x\n", sec_ctl.cfgenaes_256_rx, sec_ctl.cfgenaes_256_rx);
        bdmf_session_print(session, "cfgenaes_256_tx = %u = 0x%x\n", sec_ctl.cfgenaes_256_tx, sec_ctl.cfgenaes_256_tx);
        bdmf_session_print(session, "cfg_macsec_xpn_tx = %u = 0x%x\n", sec_ctl.cfg_macsec_xpn_tx, sec_ctl.cfg_macsec_xpn_tx);
        bdmf_session_print(session, "cfg_macsec_xpn_rx = %u = 0x%x\n", sec_ctl.cfg_macsec_xpn_rx, sec_ctl.cfg_macsec_xpn_rx);
    ...
    case BDMF_1588_ts_sync_offset:
    {
        ...
        uint16_t cfgtssyncoffset_161;
        uint16_t cfgtssyncoffset_312;
        uint16_t cfgtssyncoffset_125;
        err = ag_drv_xif_1588_ts_sync_offset_get(&cfg_ts48_sync_ns_increment, &cfgtssyncoffset_161, &cfgtssyncoffset_312, &cfgtssyncoffset_125);
        bdmf_session_print(session, "cfg_ts48_sync_ns_increment = %u = 0x%x\n", cfg_ts48_sync_ns_increment, cfg_ts48_sync_ns_increment);
        bdmf_session_print(session, "cfgtssyncoffset_161 = %u = 0x%x\n", cfgtssyncoffset_161, cfgtssyncoffset_161);
    ...
    {
        uint32_t portdata8;
        err = ag_drv_xif_port_data_8_get(&portdata8);
        bdmf_session_print(session, "portdata8 = %u = 0x%x\n", portdata8, portdata8);
        break;
    }
    case BDMF_port_data_9:
    {
        uint32_t portdata9;
        err = ag_drv_xif_port_data_9_get(&portdata9);
        bdmf_session_print(session, "portdata9 = %u = 0x%x\n", portdata9, portdata9);
        break;
    }
    case BDMF_port_data_10:
    {
        uint32_t portdata10;
        err = ag_drv_xif_port_data_10_get(&portdata10);
        bdmf_session_print(session, "portdata10 = %u = 0x%x\n", portdata10, portdata10);
        break;
    }
    case BDMF_port_data_11:
    {
        uint32_t portdata11;
        err = ag_drv_xif_port_data_11_get(&portdata11);
        bdmf_session_print(session, "portdata11 = %u = 0x%x\n", portdata11, portdata11);
        break;
    }
    case BDMF_sec_tx_ssci:
    {
        uint32_t cfg_macsec_xpn_tx_ssci;
        err = ag_drv_xif_sec_tx_ssci_get(&cfg_macsec_xpn_tx_ssci);
    ...
    case BDMF_sec_tx_salt_0:
    {
        ...
        err = ag_drv_xif_sec_tx_salt_0_get(&cfg_macsec_xpn_tx_salt_0);
    ...
    case BDMF_sec_tx_salt_1:
    {
        ...
        err = ag_drv_xif_sec_tx_salt_1_get(&cfg_macsec_xpn_tx_salt_1);
    ...
    case BDMF_sec_tx_salt_2:
    {
        ...
        err = ag_drv_xif_sec_tx_salt_2_get(&cfg_macsec_xpn_tx_salt_2);
    ...
    case BDMF_sec_rx_ssci:
    {
        ...
        err = ag_drv_xif_sec_rx_ssci_get(&cfg_macsec_xpn_rx_ssci);
    ...
    case BDMF_sec_rx_salt_0:
    {
        ...
        err = ag_drv_xif_sec_rx_salt_0_get(&cfg_macsec_xpn_rx_salt_0);
    ...
    case BDMF_sec_rx_salt_1:
    {
        ...
        err = ag_drv_xif_sec_rx_salt_1_get(&cfg_macsec_xpn_rx_salt_1);
    ...
    case BDMF_sec_rx_salt_2:
    {
        ...
        err = ag_drv_xif_sec_rx_salt_2_get(&cfg_macsec_xpn_rx_salt_2);
...
static int bcm_xif_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_0_set( %u)\n", portdata0);
        if(!err) ag_drv_xif_port_data_0_set(portdata0);
        if(!err) ag_drv_xif_port_data_0_get( &portdata0);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_0_get( %u)\n", portdata0);
        if(err || portdata0!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t portdata1=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_1_set( %u)\n", portdata1);
        if(!err) ag_drv_xif_port_data_1_set(portdata1);
        if(!err) ag_drv_xif_port_data_1_get( &portdata1);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_1_get( %u)\n", portdata1);
        if(err || portdata1!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t portdata2=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_2_set( %u)\n", portdata2);
        if(!err) ag_drv_xif_port_data_2_set(portdata2);
        if(!err) ag_drv_xif_port_data_2_get( &portdata2);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_2_get( %u)\n", portdata2);
        if(err || portdata2!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t portdata3=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_3_set( %u)\n", portdata3);
        if(!err) ag_drv_xif_port_data_3_set(portdata3);
        if(!err) ag_drv_xif_port_data_3_get( &portdata3);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_3_get( %u)\n", portdata3);
        if(err || portdata3!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t portdata4=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_4_set( %u)\n", portdata4);
        if(!err) ag_drv_xif_port_data_4_set(portdata4);
        if(!err) ag_drv_xif_port_data_4_get( &portdata4);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_4_get( %u)\n", portdata4);
        if(err || portdata4!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t portdata5=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_5_set( %u)\n", portdata5);
        if(!err) ag_drv_xif_port_data_5_set(portdata5);
        if(!err) ag_drv_xif_port_data_5_get( &portdata5);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_5_get( %u)\n", portdata5);
        if(err || portdata5!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t portdata6=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_6_set( %u)\n", portdata6);
        if(!err) ag_drv_xif_port_data_6_set(portdata6);
        if(!err) ag_drv_xif_port_data_6_get( &portdata6);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_6_get( %u)\n", portdata6);
        if(err || portdata6!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t portdata7=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_7_set( %u)\n", portdata7);
        if(!err) ag_drv_xif_port_data_7_set(portdata7);
        if(!err) ag_drv_xif_port_data_7_get( &portdata7);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_7_get( %u)\n", portdata7);
        if(err || portdata7!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        xif_sec_ctl sec_ctl = {.cfgenaes_256_rx=gtmv(m, 1), .cfgenaes_256_tx=gtmv(m, 1), .cfg_macsec_xpn_tx=gtmv(m, 1), .cfg_macsec_xpn_rx=gtmv(m, 1), .cfgkeynum_4_an_3=gtmv(m, 1), .cfgkeynum_4_an_2=gtmv(m, 1), .cfgkeynum_4_an_1=gtmv(m, 1), .cfgkeynum_4_an_0=gtmv(m, 1), .cfgsecrxenshortlen=gtmv(m, 1), .cfgensectxfakeaes=gtmv(m, 1), .cfgensecrxfakeaes=gtmv(m, 1), .cfgsecrxenpktnumrlovr=gtmv(m, 1), .cfgsectxenpktnumrlovr=gtmv(m, 1), .cfgenaereplayprct=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_ctl_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", sec_ctl.cfgenaes_256_rx, sec_ctl.cfgenaes_256_tx, sec_ctl.cfg_macsec_xpn_tx, sec_ctl.cfg_macsec_xpn_rx, sec_ctl.cfgkeynum_4_an_3, sec_ctl.cfgkeynum_4_an_2, sec_ctl.cfgkeynum_4_an_1, sec_ctl.cfgkeynum_4_an_0, sec_ctl.cfgsecrxenshortlen, sec_ctl.cfgensectxfakeaes, sec_ctl.cfgensecrxfakeaes, sec_ctl.cfgsecrxenpktnumrlovr, sec_ctl.cfgsectxenpktnumrlovr, sec_ctl.cfgenaereplayprct);
        if(!err) ag_drv_xif_sec_ctl_set(&sec_ctl);
        if(!err) ag_drv_xif_sec_ctl_get( &sec_ctl);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_ctl_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", sec_ctl.cfgenaes_256_rx, sec_ctl.cfgenaes_256_tx, sec_ctl.cfg_macsec_xpn_tx, sec_ctl.cfg_macsec_xpn_rx, sec_ctl.cfgkeynum_4_an_3, sec_ctl.cfgkeynum_4_an_2, sec_ctl.cfgkeynum_4_an_1, sec_ctl.cfgkeynum_4_an_0, sec_ctl.cfgsecrxenshortlen, sec_ctl.cfgensectxfakeaes, sec_ctl.cfgensecrxfakeaes, sec_ctl.cfgsecrxenpktnumrlovr, sec_ctl.cfgsectxenpktnumrlovr, sec_ctl.cfgenaereplayprct);
        if(err || sec_ctl.cfgenaes_256_rx!=gtmv(m, 1) || sec_ctl.cfgenaes_256_tx!=gtmv(m, 1) || sec_ctl.cfg_macsec_xpn_tx!=gtmv(m, 1) || sec_ctl.cfg_macsec_xpn_rx!=gtmv(m, 1) || sec_ctl.cfgkeynum_4_an_3!=gtmv(m, 1) || sec_ctl.cfgkeynum_4_an_2!=gtmv(m, 1) || sec_ctl.cfgkeynum_4_an_1!=gtmv(m, 1) || sec_ctl.cfgkeynum_4_an_0!=gtmv(m, 1) || sec_ctl.cfgsecrxenshortlen!=gtmv(m, 1) || sec_ctl.cfgensectxfakeaes!=gtmv(m, 1) || sec_ctl.cfgensecrxfakeaes!=gtmv(m, 1) || sec_ctl.cfgsecrxenpktnumrlovr!=gtmv(m, 1) || sec_ctl.cfgsectxenpktnumrlovr!=gtmv(m, 1) || sec_ctl.cfgenaereplayprct!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    }
    {
        ...
        uint16_t cfgtssyncoffset_161=gtmv(m, 9);
        uint16_t cfgtssyncoffset_312=gtmv(m, 9);
        uint16_t cfgtssyncoffset_125=gtmv(m, 9);
        if(!err) bdmf_session_print(session, "ag_drv_xif_1588_ts_sync_offset_set( %u %u %u %u)\n", cfg_ts48_sync_ns_increment, cfgtssyncoffset_161, cfgtssyncoffset_312, cfgtssyncoffset_125);
        if(!err) ag_drv_xif_1588_ts_sync_offset_set(cfg_ts48_sync_ns_increment, cfgtssyncoffset_161, cfgtssyncoffset_312, cfgtssyncoffset_125);
        if(!err) ag_drv_xif_1588_ts_sync_offset_get( &cfg_ts48_sync_ns_increment, &cfgtssyncoffset_161, &cfgtssyncoffset_312, &cfgtssyncoffset_125);
        if(!err) bdmf_session_print(session, "ag_drv_xif_1588_ts_sync_offset_get( %u %u %u %u)\n", cfg_ts48_sync_ns_increment, cfgtssyncoffset_161, cfgtssyncoffset_312, cfgtssyncoffset_125);
        if(err || cfg_ts48_sync_ns_increment!=gtmv(m, 1) || cfgtssyncoffset_161!=gtmv(m, 9) || cfgtssyncoffset_312!=gtmv(m, 9) || cfgtssyncoffset_125!=gtmv(m, 9))
            return err ? err : BDMF_ERR_IO;
    }
    {
    ...
    {
        uint32_t portdata8=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_8_set( %u)\n", portdata8);
        if(!err) ag_drv_xif_port_data_8_set(portdata8);
        if(!err) ag_drv_xif_port_data_8_get( &portdata8);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_8_get( %u)\n", portdata8);
        if(err || portdata8!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t portdata9=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_9_set( %u)\n", portdata9);
        if(!err) ag_drv_xif_port_data_9_set(portdata9);
        if(!err) ag_drv_xif_port_data_9_get( &portdata9);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_9_get( %u)\n", portdata9);
        if(err || portdata9!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t portdata10=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_10_set( %u)\n", portdata10);
        if(!err) ag_drv_xif_port_data_10_set(portdata10);
        if(!err) ag_drv_xif_port_data_10_get( &portdata10);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_10_get( %u)\n", portdata10);
        if(err || portdata10!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t portdata11=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_11_set( %u)\n", portdata11);
        if(!err) ag_drv_xif_port_data_11_set(portdata11);
        if(!err) ag_drv_xif_port_data_11_get( &portdata11);
        if(!err) bdmf_session_print(session, "ag_drv_xif_port_data_11_get( %u)\n", portdata11);
        if(err || portdata11!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_tx_ssci=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_tx_ssci_set( %u)\n", cfg_macsec_xpn_tx_ssci);
        if(!err) ag_drv_xif_sec_tx_ssci_set(cfg_macsec_xpn_tx_ssci);
        if(!err) ag_drv_xif_sec_tx_ssci_get( &cfg_macsec_xpn_tx_ssci);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_tx_ssci_get( %u)\n", cfg_macsec_xpn_tx_ssci);
        if(err || cfg_macsec_xpn_tx_ssci!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_tx_salt_0=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_tx_salt_0_set( %u)\n", cfg_macsec_xpn_tx_salt_0);
        if(!err) ag_drv_xif_sec_tx_salt_0_set(cfg_macsec_xpn_tx_salt_0);
        if(!err) ag_drv_xif_sec_tx_salt_0_get( &cfg_macsec_xpn_tx_salt_0);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_tx_salt_0_get( %u)\n", cfg_macsec_xpn_tx_salt_0);
        if(err || cfg_macsec_xpn_tx_salt_0!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_tx_salt_1=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_tx_salt_1_set( %u)\n", cfg_macsec_xpn_tx_salt_1);
        if(!err) ag_drv_xif_sec_tx_salt_1_set(cfg_macsec_xpn_tx_salt_1);
        if(!err) ag_drv_xif_sec_tx_salt_1_get( &cfg_macsec_xpn_tx_salt_1);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_tx_salt_1_get( %u)\n", cfg_macsec_xpn_tx_salt_1);
        if(err || cfg_macsec_xpn_tx_salt_1!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_tx_salt_2=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_tx_salt_2_set( %u)\n", cfg_macsec_xpn_tx_salt_2);
        if(!err) ag_drv_xif_sec_tx_salt_2_set(cfg_macsec_xpn_tx_salt_2);
        if(!err) ag_drv_xif_sec_tx_salt_2_get( &cfg_macsec_xpn_tx_salt_2);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_tx_salt_2_get( %u)\n", cfg_macsec_xpn_tx_salt_2);
        if(err || cfg_macsec_xpn_tx_salt_2!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_rx_ssci=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_rx_ssci_set( %u)\n", cfg_macsec_xpn_rx_ssci);
        if(!err) ag_drv_xif_sec_rx_ssci_set(cfg_macsec_xpn_rx_ssci);
        if(!err) ag_drv_xif_sec_rx_ssci_get( &cfg_macsec_xpn_rx_ssci);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_rx_ssci_get( %u)\n", cfg_macsec_xpn_rx_ssci);
        if(err || cfg_macsec_xpn_rx_ssci!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_rx_salt_0=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_rx_salt_0_set( %u)\n", cfg_macsec_xpn_rx_salt_0);
        if(!err) ag_drv_xif_sec_rx_salt_0_set(cfg_macsec_xpn_rx_salt_0);
        if(!err) ag_drv_xif_sec_rx_salt_0_get( &cfg_macsec_xpn_rx_salt_0);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_rx_salt_0_get( %u)\n", cfg_macsec_xpn_rx_salt_0);
        if(err || cfg_macsec_xpn_rx_salt_0!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_rx_salt_1=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_rx_salt_1_set( %u)\n", cfg_macsec_xpn_rx_salt_1);
        if(!err) ag_drv_xif_sec_rx_salt_1_set(cfg_macsec_xpn_rx_salt_1);
        if(!err) ag_drv_xif_sec_rx_salt_1_get( &cfg_macsec_xpn_rx_salt_1);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_rx_salt_1_get( %u)\n", cfg_macsec_xpn_rx_salt_1);
        if(err || cfg_macsec_xpn_rx_salt_1!=gtmv(m, 32))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint32_t cfg_macsec_xpn_rx_salt_2=gtmv(m, 32);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_rx_salt_2_set( %u)\n", cfg_macsec_xpn_rx_salt_2);
        if(!err) ag_drv_xif_sec_rx_salt_2_set(cfg_macsec_xpn_rx_salt_2);
        if(!err) ag_drv_xif_sec_rx_salt_2_get( &cfg_macsec_xpn_rx_salt_2);
        if(!err) bdmf_session_print(session, "ag_drv_xif_sec_rx_salt_2_get( %u)\n", cfg_macsec_xpn_rx_salt_2);
...
static int bcm_xif_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case bdmf_address_port_data_0 : reg = &RU_REG(XIF, PORT_DATA_0); blk = &RU_BLK(XIF); break;
    case bdmf_address_port_data_1 : reg = &RU_REG(XIF, PORT_DATA_1); blk = &RU_BLK(XIF); break;
    case bdmf_address_port_data_2 : reg = &RU_REG(XIF, PORT_DATA_2); blk = &RU_BLK(XIF); break;
    case bdmf_address_port_data_3 : reg = &RU_REG(XIF, PORT_DATA_3); blk = &RU_BLK(XIF); break;
    case bdmf_address_port_data_4 : reg = &RU_REG(XIF, PORT_DATA_4); blk = &RU_BLK(XIF); break;
    case bdmf_address_port_data_5 : reg = &RU_REG(XIF, PORT_DATA_5); blk = &RU_BLK(XIF); break;
    case bdmf_address_port_data_6 : reg = &RU_REG(XIF, PORT_DATA_6); blk = &RU_BLK(XIF); break;
    case bdmf_address_port_data_7 : reg = &RU_REG(XIF, PORT_DATA_7); blk = &RU_BLK(XIF); break;
    ...
    case bdmf_address_port_data_8 : reg = &RU_REG(XIF, PORT_DATA_8); blk = &RU_BLK(XIF); break;
    case bdmf_address_port_data_9 : reg = &RU_REG(XIF, PORT_DATA_9); blk = &RU_BLK(XIF); break;
    case bdmf_address_port_data_10 : reg = &RU_REG(XIF, PORT_DATA_10); blk = &RU_BLK(XIF); break;
    case bdmf_address_port_data_11 : reg = &RU_REG(XIF, PORT_DATA_11); blk = &RU_BLK(XIF); break;
    case bdmf_address_sec_tx_ssci : reg = &RU_REG(XIF, SEC_TX_SSCI); blk = &RU_BLK(XIF); break;
    case bdmf_address_sec_tx_salt_0 : reg = &RU_REG(XIF, SEC_TX_SALT_0); blk = &RU_BLK(XIF); break;
    case bdmf_address_sec_tx_salt_1 : reg = &RU_REG(XIF, SEC_TX_SALT_1); blk = &RU_BLK(XIF); break;
    case bdmf_address_sec_tx_salt_2 : reg = &RU_REG(XIF, SEC_TX_SALT_2); blk = &RU_BLK(XIF); break;
    case bdmf_address_sec_rx_ssci : reg = &RU_REG(XIF, SEC_RX_SSCI); blk = &RU_BLK(XIF); break;
    case bdmf_address_sec_rx_salt_0 : reg = &RU_REG(XIF, SEC_RX_SALT_0); blk = &RU_BLK(XIF); break;
    case bdmf_address_sec_rx_salt_1 : reg = &RU_REG(XIF, SEC_RX_SALT_1); blk = &RU_BLK(XIF); break;
    case bdmf_address_sec_rx_salt_2 : reg = &RU_REG(XIF, SEC_RX_SALT_2); blk = &RU_BLK(XIF); break;
    default :
...
bdmfmon_handle_t ag_drv_xif_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_port_data_0[]={
            BDMFMON_MAKE_PARM("portdata0", "portdata0", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_port_data_1[]={
            BDMFMON_MAKE_PARM("portdata1", "portdata1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_port_data_2[]={
            BDMFMON_MAKE_PARM("portdata2", "portdata2", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_port_data_3[]={
            BDMFMON_MAKE_PARM("portdata3", "portdata3", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_port_data_4[]={
            BDMFMON_MAKE_PARM("portdata4", "portdata4", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_port_data_5[]={
            BDMFMON_MAKE_PARM("portdata5", "portdata5", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_port_data_6[]={
            BDMFMON_MAKE_PARM("portdata6", "portdata6", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_port_data_7[]={
            BDMFMON_MAKE_PARM("portdata7", "portdata7", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_sec_ctl[]={
            BDMFMON_MAKE_PARM("cfgenaes_256_rx", "cfgenaes_256_rx", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cfgenaes_256_tx", "cfgenaes_256_tx", BDMFMON_PARM_NUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_1588_ts_sync_offset[]={
            ...
            BDMFMON_MAKE_PARM("cfgtssyncoffset_161", "cfgtssyncoffset_161", BDMFMON_PARM_NUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_port_data_8[]={
            BDMFMON_MAKE_PARM("portdata8", "portdata8", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_port_data_9[]={
            BDMFMON_MAKE_PARM("portdata9", "portdata9", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_port_data_10[]={
            BDMFMON_MAKE_PARM("portdata10", "portdata10", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_port_data_11[]={
            BDMFMON_MAKE_PARM("portdata11", "portdata11", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="port_data_0", .val=BDMF_port_data_0, .parms=set_port_data_0 },
            { .name="port_data_1", .val=BDMF_port_data_1, .parms=set_port_data_1 },
            { .name="port_data_2", .val=BDMF_port_data_2, .parms=set_port_data_2 },
            { .name="port_data_3", .val=BDMF_port_data_3, .parms=set_port_data_3 },
            { .name="port_data_4", .val=BDMF_port_data_4, .parms=set_port_data_4 },
            { .name="port_data_5", .val=BDMF_port_data_5, .parms=set_port_data_5 },
            { .name="port_data_6", .val=BDMF_port_data_6, .parms=set_port_data_6 },
            { .name="port_data_7", .val=BDMF_port_data_7, .parms=set_port_data_7 },
            ...
            { .name="port_data_8", .val=BDMF_port_data_8, .parms=set_port_data_8 },
            { .name="port_data_9", .val=BDMF_port_data_9, .parms=set_port_data_9 },
            { .name="port_data_10", .val=BDMF_port_data_10, .parms=set_port_data_10 },
            { .name="port_data_11", .val=BDMF_port_data_11, .parms=set_port_data_11 },
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name="port_data_0", .val=BDMF_port_data_0, .parms=set_default },
            { .name="port_data_1", .val=BDMF_port_data_1, .parms=set_default },
            { .name="port_data_2", .val=BDMF_port_data_2, .parms=set_default },
            { .name="port_data_3", .val=BDMF_port_data_3, .parms=set_default },
            { .name="port_data_4", .val=BDMF_port_data_4, .parms=set_default },
            { .name="port_data_5", .val=BDMF_port_data_5, .parms=set_default },
            { .name="port_data_6", .val=BDMF_port_data_6, .parms=set_default },
            { .name="port_data_7", .val=BDMF_port_data_7, .parms=set_default },
            ...
            { .name="port_data_8", .val=BDMF_port_data_8, .parms=set_default },
            { .name="port_data_9", .val=BDMF_port_data_9, .parms=set_default },
            { .name="port_data_10", .val=BDMF_port_data_10, .parms=set_default },
            { .name="port_data_11", .val=BDMF_port_data_11, .parms=set_default },
    ...
    }
    {
        static bdmfmon_enum_val_t enum_table_address[] = {
            ...
            { .name="PORT_DATA_0" , .val=bdmf_address_port_data_0 },
            { .name="PORT_DATA_1" , .val=bdmf_address_port_data_1 },
            { .name="PORT_DATA_2" , .val=bdmf_address_port_data_2 },
            { .name="PORT_DATA_3" , .val=bdmf_address_port_data_3 },
            { .name="PORT_DATA_4" , .val=bdmf_address_port_data_4 },
            { .name="PORT_DATA_5" , .val=bdmf_address_port_data_5 },
            { .name="PORT_DATA_6" , .val=bdmf_address_port_data_6 },
            { .name="PORT_DATA_7" , .val=bdmf_address_port_data_7 },
            ...
            { .name="PORT_DATA_8" , .val=bdmf_address_port_data_8 },
            { .name="PORT_DATA_9" , .val=bdmf_address_port_data_9 },
            { .name="PORT_DATA_10" , .val=bdmf_address_port_data_10 },
            { .name="PORT_DATA_11" , .val=bdmf_address_port_data_11 },
