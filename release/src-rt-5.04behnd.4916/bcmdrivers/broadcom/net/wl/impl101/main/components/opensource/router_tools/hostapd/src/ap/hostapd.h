...
struct hostapd_link_unit {
	struct dl_list list;
	char link_id;
	struct hostapd_data *hapd;
};

struct hostapd_mld_unit {
	struct dl_list list;
...
struct hostapd_mlo_global {
	struct dl_list mld_info;
	int mld_count;
};

struct hostapd_mld_link_config {
	struct hostapd_mld_unit *mld;
	struct hostapd_link_unit *link;
};
...
#endif /* CONFIG_CTRL_IFACE_UDP */
#ifdef CONFIG_DRIVER_BRCM_MLO
       struct hostapd_mlo_global *mlo_info;
#endif /* CONFIG_DRIVER_BRCM_MLO */
...
#endif /* CONFIG_CTRL_IFACE_UDP */
#ifdef CONFIG_DRIVER_BRCM_MLO
       struct hostapd_mld_link_config mld_link;
#endif /* CONFIG_DRIVER_BRCM_MLO */
};
...
#ifdef CONFIG_DRIVER_BRCM_MLO
int hostapd_mlo_add(struct hostapd_data *hapd, int mld_id, int link_id);
void hostapd_mlo_remove(struct hostapd_data *hapd);
#endif /* CONFIG_DRIVER_BRCM_MLO */
