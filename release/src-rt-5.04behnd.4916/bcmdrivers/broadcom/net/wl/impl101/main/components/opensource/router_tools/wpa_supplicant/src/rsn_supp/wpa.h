...
#ifdef CONFIG_DRIVER_BRCM_MLO
static inline void wpa_sm_set_mlo_link(struct wpa_sm *sm, int link_id)
{
}

static inline void wpa_sm_set_mlo_mld(struct wpa_sm *sm, int mld_unit)
{
}

static inline void wpa_sm_set_has_ML(struct wpa_sm *sm)
{
}
