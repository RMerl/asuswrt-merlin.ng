...
struct wpa_mld_link_config {
	struct wpa_mld_unit *mld;
	struct wpa_link_unit *link;
};
...
#ifdef CONFIG_DRIVER_BRCM_MLO
	struct wpa_mld_link_config mld_link;
	u8 mld_link_pref;
#endif /* CONFIG_DRIVER_BRCM_MLO */
#ifdef CONFIG_DRIVER_BRCM_MAP
	bool dpp_shadow_chirp_done;
#endif /* CONFIG_DRIVER_BRCM_MAP */
};

#ifdef CONFIG_DRIVER_BRCM_MLO
#define MLO_AP_NO_FILTER 0
#define MLO_AP_NO_LINK_FILTER 0xFF
#endif /* CONFIG_DRIVER_BRCM_MLO */
