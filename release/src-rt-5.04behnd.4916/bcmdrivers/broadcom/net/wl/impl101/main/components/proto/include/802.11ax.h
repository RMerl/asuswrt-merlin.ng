 ...
 *
 * $Id: 802.11ax.h 820423 2023-01-16 18:04:12Z $
 */
...
/**
 * HE Capabilities element (IEEE Draft P802.11ax D3.0 9.4.2.237)
 */
...
/* HT Control Field: (IEEE Std 802.11ax-2021, Table 9-13b) */
#define HTC_VARIANT_MASK		0x3	/* See 9.2.4.6 */
#define HTC_VARIANT_SZ			2	/* HTC code variant is 2 bits. */
#define HTC_HE_VARIANT			0x3

/* HE variant control ID: (IEEE Std 802.11ax-2021, Figure 9-19a/9-19b) */
#define HTC_CONTROL_ID_SZ		4	/* HTC code HE control ID is 4 bits. */

/* HT Control ID subfield definitions: (IEEE Std 802.11ax-2021, Table 9-22a) */
...
/* some definitions added in 802.11be kept here for better overview */
#define HTC_CONTROL_ID_EHT_OM		7	/* HTC Control ID EHT operating mode */
#define HTC_CONTROL_EHT_OM_SZ		6
#define HTC_CONTROL_ID_SRS		8	/* HTC Control ID Single Response Scheduling */
#define HTC_CONTROL_SRS_SZ		10
#define HTC_CONTROL_ID_AAR		9	/* HTC Control ID AP assistance request */
#define HTC_CONTROL_AAR_SZ		20
#define HTC_CONTROL_ID_ONES		15	/* HTC Control ID ONES */
#define HTC_CONTROL_ONES_SZ		26

/* OM Control: HE version, See IEEE Std 802.11ax-2021, Section 9.2.4.6a.2 */
#define HTC_HE_OM_CONTROL_RX_NSS_MASK			0x007
#define HTC_HE_OM_CONTROL_RX_NSS_OFFSET			0
#define HTC_HE_OM_CONTROL_CHANNEL_WIDTH_MASK		0x018
#define HTC_HE_OM_CONTROL_CHANNEL_WIDTH_OFFSET		3
#define HTC_HE_OM_CONTROL_UL_MU_DISABLE_MASK		0x020
#define HTC_HE_OM_CONTROL_UL_MU_DISABLE_OFFSET		5
#define HTC_HE_OM_CONTROL_TX_NSTS_MASK			0x1C0
#define HTC_HE_OM_CONTROL_TX_NSTS_OFFSET		6
#define HTC_HE_OM_CONTROL_ER_SU_DISABLE_MASK		0x200
#define HTC_HE_OM_CONTROL_ER_SU_DISABLE_OFFSET		9
#define HTC_HE_OM_CONTROL_DL_MUMIMO_RESOUND_MASK	0x400
#define HTC_HE_OM_CONTROL_DL_MUMIMO_RESOUND_OFFSET	10
#define HTC_HE_OM_CONTROL_UL_MU_DATA_DISABLE_MASK	0x800
#define HTC_HE_OM_CONTROL_UL_MU_DATA_DISABLE_OFFSET	11

/* HE OM control decode helpers */
#define HTC_HE_OM_CONTROL_CHANNEL_WIDTH(omi)	(((omi) & HTC_HE_OM_CONTROL_CHANNEL_WIDTH_MASK) \
	>> HTC_HE_OM_CONTROL_CHANNEL_WIDTH_OFFSET)
#define HTC_HE_OM_CONTROL_RX_NSS(omi)		(((omi) & HTC_HE_OM_CONTROL_RX_NSS_MASK) \
	>> HTC_HE_OM_CONTROL_RX_NSS_OFFSET)
#define HTC_HE_OM_CONTROL_TX_NSTS(omi)		(((omi) & HTC_HE_OM_CONTROL_TX_NSTS_MASK) \
	>> HTC_HE_OM_CONTROL_TX_NSTS_OFFSET)
#define HTC_HE_OM_CONTROL_ER_SU_DISABLE(omi)	(((omi) & HTC_HE_OM_CONTROL_ER_SU_DISABLE_MASK) \
	>> HTC_HE_OM_CONTROL_ER_SU_DISABLE_OFFSET)
#define HTC_HE_OM_CONTROL_DL_MUMIMO_RESOUND(omi)	\
	(((omi) & HTC_HE_OM_CONTROL_DL_MUMIMO_RESOUND_MASK) \
		>> HTC_HE_OM_CONTROL_DL_MUMIMO_RESOUND_OFFSET)
#define HTC_HE_OM_CONTROL_UL_MU_DISABLE(omi)	(((omi) & HTC_HE_OM_CONTROL_UL_MU_DISABLE_MASK) \
	>> HTC_HE_OM_CONTROL_UL_MU_DISABLE_OFFSET)
#define HTC_HE_OM_CONTROL_UL_MU_DATA_DISABLE(omi)	\
	(((omi) & HTC_HE_OM_CONTROL_UL_MU_DATA_DISABLE_MASK) \
		>> HTC_HE_OM_CONTROL_UL_MU_DATA_DISABLE_OFFSET)

/* HE OM control encode helper */
#define HTC_HE_OMI_ENCODE(rx, tx, bw, er_su_dis, dl_res, ul_dis, ul_data_dis) \
	(((rx) << HTC_HE_OM_CONTROL_RX_NSS_OFFSET) | \
	((tx) << HTC_HE_OM_CONTROL_TX_NSTS_OFFSET) | \
	((bw) << HTC_HE_OM_CONTROL_CHANNEL_WIDTH_OFFSET) | \
	((er_su_dis) << HTC_HE_OM_CONTROL_ER_SU_DISABLE_OFFSET) | \
	((dl_res) << HTC_HE_OM_CONTROL_DL_MUMIMO_RESOUND_OFFSET) | \
	((ul_dis) << HTC_HE_OM_CONTROL_UL_MU_DISABLE_OFFSET) | \
	((ul_data_dis) << HTC_HE_OM_CONTROL_UL_MU_DATA_DISABLE_OFFSET))
...
#define HE_PHY_NOMINAL_PACKET_PADDING_IDX		78	/* used to determine PE duration */
...
/* b78-b79 Nominal Packet Padding */
...
/* HE_CAP_MAX_MCS_NONE: a reserved field that is repurposed for a brcm-internal representation */
...
/**
 * An MCS map stores the supported MCS'es, for each NSS, in a compact form. 2 bits are used for
 * encoding each MCS per NSS map (HE MAX MCS MAP is 16 bits).
 *
...
#define HE_MCS_MAP_GET_SS_IDX(nss) (((nss) - 1) * HE_CAP_MAX_MCS_SIZE)

/** @return e.g. HE_CAP_MAX_MCS_0_9 */
#define HE_MCS_MAP_GET_MCS(nss, mcs_map) \
	(((mcs_map) >> HE_MCS_MAP_GET_SS_IDX(nss)) & HE_CAP_MAX_MCS_MASK)

/* HE 6GHz band capabilities element (DOT11_MNG_HE_6G_BAND_CAPS_ID=='d314) */
BWL_PRE_PACKED_STRUCT struct he_6g_band_caps_ie {
	uint8 id;
	uint8 len;
	uint8 id_ext;
	uint16 caps_info; /**< capabilities information field, using HE_6G_CAP_ defs below */
} BWL_POST_PACKED_STRUCT;

typedef struct he_6g_band_caps_ie he_6g_band_caps_ie_t;

#define HE_6G_CAP_MIN_MPDU_START_SPC_IDX		0
#define HE_6G_CAP_MIN_MPDU_START_SPC_FSZ		3
#define HE_6G_CAP_MAX_AMPDU_LEN_EXP_IDX		3
#define HE_6G_CAP_MAX_AMPDU_LEN_EXP_FSZ		3
#define HE_6G_CAP_MAX_MPDU_LEN_IDX		6
#define HE_6G_CAP_MAX_MPDU_LEN_FSZ		3
#define HE_6G_CAP_SM_PWR_SAVE_IDX			9
#define HE_6G_CAP_SM_PWR_SAVE_FSZ			2
#define HE_6G_CAP_RD_RESP_IDX			11
#define HE_6G_CAP_RD_RESP_FSZ			1
#define HE_6G_CAP_RX_ANT_PATT_CONSISTENCY_IDX	12
#define HE_6G_CAP_RX_ANT_PATT_CONSISTENCY_FSZ	1
#define HE_6G_CAP_TX_ANT_PATT_CONSISTENCY_IDX	13
#define HE_6G_CAP_TX_ANT_PATT_CONSISTENCY_FSZ	1
...
#define HE_SIGA_LDPC_EXT		0x00000004
 ...
 * @param[in] nss   Max supported number of spatial streams
...
#define HE_OP_6G_OP_IE_PRESENT_IDX		17	/* 6GHz Operation Information present */
...
#define HE_OP_VHT_OP_INFO_SIZE 3
typedef uint8 he_op_vht_op_info_t[HE_OP_VHT_OP_INFO_SIZE];

#define HE_OP_COHOST_BSS_SIZE 1
typedef uint8 he_op_cohost_bss_t[HE_OP_COHOST_BSS_SIZE];

/* Control field format (802.11axD5.0 figure 9-787l) */
#define HE_6GHZ_OP_CTRL_CHANN_WIDTH_IDX 0   /**< channel width */
#define HE_6GHZ_OP_CTRL_CHANN_WIDTH_FSZ 2
#define HE_6GHZ_OP_CTRL_DUP_BCN_IDX 2       /**< duplicate beacon */
#define HE_6GHZ_OP_CTRL_DUP_BCN_FSZ 1

enum he_6ghz_op_ctrl_bw {
	HE_6GHZ_OP_CTRL_BW20 = 0,
	HE_6GHZ_OP_CTRL_BW40,
	HE_6GHZ_OP_CTRL_BW80,
	HE_6GHZ_OP_CTRL_BW8080_160
};

BWL_PRE_PACKED_STRUCT struct he_op_6ghz_op_info {
	uint8 pri_chan;
	uint8 control;
	uint8 cntr_fq_seg0;
	uint8 cntr_fq_seg1;
...
typedef struct he_op_6ghz_op_info he_op_6ghz_op_info_t;

#define HE_OP_6GHZ_OP_INFO_SIZE sizeof(he_op_6ghz_op_info_t)

/** maximum size in [bytes] of optional fields in the HE OP element */
#define HE_OP_MAX_OPTIONAL_BYTES \
	((uint)(HE_OP_VHT_OP_INFO_SIZE + HE_OP_COHOST_BSS_SIZE + HE_OP_6GHZ_OP_INFO_SIZE))

/** minimum 'len' field value in [bytes] of the HE OP element */
#define HE_OP_IE_MIN_LEN \
((uint)(sizeof(uint8) + sizeof(he_op_parms_t) + sizeof(he_bss_color_info_t) + sizeof(uint16)))
...
BWL_PRE_PACKED_STRUCT struct he_op_ie {
	...
	/** optional fields, presence indicated in the 'parms' field: */
	uint8 optional[HE_OP_MAX_OPTIONAL_BYTES];
} BWL_POST_PACKED_STRUCT;

typedef struct he_op_ie he_op_ie_t;

/* HE Short SSID list element - DOT11_MNG_SHORT_SSID_ID */
BWL_PRE_PACKED_STRUCT struct he_short_ssid_list_ie {
	uint8 id;		/* 'd255 */
	uint8 len;
	uint8 id_ext;		/* 'd58 */
	uint32 short_ssid[1];	/* CRC-32 over SSID string */
} BWL_POST_PACKED_STRUCT;

typedef struct he_short_ssid_list_ie he_short_ssid_list_ie_t;

/** addba ext IE data structure */
BWL_PRE_PACKED_STRUCT struct dot11_addba_ext_ie {
	uint8 id;       /* id DOT11_MNG_EXT_ADDBA_ID */
	uint8 len;      /* length of IE */
	uint8 ext_param_set;
} BWL_POST_PACKED_STRUCT;
typedef struct dot11_addba_ext_ie dot11_addba_ext_ie_t;
...
#define HE_26_TONE_RU_INDX_8		8
#define HE_MAX_26_TONE_RU_INDX		36
#define HE_MIN_52_TONE_RU_INDX		37
#define HE_52_TONE_RU_INDX_38		38
#define HE_52_TONE_RU_INDX_42		42
#define HE_52_TONE_RU_INDX_46		46
#define HE_52_TONE_RU_INDX_50		50
#define HE_MAX_52_TONE_RU_INDX		52
#define HE_MIN_106_TONE_RU_INDX		53
#define HE_106_TONE_RU_INDX_53		53
#define HE_106_TONE_RU_INDX_55		55
#define HE_106_TONE_RU_INDX_56		56
#define HE_106_TONE_RU_INDX_57		57
#define HE_106_TONE_RU_INDX_60		60
#define HE_MAX_106_TONE_RU_INDX		60
#define HE_MIN_242_TONE_RU_INDX		61
#define HE_242_TONE_RU_INDX_62		62
#define HE_242_TONE_RU_INDX_63		63
#define HE_MAX_242_TONE_RU_INDX		64
#define HE_MIN_484_TONE_RU_INDX		65
#define HE_MAX_484_TONE_RU_INDX		66
#define HE_996_TONE_RU_INDX		67
#define HE_MAX_996_TONE_RU_INDX		HE_996_TONE_RU_INDX /* obsolete name */
#define HE_2x996_TONE_RU_INDX		68
#define HE_MAX_2x996_TONE_RU_INDX	HE_2x996_TONE_RU_INDX /* obsolete name */

/* dot11ObssNbRuToleranceTime default 1800 seconds. */
#define DOT11_OBSS_NBRU_TOLR_TIME       1800u
...
#define ADDBA_CAP_EXT_BUF_SIZE_IDX	5	/* Ext buffer size */
#define ADDBA_CAP_EXT_BUF_SIZE_FSZ	3

#define ADDBA_CAP_EXT_BUF_SIZE_MASK	0xE0
