...
BRCM_WIFI_CCSP_HAL_SRC_URI = "file://wifi_src.tgz;subdir=git"
...
SRC_URI += "file://rdkb_hal_wifi_getApAssociatedDeviceTidStatsResult.patch"
...
do_compile_prepend() {
	sed -i 's/-Wextra -Wall -Werror/-Wno-error=all/g' ${S}/Makefile.am
}
inherit autotools
