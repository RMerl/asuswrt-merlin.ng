 ...
 *
 * $Id: bcmdevs.h 832504 2023-11-08 12:23:16Z $
 */
...
#define BCM6711_D11BE2G_ID	0x603c		/**< 6711 802.11be 2G device */
...
#define EMBEDDED_4x4BE160_DEV6G_ID	0x603f	/**< .11be 4x4 160MHz embedded 5G band device */
...
/* 6711 package options: OTP bit[730:720] map to otpflag bit[10:0] */
#define BCM6711_PKG0_MASK	(0x1)
#define BCM6711_PKG5_MASK	(0x20)
#define BCM6711_PKG6_MASK	(0x40)
#define BCM6711_PKG8_MASK	(0x100)
#define BCM6711_PKG_ID_MASK			(BCM6711_PKG0_MASK | BCM6711_PKG5_MASK | \
						 BCM6711_PKG6_MASK | BCM6711_PKG8_MASK)
#define BCM6711_THREE_BY_THREE_PKG_ID		(0x101)
#define BCM6711_TWO_PLUS_ONE_PKG_ID		(0x040)
#define BCM6711_TWO_BY_TWO_PKG_ID		(0x121)
#define BCM6711_THREE_BY_THREE_PKG(otpflag)	((otpflag & BCM6711_PKG_ID_MASK) == \
						BCM6711_THREE_BY_THREE_PKG_ID)
#define BCM6711_TWO_PLUS_ONE_PKG(otpflag)	((otpflag & BCM6711_PKG_ID_MASK) == \
						BCM6711_TWO_PLUS_ONE_PKG_ID)
#define BCM6711_TWO_BY_TWO_PKG(otpflag)		((otpflag & BCM6711_PKG_ID_MASK) == \
						BCM6711_TWO_BY_TWO_PKG_ID)
