 ...
 *
 * $Id: hnd_pktpool.h 822389 2023-03-08 06:15:08Z $
 */
...
/* Buf (pool) type defines - Extend new pkt pool types here */
#define PKTPOOL_TYPE_PCN	4	/* PCN Pkt pool type */
#define PKTPOOL_PCN_LEN_MAX	64	/* Max PCN pool length */
...
extern int pktpool_attach(uint32 total_pools);
extern int pktpool_dettach(void); /* Relinquish registry */
...
#define D11BUF_POOL_AVAIL() lfbufpool_avail(D11_LFRAG_BUF_POOL)
#else
/* You should have D11 memory space already */
#define D11BUF_POOL_AVAIL() ((uint16)(~0U))
