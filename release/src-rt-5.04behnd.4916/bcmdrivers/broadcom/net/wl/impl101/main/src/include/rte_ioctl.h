 ...
 *
 * $Id: rte_ioctl.h 821234 2023-02-06 14:16:52Z $
 */
...
enum hnd_ioctl_cmd {
	...
	BUS_SCB_FLOW_DELINK = 11,
	BUS_SET_MONITOR_MODE = 12,
	BUS_FLOW_FLUSH_PEND = 13,
	BUS_TAF_SCHEDULER_CONFIG = 14,
	BUS_SCHEDULE_SQS_STRIDE = 15,
	BUS_FLOW_SUSPEND = 16,
	BUS_MLO_IPC_STATE_UPDATE = 17,
	BUS_HC_EVENT_MASK_UPDATE = 18,
	BUS_CPU_DBG_WRIDX_UPDATE = 19
};
...
typedef struct memuse_info {
	...
	uint32 rodata_len;	/* Size of Read Only Data segment memory */
#ifdef SW_PAGING
	uint32 pageable_text_len;	/* Size of Pageable Text segment memory */
	uint32 pageable_rodata_len;	/* Size of Pageable Read Only Data segment memory */
#endif
} memuse_info_t;
