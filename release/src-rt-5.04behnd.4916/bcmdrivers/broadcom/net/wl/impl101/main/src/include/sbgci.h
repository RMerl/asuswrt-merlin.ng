 ...
 *
 * $Id: sbgci.h 829575 2023-09-01 03:46:56Z $
 */
...
#define GCI_OFFSETOF(sih, reg) OFFSETOF(gciregs_t, reg)

#define GCI_CORE_IDX(sih) si_findcoreidx(sih, GCI_CORE_ID, 0)
...
typedef volatile struct {
	...
	uint32 PAD[PADSZ(0x270, 0x2fc)];		/* 0x270-0x2fc */
	...
	uint32 PAD[PADSZ(0x400, 0xb7c)];		/* 0x400-0xB7C */
	uint32 gci_hw_sema_func_sts;			/* 0xB80 */
	uint32 gci_hw_sema_func0_req;			/* 0xB84 */
	uint32 gci_hw_sema_func1_req;			/* 0xB88 */
	uint32 PAD[PADSZ(0xb8c, 0xbfc)];		/* 0x400-0xBFC */
...
/* GCI HW Semaphore Func Status Register (0xB80) */
#define GCI_HW_SEMA_FSTS_GRANT_FUN0_SHIFT		8
#define GCI_HW_SEMA_FSTS_GRANT_FUN0_MASK		(1 << GCI_HW_SEMA_FSTS_GRANT_FUN0_SHIFT)
#define GCI_HW_SEMA_FSTS_GRANT_FUN1_SHIFT		9
#define GCI_HW_SEMA_FSTS_GRANT_FUN1_MASK		(1 << GCI_HW_SEMA_FSTS_GRANT_FUN1_SHIFT)

/* GCI HW Semaphore Func0 Request Register (0xB84) */
#define GCI_HW_SEMA_FUN0_REQ_SHIFT			0
#define GCI_HW_SEMA_FUN0_REQ_MASK			(1 << GCI_HW_SEMA_FUN0_REQ_SHIFT)

/* GCI HW Semaphore Func1 Request Register (0xB88) */
#define GCI_HW_SEMA_FUN1_REQ_SHIFT			0
#define GCI_HW_SEMA_FUN1_REQ_MASK			(1 << GCI_HW_SEMA_FUN1_REQ_SHIFT)
