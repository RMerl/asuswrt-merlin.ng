 ...
 *
 * $Id: wltunable_lx_6766.h 831497 2023-10-19 03:49:02Z $
 *
 * wl driver tunables
 */
...
#define D11CONF5	0x00000748	/* D11 Core Rev > 127, 131(6710),
					 * 134(6726B0), 136(6766A0-5G),
					 * 137(6766A0-2G), 138(6711)
					 */
#define ACCONF5		0x000003A2	/* AC-Phy Rev > 127, Rev 129(6710),
					 * 133(6726B0), 135(6766A0-5G),
					 * 136(6766A0-2G), 137(6711)
					 */
