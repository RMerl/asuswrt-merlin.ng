 ...
 *
 * $Id: dhd_bus.h 832812 2023-11-14 01:54:32Z $
 */
...
/* Add dump Flowring IDs in use output to a buffer */
extern void dhd_bus_flowring_ids_dump(dhd_pub_t *dhdp, struct bcmstrbuf *strbuf);
...
/* Add dump Flowring IDs in use output to a buffer */
extern void dhd_bus_pcap_dump(dhd_pub_t *dhdp, struct bcmstrbuf *strbuf);
...
extern uint32 dhd_bus_max_d2h_rings(struct dhd_bus *bus);
extern uint32 dhd_bus_max_h2d_dynamic_rings(struct dhd_bus *bus);
extern uint32 dhd_bus_max_d2h_dynamic_rings(struct dhd_bus *bus);
...
extern void dhd_bus_update_cpudbg_wridx(dhd_pub_t *dhd);
extern void dhd_bus_update_cpudbg(dhd_pub_t *dhd);
...
#ifdef BCMMLO_GR
extern int dhd_schedule_mlo_bh_req(dhd_pub_t * dhd_pub, bool is_halt);
#endif /* BCMMLO_GR */

#endif /* BCMPCIE */

extern void dhd_bus_intr_reenable(struct dhd_bus *bus);
#endif /* _dhd_bus_h_ */
