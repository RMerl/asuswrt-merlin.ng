 ...
 *
 * $Id: dhd_buzzz.h 825213 2023-05-16 08:07:01Z $
 */
...
typedef enum buzzz_evt_id
{
	...
	BUZZZ_EVT(DHD_FWD_IOCT_REQST_BGN)
	BUZZZ_EVT(DHD_FWD_IOCT_REQST_END)
...
static inline void dhd_buzzz_fmt_init(void)
{
	...
	BUZZZ_FMT(DHD_FWD_IOCT_REQST_BGN, "{ dhd_fwd_ioct_reqst_ptrbased cmd<%u> transid<%u>")
	BUZZZ_FMT(DHD_FWD_IOCT_REQST_END,
		"} dhd_FWD_ioct_reqst_ptrbased transid<%u> bus::pktid<%u>")
