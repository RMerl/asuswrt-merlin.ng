 ...
 *
 * $Id: dhd_cfg80211.c 828127 2023-08-02 10:59:48Z $
 */
...
struct net_device* wl_cfg80211_allocate_if(struct bcm_cfg80211 *cfg, int ifidx, const char *name,
	const uint8 *mac, uint8 bssidx, bool rtnl_needed, const char *dngl_name)
{
	struct net_device* net;

	DHD_LOCK(cfg->pub);
	net = dhd_allocate_if(cfg->pub, ifidx, name, mac, bssidx, rtnl_needed, dngl_name);
	DHD_UNLOCK(cfg->pub);
