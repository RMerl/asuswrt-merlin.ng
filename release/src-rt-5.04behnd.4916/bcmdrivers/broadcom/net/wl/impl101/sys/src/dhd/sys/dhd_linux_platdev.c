 ...
 *
 * $Id: dhd_linux_platdev.c 832961 2023-11-15 21:40:29Z $
 */
#include <typedefs.h>
...
#if defined(BCMPCIE) && defined(OEM_ANDROID)
static int
dhd_wifi_platform_load_pcie(void)
{
	int err = 0;
	int i;
	wifi_adapter_info_t *adapter;
