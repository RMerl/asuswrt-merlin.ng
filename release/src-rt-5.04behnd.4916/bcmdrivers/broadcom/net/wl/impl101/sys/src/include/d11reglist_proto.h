 ...
 *
 * $Id: d11reglist_proto.h 825688 2023-05-25 22:55:33Z $
 */
...
enum d11reg_type_e {
	...
	D11REG_TYPE_SCR1	= 10,
	D11REG_TYPE_SHM1	= 11,
	D11REG_TYPE_IHR16CM7	= 12,
	D11REG_TYPE_SHMCM7	= 13,
	D11REG_TYPE_IPC		= 14,
	D11REG_TYPE_ICC		= 15,
	D11REG_TYPE_MLOAMGR	= 16,
	D11REG_TYPE_DTCMCM7	= 17,
	D11REG_TYPE_DTCMCM4	= 18,
	D11REG_TYPE_DTCMPHY	= 19,
	D11REG_TYPE_MLO_AMGR	= 20,
	D11REG_TYPE_ICC_OUT	= 21,
	D11REG_TYPE_MAX		= 22
};
...
typedef enum _d11reg_xtlv_type {
	...
	D11REG_XTLV_LMAC  = 0x6,
	D11REG_XTLV_PHYDTCM = 0x7
} d11reg_xtlv_type;

typedef struct _d11regs_list {
	uint8 type;		/**< enum d11reg_type_e */
	uint16 byte_offset;	/**< relative to the start of the d11 core enum space */
	uint32 bitmap;
	uint8 step;
...
typedef struct _d11regs_addr_list {
	uint8 type;
	uint16 cnt;
	uint16 byte_offset[D11REG_BLK_SIZE]; /* allow up to 32 per list */
} d11regs_addr_t;
