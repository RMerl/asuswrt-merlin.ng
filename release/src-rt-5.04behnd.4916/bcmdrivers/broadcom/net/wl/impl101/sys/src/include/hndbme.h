 ...
 *
 * $Id: hndbme.h 827022 2023-07-03 02:56:42Z $
 */
...
#ifdef BCM_BUZZZ
#include <bcm_buzzz.h> // BUZZZ for Full Dongle
#endif
...
#ifndef BME_ENG_MAX
#define BME_ENG_MAX     8	// Should be power of 2
#endif
#if (BME_ENG_MAX > 8)
...
#define BME_USR_FTM         (6) /* chip to hostmem */
...
#ifdef BCM_BUZZZ
/* Enable BME instrumentation in verbose mode */
#ifdef BCM_BUZZZ_FUNC_VERBOSE
#define BME_NOINSTR
#else
#define BME_NOINSTR BCM_BUZZZ_NOINSTR_FUNC
#endif /* BCM_BUZZZ_FUNC_VERBOSE */
#else
#define BME_NOINSTR
#endif /* BCM_BUZZZ */
...
/** Re-Initialize transmit and receive channels of the BME engine */
extern void bme_reinit(si_t * sih, osl_t * osh);
...
/** Get number of available engines for BME service. */
extern int bme_get_engines(osl_t * osh);

/** Get number of availble engines for a BME user */
extern int bme_get_user_engines(osl_t *osh, bme_usr_t bme_usr);
...
extern int bme_copy(osl_t * osh, uint bme_key_id,
                    const void *src_p, void *dst_p, uint len);
extern int _bme_copy64(osl_t *osh, uint bme_key_id,
                    const uint64 src64, uint64 dst64, uint len, bool wcpd);
#define bme_copy64(o, b, s, d, l) _bme_copy64(o, b, s, d, l, FALSE)
#define bme_wcopy64(o, b, s, d, l) _bme_copy64(o, b, s, d, l, TRUE)

/** Use multiple bme engines in parallel. Returns the last bme engine index in use */
extern int bme_mcopy64(osl_t *osh, uint bme_key_id,
                    const uint64 src64, uint64 dst64, uint len);

/** In HND rte.c, register BME user BME_USR_H2D and BME_USR_D2H after bme_init */
extern void BCMATTACHFN(bme_setup_pcie_users)(osl_t *osh);
#endif /* _HNDBME_H_ */
