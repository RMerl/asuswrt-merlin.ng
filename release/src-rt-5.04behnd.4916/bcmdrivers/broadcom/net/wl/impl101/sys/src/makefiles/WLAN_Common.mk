...
# example WLAN_TreeBaseA: /../my_checkout
# example WLAN_SrcBaseA: /../my_checkout/src
...
WLAN_StdIncDirs = src/include components/shared src/shared
...
vpath wlc_clm_data$(CLM_FILE_SUFFIX_NIC).c $1 $$(abspath $1)
ifneq (,$(or $(wildcard $(addsuffix /../components/clm-private/wlc_clm_data.xml,$2 $2/../../src $2/../../../src)),$(wildcard $(addsuffix /wl/clm/private/wlc_clm_data_$(CLM_TYPE).xml,$2 $2/../../src $2/../../../src))))
  ...
  $1/wlc_clm_data$(CLM_FILE_SUFFIX_NIC).c: \
      ...
      | $1; \
	  @echo wlc_clm_data$(CLM_FILE_SUFFIX_NIC).c rule -- $$@: $$+ ;\
  ...
  clm_compiled: $1/wlc_clm_data$(CLM_FILE_SUFFIX_NIC).c
  clm_clean:: ; $$(RM) $1/wlc_clm_data$(CLM_FILE_SUFFIX_NIC).c
  CLM_DATA_FILES += $1/wlc_clm_data$(CLM_FILE_SUFFIX_NIC).c
endef
