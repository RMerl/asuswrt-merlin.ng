 ...
 *
 * $Id: linux_osl.c 833572 2023-11-29 11:59:26Z $
 */
...
uint32 g_assert_type = 3; /* Debug dump collection for NIC drivers */
#else
...
void
osl_assert(const char *exp, const char *file, int line, osl_t *osh)
{
	char tempbuf[256];
	const char *basename;
	uint len = 0;
