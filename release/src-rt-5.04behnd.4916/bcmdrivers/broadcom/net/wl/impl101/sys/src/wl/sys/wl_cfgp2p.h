 ...
 *
 * $Id: wl_cfgp2p.h 820700 2023-01-23 11:40:06Z $
 */
...
#ifdef WL_DPP
extern bool
wl_cfgp2p_get_fwd_gas_rqst_status(struct bcm_cfg80211 *cfg, struct net_device *dev);
extern bool
wl_cfgp2p_is_allowed_gas_frame(struct bcm_cfg80211 *cfg,
