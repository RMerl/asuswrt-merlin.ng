 ...
 *
 * $Id: wl_core.h 825898 2023-06-02 02:10:24Z $
 */
...
typedef struct wl_core {
	osl_t *osh;			/* osh pointer */
	struct net_device *ndev;	/* dev pointer */
	struct wl_core_priv *core_priv;	/* wlcore pointer */
} wl_core_t;

int wl_core_deinit(wl_core_t *core);
void wl_core_init(wl_core_t *core);
