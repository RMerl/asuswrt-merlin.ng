...
static int wpa_cli_cmd_mlo_config(struct wpa_ctrl *ctrl, int argc,
					char *argv[])
{
	return wpa_cli_cmd(ctrl, "MLO_CONFIG", 0, argc, argv);
}
...
#ifdef CONFIG_DRIVER_BRCM_MLO
	{ "mlo_config", wpa_cli_cmd_mlo_config, NULL, cli_cmd_flag_none, "= Get the MLO CONFIG" },
#endif /* CONFIG_DRIVER_BRCM_MLO */
