...
// MOG-ON: WL_SIB_COEX
#ifdef WL_SIB_COEX
#define EVENT_LOG_TAG_SIB_INFO                  411
#define EVENT_LOG_TAG_SIB_ERR                   412
#endif /* WL_SIB_COEX */
// MOG-OFF: WL_SIB_COEX
...
/* Access Event log tags starts from 2048 */

#define EVENT_LOG_TAG_PHY_CAL_INFO_ACC		2048 /* PHY CALs scheduler info */
#define EVENT_LOG_TAG_PHY_PERIODIC_ACC		2049 /* PHY periodic log for ACC */
