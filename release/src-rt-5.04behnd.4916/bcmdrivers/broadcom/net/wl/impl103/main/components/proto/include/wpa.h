 ...
 *
 * $Id: wpa.h 833478 2023-11-28 07:29:35Z $
 */
...
#define BIP_OUI_GCM256_TYPE WPA2_OUI "\xc"
...
#define WPA_CAP_WPA2_OCVC               RSN_CAP_OCV

#define WPA2_PMKID_COUNT_LEN	2

typedef uint8  rsn_cipher_t;                    /* WPA_CIPHER_xxx */

#define PASN_BASE_AKM_MASK (BCM_BIT(RSN_AKM_PASN) | BCM_BIT(RSN_AKM_SAE_PSK) | \
	BCM_BIT(RSN_AKM_FILS_SHA256) | BCM_BIT(RSN_AKM_FILS_SHA384) | \
	BCM_BIT(RSN_AKM_FBT_1X) | BCM_BIT(RSN_AKM_FBT_PSK))
