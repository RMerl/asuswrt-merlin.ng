 ...
 *
 * $Id: bcmhme.h 836351 2024-02-09 20:50:40Z $
 *
...
#define HME_USER_RNGCSI PCIE_IPC_HME_USER_RNGCSI //  21. 11az Ranging CSI feature
#define HME_USER_RFRESH PCIE_IPC_HME_USER_RFRESH //  22. Phy Refresh Offload

#define HME_USERS_TOTAL    23
...
#ifdef BCM_HMO_PHY_REFRESH
#define PHYREFRESH_HME_BYTES (8 * 1024)
#endif /* BCM_HMO_PHY_REFRESH */
