 ...
 *
 * $Id: pcicfg.h 821234 2023-02-06 14:16:52Z $
 */
...
/* In 6717, additional 28KB BAR0 segment is implemented
 * as 7 extension of 4KB each. BAR0 region 0x9000-0xf000
 * can be configured through enummeration space register
 * 0x6D0-0x6E8.
 */
#define PCIE2_BAR0_EXT0_WIN_OFFSET	0x9000u
#define PCIE2_BAR0_EXT1_WIN_OFFSET	0xa000u
#define PCIE2_BAR0_EXT2_WIN_OFFSET	0xb000u
#define PCIE2_BAR0_EXT3_WIN_OFFSET	0xc000u
#define PCIE2_BAR0_EXT4_WIN_OFFSET	0xd000u
#define PCIE2_BAR0_EXT5_WIN_OFFSET	0xe000u
#define PCIE2_BAR0_EXT6_WIN_OFFSET	0xf000u
...
/* PCIE LinkCap Register Settings */
/* MaxLinkWidth - Indicates Maxs no of lanes supported */
#define	PCI_CFG_LINKCAP_MW_SHIFT	4
#define	PCI_CFG_LINKCAP_MW_MASK		(0x3F << PCI_CFG_LINKCAP_MW_SHIFT)
...
#define PCIE2_BAR0_CORE2_WIN	0x74  /* backplane addres space accessed by fifth 4KB of BAR0 */
#define PCIE2_BAR0_CORE2_WIN2	0x78  /* backplane addres space accessed by sixth 4KB of BAR0 */
...
#define	PCI_SBIM_UPR_MASK	0x3C0000	/* Upper backplane core interrupt mask */
#define	PCI_SBIM_UPR_SHIFT	18		/* Upper backplane core interrupt bits offset */
