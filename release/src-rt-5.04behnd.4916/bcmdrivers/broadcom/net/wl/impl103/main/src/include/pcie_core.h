 ...
 *
 * $Id: pcie_core.h 826488 2023-06-19 07:19:51Z $
 */
#ifndef	_PCIE_CORE_H
#define	_PCIE_CORE_H
...
typedef volatile struct sbpcieregs {
	...
	uint32 PAD[36];
	uint32 sbtopcie2;	/* 0xF0 */
	uint32 sbtopcie2upper;	/* 0xF4 */
	uint32 sbtopcie3;	/* 0xF8 */
	uint32 sbtopcie3upper;	/* 0xFC */
	uint32 sbtopcie0;	/* sb to pcie translation 0: 0x100 */
	uint32 sbtopcie1;	/* sb to pcie translation 1: 0x104 */
	uint32 sbtopciebigmem;	/* sb to pcie translation big memory: 0x108 */
	uint32 sbtopcie0upper;	/* sb to pcie translation 0: 0x10C */
	uint32 sbtopcie1upper;	/* sb to pcie translation 1: 0x110 */
	uint32 sbtopcie4;	/* sb to pcie translation 4 (middle window): 0x114 */;
	uint32 sbtopcie4upper;	/* sb to pcie translation 4 (middle window): 0x118 */;
	uint32 PAD;		/* 0x11C */
	...
	union {
		...
		struct {
			...
			uint32	h2d_frg_intstat1_2;	/* 0x440, ID32 ~ ID63 >= rev132 */
			uint32	h2d_frg_intmask1_2;	/* 0x444, ID32 ~ ID63 >= rev132 */

			uint32	PAD[62];	/* IFRM register area : 0x448 - 0x53F */
			...
			uint32	sawid_classify_mask0;	/* 0x600 */
			uint32	sawid_classify_data0;	/* 0x604 */
			uint32	sawid_classify_attr0;	/* 0x608 */
			uint32	PAD[61];		/* 0x60c - 0x6FF */

			uint32	sbtopcie5;		/* 0x700 */
			uint32	sbtopcie5upper;		/* 0x704 */
			uint32	sbtopcie6;		/* 0x708 */
			uint32	sbtopcie6upper;		/* 0x70C */
			uint32	sbtopcie7;		/* 0x710 */
			uint32	sbtopcie7upper;		/* 0x714 */
			uint32	sbtopcie8;		/* 0x718 */
			uint32	sbtopcie8upper;		/* 0x71C */
			uint32	PAD[48];		/* 0x720 - 0x7DF */
			uint32	axi_pcie_tx_arb0;	/* 0x7e0 */
			uint32	axi_pcie_tx_arb1;	/* 0x7e4 */
			uint32	PAD[6];			/* 0x7e8 - 0x7FF */
		} pcie2;
	} u;
...
#define PCIE_HWA_EN		0x10000000	/* HWA index update enable */
...
/** PCIE AXI Control */
#define PCIE_AXICONTROL_AXIS_WRACCEPT_SHIFT	0
#define PCIE_AXICONTROL_AXIS_RDACCEPT_SHIFT	6
#define PCIE_AXICONTROL_ARBIT_VAL_SHIFT		22
#define PCIE_AXICONTROL_ARBIT_VAL_MASK		(0x3 << PCIE_AXICONTROL_ARBIT_VAL_SHIFT)
#define PCIE_AXICONTROL_ARBIT_VAL_MODE0		(0x0 << PCIE_AXICONTROL_ARBIT_VAL_SHIFT)
#define PCIE_AXICONTROL_ARBIT_VAL_MODE1		(0x1 << PCIE_AXICONTROL_ARBIT_VAL_SHIFT)

#define PCIE_AXICONTROL_ARBIT_MODE_SHIFT	24
#define PCIE_AXICONTROL_ARBIT_MODE_MASK		(0x1 << PCIE_AXICONTROL_ARBIT_MODE_SHIFT)
#define PCIE_AXICONTROL_ARBIT_MODE_ENABLE	(0x1 << PCIE_AXICONTROL_ARBIT_MODE_SHIFT)

/* SAWID_CLASSIFY registers */
#define SAWID_CLASSFY_ATTR_PRI_SHIFT		5
#define SAWID_CLASSFY_ATTR_PRI_NORMAL		(0x1 << SAWID_CLASSFY_ATTR_PRI_SHIFT)
#define SAWID_CLASSFY_ATTR_PRI_MID		(0x2 << SAWID_CLASSFY_ATTR_PRI_SHIFT)
#define SAWID_CLASSFY_ATTR_PRI_HIGH		(0x3 << SAWID_CLASSFY_ATTR_PRI_SHIFT)

#define SAWID_CLASSFY_MASK_ENABLE_SHIFT		31
#define SAWID_CLASSFY_MASK_ENABLE		(0x1 << SAWID_CLASSFY_MASK_ENABLE_SHIFT)

/* AXI_PCIE_TX_ARB */
#define PCIE_TX_ARB_WEIGHT0_SHIFT		0
#define PCIE_TX_ARB_WEIGHT0_MASK		(0x3f << PCIE_TX_ARB_WEIGHT0_SHIFT)
#define PCIE_TX_ARB_ARB0_SHIFT			6
#define PCIE_TX_ARB_ARB0_MASK			(0x3 << PCIE_TX_ARB_ARB0_SHIFT)
#define PCIE_TX_ARB_WEIGHT1_SHIFT		8
#define PCIE_TX_ARB_WEIGHT1_MASK		(0x3f << PCIE_TX_ARB_WEIGHT1_SHIFT)
#define PCIE_TX_ARB_ARB1_SHIFT			14
#define PCIE_TX_ARB_ARB1_MASK			(0x3 << PCIE_TX_ARB_ARB1_SHIFT)
#define PCIE_TX_ARB_WEIGHT2_SHIFT		16
#define PCIE_TX_ARB_WEIGHT2_MASK		(0x3f << PCIE_TX_ARB_WEIGHT2_SHIFT)
#define PCIE_TX_ARB_ARB2_SHIFT			22
#define PCIE_TX_ARB_ARB2_MASK			(0x3 << PCIE_TX_ARB_ARB2_SHIFT)

#define PCIE_TX_ARB_SP				(0x0)
#define PCIE_TX_ARB_WRR				(0x1)
#define PCIE_TX_ARB_IWRR			(0x2)

/** Dongle Mode small pcie 128 MB region accessible via SBTOPCIE translations */
#define SBTOPCIE_SMALL_WINDOW_SIZE  (128 * 1024 * 1024)
/** Dongle Mode middle pcie 256 MB region accessible via SBTOPCIE translations */
#define SBTOPCIE_MIDDLE_WINDOW_SIZE  (256 * 1024 * 1024)

/* On chips with CCI-400, the small pcie 128 MB region base has shifted */
#define SBTOPCIE_BACKPLANE_BASE		(0x08000000)
#define SBTOPCIE_SMALL_WINDOW_BASE_CCI	(0x20000000)
#define SBTOPCIE_MIDDLE_WINDOW_BASE_CCI	(0x30000000)

/** SBTOPCIE Register Definitions: low 4 bits in sbtopcie# registers */
/* Access Type bits (0,1) */
#define SBTOPCIE_ACCESS_TYPE_MEM        0
#define SBTOPCIE_ACCESS_TYPE_IO         1
#define SBTOPCIE_ACCESS_TYPE_CFG0       2
#define SBTOPCIE_ACCESS_TYPE_CFG1       3
#define SBTOPCIE_ACCESS_TYPE_SHIFT      0
#define SBTOPCIE_ACCESS_TYPE_MASK       (0x3 << SBTOPCIE_ACCESS_TYPE_SHIFT)
#define SBTOPCIE_PREF_ENABLE_SHIFT      2
#define SBTOPCIE_PREF_ENABLE_MASK       (0x1 << SBTOPCIE_PREF_ENABLE_SHIFT)
#define SBTOPCIE_WRITE_BURST_SHIFT      3
#define SBTOPCIE_WRITE_BURST_MASK       (0x1 << SBTOPCIE_WRITE_BURST_SHIFT)
#define SBTOPCIE_LOWER_RANGE_SHIFT      4
#define SBTOPCIE_LOWER_RANGE_MASK       (0x7F << SBTOPCIE_LOWER_RANGE_SHIFT)
#define SBTOPCIE_UPPER_RANGE_SHIFT      12
#define SBTOPCIE_UPPER_RANGE_MASK       (0x7F << SBTOPCIE_UPPER_RANGE_SHIFT)

#define SBTOPCIE_BIGMEM_UPPERADDRESS_SHIFT	31
#define SBTOPCIE_BIGMEM_UPPERADDRESS_MASK	(0x1 << SBTOPCIE_BIGMEM_UPPERADDRESS_SHIFT)
...
#define PCIE_CORE_REG_S2P_TRANS2	0xf0u	/* SB To PCIe Translation 2 Register */
#define PCIE_CORE_REG_S2P_TRANS2_UPPER	0xf4u	/* SB To PCIe Translation 2 Upper Register */
#define PCIE_CORE_REG_S2P_TRANS3	0xf8u	/* SB To PCIe Translation 3 Register */
#define PCIE_CORE_REG_S2P_TRANS3_UPPER	0xfcu	/* SB To PCIe Translation 3 Upper Register */
#define PCIE_CORE_REG_S2P_TRANS0	PCIE_CORE_REG_SB_PCIE_0
#define PCIE_CORE_REG_S2P_TRANS1	PCIE_CORE_REG_SB_PCIE_1
#define PCIE_CORE_REG_S2P_TRANS_BIG	PCIE_CORE_REG_SB_PCIE_2
#define PCIE_CORE_REG_S2P_TRANS0_UPPER	0x10cu	/* SB To PCIe Translation 0 Upper Register */
#define PCIE_CORE_REG_S2P_TRANS1_UPPER	0x110u	/* SB To PCIe Translation 1 Upper Register */
#define PCIE_CORE_REG_S2P_TRANS4	0x114u	/* SB To PCIe Translation 4 Register */
#define PCIE_CORE_REG_S2P_TRANS4_UPPER	0x118u	/* SB To PCIe Translation 4 Upper Register */

#define PCIE_CORE_REG_ERRORHEADERLOG1	0x1b0u	/* Error Header Log 1 Register */
#define PCIE_CORE_REG_ERRORHEADERLOG2	0x1b4u	/* Error Header Log 2 Register */
#define PCIE_CORE_REG_ERRORHEADERLOG3	0x1b8u	/* Error Header Log 3 Register */
#define PCIE_CORE_REG_ERRORHEADERLOG4	0x1bcu	/* Error Header Log 4 Register */

#define PCIE_CORE_REG_HMAPVIOLATIONADDRLOWER	0x5c0u	/* Host Map Violation Address Lower */
#define PCIE_CORE_REG_HMAPVIOLATIONADDRUPPER	0x5c4u	/* Host Map Violation Address Upper */
#define PCIE_CORE_REG_HMAPVIOLATIONINFO	0x5c8u	/* Host Map Violation Information Register */
...
#define PCIE_CFG_ROOT_ERROR_COMMAND	0x12Cu	/* root_error_command  */
#define PCIE_CFG_ROOT_ERROR_STATUS	0x130u	/* root_error_status   */
#define PCIE_CFG_ROOT_ERROR_ID		0x134u	/* root_error_id       */
...
#define	PCIE_CFG_RC_BAD_ADDRESS_LOW	0x4050u	/* rc_bad_addr_low     */
#define	PCIE_CFG_RC_BAD_ADDRESS_HIGH	0x4054u	/* rc_bad_addr_high    */
...
#define PCIE_CAP_DEVCTRL_MRRS_2048B	4	/* 2024 Byte */
#define PCIE_CAP_DEVCTRL_MRRS_4096B	5	/* 4096 Byte */
...
#define PCIECFGREG_TL_CTRL0		0x800
#define PCIECFGREG_PDL_CTRL1		0x1004
#define PCIECFGREG_PDL_IDDQ		0x1814
#define PCIECFGREG_REG_PHY_CTL7		0x181c

/* PCIECFGREG_LINKCAP bit definitions PCI Express Capability::LinkCap */
/* MaxLinkWidth - Indicates Maxs no of lanes supported */
#define PCIECFGREG_LINKCAP_MW_SHIFT	4
#define PCIECFGREG_LINKCAP_MW_MASK	(0x3F << PCIECFGREG_LINKCAP_MW_SHIFT)
...
/* Enumeration space registers to program
 * extended 28K BAR0 region.
 */
#define PCIE_ENUM_BAR0_WIN_EXT0		0x6D0
#define PCIE_ENUM_BAR0_WIN_EXT1		0x6D4
#define PCIE_ENUM_BAR0_WIN_EXT2		0x6D8
#define PCIE_ENUM_BAR0_WIN_EXT3		0x6DC
#define PCIE_ENUM_BAR0_WIN_EXT4		0x6E0
#define PCIE_ENUM_BAR0_WIN_EXT5		0x6E4
#define PCIE_ENUM_BAR0_WIN_EXT6		0x6E8
#define PCIE_ENUM_BAR0_WINDOW_EXT(i)	(PCIE_BAR0_WINDOW_EXT##i)

#define PCIControl	0x00
#define IDMAControl	PCIControl
...
/* Direct Access regs */
#define DAR_PCIMailBoxInt		0xA48

#define DAR_PCIH2D_MailBox		0xA28
#define DAR_PCIH2D_DB1			0xA2C
#define DAR_PCIH2D_MailBox_1	0xA30  /* for dma channel1 */
#define DAR_PCIH2D_DB1_1		0xA34
#define DAR_PCIH2D_MailBox_2	0xA38  /* for dma channel2 which will be used for Implicit DMA */
#define DAR_PCIH2D_DB1_2		0xA3C
#define DAR_PCIE_PWR_CTRL		0xAE8
