 ...
 *
 * $Id: bcmwifi_rclass.c 834020 2023-12-08 08:17:00Z $
 */
...
/* op class 137 */
static const uint8 chan_set_6g_320[] = {
...
static const bcmwifi_rclass_info_t rcinfo_global[] = {
	...
	{137, BCMWIFI_RCLASS_CHAN_TYPE_CNTR_FREQ,  BCMWIFI_BW_320, BCMWIFI_BAND_6G,
	BCMWIFI_RCLASS_FLAGS_NONE, ARRAYSIZE(chan_set_6g_320), chan_set_6g_320},
};
	...
	const bcmwifi_rclass_info_t **rcinfo)
{
	...
	*rcinfo = NULL;
	ret = bcmwifi_rclass_get_rclass_table(type, &rct, &rct_len);
	if (ret != BCME_OK) {
		goto done;
	}
