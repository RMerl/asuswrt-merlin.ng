...
#define WL_WIFI_WLNVRAMVERSION (g_wifi_obj.wlNvramVersion) /*		 wlNvramVersion */
#define WL_WIFI_X_CABLELABS_COM_SSIDSTEERINGENABLE (g_wifi_obj.X_CABLELABS_COM_SSIDSteeringEnable) /*		 X_CABLELABS_COM_SSIDSteeringEnable */
#define WL_WIFI_WLBRIDGEINFO (g_wifi_obj.wlBridgeInfo) /*		 wlBridgeInfo */
#define WL_RADIO_WLENBL(idx) (gp_adapter_objs[(idx)].radio.wlEnbl) /*		 wlEnbl */
#define WL_RADIO_STATUS(idx) (gp_adapter_objs[(idx)].radio.status) /*		 status */
...
#define WL_RADIO_OPERATINGSTANDARDS(idx) (gp_adapter_objs[(idx)].radio.operatingStandards) /*		 operatingStandards */
...
#define WL_RADIO_AUTOCHANNELREFRESHPERIOD(idx) (gp_adapter_objs[(idx)].radio.autoChannelRefreshPeriod) /*		 autoChannelRefreshPeriod */
...
#define WL_RADIO_WLNBW(idx) (gp_adapter_objs[(idx)].radio.wlNBw) /*		 wlNBw */
...
#define WL_RADIO_MCS(idx) (gp_adapter_objs[(idx)].radio.MCS) /*		 MCS */
...
#define WL_RADIO_RADARTHRESHOLD(idx) (gp_adapter_objs[(idx)].radio.radarThreshold) /*		 radarThreshold */
...
#define WL_RADIO_WLACSPREFCHANNELS(idx) (gp_adapter_objs[(idx)].radio.wlAcsPrefChannels) /*		 wlAcsPrefChannels */
...
#define WL_RADIO_WLMODE(idx) (gp_adapter_objs[(idx)].radio.wlMode) /*		 wlMode */
...
#define WL_RADIO_WLEBOSENABLE(idx) (gp_adapter_objs[(idx)].radio.wlEbosEnable) /*		 wlEbosEnable */
#define WL_RADIO_WLSHORTRETRYLIMITACBE(idx) (gp_adapter_objs[(idx)].radio.wlShortRetryLimitAcBe) /*		 wlShortRetryLimitAcBe */
#define WL_RADIO_WLLONGRETRYLIMITACBE(idx) (gp_adapter_objs[(idx)].radio.wlLongRetryLimitAcBe) /*		 wlLongRetryLimitAcBe */
#define WL_RADIO_WLSHORTRETRYLIMITACBK(idx) (gp_adapter_objs[(idx)].radio.wlShortRetryLimitAcBk) /*		 wlShortRetryLimitAcBk */
#define WL_RADIO_WLLONGRETRYLIMITACBK(idx) (gp_adapter_objs[(idx)].radio.wlLongRetryLimitAcBk) /*		 wlLongRetryLimitAcBk */
#define WL_RADIO_WLSHORTRETRYLIMITACVI(idx) (gp_adapter_objs[(idx)].radio.wlShortRetryLimitAcVi) /*		 wlShortRetryLimitAcVi */
#define WL_RADIO_WLLONGRETRYLIMITACVI(idx) (gp_adapter_objs[(idx)].radio.wlLongRetryLimitAcVi) /*		 wlLongRetryLimitAcVi */
#define WL_RADIO_WLSHORTRETRYLIMITACVO(idx) (gp_adapter_objs[(idx)].radio.wlShortRetryLimitAcVo) /*		 wlShortRetryLimitAcVo */
#define WL_RADIO_WLLONGRETRYLIMITACVO(idx) (gp_adapter_objs[(idx)].radio.wlLongRetryLimitAcVo) /*		 wlLongRetryLimitAcVo */
#define WL_RADIO_WLRXCHAIN(idx) (gp_adapter_objs[(idx)].radio.wlRxChain) /*		 wlRxChain */
#define WL_RADIO_WLTXCHAIN(idx) (gp_adapter_objs[(idx)].radio.wlTxChain) /*		 wlTxChain */
#define WL_RADIO_WLBANDUTILIZATION(idx) (gp_adapter_objs[(idx)].radio.wlBandUtilization) /*		 wlBandUtilization */
#define WL_RADIO_WLNPREAMBLETYPE(idx) (gp_adapter_objs[(idx)].radio.wlNPreambleType) /*		 wlNPreambleType */
#define WL_RADIO_WLBOOTTIME(idx) (gp_adapter_objs[(idx)].radio.wlBootTime) /*		 wlBootTime */
#define WL_RADIO_DCSDWELLTIME(idx) (gp_adapter_objs[(idx)].radio.dcsDwelltime) /*		 dcsDwelltime */
#define WL_BSSID_WLENBLSSID(idx,sub) (gp_adapter_objs[(idx)].bssids[(sub)].wlEnblSsid) /*		 wlEnblSsid */
#define WL_BSSID_STATUS(idx,sub) (gp_adapter_objs[(idx)].bssids[(sub)].status) /*		 status */
#define WL_BSSID_SALIAS(idx,sub) (gp_adapter_objs[(idx)].bssids[(sub)].sAlias) /*		 sAlias */
#define WL_BSSID_NAME(idx,sub) (gp_adapter_objs[(idx)].bssids[(sub)].name) /*		 name */
...
#define WL_AP_STATUS(idx,sub) (gp_adapter_objs[(idx)].ssids[(sub)].accesspoint.status) /*		 status */
...
#define WL_AP_WMMCAPABILITY(idx,sub) (gp_adapter_objs[(idx)].ssids[(sub)].accesspoint.WMMCapability) /*		 WMMCapability */
...
#define WL_AP_WLBEACONRATE(idx,sub) (gp_adapter_objs[(idx)].ssids[(sub)].accesspoint.wlBeaconRate) /*		 wlBeaconRate */
...
#define WL_APSEC_WLPMF(idx,sub) (gp_adapter_objs[(idx)].ssids[(sub)].security.wlPmf) /*		 wlPmf */
...
#define WL_APSEC_WLPROBERESPONSEMF(idx,sub) (gp_adapter_objs[(idx)].ssids[(sub)].security.wlProbeResponseMF) /*		 wlProbeResponseMF */
...
#define WL_APWPS_WLWSCDEVPIN(idx,sub) (gp_adapter_objs[(idx)].ssids[(sub)].wps.wlWscDevPin) /*		 wlWscDevPin */
