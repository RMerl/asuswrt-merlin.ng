 ...
 *
 * $Id: blanket.h 841918 2024-07-02 12:57:47Z $
 *
 *  @author
 *  @bug No known bugs.
 */
...
/** @brief To get the Maximum Tx Power of Chanspec
 *
 * @param ifname	interface name of the BSS
 * @param tx	Out Maximum Tx Power of Chanspec
 *
 * @return		status of the call. 0 Success. Non Zero Failure
 */
int	blanket_get_chanspec_txpwr_max(char *ifname, chanspec_t chanspec, int *txpower);
...
/** @brief Set forced olpc caliberation
 *
 * @param ifname	interface name of the BSS
 *
 * @return		status of the call. 0 Success. Non Zero Failure
 */
int blanket_set_olpc_cal(char *ifname);

/** @brief Get MLO info
 *
 * @param ifname	interface name of the BSS
 * @param out_mlo_info	out object, MLO info
 * @param size		size of out_mlo_info
 *
 * @return		status of the call. 0 Success. Non Zero Failure
 */
int blanket_get_mlo_info(char *ifname, wl_mlo_info_basic_t *out_mlo_info, uint32 size);

/** @brief Get MLO SCB info
 *
 * @param ifname	interface name of the BSS
 * @param sta_mac	MAC address of STA from AP side
 * @param msi		out object, MLO SCB info
 *
 * @return		status of the call. 0 Success. Non Zero Failure
 */
int blanket_get_mlo_scb(char *ifname, struct ether_addr *sta_mac, wl_mlo_scb_info_t *msi);

/** @brief Convert driver MLO mode to IEEE1905
 *
 * @param mode		driver MLO mode
 * @param out_mode	out object, IEEE1905 MLO mode
 * @return		status of the call. 0 Success. Non Zero Failure
 */
int blanket_driver_mlo_mode_to_ieee1905(uint8 mode, uint8 *out_mode);
