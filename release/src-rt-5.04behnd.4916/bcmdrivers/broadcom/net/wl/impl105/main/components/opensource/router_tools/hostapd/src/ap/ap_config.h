...
#define AIRTIME_MODE_MAX (__AIRTIME_MODE_MAX - 1)
	...
	enum {
		MAP_4_WAY_HANDSHAKE_OFF = 0,
		MAP_4_WAY_HANDSHAKE_CTRL = 1,	/* Controller initiated 4-way handshake */
		MAP_4_WAY_HANDSHAKE_AGT = 2,	/* Agent initiated 4-way handshake */
	} map_4_way_handshake;
