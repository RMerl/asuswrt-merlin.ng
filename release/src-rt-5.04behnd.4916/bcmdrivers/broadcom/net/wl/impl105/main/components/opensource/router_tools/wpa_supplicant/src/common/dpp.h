...
#define DPP_CAPAB_WIFI7_STR		BIT(0)
#define DPP_CAPAB_WIFI7_NSTR		BIT(1)
#define DPP_CAPAB_WIFI7_EMLSR		BIT(2)
#define DPP_CAPAB_WIFI7_EMLMR		BIT(3)

#define DPP_IS_CAPAB_WIFI7_STR(f)	((f) & DPP_CAPAB_WIFI7_STR)
#define DPP_IS_CAPAB_WIFI7_NSTR(f)	((f) & DPP_CAPAB_WIFI7_NSTR)
#define DPP_IS_CAPAB_WIFI7_EMLSR(f)	((f) & DPP_CAPAB_WIFI7_EMLSR)
#define DPP_IS_CAPAB_WIFI7_EMLMR(f)	((f) & DPP_CAPAB_WIFI7_EMLMR)

#define	DPP_MAX_BSTA_COUNT	8u

struct dpp_bsta_mld_config {
	u8 link_count;	/* Number of links which can be part of backhaul sta mld */
	struct dpp_bsta_obj {
		u8 wifi7_caps;	/* of type DPP_CAPAB_WIFI7_X */
		u8 bsta_addr[ETH_ALEN];
	} bsta_objs[DPP_MAX_BSTA_COUNT];
};
...
struct dpp_authentication {
	...
	struct dpp_config_obj {
		...
		struct dpp_bsta_mld_config bsta_mld_config;
...
#if defined(CONFIG_DRIVER_BRCM_MAP) && defined(CONFIG_DRIVER_BRCM_MLO)
	void (*get_bsta_mld_config)(void *ctx, struct dpp_bsta_mld_config *config);
#endif /* CONFIG_DRIVER_BRCM_MAP && CONFIG_DRIVER_BRCM_MLO */
};
