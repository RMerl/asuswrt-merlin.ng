...
#define WPA_DRIVER_FLAGS2_MLO                   0x0000000000004000ULL
	...
	/**
	 *  * Driver supports protection of range negotiation and measurement management
	 *  * frames in STA mode for all bandwidths. Above flag ony enable non 20Mhz
	 *  *  bandwidths. 11az 4.1 spec set the RSNXE bit 15 for all bandwidths
	 *  */
#define WPA_DRIVER_FLAGS2_PROT_RANGE_ALLBW_NEG_STA    0x0000000000008000ULL
#endif // endif
	u64 flags2;
