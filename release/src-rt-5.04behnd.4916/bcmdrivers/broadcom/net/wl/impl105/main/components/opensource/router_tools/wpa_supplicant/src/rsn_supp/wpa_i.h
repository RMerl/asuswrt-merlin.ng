...
struct wpa_sm {
	...
	enum {
		...
		MAP_4_WAY_HANDSHAKE_CTRL = 1,	/* 4-way handshake with controller */
		MAP_4_WAY_HANDSHAKE_AGT = 2,	/* 4-way handshake with another agent */
	} map_4_way_handshake;
	...
	uint mlo_ie_len;
	bool bss_ml_capable;
	u8 active_link_bssid[ETH_ALEN];
	bool mld_present; /* Establish an MLD connection */
