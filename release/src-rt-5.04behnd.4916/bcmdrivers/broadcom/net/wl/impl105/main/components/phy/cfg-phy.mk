...
PHY_CMN_DIR_LIST := utils wd init refresh
PHY_TYPE_LIST := ac n lcn20
PHY_MOD_LIST := ana antdiv az btcx cache calmgr chanmgr core dccal dbg dsi et fcbs hirssi \
                lpc misc mu noise papdcal radar radio rssi rxgcrs rxiqcal rxspur \
                samp tbl temp tof tpc txpwrcap tssical txiqlocal vcocal ocl hecap prephy \
                hc vasip stf smc wareng txss ehtcap rfem padroop
...
PHY_SRC_INC_DIRS += ac/rfem
PHY_SRC_INC_DIRS += ac/rfem/data/include
PHY_SRC_INC_DIRS += ac/rfem/data/src
PHY_SRC_INC_DIRS += ac/az
