 ...
 *
 * $Id: 802.11be.h 842388 2024-07-15 09:44:24Z $
 */
...
/* EHT Operation element (fixed portion), D6.0 section 9.4.2.320 */
...
#define EHT_OP_PARMS_MCS15_DISABLE_IDX		6u	/* MCS15 reception disabled */

/* EHT Operation Information field format per 11be D6.0, section 9.4.2.320 */
...
/* IEEE 802.11be D6.0, section 9.4.2.320 EHT Operation Information subfields */
...
#define EHT_ML_CTL_TYPE_TDLS		3u	/* ref: 802.11be D3.2 */
#define EHT_ML_CTL_TYPE_EPCS		4u	/* EPCS, ref: 802.11be D3.2 */
 ...
 * *****************************************
 */
typedef BWL_PRE_PACKED_STRUCT struct eht_psta_prf_epcs_se {
	uint8	id;
	uint8	len;
	uint16	sta_ctrl;
	uint8	data[];
} BWL_POST_PACKED_STRUCT eht_psta_prf_epcs_se_t;
...
/* bitfields within the EHT MAC capabilities information field, D6.0, section 9.4.2.322.2 */
#define EHT_MAC_CAP_EPCS_PRIORITY_ACCESS_SUPP_IDX	0
#define EHT_MAC_CAP_OM_CONTROL_SUPPORTED_IDX		1
#define EHT_MAC_CAP_TXS_MODE1_SUPPORT_IDX		2
#define EHT_MAC_CAP_TXS_MODE2_SUPPORT_IDX		3
...
#define EHT_MAC_CAP_UNSOL_EPCS_PRIO_ACCESS_PARM_UPD_IDX	14
...
BWL_PRE_PACKED_STRUCT struct dot11_eht_epcs_enab_req {
	uint8	category;
	uint8	action;
	uint8	token;
	uint8	buf[];	/* epcs ml element */
} BWL_POST_PACKED_STRUCT;
typedef struct dot11_eht_epcs_enab_req dot11_eht_epcs_enab_req_t;

BWL_PRE_PACKED_STRUCT struct dot11_eht_epcs_enab_resp {
	uint8	category;
	uint8	action;
	uint8	token;
	uint16	status;
...
typedef struct dot11_eht_epcs_enab_resp dot11_eht_epcs_enab_resp_t;

BWL_PRE_PACKED_STRUCT struct dot11_eht_epcs_teardown {
	uint8	category;
	uint8	action;
} BWL_POST_PACKED_STRUCT;
typedef struct dot11_eht_epcs_teardown dot11_eht_epcs_teardown_t;
...
#define EHT_PAF_ACT_EPCS_ENABLE_REQ	3u	/* Priority Access Enable Request */
#define EHT_PAF_ACT_EPCS_ENABLE_RESP	4u	/* Priority Access Enable Response */
#define EHT_PAF_ACT_EPCS_TEARDOWN	5u	/* Priority Access Teardown */
...
/* EHT OM Control: See Draft P802.11be D6.0, 9.2.4.7.8; see also 802.11ax.h */
...
#define HTC_EHT_OM_CONTROL_MCS15_DISABLE_MASK		0x08
#define HTC_EHT_OM_CONTROL_MCS15_DISABLE_OFFSET		3
#define HTC_EHT_OM_CONTROL_RESERVED_MASK		0x30
#define HTC_EHT_OM_CONTROL_RESERVED_OFFSET		4
...
#define HTC_EHT_OM_CONTROL_MCS15_DISABLE(omi)		\
	(((omi) & HTC_EHT_OM_CONTROL_MCS15_DISABLE_MASK) \
		>> HTC_EHT_OM_CONTROL_MCS15_DISABLE_OFFSET)
...
#define HTC_EHT_OMI_ENCODE(rx, tx, bw) \
	...
	(1 << HTC_EHT_OM_CONTROL_MCS15_DISABLE_OFFSET))
...
/* IEEE P802.11be/D2.1, Section: 36.3.12.7 U-SIG.
 * https://www.radiotap.org/fields/U-SIG.html
*/
#define EHT_USIG_PPDU_VER_IDX			0u
#define EHT_USIG_PPDU_VER_FSZ			3u
#define EHT_USIG_PPDU_BW_IDX			3u
#define EHT_USIG_PPDU_BW_FSZ			3u
#define EHT_USIG_PPDU_UL_DL_IDX			6u
#define EHT_USIG_PPDU_UL_DL_FSZ			1u
#define EHT_USIG_PPDU_BSS_COLOR_IDX		7u
#define EHT_USIG_PPDU_BSS_COLOR_FSZ		6u
#define EHT_USIG_PPDU_TXOP_IDX			13u
#define EHT_USIG_PPDU_TXOP_FSZ			7u
#define EHT_USIG_PPDU_B26B51_IDX		26u
#define EHT_USIG_PPDU_B26B51_FSZ		26u
#define EHT_USIG_PPDU_B26B45_IDX                26u
#define EHT_USIG_PPDU_B26B45_FSZ                20u
