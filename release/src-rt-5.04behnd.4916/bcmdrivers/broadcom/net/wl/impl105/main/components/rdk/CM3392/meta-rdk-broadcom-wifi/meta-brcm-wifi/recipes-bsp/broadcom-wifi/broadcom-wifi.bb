...
BRCM_WIFI_AIRIQ_URI = "file://wifi_airiq.tgz;subdir=${BRCM_WIFI_DRIVER_BASE_DIR}"
...
SRC_URI += "file://kirkstone_wifidrv.patch"
...
#EXTRA_WIFI_OPTS += "RDKB_ONE_WIFI=y"
...
EXTRA_WIFI_OPTS += "LINUX_HDR_DIR=${STAGING_KERNEL_BUILDDIR}/include/${PREFERRED_PROVIDER_virtual/kernel}/include"
...
do_wifi_postunpack() {
	...
	mv ${S}/main/components/rdk/onewifi ${S}/main/components
	rm -rf ${S}/main/components/rdk/*
	mv ${S}/main/components/onewifi ${S}/main/components/rdk/
}
