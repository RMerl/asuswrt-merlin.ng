 ...
 *
 * $Id: bcmdevs.h 837506 2024-03-08 06:28:30Z $
 */
...
#define BCM43684_D11AX_ID	0x4429		/**< 43684 802.11ax 2G+5G device */
#define BCM43684_D11AX2G_ID	0x442a		/**< 43684 802.11ax 2G device */
#define BCM43684_D11AX5G_ID	0x442b		/**< 43684 802.11ax 5G device */
#define BCM43684_D11AX2G6G_ID	0x6004		/**< 43684 802.11ax 2G+6G device */
#define BCM43684_D11AX5G6G_ID	0x6005		/**< 43684 802.11ax 5G+6G device */
#define BCM43684_D11AX6G_ID	0x6006		/**< 43684 802.11ax 6G device */
#define BCM43684_D11AX2G5G6G_ID	0x6016		/**< 43684 802.11ax 2G+5G+6G device */
...
#define BCM6710_D11AX_ID	0x4493		/**< 6710 802.11ax 2G+5G device */
#define BCM6710_D11AX2G_ID	0x4494		/**< 6710 802.11ax 2G device */
#define BCM6710_D11AX5G_ID	0x4495		/**< 6710 802.11ax 5G device */
#define BCM6710_D11AX2G6G_ID	0x6007		/**< 6710 802.11ax 2G+6G device */
#define BCM6710_D11AX5G6G_ID	0x6008		/**< 6710 802.11ax 5G+6G device */
...
#define BCM6715_D11AX_ID	0x6001		/**< 6715 802.11ax 2G+5G device */
#define BCM6715_D11AX2G_ID	0x6002		/**< 6715 802.11ax 2G device */
#define BCM6715_D11AX5G_ID	0x6003		/**< 6715 802.11ax 5G device */
#define BCM6715_D11AX2G6G_ID	0x600a		/**< 6715 802.11ax 2G+6G device */
#define BCM6715_D11AX5G6G_ID	0x600b		/**< 6715 802.11ax 5G+6G device */
#define BCM6715_D11AX6G_ID	0x600c		/**< 6715 802.11ax 6G device */
#define BCM6715_D11AX2G5G6G_ID	0x6017		/**< 6715 802.11ax 2G+5G+6G device */
						/**< this is a fake device for ATE & Veloce */
...
#define BCM6717_D11BE2G6G_ID	0x6028		/**< 6717 802.11be 2G+6G device */
#define BCM6717_D11BE5G6G_ID	0x6029		/**< 6717 802.11be 5G+6G device */
#define BCM6717_D11BE2G5G6G_ID	0x602a		/**< 6717 802.11be 2G+5G+6G device */

#define BCM6726_D11BE_ID	0x602b		/**< 6726 802.11be 2G+5G device */
#define BCM6726_D11BE2G_ID	0x602c		/**< 6726 802.11be 2G device */
#define BCM6726_D11BE5G_ID	0x602d		/**< 6726 802.11be 5G device */
#define BCM6726_D11BE6G_ID	0x602e		/**< 6726 802.11be 6G device */
#define BCM6726_D11BE2G6G_ID	0x602f		/**< 6726 802.11be 2G+6G device */
#define BCM6726_D11BE5G6G_ID	0x6030		/**< 6726 802.11be 5G+6G device */
#define BCM6726_D11BE2G5G6G_ID	0x6031		/**< 6726 802.11be 2G+5G+6G device */

#define BCM6711_D11BE2G_ID	0x6711		/**< 6711 802.11be 2G device */

#define BCM6878_D11AC_ID	0x6878		/**< 6878 802.11ac dualband device */
#define BCM6878_D11AC2G_ID	0x4496		/**< 6878 802.11ac 2G device */
#define BCM6878_D11AC5G_ID	0x4497		/**< 6878 802.11ac 5G device */
...
#define EMBEDDED_2x2AX_ID		0xf6ca	/**< 63178 2x2 802.11ax embedded 2G+5G device */
...
#define EMBEDDED_2x2AX_DEV6G_ID		0x6013	/**< 802.11ax 2x2 embedded 6G band device */
#define EMBEDDED_2x2AX_DEV2G6G_ID	0x6014	/**< 802.11ax 2x2 embedded 2G+6G band device */
#define EMBEDDED_2x2AX_DEV5G6G_ID	0x6015	/**< 802.11ax 2x2 embedded 5G+6G band device */
#define EMBEDDED_2x2AX160_ID		0x6756	/**< 6756 2x2 .11ax 160MHz embedded 2G+5G device */
#define EMBEDDED_2x2AX160_DEV2G_ID	0x6018	/**< .11ax 2x2 160MHz embedded 2.4G band device */
#define EMBEDDED_2x2AX160_DEV5G_ID	0x6019	/**< .11ax 2x2 160MHz embedded 5G band device */
#define EMBEDDED_2x2AX160_DEV6G_ID	0x601a	/**< .11ax 2x2 160MHz embedded 6G band device */
#define EMBEDDED_2x2AX160_DEV2G6G_ID    0x601b	/**< .11ax 2x2 160MHz embedded 2G+6G band device */
#define EMBEDDED_2x2AX160_DEV5G6G_ID    0x601c	/**< .11ax 2x2 160MHz embedded 5G+6G band device */

#define EMBEDDED_2x2BE320_ID		0x6765	/**< 6765 2x2 .11be 320MHz embedded 2+5+6G device */
#define EMBEDDED_2x2BE320_DEV2G_ID	0x6032	/**< .11be 2x2 320MHz embedded 2.4G band device */
#define EMBEDDED_2x2BE320_DEV5G_ID	0x6033	/**< .11be 2x2 320MHz embedded 5G band device */
#define EMBEDDED_2x2BE320_DEV6G_ID	0x6034	/**< .11be 2x2 320MHz embedded 6G band device */
#define EMBEDDED_2x2BE320_DEV2G5G_ID    0x6035	/**< .11be 2x2 320MHz embedded 2G+5G band device */
#define EMBEDDED_2x2BE320_DEV5G6G_ID    0x6036	/**< .11be 2x2 320MHz embedded 5G+6G band device */
#define EMBEDDED_2x2BE320_DEV2G6G_ID    0x6037	/**< .11be 2x2 320MHz embedded 2G+6G band device */
/* 6766 cores: */
#define EMBEDDED_2x2BE40_2G_ID		0x6038	/**< .11be 2x2 40MHz embedded 2G band chip id */
#define EMBEDDED_2x2BE40_DEV2G_ID	0x6038	/**< .11be 2x2 40MHz embedded 2G band device id */
#define EMBEDDED_4x4BE160_5G6G_ID	0x6039	/**< .11be 4x4 160MHz embedded 5+6G band chip id */
#define EMBEDDED_4x4BE160_DEV5G6G_ID	0x6039	/**< .11be 4x4 160MHz embedded 5+6G band dev id */
#define EMBEDDED_4x4BE160_DEV5G_ID	0x603e	/**< .11be 4x4 160MHz embedded 5G band device */
#define EMBEDDED_4x4BE160_DEV6G_ID	0x603f	/**< .11be 4x4 160MHz embedded 6G band device */

/* 6756/47623 tri-band device */
#define EMBEDDED_2x2AX160_DEV2G5G6G_ID	0x603a	/**< .11ax 2x2 160MHz embedded 2+5+6G band device */

/* 6764 cores: */
#define EMBEDDED_2x2BE160_5G6G_ID	0x603b	/**< .11be 2x2 160MHz embedded 5+6G band device */
#define EMBEDDED_2x2BE160_DEV5G6G_ID	0x603b	/**< .11be 2x2 160MHz embedded 5+6G band device */
#define EMBEDDED_2x2BE160_DEV5G_ID	0x6040	/**< .11be 2x2 160MHz embedded 5G band device */
#define EMBEDDED_2x2BE160_DEV6G_ID	0x6041	/**< .11be 2x2 160MHz embedded 6G band device */
...
#define BCM6717_DEVICE(devid)	(((devid) == BCM6717_D11BE_ID) || \
				((devid) == BCM6717_D11BE2G_ID) || \
				((devid) == BCM6717_D11BE5G_ID) || \
				((devid) == BCM6717_D11BE6G_ID) || \
				((devid) == BCM6717_D11BE2G6G_ID) || \
				((devid) == BCM6717_D11BE5G6G_ID) || \
				((devid) == BCM6717_D11BE2G5G6G_ID))

#define BCM6726_DEVICE(devid)	(((devid) == BCM6726_D11BE_ID) || \
				((devid) == BCM6726_D11BE2G_ID) || \
				((devid) == BCM6726_D11BE5G_ID) || \
				((devid) == BCM6726_D11BE6G_ID) || \
				((devid) == BCM6726_D11BE2G6G_ID) || \
				((devid) == BCM6726_D11BE5G6G_ID) || \
				((devid) == BCM6726_D11BE2G5G6G_ID))

#define BCM6711_DEVICE(devid)	((devid) == BCM6711_D11BE2G_ID)
...
#define BCM6765_CHIP_ID		0x6765
/* 6766 uses DEVID for CHIPID */
...
#define CASE_EMBEDDED_2x2AX_160MHZ_CORE	case BCM6756_CHIP_ID

#define CASE_EMBEDDED_2x2AX_CORE	CASE_EMBEDDED_2x2AX_80MHZ_CORE: \
					CASE_EMBEDDED_2x2AX_160MHZ_CORE

#define EMBEDDED_2x2BE_320MHZ_CORE(chipid)	(CHIPID(chipid) == BCM6765_CHIP_ID)
#define EMBEDDED_2x2BE_40MHZ_CORE(chipid)	(CHIPID(chipid) == EMBEDDED_2x2BE40_2G_ID)
#define EMBEDDED_4x4BE_160MHZ_CORE(chipid)	(CHIPID(chipid) == EMBEDDED_4x4BE160_5G6G_ID)
#define EMBEDDED_2x2BE_160MHZ_CORE(chipid)	(CHIPID(chipid) == EMBEDDED_2x2BE160_5G6G_ID)

#define EMBEDDED_11BE_CORE(chipid)		(EMBEDDED_2x2BE_320MHZ_CORE(chipid) || \
						 EMBEDDED_2x2BE_40MHZ_CORE(chipid) || \
						 EMBEDDED_4x4BE_160MHZ_CORE(chipid) || \
						 EMBEDDED_2x2BE_160MHZ_CORE(chipid))

#define CASE_EMBEDDED_2x2BE_320MHZ_CORE		case BCM6765_CHIP_ID
#define CASE_EMBEDDED_2x2BE_40MHZ_CORE		case EMBEDDED_2x2BE40_2G_ID
#define CASE_EMBEDDED_2x2BE_160MHZ_CORE		case EMBEDDED_2x2BE160_5G6G_ID
#define CASE_EMBEDDED_4x4BE_160MHZ_CORE		case EMBEDDED_4x4BE160_5G6G_ID

#define CASE_EMBEDDED_11BE_CORE			CASE_EMBEDDED_2x2BE_320MHZ_CORE: \
						CASE_EMBEDDED_2x2BE_40MHZ_CORE: \
						CASE_EMBEDDED_4x4BE_160MHZ_CORE :\
						CASE_EMBEDDED_2x2BE_160MHZ_CORE

#define EMBEDDED_WLAN_CORE(chipid)		(EMBEDDED_2x2AX_CORE(chipid) || \
						 EMBEDDED_11BE_CORE(chipid))

#define EMBEDDED_11BE_CORE_DEVICE(devid)	(((devid) == EMBEDDED_2x2BE160_5G6G_ID) || \
						((devid) == EMBEDDED_2x2BE160_DEV5G6G_ID) || \
						((devid) == EMBEDDED_2x2BE160_DEV5G_ID) || \
						((devid) == EMBEDDED_2x2BE160_DEV6G_ID) || \
						((devid) == EMBEDDED_2x2BE320_ID) || \
						((devid) == EMBEDDED_2x2BE320_DEV2G_ID) || \
						((devid) == EMBEDDED_2x2BE320_DEV5G_ID) || \
						((devid) == EMBEDDED_2x2BE320_DEV6G_ID) || \
						((devid) == EMBEDDED_2x2BE320_DEV2G5G_ID) || \
						((devid) == EMBEDDED_2x2BE320_DEV5G6G_ID) || \
						((devid) == EMBEDDED_2x2BE320_DEV2G6G_ID) || \
						((devid) == EMBEDDED_2x2BE40_2G_ID) || \
						((devid) == EMBEDDED_2x2BE40_DEV2G_ID) || \
						((devid) == EMBEDDED_4x4BE160_5G6G_ID) || \
						((devid) == EMBEDDED_4x4BE160_DEV5G6G_ID) || \
						((devid) == EMBEDDED_4x4BE160_DEV5G_ID) || \
						((devid) == EMBEDDED_4x4BE160_DEV6G_ID))
...
#define BCM43794_CHIP_ID	0xab12
#define BCM6715_CHIP(chipid)	((CHIPID(chipid) == BCM6715_CHIP_ID) || \
				 (CHIPID(chipid) == BCM43794_CHIP_ID))
#define CASE_BCM6715_CHIP	case BCM6715_CHIP_ID: /* fallthrough */ \
				case BCM43794_CHIP_ID

#define BCM6726_CHIP_ID		0x6726		/* 6726 chipcommon chipid */
#define BCM43740_CHIP_ID	0xaadc		/* 43740 chipid, 6726 EAP 4x4 variant */
#define BCM43720_CHIP_ID	0xaac8		/* 43720 chipid, 6726 EAP 2x2 variant */
#define BCM6716_CHIP_ID		0x6716		/* 6716 chipcommon chipid */
#define BCM6726_CHIP(chipid)	((CHIPID(chipid) == BCM6726_CHIP_ID) || \
				 (CHIPID(chipid) == BCM6716_CHIP_ID) || \
				 (CHIPID(chipid) == BCM43740_CHIP_ID) || \
				 (CHIPID(chipid) == BCM43720_CHIP_ID))
#define CASE_BCM6726_CHIP	case BCM6726_CHIP_ID: /* fallthrough */ \
				case BCM6716_CHIP_ID: /* fallthrough */ \
				case BCM43740_CHIP_ID: /* fallthrough */ \
				case BCM43720_CHIP_ID

#define BCM6717_CHIP_ID		0x6717		/* 6717 chipcommon chipid */
#define BCM43741_CHIP_ID	0xaadd
#define BCM43721_CHIP_ID	0xaac9		/* 43721 chipid, 6717 EAP 2x2 variant */
#define BCM6717_CHIP(chipid)	((CHIPID(chipid) == BCM6717_CHIP_ID) || \
				 (CHIPID(chipid) == BCM43741_CHIP_ID) || \
				 (CHIPID(chipid) == BCM43721_CHIP_ID))
#define CASE_BCM6717_CHIP	case BCM6717_CHIP_ID: /* fallthrough */ \
				case BCM43741_CHIP_ID: /* fallthrough for 2x2 variant */ \
				case BCM43721_CHIP_ID

#define BCM6711_CHIP_ID		0x6711		/* 6711 chipcommon chipid */
#define BCM43730_CHIP_ID	0xaad2		/* 43730 chipid, 6711 2+1 variant */
#define BCM6706_CHIP_ID		0x6706		/* 6706 chipid, 6711 2x2 variant */
#define BCM6711_CHIP(chipid)	((CHIPID(chipid) == BCM6711_CHIP_ID) || \
				 (CHIPID(chipid) == BCM43730_CHIP_ID) || \
				 (CHIPID(chipid) == BCM6706_CHIP_ID))
#define CASE_BCM6711_CHIP	case BCM6711_CHIP_ID: /* fallthrough */ \
				case BCM43730_CHIP_ID: /* fallthrough for 2+1 variant */ \
...
/* Mock NIC chip id to satisfy feature_defs.h */
#define BCMNIC_CHIP_ID		0x0ffc
#define BCMNIC_CHIP(chipid)	((CHIPID(chipid) == BCMNIC_CHIP_ID))
...
#define BCM6715X_PKG_ID		(0x2)	/* 6715 die in 43684 package. 5G and 2G+5G */
#define BCM6715X2_PKG_ID	(0x10)	/* 6715 die in 43684 package. 2G only */
...
#define BCM6711_HW_CFG2_MASK	(0x4)
#define BCM6711_HW_CFG4_MASK	(0x10)
#define BCM6711_HW_CFG_VARIANT_MASK		(BCM6711_HW_CFG1_MASK | BCM6711_HW_CFG2_MASK | \
						 BCM6711_HW_CFG4_MASK)
#define BCM6711_THREE_BY_THREE_HW_CFG		(0x10)
#define BCM6711_TWO_PLUS_ONE_HW_CFG		(0x04)
#define BCM6711_TWO_BY_TWO_HW_CFG		(0x12)
#define BCM6711_THREE_BY_THREE_PKG(otpflag)	((otpflag & BCM6711_HW_CFG_VARIANT_MASK) == \
						BCM6711_THREE_BY_THREE_HW_CFG)
#define BCM6711_TWO_PLUS_ONE_PKG(otpflag)	((otpflag & BCM6711_HW_CFG_VARIANT_MASK) == \
						BCM6711_TWO_PLUS_ONE_HW_CFG)
#define BCM6711_TWO_BY_TWO_PKG(otpflag)		((otpflag & BCM6711_HW_CFG_VARIANT_MASK) == \
						BCM6711_TWO_BY_TWO_HW_CFG)

#define BCM6711_HW_CFG0_ID		(0x1)
#define BCM6711_HW_CFG0_ID_MASK		(0x1)
#define BCM6711_HW_CFG0(otpflag)	((otpflag & BCM6711_HW_CFG0_ID_MASK) == BCM6711_HW_CFG0_ID)
...
#define BFL_EXTLNA_6GHz		0x20000000  /* Board has an external LNA in 6GHz band */
...
#define BFL2_SROM20_SPURWAR 0x30000000
/* 0:DSSF, 1:SpurCan, 2:DSSF+SpurCan, 3:off, Only for internal FEM */

/* boardflags3 */
#define BFL3_FEMCTRL_SUB	  0x00000007  /* subrevs of femctrl on top of femctrl, srom<19 */
...
#define BFL4_SROM13_CCK_DIG_FILT (1 << 22) /* Apply wider CCK digital filter */
/* Apply wider CCK digital filter, it only takes effect under EU and country ALL */
#define BFL4_SROM18_LOFT_COMP_2X (1 << 23) /* enable 2x loft comp */
#define BFL4_SROM18_LOW_RATE_ADC_IDLE_TSSI (1 << 24) /* Enable low_rate_adc for idle_tssi_cal */
#define BFL4_SROM18_PKT_BASED_IDLETSSI (1 << 25) /* Enable packet-based for idle_tssi_cal */
#define BFL4_SROM18_SUBBAND_ED_ADJ (1 << 26) /* Enable subband ed threshold adjustment */
#define BFL4_SROM18_RSSI_LOW_SNR (1 << 27) /* RSSI accuracy improvement in low SNR region */
#define BFL4_SROM18_ILNA_TBL (7 << 29) /* ilna-table choice */
...
/* 43x94 MCLX Boards */
#define BCM943794MCLX		0x09b6 /* 43794 MCLX tri-band scanning radio board */
#define BCM943694C0MCLX		0x099b /* 43694C0 MCLX tr-band scanning radio board */
#define BCM_MCLX_BOARD(boardtype)	((boardtype == BCM943794MCLX) || \
					(boardtype == BCM943694C0MCLX))
