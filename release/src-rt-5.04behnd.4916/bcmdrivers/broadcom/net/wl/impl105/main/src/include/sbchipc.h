 ...
 *
 * $Id: sbchipc.h 839233 2024-04-18 13:31:09Z $
 *
...
typedef volatile struct {
	...
	/* uWire SROM interface (corerev >= 32) */
	...
	uint32	PAD[55];
	uint32	wotp_rx_cmd;		/* 0x4e4, rev >= 131 */
	uint32	wotp_rx_data;		/* 0x4e8, rev >= 131 */
	uint32	sprom_spi_ctrl;		/* 0x4ec, rev >= 132 */
	uint16	sprom_spi_addr;		/* 0x4f0, rev >= 132 */
	uint16  PAD[1];
	uint32	sprom_spi_data;		/* 0x4f4, rev >= 132 */
	uint32	PAD[2];
...
/* WL indication of MCHAN enabled/disabled to BT in unsupported mode- bit 36 */
...
/* Fields in the wotp_rx_cmd register (rev >= 131) */
#define WOTP_RX_CMD_DAT_SEL_MASK	(3 << 0) /**< select word */
#define WOTP_RX_CMD_DAT_AV_MASK		(1 << 2) /**< data available */
#define WOTP_RX_CMD_FOUT_ERR_MASK	(1 << 3) /**< fout rx error */
...
/* When Srom support present, fields in sromcontrol (for uWire SPROM) */
#define	UWIRE_START		0x80000000
#define	UWIRE_BUSY		0x80000000
#define	UWIRE_OPCODE		0x60000000
#define	UWIRE_OP_READ		0x00000000
#define	UWIRE_OP_WRITE		0x20000000
#define	UWIRE_OP_WRDIS		0x40000000
#define	UWIRE_OP_WREN		0x60000000
#define	SRC_OTPSEL		0x00000010
#define SRC_OTPPRESENT		0x00000020
#define	UWIRE_LOCK		0x00000008
#define	UWIRE_SIZE_MASK		0x00000006
#define	UWIRE_SIZE_SHIFT	         1
#define	UWIRE_PRESENT		0x00000001

/* sprom_spi_ctrl register bitfields */
#define SPROM_SPICTL_SPROM_PRESENT	(1 << 0)
#define SPROM_SPICTL_SPROM_SIZE_SHIFT	1
#define SPROM_SPICTL_SPROM_SIZE_MASK	(3 << SPROM_SPICTL_SPROM_SIZE_SHIFT)
#define SPROM_SPICTL_OTP_SEL		(1 << 4)
#define SPROM_SPICTL_ADDR_SIZE		(1 << 6)
#define SPROM_SPICTL_SPI_CMD_SHIFT	16
#define SPROM_SPICTL_SPI_CMD_MASK	(0xFF << SPROM_SPICTL_SPI_CMD_SHIFT)
#define SPROM_SPICTL_SPI_DATASZ_SHIFT	24
#define SPROM_SPICTL_SPI_DATASZ_MASK	(0x3 << SPROM_SPICTL_SPI_DATASZ_SHIFT)
#define SPROM_SPICTL_START_BUSY		(1 << 31)

/** values to use in SPROM_SPICTL_SPROM_SIZE_ bitfield */
#define SPROM_SPI_SZ_RSVD		0
#define SPROM_SPI_SZ_16KBITS		1
#define SPROM_SPI_SZ_32KBITS		2
#define SPROM_SPI_SZ_64KBITS		3

/** values to use in SPROM_SPICTL_SPI_DATASZ bitfield */
#define SPROM_SPI_ACCESS_SZ_1B		0
#define SPROM_SPI_ACCESS_SZ_2B		1
#define SPROM_SPI_ACCESS_SZ_3B		2
#define SPROM_SPI_ACCESS_SZ_4B		3

/** values to use in SPROM_SPICTL_SPI_CMD bitfield */
#define SPROM_SPI_CMD_WRSR		0x01 /**< write status reg */
#define SPROM_SPI_CMD_WRITE		0x02
#define SPROM_SPI_CMD_READ		0x03
#define SPROM_SPI_CMD_WRDIS		0x04 /**< write disable (=lock) */
#define SPROM_SPI_CMD_RDSR		0x05 /**< read status reg */
#define SPROM_SPI_CMD_WREN		0x06 /**< write enable (=unlock) */

/* various uWire SPROM register bitfields */
#define SROM16K_BANK_SEL_MASK	(3 << 11)  /* chipcontrol register */
#define SROM16K_BANK_SHFT_MASK	11
#define SROM16K_ADDR_SEL_MASK	((1 << SROM16K_BANK_SHFT_MASK) - 1)

#define UWIRE_SIZE_128BITS		0
#define UWIRE_SIZE_512BITS		1
#define UWIRE_SIZE_2048BITS		2
#define UWIRE_SIZE_8192BITS		3
...
#define PMU_CC2_4369_XTALCORESIZE_BIAS_ADJ_START_VAL	(0x0 << 26)
...
/* 43684 PMU CC registers */
#define PMU_43684_CC1_FORCE_CPUPLL_PWRDN_LDO	(1 << 0)
#define PMU_43684_CC1_FORCE_CPUPLL_ARESET	(1 << 1)
#define PMU_43684_CC1_FORCE_CPUPLL_DRESET	(1 << 2)
#define PMU_43684_CC1_PMU_CPUPLL_CONTROL_OVR	(1 << 3)
#define PMU_43684_CC1_CPUPLL_HOLD_CH		(1 << 14)

/* PLL usage in 6715 */
#define PMU6715_PLL0_PC0_PDIV_MASK		0x0000000f
#define PMU6715_PLL0_PC0_PDIV_SHIFT		0
#define PMU6715_PLL0_PC0_NDIV_INT_MASK		0x00003ff0
#define PMU6715_PLL0_PC0_NDIV_INT_SHIFT		4
...
#define PMU6715_PLL0_PC2_NDIV_FRAC_MODE_SEL	(1<<26)
#define PMU6715_PLL0_PC3_CH0_MDIV_MASK		0x000001ff
#define PMU6715_PLL0_PC3_CH0_MDIV_SHIFT		0
#define PMU6715_PLL0_PC3_CH1_MDIV_MASK		0x0003fe00
#define PMU6715_PLL0_PC3_CH1_MDIV_SHIFT		9
#define PMU6715_PLL0_PC3_CH2_MDIV_MASK		0x07fc0000
#define PMU6715_PLL0_PC3_CH2_MDIV_SHIFT		18
#define PMU6715_PLL0_PC4_CH3_MDIV_MASK		0x000001ff
#define PMU6715_PLL0_PC4_CH3_MDIV_SHIFT		0

#define PMU6715_PLL1_PC6_PDIV_MASK		0x0000000f
#define PMU6715_PLL1_PC6_PDIV_SHIFT		0
#define PMU6715_PLL1_PC6_NDIV_INT_MASK		0x00003ff0
#define PMU6715_PLL1_PC6_NDIV_INT_SHIFT		4
...
#define PMU6715_PLL1_PC9_CH0_MDIV_MASK		0x000001ff
#define PMU6715_PLL1_PC9_CH0_MDIV_SHIFT		0

/* 6715 Chip control registers macro definitions */
#define PMU_6715_CC3_TXSTATUS_ACK_SEL_MASK	0x00080000
#define PMU_6715_CC3_TXSTATUS_ACK_SEL_HWA	0x00080000
#define PMU_6715_CC5_FORCE_CPUPLL_PWRDN_LDO	(1 << 0)
#define PMU_6715_CC5_FORCE_CPUPLL_ARESET	(1 << 1)
#define PMU_6715_CC5_FORCE_CPUPLL_DRESET	(1 << 2)
#define PMU_6715_CC5_PMU_CPUPLL_CONTROL_OVR	(1 << 3)
#define PMU_6715_CC5_CPUPLL_HOLD_CH		(1 << 14)

/* 6765 Chip control registers macro definitions */
#define PMU_6765_CC5_RADARDET_BLNK_BUS_MASK_0	0x00100000
#define PMU_6765_CC5_RADARDET_BLNK_BUS_MASK_1	0x00200000
#define PMU_6765_CC5_RADARDET_BLNK_BUS_MASK_2	0x00400000
#define PMU_6765_CC5_TXACTV_EXT_MODE_MASK	0x04000000
#define PMU_6765_CC5_TXACTV_EXT_MODE_SEL	0x04000000
#define PMU_6765_CC5_TXACTV_INT_MODE_MASK	0x08000000
#define PMU_6765_CC5_TXACTV_INT_MODE_SEL	0x08000000

/* 6717 PLL registers */
#define PMU6717_PLL0_PC0_PDIV_MASK		0x0000003f
#define PMU6717_PLL0_PC0_PDIV_SHIFT		0
#define PMU6717_PLL0_PC0_NDIV_INT_MASK		0x0000ffc0
#define PMU6717_PLL0_PC0_NDIV_INT_SHIFT		6
#define PMU6717_PLL0_PC1_NDIV_P_MASK		0x000003ff
#define PMU6717_PLL0_PC1_NDIV_P_SHIFT		0
#define PMU6717_PLL0_PC1_NDIV_Q_MASK		0x000ffc00
#define PMU6717_PLL0_PC1_NDIV_Q_SHIFT		10
#define PMU6717_PLL0_PC1_NDIV_FRAC_MODE_SEL	(1<<20)
#define PMU6717_PLL0_PC5_CH0_MDIV_MASK		0x000000ff
#define PMU6717_PLL0_PC5_CH0_MDIV_SHIFT		0
#define PMU6717_PLL0_PC5_CH1_MDIV_MASK		0x0000ff00
#define PMU6717_PLL0_PC5_CH1_MDIV_SHIFT		8
#define PMU6717_PLL0_PC5_CH2_MDIV_MASK		0x00ff0000
#define PMU6717_PLL0_PC5_CH2_MDIV_SHIFT		16
#define PMU6717_PLL0_PC5_CH3_MDIV_MASK		0xff000000
#define PMU6717_PLL0_PC5_CH3_MDIV_SHIFT		24
#define PMU6717_PLL1_PC7_PDIV_MASK		0x0000000f
#define PMU6717_PLL1_PC7_PDIV_SHIFT		0
#define PMU6717_PLL1_PC7_NDIV_INT_MASK		0x00003ff0
#define PMU6717_PLL1_PC7_NDIV_INT_SHIFT		4
#define PMU6717_PLL1_PC8_NDIV_P_MASK		0x000003ff
#define PMU6717_PLL1_PC8_NDIV_P_SHIFT		0
#define PMU6717_PLL1_PC8_NDIV_Q_MASK		0x000ffc00
#define PMU6717_PLL1_PC8_NDIV_Q_SHIFT		10
#define PMU6717_PLL1_PC8_NDIV_FRAC_MODE_SEL	(1<<20)

/* 6717 PMU CC registers */
#define PMU_6717_CC5_FORCE_CPUPLL_PWRDN_LDO	(1 << 0)
#define PMU_6717_CC5_FORCE_CPUPLL_ARESET	(1 << 1)
#define PMU_6717_CC5_FORCE_CPUPLL_DRESET	(1 << 2)
#define PMU_6717_CC5_PMU_CPUPLL_CONTROL_OVR	(1 << 3)
#define PMU_6717_CC5_CPUPLL_HOLD_CH		(1 << 14)

/* 6726 PLL registers */
#define PMU6726_PLL0_PC0_PDIV_MASK		0x0000000f
#define PMU6726_PLL0_PC0_PDIV_SHIFT		0
#define PMU6726_PLL0_PC0_NDIV_INT_MASK		0x00003ff0
#define PMU6726_PLL0_PC0_NDIV_INT_SHIFT		4
#define PMU6726_PLL0_PC1_NDIV_P_MASK		0x000003ff
#define PMU6726_PLL0_PC1_NDIV_P_SHIFT		0
#define PMU6726_PLL0_PC1_NDIV_Q_MASK		0x000ffc00
#define PMU6726_PLL0_PC1_NDIV_Q_SHIFT		10
#define PMU6726_PLL0_PC2_NDIV_FRAC_MODE_SEL	(1<<26)
#define PMU6726_PLL0_PC3_CH0_MDIV_MASK		0x000001ff
#define PMU6726_PLL0_PC3_CH0_MDIV_SHIFT		0
#define PMU6726_PLL0_PC3_CH1_MDIV_MASK		0x0003fe00
#define PMU6726_PLL0_PC3_CH1_MDIV_SHIFT		9
#define PMU6726_PLL0_PC3_CH2_MDIV_MASK		0x03fc0000
#define PMU6726_PLL0_PC3_CH2_MDIV_SHIFT		18
#define PMU6726_PLL0_PC4_CH3_MDIV_MASK		0x000001ff
#define PMU6726_PLL0_PC4_CH3_MDIV_SHIFT		0
#define PMU6726_PLL1_PC6_PDIV_MASK		0x0000000f
#define PMU6726_PLL1_PC6_PDIV_SHIFT		0
#define PMU6726_PLL1_PC6_NDIV_INT_MASK		0x00003ff0
#define PMU6726_PLL1_PC6_NDIV_INT_SHIFT		4
#define PMU6726_PLL1_PC7_NDIV_P_MASK		0x000003ff
#define PMU6726_PLL1_PC7_NDIV_P_SHIFT		0
#define PMU6726_PLL1_PC7_NDIV_Q_MASK		0x000ffc00
#define PMU6726_PLL1_PC7_NDIV_Q_SHIFT		10
#define PMU6726_PLL1_PC8_NDIV_FRAC_MODE_SEL	(1<<26)
#define PMU6726_PLL1_PC9_CH0_MDIV_MASK		0x000001ff
#define PMU6726_PLL1_PC9_CH0_MDIV_SHIFT		0

/* 6726 PMU CC registers */
#define PMU_6726_CC3_NIC_MODE			(1 << 25)

#define PMU_6726_CC5_FORCE_CPUPLL_PWRDN_LDO	(1 << 0)
#define PMU_6726_CC5_FORCE_CPUPLL_ARESET	(1 << 1)
#define PMU_6726_CC5_FORCE_CPUPLL_DRESET	(1 << 2)
#define PMU_6726_CC5_PMU_CPUPLL_CONTROL_OVR	(1 << 3)
#define PMU_6726_CC5_CPUPLL_HOLD_CH		(1 << 14)

/* 6711 PLL registers */
#define PMU6711_PLL0_PC0_PDIV_MASK		0x0000000f
#define PMU6711_PLL0_PC0_PDIV_SHIFT		0
#define PMU6711_PLL0_PC0_NDIV_INT_MASK		0x00003ff0
#define PMU6711_PLL0_PC0_NDIV_INT_SHIFT		4
#define PMU6711_PLL0_PC1_NDIV_P_MASK		0x000003ff
#define PMU6711_PLL0_PC1_NDIV_P_SHIFT		0
#define PMU6711_PLL0_PC1_NDIV_Q_MASK		0x000ffc00
#define PMU6711_PLL0_PC1_NDIV_Q_SHIFT		10
#define PMU6711_PLL0_PC2_NDIV_FRAC_MODE_SEL	(1 << 26)
#define PMU6711_PLL0_PC3_CH0_MDIV_MASK		0x000001ff
#define PMU6711_PLL0_PC3_CH0_MDIV_SHIFT		0
#define PMU6711_PLL0_PC3_CH1_MDIV_MASK		0x0003fe00
#define PMU6711_PLL0_PC3_CH1_MDIV_SHIFT		9
#define PMU6711_PLL0_PC3_CH2_MDIV_MASK		0x07fc0000
#define PMU6711_PLL0_PC3_CH2_MDIV_SHIFT		18
#define PMU6711_PLL0_PC4_CH3_MDIV_MASK		0x000001ff
#define PMU6711_PLL0_PC4_CH3_MDIV_SHIFT		0
...
/* 43684 Chip status bits */
#define CST43684_CPUPLL_LOCKED			(1<<6)

#define RES2x2AX_XTAL_STABLE			0
#define RES2x2AX_WL_CORE_RDY			1
#define RES2x2AX_BB_PLL_LDO_PU			2
#define RES2x2AX_BB_PLL_PU			3
#define RES2x2AX_ILP_REQ			4
#define RES2x2AX_ALP_AVAIL			5
#define RES2x2AX_HT_AVAIL			6
#define RES2x2AX_RADIO_BG_PU			7
#define RES2x2AX_MINI_PMU_PU			8
#define RES2x2AX_RADIO_PU			9
#define RES2x2AX_MACPHY_CLK_AVAIL		10

#define TSF_CLK_FRAC_L_63178_240p0431MHZ	0x4412
#define TSF_CLK_FRAC_H_63178_240p0431MHZ	0x4
#define TSF_CLK_FRAC_L_63178_242p2504MHZ	0x3A1F
#define TSF_CLK_FRAC_H_63178_242p2504MHZ	0x4
...
/* 6715 Chip status bits */
#define CST6715_CPUPLL_LOCKED			(1<<18)

/* 6717 PMU resources, also used by 6726 */
#define RES6717_XTAL_PU				0
#define RES6717_XTAL_STABLE			1
#define RES6717_PCIE_LDO_BG_PU			2
#define RES6717_PCIE_LDO_PU			3
#define RES6717_WL_CORE_RDY			4
#define RES6717_ILP_REQ				5
#define RES6717_BB_PLL_LDO_PU			6
#define RES6717_BB_PLL_PU			7
#define RES6717_ALP_AVAIL			8
#define RES6717_HT_AVAIL			9
#define RES6717_RADIO_BG_PU			10
#define RES6717_MINI_PMU_PU			11
#define RES6717_RADIO_PU			12
#define RES6717_MACPHY_CLK_AVAIL		13
#define RES6717_LVM_DIS				14
#define RES6717_CPU_PLL_LDO_PU			15
#define RES6717_CPU_PLL_PU			16

/* 6717 Chip status bits, also used by 6726 */
#define CST6717_CPUPLL_LOCKED			(1<<18)

/* 6711 PMU resources */
#define RES6711_XTAL_PU				0
#define RES6711_XTAL_STABLE			1
#define RES6711_PCIE_LDO_BG_PU			2
#define RES6711_PCIE_LDO_PU			3
#define RES6711_WL_CORE_RDY			4
#define RES6711_ILP_REQ				5
#define RES6711_BB_PLL_LDO_PU			6
#define RES6711_BB_PLL_PU			7
#define RES6711_ALP_AVAIL			8
#define RES6711_HT_AVAIL			9
#define RES6711_RADIO_BG_PU			10
#define RES6711_MINI_PMU_PU			11
#define RES6711_RADIO_PU			12
#define RES6711_MACPHY_CLK_AVAIL		13
#define RES6711_LVM_DIS				14
#define RES6711_SR_CLK_STABLE			15
#define RES6711_SR_SAVE				16
...
#define CA53_6717_RAM_BASE                   (0x0)
#define CA7_6726_RAM_BASE                    (0x0)
...
#define ECI_OUT_CHANNEL_MASK (ECI48_OUT_MASKMAGIC_HIWORD | 0xf000)
#define ECI_OUT_CHANNEL_SHIFT (12)
#define ECI_OUT_BW_MASK (ECI48_OUT_MASKMAGIC_HIWORD | 0xe00)
#define ECI_OUT_BW_SHIFT (9)
#define ECI_OUT_ANTENNA_MASK (ECI48_OUT_MASKMAGIC_HIWORD | 0x100)
#define ECI_OUT_ANTENNA_SHIFT (8)
#define ECI_OUT_SIMUL_TXRX_MASK (ECI48_OUT_MASKMAGIC_HIWORD | 0x80)
#define ECI_OUT_SIMUL_TXRX_SHIFT (7)
#define ECI_OUT_FM_DISABLE_MASK (ECI48_OUT_MASKMAGIC_HIWORD | 0x40)
#define ECI_OUT_FM_DISABLE_SHIFT (6)
