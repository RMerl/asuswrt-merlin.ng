 ...
 *
 * $Id: siutils.h 836755 2024-02-21 02:36:27Z $
 */
...
/*
 * XXX: TODO move this to hw-specific .h file (TBD)
 * Note: All following OFFSET are based on CM_CLUSTER_ADDR 0x2A00_0000
 * except CM_CLUSTER_ADDR_OFFST
 */
...
#define CM_ICC_REGS_MEM_OFFSET      0x00010000 // ICC Regs offset from mem base
...
#define CPUDBG_HOSTBUF_SZ		(CM_CPU_DBG_BUF_SIZE * 2) // 64k
...
#define CM_CPU_DBG_CFG_LINKID_MASK	0x0f00	/* linkId */
#define CM_CPU_DBG_CFG_LINKID_SHIFT	8
