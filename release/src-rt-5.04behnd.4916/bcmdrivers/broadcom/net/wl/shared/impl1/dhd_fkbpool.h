...
#ifdef WLCSM_DEBUG
FkBuff_t *
dhd_fkb_pool_clone2unicast(osl_t *osh, FkBuff_t *fkb_p, void *mac, const char *file, int line);
#define DHD_FKB_CLONE2UNICAST(osh, fkb_p, mac) \
	dhd_fkb_pool_clone2unicast(osh, fkb_p, mac, __FUNCTION__, __LINE__)
#else
