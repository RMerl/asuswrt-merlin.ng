...
extern void *dhd_pktfwd_lut_ins(uint8_t *d3addr, struct net_device *dev, bool is_wlan);
extern void   dhd_pktfwd_lut_del(uint8_t *d3addr, struct net_device *net_device);
extern int    dhd_pktfwd_lut_hit(uint8_t *d3addr, struct net_device *net_device);
extern void   dhd_pktfwd_lut_clr(struct net_device *dev); /* Flush full LUT */

/** PKTFWD WLAN Radio insert/delete/debug */
extern void *dhd_pktfwd_wlif_ins(void *wlif, void *osh, struct net_device *dev, unsigned int unit);
...
extern int    (*fdb_check_expired_dhd_hook)(unsigned char *addr, struct net_device *net_device);
...
extern void dhd_pktfwd_link_update(dhd_pub_t *dhdp, wl_event_msg_t *event);
