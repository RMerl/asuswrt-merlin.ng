...
#ifndef __6756_SYSPORT_H__
#define __6756_SYSPORT_H__
...
typedef struct sys_port_rxchk {
    ...
    uint32_t SYSTEMPORT_RXCHK_ETHERTYPE0;//0x80490348
    uint32_t SYSTEMPORT_RXCHK_ETHERTYPE1;//0x8049034C
    uint32_t SYSTEMPORT_RXCHK_WAN_PORT_AND_HOST_CPU_MAPPING;//0x80490350
    uint32_t SYSTEMPORT_RXCHK_MLT_CONFIG;//0x80490354
    uint32_t SYSTEMPORT_RXCHK_RX_QUEUE_MAPPING;//0x80490358
    uint32_t SYSTEMPORT_RXCHK_MLT_CMDDATA1;//0x8049035C
    uint32_t SYSTEMPORT_RXCHK_MLT_DATA0;//0x80490360
    uint32_t SYSTEMPORT_RXCHK_BAD_CHECKSUM_PACKET_DISCARD_COUNTER;//0x80490364
    uint32_t SYSTEMPORT_RXCHK_OTHER_PACKET_DISCARD_COUNTER;//0x80490368
    uint32_t SYSTEMPORT_RXCHK_RSB32BX_CFG1;//0x8049036C
    uint32_t SYSTEMPORT_RXCHK_RSB32BX_CFG2;//0x80490370
...
typedef struct sysport {
    union {
        ...
        uint8_t SYSTEMPORT_TOPCTRL_buf[64];//0x80490000
    };
    union {
        SYSTEMPORT_SYSBUSCFG SYSTEMPORT_SYSBUSCFG;
        uint8_t SYSTEMPORT_SYSBUSCFG_buf[704];//0x80490040
    };
    union {
        SYSTEMPORT_RXCHK SYSTEMPORT_RXCHK;
        uint8_t SYSTEMPORT_RXCHK_buf[256];//0x80490300
    };
    union {
        SYSTEMPORT_RBUF SYSTEMPORT_RBUF;
        uint8_t SYSTEMPORT_RBUF_buf[512];//0x80490400
    };
    union {
        SYSTEMPORT_TBUF SYSTEMPORT_TBUF;
        uint8_t SYSTEMPORT_TBUF_buf[2048];//0x80490600
    };
    union {
        SYSTEMPORT_MPD SYSTEMPORT_MPD;
        uint8_t SYSTEMPORT_MPD_buf[4608];//0x80490e00
    };
    union {
        SYSTEMPORT_RDMA SYSTEMPORT_RDMA;
        uint8_t SYSTEMPORT_RDMA_buf[8192];//0x80492000
    };
    union {
        SYSTEMPORT_TDMA SYSTEMPORT_TDMA;
        uint8_t SYSTEMPORT_TDMA_buf[8192];//0x80494000
    };
    union {
        SYSTEMPORT_SPE SYSTEMPORT_SPE;
        uint8_t SYSTEMPORT_SPE_buf[8192];//0x80496000
    };
    union {
        SYSTEMPORT_GIB SYSTEMPORT_GIB;
        uint8_t SYSTEMPORT_GIB_buf[512];//0x80498000
    };
    union {
        SYSTEMPORT_INTRL2 SYSTEMPORT_INTRL2[8];
        uint8_t SYSTEMPORT_INTRL2_buf[256];//0x80498200
    };
    union {
        SYSTEMPORT_INTC SYSTEMPORT_INTC[8];
        uint8_t SYSTEMPORT_INTC_buf[256];//0x80498300
    };
    union {
        sys_port_intr2 SYSTEMPORT_INTRL2_MISC_RX;
        uint8_t SYSTEMPORT_INTRL2_MISC_RX_buf[256];//0x80498400
    };
    union {
        sys_port_intr2 SYSTEMPORT_INTRL2_MISC_TX;
        uint8_t SYSTEMPORT_INTRL2_MISC_TX_buf[256];//0x80498500
    };
} sysport;

#endif /* __6756_SYSPORT_H__ */
