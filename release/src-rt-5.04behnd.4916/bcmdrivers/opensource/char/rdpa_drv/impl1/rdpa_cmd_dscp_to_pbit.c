...
int rdpa_cmd_dscp_to_pbit_ioctl(unsigned long arg)
{
    ...
    if(copy_from_user(&dscp_to_pbit, userDtoP_p, sizeof(rdpa_drv_ioctl_dscp_to_pbit_t)))
    {
        CMD_D_TO_P_LOG_ERROR("copy_from_user failed\n"); 
...
d_to_p_ioctl_exit:
    ...
    {
        CMD_D_TO_P_LOG_ERROR("copy_to_user failed\n"); 
        ret=RDPA_DRV_ERROR;
    }
