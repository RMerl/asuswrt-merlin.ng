...
#if defined(CONFIG_BCM963158) || defined(CONFIG_BCM96813)
#if IS_ENABLED(CONFIG_BCM_HW_FIREWALL)
#define RDPA_CPU_RX_PON_QUEUE_OFFSET 1
#else
#define RDPA_CPU_RX_PON_QUEUE_OFFSET 0
#endif

/*  GPON - OMCI */
#define RDPA_OMCI_CPU_RX_QUEUE_ID  (2 + RDPA_CPU_RX_PON_QUEUE_OFFSET)
#define RDPA_OMCI_CPU_RX_TC_ID      2
/*  GPON - PLOAM */
#define RDPA_PLOAM_CPU_RX_QUEUE_ID (3 + RDPA_CPU_RX_PON_QUEUE_OFFSET)
#define RDPA_PLOAM_CPU_RX_TC_ID     3

/*  EPON - MPCP */
#define RDPA_MPCP_CPU_RX_QUEUE_ID (2 + RDPA_CPU_RX_PON_QUEUE_OFFSET)
#define RDPA_MPCP_CPU_RX_TC_ID     2
/*  EPON - OAM */
#define RDPA_OAM_CPU_RX_QUEUE_ID  (3 + RDPA_CPU_RX_PON_QUEUE_OFFSET)
#define RDPA_OAM_CPU_RX_TC_ID      3

#else
/*  GPON - OMCI */
#define RDPA_OMCI_CPU_RX_QUEUE_ID  5
#define RDPA_OMCI_CPU_RX_TC_ID     5
/*  GPON - PLOAM */
#define RDPA_PLOAM_CPU_RX_QUEUE_ID 6
#define RDPA_PLOAM_CPU_RX_TC_ID    6

/*  EPON - MPCP */
#define RDPA_MPCP_CPU_RX_QUEUE_ID 5
#define RDPA_MPCP_CPU_RX_TC_ID    5
/*  EPON - OAM */
#define RDPA_OAM_CPU_RX_QUEUE_ID  6
#define RDPA_OAM_CPU_RX_TC_ID     6
