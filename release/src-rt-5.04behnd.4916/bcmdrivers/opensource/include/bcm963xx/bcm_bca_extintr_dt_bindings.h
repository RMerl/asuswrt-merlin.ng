...
#define BCA_EXTINTR_SHARE_GPIO_SHIFT        5
#define BCA_EXTINTR_SHARE_GPIO_MASK         (0x1 << BCA_EXTINTR_SHARE_GPIO_SHIFT)
#define BCA_EXTINTR_SHARED_GPIO             (0x1 << BCA_EXTINTR_SHARE_GPIO_SHIFT)
