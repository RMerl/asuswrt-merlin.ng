...
extern unsigned int BcmHalMapInterrupt(FN_HANDLER isr, const char *name, void* param, unsigned int interruptId);
extern void BcmHalMapInterruptFree(void* param, unsigned int interruptId);
