...
typedef struct _spdsvc_tr471_rx_queue_if_entry {
   int            connindex;
   struct loadHdr *rxq_loadHdr_p;
} spdsvc_tr471_rx_queue_if_entry_t;

typedef struct _spdsvc_tr471_rx_queue_entry {
   int            connindex;
   struct loadHdr rxq_loadHdr;
} spdsvc_tr471_rx_queue_entry_t;
...
typedef int (* tr471_rx_queue_write_t)(spdsvc_tr471_rx_queue_if_entry_t *entry_p);
