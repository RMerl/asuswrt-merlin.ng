...
typedef enum
{
    ...
    SUPPORTED_WAN_TYPES_BIT_AE_2_2             = (1<< 6),
    SUPPORTED_WAN_TYPES_BIT_AE_10_10           = (1<< 7),
    SUPPORTED_WAN_TYPES_BIT_XGPON              = (1<< 8),
    SUPPORTED_WAN_TYPES_BIT_NGPON2_10_25       = (1<< 9),
    SUPPORTED_WAN_TYPES_BIT_NGPON2_10_10       = (1<<10),
    SUPPORTED_WAN_TYPES_BIT_XGSPON             = (1<<11),
} SUPPORTED_WAN_TYPES;
