...
typedef struct Pmc {
   ...
   uint32_t sharedMem[512];    /* 0x4000-0x47ff */
} Pmc;
...
#define BIU_CLUSTER_CLK_BASE                    0x81062094
#define BIU_CLUSTER_CLK_CTRL_OFFSET             0x0
#define BIU_CLUSTER_CLK_PATERN_OFFSET           0x8
...
#define JTAG_OTP_PHYS_BASE                      0xff800e30
#define EARLY_PMC_BASE              0x80201000
#define EARLY_PMC_SIZE              0x3800
#define EARLY_PROCMON_BASE          0x80280000
#define EARLY_PROCMON_SIZE          0x184

#define RESCAL_CTRL_REG_BASE        0xFF85A048
#define RESCAL_CTRL_REG_SIZE        0x4
#define RESCAL_CTRL_CFG_OFFSET      0x0
