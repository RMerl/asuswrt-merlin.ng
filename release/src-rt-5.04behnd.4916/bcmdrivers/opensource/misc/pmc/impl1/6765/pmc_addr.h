...
#define PMB_TMON
#define PMB_BUS_WIFI0_TMON	1
#define PMB_ADDR_WIFI0_TMON	(56 | PMB_BUS_WIFI0_TMON << PMB_BUS_ID_SHIFT)

#define PMB_BUS_WIFI1_TMON	1
#define PMB_ADDR_WIFI1_TMON	(57 | PMB_BUS_WIFI1_TMON << PMB_BUS_ID_SHIFT)
