...
#define PMB_ADDR_RDPPLL		(15 | PMB_BUS_RDPPLL << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_RDPPLL	0

#define PMB_BUS_XPHYPLL		0
#define PMB_ADDR_XPHYPLL	(16 | PMB_BUS_XPHYPLL << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_XPHYPLL	0

#define PMB_BUS_PERIPH_ARS	0
#define PMB_ADDR_PERIPH_ARS	(17 | PMB_BUS_PERIPH_ARS << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_PERIPH_ARS	0

#define PMB_BUS_PCIE0_UBUS_ARS	0
#define PMB_ADDR_PCIE0_UBUS_ARS	(18 | PMB_BUS_PCIE0_UBUS_ARS << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_PCIE0_UBUS_ARS 0

#define PMB_BUS_USB30_2X_ARS	0
#define PMB_ADDR_USB30_2X_ARS	(19 | PMB_BUS_USB30_2X_ARS << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_USB30_2X_ARS	0

#define PMB_BUS_SYS_ARS		0
#define PMB_ADDR_SYS_ARS	(20 | PMB_BUS_SYS_ARS << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_SYS_ARS	0

#define PMB_BUS_CRYPTO2_ARS	1
#define PMB_ADDR_CRYPTO2_ARS	(21 | PMB_BUS_CRYPTO2_ARS << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_CRYPTO2_ARS	0

#define PMB_BUS_XRDP_ARS	1
#define PMB_ADDR_XRDP_ARS	(22 | PMB_BUS_XRDP_ARS << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_XRDP_ARS	0

#define PMB_BUS_MPM_ARS		1
#define PMB_ADDR_MPM_ARS	(23 | PMB_BUS_MPM_ARS << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_MPM_ARS	0

#define PMB_BUS_MEMC_ARS	1
#define PMB_ADDR_MEMC_ARS	(24 | PMB_BUS_MEMC_ARS << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_MEMC_ARS	0

#define PMB_BUS_ETH_ARS		1
#define PMB_ADDR_ETH_ARS	(25 | PMB_BUS_ETH_ARS << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_ETH_ARS	0

#define PMB_BUS_PCIE1_UBUS_ARS	1
#define PMB_ADDR_PCIE1_UBUS_ARS	(26 | PMB_BUS_PCIE1_UBUS_ARS << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_PCIE1_UBUS_ARS	0

#define PMB_BUS_WAN_ARS	1
#define PMB_ADDR_WAN_ARS	(27 | PMB_BUS_PCIE3_ARS << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_WAN_ARS	0

#define PMB_BUS_MERLIN0_UBUS_ARS	1
#define PMB_ADDR_MERLIN0_UBUS_ARS	(28 | PMB_BUS_MERLIN0_UBUS_ARS << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_MERLIN0_UBUS_ARS	0

#define PMB_BUS_MERLIN1_UBUS_ARS	1
#define PMB_ADDR_MERLIN1_UBUS_ARS	(29 | PMB_BUS_MERLIN1_UBUS_ARS << PMB_BUS_ID_SHIFT)
...
static const struct bpcm_device bpcm_devs[] = {
        ...
        { "xrdp_pll",          PMB_ADDR_RDPPLL,            PMB_ZONES_RDPPLL            },
        { "xphy_pll",          PMB_ADDR_XPHYPLL,           PMB_ZONES_XPHYPLL           },		
