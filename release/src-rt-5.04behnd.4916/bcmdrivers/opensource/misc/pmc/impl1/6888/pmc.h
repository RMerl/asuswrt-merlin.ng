...
typedef struct PmcCtrlReg {
    ...
    uint32_t reserved[10];        /* 0x030 */
    uint32_t apertureOffset;      /* 0x058 */
    uint32_t diagControl;         /* 0x05c */
    uint32_t diagHigh;            /* 0x060 */
    uint32_t diagLow;             /* 0x064 */
    uint32_t reserved1[7];        /* 0x068 */
    uint32_t scratch;             /* 0x084 */
    uint32_t reserved2;           /* 0x088 */
    uint32_t softResets;          /* 0x08c */
    uint32_t reserved3;           /* 0x090 */
    uint32_t m4keCoreStatus;      /* 0x094 */
    uint32_t reserved4;           /* 0x098 */
...
typedef struct PmmReg {
    ...
    uint32_t imemControlStatus;       /* 0x0008 */
} PmmReg;
...
typedef struct Pmc {
    PmcCtrlReg ctrl;		            /* 0x1018-0x1147 */
    uint32_t unused1[622];	            /* 0x1148-0x1cff */
    PmcDQMPac dqmPac;                   /* 0x1b00-0x1b1f */
    uint32_t unused5[56];               /* 0x1b20-0x1bff */
    PmcDQMReg dqm;			            /* 0x1c00-0x1c37 */
    uint32_t unused6[754];		        /* 0x1c38-0x27ff */
    uint32_t qStatus[32];		        /* 0x2800-0x287f */
    uint32_t unused7[480];	            /* 0x2880-0x2fff */
    PmcDqmQMibReg qMib;		            /* 0x3000-0x317f */
    uint32_t unused8[928];	            /* 0x3180-0x3fff */
    PmcDqmQCtrlReg dqmQCtrl[8]; 	    /* 0x4000-0x407f */
    uint32_t unused9[992];              /* 0x4080-0x4fff */
    PmcDqmQDataReg dqmQData[8]; 	    /* 0x5000 */
} Pmc;

typedef struct Procmon {
    PmmReg  pmm;                        /* 0x20000-0x2000b */
    uint32_t unused11[21];                /* 0x2000c-0x2005f */
