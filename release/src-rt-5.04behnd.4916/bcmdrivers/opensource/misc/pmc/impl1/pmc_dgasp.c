...
static void pmc_dgasp_override_ctl( int enable )
{
...
{
	pmc_dgasp_override_ctl(0);
}
EXPORT_SYMBOL(pmc_dgasp_override_disable);

void pmc_dgasp_override_enable(void)
{
	pmc_dgasp_override_ctl(1);
}
EXPORT_SYMBOL(pmc_dgasp_override_enable);
