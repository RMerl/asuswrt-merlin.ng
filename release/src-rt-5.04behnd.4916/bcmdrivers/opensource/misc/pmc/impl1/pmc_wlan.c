...
#if defined(CONFIG_BCM947622) || defined(CONFIG_BCM96756) || defined(CONFIG_BCM96765) || defined(CONFIG_BCM96766) || defined(CONFIG_BCM96764)
...
#else
#error "pmc_wlan is not supported"
#endif

#ifndef PMB_ADDR_WLAN0_PHY1
#define PMB_ADDR_WLAN0_PHY1 -1
#define PMB_ADDR_WLAN0_PHY2 -1
#endif

#ifndef PMB_ADDR_WLAN1_PHY1
#define PMB_ADDR_WLAN1_PHY1 -1
#define PMB_ADDR_WLAN1_PHY2 -1
#endif
