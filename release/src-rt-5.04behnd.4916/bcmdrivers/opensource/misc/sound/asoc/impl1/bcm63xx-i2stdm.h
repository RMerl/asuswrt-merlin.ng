...
#ifdef CONFIG_SND_SOC_MAPLEGROVE
#define I2S_SW_LOOPBACK		1
#endif
#define TX_CHANNEL_NUM_SHIFT 	16
#define RX_CHANNEL_NUM_MASK 	0x0000FFFF
...
#define I2S_BITS_PER_SAMPLE_MASK		(0x1F << I2S_BITS_PER_SAMPLE_SHIFT)
...
#define I2S_TX_MCLK_RATIO_MASK 	(0x1F << I2S_TX_MCLK_RATIO_SHIFT)
#define I2S_TX_SCLK_1FS_DIV32_SHIFT	4
#define I2S_TX_SCLK_1FS_DIV32_MASK	(0x0F << I2S_TX_SCLK_1FS_DIV32_SHIFT)
#define I2S_TX_JUSTIFY_SHIFT	3
#define I2S_TX_JUSTIFY_MASK		(1 << I2S_TX_JUSTIFY_SHIFT)
#define I2S_TX_JUSTIFY_LEFT		(1 << I2S_TX_JUSTIFY_SHIFT)
#define I2S_TX_JUSTIFY_RIGHT	0
...
#define I2S_TX_VALID_SLOT_SHIFT		1
...
#define I2S_RX_MCLK_RATIO_MASK 	(0x1F << I2S_RX_MCLK_RATIO_SHIFT)
#define I2S_RX_SCLK_1FS_DIV32_SHIFT	4
#define I2S_RX_SCLK_1FS_DIV32_MASK	(0x0F << I2S_RX_SCLK_1FS_DIV32_SHIFT)
#define I2S_RX_JUSTIFY_SHIFT	3
#define I2S_RX_JUSTIFY_MASK		(1 << I2S_RX_JUSTIFY_SHIFT)
#define I2S_RX_JUSTIFY_LEFT		(1 << I2S_RX_JUSTIFY_SHIFT)
#define I2S_RX_JUSTIFY_RIGHT	0
...
struct bcm_i2s_priv {
	...
	struct gpio_desc *mic_sel_1_gpio;
	struct gpio_desc *mic_sel_2_gpio;
	struct gpio_desc *mic_array_sw1_gpio;
	struct gpio_desc *mic_array_sw2_gpio;
	struct gpio_desc *mic_array_sw3_gpio;
	struct gpio_desc *mic_power_en_gpio;
	struct gpio_desc *mic_mute_detect_gpio;
	struct gpio_desc *i2s_clk_select;
};
