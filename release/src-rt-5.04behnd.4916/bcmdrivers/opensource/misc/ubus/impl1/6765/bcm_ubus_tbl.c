...
ub_mst_addr_map_t ub_mst_addr_map_tbl[] = {
    ...
    {UBUS_PORT_ID_PCIE1,   "PCIE1",   0,    NULL,    1},
    {UBUS_PORT_ID_CNPTOP,  "CNPTOP",  0,    NULL,    0},
    {UBUS_PORT_ID_CNPPHY,  "CNPPHY",  0,    NULL,    0},
    {UBUS_PORT_ID_WIFI,    "WIFI0",   0,    NULL,    1},
    {UBUS_PORT_ID_WIFI1,   "WIFI1",   0,    NULL,    1},
    {UBUS_PORT_ID_MLO,     "MLO0",    0,    NULL,    0},
    {UBUS_PORT_ID_MLO1,    "MLO1",    0,    NULL,    0},
    {-1, 0}
};
