...
#define FOREACH_PORT_TYPE(TYPE) \
    ...
    TYPE(PORT_TYPE_G9991_PORT) /* SID */ \
    TYPE(PORT_TYPE_G9991_CTRL_PORT) /* Control SID */ \
    TYPE(PORT_TYPE_G9991_ES_PORT) /* Error sampling SID port, RX only */ \
    TYPE(PORT_TYPE_G9991_SYS_PORT) \
    ...
    TYPE(PORT_TYPE_NONBRCM_SW) \
    TYPE(PORT_TYPE_NONBRCM_PORT)
