...
static char ethtool_stats_strings[][ETH_GSTRING_LEN] = {
    ...
    [ET_RX_XDP_PACKETS] =  "xdp_packets         ",
    [ET_RX_XDP_BYTES] =    "xdp_bytes           ",
    [ET_RX_XDP_REDIRECT] = "xdp_redirect        ",
    [ET_RX_XDP_DROPS] =    "xdp_drops           ",
    [ET_RX_XDP_PASS] =     "xdp_pass            ",
    [ET_TX_XDP] =          "xdp_tx              ",
    [ET_TX_XDP_ERR] =      "xdp_tx_err          ",
    [ET_TX_XDP_XMIT] =     "xdp_xmit            ",
    [ET_TX_XDP_XMIT_ERR] = "xdp_xmit_err        ",
#endif
};
