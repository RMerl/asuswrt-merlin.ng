...
#define BCM_PHYID_M      0xFFF0
    ...
    #define REG_RX_GLOBAL_CTL                             0x0a

        #define REG_RX_GLOBAL_CTL_DIS_RX_MASK             0x40  // source pruning bypassed
    ...
    #define REG_CONTROL_MII1_PORT_STATE_OVERRIDE          0x0e  // 63158: move to E4-10
        ...
        #define IMP_LINK_OVERRIDE_10GFDX        (IMP_LINK_OVERRIDE | REG_CONTROL_MPSO_SPEED10G | REG_PORT_STATE_XGMII_MODE)
...
#define REG_VLAN_CTRL(p)                        (REG_VLAN_CTRL_P0+2*(p))
...
#define PAGE_CONTROL_EXP                                  0xE4
    ...
    #define REG_PORT_SIB_MODE                             0x12  // 6765
