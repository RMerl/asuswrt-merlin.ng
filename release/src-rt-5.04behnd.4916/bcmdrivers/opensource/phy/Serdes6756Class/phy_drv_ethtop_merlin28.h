...
#define MERLIN_REVID           0x000
#define MERLIN_CTRL            0x014
#define MERLIN_STATUS          0x018
#define MERLIN_INDIR_ACC_CNTRL 0x100
#define MERLIN_INDIR_ACC_ADDR  0x004
#define MERLIN_INDIR_ACC_MASK  0x008
