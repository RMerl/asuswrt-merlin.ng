...
typedef struct
{
    uint64_t byte;              /**< Receive Byte Counter */
    uint64_t packet;            /**< Receive Packet Counter */
    uint64_t frame_64;          /**< Receive 64 Byte Frame Counter */
    uint64_t frame_65_127;      /**< Receive 65 to 127 Byte Frame Counter */
    uint64_t frame_128_255;     /**< Receive 128 to 255 Byte Frame Counter */
    uint64_t frame_256_511;     /**< Receive 256 to 511 Byte Frame Counter */
    uint64_t frame_512_1023;    /**< Receive 512 to 1023 Byte Frame Counter */
    uint64_t frame_1024_1518;   /**< Receive 1024 to 1518 Byte Frame Counter */
    uint64_t frame_1519_mtu;    /**< Receive 1519 to MTU Frame Counter */
    uint64_t multicast_packet;  /**< Receive Multicast Packet */
    uint64_t broadcast_packet;  /**< Receive Broadcast Packet */
    uint64_t unicast_packet;    /**< Receive Unicast Packet */
    uint64_t alignment_error;   /**< Receive Alignment error */
    uint64_t frame_length_error;/**< Receive Frame Length Error Counter */
    uint64_t code_error;        /**< Receive Code Error Counter */
    uint64_t carrier_sense_error;/**< Receive Carrier sense error */
    uint64_t fcs_error;         /**< Receive FCS Error Counter */
    uint64_t control_frame;     /**< Receive Control Frame Counter */
    uint64_t pause_control_frame;/**< Receive Pause Control Frame */
    uint64_t unknown_opcode;    /**< Receive Unknown opcode */
    uint64_t undersize_packet;  /**< Receive Undersize Packet */
    uint64_t oversize_packet;   /**< Receive Oversize Packet */
    uint64_t fragments;         /**< Receive Fragments */
    uint64_t jabber;            /**< Receive Jabber counter */
    uint64_t overflow;          /**< Receive Overflow counter */
} rdpa_emac_rx_stat64_t;
...
typedef struct
{
    uint64_t byte;              /**< Transmit Byte Counter */
    uint64_t packet;            /**< Transmit Packet Counter */
    uint64_t frame_64;          /**< Transmit 64 Byte Frame Counter */
    uint64_t frame_65_127;      /**< Transmit 65 to 127 Byte Frame Counter */
    uint64_t frame_128_255;     /**< Transmit 128 to 255 Byte Frame Counter */
    uint64_t frame_256_511;     /**< Transmit 256 to 511 Byte Frame Counter */
    uint64_t frame_512_1023;    /**< Transmit 512 to 1023 Byte Frame Counter */
    uint64_t frame_1024_1518;   /**< Transmit 1024 to 1518 Byte Frame Counter */
    uint64_t frame_1519_mtu;    /**< Transmit 1519 to MTU Frame Counter */
    uint64_t fcs_error;         /**< Transmit FCS Error */
    uint64_t multicast_packet;  /**< Transmit Multicast Packet */
    uint64_t broadcast_packet;  /**< Transmit Broadcast Packet */
    uint64_t unicast_packet;    /**< Transmit Unicast Packet */
    uint64_t excessive_collision; /**< Transmit Excessive collision counter */
    uint64_t late_collision;    /**< Transmit Late collision counter */
    uint64_t single_collision;  /**< Transmit Single collision frame counter */
    uint64_t multiple_collision;/**< Transmit Multiple collision frame counter */
    uint64_t total_collision;   /**< Transmit Total Collision Counter */
    uint64_t pause_control_frame; /**< Transmit PAUSE Control Frame */
    uint64_t deferral_packet;   /**< Transmit Deferral Packet */
    uint64_t excessive_deferral_packet; /**< Transmit Excessive Deferral Packet */
    uint64_t jabber_frame;      /**< Transmit Jabber Frame */
    uint64_t control_frame;     /**< Transmit Control Frame */
    uint64_t oversize_frame;    /**< Transmit Oversize Frame counter */
    uint64_t undersize_frame;   /**< Transmit Undersize Frame */
    uint64_t fragments_frame;   /**< Transmit Fragments Frame counter */
    uint64_t error;             /**< Transmission errors*/
    uint64_t underrun;          /**< Transmission underrun */
} rdpa_emac_tx_stat64_t;

/** Emac statistics */
typedef struct
{
    rdpa_emac_rx_stat64_t rx; /**< Emac Receive Statistics */
    rdpa_emac_tx_stat64_t tx; /**< Emac Transmit Statistics */
} rdpa_emac_stat64_t;
