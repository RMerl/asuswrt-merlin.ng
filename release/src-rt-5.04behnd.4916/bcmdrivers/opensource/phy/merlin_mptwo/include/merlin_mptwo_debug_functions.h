 ...
 */
uint8_t merlin_mptwo_rdbl_uc_var(err_code_t *err_code, uint16_t addr);
 ...
 */
uint16_t merlin_mptwo_rdwl_uc_var(err_code_t *err_code, uint16_t addr);
 ...
 */
int8_t merlin_mptwo_rdbls_uc_var(err_code_t *err_code, uint16_t addr);
 ...
 */
int16_t merlin_mptwo_rdwls_uc_var(err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t merlin_mptwo_rdbc_uc_var(err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t merlin_mptwo_rdwc_uc_var(err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t merlin_mptwo_rdbcs_uc_var(err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t merlin_mptwo_rdwcs_uc_var(err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t merlin_mptwo_rdw_uc_ram(err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t merlin_mptwo_rdb_uc_ram(err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t merlin_mptwo_rdws_uc_ram(err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t merlin_mptwo_rdbs_uc_ram(err_code_t *err_code, uint16_t addr);
