 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _merlin_mptwo_pmd_rdt_field_byte(uint16_t addr, uint8_t shift_left, uint8_t shift_right, uint8_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _merlin_mptwo_pmd_rdt_field_signed_byte(uint16_t addr, uint8_t shift_left, uint8_t shift_right, int8_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _merlin_mptwo_pmd_rdt_field_byte_addr32(uint32_t addr, uint8_t shift_left, uint8_t shift_right, uint8_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _merlin_mptwo_pmd_rdt_field_signed_byte_addr32(uint32_t addr, uint8_t shift_left, uint8_t shift_right, int8_t *val_p);
