 ...
 * (http://ingbu.broadcom.com/hsip/merlin_mptwo/SerDes%20Documents/PMD_Methodology/Serdes%20External%20Micro%20User%20Guide.docx)
 * \n \n
 *
 * \section API_sec Important API Files
 *
 * merlin_mptwo_interface.h - provides the primary functionality.
 *
 * merlin_mptwo_dependencies.h - defines the functions to be provided by the IP user
 *
 * \n \n
 * Copyright 2014 Broadcom Corporation all rights reserved
 */

/** @file merlin_mptwo_interface.h
 * Main interface functions provided to IP User
 */

#ifndef MERLIN_MPTWO_API_INTERFACE_H
#define MERLIN_MPTWO_API_INTERFACE_H
...
struct merlin_mptwo_uc_lane_config_field_st {
...
struct merlin_mptwo_uc_core_config_field_st {
...
/** Lane Config Struct */
struct  merlin_mptwo_uc_lane_config_st {
  struct merlin_mptwo_uc_lane_config_field_st field;
  uint16_t word;
};

/** Core Config Struct */
struct  merlin_mptwo_uc_core_config_st {
  struct merlin_mptwo_uc_core_config_field_st field;
  uint16_t word;
  int vco_rate_in_Mhz; /* if >0 then will get converted and replace field.vco_rate when update is called */
};

/** Eyescan Options Struct */
struct merlin_mptwo_eyescan_options_st {
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_get_uc_core_config(struct merlin_mptwo_uc_core_config_st *struct_val);
...
/** Column definition header for merlin_mptwo_display_core_state() API output.
 * To be called before merlin_mptwo_display_core_state_line() API.
 ...
 * Call merlin_mptwo_display_core_state_hdr() API before and merlin_mptwo_display_core_state_legend() after
 * calling this API to get a formatted core state display with legend.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_display_core_state_line(void);

/** Detailed description of each column in merlin_mptwo_display_core_state_line() API output.
 * To be called after merlin_mptwo_display_core_state_line() API to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 */
err_code_t merlin_mptwo_uc_active_enable(uint8_t enable);
 ...
 * \n Note: Micro should be loaded only after issuing a merlin_mptwo_uc_reset(1) followed by asserting and de-asserting
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_ucode_mdio_load(uint8_t *ucode_image, uint16_t ucode_len);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_ucode_load_verify(uint8_t *ucode_image, uint16_t ucode_len);
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculaion [merlin_mptwo_ucode_crc_verify()] and verifying the CRC value [merlin_mptwo_start_ucode_crc_calc()].
 * @param ucode_len Length of Microcode Image (number of bytes)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculation [merlin_mptwo_ucode_crc_verify()] and verifying the CRC value [merlin_mptwo_start_ucode_crc_calc()].
 * @param expected_crc_value Expected CRC value of the microcode
 ...
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_uc_reset(uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_map_lanes(uint8_t num_lanes, uint8_t const *tx_lane_map, uint8_t const *rx_lane_map);
 ...
 * Note: merlin_mptwo_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane.
 ...
 */
err_code_t merlin_mptwo_config_shared_tx_pattern(uint8_t patt_length, const char pattern[]);
 ...
 * Note: User also needs to configure all lanes through merlin_mptwo_lane_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_core_config_for_iddq(void);

/** Serdes Core Powerdown.
 * Along with merlin_mptwo_core_pwrdn(), all lanes powerdowns should also be issued using
 * merlin_mptwo_lane_pwrdn() to complete a Core Powerdown.
 * @param mode based on enum #srds_core_pwrdn_mode_enum select from ON, CORE, DEEP power down modes
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_core_pwrdn(enum srds_core_pwrdn_mode_enum mode);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_get_uc_lane_cfg(struct merlin_mptwo_uc_lane_config_st *struct_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_configure_pll(enum merlin_mptwo_pll_enum pll_cfg);
 ...
 */
err_code_t merlin_mptwo_config_tx_hpf(uint8_t hpf_val);
 ...
 * @return Error Code generated by invalid settings (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_rd_tx_hpf_config(uint8_t *hpf_val);
 ...
 * It relies on the accuracy of merlin_mptwo_delay_us() function. \n\n
 ...
 * This function only initiates the processor actions.  User must use merlin_mptwo_read_eye_scan_stripe() function
 ...
 * merlin_mptwo_start_ber_scan_test(), merlin_mptwo_read_ber_scan_data(), merlin_mptwo_display_ber_scan_data().
 *
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum)
 * @param timer_control sets the total test time in units of ~1.31 seconds
 ...
 * \n Note: Call functions merlin_mptwo_display_lane_state_hdr() before and merlin_mptwo_display_lane_state_legend() after
 * to get a formatted lane state display with legend
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_display_lane_state(void);

/** Column definition header for merlin_mptwo display state.
 * To be called before merlin_mptwo_display_lane_state() function.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_display_lane_state_hdr(void);

/** Detailed explanation of each column in merlin_mptwo display state.
 * To be called after merlin_mptwo_display_lane_state() function to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function is required to be implemented by upper level software to enable merlin_mptwo support.
...
/** Parameterized diagnostic function which access to all merlin_mptwo control and status bits
 * This function is required to be implemented by upper level software to enable merlin_mptwo support.
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_pmd_lock_status(uint8_t *pmd_rx_lock);

/** Display CL72 Status of current lane.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_display_cl72_status(void);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_configure_fast_link_recovery(uint8_t enable, uint8_t enable_timeout, enum merlin_mptwo_flr_timeout_enum timeout_time, uint8_t enable_2ms_yield, uint8_t filter_count);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_tx_disable(uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_rx_restart(uint8_t enable);
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the merlin_mptwo_stop_rx_adaptation() API.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_write_rx_afe(enum srds_rx_afe_settings_enum param, int8_t val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_read_rx_afe(enum srds_rx_afe_settings_enum param, int8_t *val);

/*----------------------------*/
/*  Enable Pattern Generator  */
/*----------------------------*/
/** Enable/Disable Shared TX pattern generator.
 * Note: The patt_length input to the function should be the value sent to the merlin_mptwo_config_shared_tx_pattern() function
 * @param enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param patt_length length of the pattern used in merlin_mptwo_config_shared_tx_pattern()
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_tx_shared_patt_gen_en(uint8_t enable, uint8_t patt_length);
 ...
 * Once the PRBS generator is configured, to enable PRBS use the merlin_mptwo_tx_prbs_en() API.
 * @param prbs_poly_mode PRBS generator mode select (selects required PRBS polynomial)
 * @param prbs_inv PRBS invert enable
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_config_tx_prbs(enum srds_prbs_polynomial_enum prbs_poly_mode, uint8_t prbs_inv);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_get_tx_prbs_config(enum srds_prbs_polynomial_enum *prbs_poly_mode, uint8_t *prbs_inv);

/** PRBS Generator Enable/Disable.
 * @param enable Enable PRBS Generator (1 = Enable; 0 = Disable)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_tx_prbs_en(uint8_t enable);

/** Get PRBS Generator Enable/Disable.
 * @param *enable returns the value of Enable PRBS Generator (1 = Enable; 0 = Disable)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_get_tx_prbs_en(uint8_t *enable);

/** PRBS Generator Single Bit Error Injection.
 * @param enable (1 = error is injected; 0 = no error is injected)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_tx_prbs_err_inject(uint8_t enable);

/**  Configure PRBS Checker.
 * Once the PRBS checker is configured, use the merlin_mptwo_rx_prbs_en() API to enable the checker.
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_config_rx_prbs(enum srds_prbs_polynomial_enum prbs_poly_mode, enum srds_prbs_checker_mode_enum prbs_checker_mode, uint8_t prbs_inv);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_get_rx_prbs_config(enum srds_prbs_polynomial_enum *prbs_poly_mode, enum srds_prbs_checker_mode_enum *prbs_checker_mode, uint8_t *prbs_inv);

/** PRBS Checker Enable/Disable.
 * @param enable Enable PRBS Checker (1 = Enable; 0 = Disable)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_rx_prbs_en(uint8_t enable);

/** Get PRBS Checker Enable/Disable.
 * @param *enable returns with the value of Enable PRBS Checker (1 = Enable; 0 = Disable)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_get_rx_prbs_en(uint8_t *enable);

/** PRBS Checker LOCK status (live status).
 * @param *chk_lock Live lock status read by API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_prbs_chk_lock_state(uint8_t *chk_lock);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_prbs_err_count_ll(uint32_t *prbs_err_cnt);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_prbs_err_count_state(uint32_t *prbs_err_cnt, uint8_t *lock_lost);

/*--------------------------------------------------------------*/
/*  IDDQ / Powerdown / Deep Powerdown / Isolate Pins  */
/*--------------------------------------------------------------*/
/** Lane configurations for IDDQ.
 * Note: User needs to configure all lanes through merlin_mptwo_lane_config_for_iddq() and also call merlin_mptwo_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_lane_config_for_iddq(void);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_lane_pwrdn(enum srds_core_pwrdn_mode_enum mode);
 ...
 */
err_code_t merlin_mptwo_tx_pi_freq_override(uint8_t enable, int16_t freq_override_val);
 ...
 * If you want loop timing use merlin_mptwo_rmt_lpbk()
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_rmt_lpbk_from_ull(void);
 ...
 * This function should be called prior to merlin_mptwo_rptr_mode_timing();
 * @param enable Enable/Disable (1 = Enable; 0 = Disable)
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_rmt_lpbk_from_nl(void);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_ull_from_rmt_lpbk(enum srds_rptr_mode_enum mode);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_dig_lpbk_rptr(uint8_t enable, enum srds_rptr_mode_enum mode);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_ull_from_dig_lpbk(enum srds_rptr_mode_enum mode);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_nl_from_dig_lpbk(enum srds_rptr_mode_enum mode);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_mptwo_rmt_lpbk(uint8_t enable);
