...
static err_code_t merlin_mptwo_configure_pll_ctrl_bus(enum merlin_mptwo_pll_enum pll_cfg);
...
err_code_t merlin_mptwo_configure_pll(enum merlin_mptwo_pll_enum pll_cfg) {
 ...
 /* EFUN(wrc_ams_pll_cpar                     (   0x1)); */
 /* EFUN(wrc_ams_pll_curr_sel                 (   0x3)); */
 /* EFUN(wrc_ams_pll_i_ndiv_dither_en         (   0x0)); */
 /* #if (defined(MERLIN_DINO) || defined(MERLIN_MD100) || defined(MERLIN_MPTWO)) */
 /* EFUN(wrc_ams_pll_pfd_offset               (   0x0)); */
 /* #else                                                */
 ...
 /*     break;                                                    */
     ...
     */
    return merlin_mptwo_configure_pll_ctrl_bus(pll_cfg);
}
