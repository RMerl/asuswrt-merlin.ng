...
/* Please note that when adding entries here you should update the #defines in the merlin16_shasta_common.h */

/** OSR_MODES Enum */
enum merlin16_shasta_osr_mode_enum {
  MERLIN16_SHASTA_OSX1    = 0,
  MERLIN16_SHASTA_OSX2    = 1,
  MERLIN16_SHASTA_OSX3    = 2,
  MERLIN16_SHASTA_OSX3P3  = 3,
  MERLIN16_SHASTA_OSX4    = 4,
  MERLIN16_SHASTA_OSX5    = 5,
  MERLIN16_SHASTA_OSX7P5  = 6,
  MERLIN16_SHASTA_OSX8    = 7,
  MERLIN16_SHASTA_OSX8P25 = 8,
  MERLIN16_SHASTA_OSX10   = 9
};
