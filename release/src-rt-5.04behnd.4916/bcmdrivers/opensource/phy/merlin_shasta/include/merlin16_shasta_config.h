...
/** @file merlin16_shasta_config.h
 * Configuration functions provided to IP User
 */

#ifndef MERLIN16_SHASTA_API_CONFIG_H
#define MERLIN16_SHASTA_API_CONFIG_H
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_get_uc_core_config(srds_access_t *sa__, struct merlin16_shasta_uc_core_config_st *struct_val);
 ...
 * \n Note: Micro should be loaded only after issuing a merlin16_shasta_uc_reset(1) followed by asserting and de-asserting
 * core_s_reset. Information table should be intialized with merlin16_shasta_init_merlin16_shasta_info after microcode load.
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculaion [merlin16_shasta_ucode_crc_verify()] and verifying the CRC value [merlin16_shasta_start_ucode_crc_calc()].
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param ucode_len Length of Microcode Image (number of bytes)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculation [merlin16_shasta_ucode_crc_verify()] and verifying the CRC value [merlin16_shasta_start_ucode_crc_calc()].
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param expected_crc_value Expected CRC value of the microcode
 ...
 * NOTE: Information table should be intialized with merlin16_shasta_init_merlin16_shasta_info after microcode load.
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/** Initialize the merlin16_shasta_info for the uC.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated if uC does not become active (returns ERR_CODE_NONE if no errors)
 */
 ...
 */
#define merlin16_shasta_configure_pll_refclk_div_vco merlin16_shasta_INTERNAL_configure_pll
/** Configure PLL.
 *
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_get_uc_lane_cfg(srds_access_t *sa__, struct merlin16_shasta_uc_lane_config_st *struct_val);
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param param selects the parameter to read based on #merlin16_shasta_tx_afe_settings_enum
 ...
 */
err_code_t merlin16_shasta_config_tx_hpf(srds_access_t *sa__, uint8_t hpf_val);
 ...
 * @return Error Code generated by invalid settings (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_rd_tx_hpf_config(srds_access_t *sa__, uint8_t *hpf_val);
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the merlin16_shasta_stop_rx_adaptation() API.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
