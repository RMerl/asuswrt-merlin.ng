...
/**************************************************************************************
 *  File Name     :  merlin16_shasta_usr_includes.h                                        *
...
/** @file merlin16_shasta_usr_includes.h
...
#ifndef MERLIN16_SHASTA_API_USR_INCLUDES_H
#define MERLIN16_SHASTA_API_USR_INCLUDES_H
...
# endif
#define USR_DELAY_MS(stuff) merlin16_shasta_delay_ms(sa__,stuff)
#define USR_DELAY_US(stuff) merlin16_shasta_delay_us(sa__,stuff)
#define USR_DELAY_NS(stuff) merlin16_shasta_delay_ns(sa__,stuff)
#else
# ifndef NO_VARIADIC_MACROS
...
# endif
#define USR_DELAY_MS(stuff) merlin16_shasta_delay_ms(stuff)
#define USR_DELAY_US(stuff) merlin16_shasta_delay_us(stuff)
#define USR_DELAY_NS(stuff) merlin16_shasta_delay_ns(stuff)
#endif
