...
extern prog_seq_tbl datapath_reset_lane[];
...
prog_seq_tbl force_speed_2p5g_xgmii[] = {
  ...
  {"datapath_reset_lane", 0, 0, 0, 0, PROG_TYPE_SEQUENCE, PARAM(&datapath_reset_lane)},
...
prog_seq_tbl lpi_enable[] = {
  ...
  {"U_RX_X1_Control1_pcs_control_0",           0x3,  0x9430, 0x0004, 0x0004},  //02:02 LPI_ENABLE = 1'b1
  {"",                                         0x0,  0x0000, 0x0000, 0x0000}
}; 
...
prog_seq_tbl usxgmii_mac_credit_enable[] = {
...
prog_seq_tbl usxgmii_switch_pcs_from_B_to_A[] = {
  ...
  {"U_PCS_Main0_setup_1",                      0x3,  0x9101, 0x0060, 0x0040},  //05:05 uxsgmii_pcs_sel = 1'b0; [6] uport_baud_override_en = 1'b1 ; when usxgmii_pcs_sel_pin = 0
...
prog_seq_tbl usxgmii_mp_remote_pcs_loopback[] = {
