...
#define wrc_ams_pll_i_ndiv_frac_h(wr_val)                       merlin16_shortfin_acc_mwr_reg(sa__, 0xd0b7,0x3fff,0,wr_val)
...
#define wrc_ams_pll_i_ndiv_int(wr_val)                          merlin16_shortfin_acc_mwr_reg(sa__, 0xd0b8,0x03ff,0,wr_val)
...
#define wr_cl72_xmt_update_page(wr_val)                         merlin16_shortfin_acc_wr_reg(sa__, 0xd060,wr_val)
#define rd_cl72_ld_xmt_status_page()                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd061,__ERR)
#define wr_cl72_ld_xmt_status_page(wr_val)                      merlin16_shortfin_acc_wr_reg(sa__, 0xd061,wr_val)
...
#define wr_cl72_prbs_seed_val(wr_val)                           merlin16_shortfin_acc_mwr_reg(sa__, 0xd067,0x07ff,0,wr_val)
...
#define wrc_maskdata(wr_val)                                    merlin16_shortfin_acc_wr_reg(sa__, 0xd0f3,wr_val)
...
#define wrc_heartbeat_count_1us(wr_val)                         merlin16_shortfin_acc_mwr_reg(sa__, 0xd0f4,0x03ff,0,wr_val)
...
#define wr_cdr_freq_override_val(wr_val)                        merlin16_shortfin_acc_mwr_reg(sa__, 0xd002,0xfffe,1,wr_val)
...
#define wr_uc_dsc_data(wr_val)                                  merlin16_shortfin_acc_wr_reg(sa__, 0xd00e,wr_val)
...
#define wr_eee_lfsr_cnt(wr_val)                                 merlin16_shortfin_acc_mwr_reg(sa__, 0xd012,0x1fff,0,wr_val)
#define rd_measure_lfsr_cnt()                                   _merlin16_shortfin_pmd_rde_field(sa__, 0xd013,3,3,__ERR)
#define wr_measure_lfsr_cnt(wr_val)                             merlin16_shortfin_acc_mwr_reg(sa__, 0xd013,0x1fff,0,wr_val)
...
#define wr_hwtune_ovr_write_val(wr_val)                         merlin16_shortfin_acc_mwr_reg(sa__, 0xd02b,0x01ff,0,wr_val)
...
#define wrc_mdio_blk_addr(wr_val)                               merlin16_shortfin_acc_mwr_reg(sa__, 0xffdf,0x7ff0,4,wr_val)
...
#define wrc_mdio_addr_data(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0x000e,wr_val)
...
#define wrc_mdio_aer(wr_val)                                    merlin16_shortfin_acc_wr_reg(sa__, 0xffde,wr_val)
...
#define wrc_micro_ra_wraddr_lsw(wr_val)                         merlin16_shortfin_acc_wr_reg(sa__, 0xd204,wr_val)
#define rdc_micro_ra_wraddr_msw()                               _merlin16_shortfin_pmd_rde_reg(sa__, 0xd205,__ERR)
#define wrc_micro_ra_wraddr_msw(wr_val)                         merlin16_shortfin_acc_wr_reg(sa__, 0xd205,wr_val)
#define rdc_micro_ra_wrdata_lsw()                               _merlin16_shortfin_pmd_rde_reg(sa__, 0xd206,__ERR)
#define wrc_micro_ra_wrdata_lsw(wr_val)                         merlin16_shortfin_acc_wr_reg(sa__, 0xd206,wr_val)
#define rdc_micro_ra_wrdata_msw()                               _merlin16_shortfin_pmd_rde_reg(sa__, 0xd207,__ERR)
#define wrc_micro_ra_wrdata_msw(wr_val)                         merlin16_shortfin_acc_wr_reg(sa__, 0xd207,wr_val)
#define rdc_micro_ra_rdaddr_lsw()                               _merlin16_shortfin_pmd_rde_reg(sa__, 0xd208,__ERR)
#define wrc_micro_ra_rdaddr_lsw(wr_val)                         merlin16_shortfin_acc_wr_reg(sa__, 0xd208,wr_val)
#define rdc_micro_ra_rdaddr_msw()                               _merlin16_shortfin_pmd_rde_reg(sa__, 0xd209,__ERR)
#define wrc_micro_ra_rdaddr_msw(wr_val)                         merlin16_shortfin_acc_wr_reg(sa__, 0xd209,wr_val)
...
#define wrc_micro_pramif_ahb_wraddr_lsw(wr_val)                 merlin16_shortfin_acc_mwr_reg(sa__, 0xd20d,0xfffc,2,wr_val)
#define rdc_micro_pramif_ahb_wraddr_msw()                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd20e,__ERR)
#define wrc_micro_pramif_ahb_wraddr_msw(wr_val)                 merlin16_shortfin_acc_wr_reg(sa__, 0xd20e,wr_val)
...
#define wrc_micro_rmi_to_micro_mbox0(wr_val)                    merlin16_shortfin_acc_wr_reg(sa__, 0xd211,wr_val)
#define rdc_micro_rmi_to_micro_mbox1()                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd212,__ERR)
#define wrc_micro_rmi_to_micro_mbox1(wr_val)                    merlin16_shortfin_acc_wr_reg(sa__, 0xd212,wr_val)
...
#define wrc_micro_pvt_tempdata_frcval(wr_val)                   merlin16_shortfin_acc_mwr_reg(sa__, 0xd21b,0x03ff,0,wr_val)
...
#define wrc_patt_gen_seq_0(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd100,wr_val)
#define rdc_patt_gen_seq_1()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd101,__ERR)
#define wrc_patt_gen_seq_1(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd101,wr_val)
#define rdc_patt_gen_seq_2()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd102,__ERR)
#define wrc_patt_gen_seq_2(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd102,wr_val)
#define rdc_patt_gen_seq_3()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd103,__ERR)
#define wrc_patt_gen_seq_3(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd103,wr_val)
#define rdc_patt_gen_seq_4()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd104,__ERR)
#define wrc_patt_gen_seq_4(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd104,wr_val)
#define rdc_patt_gen_seq_5()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd105,__ERR)
#define wrc_patt_gen_seq_5(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd105,wr_val)
#define rdc_patt_gen_seq_6()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd106,__ERR)
#define wrc_patt_gen_seq_6(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd106,wr_val)
#define rdc_patt_gen_seq_7()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd107,__ERR)
#define wrc_patt_gen_seq_7(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd107,wr_val)
#define rdc_patt_gen_seq_8()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd108,__ERR)
#define wrc_patt_gen_seq_8(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd108,wr_val)
#define rdc_patt_gen_seq_9()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd109,__ERR)
#define wrc_patt_gen_seq_9(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd109,wr_val)
#define rdc_patt_gen_seq_10()                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd10a,__ERR)
#define wrc_patt_gen_seq_10(wr_val)                             merlin16_shortfin_acc_wr_reg(sa__, 0xd10a,wr_val)
#define rdc_patt_gen_seq_11()                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd10b,__ERR)
#define wrc_patt_gen_seq_11(wr_val)                             merlin16_shortfin_acc_wr_reg(sa__, 0xd10b,wr_val)
#define rdc_patt_gen_seq_12()                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd10c,__ERR)
#define wrc_patt_gen_seq_12(wr_val)                             merlin16_shortfin_acc_wr_reg(sa__, 0xd10c,wr_val)
#define rdc_patt_gen_seq_13()                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd10d,__ERR)
#define wrc_patt_gen_seq_13(wr_val)                             merlin16_shortfin_acc_wr_reg(sa__, 0xd10d,wr_val)
#define rdc_patt_gen_seq_14()                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd10e,__ERR)
#define wrc_patt_gen_seq_14(wr_val)                             merlin16_shortfin_acc_wr_reg(sa__, 0xd10e,wr_val)
...
#define wrc_calib_step_time(wr_val)                             merlin16_shortfin_acc_mwr_reg(sa__, 0xd120,0x1fff,0,wr_val)
#define rdc_freqdet_time()                                      _merlin16_shortfin_pmd_rde_reg(sa__, 0xd121,__ERR)
#define wrc_freqdet_time(wr_val)                                merlin16_shortfin_acc_wr_reg(sa__, 0xd121,wr_val)
#define rdc_calib_cap_charge_time()                             _merlin16_shortfin_pmd_rde_field(sa__, 0xd122,4,4,__ERR)
#define wrc_calib_cap_charge_time(wr_val)                       merlin16_shortfin_acc_mwr_reg(sa__, 0xd122,0x0fff,0,wr_val)
...
#define wr_tx_pi_freq_override_val(wr_val)                      merlin16_shortfin_acc_mwr_reg(sa__, 0xd071,0x7fff,0,wr_val)
...
#define wrc_txcom_cl72_max_wait_timer_period(wr_val)            merlin16_shortfin_acc_wr_reg(sa__, 0xd130,wr_val)
#define rdc_txcom_cl72_wait_cntr_limit()                        _merlin16_shortfin_pmd_rde_field(sa__, 0xd131,7,7,__ERR)
#define wrc_txcom_cl72_wait_cntr_limit(wr_val)                  merlin16_shortfin_acc_mwr_reg(sa__, 0xd131,0x01ff,0,wr_val)

#define reg_rd_AMS_RX_RXCONTROL_0()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd090,__ERR)
#define reg_wr_AMS_RX_RXCONTROL_0(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd090,wr_val)
#define reg_rd_AMS_RX_RXCONTROL_1()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd091,__ERR)
#define reg_wr_AMS_RX_RXCONTROL_1(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd091,wr_val)
#define reg_rd_AMS_RX_RXCONTROL_2()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd092,__ERR)
#define reg_wr_AMS_RX_RXCONTROL_2(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd092,wr_val)
#define reg_rd_AMS_RX_RXCONTROL_3()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd093,__ERR)
#define reg_wr_AMS_RX_RXCONTROL_3(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd093,wr_val)
#define reg_rd_AMS_RX_RXCONTROL_4()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd094,__ERR)
#define reg_wr_AMS_RX_RXCONTROL_4(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd094,wr_val)
#define reg_rd_AMS_RX_RXCONTROL_5()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd095,__ERR)
#define reg_wr_AMS_RX_RXCONTROL_5(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd095,wr_val)
#define reg_rd_AMS_RX_RXCONTROL_6()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd096,__ERR)
#define reg_wr_AMS_RX_RXCONTROL_6(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd096,wr_val)
#define reg_rd_AMS_RX_RXCONTROL_7()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd097,__ERR)
#define reg_wr_AMS_RX_RXCONTROL_7(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd097,wr_val)
#define reg_rd_AMS_RX_INTCTRL()                                                        _merlin16_shortfin_pmd_rde_reg(sa__, 0xd098,__ERR)
#define reg_wr_AMS_RX_INTCTRL(wr_val)                                                  merlin16_shortfin_acc_wr_reg(sa__, 0xd098,wr_val)
#define reg_rd_AMS_RX_RXSTATUS()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd099,__ERR)
#define reg_wr_AMS_RX_RXSTATUS(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd099,wr_val)
#define reg_rd_AMS_TX_TXCONTROL_0()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0a0,__ERR)
#define reg_wr_AMS_TX_TXCONTROL_0(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd0a0,wr_val)
#define reg_rd_AMS_TX_TXCONTROL_1()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0a1,__ERR)
#define reg_wr_AMS_TX_TXCONTROL_1(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd0a1,wr_val)
#define reg_rd_AMS_TX_TXCONTROL_2()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0a2,__ERR)
#define reg_wr_AMS_TX_TXCONTROL_2(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd0a2,wr_val)
#define reg_rd_AMS_TX_TXCONTROL_3()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0a3,__ERR)
#define reg_wr_AMS_TX_TXCONTROL_3(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd0a3,wr_val)
#define reg_rd_AMS_TX_TXCONTROL_4()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0a4,__ERR)
#define reg_wr_AMS_TX_TXCONTROL_4(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd0a4,wr_val)
#define reg_rd_AMS_TX_TXCONTROL_5()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0a5,__ERR)
#define reg_wr_AMS_TX_TXCONTROL_5(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd0a5,wr_val)
#define reg_rd_AMS_TX_TXCONTROL_6()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0a6,__ERR)
#define reg_wr_AMS_TX_TXCONTROL_6(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd0a6,wr_val)
#define reg_rd_AMS_TX_TXCONTROL_7()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0a7,__ERR)
#define reg_wr_AMS_TX_TXCONTROL_7(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd0a7,wr_val)
#define reg_rd_AMS_TX_TXCONTROL_8()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0a8,__ERR)
#define reg_wr_AMS_TX_TXCONTROL_8(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd0a8,wr_val)
#define reg_rd_AMS_TX_TXINTCTRL()                                                      _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0a9,__ERR)
#define reg_wr_AMS_TX_TXINTCTRL(wr_val)                                                merlin16_shortfin_acc_wr_reg(sa__, 0xd0a9,wr_val)
#define reg_rd_AMS_TX_TXSTATUS()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0aa,__ERR)
#define reg_wr_AMS_TX_TXSTATUS(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd0aa,wr_val)
#define reg_rdc_AMS_COM_PLL_CTRL_0()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0b0,__ERR)
#define reg_wrc_AMS_COM_PLL_CTRL_0(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd0b0,wr_val)
#define reg_rdc_AMS_COM_PLL_CTRL_1()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0b1,__ERR)
#define reg_wrc_AMS_COM_PLL_CTRL_1(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd0b1,wr_val)
#define reg_rdc_AMS_COM_PLL_CTRL_2()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0b2,__ERR)
#define reg_wrc_AMS_COM_PLL_CTRL_2(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd0b2,wr_val)
#define reg_rdc_AMS_COM_PLL_CTRL_3()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0b3,__ERR)
#define reg_wrc_AMS_COM_PLL_CTRL_3(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd0b3,wr_val)
#define reg_rdc_AMS_COM_PLL_CTRL_4()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0b4,__ERR)
#define reg_wrc_AMS_COM_PLL_CTRL_4(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd0b4,wr_val)
#define reg_rdc_AMS_COM_PLL_CTRL_5()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0b5,__ERR)
#define reg_wrc_AMS_COM_PLL_CTRL_5(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd0b5,wr_val)
#define reg_rdc_AMS_COM_PLL_CTRL_6()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0b6,__ERR)
#define reg_wrc_AMS_COM_PLL_CTRL_6(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd0b6,wr_val)
#define reg_rdc_AMS_COM_PLL_CTRL_7()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0b7,__ERR)
#define reg_wrc_AMS_COM_PLL_CTRL_7(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd0b7,wr_val)
#define reg_rdc_AMS_COM_PLL_CTRL_8()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0b8,__ERR)
#define reg_wrc_AMS_COM_PLL_CTRL_8(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd0b8,wr_val)
#define reg_rdc_AMS_COM_PLL_CTRL_9()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0b9,__ERR)
#define reg_wrc_AMS_COM_PLL_CTRL_9(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd0b9,wr_val)
#define reg_rdc_AMS_COM_PLL_CTRL_10()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0ba,__ERR)
#define reg_wrc_AMS_COM_PLL_CTRL_10(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd0ba,wr_val)
#define reg_rdc_AMS_COM_PLL_INT()                                                      _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0be,__ERR)
#define reg_wrc_AMS_COM_PLL_INT(wr_val)                                                merlin16_shortfin_acc_wr_reg(sa__, 0xd0be,wr_val)
#define reg_rdc_AMS_COM_PLL_STS()                                                      _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0bf,__ERR)
#define reg_wrc_AMS_COM_PLL_STS(wr_val)                                                merlin16_shortfin_acc_wr_reg(sa__, 0xd0bf,wr_val)
#define reg_rd_CL72_IEEE_RX_CL72IR_BASE_R_LP_COEFF_UPDATE_REGISTER_152()               _merlin16_shortfin_pmd_rde_reg(sa__, 0x0098,__ERR)
#define reg_wr_CL72_IEEE_RX_CL72IR_BASE_R_LP_COEFF_UPDATE_REGISTER_152(wr_val)         merlin16_shortfin_acc_wr_reg(sa__, 0x0098,wr_val)
#define reg_rd_CL72_IEEE_RX_CL72IR_BASE_R_LP_STATUS_REPORT_REGISTER_153()              _merlin16_shortfin_pmd_rde_reg(sa__, 0x0099,__ERR)
#define reg_wr_CL72_IEEE_RX_CL72IR_BASE_R_LP_STATUS_REPORT_REGISTER_153(wr_val)        merlin16_shortfin_acc_wr_reg(sa__, 0x0099,wr_val)
#define reg_rd_CL72_IEEE_TX_CL72IT_BASE_R_PMD_CONTROL_REGISTER_150()                   _merlin16_shortfin_pmd_rde_reg(sa__, 0x0096,__ERR)
#define reg_wr_CL72_IEEE_TX_CL72IT_BASE_R_PMD_CONTROL_REGISTER_150(wr_val)             merlin16_shortfin_acc_wr_reg(sa__, 0x0096,wr_val)
#define reg_rd_CL72_IEEE_TX_CL72IT_BASE_R_PMD_STATUS_REGISTER_151()                    _merlin16_shortfin_pmd_rde_reg(sa__, 0x0097,__ERR)
#define reg_wr_CL72_IEEE_TX_CL72IT_BASE_R_PMD_STATUS_REGISTER_151(wr_val)              merlin16_shortfin_acc_wr_reg(sa__, 0x0097,wr_val)
#define reg_rd_CL72_IEEE_TX_CL72IT_BASE_R_LD_COEFF_UPDATE_REGISTER_154()               _merlin16_shortfin_pmd_rde_reg(sa__, 0x009a,__ERR)
#define reg_wr_CL72_IEEE_TX_CL72IT_BASE_R_LD_COEFF_UPDATE_REGISTER_154(wr_val)         merlin16_shortfin_acc_wr_reg(sa__, 0x009a,wr_val)
#define reg_rd_CL72_IEEE_TX_CL72IT_BASE_R_LD_STATUS_REPORT_REGISTER_155()              _merlin16_shortfin_pmd_rde_reg(sa__, 0x009b,__ERR)
#define reg_wr_CL72_IEEE_TX_CL72IT_BASE_R_LD_STATUS_REPORT_REGISTER_155(wr_val)        merlin16_shortfin_acc_wr_reg(sa__, 0x009b,wr_val)
#define reg_rd_CL72_USER_RX_CL72UR_CONTROL0_REGISTER()                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd050,__ERR)
#define reg_wr_CL72_USER_RX_CL72UR_CONTROL0_REGISTER(wr_val)                           merlin16_shortfin_acc_wr_reg(sa__, 0xd050,wr_val)
#define reg_rd_CL72_USER_RX_CL72UR_CONTROL1_REGISTER()                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd051,__ERR)
#define reg_wr_CL72_USER_RX_CL72UR_CONTROL1_REGISTER(wr_val)                           merlin16_shortfin_acc_wr_reg(sa__, 0xd051,wr_val)
#define reg_rd_CL72_USER_RX_CL72UR_CONTROL2_REGISTER()                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd052,__ERR)
#define reg_wr_CL72_USER_RX_CL72UR_CONTROL2_REGISTER(wr_val)                           merlin16_shortfin_acc_wr_reg(sa__, 0xd052,wr_val)
#define reg_rd_CL72_USER_RX_CL72UR_STATUS0_REGISTER()                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd053,__ERR)
#define reg_wr_CL72_USER_RX_CL72UR_STATUS0_REGISTER(wr_val)                            merlin16_shortfin_acc_wr_reg(sa__, 0xd053,wr_val)
#define reg_rd_CL72_USER_RX_CL72UR_MICRO_INTERRUPT_CONTROL0_REGISTER()                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd054,__ERR)
#define reg_wr_CL72_USER_RX_CL72UR_MICRO_INTERRUPT_CONTROL0_REGISTER(wr_val)           merlin16_shortfin_acc_wr_reg(sa__, 0xd054,wr_val)
#define reg_rd_CL72_USER_RX_CL72UR_MICRO_STATUS0_REGISTER()                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd055,__ERR)
#define reg_wr_CL72_USER_RX_CL72UR_MICRO_STATUS0_REGISTER(wr_val)                      merlin16_shortfin_acc_wr_reg(sa__, 0xd055,wr_val)
#define reg_rd_CL72_USER_RX_CL72UR_MICRO_STATUS1_REGISTER()                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd056,__ERR)
#define reg_wr_CL72_USER_RX_CL72UR_MICRO_STATUS1_REGISTER(wr_val)                      merlin16_shortfin_acc_wr_reg(sa__, 0xd056,wr_val)
#define reg_rd_CL72_USER_TX_CL72UT_XMT_UPDATE_PAGE_REGISTER()                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd060,__ERR)
#define reg_wr_CL72_USER_TX_CL72UT_XMT_UPDATE_PAGE_REGISTER(wr_val)                    merlin16_shortfin_acc_wr_reg(sa__, 0xd060,wr_val)
#define reg_rd_CL72_USER_TX_CL72UT_LD_XMT_STATUS_PAGE()                                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd061,__ERR)
#define reg_wr_CL72_USER_TX_CL72UT_LD_XMT_STATUS_PAGE(wr_val)                          merlin16_shortfin_acc_wr_reg(sa__, 0xd061,wr_val)
#define reg_rd_CL72_USER_TX_CL72UT_CONTROL0_REGISTER()                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd062,__ERR)
#define reg_wr_CL72_USER_TX_CL72UT_CONTROL0_REGISTER(wr_val)                           merlin16_shortfin_acc_wr_reg(sa__, 0xd062,wr_val)
#define reg_rd_CL72_USER_TX_CL72UT_CONTROL1_REGISTER()                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd063,__ERR)
#define reg_wr_CL72_USER_TX_CL72UT_CONTROL1_REGISTER(wr_val)                           merlin16_shortfin_acc_wr_reg(sa__, 0xd063,wr_val)
#define reg_rd_CL72_USER_TX_CL72UT_CONTROL2_REGISTER()                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd064,__ERR)
#define reg_wr_CL72_USER_TX_CL72UT_CONTROL2_REGISTER(wr_val)                           merlin16_shortfin_acc_wr_reg(sa__, 0xd064,wr_val)
#define reg_rd_CL72_USER_TX_CL72UT_CONTROL3_REGISTER()                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd065,__ERR)
#define reg_wr_CL72_USER_TX_CL72UT_CONTROL3_REGISTER(wr_val)                           merlin16_shortfin_acc_wr_reg(sa__, 0xd065,wr_val)
#define reg_rd_CL72_USER_TX_CL72UT_STATUS0_REGISTER()                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd066,__ERR)
#define reg_wr_CL72_USER_TX_CL72UT_STATUS0_REGISTER(wr_val)                            merlin16_shortfin_acc_wr_reg(sa__, 0xd066,wr_val)
#define reg_rd_CL72_USER_TX_CL72UT_CONTROL4_REGISTER()                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd067,__ERR)
#define reg_wr_CL72_USER_TX_CL72UT_CONTROL4_REGISTER(wr_val)                           merlin16_shortfin_acc_wr_reg(sa__, 0xd067,wr_val)
#define reg_rdc_DIG_COM_REVID0()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0f0,__ERR)
#define reg_wrc_DIG_COM_REVID0(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd0f0,wr_val)
#define reg_rdc_DIG_COM_REVID1()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0fa,__ERR)
#define reg_wrc_DIG_COM_REVID1(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd0fa,wr_val)
#define reg_rdc_DIG_COM_REVID2()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0fe,__ERR)
#define reg_wrc_DIG_COM_REVID2(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd0fe,wr_val)
#define reg_rdc_DIG_COM_RESET_CONTROL_PMD()                                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0f1,__ERR)
#define reg_wrc_DIG_COM_RESET_CONTROL_PMD(wr_val)                                      merlin16_shortfin_acc_wr_reg(sa__, 0xd0f1,wr_val)
#define reg_rdc_DIG_COM_RESET_CONTROL_CORE_DP()                                        _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0f2,__ERR)
#define reg_wrc_DIG_COM_RESET_CONTROL_CORE_DP(wr_val)                                  merlin16_shortfin_acc_wr_reg(sa__, 0xd0f2,wr_val)
#define reg_rdc_DIG_COM_MASKDATA_REG()                                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0f3,__ERR)
#define reg_wrc_DIG_COM_MASKDATA_REG(wr_val)                                           merlin16_shortfin_acc_wr_reg(sa__, 0xd0f3,wr_val)
#define reg_rdc_DIG_COM_TOP_USER_CONTROL_0()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0f4,__ERR)
#define reg_wrc_DIG_COM_TOP_USER_CONTROL_0(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd0f4,wr_val)
#define reg_rdc_DIG_COM_UC_ACK_CORE_CONTROL()                                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0f5,__ERR)
#define reg_wrc_DIG_COM_UC_ACK_CORE_CONTROL(wr_val)                                    merlin16_shortfin_acc_wr_reg(sa__, 0xd0f5,wr_val)
#define reg_rdc_DIG_COM_CORE_DP_RESET_STATE_STATUS()                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0f8,__ERR)
#define reg_wrc_DIG_COM_CORE_DP_RESET_STATE_STATUS(wr_val)                             merlin16_shortfin_acc_wr_reg(sa__, 0xd0f8,wr_val)
#define reg_rdc_DIG_COM_CORE_REG_RESET_OCCURRED_CONTROL()                              _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0f6,__ERR)
#define reg_wrc_DIG_COM_CORE_REG_RESET_OCCURRED_CONTROL(wr_val)                        merlin16_shortfin_acc_wr_reg(sa__, 0xd0f6,wr_val)
#define reg_rdc_DIG_COM_RST_SEQ_TIMER_CONTROL()                                        _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0f7,__ERR)
#define reg_wrc_DIG_COM_RST_SEQ_TIMER_CONTROL(wr_val)                                  merlin16_shortfin_acc_wr_reg(sa__, 0xd0f7,wr_val)
#define reg_rdc_DIG_COM_PMD_CORE_MODE_STATUS()                                         _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0f9,__ERR)
#define reg_wrc_DIG_COM_PMD_CORE_MODE_STATUS(wr_val)                                   merlin16_shortfin_acc_wr_reg(sa__, 0xd0f9,wr_val)
#define reg_rd_DSC_A_CDR_STATUS_INTEG_REG()                                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd005,__ERR)
#define reg_wr_DSC_A_CDR_STATUS_INTEG_REG(wr_val)                                      merlin16_shortfin_acc_wr_reg(sa__, 0xd005,wr_val)
#define reg_rd_DSC_A_CDR_STATUS_PHASE_ERROR()                                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd006,__ERR)
#define reg_wr_DSC_A_CDR_STATUS_PHASE_ERROR(wr_val)                                    merlin16_shortfin_acc_wr_reg(sa__, 0xd006,wr_val)
#define reg_rd_DSC_A_RX_PI_CNT_BIN_D()                                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd007,__ERR)
#define reg_wr_DSC_A_RX_PI_CNT_BIN_D(wr_val)                                           merlin16_shortfin_acc_wr_reg(sa__, 0xd007,wr_val)
#define reg_rd_DSC_A_RX_PI_CNT_BIN_P()                                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd008,__ERR)
#define reg_wr_DSC_A_RX_PI_CNT_BIN_P(wr_val)                                           merlin16_shortfin_acc_wr_reg(sa__, 0xd008,wr_val)
#define reg_rd_DSC_A_RX_PI_CNT_BIN_M()                                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd009,__ERR)
#define reg_wr_DSC_A_RX_PI_CNT_BIN_M(wr_val)                                           merlin16_shortfin_acc_wr_reg(sa__, 0xd009,wr_val)
#define reg_rd_DSC_A_RX_PI_DIFF_BIN()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd00a,__ERR)
#define reg_wr_DSC_A_RX_PI_DIFF_BIN(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd00a,wr_val)
#define reg_rd_DSC_A_CDR_CONTROL_0()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd001,__ERR)
#define reg_wr_DSC_A_CDR_CONTROL_0(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd001,wr_val)
#define reg_rd_DSC_A_CDR_CONTROL_1()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd002,__ERR)
#define reg_wr_DSC_A_CDR_CONTROL_1(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd002,wr_val)
#define reg_rd_DSC_A_CDR_CONTROL_2()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd003,__ERR)
#define reg_wr_DSC_A_CDR_CONTROL_2(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd003,wr_val)
#define reg_rd_DSC_A_RX_PI_CONTROL()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd004,__ERR)
#define reg_wr_DSC_A_RX_PI_CONTROL(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd004,wr_val)
#define reg_rd_DSC_A_DSC_UC_CTRL()                                                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd00d,__ERR)
#define reg_wr_DSC_A_DSC_UC_CTRL(wr_val)                                               merlin16_shortfin_acc_wr_reg(sa__, 0xd00d,wr_val)
#define reg_rd_DSC_A_DSC_SCRATCH()                                                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd00e,__ERR)
#define reg_wr_DSC_A_DSC_SCRATCH(wr_val)                                               merlin16_shortfin_acc_wr_reg(sa__, 0xd00e,wr_val)
#define reg_rd_DSC_B_DSC_SM_CTRL_0()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd010,__ERR)
#define reg_wr_DSC_B_DSC_SM_CTRL_0(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd010,wr_val)
#define reg_rd_DSC_B_DSC_SM_CTRL_1()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd011,__ERR)
#define reg_wr_DSC_B_DSC_SM_CTRL_1(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd011,wr_val)
#define reg_rd_DSC_B_DSC_SM_CTRL_2()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd012,__ERR)
#define reg_wr_DSC_B_DSC_SM_CTRL_2(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd012,wr_val)
#define reg_rd_DSC_B_DSC_SM_CTRL_3()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd013,__ERR)
#define reg_wr_DSC_B_DSC_SM_CTRL_3(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd013,wr_val)
#define reg_rd_DSC_B_DSC_SM_CTRL_4()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd014,__ERR)
#define reg_wr_DSC_B_DSC_SM_CTRL_4(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd014,wr_val)
#define reg_rd_DSC_B_DSC_SM_CTRL_5()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd015,__ERR)
#define reg_wr_DSC_B_DSC_SM_CTRL_5(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd015,wr_val)
#define reg_rd_DSC_B_DSC_SM_CTRL_6()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd016,__ERR)
#define reg_wr_DSC_B_DSC_SM_CTRL_6(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd016,wr_val)
#define reg_rd_DSC_B_DSC_SM_CTRL_7()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd017,__ERR)
#define reg_wr_DSC_B_DSC_SM_CTRL_7(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd017,wr_val)
#define reg_rd_DSC_B_DSC_SM_CTRL_8()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd018,__ERR)
#define reg_wr_DSC_B_DSC_SM_CTRL_8(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd018,wr_val)
#define reg_rd_DSC_B_DSC_SM_CTRL_9()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd019,__ERR)
#define reg_wr_DSC_B_DSC_SM_CTRL_9(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd019,wr_val)
#define reg_rd_DSC_B_DSC_SM_STATUS_DSC_STATE_ONE_HOT()                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd01b,__ERR)
#define reg_wr_DSC_B_DSC_SM_STATUS_DSC_STATE_ONE_HOT(wr_val)                           merlin16_shortfin_acc_wr_reg(sa__, 0xd01b,wr_val)
#define reg_rd_DSC_B_DSC_SM_STATUS_DSC_STATE_EEE_ONE_HOT()                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd01c,__ERR)
#define reg_wr_DSC_B_DSC_SM_STATUS_DSC_STATE_EEE_ONE_HOT(wr_val)                       merlin16_shortfin_acc_wr_reg(sa__, 0xd01c,wr_val)
#define reg_rd_DSC_B_DSC_SM_STATUS_RESTART()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd01d,__ERR)
#define reg_wr_DSC_B_DSC_SM_STATUS_RESTART(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd01d,wr_val)
#define reg_rd_DSC_B_DSC_SM_STATUS_DSC_STATE()                                         _merlin16_shortfin_pmd_rde_reg(sa__, 0xd01e,__ERR)
#define reg_wr_DSC_B_DSC_SM_STATUS_DSC_STATE(wr_val)                                   merlin16_shortfin_acc_wr_reg(sa__, 0xd01e,wr_val)
#define reg_rd_DSC_B_DSC_SM_STATUS_DSC_LOCK()                                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd01a,__ERR)
#define reg_wr_DSC_B_DSC_SM_STATUS_DSC_LOCK(wr_val)                                    merlin16_shortfin_acc_wr_reg(sa__, 0xd01a,wr_val)
#define reg_rd_DSC_C_DFE_1_CTL()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd021,__ERR)
#define reg_wr_DSC_C_DFE_1_CTL(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd021,wr_val)
#define reg_rd_DSC_C_DFE_2_CTL()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd022,__ERR)
#define reg_wr_DSC_C_DFE_2_CTL(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd022,wr_val)
#define reg_rd_DSC_C_DFE_3_CTL()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd023,__ERR)
#define reg_wr_DSC_C_DFE_3_CTL(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd023,wr_val)
#define reg_rd_DSC_C_DFE_4_CTL()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd024,__ERR)
#define reg_wr_DSC_C_DFE_4_CTL(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd024,wr_val)
#define reg_rd_DSC_C_DFE_5_CTL()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd025,__ERR)
#define reg_wr_DSC_C_DFE_5_CTL(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd025,wr_val)
#define reg_rd_DSC_C_DFE_PAT_CTL()                                                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd026,__ERR)
#define reg_wr_DSC_C_DFE_PAT_CTL(wr_val)                                               merlin16_shortfin_acc_wr_reg(sa__, 0xd026,wr_val)
#define reg_rd_DSC_C_DFE_COMMON_CTL()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd020,__ERR)
#define reg_wr_DSC_C_DFE_COMMON_CTL(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd020,wr_val)
#define reg_rd_DSC_C_HWTUNE_OVR_OVERRIDE()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd02b,__ERR)
#define reg_wr_DSC_C_HWTUNE_OVR_OVERRIDE(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd02b,wr_val)
#define reg_rd_DSC_C_VGA_CTL()                                                         _merlin16_shortfin_pmd_rde_reg(sa__, 0xd02c,__ERR)
#define reg_wr_DSC_C_VGA_CTL(wr_val)                                                   merlin16_shortfin_acc_wr_reg(sa__, 0xd02c,wr_val)
#define reg_rd_DSC_C_VGA_PAT_EYEDIAG_CTL()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd02d,__ERR)
#define reg_wr_DSC_C_VGA_PAT_EYEDIAG_CTL(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd02d,wr_val)
#define reg_rd_DSC_C_P1_FRAC_OFFS_CTL()                                                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd02e,__ERR)
#define reg_wr_DSC_C_P1_FRAC_OFFS_CTL(wr_val)                                          merlin16_shortfin_acc_wr_reg(sa__, 0xd02e,wr_val)
#define reg_rd_DSC_C_VGA_P1_MISC_CONTROL()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd027,__ERR)
#define reg_wr_DSC_C_VGA_P1_MISC_CONTROL(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd027,wr_val)
#define reg_rd_DSC_C_SLICER_OFFSET_CONTROL()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd02a,__ERR)
#define reg_wr_DSC_C_SLICER_OFFSET_CONTROL(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd02a,wr_val)
#define reg_rd_DSC_C_DC_SLICER_OFFSET_CTL()                                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd029,__ERR)
#define reg_wr_DSC_C_DC_SLICER_OFFSET_CTL(wr_val)                                      merlin16_shortfin_acc_wr_reg(sa__, 0xd029,wr_val)
#define reg_rd_DSC_D_VGA_P1EYEDIAG_STS()                                               _merlin16_shortfin_pmd_rde_reg(sa__, 0xd03a,__ERR)
#define reg_wr_DSC_D_VGA_P1EYEDIAG_STS(wr_val)                                         merlin16_shortfin_acc_wr_reg(sa__, 0xd03a,wr_val)
#define reg_rd_DSC_D_DFE_1_STS()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd03b,__ERR)
#define reg_wr_DSC_D_DFE_1_STS(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd03b,wr_val)
#define reg_rd_DSC_D_DFE_2_STS()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd03c,__ERR)
#define reg_wr_DSC_D_DFE_2_STS(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd03c,wr_val)
#define reg_rd_DSC_D_DFE_3_4_5_STS()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd03d,__ERR)
#define reg_wr_DSC_D_DFE_3_4_5_STS(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd03d,wr_val)
#define reg_rd_DSC_D_VGA_TAP_BIN()                                                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd03e,__ERR)
#define reg_wr_DSC_D_VGA_TAP_BIN(wr_val)                                               merlin16_shortfin_acc_wr_reg(sa__, 0xd03e,wr_val)
#define reg_rd_DSC_E_CTRL()                                                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd040,__ERR)
#define reg_wr_DSC_E_CTRL(wr_val)                                                      merlin16_shortfin_acc_wr_reg(sa__, 0xd040,wr_val)
#define reg_rd_DSC_E_PF_CTRL()                                                         _merlin16_shortfin_pmd_rde_reg(sa__, 0xd041,__ERR)
#define reg_wr_DSC_E_PF_CTRL(wr_val)                                                   merlin16_shortfin_acc_wr_reg(sa__, 0xd041,wr_val)
#define reg_rd_DSC_E_PF2_LOWP_CTRL()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd042,__ERR)
#define reg_wr_DSC_E_PF2_LOWP_CTRL(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd042,wr_val)
#define reg_rd_DSC_F_DATA_ODD_OFFSET()                                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd141,__ERR)
#define reg_wr_DSC_F_DATA_ODD_OFFSET(wr_val)                                           merlin16_shortfin_acc_wr_reg(sa__, 0xd141,wr_val)
#define reg_rd_DSC_F_DATA_EVEN_OFFSET()                                                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd142,__ERR)
#define reg_wr_DSC_F_DATA_EVEN_OFFSET(wr_val)                                          merlin16_shortfin_acc_wr_reg(sa__, 0xd142,wr_val)
#define reg_rd_DSC_F_P1_ODD_OFFSET()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd143,__ERR)
#define reg_wr_DSC_F_P1_ODD_OFFSET(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd143,wr_val)
#define reg_rd_DSC_F_P1_EVEN_OFFSET()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd144,__ERR)
#define reg_wr_DSC_F_P1_EVEN_OFFSET(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd144,wr_val)
#define reg_rd_DSC_F_M1_ODD_OFFSET()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd145,__ERR)
#define reg_wr_DSC_F_M1_ODD_OFFSET(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd145,wr_val)
#define reg_rd_DSC_F_M1_EVEN_OFFSET()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd146,__ERR)
#define reg_wr_DSC_F_M1_EVEN_OFFSET(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd146,wr_val)
#define reg_rd_DSC_F_DC_OFFSET()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd147,__ERR)
#define reg_wr_DSC_F_DC_OFFSET(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd147,wr_val)
#define reg_rdc_MDIO_BLK_ADDR_BLK_ADDR()                                               _merlin16_shortfin_pmd_rde_reg(sa__, 0xffdf,__ERR)
#define reg_wrc_MDIO_BLK_ADDR_BLK_ADDR(wr_val)                                         merlin16_shortfin_acc_wr_reg(sa__, 0xffdf,wr_val)
#define reg_rdc_MDIO_CL22_IEEE_ACC_CTRL()                                              _merlin16_shortfin_pmd_rde_reg(sa__, 0x000d,__ERR)
#define reg_wrc_MDIO_CL22_IEEE_ACC_CTRL(wr_val)                                        merlin16_shortfin_acc_wr_reg(sa__, 0x000d,wr_val)
#define reg_rdc_MDIO_CL22_IEEE_ACC_ADDR_DATA()                                         _merlin16_shortfin_pmd_rde_reg(sa__, 0x000e,__ERR)
#define reg_wrc_MDIO_CL22_IEEE_ACC_ADDR_DATA(wr_val)                                   merlin16_shortfin_acc_wr_reg(sa__, 0x000e,wr_val)
#define reg_rdc_MDIO_MMDSEL_AER_MDIO_BRCST_PORT_ADDR()                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xffdc,__ERR)
#define reg_wrc_MDIO_MMDSEL_AER_MDIO_BRCST_PORT_ADDR(wr_val)                           merlin16_shortfin_acc_wr_reg(sa__, 0xffdc,wr_val)
#define reg_rdc_MDIO_MMDSEL_AER_MDIO_MMD_SELECT()                                      _merlin16_shortfin_pmd_rde_reg(sa__, 0xffdd,__ERR)
#define reg_wrc_MDIO_MMDSEL_AER_MDIO_MMD_SELECT(wr_val)                                merlin16_shortfin_acc_wr_reg(sa__, 0xffdd,wr_val)
#define reg_rdc_MDIO_MMDSEL_AER_MDIO_AER()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xffde,__ERR)
#define reg_wrc_MDIO_MMDSEL_AER_MDIO_AER(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xffde,wr_val)
#define reg_rdc_MICRO_A_COM_CLOCK_CONTROL0()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd200,__ERR)
#define reg_wrc_MICRO_A_COM_CLOCK_CONTROL0(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd200,wr_val)
#define reg_rdc_MICRO_A_COM_RESET_CONTROL0()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd201,__ERR)
#define reg_wrc_MICRO_A_COM_RESET_CONTROL0(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd201,wr_val)
#define reg_rdc_MICRO_A_COM_AHB_CONTROL0()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd202,__ERR)
#define reg_wrc_MICRO_A_COM_AHB_CONTROL0(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd202,wr_val)
#define reg_rdc_MICRO_A_COM_AHB_STATUS0()                                              _merlin16_shortfin_pmd_rde_reg(sa__, 0xd203,__ERR)
#define reg_wrc_MICRO_A_COM_AHB_STATUS0(wr_val)                                        merlin16_shortfin_acc_wr_reg(sa__, 0xd203,wr_val)
#define reg_rdc_MICRO_A_COM_AHB_WRADDR_LSW()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd204,__ERR)
#define reg_wrc_MICRO_A_COM_AHB_WRADDR_LSW(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd204,wr_val)
#define reg_rdc_MICRO_A_COM_AHB_WRADDR_MSW()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd205,__ERR)
#define reg_wrc_MICRO_A_COM_AHB_WRADDR_MSW(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd205,wr_val)
#define reg_rdc_MICRO_A_COM_AHB_WRDATA_LSW()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd206,__ERR)
#define reg_wrc_MICRO_A_COM_AHB_WRDATA_LSW(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd206,wr_val)
#define reg_rdc_MICRO_A_COM_AHB_WRDATA_MSW()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd207,__ERR)
#define reg_wrc_MICRO_A_COM_AHB_WRDATA_MSW(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd207,wr_val)
#define reg_rdc_MICRO_A_COM_AHB_RDADDR_LSW()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd208,__ERR)
#define reg_wrc_MICRO_A_COM_AHB_RDADDR_LSW(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd208,wr_val)
#define reg_rdc_MICRO_A_COM_AHB_RDADDR_MSW()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd209,__ERR)
#define reg_wrc_MICRO_A_COM_AHB_RDADDR_MSW(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd209,wr_val)
#define reg_rdc_MICRO_A_COM_AHB_RDDATA_LSW()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd20a,__ERR)
#define reg_wrc_MICRO_A_COM_AHB_RDDATA_LSW(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd20a,wr_val)
#define reg_rdc_MICRO_A_COM_AHB_RDDATA_MSW()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd20b,__ERR)
#define reg_wrc_MICRO_A_COM_AHB_RDDATA_MSW(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd20b,wr_val)
#define reg_rdc_MICRO_A_COM_PRAMIF_CONTROL0()                                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd20c,__ERR)
#define reg_wrc_MICRO_A_COM_PRAMIF_CONTROL0(wr_val)                                    merlin16_shortfin_acc_wr_reg(sa__, 0xd20c,wr_val)
#define reg_rdc_MICRO_A_COM_PRAMIF_AHB_WRADDR_LSW()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd20d,__ERR)
#define reg_wrc_MICRO_A_COM_PRAMIF_AHB_WRADDR_LSW(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd20d,wr_val)
#define reg_rdc_MICRO_A_COM_PRAMIF_AHB_WRADDR_MSW()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd20e,__ERR)
#define reg_wrc_MICRO_A_COM_PRAMIF_AHB_WRADDR_MSW(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd20e,wr_val)
#define reg_rdc_MICRO_B_COM_PVT_STATUS0()                                              _merlin16_shortfin_pmd_rde_reg(sa__, 0xd210,__ERR)
#define reg_wrc_MICRO_B_COM_PVT_STATUS0(wr_val)                                        merlin16_shortfin_acc_wr_reg(sa__, 0xd210,wr_val)
#define reg_rdc_MICRO_B_COM_RMI_TO_MICRO_MBOX0()                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd211,__ERR)
#define reg_wrc_MICRO_B_COM_RMI_TO_MICRO_MBOX0(wr_val)                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd211,wr_val)
#define reg_rdc_MICRO_B_COM_RMI_TO_MICRO_MBOX1()                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd212,__ERR)
#define reg_wrc_MICRO_B_COM_RMI_TO_MICRO_MBOX1(wr_val)                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd212,wr_val)
#define reg_rdc_MICRO_B_COM_MICRO_TO_RMI_MBOX0()                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd213,__ERR)
#define reg_wrc_MICRO_B_COM_MICRO_TO_RMI_MBOX0(wr_val)                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd213,wr_val)
#define reg_rdc_MICRO_B_COM_MICRO_TO_RMI_MBOX1()                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd214,__ERR)
#define reg_wrc_MICRO_B_COM_MICRO_TO_RMI_MBOX1(wr_val)                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd214,wr_val)
#define reg_rdc_MICRO_B_COM_RMI_MBOX_CONTROL0()                                        _merlin16_shortfin_pmd_rde_reg(sa__, 0xd215,__ERR)
#define reg_wrc_MICRO_B_COM_RMI_MBOX_CONTROL0(wr_val)                                  merlin16_shortfin_acc_wr_reg(sa__, 0xd215,wr_val)
#define reg_rdc_MICRO_B_COM_RMI_AHB_CONTROL1()                                         _merlin16_shortfin_pmd_rde_reg(sa__, 0xd216,__ERR)
#define reg_wrc_MICRO_B_COM_RMI_AHB_CONTROL1(wr_val)                                   merlin16_shortfin_acc_wr_reg(sa__, 0xd216,wr_val)
#define reg_rdc_MICRO_B_COM_RMI_AHB_STATUS1()                                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd217,__ERR)
#define reg_wrc_MICRO_B_COM_RMI_AHB_STATUS1(wr_val)                                    merlin16_shortfin_acc_wr_reg(sa__, 0xd217,wr_val)
#define reg_rdc_MICRO_B_COM_RMI_RA_AUTOINC_NXT_WRADDR_LSW()                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd218,__ERR)
#define reg_wrc_MICRO_B_COM_RMI_RA_AUTOINC_NXT_WRADDR_LSW(wr_val)                      merlin16_shortfin_acc_wr_reg(sa__, 0xd218,wr_val)
#define reg_rdc_MICRO_B_COM_RMI_RA_AUTOINC_NXT_RDADDR_LSW()                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd219,__ERR)
#define reg_wrc_MICRO_B_COM_RMI_RA_AUTOINC_NXT_RDADDR_LSW(wr_val)                      merlin16_shortfin_acc_wr_reg(sa__, 0xd219,wr_val)
#define reg_rdc_MICRO_B_COM_RMI_PR_AUTOINC_NXT_WRADDR_LSW()                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd21a,__ERR)
#define reg_wrc_MICRO_B_COM_RMI_PR_AUTOINC_NXT_WRADDR_LSW(wr_val)                      merlin16_shortfin_acc_wr_reg(sa__, 0xd21a,wr_val)
#define reg_rdc_MICRO_B_COM_RMI_PVT_CONTROL0()                                         _merlin16_shortfin_pmd_rde_reg(sa__, 0xd21b,__ERR)
#define reg_wrc_MICRO_B_COM_RMI_PVT_CONTROL0(wr_val)                                   merlin16_shortfin_acc_wr_reg(sa__, 0xd21b,wr_val)
#define reg_rdc_MICRO_C_COM_CODE_RAM_ECCCONTROL0()                                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd220,__ERR)
#define reg_wrc_MICRO_C_COM_CODE_RAM_ECCCONTROL0(wr_val)                               merlin16_shortfin_acc_wr_reg(sa__, 0xd220,wr_val)
#define reg_rdc_MICRO_C_COM_CODE_RAM_ECCCONTRO1()                                      _merlin16_shortfin_pmd_rde_reg(sa__, 0xd221,__ERR)
#define reg_wrc_MICRO_C_COM_CODE_RAM_ECCCONTRO1(wr_val)                                merlin16_shortfin_acc_wr_reg(sa__, 0xd221,wr_val)
#define reg_rdc_MICRO_C_COM_CODE_RAM_ECCSTATUS0()                                      _merlin16_shortfin_pmd_rde_reg(sa__, 0xd222,__ERR)
#define reg_wrc_MICRO_C_COM_CODE_RAM_ECCSTATUS0(wr_val)                                merlin16_shortfin_acc_wr_reg(sa__, 0xd222,wr_val)
#define reg_rdc_MICRO_C_COM_CODE_RAM_ECCSTATUS1()                                      _merlin16_shortfin_pmd_rde_reg(sa__, 0xd223,__ERR)
#define reg_wrc_MICRO_C_COM_CODE_RAM_ECCSTATUS1(wr_val)                                merlin16_shortfin_acc_wr_reg(sa__, 0xd223,wr_val)
#define reg_rdc_MICRO_C_COM_CODE_RAM_TESTIFCONTROL0()                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd224,__ERR)
#define reg_wrc_MICRO_C_COM_CODE_RAM_TESTIFCONTROL0(wr_val)                            merlin16_shortfin_acc_wr_reg(sa__, 0xd224,wr_val)
#define reg_rdc_MICRO_C_COM_RAM_CONTROL0()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd225,__ERR)
#define reg_wrc_MICRO_C_COM_RAM_CONTROL0(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd225,wr_val)
#define reg_rdc_MICRO_C_COM_RMI_EXT_INTR_STATUS0()                                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd227,__ERR)
#define reg_wrc_MICRO_C_COM_RMI_EXT_INTR_STATUS0(wr_val)                               merlin16_shortfin_acc_wr_reg(sa__, 0xd227,wr_val)
#define reg_rdc_MICRO_C_COM_RMI_EXT_INTR_CONTROL0()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd226,__ERR)
#define reg_wrc_MICRO_C_COM_RMI_EXT_INTR_CONTROL0(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd226,wr_val)
#define reg_rdc_MICRO_C_COM_RMI_PMI_IF_CONTROL0()                                      _merlin16_shortfin_pmd_rde_reg(sa__, 0xd228,__ERR)
#define reg_wrc_MICRO_C_COM_RMI_PMI_IF_CONTROL0(wr_val)                                merlin16_shortfin_acc_wr_reg(sa__, 0xd228,wr_val)
#define reg_rdc_MICRO_C_COM_RMI_SILICON_DEBUG_CONTROL0()                               _merlin16_shortfin_pmd_rde_reg(sa__, 0xd229,__ERR)
#define reg_wrc_MICRO_C_COM_RMI_SILICON_DEBUG_CONTROL0(wr_val)                         merlin16_shortfin_acc_wr_reg(sa__, 0xd229,wr_val)
#define reg_rdc_MICRO_C_COM_RMI_SILICON_DEBUG_STATUS0()                                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd22a,__ERR)
#define reg_wrc_MICRO_C_COM_RMI_SILICON_DEBUG_STATUS0(wr_val)                          merlin16_shortfin_acc_wr_reg(sa__, 0xd22a,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_0()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd100,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_0(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd100,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_1()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd101,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_1(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd101,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_2()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd102,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_2(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd102,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_3()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd103,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_3(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd103,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_4()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd104,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_4(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd104,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_5()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd105,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_5(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd105,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_6()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd106,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_6(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd106,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_7()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd107,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_7(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd107,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_8()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd108,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_8(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd108,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_9()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd109,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_9(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd109,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_10()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd10a,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_10(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd10a,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_11()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd10b,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_11(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd10b,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_12()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd10c,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_12(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd10c,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_13()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd10d,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_13(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd10d,wr_val)
#define reg_rdc_PATT_GEN_COM_SEQ_14()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd10e,__ERR)
#define reg_wrc_PATT_GEN_COM_SEQ_14(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd10e,wr_val)
#define reg_rdc_PLL_CAL_COM_CTL_0()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd120,__ERR)
#define reg_wrc_PLL_CAL_COM_CTL_0(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd120,wr_val)
#define reg_rdc_PLL_CAL_COM_CTL_1()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd121,__ERR)
#define reg_wrc_PLL_CAL_COM_CTL_1(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd121,wr_val)
#define reg_rdc_PLL_CAL_COM_CTL_2()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd122,__ERR)
#define reg_wrc_PLL_CAL_COM_CTL_2(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd122,wr_val)
#define reg_rdc_PLL_CAL_COM_CTL_3()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd123,__ERR)
#define reg_wrc_PLL_CAL_COM_CTL_3(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd123,wr_val)
#define reg_rdc_PLL_CAL_COM_CTL_4()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd124,__ERR)
#define reg_wrc_PLL_CAL_COM_CTL_4(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd124,wr_val)
#define reg_rdc_PLL_CAL_COM_CTL_5()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd125,__ERR)
#define reg_wrc_PLL_CAL_COM_CTL_5(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd125,wr_val)
#define reg_rdc_PLL_CAL_COM_CTL_6()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd126,__ERR)
#define reg_wrc_PLL_CAL_COM_CTL_6(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd126,wr_val)
#define reg_rdc_PLL_CAL_COM_STS_0()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd128,__ERR)
#define reg_wrc_PLL_CAL_COM_STS_0(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd128,wr_val)
#define reg_rdc_PLL_CAL_COM_STS_1()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd129,__ERR)
#define reg_wrc_PLL_CAL_COM_STS_1(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd129,wr_val)
#define reg_rdc_PLL_CAL_COM_STS_2()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd12a,__ERR)
#define reg_wrc_PLL_CAL_COM_STS_2(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd12a,wr_val)
#define reg_rdc_PLL_CAL_COM_STS_3()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd12b,__ERR)
#define reg_wrc_PLL_CAL_COM_STS_3(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd12b,wr_val)
#define reg_rdc_PLL_CAL_COM_STS_4()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd12c,__ERR)
#define reg_wrc_PLL_CAL_COM_STS_4(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd12c,wr_val)
#define reg_rdc_PLL_CAL_COM_STS_5()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd12d,__ERR)
#define reg_wrc_PLL_CAL_COM_STS_5(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd12d,wr_val)
#define reg_rdc_PLL_CAL_COM_STS_6()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd12e,__ERR)
#define reg_wrc_PLL_CAL_COM_STS_6(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd12e,wr_val)
#define reg_rd_RX_CKRST_CTRL_RX_LANE_CLK_RESET_N_POWERDOWN_CONTROL()                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd161,__ERR)
#define reg_wr_RX_CKRST_CTRL_RX_LANE_CLK_RESET_N_POWERDOWN_CONTROL(wr_val)             merlin16_shortfin_acc_wr_reg(sa__, 0xd161,wr_val)
#define reg_rd_RX_CKRST_CTRL_RX_CLOCK_N_RESET_DEBUG_CONTROL()                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd167,__ERR)
#define reg_wr_RX_CKRST_CTRL_RX_CLOCK_N_RESET_DEBUG_CONTROL(wr_val)                    merlin16_shortfin_acc_wr_reg(sa__, 0xd167,wr_val)
#define reg_rd_RX_CKRST_CTRL_RX_LANE_DEBUG_RESET_CONTROL()                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd164,__ERR)
#define reg_wr_RX_CKRST_CTRL_RX_LANE_DEBUG_RESET_CONTROL(wr_val)                       merlin16_shortfin_acc_wr_reg(sa__, 0xd164,wr_val)
#define reg_rd_RX_CKRST_CTRL_RX_LANE_AFE_RESET_PWRDWN_CONTROL_CONTROL()                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd162,__ERR)
#define reg_wr_RX_CKRST_CTRL_RX_LANE_AFE_RESET_PWRDWN_CONTROL_CONTROL(wr_val)          merlin16_shortfin_acc_wr_reg(sa__, 0xd162,wr_val)
#define reg_rd_RX_CKRST_CTRL_RX_LANE_RESET_N_PWRDN_PIN_KILL_CONTROL()                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd163,__ERR)
#define reg_wr_RX_CKRST_CTRL_RX_LANE_RESET_N_PWRDN_PIN_KILL_CONTROL(wr_val)            merlin16_shortfin_acc_wr_reg(sa__, 0xd163,wr_val)
#define reg_rd_RX_CKRST_CTRL_RX_PMD_LANE_MODE_STATUS()                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd168,__ERR)
#define reg_wr_RX_CKRST_CTRL_RX_PMD_LANE_MODE_STATUS(wr_val)                           merlin16_shortfin_acc_wr_reg(sa__, 0xd168,wr_val)
#define reg_rd_RX_CKRST_CTRL_RX_AFE_RESET_PWRDN_OSR_MODE_PIN_STATUS()                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd16c,__ERR)
#define reg_wr_RX_CKRST_CTRL_RX_AFE_RESET_PWRDN_OSR_MODE_PIN_STATUS(wr_val)            merlin16_shortfin_acc_wr_reg(sa__, 0xd16c,wr_val)
#define reg_rd_RXCOM_CKRST_CTRL_RXCOM_OSR_MODE_CONTROL()                               _merlin16_shortfin_pmd_rde_reg(sa__, 0xd180,__ERR)
#define reg_wr_RXCOM_CKRST_CTRL_RXCOM_OSR_MODE_CONTROL(wr_val)                         merlin16_shortfin_acc_wr_reg(sa__, 0xd180,wr_val)
#define reg_rd_RXCOM_CKRST_CTRL_RXCOM_LANE_CLK_RESET_N_POWERDOWN_CONTROL()             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd181,__ERR)
#define reg_wr_RXCOM_CKRST_CTRL_RXCOM_LANE_CLK_RESET_N_POWERDOWN_CONTROL(wr_val)       merlin16_shortfin_acc_wr_reg(sa__, 0xd181,wr_val)
#define reg_rd_RXCOM_CKRST_CTRL_RXCOM_LN_S_RSTB_CONTROL()                              _merlin16_shortfin_pmd_rde_reg(sa__, 0xd18e,__ERR)
#define reg_wr_RXCOM_CKRST_CTRL_RXCOM_LN_S_RSTB_CONTROL(wr_val)                        merlin16_shortfin_acc_wr_reg(sa__, 0xd18e,wr_val)
...
#define reg_wr_RXCOM_CKRST_CTRL_RXCOM_LANE_RESET_N_PWRDN_PIN_KILL_CONTROL(wr_val)      merlin16_shortfin_acc_wr_reg(sa__, 0xd183,wr_val)
#define reg_rd_RXCOM_CKRST_CTRL_RXCOM_UC_ACK_LANE_CONTROL()                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd185,__ERR)
#define reg_wr_RXCOM_CKRST_CTRL_RXCOM_UC_ACK_LANE_CONTROL(wr_val)                      merlin16_shortfin_acc_wr_reg(sa__, 0xd185,wr_val)
#define reg_rd_RXCOM_CKRST_CTRL_RXCOM_LANE_DP_RESET_STATE_STATUS()                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd189,__ERR)
#define reg_wr_RXCOM_CKRST_CTRL_RXCOM_LANE_DP_RESET_STATE_STATUS(wr_val)               merlin16_shortfin_acc_wr_reg(sa__, 0xd189,wr_val)
#define reg_rd_RXCOM_CKRST_CTRL_RXCOM_LANE_REG_RESET_OCCURRED_CONTROL()                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd186,__ERR)
#define reg_wr_RXCOM_CKRST_CTRL_RXCOM_LANE_REG_RESET_OCCURRED_CONTROL(wr_val)          merlin16_shortfin_acc_wr_reg(sa__, 0xd186,wr_val)
#define reg_rd_RXCOM_CKRST_CTRL_RXCOM_OSR_MODE_STATUS_MC_MASK()                        _merlin16_shortfin_pmd_rde_reg(sa__, 0xd18b,__ERR)
#define reg_wr_RXCOM_CKRST_CTRL_RXCOM_OSR_MODE_STATUS_MC_MASK(wr_val)                  merlin16_shortfin_acc_wr_reg(sa__, 0xd18b,wr_val)
...
#define reg_wr_RXCOM_CKRST_CTRL_RXCOM_AFE_RESET_PWRDN_OSR_MODE_PIN_STATUS(wr_val)      merlin16_shortfin_acc_wr_reg(sa__, 0xd18c,wr_val)
#define reg_rd_RXTXCOM_CKRST_CTRL_RXTXCOM_OSR_MODE_CONTROL()                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd080,__ERR)
#define reg_wr_RXTXCOM_CKRST_CTRL_RXTXCOM_OSR_MODE_CONTROL(wr_val)                     merlin16_shortfin_acc_wr_reg(sa__, 0xd080,wr_val)
...
#define reg_wr_RXTXCOM_CKRST_CTRL_RXTXCOM_LANE_CLK_RESET_N_POWERDOWN_CONTROL(wr_val)   merlin16_shortfin_acc_wr_reg(sa__, 0xd081,wr_val)
#define reg_rd_RXTXCOM_CKRST_CTRL_RXTXCOM_LN_S_RSTB_CONTROL()                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd08e,__ERR)
#define reg_wr_RXTXCOM_CKRST_CTRL_RXTXCOM_LN_S_RSTB_CONTROL(wr_val)                    merlin16_shortfin_acc_wr_reg(sa__, 0xd08e,wr_val)
...
#define reg_wr_RXTXCOM_CKRST_CTRL_RXTXCOM_LANE_RESET_N_PWRDN_PIN_KILL_CONTROL(wr_val)  merlin16_shortfin_acc_wr_reg(sa__, 0xd083,wr_val)
#define reg_rd_RXTXCOM_CKRST_CTRL_RXTXCOM_UC_ACK_LANE_CONTROL()                        _merlin16_shortfin_pmd_rde_reg(sa__, 0xd085,__ERR)
#define reg_wr_RXTXCOM_CKRST_CTRL_RXTXCOM_UC_ACK_LANE_CONTROL(wr_val)                  merlin16_shortfin_acc_wr_reg(sa__, 0xd085,wr_val)
#define reg_rd_RXTXCOM_CKRST_CTRL_RXTXCOM_LANE_DP_RESET_STATE_STATUS()                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd089,__ERR)
#define reg_wr_RXTXCOM_CKRST_CTRL_RXTXCOM_LANE_DP_RESET_STATE_STATUS(wr_val)           merlin16_shortfin_acc_wr_reg(sa__, 0xd089,wr_val)
...
#define reg_wr_RXTXCOM_CKRST_CTRL_RXTXCOM_LANE_REG_RESET_OCCURRED_CONTROL(wr_val)      merlin16_shortfin_acc_wr_reg(sa__, 0xd086,wr_val)
#define reg_rd_RXTXCOM_CKRST_CTRL_RXTXCOM_OSR_MODE_STATUS_MC_MASK()                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd08b,__ERR)
#define reg_wr_RXTXCOM_CKRST_CTRL_RXTXCOM_OSR_MODE_STATUS_MC_MASK(wr_val)              merlin16_shortfin_acc_wr_reg(sa__, 0xd08b,wr_val)
...
#define reg_wr_RXTXCOM_CKRST_CTRL_RXTXCOM_AFE_RESET_PWRDN_OSR_MODE_PIN_STATUS(wr_val)  merlin16_shortfin_acc_wr_reg(sa__, 0xd08c,wr_val)
#define reg_rd_SIGDET_SDCTRL_0()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0c0,__ERR)
#define reg_wr_SIGDET_SDCTRL_0(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd0c0,wr_val)
#define reg_rd_SIGDET_SDCTRL_1()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0c1,__ERR)
#define reg_wr_SIGDET_SDCTRL_1(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd0c1,wr_val)
#define reg_rd_SIGDET_SDCTRL_2()                                                       _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0c2,__ERR)
#define reg_wr_SIGDET_SDCTRL_2(wr_val)                                                 merlin16_shortfin_acc_wr_reg(sa__, 0xd0c2,wr_val)
#define reg_rd_SIGDET_SDSTATUS_0()                                                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0c8,__ERR)
#define reg_wr_SIGDET_SDSTATUS_0(wr_val)                                               merlin16_shortfin_acc_wr_reg(sa__, 0xd0c8,wr_val)
#define reg_rd_SIGDET_SDSTATUS_1()                                                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0c9,__ERR)
#define reg_wr_SIGDET_SDSTATUS_1(wr_val)                                               merlin16_shortfin_acc_wr_reg(sa__, 0xd0c9,wr_val)
#define reg_rd_SIGDET_SDSTATUS_2()                                                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0ca,__ERR)
#define reg_wr_SIGDET_SDSTATUS_2(wr_val)                                               merlin16_shortfin_acc_wr_reg(sa__, 0xd0ca,wr_val)
#define reg_rd_SIGDET_SDSTATUS_3()                                                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0cb,__ERR)
#define reg_wr_SIGDET_SDSTATUS_3(wr_val)                                               merlin16_shortfin_acc_wr_reg(sa__, 0xd0cb,wr_val)
#define reg_rd_SIGDET_SDSTATUS_4()                                                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0cc,__ERR)
#define reg_wr_SIGDET_SDSTATUS_4(wr_val)                                               merlin16_shortfin_acc_wr_reg(sa__, 0xd0cc,wr_val)
#define reg_rd_TLB_RX_PRBS_CHK_CONFIG()                                                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0d1,__ERR)
#define reg_wr_TLB_RX_PRBS_CHK_CONFIG(wr_val)                                          merlin16_shortfin_acc_wr_reg(sa__, 0xd0d1,wr_val)
#define reg_rd_TLB_RX_PRBS_CHK_CNT_CONFIG()                                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0d0,__ERR)
#define reg_wr_TLB_RX_PRBS_CHK_CNT_CONFIG(wr_val)                                      merlin16_shortfin_acc_wr_reg(sa__, 0xd0d0,wr_val)
#define reg_rd_TLB_RX_DIG_LPBK_CONFIG()                                                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0d2,__ERR)
#define reg_wr_TLB_RX_DIG_LPBK_CONFIG(wr_val)                                          merlin16_shortfin_acc_wr_reg(sa__, 0xd0d2,wr_val)
#define reg_rd_TLB_RX_RXMISC_CONFIG()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0d3,__ERR)
#define reg_wr_TLB_RX_RXMISC_CONFIG(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd0d3,wr_val)
#define reg_rd_TLB_RX_PRBS_CHK_EN_TIMER_CONTROL()                                      _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0d4,__ERR)
#define reg_wr_TLB_RX_PRBS_CHK_EN_TIMER_CONTROL(wr_val)                                merlin16_shortfin_acc_wr_reg(sa__, 0xd0d4,wr_val)
#define reg_rd_TLB_RX_DIG_LPBK_PD_STATUS()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0d8,__ERR)
#define reg_wr_TLB_RX_DIG_LPBK_PD_STATUS(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd0d8,wr_val)
#define reg_rd_TLB_RX_PRBS_CHK_LOCK_STATUS()                                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0d9,__ERR)
#define reg_wr_TLB_RX_PRBS_CHK_LOCK_STATUS(wr_val)                                     merlin16_shortfin_acc_wr_reg(sa__, 0xd0d9,wr_val)
#define reg_rd_TLB_RX_PRBS_CHK_ERR_CNT_MSB_STATUS()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0da,__ERR)
#define reg_wr_TLB_RX_PRBS_CHK_ERR_CNT_MSB_STATUS(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd0da,wr_val)
#define reg_rd_TLB_RX_PRBS_CHK_ERR_CNT_LSB_STATUS()                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0db,__ERR)
#define reg_wr_TLB_RX_PRBS_CHK_ERR_CNT_LSB_STATUS(wr_val)                              merlin16_shortfin_acc_wr_reg(sa__, 0xd0db,wr_val)
#define reg_rd_TLB_RX_PMD_RX_LOCK_STATUS()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0dc,__ERR)
#define reg_wr_TLB_RX_PMD_RX_LOCK_STATUS(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd0dc,wr_val)
#define reg_rd_TLB_RX_DBG_PMD_RX_LOCK_STATUS()                                         _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0d6,__ERR)
#define reg_wr_TLB_RX_DBG_PMD_RX_LOCK_STATUS(wr_val)                                   merlin16_shortfin_acc_wr_reg(sa__, 0xd0d6,wr_val)
#define reg_rd_TLB_RX_UC_PMD_RX_LOCK_STATUS()                                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0d7,__ERR)
#define reg_wr_TLB_RX_UC_PMD_RX_LOCK_STATUS(wr_val)                                    merlin16_shortfin_acc_wr_reg(sa__, 0xd0d7,wr_val)
#define reg_rd_TLB_RX_PRBS_CHK_BURST_ERR_CNT_STATUS()                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0d5,__ERR)
#define reg_wr_TLB_RX_PRBS_CHK_BURST_ERR_CNT_STATUS(wr_val)                            merlin16_shortfin_acc_wr_reg(sa__, 0xd0d5,wr_val)
#define reg_rd_TLB_TX_PATT_GEN_CONFIG()                                                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0e0,__ERR)
#define reg_wr_TLB_TX_PATT_GEN_CONFIG(wr_val)                                          merlin16_shortfin_acc_wr_reg(sa__, 0xd0e0,wr_val)
#define reg_rd_TLB_TX_PRBS_GEN_CONFIG()                                                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0e1,__ERR)
#define reg_wr_TLB_TX_PRBS_GEN_CONFIG(wr_val)                                          merlin16_shortfin_acc_wr_reg(sa__, 0xd0e1,wr_val)
#define reg_rd_TLB_TX_RMT_LPBK_CONFIG()                                                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0e2,__ERR)
#define reg_wr_TLB_TX_RMT_LPBK_CONFIG(wr_val)                                          merlin16_shortfin_acc_wr_reg(sa__, 0xd0e2,wr_val)
#define reg_rd_TLB_TX_TXMISC_CONFIG()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0e3,__ERR)
#define reg_wr_TLB_TX_TXMISC_CONFIG(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd0e3,wr_val)
#define reg_rd_TLB_TX_RMT_LPBK_PD_STATUS()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd0e8,__ERR)
#define reg_wr_TLB_TX_RMT_LPBK_PD_STATUS(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd0e8,wr_val)
#define reg_rd_TX_CKRST_CTRL_TX_LANE_CLK_RESET_N_POWERDOWN_CONTROL()                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd171,__ERR)
#define reg_wr_TX_CKRST_CTRL_TX_LANE_CLK_RESET_N_POWERDOWN_CONTROL(wr_val)             merlin16_shortfin_acc_wr_reg(sa__, 0xd171,wr_val)
#define reg_rd_TX_CKRST_CTRL_TX_CLOCK_N_RESET_DEBUG_CONTROL()                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd177,__ERR)
#define reg_wr_TX_CKRST_CTRL_TX_CLOCK_N_RESET_DEBUG_CONTROL(wr_val)                    merlin16_shortfin_acc_wr_reg(sa__, 0xd177,wr_val)
#define reg_rd_TX_CKRST_CTRL_TX_LANE_DEBUG_RESET_CONTROL()                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd174,__ERR)
#define reg_wr_TX_CKRST_CTRL_TX_LANE_DEBUG_RESET_CONTROL(wr_val)                       merlin16_shortfin_acc_wr_reg(sa__, 0xd174,wr_val)
#define reg_rd_TX_CKRST_CTRL_TX_LANE_AFE_RESET_PWRDWN_CONTROL_CONTROL()                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd172,__ERR)
#define reg_wr_TX_CKRST_CTRL_TX_LANE_AFE_RESET_PWRDWN_CONTROL_CONTROL(wr_val)          merlin16_shortfin_acc_wr_reg(sa__, 0xd172,wr_val)
#define reg_rd_TX_CKRST_CTRL_TX_LANE_RESET_N_PWRDN_PIN_KILL_CONTROL()                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd173,__ERR)
#define reg_wr_TX_CKRST_CTRL_TX_LANE_RESET_N_PWRDN_PIN_KILL_CONTROL(wr_val)            merlin16_shortfin_acc_wr_reg(sa__, 0xd173,wr_val)
#define reg_rd_TX_CKRST_CTRL_TX_AFE_RESET_PWRDN_OSR_MODE_PIN_STATUS()                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd17c,__ERR)
#define reg_wr_TX_CKRST_CTRL_TX_AFE_RESET_PWRDN_OSR_MODE_PIN_STATUS(wr_val)            merlin16_shortfin_acc_wr_reg(sa__, 0xd17c,wr_val)
#define reg_rd_TX_CKRST_CTRL_TX_CLOCK_N_RESET_MISC_CONTROL()                           _merlin16_shortfin_pmd_rde_reg(sa__, 0xd17d,__ERR)
#define reg_wr_TX_CKRST_CTRL_TX_CLOCK_N_RESET_MISC_CONTROL(wr_val)                     merlin16_shortfin_acc_wr_reg(sa__, 0xd17d,wr_val)
#define reg_rd_TX_FED_TXFIR_TAP_CONTROL0()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd110,__ERR)
#define reg_wr_TX_FED_TXFIR_TAP_CONTROL0(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd110,wr_val)
#define reg_rd_TX_FED_MISC_CONTROL0()                                                  _merlin16_shortfin_pmd_rde_reg(sa__, 0xd111,__ERR)
#define reg_wr_TX_FED_MISC_CONTROL0(wr_val)                                            merlin16_shortfin_acc_wr_reg(sa__, 0xd111,wr_val)
#define reg_rd_TX_FED_MISC_STATUS0()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd112,__ERR)
#define reg_wr_TX_FED_MISC_STATUS0(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd112,wr_val)
#define reg_rd_TX_FED_MICRO_CONTROL0()                                                 _merlin16_shortfin_pmd_rde_reg(sa__, 0xd113,__ERR)
#define reg_wr_TX_FED_MICRO_CONTROL0(wr_val)                                           merlin16_shortfin_acc_wr_reg(sa__, 0xd113,wr_val)
#define reg_rd_TX_FED_POST2_AFE_CONTROL0()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd11b,__ERR)
#define reg_wr_TX_FED_POST2_AFE_CONTROL0(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd11b,wr_val)
#define reg_rd_TX_FED_POST1_AFE_CONTROL0()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd11c,__ERR)
#define reg_wr_TX_FED_POST1_AFE_CONTROL0(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd11c,wr_val)
#define reg_rd_TX_FED_POST1PRE_AFE_CONTROL0()                                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd11d,__ERR)
#define reg_wr_TX_FED_POST1PRE_AFE_CONTROL0(wr_val)                                    merlin16_shortfin_acc_wr_reg(sa__, 0xd11d,wr_val)
#define reg_rd_TX_FED_DC_LEVEL_AFE_CONTROL0()                                          _merlin16_shortfin_pmd_rde_reg(sa__, 0xd11e,__ERR)
#define reg_wr_TX_FED_DC_LEVEL_AFE_CONTROL0(wr_val)                                    merlin16_shortfin_acc_wr_reg(sa__, 0xd11e,wr_val)
#define reg_rd_TX_PI_TXPICONTROL_0()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd070,__ERR)
#define reg_wr_TX_PI_TXPICONTROL_0(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd070,wr_val)
#define reg_rd_TX_PI_TXPICONTROL_1()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd071,__ERR)
#define reg_wr_TX_PI_TXPICONTROL_1(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd071,wr_val)
#define reg_rd_TX_PI_TXPICONTROL_2()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd072,__ERR)
#define reg_wr_TX_PI_TXPICONTROL_2(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd072,wr_val)
#define reg_rd_TX_PI_TXPICONTROL_3()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd073,__ERR)
#define reg_wr_TX_PI_TXPICONTROL_3(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd073,wr_val)
#define reg_rd_TX_PI_TXPICONTROL_4()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd074,__ERR)
#define reg_wr_TX_PI_TXPICONTROL_4(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd074,wr_val)
#define reg_rd_TX_PI_TXPICONTROL_5()                                                   _merlin16_shortfin_pmd_rde_reg(sa__, 0xd075,__ERR)
#define reg_wr_TX_PI_TXPICONTROL_5(wr_val)                                             merlin16_shortfin_acc_wr_reg(sa__, 0xd075,wr_val)
#define reg_rd_TX_PI_TXPISTATUS_0()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd078,__ERR)
#define reg_wr_TX_PI_TXPISTATUS_0(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd078,wr_val)
#define reg_rd_TX_PI_TXPISTATUS_1()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd079,__ERR)
#define reg_wr_TX_PI_TXPISTATUS_1(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd079,wr_val)
#define reg_rd_TX_PI_TXPISTATUS_2()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd07a,__ERR)
#define reg_wr_TX_PI_TXPISTATUS_2(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd07a,wr_val)
#define reg_rd_TX_PI_TXPISTATUS_3()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd07b,__ERR)
#define reg_wr_TX_PI_TXPISTATUS_3(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd07b,wr_val)
#define reg_rd_TX_PI_TXPISTATUS_4()                                                    _merlin16_shortfin_pmd_rde_reg(sa__, 0xd07c,__ERR)
#define reg_wr_TX_PI_TXPISTATUS_4(wr_val)                                              merlin16_shortfin_acc_wr_reg(sa__, 0xd07c,wr_val)
#define reg_rd_TX_PI_TX_FIFO_OVFB_STATUS()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd07d,__ERR)
#define reg_wr_TX_PI_TX_FIFO_OVFB_STATUS(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd07d,wr_val)
#define reg_rd_TXCOM_CKRST_CTRL_TXCOM_OSR_MODE_CONTROL()                               _merlin16_shortfin_pmd_rde_reg(sa__, 0xd190,__ERR)
#define reg_wr_TXCOM_CKRST_CTRL_TXCOM_OSR_MODE_CONTROL(wr_val)                         merlin16_shortfin_acc_wr_reg(sa__, 0xd190,wr_val)
#define reg_rd_TXCOM_CKRST_CTRL_TXCOM_LANE_CLK_RESET_N_POWERDOWN_CONTROL()             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd191,__ERR)
#define reg_wr_TXCOM_CKRST_CTRL_TXCOM_LANE_CLK_RESET_N_POWERDOWN_CONTROL(wr_val)       merlin16_shortfin_acc_wr_reg(sa__, 0xd191,wr_val)
#define reg_rd_TXCOM_CKRST_CTRL_TXCOM_LN_S_RSTB_CONTROL()                              _merlin16_shortfin_pmd_rde_reg(sa__, 0xd19e,__ERR)
#define reg_wr_TXCOM_CKRST_CTRL_TXCOM_LN_S_RSTB_CONTROL(wr_val)                        merlin16_shortfin_acc_wr_reg(sa__, 0xd19e,wr_val)
...
#define reg_wr_TXCOM_CKRST_CTRL_TXCOM_LANE_RESET_N_PWRDN_PIN_KILL_CONTROL(wr_val)      merlin16_shortfin_acc_wr_reg(sa__, 0xd193,wr_val)
#define reg_rd_TXCOM_CKRST_CTRL_TXCOM_UC_ACK_LANE_CONTROL()                            _merlin16_shortfin_pmd_rde_reg(sa__, 0xd195,__ERR)
#define reg_wr_TXCOM_CKRST_CTRL_TXCOM_UC_ACK_LANE_CONTROL(wr_val)                      merlin16_shortfin_acc_wr_reg(sa__, 0xd195,wr_val)
#define reg_rd_TXCOM_CKRST_CTRL_TXCOM_LANE_DP_RESET_STATE_STATUS()                     _merlin16_shortfin_pmd_rde_reg(sa__, 0xd199,__ERR)
#define reg_wr_TXCOM_CKRST_CTRL_TXCOM_LANE_DP_RESET_STATE_STATUS(wr_val)               merlin16_shortfin_acc_wr_reg(sa__, 0xd199,wr_val)
#define reg_rd_TXCOM_CKRST_CTRL_TXCOM_LANE_REG_RESET_OCCURRED_CONTROL()                _merlin16_shortfin_pmd_rde_reg(sa__, 0xd196,__ERR)
#define reg_wr_TXCOM_CKRST_CTRL_TXCOM_LANE_REG_RESET_OCCURRED_CONTROL(wr_val)          merlin16_shortfin_acc_wr_reg(sa__, 0xd196,wr_val)
#define reg_rd_TXCOM_CKRST_CTRL_TXCOM_OSR_MODE_STATUS_MC_MASK()                        _merlin16_shortfin_pmd_rde_reg(sa__, 0xd19b,__ERR)
#define reg_wr_TXCOM_CKRST_CTRL_TXCOM_OSR_MODE_STATUS_MC_MASK(wr_val)                  merlin16_shortfin_acc_wr_reg(sa__, 0xd19b,wr_val)
...
#define reg_wr_TXCOM_CKRST_CTRL_TXCOM_AFE_RESET_PWRDN_OSR_MODE_PIN_STATUS(wr_val)      merlin16_shortfin_acc_wr_reg(sa__, 0xd19c,wr_val)
#define reg_rdc_TX_COM_CONTROL0_REGISTER()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd130,__ERR)
#define reg_wrc_TX_COM_CONTROL0_REGISTER(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd130,wr_val)
#define reg_rdc_TX_COM_CONTROL1_REGISTER()                                             _merlin16_shortfin_pmd_rde_reg(sa__, 0xd131,__ERR)
#define reg_wrc_TX_COM_CONTROL1_REGISTER(wr_val)                                       merlin16_shortfin_acc_wr_reg(sa__, 0xd131,wr_val)
