...
struct merlin16_shortfin_prbs_chk_hw_timer_ctrl_st {
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shortfin_get_prbs_chk_hw_timer_ctrl(srds_access_t *sa__, struct merlin16_shortfin_prbs_chk_hw_timer_ctrl_st * const prbs_chk_hw_timer_ctrl_bak);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shortfin_set_prbs_chk_hw_timer_ctrl(srds_access_t *sa__, struct merlin16_shortfin_prbs_chk_hw_timer_ctrl_st const * const prbs_chk_hw_timer_ctrl_bak);
