...
/**************************************************************************************
 **************************************************************************************
 *  File Name     :  merlin16_shortfin_prbs.c                                                *
...
err_code_t merlin16_shortfin_config_prbs_chk_hw_timer(srds_access_t *sa__, uint16_t time_ms, uint16_t *time_ms_adjusted) {
    ...
    struct merlin16_shortfin_prbs_chk_hw_timer_ctrl_st prbs_chk_hw_timer_ctrl;
    USR_MEMSET(&prbs_chk_hw_timer_ctrl, 0, sizeof(struct merlin16_shortfin_prbs_chk_hw_timer_ctrl_st));
