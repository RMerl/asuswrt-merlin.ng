...
static inline int phy_dsl_serdes_is_cl49_pcs(phy_dev_t *phy_dev)
{
    int mode;

    mode = (1<<phy_dev_current_inter_phy_type_get(phy_dev));
    if (mode & (INTER_PHY_TYPE_USXGMII_M | INTER_PHY_TYPE_USXGMII_MP_M | INTER_PHY_TYPE_10GBASE_R_M |
            INTER_PHY_TYPE_5GBASE_R_M |INTER_PHY_TYPE_2P5GBASE_R_M | INTER_PHY_TYPE_1GBASE_R_M))
        return 1;
