...
#define XPORT_XLMAC_INDIRECT_WRITE(i,b,r,v) WRITE_64(RU_BLK(b).addr[i] + RU_REG_OFFSET(b,r),v)
#define XPORT_XLMAC_INDIRECT_READ(i,b,r,v)  READ_64(RU_BLK(b).addr[i] + RU_REG_OFFSET(b,r),v)
