...
int ag_drv_xport_xlmac_reg_rmt_lpbk_cntrl_set(uint8_t dummy_xlmac_id, const xport_xlmac_reg_rmt_lpbk_cntrl *rmt_lpbk_cntrl)
{
...
int ag_drv_xport_xlmac_reg_rmt_lpbk_cntrl_get(uint8_t dummy_xlmac_id, xport_xlmac_reg_rmt_lpbk_cntrl *rmt_lpbk_cntrl)
{
    uint32_t reg_rmt_lpbk_cntrl=0;
