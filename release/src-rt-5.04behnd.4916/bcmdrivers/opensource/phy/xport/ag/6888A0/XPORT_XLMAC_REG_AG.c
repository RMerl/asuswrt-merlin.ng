...
/******************************************************************************
 * Field: XPORT_XLMAC_REG_MPD_CFG_RESERVED0
 ******************************************************************************/
const ru_field_rec XPORT_XLMAC_REG_MPD_CFG_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    XPORT_XLMAC_REG_MPD_CFG_RESERVED0_FIELD_MASK,
    0,
    XPORT_XLMAC_REG_MPD_CFG_RESERVED0_FIELD_WIDTH,
    XPORT_XLMAC_REG_MPD_CFG_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_XLMAC_REG_MPD_CFG_RX_DIS
 ******************************************************************************/
const ru_field_rec XPORT_XLMAC_REG_MPD_CFG_RX_DIS_FIELD =
{
    "RX_DIS",
#if RU_INCLUDE_DESC
    "",
    "1=> RXDV signal toward the system, for the MPD monitoring port (selected by %%fref MPD_CFG.RXPORT_ID%%), will be gated off (i.e. will be 0) when MPD_EN is 1.",
#endif
    XPORT_XLMAC_REG_MPD_CFG_RX_DIS_FIELD_MASK,
    0,
    XPORT_XLMAC_REG_MPD_CFG_RX_DIS_FIELD_WIDTH,
    XPORT_XLMAC_REG_MPD_CFG_RX_DIS_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_XLMAC_REG_MPD_CFG_RESERVED1
 ******************************************************************************/
const ru_field_rec XPORT_XLMAC_REG_MPD_CFG_RESERVED1_FIELD =
{
    "RESERVED1",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    XPORT_XLMAC_REG_MPD_CFG_RESERVED1_FIELD_MASK,
    0,
    XPORT_XLMAC_REG_MPD_CFG_RESERVED1_FIELD_WIDTH,
    XPORT_XLMAC_REG_MPD_CFG_RESERVED1_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_XLMAC_REG_MPD_CFG_RXPORT_ID
 ******************************************************************************/
const ru_field_rec XPORT_XLMAC_REG_MPD_CFG_RXPORT_ID_FIELD =
{
    "RXPORT_ID",
#if RU_INCLUDE_DESC
    "",
...
#endif
    XPORT_XLMAC_REG_MPD_CFG_RXPORT_ID_FIELD_MASK,
    0,
    XPORT_XLMAC_REG_MPD_CFG_RXPORT_ID_FIELD_WIDTH,
    XPORT_XLMAC_REG_MPD_CFG_RXPORT_ID_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Register: XPORT_XLMAC_REG_MPD_CFG
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPORT_XLMAC_REG_MPD_CFG_FIELDS[] =
{
    &XPORT_XLMAC_REG_MPD_CFG_RESERVED0_FIELD,
    &XPORT_XLMAC_REG_MPD_CFG_RX_DIS_FIELD,
    &XPORT_XLMAC_REG_MPD_CFG_RESERVED1_FIELD,
    &XPORT_XLMAC_REG_MPD_CFG_RXPORT_ID_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPORT_XLMAC_REG_MPD_CFG_REG = 
{
    "MPD_CFG",
#if RU_INCLUDE_DESC
    "XLMAC Magic Packet Detection Configuration Register",
    "",
#endif
    XPORT_XLMAC_REG_MPD_CFG_REG_OFFSET,
    0,
    0,
    188,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    4,
    XPORT_XLMAC_REG_MPD_CFG_FIELDS,
#endif /* RU_INCLUDE_FIELD_DB */
    ru_reg_size_32
};
