...
static xport_rx_stats_s rxCountersLast[XPORT_NUM_OF_XLMACS*XPORT_NUM_OF_PORTS_PER_XLMAC];
static xport_tx_stats_s txCountersLast[XPORT_NUM_OF_XLMACS*XPORT_NUM_OF_PORTS_PER_XLMAC];
#define XPORT_CURRENT_COUNTERS(portid, cur, last, bits, param) \
    do{\
        uint64_t  paramCurrent = cur->param; \
        cur->param = (cur->param - last[portid].param) & (((uint64_t)1<<bits)-1); \
        last[portid].param   = paramCurrent; \
    }while(0)
...
int xport_stats_get_rx(uint32_t portid, xport_rx_stats_s *rx_stats)
{
    ...
    rc = rc ? rc :ag_drv_xport_mib_core_grxlpi_get(portid,&cnt32);  if (!rc) rx_stats->GRXLPI = (uint64_t) cnt32;
    rc = rc ? rc :ag_drv_xport_mib_core_grxdlpi_get(portid,&cnt32); if (!rc) rx_stats->GRXDLPI = (uint64_t) cnt32;
    ...
    if (!rc)
    {
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRX64);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRX127);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRX255);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRX511);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRX1023);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRX1518);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRX1522);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRX2047);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRX4095);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRX9216);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRX16383);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXPKT);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXUCA);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXMCA);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXBCA);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXFCS);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXCF);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXPP);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXPF);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXUDA);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXWSA);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXALN);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXFLR);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXFRERR);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXFCR);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXOVR);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXJBR);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXMTUE);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXMCRC);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXPRM);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXVLN);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXDVLN);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXTRFU);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXPOK);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXSCHCRC);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 48, GRXBYT);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXRPKT);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXUND);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXFRG);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 48, GRXRBYT);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 32, GRXLPI);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 32, GRXDLPI);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXPTLLFC);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXLTLLFC);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXLLFCFCS);
        XPORT_CURRENT_COUNTERS(portid, rx_stats, rxCountersLast, 40, GRXUO);
    }
    return rc;
}
...
int xport_stats_get_tx(uint32_t portid, xport_tx_stats_s *tx_stats)
{
    ...
    rc = rc ? rc :ag_drv_xport_mib_core_gtxlpi_get(portid, &cnt32);  if (!rc) tx_stats->GTXLPI = (uint64_t) cnt32;
    rc = rc ? rc :ag_drv_xport_mib_core_gtxdlpi_get(portid, &cnt32); if (!rc) tx_stats->GTXDLPI = (uint64_t) cnt32;
    rc = rc ? rc :ag_drv_xport_mib_core_gtxltllfc_get(portid, &tx_stats->GTXLTLLFC);
    
    if (!rc)
    {
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTX64);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTX127);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTX255);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTX511);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTX1023);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTX1518);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTX1522);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTX2047);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTX4095);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTX9216);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTX16383);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXPOK);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXPKT);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXUCA);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXMCA);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXBCA);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXPF);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXPFC);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXJBR);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXFCS);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXCF);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXOVR);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXDFR);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXEDF);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXSCL);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXMCL);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXLCL);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXXCL);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXFRG);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXERR);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXVLN);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXDVLN);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXRPKT);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXUFL);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXNCL);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 48, GTXBYT);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 32, GTXLPI);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 32, GTXDLPI);
        XPORT_CURRENT_COUNTERS(portid, tx_stats, txCountersLast, 40, GTXLTLLFC);
    }
    return rc;
}
...
int xport_stats_reset(uint32_t portid)
{
    ...
    memset(&rxCountersLast[portid], 0, sizeof(rxCountersLast[0]));
    memset(&txCountersLast[portid], 0, sizeof(txCountersLast[0]));
