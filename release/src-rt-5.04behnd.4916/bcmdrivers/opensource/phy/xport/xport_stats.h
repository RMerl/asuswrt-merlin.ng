...
typedef struct
{
    ...
    uint64_t    GRXBYT;   /*< Receive Byte Counter*/        // 48bit hw
    ...
    uint64_t    GRXRBYT;  /*< Receive Runt Byte Counter*/   // 48bit hw
    uint64_t    GRXLPI;   /*< RX EEE LPI Event Counter*/    // 32bit hw
    uint64_t    GRXDLPI;  /*< RX EEE LPI Duration Counte*/  // 32bit hw
...
typedef struct
{
    ...
    uint64_t    GTXBYT;   /*< Transmit Byte Counter*/       // 48bit hw
    uint64_t    GTXLPI;   /*< TX EEE LPI Event Counter*/    // 32bit hw
    uint64_t    GTXDLPI;  /*< TX EEE LPI Duration Counter*/ // 32bit hw
