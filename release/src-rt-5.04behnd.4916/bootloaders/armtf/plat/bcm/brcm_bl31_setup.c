...
extern void console_8250_register(uintptr_t baseaddr, console_t *console);
/*
...
#endif
#if defined (SMC_BASE)
  MAP_REGION_FLAT(SMC_BASE,     SMC_SIZE,    MT_DEVICE | MT_RW | MT_SECURE),
#endif
  {0}
};
...
void bl31_plat_arch_setup(void)
{
	...
	console_8250_register(UART0_BASE, &console);
#else
