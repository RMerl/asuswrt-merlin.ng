...
#define WDTIMR0_BASE		0x00000000
#define WDTIMR0_OFFSET		0x428
...
#define BIU_CPU_CTRL_PWR_ZONE_CTRL_ZONE_RESET       ((uint32)1<<BIU_CPU_CTRL_PWR_ZONE_CTRL_ZONE_RESET_SHIFT)
