...
typedef struct SCU_CTRL {
	uint32_t ctrl;			/* 0x00 */
	uint32_t cfg;			/* 0x04 */
	uint32_t pwr_sts;		/* 0x08 */
	uint32_t invalid_all;	/* 0x0c */
	uint32_t rsvd1[12];		/* 0x10 */
	uint32_t filter_start;	/* 0x40 */
	uint32_t filter_end;	/* 0x44 */
	uint32_t rsvd2[2];		/* 0x48 */
	uint32_t access_ctrl;	/* 0x50 */
	uint32_t secure_acc;	/* 0x54 */
} SCU_CTRL;

#define SCU ((volatile SCU_CTRL * const) SCU_BASE)
