...
#define UBUSIF_CFG_OOB_ERR_MASK_MASK        (0x1<< UBUSIF_CFG_OOB_ERR_MASK_SHIFT)
   ...
   uint32_t SRC_QUEUE_CTRL[4];  /* 0x08 - 0x17 */
   uint32_t REP_ARB_MODE;       /* 0x18 */
...
#define UBUSIF_REP_ARB_MODE_FIFO_MODE_MASK  (0x1<<UBUSIF_REP_ARB_MODE_FIFO_MODE_SHIFT)
   uint32_t HPQ_CFG;            /* 0x1c */
   uint32_t SCRATCH;            /* 0x20 */
   uint32_t DEBUG_R0;           /* 0x24 */
   uint32_t unused[38];         /* 0x28-0xbf */
} UBUSInterface;
...
typedef struct AXIInterface {
   ...
   uint32_t SRC_QUEUE_CTL[8]; /* 0x10 */
   uint32_t SRCID4_QUEUE_CFG; /* 0x30 */
   uint32_t SCRATCH;          /* 0x34 */
   uint32_t AXI_DEBUG[2];         /* 0x38-0x3f */
} AXIInterface;
...
#define MC_CHN_TIM_TIM3_TIM3_TZQCS_DEFAULT                         0x00000040
   ...
   uint32_t unused8[38];                  /* 0x268-0x2ff */

   uint32_t ARB_CFG;                /* 0x300 */
   uint32_t ARB_QUE_DIS[2];         /* 0x304-0x30b */
   uint32_t unused9;                /* 0x30c */
   uint32_t ARB_BUCKET_CFG_CPU_WR[4]; /* 0x310-0x31f */
   uint32_t ARB_BUCKET_CFG_CPU_RD[4]; /* 0x320-0x32f */
   uint32_t ARB_BUCKET_CFG_CPQ_RD[4]; /* 0x330-0x33f */
   uint32_t ARB_BUCKET_CFG_CPQ_WR[4]; /* 0x340-0x34f */
   uint32_t ARB_BUCKET_CFG_EDIS[4]; /* 0x350-0x35f */
   uint32_t ARB_BUCKET_CFG_UBUS[32];/* 0x360-0x3df */
   uint32_t ARB_QUEUE_PRI[3];       /* 0x3e0-0x3eb */
   uint32_t ARB_WRR_QUEUE_PRI;      /* 0x3ec */
   uint32_t ARB_RATE_OK_WEIGHT[2];  /* 0x3f0-0x3f7 */
   uint32_t ARB_RATE_FAILED_WEIGHT[2];/* 0x3f8-0x3ff */

   UBUSInterface UBUSIF0;         /* 0x400-0x4bf */
   AXIInterface AXIRIF;           /* 0x4c0-0x4ff */
   uint32_t unused10[192];          /* 0x500-0x7ff */

   EDISEngine EDIS_0;             /* 0x800 */
   uint32_t unused11[64];           /* 0x900-0x9ff */
   ...
   uint32_t STATS_MAX_LATENCY;      /* 0xa20 */
...
#define MEMC_STATS_FILTER_CFG_INTF_EDIS1       MEMC_STATS_FILTER_CFG_INTF_UNUSED
   ...
   uint32_t STATS_PROG0_MAX_LATENCY;/* 0xa68 */
   uint32_t unused12;               /* 0xa6c */
   ...
   uint32_t unused13[2];            /* 0xa88 - 0xa8c */   
   ...
   uint32_t unused14[2];            /* 0xaa8 - 0xaac */
   ...
   uint32_t unused26[31866];         /* 0xe18-0x1ffff */
