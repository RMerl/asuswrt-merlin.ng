...
#define ETHSW_QGPHY3_LED_OVRD_MASK            (1 << ETHSW_QGPHY3_LED_OVRD_SHIFT)
    uint32_t reserved_cc;                      /* 0x00cc */           //63178: crossbar_switch_ctrl not populated
    uint32_t reserved_d0[19];                  /* 0x00d0 - 0x011b */
    uint32_t rgmii_5_ctrl;                     /* 0x011c */           //63178: add rgmii_5, remove rgmii_11,12,13
...
#define ETHSW_RC_RGMII_EN                    0x01
    uint32_t rgmii_5_ib_status;                /* 0x0120 */
    uint32_t rgmii_5_rx_clk_delay_ctrl;        /* 0x0124 */
#define ETHSW_RXCLK_IDDQ                     (1<<4)
#define ETHSW_RXCLK_BYPASS                   (1<<5)
    uint32_t reserved_128[202];                 /* 0x0128 - 0x044f */
    uint32_t moca_bp_mapping_port5;            /* 0x0450*/
} EthernetSwitchReg;
