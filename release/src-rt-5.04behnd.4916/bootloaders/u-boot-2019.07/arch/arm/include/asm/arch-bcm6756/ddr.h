...
#define MC_ARB_BUCKET_CFG_CPU_WR_0_THROTTLE_DIS_SHIFT              31
	uint32_t ARB_BKT_CFG_CPU_RD[4];	/* 0x320 */
#define MC_ARB_BUCKET_CFG_CPU_RD_0_THROTTLE_DIS_SHIFT              31
	uint32_t ARB_BKT_CFG_CPQ_RD[4];	/* 0x330 */
#define MC_ARB_BUCKET_CFG_CPQ_RD_1_FILL_RATE_0_SHIFT               0
#define MC_ARB_BUCKET_CFG_CPQ_RD_1_FILL_RATE_1_SHIFT               16
	uint32_t ARB_BKT_CFG_CPQ_WR[4];	/* 0x340 */
#define MC_ARB_BUCKET_CFG_CPQ_WR_1_FILL_RATE_0_SHIFT               0
#define MC_ARB_BUCKET_CFG_CPQ_WR_1_FILL_RATE_1_SHIFT               16
