...
/* row 1 */
#define OTP_MFG_PROG_ROW               1
#define OTP_MFG_PROG_SHIFT             8
#define OTP_MFG_PROG_MASK              0xffff
...
#define	DEFINE_OTP_MAP_ROW_INITLR(__VV__)									\
	...
	{OTP_MAP_MFG_PROG, OTP_MFG_PROG_ROW, OTP_MFG_PROG_MASK, OTP_MFG_PROG_SHIFT, 1},				\
