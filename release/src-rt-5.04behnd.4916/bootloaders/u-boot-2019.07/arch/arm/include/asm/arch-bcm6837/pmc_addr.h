...
#ifndef _6837_PMC_ADDR_H
#define _6837_PMC_ADDR_H
...
#define PMB_BUS_RGPERIPH         0
#define PMB_ADDR_RGPERIPH        (5 | PMB_BUS_RGPERIPH << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_RGPERIPH       1

#define PMB_BUS_RGPERIPH_HIF     0
#define PMB_ADDR_RGPERIPH_HIF    (6 | PMB_BUS_RGPERIPH_HIF << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_RGPERIPH_HIF   1
