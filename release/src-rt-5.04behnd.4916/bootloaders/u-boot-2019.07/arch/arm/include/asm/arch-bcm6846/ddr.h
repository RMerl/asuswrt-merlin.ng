...
#define MEMC_STATS_FILTER_CFG_INTF_EDIS1       MEMC_STATS_FILTER_CFG_INTF_UNUSED
   ...
   uint32_t PhyControl[256];           /* 0x2000 */
   uint32_t PhyByteLane0Control[128];  /* 0x2400 */
   uint32_t PhyByteLane1Control[128];  /* 0x2600 */
   uint32_t PhyByteLane2Control[128];  /* 0x2800 */
   uint32_t PhyByteLane3Control[128];  /* 0x2a00 */
} MEMCControl;
