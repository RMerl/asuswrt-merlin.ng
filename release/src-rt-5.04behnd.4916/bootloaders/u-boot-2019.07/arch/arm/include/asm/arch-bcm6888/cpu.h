...
#define UBUSCCB_BASE      0x81200000
...
typedef struct UBUSCCB {
	uint32_t gen_perm_ctrl;
	uint32_t dbg_perm_ctrl;
	uint32_t psu_perm_ctrl;
	uint32_t cap_perm_ctrl;
}UBUSCCB;
#define CCB ((volatile UBUSCCB * const) UBUSCCB_BASE)
...
typedef struct BIUCFG_Ubus {
    uint32_t ubus_permission;  /* 0x00 */
    uint32_t rsvd;             /* 0x04 */
    uint32_t ax2u_modid;       /* 0x8 */
    uint32_t rsvd_1[5];        /* 0xc */
    uint32_t ccb_modid;        /* 0x20 */
    uint32_t cci_modid;        /* 0x24 */
    uint32_t u2up_modid;       /* 0x28 */
    uint32_t status;           /* 0x2c */
#define BIUCFG_UBUS_CCB_MOD_SEL   0x1
    uint32_t rsvd_2[52];       /* 0x30 - 0xff */
} BIUCFG_Ubus;
...
typedef struct BIUCFG {
	...
	uint32_t anonymous[128];    /* 0x500 - 0x6ff */
