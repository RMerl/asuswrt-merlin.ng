...
#define L310_AUX_CTRL_WAY_SIZE_32KB			(2 << 17)
#define L310_AUX_CTRL_WAY_SIZE_MASK			(3 << 17)
#define L310_SHARED_ATT_OVERRIDE_ENABLE		(1 << 22)
#define L310_AUX_CTRL_NS_LOCK_ENABLE		(1 << 26)
#define L310_AUX_CTRL_NS_INT_ENABLE			(1 << 27)
#define L310_AUX_CTRL_DATA_PREFETCH_MASK	(1 << 28)
#define L310_AUX_CTRL_INST_PREFETCH_MASK	(1 << 29)
#define L310_AUX_CTRL_EARLY_BRESP_ENABLE	(1 << 30)
