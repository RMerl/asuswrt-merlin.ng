...
void print_chipinfo(void)
{
	...
	printf("ARM Cortex A55 Dual Core: %dMHz\n", cpu_speed);
...
int arch_cpu_init(void)
{
	...
	*((volatile unsigned int*)0x842100BC) |= 0x4; // turn on UPG_WDT0_RESET_EN bit 	
#endif
...
#define CPU_MASK	0x2
    ...
    BIUCFG->cluster[0].rvbar_addr[1] = rvbar;
...
#endif
        printf("failed to boot secondary cpu - sts %d\n", stat);
