...
#if defined(BQ16) || defined(BQ16_PRO) || defined(BT10) || defined(RTBE82U) || defined(RTBE82M) || defined(GSBE18000) || defined(GSBE12000) || defined(GS7_PRO) || defined(GT7) || defined(GS7_PRO_MAX) || defined(RTBE86U)
	char cma_str[30] = {0};
#endif
...
#ifdef RTBE86U
	snprintf(cma_str, sizeof(cma_str), "%s", env_get("bootargs_append"));
	if (strcmp(cma_str, "cma=48M") == 0){
		printf("RT-BE86U: cma=48M\n");
	} else {
		printf("RT-BE86U overwrites: cma=48M\n");
		env_set("bootargs_append","cma=48M");
	}
