...
#define LPDDR4_TABLE_MAGIC	0x4C705234
#define LPDDR5_TABLE_MAGIC	0x4C705235
#define DPFE_DDR3_TABLE_MAGIC	0x64503300
#define DPFE_DDR4_TABLE_MAGIC	0x64503400
#define DPFE_LPDDR4_TABLE_MAGIC	0x64506C00
#define DPFE_LPDDR5_TABLE_MAGIC	0x64506D00
...
#define IS_DPFE_LPDDR4_MAGIC(magic)   \
    (((magic)&DPFE_MAGIC_MASK) == DPFE_LPDDR4_TABLE_MAGIC)
#define IS_DPFE_LPDDR5_MAGIC(magic)   \
    (((magic)&DPFE_MAGIC_MASK) == DPFE_LPDDR5_TABLE_MAGIC)


#define IS_DPFE_MAGIC(magic)		\
	(IS_DPFE_DDR3_MAGIC(magic) || IS_DPFE_DDR4_MAGIC(magic) || IS_DPFE_LPDDR4_MAGIC(magic) || IS_DPFE_LPDDR5_MAGIC(magic))
