...
#define SKO_PAC_PERM_MASK			0x0f
#define	SKO_KEY_PERM_MASK			0xf0
...
/* The following  are masks (not the lock values) of the corresponding bits of the 
 * PAC and key control registers */
#define SKO_PERM_KEY_SR_LOCK			(0x1<<SKO_PAC_KEY_SR_LOCK_SHIFT)  /* '1' locks */
#define SKO_PERM_KEY_NSR_LOCK			(0x1<<SKO_PAC_KEY_NSR_LOCK_SHIFT) /* '1' locks */

#define SKO_PERM_KEY_SW_LOCK			(0x1<<SKO_PAC_KEY_SW_LOCK_SHIFT)  /* '1' locks */
#define SKO_PERM_KEY_NSW_LOCK			(0x1<<SKO_PAC_KEY_NSW_LOCK_SHIFT) /* '1' locks */

#define SKO_PERM_PAC_SR_LOCK			(0x1<<SKO_PAC_PERM_SR_LOCK_SHIFT)  /* '1' actually unlocks */
#define SKO_PERM_PAC_NSR_LOCK			(0x1<<SKO_PAC_PERM_NSR_LOCK_SHIFT) /* '1' actually unlocks */

#define SKO_PERM_PAC_SW_LOCK			(0x1<<SKO_PAC_PERM_SW_LOCK_SHIFT)  /* '1' actually unlocks */
#define SKO_PERM_PAC_NSW_LOCK			(0x1<<SKO_PAC_PERM_NSW_LOCK_SHIFT) /* '1' actually unlocks */

#define SKO_PERM_UNLOCK_ALL			0x0f

/* The following macro sets actual locking based on mask input
 *    
