...
#if IS_BCMCHIP(68880) && !defined(CONFIG_BCMBCA_NO_SMC_BOOT)
...
#if IS_BCMCHIP(6858) || IS_BCMCHIP(6855) || IS_BCMCHIP(6888) || IS_BCMCHIP(68880) || IS_BCMCHIP(6837)
#define XRDPPLL_RUNNER_CHANNEL   0
#define XRDPPLL_XRDP_CHANNEL     2
#endif
