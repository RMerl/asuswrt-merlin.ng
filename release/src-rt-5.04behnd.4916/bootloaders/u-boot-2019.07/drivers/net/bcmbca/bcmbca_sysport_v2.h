...
typedef struct sys_port_topctrl {
	...
	uint32_t SYSTEMPORT_TOPCTRL_WR_REPLY_CFG;           // not in 6765
...
typedef struct sys_port_rdma {
	...
	uint32_t SYSTEMPORT_RDMA_SYSBUS_BURST;          // not in 6765
...
#define SYSPORT_TDMA_CONTROL_DATA_OFFSET_M              FIELD_MASK(10,5)    // not in 6765
...
#define SYSTEMPORT_TDMA_DESC_RING_CONTROL_RING_EN 0x02
	...
	uint32_t SYSTEMPORT_TDMA_SYSBUS_BURST;      // not in 6765
	...
	uint32_t SYSTEMPORT_TDMA_LS_ETHERTYPE;      // not in 6765
#endif
...
#endif
    // 6765 has additional TDMA_QSHAPER registers
...
typedef struct xbow_ipa {
	uint32_t XBOW_IPA_CFG;
	uint32_t XBOW_IPA_SIB_CTRL;
#define SYSPORT_XBOW_IPA_SIB_CTL_RX_EN 0x01
#define SYSPORT_XBOW_IPA_SIB_CTL_TX_EN 0x02
	uint32_t res08[6];
	uint32_t XBOW_IPA_RDS_CFG;
#define SYSPORT_XBOW_IPA_RDS_DISABLE  0
#define SYSPORT_XBOW_IPA_RDS_ENABLE   1
} xbow_ipa; /* crossbow Ingress Port Arbiter */
