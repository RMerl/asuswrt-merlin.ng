...
#if defined REG_DIR_WRITE_32
#undef REG_DIR_WRITE_32
#endif
#define REG_DIR_WRITE_32(reg, val) REG_WRITE_32(bcm_dev_phy2vir(reg), val)

#if defined(REG_DIR_READ_32)
#undef REG_DIR_READ_32
#endif
...
#define MERLIN_AN_LINK_STATUS  0x2020
#define MERLIN_SERDES_0_MISC_STATUS 0x2024
#else
