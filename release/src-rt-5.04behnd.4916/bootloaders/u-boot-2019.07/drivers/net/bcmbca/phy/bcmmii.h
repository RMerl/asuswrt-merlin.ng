...
#define BCM_PHYID_M      0xFFF0
    ...
    #define REG_CONTROL_MII1_PORT_STATE_OVERRIDE          0x0e  // 63158: move to E4-10
        ...
        #define REG_CONTROL_MPSO_SPEED10G                 0x40 // for 6765
        #define REG_CONTROL_MPSO_SPEED5G                  0x44 // for 6765
    ...
    #define REG_PORT_STATE                                0x58  // 63158: move to E4-00
        ...
        #define REG_PORT_STATE_XGMII_MODE                0x100  /* 6765 */
        ...
        #define REG_PORT_STATE_2500                       0x0c  /* 6756, 6765 */
        #define REG_PORT_STATE_10000                      0x80  /* 6756, 6765 */
        #define REG_PORT_STATE_5000                       0x84  /* 6756, 6765 */
        #define REG_PORT_STATE_EXT_SPD_MSK                0x8c
        #define REG_PORT_STATE_IMP_SPD_MSK                0x4c
...
/*   External switch RGMII definitions */
    ...
    #define REG_LIGHTSTACK_CTRL                           0xec
        #define REG_LSTACK_EN                                 (1<<0)
        #define REG_LSTACK_MASTER                             (1<<1)
        #define REG_LSTACK_PORT0_SHIFT                        8
        #define REG_LSTACK_PORT0_LEGACY                       (1<<11)
        #define REG_LSTACK_FWD_MAP2_WORKAROUND                (0x3f<<24)
...
#define PAGE_STATUS                                       0x01
    ...
    #define REG_LNKSTS                                    0x00
        #define LNKSTS_UP(v,p)                            (((v) >> (p))& 1)
        
    #define REG_SPDSTS                                    0x04
        #define SPDSTS(v,p)                               (((v) >> (p)*2)& 3)

    #define REG_DUPSTS                                    0x08
        #define DUPSTS(v,p)                               (((v) >> (p))& 1)
        
    #define REG_PAUSESTS                                  0x0a
        #define PAUSETXSTS(v,p)                           (((v) >> (p))& 1)
        #define PAUSERXSTS(v,p)                           (((v) >> ((p)+9))& 1)

    #define REG_NEW_SPDSTS                                0x94  // 6756, 6765
        #define NSPDSTS(v,p)                              (((v) >> (p)*3)& 7)

    #define REG_XGMSTS                                    0x98  // 6765
/****************************************************************************
...
#define PAGE_MANAGEMENT                                   0x02
    ...
    #define REG_IPG_SHRINK_10G_WA                         0x58  // 6765
    #define REG_STRICT_RXIPG_CTRL                         0x79  // 6765
    #define REG_XGMII_EARLY_TX_CTRL                       0x7a  // 6765
    #define REG_XGMII_TX_UFLOW_DIS                        0x7c  // 6765

    #define REG_TXIPG_PORT0                               0x80  // 6756, 6765
#define TXIPG_REG(p)                (REG_TXIPG_PORT0+(p))
        #define TXIPG_LEN_OVR                                   0x80

    #define REG_TXIPG_DIC_DIS                             0x8a  // 6765
...
#define PORT_OVERIDE_REG        CTL_OVERIDE_REG
