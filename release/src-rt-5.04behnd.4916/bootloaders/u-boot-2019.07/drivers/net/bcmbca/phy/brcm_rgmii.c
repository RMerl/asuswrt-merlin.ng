...
#define     RGMII_VER1  1   /* for PON devices              rgmii_ctrl   gpio_pad_ctrl      top_rgmii_ctrl */
#define     RGMII_VER2  2   /* for 63146,4912,6888 devices  rgmii_ctrl   gpio_pad_ctrl */
...
#define     RGMII_VER5  5   /* for 63158,148,138 devices    rgmii_ctrl[] rgmii_pad_ctrl[] */
...
static void bcm_misc_hw_xmii_pads_init(rgmii_params *params)
{
    ...
    {
        tp_data = 0;
        if (rgmii_ver == RGMII_VER1 || rgmii_ver == RGMII_VER2 || rgmii_ver == RGMII_VER7 || rgmii_ver == RGMII_VER8)
        {
...
#endif
#if defined(CONFIG_BCM94912) || defined(CONFIG_BCM96888)
    { // turn on RGMII clk 250 en
        uint32_t data;
...
static const struct udevice_id rgmii_ids[] = {
    { .compatible = "brcm,rgmii1", .data = RGMII_VER1 },
    { .compatible = "brcm,rgmii2", .data = RGMII_VER2 },
    { .compatible = "brcm,rgmii3", .data = RGMII_VER3 },
    { .compatible = "brcm,rgmii4", .data = RGMII_VER4 },
    { .compatible = "brcm,rgmii5", .data = RGMII_VER5 },
    { .compatible = "brcm,rgmii6", .data = RGMII_VER6 },
    { .compatible = "brcm,rgmii7", .data = RGMII_VER7 },
    { .compatible = "brcm,rgmii8", .data = RGMII_VER8 },
    { /* end of list */ },
};
