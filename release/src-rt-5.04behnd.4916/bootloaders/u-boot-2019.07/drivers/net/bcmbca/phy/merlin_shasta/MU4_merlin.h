...
#define PARAM(x) (uintptr_t)(x)
extern prog_seq_u4_tbl MU4_datapath_reset_lane[];

//x Figure 18 Initialize (both blackfin and maple2)
prog_seq_u4_tbl MU4_Initialize_12p5_VCO[] = {
...
prog_seq_u4_tbl MU4_PMD_setup_400_10p3125_VCO[] = {
...
prog_seq_u4_tbl MU4_PMD_setup_400_12p5_VCO[] = {
  {"main control register",      0x3,  0x9100, 0xf000, 0x5000}, //refclk_sel [15:12]
  {"digcom_top_user_control_0",  0x1,  0xD0F4, 0x2000, 0x0000}, //core_dp_s_rstb [13]
...
prog_seq_u4_tbl MU4_PMD_setup_50_10p3125_VCO[] = {
  {"main control register",      0x3,  0x9100, 0xf000, 0x6000}, //refclk_sel [15:12]
  {"core_pll_top_user_control",  0x1,  0xD1A4, 0x2000, 0x0000}, //core_dp_s_rstb [13]
  {"tlb_tx_misc_config",         0x1,  0xd0e3, 0x0002, 0x0002}, //bypass pmd tx oversampling [01:01]
  {"amscom_pll_ctrl_5",          0x1,  0xd0b5, 0x0080, 0x0000}, // pll pwrdwn [07:07]
  {"amscom_pll_ctrl_9",          0x1,  0xD0B9, 0x0006, 0x0004}, // frac_mode [02:01}
  {"amscom_pll_ctrl_8",          0x1,  0xd0b8, 0x03FF, 0x00ce}, // ndiv_int [9:0] = 0xce
  {"amscom_pll_ctrl_7",          0x1,  0xd0b7, 0x3FFF, 0x1000}, // ndiv_frac_h [13:0] = 0x1000
  {"amscom_pll_ctrl_6",          0x1,  0xd0b6, 0xF000, 0x0000}, // ndiv_frac_l [15:12] = 0x0
  {"amscom_pll_ctrl_8",          0x1,  0xd0b8, 0x8000, 0x8000}, // dither_en [15]  = 0x0
  {"amscom_pll_ctrl_9",          0x1,  0xD0B9, 0x0001, 0x0000}, // mmd_rstb [0] = 1'b0
  {"amscom_pll_ctrl_9",          0x1,  0xD0B9, 0x0001, 0x0001}, // mmd_rstb [0] = 1'b1
  {"",                           0x0,  0x0000, 0x0000, 0x0000}
}; 
prog_seq_u4_tbl MU4_PMD_setup_50_12p5_VCO[] = {
  {"main control register",      0x3,  0x9100, 0xf000, 0x6000}, //refclk_sel [15:12]
  {"core_pll_top_user_control",  0x1,  0xD1A4, 0x2000, 0x0000}, //core_dp_s_rstb [13]
  {"tlb_tx_misc_config",         0x1,  0xd0e3, 0x0002, 0x0002}, //bypass pmd tx oversampling [01:01]
  {"amscom_pll_ctrl_5",          0x1,  0xd0b5, 0x0080, 0x0000}, // pll pwrdwn [07:07]
  {"amscom_pll_ctrl_9",          0x1,  0xD0B9, 0x0006, 0x0004}, // frac_mode [02:01}
  {"amscom_pll_ctrl_8",          0x1,  0xd0b8, 0x03FF, 0x00FA}, // ndiv_int [9:0] = 0x050
...
//x leverage from the Figure 21 PMD Setup 400MHz (div2 = 0); also refer to ANA_SFI1X_TS16FFC_S6_spec.pdf
prog_seq_u4_tbl MU4_PMD_setup_156p25_10p3125_VCO[] = {
  {"main control register",       0x3,  0x9100, 0xf000, 0x3000}, //15:12 refclk_sel = 4'h3  
  {"digcom_top_user_control_0",   0x1,  0xD0F4, 0x2000, 0x0000}, //core_dp_s_rstb [13]
  //{"TLB TX tlb tx Misc. Control", 0x1,  0xD0E3, 0x0002, 0x0002}, //01:01 bypass pmd tx oversampling = 1'b1 //no need due to pmd_tx_osr_mode_legacy = 0
...
//x leverage from the Figure 21 PMD Setup 400MHz (div2 = 0); also refer to ANA_SFI1X_TS16FFC_S6_spec.pdf
prog_seq_u4_tbl MU4_PMD_setup_156p25_12p5_VCO[] = {
  {"main control register",       0x3,  0x9100, 0xf000, 0x3000}, //15:12 refclk_sel = 4'h3  
  {"digcom_top_user_control_0",   0x1,  0xD0F4, 0x2000, 0x0000}, //core_dp_s_rstb [13]
  //{"TLB TX tlb tx Misc. Control", 0x1,  0xD0E3, 0x0002, 0x0002}, //01:01 bypass pmd tx oversampling = 1'b1 //no need due to pmd_tx_osr_mode_legacy = 0
  {"amscom_pll_ctrl_9",           0x1,  0xD0B9, 0x0007, 0x0004}, //00:00 mmd_rstb = 1'h0
...
prog_seq_u4_tbl MU4_PMD_setup_156p25_10p3125_VCO_per_lane[] = {
...
// (~CL36) 5G
prog_seq_u4_tbl MU4_force_speed_5g[] = {
...
prog_seq_u4_tbl MU4_force_speed_5g_xgmii[] = {
...
prog_seq_u4_tbl MU4_force_speed_2p5g[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_2p5g_xgmii[] = {
  {"Main0 misc control1 register",             0x3,  0x910c, 0x0080, 0x0080},  //07:07 force_cl36_xgmii = 1'b1
  {"RX_X1_Control0_reorder",                   0x3,  0x9224, 0x0020, 0x0020},  //05:05 idle_force_link_down = 1'b1
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
  ...
  {"datapath_reset_lane", 0, 0, 0, 0, PROG_TYPE_SEQUENCE, PARAM(&MU4_datapath_reset_lane)},
  {"udelay 200",          0, 0, 0, 0, PROG_TYPE_UDELAY,   PARAM(200)},
...
prog_seq_u4_tbl MU4_force_speed_1g[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_1g_xgmii[] = {
  {"Main0 misc control1 register",             0x3,  0x910c, 0x0080, 0x0080},  //07:07 force_cl36_xgmii = 1'b1
  {"RX_X1_Control0_reorder",                   0x3,  0x9224, 0x0020, 0x0020},  //05:05 idle_force_link_down = 1'b1
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_1g_kx1[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_1g_kx1_xgmii[] = {
  {"Main0 misc control1 register",             0x3,  0x910c, 0x0080, 0x0080},  //07:07 force_cl36_xgmii = 1'b1
  {"RX_X1_Control0_reorder",                   0x3,  0x9224, 0x0020, 0x0020},  //05:05 idle_force_link_down = 1'b1
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_100m[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_10m[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_auto_neg_1g_kx_ieee_cl73[] = {
...
prog_seq_u4_tbl MU4_auto_neg_1g_kx_ieee_cl73_xgmii[] = {
  {"Main0 misc control1 register",             0x3,  0x910c, 0x0080, 0x0080},  //07:07 force_cl36_xgmii = 1'b1
  {"RX_X1_Control0_reorder",                   0x3,  0x9224, 0x0020, 0x0020},  //05:05 idle_force_link_down = 1'b1
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x0000},  //13:12 use_ieee_reg_ctrl_sel = 2'b00
  {"AN advertisement 1",                       0x7,  0x0011, 0xffe0, 0x0020},  //15:05 speed advertisement = 11'h001  
...
prog_seq_u4_tbl MU4_auto_neg_1g_user_cl73[] = {
...
prog_seq_u4_tbl MU4_auto_neg_1g_user_cl73_xgmii[] = {
  {"Main0 misc control1 register",             0x3,  0x910c, 0x0080, 0x0080},  //07:07 force_cl36_xgmii = 1'b1
  {"RX_X1_Control0_reorder",                   0x3,  0x9224, 0x0020, 0x0020},  //05:05 idle_force_link_down = 1'b1
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x2000},  //13:12 use_ieee_reg_ctrl_sel = 2'b10
  {"CL73 BASE PAGE ABILITIES REG 0",           0x3,  0xC486, 0x0020, 0x0020},  //05:05 speed advertisement = 1'b1  
...
prog_seq_u4_tbl MU4_auto_neg_1g_ieee_cl37[] = {
...
prog_seq_u4_tbl MU4_auto_neg_1g_ieee_cl37_xgmii[] = {
  {"Main0 misc control1 register",             0x3,  0x910c, 0x0080, 0x0080},  //07:07 force_cl36_xgmii = 1'b1
  {"RX_X1_Control0_reorder",                   0x3,  0x9224, 0x0020, 0x0020},  //05:05 idle_force_link_down = 1'b1
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x1000},  //13:12 use_ieee_reg_ctrl_sel = 2'b01
  {"IEEE AN advertised abilities register",    0x0,  0x0004, 0x0020, 0x0020},  //05:05 duplex = 1'b1  
...
prog_seq_u4_tbl MU4_auto_neg_1g_user_cl37[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x2000},  //13:12 use_ieee_reg_ctrl_sel = 2'b10
...
prog_seq_u4_tbl MU4_auto_neg_1g_user_cl37_xgmii[] = {
  {"Main0 misc control1 register",             0x3,  0x910c, 0x0080, 0x0080},  //07:07 force_cl36_xgmii = 1'b1
  {"RX_X1_Control0_reorder",                   0x3,  0x9224, 0x0020, 0x0020},  //05:05 idle_force_link_down = 1'b1
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x2000},  //13:12 use_ieee_reg_ctrl_sel = 2'b10
  {"CL37 BASE PAGE ABILITIES",                 0x3,  0xC481, 0x0010, 0x0010},  //04:04 duplex = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_10g_R[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_10g_R_cl74_fec[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x003f, 0x000f},  //05:00 SW_actual_speed = 6'h0f
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x087f, 0x004f},  //merged [11] and [06:00]
...
prog_seq_u4_tbl MU4_auto_neg_10g_kr_cl73[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x0000},  //13:12 use_ieee_reg_ctrl_sel = 2'b00
...
prog_seq_u4_tbl MU4_auto_neg_10g_kr_cl73_cl74_fec[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x0000},  //13:12 use_ieee_reg_ctrl_sel = 2'b00
  {"AN advertisement 1",                       0x7,  0x0011, 0xffe0, 0x0080},  //15:05 speed advertisement = 11'h004  
  {"AN advertisement 0",                       0x7,  0x0010, 0x001f, 0x0001},  //04:00 base selector = 5'h01  
  //{"cl72_ieee_training_enable",                0x1,  0x0096, 0x0002, 0x0002},  //01:01 cl72_ieee_training_enable = 1'b1
...
prog_seq_u4_tbl MU4_auto_neg_10g_user_cl73[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x2000},  //13:12 use_ieee_reg_ctrl_sel = 2'b10
...
prog_seq_u4_tbl MU4_auto_neg_10g_user_cl73_cl74_fec[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x2000},  //13:12 use_ieee_reg_ctrl_sel = 2'b10
  {"CL73 BASE PAGE ABILITIES REG 0",           0x3,  0xC486, 0x0008, 0x0008},  //03:03 speed advertisement = 1'b1  
  {"CL73 BASE PAGE ABILITIES REG 1",           0x3,  0xC485, 0x001f, 0x0001},  //04:00 base selector = 5'h01  
  //{"cl72_ieee_training_enable",                0x1,  0x0096, 0x0002, 0x0002},  //01:01 cl72_ieee_training_enable = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_5g_x[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_2p5g_x[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_1g_x[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_cl127_credit_10p3125_VCO[] = {
...
prog_seq_u4_tbl MU4_auto_neg_2p5g_kx_cl73[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x0000},  //13:12 use_ieee_reg_ctrl_sel = 2'b00
...
prog_seq_u4_tbl MU4_auto_neg_2p5g_user_cl73[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x2000},  //13:12 use_ieee_reg_ctrl_sel = 2'b10
...
// CL129 5GBASE-R
prog_seq_u4_tbl MU4_force_speed_5g_R[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_2p5g_R[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_1g_R[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_lpi_enable[] = {
...
prog_seq_u4_tbl MU4_global_pcs_loopback_lane[] = {
  {"SIGDET_CTRL_1",                            0x1,  0xD0C1, 0x0180, 0x0180},   //08:07 singal_detect_frc = 2'b11
  {"",                                         0x0,  0x0000, 0x0000, 0x0000}
}; 
prog_seq_u4_tbl MU4_global_pcs_loopback[] = {
  //{"SIGDET_CTRL_1",                            0x1,  0xD0C1, 0x0180, 0x0180},   //08:07 singal_detect_frc = 2'b11
...
prog_seq_u4_tbl MU4_global_pmd_loopback[] = {
  {"SIGDET_CTRL_1",                            0x1,  0xD0C1, 0x0180, 0x0180},   //08:07 singal_detect_frc = 2'b11
...
prog_seq_u4_tbl MU4_remote_pcs_loopback[] = {
...
prog_seq_u4_tbl MU4_remote_pmd_loopback[] = {
...
prog_seq_u4_tbl MU4_prbs_gen_31[] = {
...
prog_seq_u4_tbl MU4_prbs_gen_7[] = {
...
prog_seq_u4_tbl MU4_prbs_gen_15[] = {
...
prog_seq_u4_tbl MU4_prbs_gen_58[] = {
...
prog_seq_u4_tbl MU4_pll_lock_speedup[] = {
...
prog_seq_u4_tbl MU4_pmd_lock_speedup[] = {
...
prog_seq_u4_tbl MU4_AN_speedup[] = {
...
prog_seq_u4_tbl MU4_timeout_test[] = {
...
prog_seq_u4_tbl MU4_powerdn_lane[] = {
...
prog_seq_u4_tbl MU4_powerup_lane[] = {
  //PMD analog power up
...
prog_seq_u4_tbl MU4_powerdn_core[] = {
//merlin16_shasta_core_pwrdn().PWRDN:
  //merlin16_shasta_core_dp_reset(0x1):
  {"DIGCOM_TOP_USER_CONTROL_0",                0x1,  0xd1a4, 0x2000, 0x0000},    //13:13 core_dp_s_rstb = 0
  {"timeout_100ns",                            0xa,  0x0,    0x0,    0x0   },    //timeout_ns 100ns for above core_dp_s_rstb <== Minimum assertion time is 50 comclk cycles
  {"DIGCOM_TOP_USER_CONTROL_0",                0x1,  0xd1a4, 0x4000, 0x4000},    //14:14 afe_s_pll_pwrdn = 1 
...
prog_seq_u4_tbl MU4_powerup_core[] = {
//merlin16_shasta_core_pwrdn().PWRON:
  //merlin16_shasta_INTERNAL_core_clkgate(): !!! skipped due to the function does nothing
  {"AMSCOM_PLL_CTRL_5",                        0x1,  0xd0b5, 0x0080, 0x0000},    //07:07 pwrdn = 1
  {"DIGCOM_TOP_USER_CONTROL_0",                0x1,  0xd1a4, 0x4000, 0x0000},    //02:02 afe_s_pll_pwrdn = 0
  //merlin16_shasta_core_dp_reset(0x0): !!! skipped
  {"DIGCOM_TOP_USER_CONTROL_0",                0x1,  0xd1a4, 0x2000, 0x2000},    //13:13 core_dp_s_rstb = 1
...
// /projects/BCA_Ethernet/BCG_Serdes/serdes_16nm_eval/A107_21/merlin16_shortfin/src/merlin16_shortfin_pwr_mgt.c
prog_seq_u4_tbl MU4_iddq_core[] = {
  {"AMSCOM_PLL_CTRL_5",                        0x1,  0xd0b5, 0x0080, 0x0080},    //07:07 pwrdn = 1
  {"",                                         0x0,  0x0000, 0x0000, 0x0000}
}; 

prog_seq_u4_tbl MU4_iddq_lane[] = {
...
prog_seq_u4_tbl MU4_sgmii_an_speed_1g_master[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x2000},  //13:12 use_ieee_reg_ctrl_sel = 2'b10
...
prog_seq_u4_tbl MU4_sgmii_an_speed_100m_master[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x2000},  //13:12 use_ieee_reg_ctrl_sel = 2'b10
  {"CL37 BASE PAGE ABILITIES",                 0x3,  0xC481, 0x0004, 0x0004},  //02:02 duplex = 1'b1
...
prog_seq_u4_tbl MU4_sgmii_an_speed_10m_master[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x2000},  //13:12 use_ieee_reg_ctrl_sel = 2'b10
  {"CL37 BASE PAGE ABILITIES",                 0x3,  0xC481, 0x0004, 0x0004},  //02:02 duplex = 1'b1
...
prog_seq_u4_tbl MU4_sgmii_an_slave[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x2000},  //13:12 use_ieee_reg_ctrl_sel = 2'b10
  {"AN ENABLES",                               0x3,  0xC480, 0x00c0, 0x00c0},  //07:06 AN enable = 2'b11  
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0000},  //06:06 SW_actual_speed_force_en = 1'b0
...
prog_seq_u4_tbl MU4_sgmii_an_slave_xgmii[] = {
  {"Main0 misc control1 register",             0x3,  0x910c, 0x0080, 0x0080},  //07:07 force_cl36_xgmii = 1'b1
  {"RX_X1_Control0_reorder",                   0x3,  0x9224, 0x0020, 0x0020},  //05:05 idle_force_link_down = 1'b1
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x3000, 0x2000},  //13:12 use_ieee_reg_ctrl_sel = 2'b10
  {"AN ENABLES",                               0x3,  0xC480, 0x00c0, 0x00c0},  //07:06 AN enable = 2'b11  
...
prog_seq_u4_tbl MU4_force_speed_10g_usxgmii[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_10g_usxgmii_cl74_fec[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x003f, 0x0036},  //05:00 SW_actual_speed = 6'h36
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x087f, 0x0076},  //merged [11] and [06:00] 
...
prog_seq_u4_tbl MU4_force_speed_5g_usxgmii[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_2p5g_usxgmii[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_1g_usxgmii[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_force_speed_100m_usxgmii[] = {
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0800, 0x0000},  //11:11 credit_sw_en = 1'b0
  //{"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0040},  //06:06 SW_actual_speed_force_en = 1'b1
...
prog_seq_u4_tbl MU4_usxgmii_an_master[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0000},  //06:06 SW_actual_speed_force_en = 1'b0
...
prog_seq_u4_tbl MU4_usxgmii_an_slave[] = {
  {"Miscellaneous digital  control1 register", 0x3,  0xC30B, 0x0040, 0x0000},  //06:06 SW_actual_speed_force_en = 1'b0
  {"usxgmii autoneg control0 register",        0x3,  0xC4B1, 0x0001, 0x0001},  //00:00 usxgmii_an_mode = 1'b1
  {"usxgmii autoneg control0 register",        0x3,  0xC4B1, 0x0040, 0x0040},  //06:06 an_fast_timer = 1'b1
...
prog_seq_u4_tbl MU4_usxgmii_pcs_reset_and_enable[] = {
  //{"TX_FED_txfir_misc_control1",               0x1,  0xD13D, 0x0001, 0x0000},  //00:00 40-bit path = 1'b0
  //{"AN_X4_USXGMII_usxgmii_an_control2",        0x3,  0xc6b3, 0x0060, 0x0000},  //06:05 t_rep_wptr_latency = 0x0
...
//release resets for AN function
...
prog_seq_u4_tbl MU4_usxgmii_port_reset[] = {                                        //release resets for AN function
  {"RX_X4_Control0_r_usxgmii_dereplicate",     0x3,  0xC69C, 0x0002, 0x0002},  //01:01 rstb_rx_port
  {"U_TX_X8_Control0_tx_x8_control",           0x3,  0xC681, 0x0010, 0x0010},  //04:04 rstb_tx_port
  {"",                                         0x0,  0x0000, 0x0000, 0x0000}
};
...
prog_seq_u4_tbl MU4_usxgmii_switch_pcs_from_A_to_B_1port_10g[] = {
...
prog_seq_u4_tbl MU4_usxgmii_switch_pcs_from_A_to_B_2port_10g[] = {
  {"Main0_setup_1",                            0x3,  0x9101, 0x0040, 0x0040},  //06:06 uport_ubuad_override = 1'b1
  {"Main0_setup_1",                            0x3,  0x9101, 0x0020, 0x0020},  //05:05 usxgmii_pcs_sel = 1'b1
  {"U_TX_X1_Control0_pmd_osr_mode",            0x3,  0x9402, 0x00f0, 0x0000},  //07:04 pmd_osr_mode_2 = 'h0 (i.e. osm1)
...
prog_seq_u4_tbl MU4_usxgmii_switch_pcs_from_A_to_B_4port_10g[] = {
  {"Main0_setup_1",                            0x3,  0x9101, 0x0040, 0x0040},  //06:06 uport_ubuad_override = 1'b1
  {"Main0_setup_1",                            0x3,  0x9101, 0x0020, 0x0020},  //05:05 usxgmii_pcs_sel = 1'b1
  {"U_TX_X1_Control0_pmd_osr_mode",            0x3,  0x9402, 0x00f0, 0x0000},  //07:04 pmd_osr_mode_2 = 'h0 (i.e. osm1)
...
prog_seq_u4_tbl MU4_usxgmii_switch_pcs_from_A_to_B_1port_5g[] = {
  {"Main0_setup_1",                            0x3,  0x9101, 0x0040, 0x0040},  //06:06 uport_ubuad_override = 1'b1
  {"Main0_setup_1",                            0x3,  0x9101, 0x0020, 0x0020},  //05:05 usxgmii_pcs_sel = 1'b1
...
prog_seq_u4_tbl MU4_usxgmii_switch_pcs_from_A_to_B_2port_5g[] = {
  {"Main0_setup_1",                            0x3,  0x9101, 0x0040, 0x0040},  //06:06 uport_ubuad_override = 1'b1
  {"Main0_setup_1",                            0x3,  0x9101, 0x0020, 0x0020},  //05:05 usxgmii_pcs_sel = 1'b1
  {"U_TX_X1_Control0_pmd_osr_mode",            0x3,  0x9402, 0x0f00, 0x0100},  //11:08 pmd_osr_mode_4 = 'h1 (i.e. osm2)
  {"U_PCS_Main0_setup_1",                      0x3,  0x9301, 0x000c, 0x0004},  //03:02 uport_num = 2'b01 (2port)
...
prog_seq_u4_tbl MU4_usxgmii_switch_pcs_from_A_to_B_1port_2p5g[] = {
  {"Main0_setup_1",                            0x3,  0x9101, 0x0040, 0x0040},  //06:06 uport_ubuad_override = 1'b1
  {"Main0_setup_1",                            0x3,  0x9101, 0x0020, 0x0020},  //05:05 usxgmii_pcs_sel = 1'b1
...
prog_seq_u4_tbl MU4_usxgmii_switch_pcs_from_B_to_A[] = {
...
prog_seq_u4_tbl MU4_usxgmii_mp_an_master[] = {
  {"Digital_MiscDigControl",                   0x3,  0xc60b, 0x007f, 0x0036},  //05:00 SW_actual_speed = 0x36; [6] SW_actual_speed_force_en = 1'b0
  {"usxgmii autoneg control0 register",        0x3,  0xC6B1, 0x0001, 0x0001},  //00:00 usxgmii_an_mode = 1'b1
  {"usxgmii autoneg control0 register",        0x3,  0xC6B1, 0x0040, 0x0040},  //06:06 an_fast_timer = 1'b1
...
prog_seq_u4_tbl MU4_usxgmii_mp_global_pcs_loopback[] = {
  {"LOOPBACK CONTROL REGISTER",                0x3,  0x9309, 0x0010, 0x0010},   //04:04 local_pcs_loopback_enable = 1'b1
  {"",                                         0x0,  0x0000, 0x0000, 0x0000}
}; 

// Figure 85 Remmote PCS Loopback (USXGMII_M_PHY_1_shortfin-002_spec.pdf)
prog_seq_u4_tbl MU4_usxgmii_mp_remote_pcs_loopback[] = {
  {"LOOPBACK CONTROL REGISTER",                0x3,  0x9309, 0x0020, 0x0020},   //05:05 remote_pcs_loopback_enable = 1'b1
  {"",                                         0x0,  0x0000, 0x0000, 0x0000}
}; 
