...
/** @file merlin16_shasta_access.h
 * Implementation of API uC access functions
 */

#ifndef MERLIN16_SHASTA_API_ACCESS_H
#define MERLIN16_SHASTA_API_ACCESS_H
 ...
 */
uint8_t merlin16_shasta_rdbl_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 */
uint16_t merlin16_shasta_rdwl_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 */
int8_t merlin16_shasta_rdbls_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 */
int16_t merlin16_shasta_rdwls_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t merlin16_shasta_rdbc_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t merlin16_shasta_rdwc_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t merlin16_shasta_rdbcs_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t merlin16_shasta_rdwcs_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 */
uint32_t merlin16_shasta_rd_long_uc_prog_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_wr_long_uc_ram(srds_access_t *sa__, uint16_t addr, uint32_t wr_val);
 ...
 */
uint32_t merlin16_shasta_rd_long_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t merlin16_shasta_rdw_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t merlin16_shasta_rdb_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t merlin16_shasta_rdws_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t merlin16_shasta_rdbs_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
