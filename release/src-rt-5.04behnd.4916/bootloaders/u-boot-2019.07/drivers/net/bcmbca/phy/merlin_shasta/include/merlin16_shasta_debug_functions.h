...
/** @file merlin16_shasta_debug_functions.h
 * Functions used internally and available in debug shell only
 */

#ifndef MERLIN16_SHASTA_DEBUG_FUNCTIONS_H
#define MERLIN16_SHASTA_DEBUG_FUNCTIONS_H
 ...
 * @param line __LINE__
 */
void merlin16_shasta_INTERNAL_print_triage_info(srds_access_t *sa__, err_code_t err_code, uint8_t print_header, uint8_t print_data, uint16_t line);
 ...
 */
err_code_t merlin16_shasta_isolate_ctrl_pins(srds_access_t *sa__, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_isolate_lane_ctrl_pins(srds_access_t *sa__, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_isolate_core_ctrl_pins(srds_access_t *sa__, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_stop_uc_lane(srds_access_t *sa__, uint8_t enable);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_stop_uc_lane_status(srds_access_t *sa__, uint8_t *uc_lane_stopped);
 ...
 */
err_code_t merlin16_shasta_set_usr_ctrl_disable_startup(srds_access_t *sa__, struct merlin16_shasta_usr_ctrl_disable_functions_st set_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_set_usr_ctrl_disable_startup_dfe(srds_access_t *sa__, struct merlin16_shasta_usr_ctrl_disable_dfe_functions_st set_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_set_usr_ctrl_disable_steady_state(srds_access_t *sa__, struct merlin16_shasta_usr_ctrl_disable_functions_st set_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_set_usr_ctrl_disable_steady_state_dfe(srds_access_t *sa__, struct merlin16_shasta_usr_ctrl_disable_dfe_functions_st set_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_get_usr_ctrl_disable_startup(srds_access_t *sa__, struct merlin16_shasta_usr_ctrl_disable_functions_st *get_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_get_usr_ctrl_disable_startup_dfe(srds_access_t *sa__, struct merlin16_shasta_usr_ctrl_disable_dfe_functions_st *get_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_get_usr_ctrl_disable_steady_state(srds_access_t *sa__, struct merlin16_shasta_usr_ctrl_disable_functions_st *get_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_get_usr_ctrl_disable_steady_state_dfe(srds_access_t *sa__, struct merlin16_shasta_usr_ctrl_disable_dfe_functions_st *get_val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_reg_dump(srds_access_t *sa__, uint8_t core, uint8_t lane, char reg_buffer[][250]);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_uc_core_var_dump(srds_access_t *sa__, uint8_t core, char ram_buffer[][250]);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_uc_lane_var_dump(srds_access_t *sa__, uint8_t core, uint8_t lane, char ram_buffer[][250]);
 ...
 */
err_code_t merlin16_shasta_tx_pi_jitt_gen(srds_access_t *sa__, uint8_t enable, int16_t freq_override_val, enum srds_tx_pi_freq_jit_gen_enum jit_type, uint8_t tx_pi_jit_freq_idx, uint8_t tx_pi_jit_amp);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_read_event_log(srds_access_t *sa__);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_set_usr_ctrl_lane_event_log_level(srds_access_t *sa__, uint8_t lane_event_log_level);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_get_usr_ctrl_lane_event_log_level(srds_access_t *sa__, uint8_t *lane_event_log_level);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_set_usr_ctrl_core_event_log_level(srds_access_t *sa__, uint8_t core_event_log_level);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_get_usr_ctrl_core_event_log_level(srds_access_t *sa__, uint8_t *core_event_log_level);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_dig_lpbk(srds_access_t *sa__, uint8_t enable);
