...
/** @file merlin16_shasta_diag.h
 * Diagnostic functions provided to IP User
 */

#ifndef MERLIN16_SHASTA_API_DIAG_H
#define MERLIN16_SHASTA_API_DIAG_H
...
struct merlin16_shasta_eyescan_options_st {
...
/** Column definition header for merlin16_shasta_display_core_state() API output.
 * To be called before merlin16_shasta_display_core_state_line() API.
 ...
 * Call merlin16_shasta_display_core_state_hdr() API before and merlin16_shasta_display_core_state_legend() after
...
/** Detailed description of each column in merlin16_shasta_display_core_state_line() API output.
 * To be called after merlin16_shasta_display_core_state_line() API to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function only initiates the processor actions.  User must use merlin16_shasta_read_eye_scan_stripe() function
 ...
 * merlin16_shasta_start_ber_scan_test(), merlin16_shasta_read_ber_scan_data(), merlin16_shasta_display_ber_scan_data().
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum)
 ...
 * \n Note: Call functions merlin16_shasta_display_lane_state_hdr() before and merlin16_shasta_display_lane_state_legend() after
...
/** Column definition header for merlin16_shasta display state.
 * To be called before merlin16_shasta_display_lane_state() function.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_shasta_display_lane_state_hdr(void);

/** Detailed explanation of each column in merlin16_shasta display state.
 * To be called after merlin16_shasta_display_lane_state() function to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function is required to be implemented by upper level software to enable merlin16_shasta support.
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/** Parameterized diagnostic function which access to all merlin16_shasta control and status bits
 * This function is required to be implemented by upper level software to enable merlin16_shasta support.
 * @param sa__ is an opaque state vector passed through to device access functions.
