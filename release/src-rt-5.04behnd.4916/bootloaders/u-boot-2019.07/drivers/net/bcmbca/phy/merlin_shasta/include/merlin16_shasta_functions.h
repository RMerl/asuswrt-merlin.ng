...
/***********************************************************************************
 ***********************************************************************************
 *  File Name  :  merlin16_shasta_functions.h                                           *
...
#ifndef MERLIN16_SHASTA_API_FUNCTIONS_H
#define MERLIN16_SHASTA_API_FUNCTIONS_H
    ...
    do  { \
        ...
        *(__ERR) = (expr); \
        if (*(__ERR) != ERR_CODE_NONE) { \
            return merlin16_shasta_error_report(sa__, *(__ERR)); \
        }\
        (void)__err; \
    }   while(0)
/**
 ...
 *  Only used in merlin16_shasta_INTERNAL_print_triage_info() and requires __err to be declared.
 */
