 ...
 * (https://broadcom.box.com/v/merlin16_shasta-common-16nm)
 * \n \n
 *
 * \section API_sec Important API Files
 *
 * merlin16_shasta_interface.h - provides the primary functionality.
 *
 * merlin16_shasta_dependencies.h - defines the functions to be provided by the IP user
 */

/** @file merlin16_shasta_interface.h
 * Main interface functions provided to IP User
 */

#ifndef MERLIN16_SHASTA_API_INTERFACE_H
#define MERLIN16_SHASTA_API_INTERFACE_H

#include "merlin16_shasta_access.h"
#include "merlin16_shasta_config.h"
#include "merlin16_shasta_debug_functions.h"
#include "merlin16_shasta_diag.h"
