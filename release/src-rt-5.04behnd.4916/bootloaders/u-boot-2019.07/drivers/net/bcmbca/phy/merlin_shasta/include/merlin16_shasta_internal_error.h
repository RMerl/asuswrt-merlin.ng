...
/** @file merlin16_shasta_internal_error.h
 * Internal API error functions
 */

#ifndef MERLIN16_SHASTA_API_INTERNAL_ERROR_H
#define MERLIN16_SHASTA_API_INTERNAL_ERROR_H
 ...
 */
#define merlin16_shasta_error_report(sa__, err_code) \
        merlin16_shasta_INTERNAL_print_err_msg_and_triage_info(sa__, (err_code), __FILE__, API_FUNCTION_NAME, __LINE__)
/**@}*/

/* Prints error code, containing function, file and line number */
#define merlin16_shasta_error(sa__, err_code) \
        merlin16_shasta_INTERNAL_print_err_msg(sa__, (err_code), __FILE__, API_FUNCTION_NAME, __LINE__)
 ...
 * @return Error Code
 */
err_code_t merlin16_shasta_INTERNAL_print_err_msg(srds_access_t *sa__, uint16_t err_code, const char *filename, const char *func_name, uint16_t line);
 ...
 * @return Error Code
 */
err_code_t merlin16_shasta_INTERNAL_print_err_msg_and_triage_info(srds_access_t *sa__, uint16_t err_code, const char *filename, const char *func_name, uint16_t line);
 ...
 */
const char* merlin16_shasta_INTERNAL_e2s_err_code(err_code_t err_code);
