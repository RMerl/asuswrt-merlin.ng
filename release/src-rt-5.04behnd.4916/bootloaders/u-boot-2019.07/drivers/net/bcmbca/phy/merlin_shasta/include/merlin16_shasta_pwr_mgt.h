...
/** @file merlin16_shasta_pwr_mgt.h
 * Power management functions provided to IP User
 */
#ifndef MERLIN16_SHASTA_API_PWR_MGT_H
#define MERLIN16_SHASTA_API_PWR_MGT_H
 ...
 * Note: User also needs to configure all lanes through merlin16_shasta_lane_config_for_iddq()
 ...
 * Along with merlin16_shasta_core_pwrdn(), all lanes powerdowns should also be issued using
 * merlin16_shasta_lane_pwrdn() to complete a Core Powerdown.
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * Note: User needs to configure all lanes through merlin16_shasta_lane_config_for_iddq() and also call merlin16_shasta_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
