...
/***********************************************************************************
 ***********************************************************************************
 *  File Name     :  merlin16_shortfin_internal.c                                         *
...
err_code_t merlin16_shortfin_INTERNAL_get_BER_string(srds_access_t *sa__, uint16_t time_ms, char *string) {
    char string2[3];
    struct merlin16_shortfin_ber_data_st ber_data_local = {0, 0, 0, 0};
...
err_code_t merlin16_shortfin_INTERNAL_get_BER_data(srds_access_t *sa__, uint16_t time_ms, struct merlin16_shortfin_ber_data_st *ber_data, enum merlin16_shortfin_prbs_chk_timer_selection_enum timer_sel) {
    uint8_t lcklost = 0;
    uint32_t err_cnt= 0;
    ...
    if((time_ms <= PRBS_MAX_HW_TIMER_TIMEOUT) && (timer_sel == USE_HW_TIMERS)) {
        ...
        struct merlin16_shortfin_prbs_chk_hw_timer_ctrl_st prbs_chk_hw_timer_ctrl_bak;
        USR_MEMSET(&prbs_chk_hw_timer_ctrl_bak, 0, sizeof(struct merlin16_shortfin_prbs_chk_hw_timer_ctrl_st));
...
#if defined(MERLIN16_SHORTFIN_PRBS_CHK_HARDWARE_TIMERS)
err_code_t merlin16_shortfin_INTERNAL_get_prbs_timeout_count_from_time(uint16_t time_ms, uint16_t * time_ms_adjusted, struct merlin16_shortfin_prbs_chk_hw_timer_ctrl_st * const prbs_chk_hw_timer_ctrl ) {
