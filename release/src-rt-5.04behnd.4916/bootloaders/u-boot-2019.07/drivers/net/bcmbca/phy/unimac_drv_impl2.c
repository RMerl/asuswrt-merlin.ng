...
/* impl2 has mib counter as in part of conf,
...
void * unimac_conf_base;
void * unimac_mib_base;
void * unimac_top_base;
...
static int unimac_probe(dt_device_t *pdev)
{
    ...
    dev_dbg(&pdev->dev, "unimac_conf_base=0x%p\n", unimac_conf_base);
    dev_dbg(&pdev->dev, "unimac_mib_base=0x%p\n", unimac_mib_base);
    dev_dbg(&pdev->dev, "unimac_top_base=0x%p\n", unimac_top_base);
...
#ifdef __UBOOT__
static const struct udevice_id unimac_ids[] = {
    { .compatible = "brcm,unimac" },
    { .compatible = "brcm,unimac3" },
    { /* end of list */ },
};

U_BOOT_DRIVER(brcm_unimac) = {
    .name	= "brcm-unimac",
    .id	= UCLASS_MISC,
    .of_match = unimac_ids,
    .probe = unimac_probe,
...
/*                                                                           */
/*****************************************************************************/
#if !(defined(CONFIG_BCM963158) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM96856) || defined(CONFIG_BCM947622) || defined(CONFIG_BCM96878) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912) || defined(CONFIG_BCM96813))
#ifdef __UBOOT__
static void get_rdp_freq(unsigned int *rdp_freq) {}
#else
#include "clk_rst.h"
#endif
#endif
...
void mac_hwapi_get_rx_counters64(rdpa_emac emacNum,rdpa_emac_rx_stat64_t *rxCounters)
{
    ...
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, alignment_error);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, broadcast_packet);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, unicast_packet);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 48, byte);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, carrier_sense_error);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, code_error);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, control_frame);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, fcs_error);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, frame_64);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, frame_65_127);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, frame_128_255);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, frame_256_511);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, frame_512_1023);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, frame_1024_1518);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, frame_1519_mtu);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, frame_length_error);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, jabber);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, multicast_packet);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, oversize_packet);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, undersize_packet);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, packet);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, pause_control_frame);
    UNIMAC_CURRENT_COUNTERS(emacNum, rxCounters, rxCountersLast, 40, unknown_opcode);
}
EXPORT_SYMBOL(mac_hwapi_get_rx_counters64);
...
void mac_hwapi_get_tx_counters64(rdpa_emac emacNum,rdpa_emac_tx_stat64_t *txCounters)
{
    ...
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 48, byte);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, packet);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, broadcast_packet);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, multicast_packet);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, unicast_packet);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, deferral_packet);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, excessive_deferral_packet);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, control_frame);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, jabber_frame);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, oversize_frame);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, pause_control_frame);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, fragments_frame);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, error);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, fcs_error);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, frame_64);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, frame_65_127);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, frame_128_255);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, frame_256_511);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, frame_512_1023);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, frame_1024_1518);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, frame_1519_mtu);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, single_collision);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, total_collision);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, late_collision);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, multiple_collision);
    UNIMAC_CURRENT_COUNTERS(emacNum, txCounters, txCountersLast, 40, excessive_collision);
}
EXPORT_SYMBOL(mac_hwapi_get_tx_counters64);
...
{
#if !defined(CONFIG_BCM947622) && !defined(CONFIG_BCM963146) && !defined(CONFIG_BCM94912) && !defined(CONFIG_BCM96813) && !defined(CONFIG_BCM96855)
