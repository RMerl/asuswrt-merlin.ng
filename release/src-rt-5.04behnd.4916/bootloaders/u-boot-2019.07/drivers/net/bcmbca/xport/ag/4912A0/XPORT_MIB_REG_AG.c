...
/******************************************************************************
 * Field: XPORT_MIB_REG_CONTROL_RESERVED0
 ******************************************************************************/
const ru_field_rec XPORT_MIB_REG_CONTROL_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    XPORT_MIB_REG_CONTROL_RESERVED0_FIELD_MASK,
    0,
    XPORT_MIB_REG_CONTROL_RESERVED0_FIELD_WIDTH,
    XPORT_MIB_REG_CONTROL_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_MIB_REG_CONTROL_EEE_CNT_MODE
 ******************************************************************************/
const ru_field_rec XPORT_MIB_REG_CONTROL_EEE_CNT_MODE_FIELD =
{
    "EEE_CNT_MODE",
#if RU_INCLUDE_DESC
    "",
...
#endif
    XPORT_MIB_REG_CONTROL_EEE_CNT_MODE_FIELD_MASK,
    0,
    XPORT_MIB_REG_CONTROL_EEE_CNT_MODE_FIELD_WIDTH,
    XPORT_MIB_REG_CONTROL_EEE_CNT_MODE_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_MIB_REG_CONTROL_SATURATE_EN
 ******************************************************************************/
const ru_field_rec XPORT_MIB_REG_CONTROL_SATURATE_EN_FIELD =
{
    "SATURATE_EN",
#if RU_INCLUDE_DESC
    "",
...
#endif
    XPORT_MIB_REG_CONTROL_SATURATE_EN_FIELD_MASK,
    0,
    XPORT_MIB_REG_CONTROL_SATURATE_EN_FIELD_WIDTH,
    XPORT_MIB_REG_CONTROL_SATURATE_EN_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_MIB_REG_CONTROL_COR_EN
 ******************************************************************************/
const ru_field_rec XPORT_MIB_REG_CONTROL_COR_EN_FIELD =
{
    "COR_EN",
#if RU_INCLUDE_DESC
    "",
...
#endif
    XPORT_MIB_REG_CONTROL_COR_EN_FIELD_MASK,
    0,
    XPORT_MIB_REG_CONTROL_COR_EN_FIELD_WIDTH,
    XPORT_MIB_REG_CONTROL_COR_EN_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_MIB_REG_CONTROL_CNT_RST
 ******************************************************************************/
const ru_field_rec XPORT_MIB_REG_CONTROL_CNT_RST_FIELD =
{
    "CNT_RST",
#if RU_INCLUDE_DESC
    "",
...
#endif
    XPORT_MIB_REG_CONTROL_CNT_RST_FIELD_MASK,
    0,
    XPORT_MIB_REG_CONTROL_CNT_RST_FIELD_WIDTH,
    XPORT_MIB_REG_CONTROL_CNT_RST_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Register: XPORT_MIB_REG_CONTROL
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPORT_MIB_REG_CONTROL_FIELDS[] =
{
    &XPORT_MIB_REG_CONTROL_RESERVED0_FIELD,
    &XPORT_MIB_REG_CONTROL_EEE_CNT_MODE_FIELD,
    &XPORT_MIB_REG_CONTROL_SATURATE_EN_FIELD,
    &XPORT_MIB_REG_CONTROL_COR_EN_FIELD,
    &XPORT_MIB_REG_CONTROL_CNT_RST_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPORT_MIB_REG_CONTROL_REG = 
{
    "CONTROL",
#if RU_INCLUDE_DESC
    "MIB Control/Config Register",
    "",
#endif
    XPORT_MIB_REG_CONTROL_REG_OFFSET,
    0,
    0,
    196,
#if RU_INCLUDE_ACCESS
