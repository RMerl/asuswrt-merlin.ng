...
/******************************************************************************
 * Field: XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII3_TX_FIFO_MAX_DEPTH
 ******************************************************************************/
const ru_field_rec XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII3_TX_FIFO_MAX_DEPTH_FIELD =
{
    "XGMII3_TX_FIFO_MAX_DEPTH",
#if RU_INCLUDE_DESC
    "",
    "XGMII P3 asynchronous TX FIFO maximal allowed depth, in 72-bit fifo write words. Zero means no soft limit.",
#endif
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII3_TX_FIFO_MAX_DEPTH_FIELD_MASK,
    0,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII3_TX_FIFO_MAX_DEPTH_FIELD_WIDTH,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII3_TX_FIFO_MAX_DEPTH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII2_TX_FIFO_MAX_DEPTH
 ******************************************************************************/
const ru_field_rec XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII2_TX_FIFO_MAX_DEPTH_FIELD =
{
    "XGMII2_TX_FIFO_MAX_DEPTH",
#if RU_INCLUDE_DESC
    "",
    "XGMII P2 asynchronous TX FIFO maximal allowed depth, in 72-bit fifo write words. Zero means no soft limit.",
#endif
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII2_TX_FIFO_MAX_DEPTH_FIELD_MASK,
    0,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII2_TX_FIFO_MAX_DEPTH_FIELD_WIDTH,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII2_TX_FIFO_MAX_DEPTH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII1_TX_FIFO_MAX_DEPTH
 ******************************************************************************/
const ru_field_rec XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII1_TX_FIFO_MAX_DEPTH_FIELD =
{
    "XGMII1_TX_FIFO_MAX_DEPTH",
#if RU_INCLUDE_DESC
    "",
    "XGMII P1 asynchronous TX FIFO maximal allowed depth, in 72-bit fifo write words. Zero means no soft limit.",
#endif
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII1_TX_FIFO_MAX_DEPTH_FIELD_MASK,
    0,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII1_TX_FIFO_MAX_DEPTH_FIELD_WIDTH,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII1_TX_FIFO_MAX_DEPTH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII0_TX_FIFO_MAX_DEPTH
 ******************************************************************************/
const ru_field_rec XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII0_TX_FIFO_MAX_DEPTH_FIELD =
{
    "XGMII0_TX_FIFO_MAX_DEPTH",
#if RU_INCLUDE_DESC
    "",
    "XGMII P0 asynchronous TX FIFO maximal allowed depth, in 72-bit fifo write words. Zero means no soft limit.",
#endif
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII0_TX_FIFO_MAX_DEPTH_FIELD_MASK,
    0,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII0_TX_FIFO_MAX_DEPTH_FIELD_WIDTH,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII0_TX_FIFO_MAX_DEPTH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII3_TX_FIFO_MAX_DEPTH
 ******************************************************************************/
const ru_field_rec XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII3_TX_FIFO_MAX_DEPTH_FIELD =
{
    "GMII3_TX_FIFO_MAX_DEPTH",
#if RU_INCLUDE_DESC
    "",
    "GMII P3 asynchronous TX FIFO maximal allowed depth, in 80-bit fifo write words. Zero means no soft limit.",
#endif
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII3_TX_FIFO_MAX_DEPTH_FIELD_MASK,
    0,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII3_TX_FIFO_MAX_DEPTH_FIELD_WIDTH,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII3_TX_FIFO_MAX_DEPTH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII2_TX_FIFO_MAX_DEPTH
 ******************************************************************************/
const ru_field_rec XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII2_TX_FIFO_MAX_DEPTH_FIELD =
{
    "GMII2_TX_FIFO_MAX_DEPTH",
#if RU_INCLUDE_DESC
    "",
    "GMII P2 asynchronous TX FIFO maximal allowed depth, in 80-bit fifo write words. Zero means no soft limit.",
#endif
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII2_TX_FIFO_MAX_DEPTH_FIELD_MASK,
    0,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII2_TX_FIFO_MAX_DEPTH_FIELD_WIDTH,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII2_TX_FIFO_MAX_DEPTH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII1_TX_FIFO_MAX_DEPTH
 ******************************************************************************/
const ru_field_rec XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII1_TX_FIFO_MAX_DEPTH_FIELD =
{
    "GMII1_TX_FIFO_MAX_DEPTH",
#if RU_INCLUDE_DESC
    "",
    "GMII P1 asynchronous TX FIFO maximal allowed depth, in 80-bit fifo write words. Zero means no soft limit.",
#endif
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII1_TX_FIFO_MAX_DEPTH_FIELD_MASK,
    0,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII1_TX_FIFO_MAX_DEPTH_FIELD_WIDTH,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII1_TX_FIFO_MAX_DEPTH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII0_TX_FIFO_MAX_DEPTH
 ******************************************************************************/
const ru_field_rec XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII0_TX_FIFO_MAX_DEPTH_FIELD =
{
    "GMII0_TX_FIFO_MAX_DEPTH",
#if RU_INCLUDE_DESC
    "",
    "GMII P0 asynchronous TX FIFO maximal allowed depth, in 80-bit fifo write words. Zero means no soft limit.",
#endif
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII0_TX_FIFO_MAX_DEPTH_FIELD_MASK,
    0,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII0_TX_FIFO_MAX_DEPTH_FIELD_WIDTH,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII0_TX_FIFO_MAX_DEPTH_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Register: XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG
 ******************************************************************************/
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_FIELDS[] =
{
    &XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII3_TX_FIFO_MAX_DEPTH_FIELD,
    &XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII2_TX_FIFO_MAX_DEPTH_FIELD,
    &XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII1_TX_FIFO_MAX_DEPTH_FIELD,
    &XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_XGMII0_TX_FIFO_MAX_DEPTH_FIELD,
    &XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII3_TX_FIFO_MAX_DEPTH_FIELD,
    &XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII2_TX_FIFO_MAX_DEPTH_FIELD,
    &XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII1_TX_FIFO_MAX_DEPTH_FIELD,
    &XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_GMII0_TX_FIFO_MAX_DEPTH_FIELD,
};

#endif /* RU_INCLUDE_FIELD_DB */

const ru_reg_rec XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_REG = 
{
    "TX_FIFO_MAX_DEPTH_CFG",
#if RU_INCLUDE_DESC
    "MSBUS Adaptation TX FIFO Max Depth Configuration Register",
    "This register defines soft limits for TX fifo sizes.",
#endif
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_REG_OFFSET,
    0,
    0,
    231,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    8,
    XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_FIELDS,
#endif /* RU_INCLUDE_FIELD_DB */
    ru_reg_size_32
};
...
static const ru_reg_rec *XPORT_MAB_REGS[] =
{
    ...
    &XPORT_MAB_TX_FIFO_MAX_DEPTH_CFG_REG,
};
