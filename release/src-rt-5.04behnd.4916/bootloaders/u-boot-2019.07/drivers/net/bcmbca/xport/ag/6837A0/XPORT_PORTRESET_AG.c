...
#if RU_INCLUDE_DESC
    "",
    "Allow the port reset state machine to assert XLMAC_RX_DISAB.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Allow the port reset state machine to assert XLMAC_TX_DISAB.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Allow the port reset state machine to assert XLMAC_TX_DISCARD.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Allow the port reset state machine to assert XLMAC_SOFT_RESET.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Allow the port reset state machine to assert MAB_RX_PORT_INIT.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Allow the port reset state machine to assert MAB_TX_PORT_INIT.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Allow the port reset state machine to assert MAB_TX_CREDIT_DISAB.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Allow the port reset state machine to assert MAB_TX_FIFO_INIT.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Allow the port reset state machine to assert the \"port is under reset\" indication.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Allow the port reset state machine to assert XLMAC_EP_DISCARD.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of XLMAC_RX_DISAB signal assertion after the effective link-down event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of XLMAC_TX_DISAB signal assertion after the effective link-down event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of XLMAC_TX_DISCARD signal assertion after the effective link-down event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of XLMAC_SOFT_RESET signal assertion after the effective link-down event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of MAB_RX_PORT_INIT signal assertion after the effective link-down event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of MAB_TX_PORT_INIT signal assertion after the effective link-down event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of MAB_TX_CREDIT_DISAB signal assertion after the effective link-down event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of MAB_TX_FIFO_INIT signal assertion after the effective link-down event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of PORT_IS_UNDER_RESET signal assertion after the effective link-down event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of LMAC_RX_DISAB signal de-assertion after the effective link-up event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of XLMAC_TX_DISAB signal de-assertion after the effective link-up event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of XLMAC_TX_DISCARD signal de-assertion after the effective link-up event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of XLMAC_SOFT_RESET signal de-assertion after the effective link-up event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of MAB_RX_PORT_INIT signal de-assertion after the effective link-up event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of MAB_TX_PORT_INIT signal de-assertion after the effective link-up event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of MAB_TX_CREDIT_DISAB signal de-assertion after the effective link-up event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of MAB_TX_FIFO_INIT signal de-assertion after the effective link-up event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Specifies the time of PORT_IS_UNDER_RESET signal de-assertion after the effective link-up event in the port reset state machine.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Port3 port reset state machine state.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Port2 port reset state machine state.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Port1 port reset state machine state.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Port0 port reset state machine state.",
#endif
