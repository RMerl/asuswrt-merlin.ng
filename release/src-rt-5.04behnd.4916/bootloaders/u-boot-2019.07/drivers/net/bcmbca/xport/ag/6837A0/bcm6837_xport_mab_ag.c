...
{
    uint32_t reg_tx_fifo_max_depth_cfg=0;

#ifdef VALIDATE_PARMS
    if(!tx_fifo_max_depth_cfg)
    {
        pr_err("ERROR driver %s:%u|(%d)\n", __FILE__, __LINE__, 1);
        return 1;
    }
    if((xlmac_id >= BLOCK_ADDR_COUNT) ||
       (tx_fifo_max_depth_cfg->xgmii3_tx_fifo_max_depth >= _4BITS_MAX_VAL_) ||
       (tx_fifo_max_depth_cfg->xgmii2_tx_fifo_max_depth >= _4BITS_MAX_VAL_) ||
       (tx_fifo_max_depth_cfg->xgmii1_tx_fifo_max_depth >= _4BITS_MAX_VAL_) ||
       (tx_fifo_max_depth_cfg->xgmii0_tx_fifo_max_depth >= _4BITS_MAX_VAL_) ||
       (tx_fifo_max_depth_cfg->gmii3_tx_fifo_max_depth >= _4BITS_MAX_VAL_) ||
       (tx_fifo_max_depth_cfg->gmii2_tx_fifo_max_depth >= _4BITS_MAX_VAL_) ||
       (tx_fifo_max_depth_cfg->gmii1_tx_fifo_max_depth >= _4BITS_MAX_VAL_) ||
       (tx_fifo_max_depth_cfg->gmii0_tx_fifo_max_depth >= _4BITS_MAX_VAL_))
    {
        pr_err("ERROR driver %s:%u|(%d)\n", __FILE__, __LINE__, 0);
        return 0;
    }
    ...
    reg_tx_fifo_max_depth_cfg = RU_FIELD_SET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, XGMII3_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg, tx_fifo_max_depth_cfg->xgmii3_tx_fifo_max_depth);
    reg_tx_fifo_max_depth_cfg = RU_FIELD_SET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, XGMII2_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg, tx_fifo_max_depth_cfg->xgmii2_tx_fifo_max_depth);
    reg_tx_fifo_max_depth_cfg = RU_FIELD_SET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, XGMII1_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg, tx_fifo_max_depth_cfg->xgmii1_tx_fifo_max_depth);
    reg_tx_fifo_max_depth_cfg = RU_FIELD_SET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, XGMII0_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg, tx_fifo_max_depth_cfg->xgmii0_tx_fifo_max_depth);
    reg_tx_fifo_max_depth_cfg = RU_FIELD_SET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, GMII3_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg, tx_fifo_max_depth_cfg->gmii3_tx_fifo_max_depth);
    reg_tx_fifo_max_depth_cfg = RU_FIELD_SET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, GMII2_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg, tx_fifo_max_depth_cfg->gmii2_tx_fifo_max_depth);
    reg_tx_fifo_max_depth_cfg = RU_FIELD_SET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, GMII1_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg, tx_fifo_max_depth_cfg->gmii1_tx_fifo_max_depth);
    reg_tx_fifo_max_depth_cfg = RU_FIELD_SET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, GMII0_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg, tx_fifo_max_depth_cfg->gmii0_tx_fifo_max_depth);

    RU_REG_WRITE(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, reg_tx_fifo_max_depth_cfg);
...
int ag_drv_xport_mab_tx_fifo_max_depth_cfg_get(uint8_t xlmac_id, xport_mab_tx_fifo_max_depth_cfg *tx_fifo_max_depth_cfg)
{
    ...
    RU_REG_READ(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, reg_tx_fifo_max_depth_cfg);

    tx_fifo_max_depth_cfg->xgmii3_tx_fifo_max_depth = RU_FIELD_GET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, XGMII3_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg);
    tx_fifo_max_depth_cfg->xgmii2_tx_fifo_max_depth = RU_FIELD_GET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, XGMII2_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg);
    tx_fifo_max_depth_cfg->xgmii1_tx_fifo_max_depth = RU_FIELD_GET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, XGMII1_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg);
    tx_fifo_max_depth_cfg->xgmii0_tx_fifo_max_depth = RU_FIELD_GET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, XGMII0_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg);
    tx_fifo_max_depth_cfg->gmii3_tx_fifo_max_depth = RU_FIELD_GET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, GMII3_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg);
    tx_fifo_max_depth_cfg->gmii2_tx_fifo_max_depth = RU_FIELD_GET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, GMII2_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg);
    tx_fifo_max_depth_cfg->gmii1_tx_fifo_max_depth = RU_FIELD_GET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, GMII1_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg);
    tx_fifo_max_depth_cfg->gmii0_tx_fifo_max_depth = RU_FIELD_GET(xlmac_id, XPORT_MAB, TX_FIFO_MAX_DEPTH_CFG, GMII0_TX_FIFO_MAX_DEPTH, reg_tx_fifo_max_depth_cfg);
