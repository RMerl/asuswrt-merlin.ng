...
#ifndef _BCM6837_XPORT_MAB_AG_H_
#define _BCM6837_XPORT_MAB_AG_H_
...
/**************************************************************************************************/
/* xgmii3_tx_fifo_max_depth:  - XGMII P3 asynchronous TX FIFO maximal allowed depth, in 72-bit fi */
/*                           fo write words. Zero means no soft limit.                            */
/* xgmii2_tx_fifo_max_depth:  - XGMII P2 asynchronous TX FIFO maximal allowed depth, in 72-bit fi */
/*                           fo write words. Zero means no soft limit.                            */
/* xgmii1_tx_fifo_max_depth:  - XGMII P1 asynchronous TX FIFO maximal allowed depth, in 72-bit fi */
/*                           fo write words. Zero means no soft limit.                            */
/* xgmii0_tx_fifo_max_depth:  - XGMII P0 asynchronous TX FIFO maximal allowed depth, in 72-bit fi */
/*                           fo write words. Zero means no soft limit.                            */
/* gmii3_tx_fifo_max_depth:  - GMII P3 asynchronous TX FIFO maximal allowed depth, in 80-bit fifo */
/*                           write words. Zero means no soft limit.                               */
/* gmii2_tx_fifo_max_depth:  - GMII P2 asynchronous TX FIFO maximal allowed depth, in 80-bit fifo */
/*                           write words. Zero means no soft limit.                               */
/* gmii1_tx_fifo_max_depth:  - GMII P1 asynchronous TX FIFO maximal allowed depth, in 80-bit fifo */
/*                           write words. Zero means no soft limit.                               */
/* gmii0_tx_fifo_max_depth:  - GMII P0 asynchronous TX FIFO maximal allowed depth, in 80-bit fifo */
/*                           write words. Zero means no soft limit.                               */
/**************************************************************************************************/
typedef struct
{
    uint8_t xgmii3_tx_fifo_max_depth;
    uint8_t xgmii2_tx_fifo_max_depth;
    uint8_t xgmii1_tx_fifo_max_depth;
    uint8_t xgmii0_tx_fifo_max_depth;
    uint8_t gmii3_tx_fifo_max_depth;
    uint8_t gmii2_tx_fifo_max_depth;
    uint8_t gmii1_tx_fifo_max_depth;
    uint8_t gmii0_tx_fifo_max_depth;
} xport_mab_tx_fifo_max_depth_cfg;
...
int ag_drv_xport_mab_tx_fifo_max_depth_cfg_set(uint8_t xlmac_id, const xport_mab_tx_fifo_max_depth_cfg *tx_fifo_max_depth_cfg);
int ag_drv_xport_mab_tx_fifo_max_depth_cfg_get(uint8_t xlmac_id, xport_mab_tx_fifo_max_depth_cfg *tx_fifo_max_depth_cfg);
