...
#ifndef _BCM6888_XPORT_PORTRESET_AG_H_
#define _BCM6888_XPORT_PORTRESET_AG_H_


/**************************************************************************************************/
/* enable_xlmac_rx_disab:  - Allow the port reset state machine to assert XLMAC_RX_DISAB.         */
/* enable_xlmac_tx_disab:  - Allow the port reset state machine to assert XLMAC_TX_DISAB.         */
/* enable_xlmac_tx_discard:  - Allow the port reset state machine to assert XLMAC_TX_DISCARD.     */
/* enable_xlmac_soft_reset:  - Allow the port reset state machine to assert XLMAC_SOFT_RESET.     */
/* enable_mab_rx_port_init:  - Allow the port reset state machine to assert MAB_RX_PORT_INIT.     */
/* enable_mab_tx_port_init:  - Allow the port reset state machine to assert MAB_TX_PORT_INIT.     */
/* enable_mab_tx_credit_disab:  - Allow the port reset state machine to assert MAB_TX_CREDIT_DISA */
/*                             B.                                                                 */
/* enable_mab_tx_fifo_init:  - Allow the port reset state machine to assert MAB_TX_FIFO_INIT.     */
/* enable_port_is_under_reset:  - Allow the port reset state machine to assert the "port is under */
/*                              reset" indication.                                                */
/* enable_xlmac_ep_discard:  - Allow the port reset state machine to assert XLMAC_EP_DISCARD.     */
/**************************************************************************************************/
typedef struct
{
