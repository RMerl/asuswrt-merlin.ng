...
#if defined(BCM_WARN_SUPPORTED)
#define BCM_WARNCODE(code)    code
#else
#define BCM_WARNCODE(code)
#endif /*defined(BCM_WARN_SUPPORTED)*/
...
/**
 * Warn API: Activate by #defining BCM_WARN_SUPPORTED
 **/

#define BCM_WARN(cond)                                         \
    BCM_WARNCODE( if ( !(cond) ) {                                    \
                        bcm_printk(CLRerr "[WARN " "%s" "] %-10s,%d: " #cond CLRnl, \
                               __FILE__, __FUNCTION__, __LINE__); \
                        WARN_ON(1);                                          \
                     } )
