...
/* Caution changing dpi_queue bits needs new fcache binary */ 
...
/* Caution changing service_queue_enable_mark bit needs new fcache binary */ 
...
#define SKBMARK_CLEAR_SQ_MARK(MARK) \
    ((MARK & ~SKBMARK_SQ_MARK_M))
