...
int (*dpi_tdts_shell_dpi_l3_skb)(struct sk_buff *skb, void *p);
EXPORT_SYMBOL(dpi_tdts_shell_dpi_l3_skb);

int (*dpi_tdts_shell_system_setting_tcp_conn_max_get)(unsigned *p);
EXPORT_SYMBOL(dpi_tdts_shell_system_setting_tcp_conn_max_get);

int (*dpi_tdts_shell_system_setting_tcp_conn_timeout_get)(unsigned *p);
EXPORT_SYMBOL(dpi_tdts_shell_system_setting_tcp_conn_timeout_get);

int (*dpi_tdts_shell_system_setting_udp_conn_max_get)(unsigned *p);
EXPORT_SYMBOL(dpi_tdts_shell_system_setting_udp_conn_max_get);

int (*dpi_tdts_shell_tcp_conn_remove)(uint8_t ip_ver, uint8_t *sip,
		uint8_t *dip, uint16_t sport, uint16_t dport);
EXPORT_SYMBOL(dpi_tdts_shell_tcp_conn_remove);

int (*dpi_tdts_shell_udp_conn_remove)(uint8_t ip_ver, uint8_t *sip,
		uint8_t *dip, uint16_t sport, uint16_t dport);
EXPORT_SYMBOL(dpi_tdts_shell_udp_conn_remove);
