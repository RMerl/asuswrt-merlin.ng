...
#if RU_INCLUDE_FIELD_DB
/***** Field: CTR0_RST *****/
const ru_field_rec BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR0_RST_FIELD =
{
    "CTR0_RST",
#if RU_INCLUDE_DESC
    "",
...
#endif
    { BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR0_RST_FIELD_MASK },
    0,
    { BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR0_RST_FIELD_WIDTH },
    { BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR0_RST_FIELD_SHIFT },
    0,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
#endif
...
#if RU_INCLUDE_FIELD_DB
/***** Field: CTR1_RST *****/
const ru_field_rec BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR1_RST_FIELD =
{
    "CTR1_RST",
#if RU_INCLUDE_DESC
    "",
...
#endif
    { BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR1_RST_FIELD_MASK },
    0,
    { BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR1_RST_FIELD_WIDTH },
    { BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR1_RST_FIELD_SHIFT },
    0,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
#endif
...
#if RU_INCLUDE_FIELD_DB
/***** Field: CTR2_RST *****/
const ru_field_rec BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR2_RST_FIELD =
{
    "CTR2_RST",
#if RU_INCLUDE_DESC
    "",
...
#endif
    { BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR2_RST_FIELD_MASK },
    0,
    { BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR2_RST_FIELD_WIDTH },
    { BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR2_RST_FIELD_SHIFT },
    0,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
#endif
...
static const ru_field_rec *BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_FIELDS[] =
{
    ...
    &BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR0_RST_FIELD,
    &BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR1_FIELD,
    &BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR1_RST_FIELD,
    &BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR2_FIELD,
    &BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_CTR2_RST_FIELD,
};
#endif /* RU_INCLUDE_FIELD_DB */
...
const ru_reg_rec BUFMNG_COUNTERS_CFG_STAT_HI_WMRK_CFG_REG =
{
    ...
    "3 counter numbers to get the high watermark of, + rst bit for each counter.\n(The rst is executed once when detecting change from 0->1, so if another rst is needed, first need to write 0, then write 1 to the rst bit)\n",
#endif
...
#if RU_INCLUDE_DESC
    "CNTR_INIT Register",
    "initialize counter with a value, and also the hi_wmr to the same value (if the index in amongst the 3 indexes of hi_wmr).\nNo read from this register, since it is not written to a constant register, but is indirect write according to index in field [0..5]. The counters can be read through BufMng.BufMng_BLOCK.counters_cfg_stat.CTRS_VAL.\nThis reg should be waived in register test.\n",
#endif
...
const ru_reg_rec BUFMNG_COUNTERS_CFG_STAT_CNTR_NEG_ST_CLR_REG =
{
    ...
    "32b vector.\nIf bit=1, it clears corresponding bit in cntr_neg_stat register.\nNo physical register(saves space), so no option to read. It only affects the status register, which can be read. This reg should be waived in register test.\n",
#endif
