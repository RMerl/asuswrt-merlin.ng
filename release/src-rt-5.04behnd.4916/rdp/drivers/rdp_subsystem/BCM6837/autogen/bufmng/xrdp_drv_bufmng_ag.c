...
bdmf_error_t ag_drv_bufmng_counters_cfg_stat_hi_wmrk_cfg_set(const bufmng_counters_cfg_stat_hi_wmrk_cfg *counters_cfg_stat_hi_wmrk_cfg)
{
    uint32_t reg_counters_cfg_stat_hi_wmrk_cfg = 0;

#ifdef VALIDATE_PARMS
    if(!counters_cfg_stat_hi_wmrk_cfg)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    if ((counters_cfg_stat_hi_wmrk_cfg->ctr0 >= _5BITS_MAX_VAL_) ||
       (counters_cfg_stat_hi_wmrk_cfg->ctr0_rst >= _1BITS_MAX_VAL_) ||
       (counters_cfg_stat_hi_wmrk_cfg->ctr1 >= _5BITS_MAX_VAL_) ||
       (counters_cfg_stat_hi_wmrk_cfg->ctr1_rst >= _1BITS_MAX_VAL_) ||
       (counters_cfg_stat_hi_wmrk_cfg->ctr2 >= _5BITS_MAX_VAL_) ||
       (counters_cfg_stat_hi_wmrk_cfg->ctr2_rst >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_counters_cfg_stat_hi_wmrk_cfg = RU_FIELD_SET(0, BUFMNG, COUNTERS_CFG_STAT_HI_WMRK_CFG, CTR0, reg_counters_cfg_stat_hi_wmrk_cfg, counters_cfg_stat_hi_wmrk_cfg->ctr0);
    reg_counters_cfg_stat_hi_wmrk_cfg = RU_FIELD_SET(0, BUFMNG, COUNTERS_CFG_STAT_HI_WMRK_CFG, CTR0_RST, reg_counters_cfg_stat_hi_wmrk_cfg, counters_cfg_stat_hi_wmrk_cfg->ctr0_rst);
    reg_counters_cfg_stat_hi_wmrk_cfg = RU_FIELD_SET(0, BUFMNG, COUNTERS_CFG_STAT_HI_WMRK_CFG, CTR1, reg_counters_cfg_stat_hi_wmrk_cfg, counters_cfg_stat_hi_wmrk_cfg->ctr1);
    reg_counters_cfg_stat_hi_wmrk_cfg = RU_FIELD_SET(0, BUFMNG, COUNTERS_CFG_STAT_HI_WMRK_CFG, CTR1_RST, reg_counters_cfg_stat_hi_wmrk_cfg, counters_cfg_stat_hi_wmrk_cfg->ctr1_rst);
    reg_counters_cfg_stat_hi_wmrk_cfg = RU_FIELD_SET(0, BUFMNG, COUNTERS_CFG_STAT_HI_WMRK_CFG, CTR2, reg_counters_cfg_stat_hi_wmrk_cfg, counters_cfg_stat_hi_wmrk_cfg->ctr2);
    reg_counters_cfg_stat_hi_wmrk_cfg = RU_FIELD_SET(0, BUFMNG, COUNTERS_CFG_STAT_HI_WMRK_CFG, CTR2_RST, reg_counters_cfg_stat_hi_wmrk_cfg, counters_cfg_stat_hi_wmrk_cfg->ctr2_rst);
...
bdmf_error_t ag_drv_bufmng_counters_cfg_stat_hi_wmrk_cfg_get(bufmng_counters_cfg_stat_hi_wmrk_cfg *counters_cfg_stat_hi_wmrk_cfg)
{
    ...
    counters_cfg_stat_hi_wmrk_cfg->ctr0 = RU_FIELD_GET(0, BUFMNG, COUNTERS_CFG_STAT_HI_WMRK_CFG, CTR0, reg_counters_cfg_stat_hi_wmrk_cfg);
    counters_cfg_stat_hi_wmrk_cfg->ctr0_rst = RU_FIELD_GET(0, BUFMNG, COUNTERS_CFG_STAT_HI_WMRK_CFG, CTR0_RST, reg_counters_cfg_stat_hi_wmrk_cfg);
    counters_cfg_stat_hi_wmrk_cfg->ctr1 = RU_FIELD_GET(0, BUFMNG, COUNTERS_CFG_STAT_HI_WMRK_CFG, CTR1, reg_counters_cfg_stat_hi_wmrk_cfg);
    counters_cfg_stat_hi_wmrk_cfg->ctr1_rst = RU_FIELD_GET(0, BUFMNG, COUNTERS_CFG_STAT_HI_WMRK_CFG, CTR1_RST, reg_counters_cfg_stat_hi_wmrk_cfg);
    counters_cfg_stat_hi_wmrk_cfg->ctr2 = RU_FIELD_GET(0, BUFMNG, COUNTERS_CFG_STAT_HI_WMRK_CFG, CTR2, reg_counters_cfg_stat_hi_wmrk_cfg);
    counters_cfg_stat_hi_wmrk_cfg->ctr2_rst = RU_FIELD_GET(0, BUFMNG, COUNTERS_CFG_STAT_HI_WMRK_CFG, CTR2_RST, reg_counters_cfg_stat_hi_wmrk_cfg);
...
bdmf_error_t ag_drv_bufmng_counters_cfg_stat_cntr_init_get(uint8_t *idx, uint32_t *val)
{
    uint32_t reg_counters_cfg_stat_cntr_init;
    ...
    RU_REG_READ(0, BUFMNG, COUNTERS_CFG_STAT_CNTR_INIT, reg_counters_cfg_stat_cntr_init);

    *idx = RU_FIELD_GET(0, BUFMNG, COUNTERS_CFG_STAT_CNTR_INIT, IDX, reg_counters_cfg_stat_cntr_init);
    *val = RU_FIELD_GET(0, BUFMNG, COUNTERS_CFG_STAT_CNTR_INIT, VAL, reg_counters_cfg_stat_cntr_init);
...
bdmf_error_t ag_drv_bufmng_counters_cfg_stat_cntr_neg_st_clr_get(uint32_t *val)
{
    uint32_t reg_counters_cfg_stat_cntr_neg_st_clr;
    ...
    RU_REG_READ(0, BUFMNG, COUNTERS_CFG_STAT_CNTR_NEG_ST_CLR, reg_counters_cfg_stat_cntr_neg_st_clr);

    *val = RU_FIELD_GET(0, BUFMNG, COUNTERS_CFG_STAT_CNTR_NEG_ST_CLR, VAL, reg_counters_cfg_stat_cntr_neg_st_clr);
...
static int ag_drv_bufmng_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        bufmng_counters_cfg_stat_hi_wmrk_cfg counters_cfg_stat_hi_wmrk_cfg = { .ctr0 = parm[1].value.unumber, .ctr0_rst = parm[2].value.unumber, .ctr1 = parm[3].value.unumber, .ctr1_rst = parm[4].value.unumber, .ctr2 = parm[5].value.unumber, .ctr2_rst = parm[6].value.unumber};
        ag_err = ag_drv_bufmng_counters_cfg_stat_hi_wmrk_cfg_set(&counters_cfg_stat_hi_wmrk_cfg);
        break;
    }
...
int bcm_bufmng_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_bufmng_counters_cfg_stat_hi_wmrk_cfg:
    {
        bufmng_counters_cfg_stat_hi_wmrk_cfg counters_cfg_stat_hi_wmrk_cfg;
        ag_err = ag_drv_bufmng_counters_cfg_stat_hi_wmrk_cfg_get(&counters_cfg_stat_hi_wmrk_cfg);
        bdmf_session_print(session, "ctr0 = %u = 0x%x\n", counters_cfg_stat_hi_wmrk_cfg.ctr0, counters_cfg_stat_hi_wmrk_cfg.ctr0);
        bdmf_session_print(session, "ctr0_rst = %u = 0x%x\n", counters_cfg_stat_hi_wmrk_cfg.ctr0_rst, counters_cfg_stat_hi_wmrk_cfg.ctr0_rst);
        bdmf_session_print(session, "ctr1 = %u = 0x%x\n", counters_cfg_stat_hi_wmrk_cfg.ctr1, counters_cfg_stat_hi_wmrk_cfg.ctr1);
        bdmf_session_print(session, "ctr1_rst = %u = 0x%x\n", counters_cfg_stat_hi_wmrk_cfg.ctr1_rst, counters_cfg_stat_hi_wmrk_cfg.ctr1_rst);
        bdmf_session_print(session, "ctr2 = %u = 0x%x\n", counters_cfg_stat_hi_wmrk_cfg.ctr2, counters_cfg_stat_hi_wmrk_cfg.ctr2);
        bdmf_session_print(session, "ctr2_rst = %u = 0x%x\n", counters_cfg_stat_hi_wmrk_cfg.ctr2_rst, counters_cfg_stat_hi_wmrk_cfg.ctr2_rst);
        break;
    }
    ...
    case cli_bufmng_counters_cfg_stat_cntr_init:
    {
        uint8_t idx;
        uint32_t val;
        ag_err = ag_drv_bufmng_counters_cfg_stat_cntr_init_get(&idx, &val);
    ...
    {
        uint32_t val;
        ag_err = ag_drv_bufmng_counters_cfg_stat_cntr_neg_st_clr_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    case cli_bufmng_counters_cfg_stat_capt_cfg:
...
static int ag_drv_bufmng_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        bufmng_counters_cfg_stat_hi_wmrk_cfg counters_cfg_stat_hi_wmrk_cfg = {.ctr0 = gtmv(m, 5), .ctr0_rst = gtmv(m, 1), .ctr1 = gtmv(m, 5), .ctr1_rst = gtmv(m, 1), .ctr2 = gtmv(m, 5), .ctr2_rst = gtmv(m, 1)};
        bdmf_session_print(session, "ag_drv_bufmng_counters_cfg_stat_hi_wmrk_cfg_set( %u %u %u %u %u %u)\n",
            counters_cfg_stat_hi_wmrk_cfg.ctr0, counters_cfg_stat_hi_wmrk_cfg.ctr0_rst, counters_cfg_stat_hi_wmrk_cfg.ctr1, counters_cfg_stat_hi_wmrk_cfg.ctr1_rst, 
            counters_cfg_stat_hi_wmrk_cfg.ctr2, counters_cfg_stat_hi_wmrk_cfg.ctr2_rst);
        ag_err = ag_drv_bufmng_counters_cfg_stat_hi_wmrk_cfg_set(&counters_cfg_stat_hi_wmrk_cfg);
        if (!ag_err)
            ag_err = ag_drv_bufmng_counters_cfg_stat_hi_wmrk_cfg_get(&counters_cfg_stat_hi_wmrk_cfg);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_bufmng_counters_cfg_stat_hi_wmrk_cfg_get( %u %u %u %u %u %u)\n",
                counters_cfg_stat_hi_wmrk_cfg.ctr0, counters_cfg_stat_hi_wmrk_cfg.ctr0_rst, counters_cfg_stat_hi_wmrk_cfg.ctr1, counters_cfg_stat_hi_wmrk_cfg.ctr1_rst, 
                counters_cfg_stat_hi_wmrk_cfg.ctr2, counters_cfg_stat_hi_wmrk_cfg.ctr2_rst);
        }
        else
        ...
        if (counters_cfg_stat_hi_wmrk_cfg.ctr0 != gtmv(m, 5) || counters_cfg_stat_hi_wmrk_cfg.ctr0_rst != gtmv(m, 1) || counters_cfg_stat_hi_wmrk_cfg.ctr1 != gtmv(m, 5) || counters_cfg_stat_hi_wmrk_cfg.ctr1_rst != gtmv(m, 1) || counters_cfg_stat_hi_wmrk_cfg.ctr2 != gtmv(m, 5) || counters_cfg_stat_hi_wmrk_cfg.ctr2_rst != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_bufmng_counters_cfg_stat_cntr_init_get( %u %u)\n",
                idx, val);
        }
        else
        {
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_bufmng_counters_cfg_stat_cntr_neg_st_clr_get( %u)\n",
                val);
        }
        else
        {
...
bdmfmon_handle_t ag_drv_bufmng_cli_init(bdmfmon_handle_t root_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_counters_cfg_stat_hi_wmrk_cfg[] = {
            ...
            BDMFMON_MAKE_PARM("ctr0_rst", "ctr0_rst", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("ctr1", "ctr1", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("ctr1_rst", "ctr1_rst", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("ctr2", "ctr2", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("ctr2_rst", "ctr2_rst", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name = "counters_cfg_stat_cntr_init", .val = cli_bufmng_counters_cfg_stat_cntr_init, .parms = get_default },
            { .name = "counters_cfg_stat_cntr_neg_st", .val = cli_bufmng_counters_cfg_stat_cntr_neg_st, .parms = get_default },
            { .name = "counters_cfg_stat_cntr_neg_st_clr", .val = cli_bufmng_counters_cfg_stat_cntr_neg_st_clr, .parms = get_default },
