...
bdmf_error_t ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_set(const dsptchr_reorder_cfg_dsptchr_reordr_cfg *reorder_cfg_dsptchr_reordr_cfg)
{
    ...
    if ((reorder_cfg_dsptchr_reordr_cfg->disp_enable >= _1BITS_MAX_VAL_) ||
       (reorder_cfg_dsptchr_reordr_cfg->auto_init_en >= _1BITS_MAX_VAL_) ||
       (reorder_cfg_dsptchr_reordr_cfg->auto_init_size >= _2BITS_MAX_VAL_) ||
       ...
       (reorder_cfg_dsptchr_reordr_cfg->crdt_eff_rep >= _1BITS_MAX_VAL_) ||
       (reorder_cfg_dsptchr_reordr_cfg->tsk_free_num_place >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_reorder_cfg_dsptchr_reordr_cfg = RU_FIELD_SET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, AUTO_INIT_EN, reg_reorder_cfg_dsptchr_reordr_cfg, reorder_cfg_dsptchr_reordr_cfg->auto_init_en);
    reg_reorder_cfg_dsptchr_reordr_cfg = RU_FIELD_SET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, AUTO_INIT_SIZE, reg_reorder_cfg_dsptchr_reordr_cfg, reorder_cfg_dsptchr_reordr_cfg->auto_init_size);
    ...
    reg_reorder_cfg_dsptchr_reordr_cfg = RU_FIELD_SET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, CRDT_EFF_REP, reg_reorder_cfg_dsptchr_reordr_cfg, reorder_cfg_dsptchr_reordr_cfg->crdt_eff_rep);
    reg_reorder_cfg_dsptchr_reordr_cfg = RU_FIELD_SET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, TSK_FREE_NUM_PLACE, reg_reorder_cfg_dsptchr_reordr_cfg, reorder_cfg_dsptchr_reordr_cfg->tsk_free_num_place);
...
bdmf_error_t ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_get(dsptchr_reorder_cfg_dsptchr_reordr_cfg *reorder_cfg_dsptchr_reordr_cfg)
{
    ...
    reorder_cfg_dsptchr_reordr_cfg->auto_init_en = RU_FIELD_GET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, AUTO_INIT_EN, reg_reorder_cfg_dsptchr_reordr_cfg);
    reorder_cfg_dsptchr_reordr_cfg->auto_init_size = RU_FIELD_GET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, AUTO_INIT_SIZE, reg_reorder_cfg_dsptchr_reordr_cfg);
    ...
    reorder_cfg_dsptchr_reordr_cfg->crdt_eff_rep = RU_FIELD_GET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, CRDT_EFF_REP, reg_reorder_cfg_dsptchr_reordr_cfg);
    reorder_cfg_dsptchr_reordr_cfg->tsk_free_num_place = RU_FIELD_GET(0, DSPTCHR, REORDER_CFG_DSPTCHR_REORDR_CFG, TSK_FREE_NUM_PLACE, reg_reorder_cfg_dsptchr_reordr_cfg);
...
bdmf_error_t ag_drv_dsptchr_congestion_total_egrs_congstn_set(uint8_t viq_idx, const dsptchr_cngs_params *cngs_params)
{
    ...
    RU_REG_RAM_WRITE(0, viq_idx, DSPTCHR, CONGESTION_TOTAL_EGRS_CONGSTN, reg_congestion_ingrs_congstn);
...
bdmf_error_t ag_drv_dsptchr_congestion_total_egrs_congstn_get(uint8_t viq_idx, dsptchr_cngs_params *cngs_params)
{
    ...
    RU_REG_RAM_READ(0, viq_idx, DSPTCHR, CONGESTION_TOTAL_EGRS_CONGSTN, reg_congestion_ingrs_congstn);
...
bdmf_error_t ag_drv_dsptchr_queue_mapping_q_dest_set(uint8_t q_idx, bdmf_boolean is_dest_disp)
{
    ...
    reg_queue_mapping_q_dest = RU_FLD_VAL_SET(reg_queue_mapping_q_dest, 0x1 << (q_idx % 32), q_idx % 32, is_dest_disp);
...
bdmf_error_t ag_drv_dsptchr_queue_mapping_q_dest_get(uint8_t q_idx, bdmf_boolean *is_dest_disp)
{
    ...
    *is_dest_disp = RU_FLD_VAL_GET(reg_queue_mapping_q_dest, 0x1 << (q_idx % 32), q_idx % 32);
...
{
    uint32_t reg_queue_mapping_pd_dsptch_add_rnr_grp = 0;

#ifdef VALIDATE_PARMS
    if(!queue_mapping_pd_dsptch_add_rnr_grp)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    if ((queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel0 >= _1BITS_MAX_VAL_) ||
       (queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel1 >= _1BITS_MAX_VAL_) ||
       (queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel2 >= _1BITS_MAX_VAL_) ||
       (queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel3 >= _1BITS_MAX_VAL_) ||
       (queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel4 >= _1BITS_MAX_VAL_) ||
       (queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel5 >= _1BITS_MAX_VAL_) ||
       (queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel6 >= _1BITS_MAX_VAL_) ||
       (queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel7 >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_queue_mapping_pd_dsptch_add_rnr_grp = RU_FIELD_SET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL0, reg_queue_mapping_pd_dsptch_add_rnr_grp, queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel0);
    reg_queue_mapping_pd_dsptch_add_rnr_grp = RU_FIELD_SET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL1, reg_queue_mapping_pd_dsptch_add_rnr_grp, queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel1);
    reg_queue_mapping_pd_dsptch_add_rnr_grp = RU_FIELD_SET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL2, reg_queue_mapping_pd_dsptch_add_rnr_grp, queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel2);
    reg_queue_mapping_pd_dsptch_add_rnr_grp = RU_FIELD_SET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL3, reg_queue_mapping_pd_dsptch_add_rnr_grp, queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel3);
    reg_queue_mapping_pd_dsptch_add_rnr_grp = RU_FIELD_SET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL4, reg_queue_mapping_pd_dsptch_add_rnr_grp, queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel4);
    reg_queue_mapping_pd_dsptch_add_rnr_grp = RU_FIELD_SET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL5, reg_queue_mapping_pd_dsptch_add_rnr_grp, queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel5);
    reg_queue_mapping_pd_dsptch_add_rnr_grp = RU_FIELD_SET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL6, reg_queue_mapping_pd_dsptch_add_rnr_grp, queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel6);
    reg_queue_mapping_pd_dsptch_add_rnr_grp = RU_FIELD_SET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL7, reg_queue_mapping_pd_dsptch_add_rnr_grp, queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel7);

    RU_REG_WRITE(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, reg_queue_mapping_pd_dsptch_add_rnr_grp);
...
{
    uint32_t reg_queue_mapping_pd_dsptch_add_rnr_grp;
    ...
    RU_REG_READ(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, reg_queue_mapping_pd_dsptch_add_rnr_grp);

    queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel0 = RU_FIELD_GET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL0, reg_queue_mapping_pd_dsptch_add_rnr_grp);
    queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel1 = RU_FIELD_GET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL1, reg_queue_mapping_pd_dsptch_add_rnr_grp);
    queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel2 = RU_FIELD_GET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL2, reg_queue_mapping_pd_dsptch_add_rnr_grp);
    queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel3 = RU_FIELD_GET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL3, reg_queue_mapping_pd_dsptch_add_rnr_grp);
    queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel4 = RU_FIELD_GET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL4, reg_queue_mapping_pd_dsptch_add_rnr_grp);
    queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel5 = RU_FIELD_GET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL5, reg_queue_mapping_pd_dsptch_add_rnr_grp);
    queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel6 = RU_FIELD_GET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL6, reg_queue_mapping_pd_dsptch_add_rnr_grp);
    queue_mapping_pd_dsptch_add_rnr_grp->rnr_g_sel7 = RU_FIELD_GET(0, DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP, RNR_G_SEL7, reg_queue_mapping_pd_dsptch_add_rnr_grp);
...
bdmf_error_t ag_drv_dsptchr_mask_dly_q_set(uint8_t q_idx, bdmf_boolean set_delay)
{
    ...
    reg_mask_dly_q = RU_FLD_VAL_SET(reg_mask_dly_q, 0x1 << (q_idx % 32), q_idx % 32, set_delay);
...
bdmf_error_t ag_drv_dsptchr_mask_dly_q_get(uint8_t q_idx, bdmf_boolean *set_delay)
{
    ...
    *set_delay = RU_FLD_VAL_GET(reg_mask_dly_q, 0x1 << (q_idx % 32), q_idx % 32);
...
bdmf_error_t ag_drv_dsptchr_mask_non_dly_q_set(uint8_t q_idx, bdmf_boolean set_non_delay)
{
    ...
    reg_mask_non_dly_q = RU_FLD_VAL_SET(reg_mask_non_dly_q, 0x1 << (q_idx % 32), q_idx % 32, set_non_delay);
...
bdmf_error_t ag_drv_dsptchr_mask_non_dly_q_get(uint8_t q_idx, bdmf_boolean *set_non_delay)
{
    ...
    *set_non_delay = RU_FLD_VAL_GET(reg_mask_non_dly_q, 0x1 << (q_idx % 32), q_idx % 32);
...
bdmf_error_t ag_drv_dsptchr_debug_intr_vec_0_get(uint32_t *intr_vec_0)
{
    uint32_t reg_debug_intr_vec_0;
    ...
    RU_REG_READ(0, DSPTCHR, DEBUG_INTR_VEC_0, reg_debug_intr_vec_0);

    *intr_vec_0 = RU_FIELD_GET(0, DSPTCHR, DEBUG_INTR_VEC_0, INTR_VEC_0, reg_debug_intr_vec_0);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_dsptchr_debug_intr_vec_1_get(uint32_t *intr_vec_1)
{
    uint32_t reg_debug_intr_vec_1;
    ...
    RU_REG_READ(0, DSPTCHR, DEBUG_INTR_VEC_1, reg_debug_intr_vec_1);

    *intr_vec_1 = RU_FIELD_GET(0, DSPTCHR, DEBUG_INTR_VEC_1, INTR_VEC_1, reg_debug_intr_vec_1);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_dsptchr_debug_intr_vec_2_get(uint32_t *intr_vec_2)
{
    uint32_t reg_debug_intr_vec_2;
    ...
    RU_REG_READ(0, DSPTCHR, DEBUG_INTR_VEC_2, reg_debug_intr_vec_2);

    *intr_vec_2 = RU_FIELD_GET(0, DSPTCHR, DEBUG_INTR_VEC_2, INTR_VEC_2, reg_debug_intr_vec_2);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_dsptchr_debug_intr_vec_3_get(uint32_t *intr_vec_3)
{
    uint32_t reg_debug_intr_vec_3;
    ...
    RU_REG_READ(0, DSPTCHR, DEBUG_INTR_VEC_3, reg_debug_intr_vec_3);

    *intr_vec_3 = RU_FIELD_GET(0, DSPTCHR, DEBUG_INTR_VEC_3, INTR_VEC_3, reg_debug_intr_vec_3);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_dsptchr_debug_intr_vec_4_get(uint32_t *intr_vec_4)
{
    uint32_t reg_debug_intr_vec_4;
    ...
    RU_REG_READ(0, DSPTCHR, DEBUG_INTR_VEC_4, reg_debug_intr_vec_4);

    *intr_vec_4 = RU_FIELD_GET(0, DSPTCHR, DEBUG_INTR_VEC_4, INTR_VEC_4, reg_debug_intr_vec_4);
...
typedef enum
{
    ...
    bdmf_address_debug_intr_vec_0,
    bdmf_address_debug_intr_vec_1,
    bdmf_address_debug_intr_vec_2,
    bdmf_address_debug_intr_vec_3,
    bdmf_address_debug_intr_vec_4,
...
static int ag_drv_dsptchr_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    bdmf_error_t ag_err;
    ...
    case cli_dsptchr_cngs_params:
    {
        ...
        ag_err = ag_drv_dsptchr_cngs_params_set(parm[1].value.unumber, &cngs_params);
        break;
    }
    case cli_dsptchr_glbl_cngs_params:
    {
        ...
        ag_err = ag_drv_dsptchr_glbl_cngs_params_set(&glbl_cngs_params);
        break;
    }
    case cli_dsptchr_q_size_params:
        ag_err = ag_drv_dsptchr_q_size_params_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_credit_cnt:
        ag_err = ag_drv_dsptchr_credit_cnt_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_q_limits_params:
        ag_err = ag_drv_dsptchr_q_limits_params_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_dsptchr_ingress_coherency_params:
        ag_err = ag_drv_dsptchr_ingress_coherency_params_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_dsptchr_pools_limits:
    {
        ...
        ag_err = ag_drv_dsptchr_pools_limits_set(&pools_limits);
        break;
    }
    case cli_dsptchr_fll_entry:
    {
        ...
        ag_err = ag_drv_dsptchr_fll_entry_set(&fll_entry);
        break;
    }
    case cli_dsptchr_rnr_dsptch_addr:
    {
        ...
        ag_err = ag_drv_dsptchr_rnr_dsptch_addr_set(parm[1].value.unumber, &rnr_dsptch_addr);
        break;
    }
    case cli_dsptchr_reorder_cfg_dsptchr_reordr_cfg:
    {
        dsptchr_reorder_cfg_dsptchr_reordr_cfg reorder_cfg_dsptchr_reordr_cfg = { .disp_enable = parm[1].value.unumber, .auto_init_en = parm[2].value.unumber, .auto_init_size = parm[3].value.unumber, .rdy = parm[4].value.unumber, .reordr_par_mod = parm[5].value.unumber, .per_q_egrs_congst_en = parm[6].value.unumber, .dsptch_sm_enh_mod = parm[7].value.unumber, .ingrs_pipe_dly_en = parm[8].value.unumber, .ingrs_pipe_dly_cnt = parm[9].value.unumber, .egrs_drop_only = parm[10].value.unumber, .crdt_eff_rep = parm[11].value.unumber, .tsk_free_num_place = parm[12].value.unumber};
        ag_err = ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_set(&reorder_cfg_dsptchr_reordr_cfg);
        break;
    }
    case cli_dsptchr_reorder_cfg_vq_en:
        ag_err = ag_drv_dsptchr_reorder_cfg_vq_en_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_reorder_cfg_bb_cfg:
        ag_err = ag_drv_dsptchr_reorder_cfg_bb_cfg_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    case cli_dsptchr_reorder_cfg_clk_gate_cntrl:
    {
        ...
        ag_err = ag_drv_dsptchr_reorder_cfg_clk_gate_cntrl_set(&reorder_cfg_clk_gate_cntrl);
        break;
    }
    case cli_dsptchr_congestion_egrs_congstn:
    {
        dsptchr_cngs_params cngs_params = { .frst_lvl = parm[2].value.unumber, .scnd_lvl = parm[3].value.unumber, .hyst_thrs = parm[4].value.unumber};
        ag_err = ag_drv_dsptchr_congestion_egrs_congstn_set(parm[1].value.unumber, &cngs_params);
        break;
    }
    case cli_dsptchr_congestion_total_egrs_congstn:
    {
        dsptchr_cngs_params cngs_params = { .frst_lvl = parm[2].value.unumber, .scnd_lvl = parm[3].value.unumber, .hyst_thrs = parm[4].value.unumber};
        ag_err = ag_drv_dsptchr_congestion_total_egrs_congstn_set(parm[1].value.unumber, &cngs_params);
        break;
    }
    case cli_dsptchr_queue_mapping_crdt_cfg:
        ag_err = ag_drv_dsptchr_queue_mapping_crdt_cfg_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_dsptchr_queue_mapping_q_dest:
        ag_err = ag_drv_dsptchr_queue_mapping_q_dest_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_queue_mapping_pd_dsptch_add_rnr_grp:
    {
        dsptchr_queue_mapping_pd_dsptch_add_rnr_grp queue_mapping_pd_dsptch_add_rnr_grp = { .rnr_g_sel0 = parm[1].value.unumber, .rnr_g_sel1 = parm[2].value.unumber, .rnr_g_sel2 = parm[3].value.unumber, .rnr_g_sel3 = parm[4].value.unumber, .rnr_g_sel4 = parm[5].value.unumber, .rnr_g_sel5 = parm[6].value.unumber, .rnr_g_sel6 = parm[7].value.unumber, .rnr_g_sel7 = parm[8].value.unumber};
        ag_err = ag_drv_dsptchr_queue_mapping_pd_dsptch_add_rnr_grp_set(&queue_mapping_pd_dsptch_add_rnr_grp);
        break;
    }
    case cli_dsptchr_mask_msk_tsk_255_0:
    {
        ...
        ag_err = ag_drv_dsptchr_mask_msk_tsk_255_0_set(parm[1].value.unumber, &mask_msk_tsk_255_0);
        break;
    }
    case cli_dsptchr_mask_msk_q:
        ag_err = ag_drv_dsptchr_mask_msk_q_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_mask_dly_q:
        ag_err = ag_drv_dsptchr_mask_dly_q_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_mask_non_dly_q:
        ag_err = ag_drv_dsptchr_mask_non_dly_q_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_egrs_queues_egrs_dly_qm_crdt:
        ag_err = ag_drv_dsptchr_egrs_queues_egrs_dly_qm_crdt_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_egrs_queues_egrs_non_dly_qm_crdt:
        ag_err = ag_drv_dsptchr_egrs_queues_egrs_non_dly_qm_crdt_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_egrs_queues_total_q_egrs_size:
        ag_err = ag_drv_dsptchr_egrs_queues_total_q_egrs_size_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_wakeup_control_wkup_req:
    {
        ...
        ag_err = ag_drv_dsptchr_wakeup_control_wkup_req_set(&wakeup_control_wkup_req);
        break;
    }
    case cli_dsptchr_wakeup_control_wkup_thrshld:
        ag_err = ag_drv_dsptchr_wakeup_control_wkup_thrshld_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_disptch_scheduling_dwrr_info:
        ag_err = ag_drv_dsptchr_disptch_scheduling_dwrr_info_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    case cli_dsptchr_disptch_scheduling_vld_crdt:
    {
        dsptchr_disptch_scheduling_vld_crdt disptch_scheduling_vld_crdt = { .q0 = parm[1].value.unumber, .q1 = parm[2].value.unumber, .q2 = parm[3].value.unumber, .q3 = parm[4].value.unumber, .q4 = parm[5].value.unumber, .q5 = parm[6].value.unumber, .q6 = parm[7].value.unumber, .q7 = parm[8].value.unumber, .q8 = parm[9].value.unumber, .q9 = parm[10].value.unumber, .q10 = parm[11].value.unumber, .q11 = parm[12].value.unumber, .q12 = parm[13].value.unumber, .q13 = parm[14].value.unumber, .q14 = parm[15].value.unumber, .q15 = parm[16].value.unumber, .q16 = parm[17].value.unumber, .q17 = parm[18].value.unumber, .q18 = parm[19].value.unumber, .q19 = parm[20].value.unumber, .q20 = parm[21].value.unumber, .q21 = parm[22].value.unumber, .q22 = parm[23].value.unumber, .q23 = parm[24].value.unumber, .q24 = parm[25].value.unumber, .q25 = parm[26].value.unumber, .q26 = parm[27].value.unumber, .q27 = parm[28].value.unumber, .q28 = parm[29].value.unumber, .q29 = parm[30].value.unumber, .q30 = parm[31].value.unumber, .q31 = parm[32].value.unumber};
        ag_err = ag_drv_dsptchr_disptch_scheduling_vld_crdt_set(&disptch_scheduling_vld_crdt);
        break;
    }
    case cli_dsptchr_load_balancing_lb_cfg:
        ag_err = ag_drv_dsptchr_load_balancing_lb_cfg_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_load_balancing_free_task_0_1:
        ag_err = ag_drv_dsptchr_load_balancing_free_task_0_1_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_load_balancing_free_task_2_3:
        ag_err = ag_drv_dsptchr_load_balancing_free_task_2_3_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_load_balancing_free_task_4_5:
        ag_err = ag_drv_dsptchr_load_balancing_free_task_4_5_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_load_balancing_free_task_6_7:
        ag_err = ag_drv_dsptchr_load_balancing_free_task_6_7_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_load_balancing_free_task_8_9:
        ag_err = ag_drv_dsptchr_load_balancing_free_task_8_9_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_load_balancing_free_task_10_11:
        ag_err = ag_drv_dsptchr_load_balancing_free_task_10_11_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_load_balancing_free_task_12_13:
        ag_err = ag_drv_dsptchr_load_balancing_free_task_12_13_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_load_balancing_free_task_14_15:
        ag_err = ag_drv_dsptchr_load_balancing_free_task_14_15_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_load_balancing_tsk_to_rg_mapping:
    {
        ...
        ag_err = ag_drv_dsptchr_load_balancing_tsk_to_rg_mapping_set(parm[1].value.unumber, &load_balancing_tsk_to_rg_mapping);
        break;
    }
    case cli_dsptchr_load_balancing_rg_avlabl_tsk_0_3:
        ag_err = ag_drv_dsptchr_load_balancing_rg_avlabl_tsk_0_3_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    case cli_dsptchr_load_balancing_rg_avlabl_tsk_4_7:
        ag_err = ag_drv_dsptchr_load_balancing_rg_avlabl_tsk_4_7_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    case cli_dsptchr_dsptcher_reordr_top_intr_ctrl_0_isr:
    {
        ...
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_isr_set(&dsptcher_reordr_top_intr_ctrl_0_isr);
        break;
    }
    case cli_dsptchr_dsptcher_reordr_top_intr_ctrl_0_ier:
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_ier_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_dsptcher_reordr_top_intr_ctrl_0_itr:
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_itr_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_dsptcher_reordr_top_intr_ctrl_1_isr:
    {
        ...
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_isr_set(&dsptcher_reordr_top_intr_ctrl_1_isr);
        break;
    }
    case cli_dsptchr_dsptcher_reordr_top_intr_ctrl_1_ier:
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_ier_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_dsptcher_reordr_top_intr_ctrl_1_itr:
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_itr_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_debug_dbg_bypss_cntrl:
        ag_err = ag_drv_dsptchr_debug_dbg_bypss_cntrl_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
    case cli_dsptchr_debug_glbl_tsk_cnt_0_7:
    {
        ...
        ag_err = ag_drv_dsptchr_debug_glbl_tsk_cnt_0_7_set(&debug_glbl_tsk_cnt_0_7);
        break;
    }
    case cli_dsptchr_debug_glbl_tsk_cnt_8_15:
    {
        ...
        ag_err = ag_drv_dsptchr_debug_glbl_tsk_cnt_8_15_set(&debug_glbl_tsk_cnt_8_15);
        break;
    }
    case cli_dsptchr_debug_dbg_bus_cntrl:
        ag_err = ag_drv_dsptchr_debug_dbg_bus_cntrl_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_debug_statistics_dbg_sttstcs_ctrl:
        ag_err = ag_drv_dsptchr_debug_statistics_dbg_sttstcs_ctrl_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    case cli_dsptchr_qdes_head:
        ag_err = ag_drv_dsptchr_qdes_head_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_qdes_bfout:
    {
        ...
        ag_err = ag_drv_dsptchr_qdes_bfout_set(parm[1].value.unumber, &qdes_bfout);
        break;
    }
    case cli_dsptchr_qdes_bufin:
    {
        ...
        ag_err = ag_drv_dsptchr_qdes_bufin_set(parm[1].value.unumber, &qdes_bufin);
        break;
    }
    case cli_dsptchr_qdes_tail:
        ag_err = ag_drv_dsptchr_qdes_tail_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_qdes_fbdnull:
    {
        ...
        ag_err = ag_drv_dsptchr_qdes_fbdnull_set(parm[1].value.unumber, &qdes_fbdnull);
        break;
    }
    case cli_dsptchr_qdes_nullbd:
    {
        ...
        ag_err = ag_drv_dsptchr_qdes_nullbd_set(parm[1].value.unumber, &qdes_nullbd);
        break;
    }
    case cli_dsptchr_qdes_reg_q_head:
        ag_err = ag_drv_dsptchr_qdes_reg_q_head_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_qdes_reg_viq_head_vld:
        ag_err = ag_drv_dsptchr_qdes_reg_viq_head_vld_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_qdes_reg_viq_chrncy_vld:
        ag_err = ag_drv_dsptchr_qdes_reg_viq_chrncy_vld_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_qdes_reg_veq_head_vld:
        ag_err = ag_drv_dsptchr_qdes_reg_veq_head_vld_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_qdes_reg_qdes_buf_avl_cntrl:
        ag_err = ag_drv_dsptchr_qdes_reg_qdes_buf_avl_cntrl_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_flldes_flldrop:
        ag_err = ag_drv_dsptchr_flldes_flldrop_set(parm[1].value.unumber);
        break;
    case cli_dsptchr_bdram_next_data:
        ag_err = ag_drv_dsptchr_bdram_next_data_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_bdram_prev_data:
        ag_err = ag_drv_dsptchr_bdram_prev_data_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_dsptchr_pdram_data:
    {
        dsptchr_pdram_data pdram_data = { .reorder_ram_data = { parm[2].value.unumber, parm[3].value.unumber}};
        ag_err = ag_drv_dsptchr_pdram_data_set(parm[1].value.unumber, &pdram_data);
        break;
    }
    default:
...
int bcm_dsptchr_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_dsptchr_cngs_params:
    {
        ...
        ag_err = ag_drv_dsptchr_cngs_params_get(parm[1].value.unumber, &cngs_params);
    ...
    case cli_dsptchr_glbl_cngs_params:
    {
        ...
        ag_err = ag_drv_dsptchr_glbl_cngs_params_get(&glbl_cngs_params);
    ...
    {
        uint16_t cmn_cnt;
        ag_err = ag_drv_dsptchr_q_size_params_get(parm[1].value.unumber, &cmn_cnt);
    ...
    {
        uint16_t credit_cnt;
        ag_err = ag_drv_dsptchr_credit_cnt_get(parm[1].value.unumber, &credit_cnt);
    ...
    case cli_dsptchr_q_limits_params:
    {
        uint16_t cmn_max;
        uint16_t gurntd_max;
        ag_err = ag_drv_dsptchr_q_limits_params_get(parm[1].value.unumber, &cmn_max, &gurntd_max);
    ...
    case cli_dsptchr_ingress_coherency_params:
    {
        ...
        uint16_t chrncy_cnt;
        ag_err = ag_drv_dsptchr_ingress_coherency_params_get(parm[1].value.unumber, &chrncy_en, &chrncy_cnt);
    ...
    case cli_dsptchr_pools_limits:
    {
        ...
        ag_err = ag_drv_dsptchr_pools_limits_get(&pools_limits);
    ...
    case cli_dsptchr_fll_entry:
    {
        ...
        ag_err = ag_drv_dsptchr_fll_entry_get(&fll_entry);
    ...
    case cli_dsptchr_rnr_dsptch_addr:
    {
        ...
        ag_err = ag_drv_dsptchr_rnr_dsptch_addr_get(parm[1].value.unumber, &rnr_dsptch_addr);
    ...
    case cli_dsptchr_reorder_cfg_dsptchr_reordr_cfg:
    {
        ...
        ag_err = ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_get(&reorder_cfg_dsptchr_reordr_cfg);
        ...
        bdmf_session_print(session, "auto_init_en = %u = 0x%x\n", reorder_cfg_dsptchr_reordr_cfg.auto_init_en, reorder_cfg_dsptchr_reordr_cfg.auto_init_en);
        bdmf_session_print(session, "auto_init_size = %u = 0x%x\n", reorder_cfg_dsptchr_reordr_cfg.auto_init_size, reorder_cfg_dsptchr_reordr_cfg.auto_init_size);
        ...
        bdmf_session_print(session, "crdt_eff_rep = %u = 0x%x\n", reorder_cfg_dsptchr_reordr_cfg.crdt_eff_rep, reorder_cfg_dsptchr_reordr_cfg.crdt_eff_rep);
        bdmf_session_print(session, "tsk_free_num_place = %u = 0x%x\n", reorder_cfg_dsptchr_reordr_cfg.tsk_free_num_place, reorder_cfg_dsptchr_reordr_cfg.tsk_free_num_place);
        break;
    }
    case cli_dsptchr_reorder_cfg_vq_en:
    {
        uint32_t en;
        ag_err = ag_drv_dsptchr_reorder_cfg_vq_en_get(&en);
    ...
    case cli_dsptchr_reorder_cfg_bb_cfg:
    {
        ...
        ag_err = ag_drv_dsptchr_reorder_cfg_bb_cfg_get(&src_id, &dst_id_ovride, &route_ovride, &ovride_en);
    ...
    case cli_dsptchr_reorder_cfg_clk_gate_cntrl:
    {
        ...
        ag_err = ag_drv_dsptchr_reorder_cfg_clk_gate_cntrl_get(&reorder_cfg_clk_gate_cntrl);
    ...
    {
        dsptchr_cngs_params cngs_params;
        ag_err = ag_drv_dsptchr_congestion_egrs_congstn_get(parm[1].value.unumber, &cngs_params);
        bdmf_session_print(session, "frst_lvl = %u = 0x%x\n", cngs_params.frst_lvl, cngs_params.frst_lvl);
        bdmf_session_print(session, "scnd_lvl = %u = 0x%x\n", cngs_params.scnd_lvl, cngs_params.scnd_lvl);
        bdmf_session_print(session, "hyst_thrs = %u = 0x%x\n", cngs_params.hyst_thrs, cngs_params.hyst_thrs);
        break;
    ...
    {
        dsptchr_cngs_params cngs_params;
        ag_err = ag_drv_dsptchr_congestion_total_egrs_congstn_get(parm[1].value.unumber, &cngs_params);
        bdmf_session_print(session, "frst_lvl = %u = 0x%x\n", cngs_params.frst_lvl, cngs_params.frst_lvl);
        bdmf_session_print(session, "scnd_lvl = %u = 0x%x\n", cngs_params.scnd_lvl, cngs_params.scnd_lvl);
        bdmf_session_print(session, "hyst_thrs = %u = 0x%x\n", cngs_params.hyst_thrs, cngs_params.hyst_thrs);
        break;
    ...
    case cli_dsptchr_congestion_congstn_status:
    {
        ...
        ag_err = ag_drv_dsptchr_congestion_congstn_status_get(&congestion_congstn_status);
    ...
    case cli_dsptchr_congestion_per_q_ingrs_congstn_low:
    {
        ...
        ag_err = ag_drv_dsptchr_congestion_per_q_ingrs_congstn_low_get(&congstn_state);
    ...
    {
        uint32_t congstn_state;
        ag_err = ag_drv_dsptchr_congestion_per_q_ingrs_congstn_high_get(&congstn_state);
        bdmf_session_print(session, "congstn_state = %u = 0x%x\n", congstn_state, congstn_state);
        break;
    }
    ...
    {
        uint32_t congstn_state;
        ag_err = ag_drv_dsptchr_congestion_per_q_egrs_congstn_low_get(&congstn_state);
        bdmf_session_print(session, "congstn_state = %u = 0x%x\n", congstn_state, congstn_state);
        break;
    }
    ...
    {
        uint32_t congstn_state;
        ag_err = ag_drv_dsptchr_congestion_per_q_egrs_congstn_high_get(&congstn_state);
        bdmf_session_print(session, "congstn_state = %u = 0x%x\n", congstn_state, congstn_state);
        break;
    }
    case cli_dsptchr_queue_mapping_crdt_cfg:
    {
        uint8_t bb_id;
        uint16_t trgt_add;
        ag_err = ag_drv_dsptchr_queue_mapping_crdt_cfg_get(parm[1].value.unumber, &bb_id, &trgt_add);
    ...
    case cli_dsptchr_queue_mapping_q_dest:
    {
        ...
        ag_err = ag_drv_dsptchr_queue_mapping_q_dest_get(parm[1].value.unumber, &is_dest_disp);
        bdmf_session_print(session, "is_dest_disp = %u = 0x%x\n", is_dest_disp, is_dest_disp);
        break;
    }
    case cli_dsptchr_queue_mapping_pd_dsptch_add_rnr_grp:
    {
        dsptchr_queue_mapping_pd_dsptch_add_rnr_grp queue_mapping_pd_dsptch_add_rnr_grp;
        ag_err = ag_drv_dsptchr_queue_mapping_pd_dsptch_add_rnr_grp_get(&queue_mapping_pd_dsptch_add_rnr_grp);
        bdmf_session_print(session, "rnr_g_sel0 = %u = 0x%x\n", queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel0, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel0);
        bdmf_session_print(session, "rnr_g_sel1 = %u = 0x%x\n", queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel1, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel1);
        bdmf_session_print(session, "rnr_g_sel2 = %u = 0x%x\n", queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel2, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel2);
        bdmf_session_print(session, "rnr_g_sel3 = %u = 0x%x\n", queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel3, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel3);
        bdmf_session_print(session, "rnr_g_sel4 = %u = 0x%x\n", queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel4, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel4);
        bdmf_session_print(session, "rnr_g_sel5 = %u = 0x%x\n", queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel5, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel5);
        bdmf_session_print(session, "rnr_g_sel6 = %u = 0x%x\n", queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel6, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel6);
        bdmf_session_print(session, "rnr_g_sel7 = %u = 0x%x\n", queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel7, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel7);
        break;
    }
    case cli_dsptchr_mask_msk_tsk_255_0:
    {
        dsptchr_mask_msk_tsk_255_0 mask_msk_tsk_255_0;
        ag_err = ag_drv_dsptchr_mask_msk_tsk_255_0_get(parm[1].value.unumber, &mask_msk_tsk_255_0);
    ...
    {
        uint32_t mask;
        ag_err = ag_drv_dsptchr_mask_msk_q_get(parm[1].value.unumber, &mask);
    ...
    case cli_dsptchr_mask_dly_q:
    {
        ...
        ag_err = ag_drv_dsptchr_mask_dly_q_get(parm[1].value.unumber, &set_delay);
    ...
    case cli_dsptchr_mask_non_dly_q:
    {
        ...
        ag_err = ag_drv_dsptchr_mask_non_dly_q_get(parm[1].value.unumber, &set_non_delay);
    ...
    {
        uint8_t dly_crdt;
        ag_err = ag_drv_dsptchr_egrs_queues_egrs_dly_qm_crdt_get(&dly_crdt);
    ...
    case cli_dsptchr_egrs_queues_egrs_non_dly_qm_crdt:
    {
        ...
        ag_err = ag_drv_dsptchr_egrs_queues_egrs_non_dly_qm_crdt_get(&non_dly_crdt);
    ...
    case cli_dsptchr_egrs_queues_total_q_egrs_size:
    {
        ...
        ag_err = ag_drv_dsptchr_egrs_queues_total_q_egrs_size_get(&total_egrs_size);
    ...
    case cli_dsptchr_egrs_queues_per_q_egrs_size:
    {
        ...
        ag_err = ag_drv_dsptchr_egrs_queues_per_q_egrs_size_get(parm[1].value.unumber, &q_egrs_size);
    ...
    case cli_dsptchr_wakeup_control_wkup_req:
    {
        ...
        ag_err = ag_drv_dsptchr_wakeup_control_wkup_req_get(&wakeup_control_wkup_req);
    ...
    case cli_dsptchr_wakeup_control_wkup_thrshld:
    {
        ...
        ag_err = ag_drv_dsptchr_wakeup_control_wkup_thrshld_get(&wkup_thrshld);
    ...
    case cli_dsptchr_disptch_scheduling_dwrr_info:
    {
        ...
        bdmf_boolean ngtv;
        uint16_t quntum;
        ag_err = ag_drv_dsptchr_disptch_scheduling_dwrr_info_get(parm[1].value.unumber, &q_crdt, &ngtv, &quntum);
    ...
    {
        dsptchr_disptch_scheduling_vld_crdt disptch_scheduling_vld_crdt;
        ag_err = ag_drv_dsptchr_disptch_scheduling_vld_crdt_get(&disptch_scheduling_vld_crdt);
    ...
    case cli_dsptchr_load_balancing_lb_cfg:
    {
        ...
        uint8_t sp_thrshld;
        ag_err = ag_drv_dsptchr_load_balancing_lb_cfg_get(&lb_mode, &sp_thrshld);
    ...
    case cli_dsptchr_load_balancing_free_task_0_1:
    {
        uint16_t rnr0;
        uint16_t rnr1;
        ag_err = ag_drv_dsptchr_load_balancing_free_task_0_1_get(&rnr0, &rnr1);
    ...
    case cli_dsptchr_load_balancing_free_task_2_3:
    {
        uint16_t rnr2;
        uint16_t rnr3;
        ag_err = ag_drv_dsptchr_load_balancing_free_task_2_3_get(&rnr2, &rnr3);
    ...
    case cli_dsptchr_load_balancing_free_task_4_5:
    {
        uint16_t rnr4;
        uint16_t rnr5;
        ag_err = ag_drv_dsptchr_load_balancing_free_task_4_5_get(&rnr4, &rnr5);
    ...
    case cli_dsptchr_load_balancing_free_task_6_7:
    {
        uint16_t rnr6;
        uint16_t rnr7;
        ag_err = ag_drv_dsptchr_load_balancing_free_task_6_7_get(&rnr6, &rnr7);
    ...
    case cli_dsptchr_load_balancing_free_task_8_9:
    {
        uint16_t rnr8;
        uint16_t rnr9;
        ag_err = ag_drv_dsptchr_load_balancing_free_task_8_9_get(&rnr8, &rnr9);
    ...
    case cli_dsptchr_load_balancing_free_task_10_11:
    {
        uint16_t rnr10;
        uint16_t rnr11;
        ag_err = ag_drv_dsptchr_load_balancing_free_task_10_11_get(&rnr10, &rnr11);
    ...
    case cli_dsptchr_load_balancing_free_task_12_13:
    {
        uint16_t rnr12;
        uint16_t rnr13;
        ag_err = ag_drv_dsptchr_load_balancing_free_task_12_13_get(&rnr12, &rnr13);
    ...
    case cli_dsptchr_load_balancing_free_task_14_15:
    {
        uint16_t rnr14;
        uint16_t rnr15;
        ag_err = ag_drv_dsptchr_load_balancing_free_task_14_15_get(&rnr14, &rnr15);
    ...
    case cli_dsptchr_load_balancing_tsk_to_rg_mapping:
    {
        ...
        ag_err = ag_drv_dsptchr_load_balancing_tsk_to_rg_mapping_get(parm[1].value.unumber, &load_balancing_tsk_to_rg_mapping);
    ...
    case cli_dsptchr_load_balancing_rg_avlabl_tsk_0_3:
    {
        ...
        ag_err = ag_drv_dsptchr_load_balancing_rg_avlabl_tsk_0_3_get(&tsk_cnt_rg_0, &tsk_cnt_rg_1, &tsk_cnt_rg_2, &tsk_cnt_rg_3);
    ...
    case cli_dsptchr_load_balancing_rg_avlabl_tsk_4_7:
    {
        ...
        ag_err = ag_drv_dsptchr_load_balancing_rg_avlabl_tsk_4_7_get(&tsk_cnt_rg_4, &tsk_cnt_rg_5, &tsk_cnt_rg_6, &tsk_cnt_rg_7);
    ...
    case cli_dsptchr_dsptcher_reordr_top_intr_ctrl_0_isr:
    {
        ...
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_isr_get(&dsptcher_reordr_top_intr_ctrl_0_isr);
    ...
    {
        uint32_t ism;
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_ism_get(&ism);
    ...
    {
        uint32_t iem;
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_ier_get(&iem);
    ...
    {
        uint32_t ist;
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_itr_get(&ist);
    ...
    {
        dsptchr_dsptcher_reordr_top_intr_ctrl_1_isr dsptcher_reordr_top_intr_ctrl_1_isr;
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_isr_get(&dsptcher_reordr_top_intr_ctrl_1_isr);
    ...
    {
        uint32_t ism;
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_ism_get(&ism);
        bdmf_session_print(session, "ism = %u = 0x%x\n", ism, ism);
        break;
    }
    case cli_dsptchr_dsptcher_reordr_top_intr_ctrl_1_ier:
    {
        uint32_t iem;
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_ier_get(&iem);
        bdmf_session_print(session, "iem = %u = 0x%x\n", iem, iem);
        break;
    }
    case cli_dsptchr_dsptcher_reordr_top_intr_ctrl_1_itr:
    {
        uint32_t ist;
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_itr_get(&ist);
        bdmf_session_print(session, "ist = %u = 0x%x\n", ist, ist);
        break;
    }
    case cli_dsptchr_debug_dbg_bypss_cntrl:
    {
        ...
        uint8_t bbid_dly;
        ag_err = ag_drv_dsptchr_debug_dbg_bypss_cntrl_get(&en_byp, &bbid_non_dly, &bbid_dly);
    ...
    case cli_dsptchr_debug_glbl_tsk_cnt_0_7:
    {
        ...
        ag_err = ag_drv_dsptchr_debug_glbl_tsk_cnt_0_7_get(&debug_glbl_tsk_cnt_0_7);
    ...
    case cli_dsptchr_debug_glbl_tsk_cnt_8_15:
    {
        ...
        ag_err = ag_drv_dsptchr_debug_glbl_tsk_cnt_8_15_get(&debug_glbl_tsk_cnt_8_15);
    ...
    {
        uint8_t dbg_sel;
        ag_err = ag_drv_dsptchr_debug_dbg_bus_cntrl_get(&dbg_sel);
    ...
    case cli_dsptchr_debug_dbg_vec_0:
    {
        ...
        ag_err = ag_drv_dsptchr_debug_dbg_vec_0_get(&dbg_vec_val);
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_1_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_2_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_3_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_4_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_5_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_6_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_7_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_8_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_9_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_10_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_11_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_12_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_13_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_14_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_15_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_16_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_17_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_18_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_19_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_20_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_21_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_22_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_dbg_vec_23_get(&dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    case cli_dsptchr_debug_intr_vec_0:
    {
        uint32_t intr_vec_0;
        ag_err = ag_drv_dsptchr_debug_intr_vec_0_get(&intr_vec_0);
        bdmf_session_print(session, "intr_vec_0 = %u = 0x%x\n", intr_vec_0, intr_vec_0);
        break;
    }
    case cli_dsptchr_debug_intr_vec_1:
    {
        uint32_t intr_vec_1;
        ag_err = ag_drv_dsptchr_debug_intr_vec_1_get(&intr_vec_1);
        bdmf_session_print(session, "intr_vec_1 = %u = 0x%x\n", intr_vec_1, intr_vec_1);
        break;
    }
    case cli_dsptchr_debug_intr_vec_2:
    {
        uint32_t intr_vec_2;
        ag_err = ag_drv_dsptchr_debug_intr_vec_2_get(&intr_vec_2);
        bdmf_session_print(session, "intr_vec_2 = %u = 0x%x\n", intr_vec_2, intr_vec_2);
        break;
    }
    case cli_dsptchr_debug_intr_vec_3:
    {
        uint32_t intr_vec_3;
        ag_err = ag_drv_dsptchr_debug_intr_vec_3_get(&intr_vec_3);
        bdmf_session_print(session, "intr_vec_3 = %u = 0x%x\n", intr_vec_3, intr_vec_3);
        break;
    }
    case cli_dsptchr_debug_intr_vec_4:
    {
        uint32_t intr_vec_4;
        ag_err = ag_drv_dsptchr_debug_intr_vec_4_get(&intr_vec_4);
        bdmf_session_print(session, "intr_vec_4 = %u = 0x%x\n", intr_vec_4, intr_vec_4);
        break;
    }
    case cli_dsptchr_debug_statistics_dbg_sttstcs_ctrl:
    {
        ...
        uint8_t dbg_rnr_sel;
        ag_err = ag_drv_dsptchr_debug_statistics_dbg_sttstcs_ctrl_get(&dbg_mode, &en_cntrs, &clr_cntrs, &dbg_rnr_sel);
    ...
    {
        uint32_t dbg_vec_val;
        ag_err = ag_drv_dsptchr_debug_statistics_dbg_cnt_get(parm[1].value.unumber, &dbg_vec_val);
        bdmf_session_print(session, "dbg_vec_val = %u = 0x%x\n", dbg_vec_val, dbg_vec_val);
        break;
    }
    case cli_dsptchr_qdes_head:
    {
        uint32_t head;
        ag_err = ag_drv_dsptchr_qdes_head_get(parm[1].value.unumber, &head);
        bdmf_session_print(session, "head = %u = 0x%x\n", head, head);
        break;
    }
    case cli_dsptchr_qdes_bfout:
    {
        ...
        ag_err = ag_drv_dsptchr_qdes_bfout_get(parm[1].value.unumber, &qdes_bfout);
    ...
    case cli_dsptchr_qdes_bufin:
    {
        ...
        ag_err = ag_drv_dsptchr_qdes_bufin_get(parm[1].value.unumber, &qdes_bufin);
    ...
    {
        uint32_t tail;
        ag_err = ag_drv_dsptchr_qdes_tail_get(parm[1].value.unumber, &tail);
        bdmf_session_print(session, "tail = %u = 0x%x\n", tail, tail);
        break;
    }
    case cli_dsptchr_qdes_fbdnull:
    {
        ...
        ag_err = ag_drv_dsptchr_qdes_fbdnull_get(parm[1].value.unumber, &qdes_fbdnull);
    ...
    case cli_dsptchr_qdes_nullbd:
    {
        ...
        ag_err = ag_drv_dsptchr_qdes_nullbd_get(parm[1].value.unumber, &qdes_nullbd);
    ...
    case cli_dsptchr_qdes_bufavail:
    {
        ...
        ag_err = ag_drv_dsptchr_qdes_bufavail_get(parm[1].value.unumber, &qdes_bufavail);
    ...
    {
        uint16_t head;
        ag_err = ag_drv_dsptchr_qdes_reg_q_head_get(parm[1].value.unumber, &head);
        bdmf_session_print(session, "head = %u = 0x%x\n", head, head);
        break;
    }
    case cli_dsptchr_qdes_reg_viq_head_vld:
    {
        ...
        ag_err = ag_drv_dsptchr_qdes_reg_viq_head_vld_get(&viq_head_vld);
    ...
    {
        uint32_t chrncy_vld;
        ag_err = ag_drv_dsptchr_qdes_reg_viq_chrncy_vld_get(&chrncy_vld);
    ...
    {
        uint32_t viq_head_vld;
        ag_err = ag_drv_dsptchr_qdes_reg_veq_head_vld_get(&viq_head_vld);
        bdmf_session_print(session, "viq_head_vld = %u = 0x%x\n", viq_head_vld, viq_head_vld);
        break;
    }
    case cli_dsptchr_qdes_reg_qdes_buf_avl_cntrl:
    {
        ...
        ag_err = ag_drv_dsptchr_qdes_reg_qdes_buf_avl_cntrl_get(&use_buf_avl, &dec_bufout_when_mltcst);
    ...
    {
        uint32_t drpcnt;
        ag_err = ag_drv_dsptchr_flldes_flldrop_get(&drpcnt);
    ...
    {
        uint32_t bufavail;
        ag_err = ag_drv_dsptchr_flldes_bufavail_get(&bufavail);
    ...
    {
        uint32_t freemin;
        ag_err = ag_drv_dsptchr_flldes_freemin_get(&freemin);
    ...
    {
        uint16_t data;
        ag_err = ag_drv_dsptchr_bdram_next_data_get(parm[1].value.unumber, &data);
    ...
    {
        uint16_t data;
        ag_err = ag_drv_dsptchr_bdram_prev_data_get(parm[1].value.unumber, &data);
        bdmf_session_print(session, "data = %u = 0x%x\n", data, data);
        break;
    }
    case cli_dsptchr_pdram_data:
    {
        ...
        ag_err = ag_drv_dsptchr_pdram_data_get(parm[1].value.unumber, &pdram_data);
...
static int ag_drv_dsptchr_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_cngs_params_set( %u %u %u %u)\n", viq_idx,
            cngs_params.frst_lvl, cngs_params.scnd_lvl, cngs_params.hyst_thrs);
        ag_err = ag_drv_dsptchr_cngs_params_set(viq_idx, &cngs_params);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_cngs_params_get(viq_idx, &cngs_params);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_cngs_params_get( %u %u %u %u)\n", viq_idx,
                cngs_params.frst_lvl, cngs_params.scnd_lvl, cngs_params.hyst_thrs);
        }
        else
        {
        ...
        if (cngs_params.frst_lvl != gtmv(m, 12) || cngs_params.scnd_lvl != gtmv(m, 12) || cngs_params.hyst_thrs != gtmv(m, 8))
        {
            test_failure_cnt++;
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_glbl_cngs_params_set( %u %u %u)\n",
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_glbl_cngs_params_get( %u %u %u)\n",
                glbl_cngs_params.frst_lvl, glbl_cngs_params.scnd_lvl, glbl_cngs_params.hyst_thrs);
        }
        else
        {
        ...
        if (glbl_cngs_params.frst_lvl != gtmv(m, 12) || glbl_cngs_params.scnd_lvl != gtmv(m, 12) || glbl_cngs_params.hyst_thrs != gtmv(m, 8))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_q_size_params_set( %u %u)\n", q_idx,
            cmn_cnt);
        ag_err = ag_drv_dsptchr_q_size_params_set(q_idx, cmn_cnt);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_q_size_params_get(q_idx, &cmn_cnt);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_q_size_params_get( %u %u)\n", q_idx,
                cmn_cnt);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_credit_cnt_set( %u %u)\n", q_idx,
            credit_cnt);
        ag_err = ag_drv_dsptchr_credit_cnt_set(q_idx, credit_cnt);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_credit_cnt_get(q_idx, &credit_cnt);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_credit_cnt_get( %u %u)\n", q_idx,
                credit_cnt);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_q_limits_params_set( %u %u %u)\n", q_idx,
            cmn_max, gurntd_max);
        ag_err = ag_drv_dsptchr_q_limits_params_set(q_idx, cmn_max, gurntd_max);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_q_limits_params_get(q_idx, &cmn_max, &gurntd_max);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_q_limits_params_get( %u %u %u)\n", q_idx,
                cmn_max, gurntd_max);
        }
        else
        {
        ...
        if (cmn_max != gtmv(m, 10) || gurntd_max != gtmv(m, 10))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_ingress_coherency_params_set( %u %u %u)\n", q_idx,
            chrncy_en, chrncy_cnt);
        ag_err = ag_drv_dsptchr_ingress_coherency_params_set(q_idx, chrncy_en, chrncy_cnt);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_ingress_coherency_params_get(q_idx, &chrncy_en, &chrncy_cnt);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_ingress_coherency_params_get( %u %u %u)\n", q_idx,
                chrncy_en, chrncy_cnt);
        }
        else
        {
        ...
        if (chrncy_en != gtmv(m, 1) || chrncy_cnt != gtmv(m, 10))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_pools_limits_set( %u %u %u %u %u %u %u %u %u)\n",
            pools_limits.cmn_pool_lmt, pools_limits.grnted_pool_lmt, pools_limits.mcast_pool_lmt, pools_limits.rnr_pool_lmt, 
            pools_limits.cmn_pool_size, pools_limits.grnted_pool_size, pools_limits.mcast_pool_size, pools_limits.rnr_pool_size, 
            pools_limits.processing_pool_size);
        ag_err = ag_drv_dsptchr_pools_limits_set(&pools_limits);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_pools_limits_get(&pools_limits);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_pools_limits_get( %u %u %u %u %u %u %u %u %u)\n",
                pools_limits.cmn_pool_lmt, pools_limits.grnted_pool_lmt, pools_limits.mcast_pool_lmt, pools_limits.rnr_pool_lmt, 
                pools_limits.cmn_pool_size, pools_limits.grnted_pool_size, pools_limits.mcast_pool_size, pools_limits.rnr_pool_size, 
                pools_limits.processing_pool_size);
        }
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_fll_entry_set( %u %u %u %u %u)\n",
            fll_entry.head, fll_entry.tail, fll_entry.minbuf, fll_entry.bfin, 
            fll_entry.count);
        ag_err = ag_drv_dsptchr_fll_entry_set(&fll_entry);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_fll_entry_get(&fll_entry);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_fll_entry_get( %u %u %u %u %u)\n",
                fll_entry.head, fll_entry.tail, fll_entry.minbuf, fll_entry.bfin, 
                fll_entry.count);
        }
        else
        ...
        if (fll_entry.head != gtmv(m, 32) || fll_entry.tail != gtmv(m, 32) || fll_entry.minbuf != gtmv(m, 32) || fll_entry.bfin != gtmv(m, 32) || fll_entry.count != gtmv(m, 32))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_rnr_dsptch_addr_set( %u %u %u)\n", rnr_idx,
            rnr_dsptch_addr.base_add, rnr_dsptch_addr.offset_add);
        ag_err = ag_drv_dsptchr_rnr_dsptch_addr_set(rnr_idx, &rnr_dsptch_addr);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_rnr_dsptch_addr_get(rnr_idx, &rnr_dsptch_addr);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_rnr_dsptch_addr_get( %u %u %u)\n", rnr_idx,
                rnr_dsptch_addr.base_add, rnr_dsptch_addr.offset_add);
        }
        else
        {
        ...
        if (rnr_dsptch_addr.base_add != gtmv(m, 16) || rnr_dsptch_addr.offset_add != gtmv(m, 16))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
    ...
    {
        dsptchr_reorder_cfg_dsptchr_reordr_cfg reorder_cfg_dsptchr_reordr_cfg = {.disp_enable = gtmv(m, 1), .auto_init_en = gtmv(m, 1), .auto_init_size = gtmv(m, 2), .rdy = gtmv(m, 1), .reordr_par_mod = gtmv(m, 1), .per_q_egrs_congst_en = gtmv(m, 1), .dsptch_sm_enh_mod = gtmv(m, 1), .ingrs_pipe_dly_en = gtmv(m, 1), .ingrs_pipe_dly_cnt = gtmv(m, 3), .egrs_drop_only = gtmv(m, 1), .crdt_eff_rep = gtmv(m, 1), .tsk_free_num_place = gtmv(m, 1)};
        bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_set( %u %u %u %u %u %u %u %u %u %u %u %u)\n",
            reorder_cfg_dsptchr_reordr_cfg.disp_enable, reorder_cfg_dsptchr_reordr_cfg.auto_init_en, reorder_cfg_dsptchr_reordr_cfg.auto_init_size, reorder_cfg_dsptchr_reordr_cfg.rdy, 
            reorder_cfg_dsptchr_reordr_cfg.reordr_par_mod, reorder_cfg_dsptchr_reordr_cfg.per_q_egrs_congst_en, reorder_cfg_dsptchr_reordr_cfg.dsptch_sm_enh_mod, reorder_cfg_dsptchr_reordr_cfg.ingrs_pipe_dly_en, 
            reorder_cfg_dsptchr_reordr_cfg.ingrs_pipe_dly_cnt, reorder_cfg_dsptchr_reordr_cfg.egrs_drop_only, reorder_cfg_dsptchr_reordr_cfg.crdt_eff_rep, reorder_cfg_dsptchr_reordr_cfg.tsk_free_num_place);
        ag_err = ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_set(&reorder_cfg_dsptchr_reordr_cfg);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_get(&reorder_cfg_dsptchr_reordr_cfg);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_get( %u %u %u %u %u %u %u %u %u %u %u %u)\n",
                reorder_cfg_dsptchr_reordr_cfg.disp_enable, reorder_cfg_dsptchr_reordr_cfg.auto_init_en, reorder_cfg_dsptchr_reordr_cfg.auto_init_size, reorder_cfg_dsptchr_reordr_cfg.rdy, 
                reorder_cfg_dsptchr_reordr_cfg.reordr_par_mod, reorder_cfg_dsptchr_reordr_cfg.per_q_egrs_congst_en, reorder_cfg_dsptchr_reordr_cfg.dsptch_sm_enh_mod, reorder_cfg_dsptchr_reordr_cfg.ingrs_pipe_dly_en, 
                reorder_cfg_dsptchr_reordr_cfg.ingrs_pipe_dly_cnt, reorder_cfg_dsptchr_reordr_cfg.egrs_drop_only, reorder_cfg_dsptchr_reordr_cfg.crdt_eff_rep, reorder_cfg_dsptchr_reordr_cfg.tsk_free_num_place);
        }
        ...
        if (reorder_cfg_dsptchr_reordr_cfg.disp_enable != gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.auto_init_en != gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.auto_init_size != gtmv(m, 2) || reorder_cfg_dsptchr_reordr_cfg.rdy != gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.reordr_par_mod != gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.per_q_egrs_congst_en != gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.dsptch_sm_enh_mod != gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.ingrs_pipe_dly_en != gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.ingrs_pipe_dly_cnt != gtmv(m, 3) || reorder_cfg_dsptchr_reordr_cfg.egrs_drop_only != gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.crdt_eff_rep != gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.tsk_free_num_place != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_vq_en_set( %u)\n",
            en);
        ag_err = ag_drv_dsptchr_reorder_cfg_vq_en_set(en);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_reorder_cfg_vq_en_get(&en);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_vq_en_get( %u)\n",
                en);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_bb_cfg_set( %u %u %u %u)\n",
            src_id, dst_id_ovride, route_ovride, ovride_en);
        ag_err = ag_drv_dsptchr_reorder_cfg_bb_cfg_set(src_id, dst_id_ovride, route_ovride, ovride_en);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_reorder_cfg_bb_cfg_get(&src_id, &dst_id_ovride, &route_ovride, &ovride_en);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_bb_cfg_get( %u %u %u %u)\n",
                src_id, dst_id_ovride, route_ovride, ovride_en);
        }
        else
        {
        ...
        if (src_id != gtmv(m, 6) || dst_id_ovride != gtmv(m, 6) || route_ovride != gtmv(m, 10) || ovride_en != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_clk_gate_cntrl_set( %u %u %u %u %u)\n",
            reorder_cfg_clk_gate_cntrl.bypass_clk_gate, reorder_cfg_clk_gate_cntrl.timer_val, reorder_cfg_clk_gate_cntrl.keep_alive_en, reorder_cfg_clk_gate_cntrl.keep_alive_intrvl, 
            reorder_cfg_clk_gate_cntrl.keep_alive_cyc);
        ag_err = ag_drv_dsptchr_reorder_cfg_clk_gate_cntrl_set(&reorder_cfg_clk_gate_cntrl);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_reorder_cfg_clk_gate_cntrl_get(&reorder_cfg_clk_gate_cntrl);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_clk_gate_cntrl_get( %u %u %u %u %u)\n",
                reorder_cfg_clk_gate_cntrl.bypass_clk_gate, reorder_cfg_clk_gate_cntrl.timer_val, reorder_cfg_clk_gate_cntrl.keep_alive_en, reorder_cfg_clk_gate_cntrl.keep_alive_intrvl, 
                reorder_cfg_clk_gate_cntrl.keep_alive_cyc);
        }
        else
        ...
        if (reorder_cfg_clk_gate_cntrl.bypass_clk_gate != gtmv(m, 1) || reorder_cfg_clk_gate_cntrl.timer_val != gtmv(m, 8) || reorder_cfg_clk_gate_cntrl.keep_alive_en != gtmv(m, 1) || reorder_cfg_clk_gate_cntrl.keep_alive_intrvl != gtmv(m, 3) || reorder_cfg_clk_gate_cntrl.keep_alive_cyc != gtmv(m, 8))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        uint8_t viq_idx = gtmv(m, 5);
        dsptchr_cngs_params cngs_params = {.frst_lvl = gtmv(m, 12), .scnd_lvl = gtmv(m, 12), .hyst_thrs = gtmv(m, 8)};
        bdmf_session_print(session, "ag_drv_dsptchr_congestion_egrs_congstn_set( %u %u %u %u)\n", viq_idx,
            cngs_params.frst_lvl, cngs_params.scnd_lvl, cngs_params.hyst_thrs);
        ag_err = ag_drv_dsptchr_congestion_egrs_congstn_set(viq_idx, &cngs_params);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_congestion_egrs_congstn_get(viq_idx, &cngs_params);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_congestion_egrs_congstn_get( %u %u %u %u)\n", viq_idx,
                cngs_params.frst_lvl, cngs_params.scnd_lvl, cngs_params.hyst_thrs);
        }
        else
        {
...

    {
        uint8_t viq_idx = gtmv(m, 5);
        dsptchr_cngs_params cngs_params = {.frst_lvl = gtmv(m, 12), .scnd_lvl = gtmv(m, 12), .hyst_thrs = gtmv(m, 8)};
        bdmf_session_print(session, "ag_drv_dsptchr_congestion_total_egrs_congstn_set( %u %u %u %u)\n", viq_idx,
            cngs_params.frst_lvl, cngs_params.scnd_lvl, cngs_params.hyst_thrs);
        ag_err = ag_drv_dsptchr_congestion_total_egrs_congstn_set(viq_idx, &cngs_params);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_congestion_total_egrs_congstn_get(viq_idx, &cngs_params);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_congestion_total_egrs_congstn_get( %u %u %u %u)\n", viq_idx,
                cngs_params.frst_lvl, cngs_params.scnd_lvl, cngs_params.hyst_thrs);
        }
        else
        {
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_congestion_congstn_status_get( %u %u %u %u %u %u)\n",
                congestion_congstn_status.glbl_congstn, congestion_congstn_status.glbl_egrs_congstn, congestion_congstn_status.sbpm_congstn, congestion_congstn_status.glbl_congstn_stcky, 
                congestion_congstn_status.glbl_egrs_congstn_stcky, congestion_congstn_status.sbpm_congstn_stcky);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_congestion_per_q_ingrs_congstn_low_get( %u)\n",
                congstn_state);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_congestion_per_q_ingrs_congstn_high_get( %u)\n",
                congstn_state);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_congestion_per_q_egrs_congstn_low_get( %u)\n",
                congstn_state);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_congestion_per_q_egrs_congstn_high_get( %u)\n",
                congstn_state);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_queue_mapping_crdt_cfg_set( %u %u %u)\n", q_idx,
            bb_id, trgt_add);
        ag_err = ag_drv_dsptchr_queue_mapping_crdt_cfg_set(q_idx, bb_id, trgt_add);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_queue_mapping_crdt_cfg_get(q_idx, &bb_id, &trgt_add);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_queue_mapping_crdt_cfg_get( %u %u %u)\n", q_idx,
                bb_id, trgt_add);
        }
        else
        {
        ...
        if (bb_id != gtmv(m, 8) || trgt_add != gtmv(m, 16))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_queue_mapping_q_dest_set( %u)\n",
            is_dest_disp);
        ag_err = ag_drv_dsptchr_queue_mapping_q_dest_set(is_dest_disp);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_queue_mapping_q_dest_get(&is_dest_disp);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_queue_mapping_q_dest_get( %u)\n",
                is_dest_disp);
        }
        else
        {
    ...
    {
        dsptchr_queue_mapping_pd_dsptch_add_rnr_grp queue_mapping_pd_dsptch_add_rnr_grp = {.rnr_g_sel0 = gtmv(m, 1), .rnr_g_sel1 = gtmv(m, 1), .rnr_g_sel2 = gtmv(m, 1), .rnr_g_sel3 = gtmv(m, 1), .rnr_g_sel4 = gtmv(m, 1), .rnr_g_sel5 = gtmv(m, 1), .rnr_g_sel6 = gtmv(m, 1), .rnr_g_sel7 = gtmv(m, 1)};
        bdmf_session_print(session, "ag_drv_dsptchr_queue_mapping_pd_dsptch_add_rnr_grp_set( %u %u %u %u %u %u %u %u)\n",
            queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel0, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel1, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel2, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel3, 
            queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel4, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel5, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel6, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel7);
        ag_err = ag_drv_dsptchr_queue_mapping_pd_dsptch_add_rnr_grp_set(&queue_mapping_pd_dsptch_add_rnr_grp);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_queue_mapping_pd_dsptch_add_rnr_grp_get(&queue_mapping_pd_dsptch_add_rnr_grp);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_queue_mapping_pd_dsptch_add_rnr_grp_get( %u %u %u %u %u %u %u %u)\n",
                queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel0, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel1, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel2, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel3, 
                queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel4, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel5, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel6, queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel7);
        }
        else
        ...
        if (queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel0 != gtmv(m, 1) || queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel1 != gtmv(m, 1) || queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel2 != gtmv(m, 1) || queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel3 != gtmv(m, 1) || queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel4 != gtmv(m, 1) || queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel5 != gtmv(m, 1) || queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel6 != gtmv(m, 1) || queue_mapping_pd_dsptch_add_rnr_grp.rnr_g_sel7 != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_mask_msk_tsk_255_0_set( %u %u %u %u %u %u %u %u %u)\n", group_idx,
            mask_msk_tsk_255_0.task_mask[0], mask_msk_tsk_255_0.task_mask[1], mask_msk_tsk_255_0.task_mask[2], mask_msk_tsk_255_0.task_mask[3], 
            mask_msk_tsk_255_0.task_mask[4], mask_msk_tsk_255_0.task_mask[5], mask_msk_tsk_255_0.task_mask[6], mask_msk_tsk_255_0.task_mask[7]);
        ag_err = ag_drv_dsptchr_mask_msk_tsk_255_0_set(group_idx, &mask_msk_tsk_255_0);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_mask_msk_tsk_255_0_get(group_idx, &mask_msk_tsk_255_0);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_mask_msk_tsk_255_0_get( %u %u %u %u %u %u %u %u %u)\n", group_idx,
                mask_msk_tsk_255_0.task_mask[0], mask_msk_tsk_255_0.task_mask[1], mask_msk_tsk_255_0.task_mask[2], mask_msk_tsk_255_0.task_mask[3], 
                mask_msk_tsk_255_0.task_mask[4], mask_msk_tsk_255_0.task_mask[5], mask_msk_tsk_255_0.task_mask[6], mask_msk_tsk_255_0.task_mask[7]);
        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_mask_msk_q_set( %u %u)\n", group_idx,
            mask);
        ag_err = ag_drv_dsptchr_mask_msk_q_set(group_idx, mask);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_mask_msk_q_get(group_idx, &mask);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_mask_msk_q_get( %u %u)\n", group_idx,
                mask);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_mask_dly_q_set( %u)\n",
            set_delay);
        ag_err = ag_drv_dsptchr_mask_dly_q_set(set_delay);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_mask_dly_q_get(&set_delay);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_mask_dly_q_get( %u)\n",
                set_delay);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_mask_non_dly_q_set( %u)\n",
            set_non_delay);
        ag_err = ag_drv_dsptchr_mask_non_dly_q_set(set_non_delay);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_mask_non_dly_q_get(&set_non_delay);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_mask_non_dly_q_get( %u)\n",
                set_non_delay);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_egrs_queues_egrs_dly_qm_crdt_set( %u)\n",
            dly_crdt);
        ag_err = ag_drv_dsptchr_egrs_queues_egrs_dly_qm_crdt_set(dly_crdt);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_egrs_queues_egrs_dly_qm_crdt_get(&dly_crdt);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_egrs_queues_egrs_dly_qm_crdt_get( %u)\n",
                dly_crdt);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_egrs_queues_egrs_non_dly_qm_crdt_set( %u)\n",
            non_dly_crdt);
        ag_err = ag_drv_dsptchr_egrs_queues_egrs_non_dly_qm_crdt_set(non_dly_crdt);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_egrs_queues_egrs_non_dly_qm_crdt_get(&non_dly_crdt);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_egrs_queues_egrs_non_dly_qm_crdt_get( %u)\n",
                non_dly_crdt);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_egrs_queues_total_q_egrs_size_set( %u)\n",
            total_egrs_size);
        ag_err = ag_drv_dsptchr_egrs_queues_total_q_egrs_size_set(total_egrs_size);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_egrs_queues_total_q_egrs_size_get(&total_egrs_size);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_egrs_queues_total_q_egrs_size_get( %u)\n",
                total_egrs_size);
        }
        else
        {
...

    {
        ...
        if (!ag_err)
            ag_err = ag_drv_dsptchr_egrs_queues_per_q_egrs_size_get(q_idx, &q_egrs_size);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_egrs_queues_per_q_egrs_size_get( %u %u)\n", q_idx,
                q_egrs_size);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_wakeup_control_wkup_req_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n",
            wakeup_control_wkup_req.q0, wakeup_control_wkup_req.q1, wakeup_control_wkup_req.q2, wakeup_control_wkup_req.q3, 
            wakeup_control_wkup_req.q4, wakeup_control_wkup_req.q5, wakeup_control_wkup_req.q6, wakeup_control_wkup_req.q7, 
            wakeup_control_wkup_req.q8, wakeup_control_wkup_req.q9, wakeup_control_wkup_req.q10, wakeup_control_wkup_req.q11, 
            wakeup_control_wkup_req.q12, wakeup_control_wkup_req.q13, wakeup_control_wkup_req.q14, wakeup_control_wkup_req.q15, 
            wakeup_control_wkup_req.q16, wakeup_control_wkup_req.q17, wakeup_control_wkup_req.q18, wakeup_control_wkup_req.q19, 
            wakeup_control_wkup_req.q20, wakeup_control_wkup_req.q21, wakeup_control_wkup_req.q22, wakeup_control_wkup_req.q23, 
            wakeup_control_wkup_req.q24, wakeup_control_wkup_req.q25, wakeup_control_wkup_req.q26, wakeup_control_wkup_req.q27, 
            wakeup_control_wkup_req.q28, wakeup_control_wkup_req.q29, wakeup_control_wkup_req.q30, wakeup_control_wkup_req.q31);
        ag_err = ag_drv_dsptchr_wakeup_control_wkup_req_set(&wakeup_control_wkup_req);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_wakeup_control_wkup_req_get(&wakeup_control_wkup_req);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_wakeup_control_wkup_req_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n",
                wakeup_control_wkup_req.q0, wakeup_control_wkup_req.q1, wakeup_control_wkup_req.q2, wakeup_control_wkup_req.q3, 
                wakeup_control_wkup_req.q4, wakeup_control_wkup_req.q5, wakeup_control_wkup_req.q6, wakeup_control_wkup_req.q7, 
                wakeup_control_wkup_req.q8, wakeup_control_wkup_req.q9, wakeup_control_wkup_req.q10, wakeup_control_wkup_req.q11, 
                wakeup_control_wkup_req.q12, wakeup_control_wkup_req.q13, wakeup_control_wkup_req.q14, wakeup_control_wkup_req.q15, 
        ...
        if (wakeup_control_wkup_req.q0 != gtmv(m, 1) || wakeup_control_wkup_req.q1 != gtmv(m, 1) || wakeup_control_wkup_req.q2 != gtmv(m, 1) || wakeup_control_wkup_req.q3 != gtmv(m, 1) || wakeup_control_wkup_req.q4 != gtmv(m, 1) || wakeup_control_wkup_req.q5 != gtmv(m, 1) || wakeup_control_wkup_req.q6 != gtmv(m, 1) || wakeup_control_wkup_req.q7 != gtmv(m, 1) || wakeup_control_wkup_req.q8 != gtmv(m, 1) || wakeup_control_wkup_req.q9 != gtmv(m, 1) || wakeup_control_wkup_req.q10 != gtmv(m, 1) || wakeup_control_wkup_req.q11 != gtmv(m, 1) || wakeup_control_wkup_req.q12 != gtmv(m, 1) || wakeup_control_wkup_req.q13 != gtmv(m, 1) || wakeup_control_wkup_req.q14 != gtmv(m, 1) || wakeup_control_wkup_req.q15 != gtmv(m, 1) || wakeup_control_wkup_req.q16 != gtmv(m, 1) || wakeup_control_wkup_req.q17 != gtmv(m, 1) || wakeup_control_wkup_req.q18 != gtmv(m, 1) || wakeup_control_wkup_req.q19 != gtmv(m, 1) || wakeup_control_wkup_req.q20 != gtmv(m, 1) || wakeup_control_wkup_req.q21 != gtmv(m, 1) || wakeup_control_wkup_req.q22 != gtmv(m, 1) || wakeup_control_wkup_req.q23 != gtmv(m, 1) || wakeup_control_wkup_req.q24 != gtmv(m, 1) || wakeup_control_wkup_req.q25 != gtmv(m, 1) || wakeup_control_wkup_req.q26 != gtmv(m, 1) || wakeup_control_wkup_req.q27 != gtmv(m, 1) || wakeup_control_wkup_req.q28 != gtmv(m, 1) || wakeup_control_wkup_req.q29 != gtmv(m, 1) || wakeup_control_wkup_req.q30 != gtmv(m, 1) || wakeup_control_wkup_req.q31 != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_wakeup_control_wkup_thrshld_set( %u)\n",
            wkup_thrshld);
        ag_err = ag_drv_dsptchr_wakeup_control_wkup_thrshld_set(wkup_thrshld);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_wakeup_control_wkup_thrshld_get(&wkup_thrshld);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_wakeup_control_wkup_thrshld_get( %u)\n",
                wkup_thrshld);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_disptch_scheduling_dwrr_info_set( %u %u %u %u)\n", dwrr_q_idx,
            q_crdt, ngtv, quntum);
        ag_err = ag_drv_dsptchr_disptch_scheduling_dwrr_info_set(dwrr_q_idx, q_crdt, ngtv, quntum);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_disptch_scheduling_dwrr_info_get(dwrr_q_idx, &q_crdt, &ngtv, &quntum);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_disptch_scheduling_dwrr_info_get( %u %u %u %u)\n", dwrr_q_idx,
                q_crdt, ngtv, quntum);
        }
        else
        {
        ...
        if (q_crdt != gtmv(m, 20) || ngtv != gtmv(m, 1) || quntum != gtmv(m, 11))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
    ...
    {
        dsptchr_disptch_scheduling_vld_crdt disptch_scheduling_vld_crdt = {.q0 = gtmv(m, 1), .q1 = gtmv(m, 1), .q2 = gtmv(m, 1), .q3 = gtmv(m, 1), .q4 = gtmv(m, 1), .q5 = gtmv(m, 1), .q6 = gtmv(m, 1), .q7 = gtmv(m, 1), .q8 = gtmv(m, 1), .q9 = gtmv(m, 1), .q10 = gtmv(m, 1), .q11 = gtmv(m, 1), .q12 = gtmv(m, 1), .q13 = gtmv(m, 1), .q14 = gtmv(m, 1), .q15 = gtmv(m, 1), .q16 = gtmv(m, 1), .q17 = gtmv(m, 1), .q18 = gtmv(m, 1), .q19 = gtmv(m, 1), .q20 = gtmv(m, 1), .q21 = gtmv(m, 1), .q22 = gtmv(m, 1), .q23 = gtmv(m, 1), .q24 = gtmv(m, 1), .q25 = gtmv(m, 1), .q26 = gtmv(m, 1), .q27 = gtmv(m, 1), .q28 = gtmv(m, 1), .q29 = gtmv(m, 1), .q30 = gtmv(m, 1), .q31 = gtmv(m, 1)};
        bdmf_session_print(session, "ag_drv_dsptchr_disptch_scheduling_vld_crdt_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n",
            disptch_scheduling_vld_crdt.q0, disptch_scheduling_vld_crdt.q1, disptch_scheduling_vld_crdt.q2, disptch_scheduling_vld_crdt.q3, 
            disptch_scheduling_vld_crdt.q4, disptch_scheduling_vld_crdt.q5, disptch_scheduling_vld_crdt.q6, disptch_scheduling_vld_crdt.q7, 
            disptch_scheduling_vld_crdt.q8, disptch_scheduling_vld_crdt.q9, disptch_scheduling_vld_crdt.q10, disptch_scheduling_vld_crdt.q11, 
            disptch_scheduling_vld_crdt.q12, disptch_scheduling_vld_crdt.q13, disptch_scheduling_vld_crdt.q14, disptch_scheduling_vld_crdt.q15, 
            disptch_scheduling_vld_crdt.q16, disptch_scheduling_vld_crdt.q17, disptch_scheduling_vld_crdt.q18, disptch_scheduling_vld_crdt.q19, 
            disptch_scheduling_vld_crdt.q20, disptch_scheduling_vld_crdt.q21, disptch_scheduling_vld_crdt.q22, disptch_scheduling_vld_crdt.q23, 
            disptch_scheduling_vld_crdt.q24, disptch_scheduling_vld_crdt.q25, disptch_scheduling_vld_crdt.q26, disptch_scheduling_vld_crdt.q27, 
            disptch_scheduling_vld_crdt.q28, disptch_scheduling_vld_crdt.q29, disptch_scheduling_vld_crdt.q30, disptch_scheduling_vld_crdt.q31);
        ag_err = ag_drv_dsptchr_disptch_scheduling_vld_crdt_set(&disptch_scheduling_vld_crdt);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_disptch_scheduling_vld_crdt_get(&disptch_scheduling_vld_crdt);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_disptch_scheduling_vld_crdt_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n",
                disptch_scheduling_vld_crdt.q0, disptch_scheduling_vld_crdt.q1, disptch_scheduling_vld_crdt.q2, disptch_scheduling_vld_crdt.q3, 
                disptch_scheduling_vld_crdt.q4, disptch_scheduling_vld_crdt.q5, disptch_scheduling_vld_crdt.q6, disptch_scheduling_vld_crdt.q7, 
                disptch_scheduling_vld_crdt.q8, disptch_scheduling_vld_crdt.q9, disptch_scheduling_vld_crdt.q10, disptch_scheduling_vld_crdt.q11, 
                disptch_scheduling_vld_crdt.q12, disptch_scheduling_vld_crdt.q13, disptch_scheduling_vld_crdt.q14, disptch_scheduling_vld_crdt.q15, 
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_lb_cfg_set( %u %u)\n",
            lb_mode, sp_thrshld);
        ag_err = ag_drv_dsptchr_load_balancing_lb_cfg_set(lb_mode, sp_thrshld);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_load_balancing_lb_cfg_get(&lb_mode, &sp_thrshld);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_lb_cfg_get( %u %u)\n",
                lb_mode, sp_thrshld);
        }
        else
        {
        ...
        if (lb_mode != gtmv(m, 1) || sp_thrshld != gtmv(m, 5))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_0_1_set( %u %u)\n",
            rnr0, rnr1);
        ag_err = ag_drv_dsptchr_load_balancing_free_task_0_1_set(rnr0, rnr1);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_load_balancing_free_task_0_1_get(&rnr0, &rnr1);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_0_1_get( %u %u)\n",
                rnr0, rnr1);
        }
        else
        {
        ...
        if (rnr0 != gtmv(m, 16) || rnr1 != gtmv(m, 16))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_2_3_set( %u %u)\n",
            rnr2, rnr3);
        ag_err = ag_drv_dsptchr_load_balancing_free_task_2_3_set(rnr2, rnr3);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_load_balancing_free_task_2_3_get(&rnr2, &rnr3);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_2_3_get( %u %u)\n",
                rnr2, rnr3);
        }
        else
        {
        ...
        if (rnr2 != gtmv(m, 16) || rnr3 != gtmv(m, 16))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_4_5_set( %u %u)\n",
            rnr4, rnr5);
        ag_err = ag_drv_dsptchr_load_balancing_free_task_4_5_set(rnr4, rnr5);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_load_balancing_free_task_4_5_get(&rnr4, &rnr5);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_4_5_get( %u %u)\n",
                rnr4, rnr5);
        }
        else
        {
        ...
        if (rnr4 != gtmv(m, 16) || rnr5 != gtmv(m, 16))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_6_7_set( %u %u)\n",
            rnr6, rnr7);
        ag_err = ag_drv_dsptchr_load_balancing_free_task_6_7_set(rnr6, rnr7);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_load_balancing_free_task_6_7_get(&rnr6, &rnr7);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_6_7_get( %u %u)\n",
                rnr6, rnr7);
        }
        else
        {
        ...
        if (rnr6 != gtmv(m, 16) || rnr7 != gtmv(m, 16))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_8_9_set( %u %u)\n",
            rnr8, rnr9);
        ag_err = ag_drv_dsptchr_load_balancing_free_task_8_9_set(rnr8, rnr9);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_load_balancing_free_task_8_9_get(&rnr8, &rnr9);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_8_9_get( %u %u)\n",
                rnr8, rnr9);
        }
        else
        {
        ...
        if (rnr8 != gtmv(m, 16) || rnr9 != gtmv(m, 16))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_10_11_set( %u %u)\n",
            rnr10, rnr11);
        ag_err = ag_drv_dsptchr_load_balancing_free_task_10_11_set(rnr10, rnr11);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_load_balancing_free_task_10_11_get(&rnr10, &rnr11);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_10_11_get( %u %u)\n",
                rnr10, rnr11);
        }
        else
        {
        ...
        if (rnr10 != gtmv(m, 16) || rnr11 != gtmv(m, 16))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_12_13_set( %u %u)\n",
            rnr12, rnr13);
        ag_err = ag_drv_dsptchr_load_balancing_free_task_12_13_set(rnr12, rnr13);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_load_balancing_free_task_12_13_get(&rnr12, &rnr13);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_12_13_get( %u %u)\n",
                rnr12, rnr13);
        }
        else
        {
        ...
        if (rnr12 != gtmv(m, 16) || rnr13 != gtmv(m, 16))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_14_15_set( %u %u)\n",
            rnr14, rnr15);
        ag_err = ag_drv_dsptchr_load_balancing_free_task_14_15_set(rnr14, rnr15);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_load_balancing_free_task_14_15_get(&rnr14, &rnr15);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_free_task_14_15_get( %u %u)\n",
                rnr14, rnr15);
        }
        else
        {
        ...
        if (rnr14 != gtmv(m, 16) || rnr15 != gtmv(m, 16))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_tsk_to_rg_mapping_set( %u %u %u %u %u %u %u %u %u)\n", task_to_rg_mapping,
            load_balancing_tsk_to_rg_mapping.tsk0, load_balancing_tsk_to_rg_mapping.tsk1, load_balancing_tsk_to_rg_mapping.tsk2, load_balancing_tsk_to_rg_mapping.tsk3, 
            load_balancing_tsk_to_rg_mapping.tsk4, load_balancing_tsk_to_rg_mapping.tsk5, load_balancing_tsk_to_rg_mapping.tsk6, load_balancing_tsk_to_rg_mapping.tsk7);
        ag_err = ag_drv_dsptchr_load_balancing_tsk_to_rg_mapping_set(task_to_rg_mapping, &load_balancing_tsk_to_rg_mapping);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_load_balancing_tsk_to_rg_mapping_get(task_to_rg_mapping, &load_balancing_tsk_to_rg_mapping);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_tsk_to_rg_mapping_get( %u %u %u %u %u %u %u %u %u)\n", task_to_rg_mapping,
                load_balancing_tsk_to_rg_mapping.tsk0, load_balancing_tsk_to_rg_mapping.tsk1, load_balancing_tsk_to_rg_mapping.tsk2, load_balancing_tsk_to_rg_mapping.tsk3, 
                load_balancing_tsk_to_rg_mapping.tsk4, load_balancing_tsk_to_rg_mapping.tsk5, load_balancing_tsk_to_rg_mapping.tsk6, load_balancing_tsk_to_rg_mapping.tsk7);
        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_rg_avlabl_tsk_0_3_set( %u %u %u %u)\n",
            tsk_cnt_rg_0, tsk_cnt_rg_1, tsk_cnt_rg_2, tsk_cnt_rg_3);
        ag_err = ag_drv_dsptchr_load_balancing_rg_avlabl_tsk_0_3_set(tsk_cnt_rg_0, tsk_cnt_rg_1, tsk_cnt_rg_2, tsk_cnt_rg_3);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_load_balancing_rg_avlabl_tsk_0_3_get(&tsk_cnt_rg_0, &tsk_cnt_rg_1, &tsk_cnt_rg_2, &tsk_cnt_rg_3);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_rg_avlabl_tsk_0_3_get( %u %u %u %u)\n",
                tsk_cnt_rg_0, tsk_cnt_rg_1, tsk_cnt_rg_2, tsk_cnt_rg_3);
        }
        else
        {
        ...
        if (tsk_cnt_rg_0 != gtmv(m, 8) || tsk_cnt_rg_1 != gtmv(m, 8) || tsk_cnt_rg_2 != gtmv(m, 8) || tsk_cnt_rg_3 != gtmv(m, 8))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_rg_avlabl_tsk_4_7_set( %u %u %u %u)\n",
            tsk_cnt_rg_4, tsk_cnt_rg_5, tsk_cnt_rg_6, tsk_cnt_rg_7);
        ag_err = ag_drv_dsptchr_load_balancing_rg_avlabl_tsk_4_7_set(tsk_cnt_rg_4, tsk_cnt_rg_5, tsk_cnt_rg_6, tsk_cnt_rg_7);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_load_balancing_rg_avlabl_tsk_4_7_get(&tsk_cnt_rg_4, &tsk_cnt_rg_5, &tsk_cnt_rg_6, &tsk_cnt_rg_7);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_rg_avlabl_tsk_4_7_get( %u %u %u %u)\n",
                tsk_cnt_rg_4, tsk_cnt_rg_5, tsk_cnt_rg_6, tsk_cnt_rg_7);
        }
        else
        {
        ...
        if (tsk_cnt_rg_4 != gtmv(m, 8) || tsk_cnt_rg_5 != gtmv(m, 8) || tsk_cnt_rg_6 != gtmv(m, 8) || tsk_cnt_rg_7 != gtmv(m, 8))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_isr_set( %u %u %u %u %u)\n",
            dsptcher_reordr_top_intr_ctrl_0_isr.fll_return_buf, dsptcher_reordr_top_intr_ctrl_0_isr.fll_cnt_drp, dsptcher_reordr_top_intr_ctrl_0_isr.unknwn_msg, dsptcher_reordr_top_intr_ctrl_0_isr.fll_overflow, 
            dsptcher_reordr_top_intr_ctrl_0_isr.fll_neg);
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_isr_set(&dsptcher_reordr_top_intr_ctrl_0_isr);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_isr_get(&dsptcher_reordr_top_intr_ctrl_0_isr);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_isr_get( %u %u %u %u %u)\n",
                dsptcher_reordr_top_intr_ctrl_0_isr.fll_return_buf, dsptcher_reordr_top_intr_ctrl_0_isr.fll_cnt_drp, dsptcher_reordr_top_intr_ctrl_0_isr.unknwn_msg, dsptcher_reordr_top_intr_ctrl_0_isr.fll_overflow, 
                dsptcher_reordr_top_intr_ctrl_0_isr.fll_neg);
        }
        else
        ...
        if (dsptcher_reordr_top_intr_ctrl_0_isr.fll_return_buf != gtmv(m, 1) || dsptcher_reordr_top_intr_ctrl_0_isr.fll_cnt_drp != gtmv(m, 1) || dsptcher_reordr_top_intr_ctrl_0_isr.unknwn_msg != gtmv(m, 1) || dsptcher_reordr_top_intr_ctrl_0_isr.fll_overflow != gtmv(m, 1) || dsptcher_reordr_top_intr_ctrl_0_isr.fll_neg != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_ism_get( %u)\n",
                ism);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_ier_set( %u)\n",
            iem);
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_ier_set(iem);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_ier_get(&iem);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_ier_get( %u)\n",
                iem);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_itr_set( %u)\n",
            ist);
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_itr_set(ist);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_itr_get(&ist);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_0_itr_get( %u)\n",
                ist);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_isr_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n",
            dsptcher_reordr_top_intr_ctrl_1_isr.qdest0_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest1_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest2_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest3_int, 
            dsptcher_reordr_top_intr_ctrl_1_isr.qdest4_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest5_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest6_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest7_int, 
            dsptcher_reordr_top_intr_ctrl_1_isr.qdest8_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest9_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest10_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest11_int, 
            dsptcher_reordr_top_intr_ctrl_1_isr.qdest12_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest13_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest14_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest15_int, 
            dsptcher_reordr_top_intr_ctrl_1_isr.qdest16_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest17_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest18_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest19_int, 
            dsptcher_reordr_top_intr_ctrl_1_isr.qdest20_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest21_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest22_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest23_int, 
            dsptcher_reordr_top_intr_ctrl_1_isr.qdest24_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest25_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest26_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest27_int, 
            dsptcher_reordr_top_intr_ctrl_1_isr.qdest28_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest29_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest30_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest31_int);
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_isr_set(&dsptcher_reordr_top_intr_ctrl_1_isr);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_isr_get(&dsptcher_reordr_top_intr_ctrl_1_isr);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_isr_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n",
                dsptcher_reordr_top_intr_ctrl_1_isr.qdest0_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest1_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest2_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest3_int, 
                dsptcher_reordr_top_intr_ctrl_1_isr.qdest4_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest5_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest6_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest7_int, 
                dsptcher_reordr_top_intr_ctrl_1_isr.qdest8_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest9_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest10_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest11_int, 
                dsptcher_reordr_top_intr_ctrl_1_isr.qdest12_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest13_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest14_int, dsptcher_reordr_top_intr_ctrl_1_isr.qdest15_int, 
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_ism_get( %u)\n",
                ism);
        }
    }
    ...
    {
        uint32_t iem = gtmv(m, 32);
        bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_ier_set( %u)\n",
            iem);
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_ier_set(iem);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_ier_get(&iem);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_ier_get( %u)\n",
                iem);
        }
        else
        {
    ...
    {
        uint32_t ist = gtmv(m, 32);
        bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_itr_set( %u)\n",
            ist);
        ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_itr_set(ist);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_itr_get(&ist);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_dsptcher_reordr_top_intr_ctrl_1_itr_get( %u)\n",
                ist);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_bypss_cntrl_set( %u %u %u)\n",
            en_byp, bbid_non_dly, bbid_dly);
        ag_err = ag_drv_dsptchr_debug_dbg_bypss_cntrl_set(en_byp, bbid_non_dly, bbid_dly);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_debug_dbg_bypss_cntrl_get(&en_byp, &bbid_non_dly, &bbid_dly);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_bypss_cntrl_get( %u %u %u)\n",
                en_byp, bbid_non_dly, bbid_dly);
        }
        else
        {
        ...
        if (en_byp != gtmv(m, 1) || bbid_non_dly != gtmv(m, 8) || bbid_dly != gtmv(m, 8))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_debug_glbl_tsk_cnt_0_7_set( %u %u %u %u %u %u %u %u)\n",
            debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_0, debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_1, debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_2, debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_3, 
            debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_4, debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_5, debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_6, debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_7);
        ag_err = ag_drv_dsptchr_debug_glbl_tsk_cnt_0_7_set(&debug_glbl_tsk_cnt_0_7);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_debug_glbl_tsk_cnt_0_7_get(&debug_glbl_tsk_cnt_0_7);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_glbl_tsk_cnt_0_7_get( %u %u %u %u %u %u %u %u)\n",
                debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_0, debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_1, debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_2, debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_3, 
                debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_4, debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_5, debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_6, debug_glbl_tsk_cnt_0_7.tsk_cnt_rnr_7);
        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_debug_glbl_tsk_cnt_8_15_set( %u %u %u %u %u %u %u %u)\n",
            debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_8, debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_9, debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_10, debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_11, 
            debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_12, debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_13, debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_14, debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_15);
        ag_err = ag_drv_dsptchr_debug_glbl_tsk_cnt_8_15_set(&debug_glbl_tsk_cnt_8_15);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_debug_glbl_tsk_cnt_8_15_get(&debug_glbl_tsk_cnt_8_15);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_glbl_tsk_cnt_8_15_get( %u %u %u %u %u %u %u %u)\n",
                debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_8, debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_9, debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_10, debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_11, 
                debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_12, debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_13, debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_14, debug_glbl_tsk_cnt_8_15.tsk_cnt_rnr_15);
        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_bus_cntrl_set( %u)\n",
            dbg_sel);
        ag_err = ag_drv_dsptchr_debug_dbg_bus_cntrl_set(dbg_sel);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_debug_dbg_bus_cntrl_get(&dbg_sel);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_bus_cntrl_get( %u)\n",
                dbg_sel);
        }
        else
        {
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_0_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_1_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_2_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_3_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_4_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_5_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_6_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_7_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_8_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_9_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_10_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_11_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_12_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_13_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_14_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_15_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_16_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_17_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_18_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_19_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_20_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_21_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_22_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_dbg_vec_23_get( %u)\n",
                dbg_vec_val);
        }
    }

    {
        uint32_t intr_vec_0 = gtmv(m, 32);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_debug_intr_vec_0_get(&intr_vec_0);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_intr_vec_0_get( %u)\n",
                intr_vec_0);
        }
    }

    {
        uint32_t intr_vec_1 = gtmv(m, 32);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_debug_intr_vec_1_get(&intr_vec_1);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_intr_vec_1_get( %u)\n",
                intr_vec_1);
        }
    }

    {
        uint32_t intr_vec_2 = gtmv(m, 32);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_debug_intr_vec_2_get(&intr_vec_2);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_intr_vec_2_get( %u)\n",
                intr_vec_2);
        }
    }

    {
        uint32_t intr_vec_3 = gtmv(m, 32);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_debug_intr_vec_3_get(&intr_vec_3);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_intr_vec_3_get( %u)\n",
                intr_vec_3);
        }
    }

    {
        uint32_t intr_vec_4 = gtmv(m, 32);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_debug_intr_vec_4_get(&intr_vec_4);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_intr_vec_4_get( %u)\n",
                intr_vec_4);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_debug_statistics_dbg_sttstcs_ctrl_set( %u %u %u %u)\n",
            dbg_mode, en_cntrs, clr_cntrs, dbg_rnr_sel);
        ag_err = ag_drv_dsptchr_debug_statistics_dbg_sttstcs_ctrl_set(dbg_mode, en_cntrs, clr_cntrs, dbg_rnr_sel);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_debug_statistics_dbg_sttstcs_ctrl_get(&dbg_mode, &en_cntrs, &clr_cntrs, &dbg_rnr_sel);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_statistics_dbg_sttstcs_ctrl_get( %u %u %u %u)\n",
                dbg_mode, en_cntrs, clr_cntrs, dbg_rnr_sel);
        }
        else
        {
        ...
        if (dbg_mode != gtmv(m, 2) || en_cntrs != gtmv(m, 1) || clr_cntrs != gtmv(m, 1) || dbg_rnr_sel != gtmv(m, 4))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        uint32_t dbg_vec_val = gtmv(m, 32);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_debug_statistics_dbg_cnt_get(index, &dbg_vec_val);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_debug_statistics_dbg_cnt_get( %u %u)\n", index,
                dbg_vec_val);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_qdes_head_set( %u %u)\n", q_idx,
            head);
        ag_err = ag_drv_dsptchr_qdes_head_set(q_idx, head);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_qdes_head_get(q_idx, &head);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_head_get( %u %u)\n", q_idx,
                head);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_qdes_bfout_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", zero,
            qdes_bfout.qdes_bfout[0], qdes_bfout.qdes_bfout[1], qdes_bfout.qdes_bfout[2], qdes_bfout.qdes_bfout[3], 
            qdes_bfout.qdes_bfout[4], qdes_bfout.qdes_bfout[5], qdes_bfout.qdes_bfout[6], qdes_bfout.qdes_bfout[7], 
            qdes_bfout.qdes_bfout[8], qdes_bfout.qdes_bfout[9], qdes_bfout.qdes_bfout[10], qdes_bfout.qdes_bfout[11], 
            qdes_bfout.qdes_bfout[12], qdes_bfout.qdes_bfout[13], qdes_bfout.qdes_bfout[14], qdes_bfout.qdes_bfout[15], 
            qdes_bfout.qdes_bfout[16], qdes_bfout.qdes_bfout[17], qdes_bfout.qdes_bfout[18], qdes_bfout.qdes_bfout[19], 
            qdes_bfout.qdes_bfout[20], qdes_bfout.qdes_bfout[21], qdes_bfout.qdes_bfout[22], qdes_bfout.qdes_bfout[23], 
            qdes_bfout.qdes_bfout[24], qdes_bfout.qdes_bfout[25], qdes_bfout.qdes_bfout[26], qdes_bfout.qdes_bfout[27], 
            qdes_bfout.qdes_bfout[28], qdes_bfout.qdes_bfout[29], qdes_bfout.qdes_bfout[30], qdes_bfout.qdes_bfout[31]);
        ag_err = ag_drv_dsptchr_qdes_bfout_set(zero, &qdes_bfout);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_qdes_bfout_get(zero, &qdes_bfout);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_bfout_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", zero,
                qdes_bfout.qdes_bfout[0], qdes_bfout.qdes_bfout[1], qdes_bfout.qdes_bfout[2], qdes_bfout.qdes_bfout[3], 
                qdes_bfout.qdes_bfout[4], qdes_bfout.qdes_bfout[5], qdes_bfout.qdes_bfout[6], qdes_bfout.qdes_bfout[7], 
                qdes_bfout.qdes_bfout[8], qdes_bfout.qdes_bfout[9], qdes_bfout.qdes_bfout[10], qdes_bfout.qdes_bfout[11], 
                qdes_bfout.qdes_bfout[12], qdes_bfout.qdes_bfout[13], qdes_bfout.qdes_bfout[14], qdes_bfout.qdes_bfout[15], 
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_qdes_bufin_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", zero,
            qdes_bufin.qdes_bfin[0], qdes_bufin.qdes_bfin[1], qdes_bufin.qdes_bfin[2], qdes_bufin.qdes_bfin[3], 
            qdes_bufin.qdes_bfin[4], qdes_bufin.qdes_bfin[5], qdes_bufin.qdes_bfin[6], qdes_bufin.qdes_bfin[7], 
            qdes_bufin.qdes_bfin[8], qdes_bufin.qdes_bfin[9], qdes_bufin.qdes_bfin[10], qdes_bufin.qdes_bfin[11], 
            qdes_bufin.qdes_bfin[12], qdes_bufin.qdes_bfin[13], qdes_bufin.qdes_bfin[14], qdes_bufin.qdes_bfin[15], 
            qdes_bufin.qdes_bfin[16], qdes_bufin.qdes_bfin[17], qdes_bufin.qdes_bfin[18], qdes_bufin.qdes_bfin[19], 
            qdes_bufin.qdes_bfin[20], qdes_bufin.qdes_bfin[21], qdes_bufin.qdes_bfin[22], qdes_bufin.qdes_bfin[23], 
            qdes_bufin.qdes_bfin[24], qdes_bufin.qdes_bfin[25], qdes_bufin.qdes_bfin[26], qdes_bufin.qdes_bfin[27], 
            qdes_bufin.qdes_bfin[28], qdes_bufin.qdes_bfin[29], qdes_bufin.qdes_bfin[30], qdes_bufin.qdes_bfin[31]);
        ag_err = ag_drv_dsptchr_qdes_bufin_set(zero, &qdes_bufin);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_qdes_bufin_get(zero, &qdes_bufin);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_bufin_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", zero,
                qdes_bufin.qdes_bfin[0], qdes_bufin.qdes_bfin[1], qdes_bufin.qdes_bfin[2], qdes_bufin.qdes_bfin[3], 
                qdes_bufin.qdes_bfin[4], qdes_bufin.qdes_bfin[5], qdes_bufin.qdes_bfin[6], qdes_bufin.qdes_bfin[7], 
                qdes_bufin.qdes_bfin[8], qdes_bufin.qdes_bfin[9], qdes_bufin.qdes_bfin[10], qdes_bufin.qdes_bfin[11], 
                qdes_bufin.qdes_bfin[12], qdes_bufin.qdes_bfin[13], qdes_bufin.qdes_bfin[14], qdes_bufin.qdes_bfin[15], 
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_qdes_tail_set( %u %u)\n", q_idx,
            tail);
        ag_err = ag_drv_dsptchr_qdes_tail_set(q_idx, tail);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_qdes_tail_get(q_idx, &tail);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_tail_get( %u %u)\n", q_idx,
                tail);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_qdes_fbdnull_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", zero,
            qdes_fbdnull.qdes_fbdnull[0], qdes_fbdnull.qdes_fbdnull[1], qdes_fbdnull.qdes_fbdnull[2], qdes_fbdnull.qdes_fbdnull[3], 
            qdes_fbdnull.qdes_fbdnull[4], qdes_fbdnull.qdes_fbdnull[5], qdes_fbdnull.qdes_fbdnull[6], qdes_fbdnull.qdes_fbdnull[7], 
            qdes_fbdnull.qdes_fbdnull[8], qdes_fbdnull.qdes_fbdnull[9], qdes_fbdnull.qdes_fbdnull[10], qdes_fbdnull.qdes_fbdnull[11], 
            qdes_fbdnull.qdes_fbdnull[12], qdes_fbdnull.qdes_fbdnull[13], qdes_fbdnull.qdes_fbdnull[14], qdes_fbdnull.qdes_fbdnull[15], 
            qdes_fbdnull.qdes_fbdnull[16], qdes_fbdnull.qdes_fbdnull[17], qdes_fbdnull.qdes_fbdnull[18], qdes_fbdnull.qdes_fbdnull[19], 
            qdes_fbdnull.qdes_fbdnull[20], qdes_fbdnull.qdes_fbdnull[21], qdes_fbdnull.qdes_fbdnull[22], qdes_fbdnull.qdes_fbdnull[23], 
            qdes_fbdnull.qdes_fbdnull[24], qdes_fbdnull.qdes_fbdnull[25], qdes_fbdnull.qdes_fbdnull[26], qdes_fbdnull.qdes_fbdnull[27], 
            qdes_fbdnull.qdes_fbdnull[28], qdes_fbdnull.qdes_fbdnull[29], qdes_fbdnull.qdes_fbdnull[30], qdes_fbdnull.qdes_fbdnull[31]);
        ag_err = ag_drv_dsptchr_qdes_fbdnull_set(zero, &qdes_fbdnull);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_qdes_fbdnull_get(zero, &qdes_fbdnull);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_fbdnull_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", zero,
                qdes_fbdnull.qdes_fbdnull[0], qdes_fbdnull.qdes_fbdnull[1], qdes_fbdnull.qdes_fbdnull[2], qdes_fbdnull.qdes_fbdnull[3], 
                qdes_fbdnull.qdes_fbdnull[4], qdes_fbdnull.qdes_fbdnull[5], qdes_fbdnull.qdes_fbdnull[6], qdes_fbdnull.qdes_fbdnull[7], 
                qdes_fbdnull.qdes_fbdnull[8], qdes_fbdnull.qdes_fbdnull[9], qdes_fbdnull.qdes_fbdnull[10], qdes_fbdnull.qdes_fbdnull[11], 
                qdes_fbdnull.qdes_fbdnull[12], qdes_fbdnull.qdes_fbdnull[13], qdes_fbdnull.qdes_fbdnull[14], qdes_fbdnull.qdes_fbdnull[15], 
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_qdes_nullbd_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", zero,
            qdes_nullbd.qdes_nullbd[0], qdes_nullbd.qdes_nullbd[1], qdes_nullbd.qdes_nullbd[2], qdes_nullbd.qdes_nullbd[3], 
            qdes_nullbd.qdes_nullbd[4], qdes_nullbd.qdes_nullbd[5], qdes_nullbd.qdes_nullbd[6], qdes_nullbd.qdes_nullbd[7], 
            qdes_nullbd.qdes_nullbd[8], qdes_nullbd.qdes_nullbd[9], qdes_nullbd.qdes_nullbd[10], qdes_nullbd.qdes_nullbd[11], 
            qdes_nullbd.qdes_nullbd[12], qdes_nullbd.qdes_nullbd[13], qdes_nullbd.qdes_nullbd[14], qdes_nullbd.qdes_nullbd[15], 
            qdes_nullbd.qdes_nullbd[16], qdes_nullbd.qdes_nullbd[17], qdes_nullbd.qdes_nullbd[18], qdes_nullbd.qdes_nullbd[19], 
            qdes_nullbd.qdes_nullbd[20], qdes_nullbd.qdes_nullbd[21], qdes_nullbd.qdes_nullbd[22], qdes_nullbd.qdes_nullbd[23], 
            qdes_nullbd.qdes_nullbd[24], qdes_nullbd.qdes_nullbd[25], qdes_nullbd.qdes_nullbd[26], qdes_nullbd.qdes_nullbd[27], 
            qdes_nullbd.qdes_nullbd[28], qdes_nullbd.qdes_nullbd[29], qdes_nullbd.qdes_nullbd[30], qdes_nullbd.qdes_nullbd[31]);
        ag_err = ag_drv_dsptchr_qdes_nullbd_set(zero, &qdes_nullbd);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_qdes_nullbd_get(zero, &qdes_nullbd);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_nullbd_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", zero,
                qdes_nullbd.qdes_nullbd[0], qdes_nullbd.qdes_nullbd[1], qdes_nullbd.qdes_nullbd[2], qdes_nullbd.qdes_nullbd[3], 
                qdes_nullbd.qdes_nullbd[4], qdes_nullbd.qdes_nullbd[5], qdes_nullbd.qdes_nullbd[6], qdes_nullbd.qdes_nullbd[7], 
                qdes_nullbd.qdes_nullbd[8], qdes_nullbd.qdes_nullbd[9], qdes_nullbd.qdes_nullbd[10], qdes_nullbd.qdes_nullbd[11], 
                qdes_nullbd.qdes_nullbd[12], qdes_nullbd.qdes_nullbd[13], qdes_nullbd.qdes_nullbd[14], qdes_nullbd.qdes_nullbd[15], 
...

    {
        ...
        if (!ag_err)
            ag_err = ag_drv_dsptchr_qdes_bufavail_get(zero, &qdes_bufavail);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_bufavail_get( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", zero,
                qdes_bufavail.qdes_bufavail[0], qdes_bufavail.qdes_bufavail[1], qdes_bufavail.qdes_bufavail[2], qdes_bufavail.qdes_bufavail[3], 
                qdes_bufavail.qdes_bufavail[4], qdes_bufavail.qdes_bufavail[5], qdes_bufavail.qdes_bufavail[6], qdes_bufavail.qdes_bufavail[7], 
                qdes_bufavail.qdes_bufavail[8], qdes_bufavail.qdes_bufavail[9], qdes_bufavail.qdes_bufavail[10], qdes_bufavail.qdes_bufavail[11], 
                qdes_bufavail.qdes_bufavail[12], qdes_bufavail.qdes_bufavail[13], qdes_bufavail.qdes_bufavail[14], qdes_bufavail.qdes_bufavail[15], 
                qdes_bufavail.qdes_bufavail[16], qdes_bufavail.qdes_bufavail[17], qdes_bufavail.qdes_bufavail[18], qdes_bufavail.qdes_bufavail[19], 
                qdes_bufavail.qdes_bufavail[20], qdes_bufavail.qdes_bufavail[21], qdes_bufavail.qdes_bufavail[22], qdes_bufavail.qdes_bufavail[23], 
                qdes_bufavail.qdes_bufavail[24], qdes_bufavail.qdes_bufavail[25], qdes_bufavail.qdes_bufavail[26], qdes_bufavail.qdes_bufavail[27], 
                qdes_bufavail.qdes_bufavail[28], qdes_bufavail.qdes_bufavail[29], qdes_bufavail.qdes_bufavail[30], qdes_bufavail.qdes_bufavail[31]);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_qdes_reg_q_head_set( %u %u)\n", q_head_idx,
            head);
        ag_err = ag_drv_dsptchr_qdes_reg_q_head_set(q_head_idx, head);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_qdes_reg_q_head_get(q_head_idx, &head);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_reg_q_head_get( %u %u)\n", q_head_idx,
                head);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_qdes_reg_viq_head_vld_set( %u)\n",
            viq_head_vld);
        ag_err = ag_drv_dsptchr_qdes_reg_viq_head_vld_set(viq_head_vld);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_qdes_reg_viq_head_vld_get(&viq_head_vld);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_reg_viq_head_vld_get( %u)\n",
                viq_head_vld);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_qdes_reg_viq_chrncy_vld_set( %u)\n",
            chrncy_vld);
        ag_err = ag_drv_dsptchr_qdes_reg_viq_chrncy_vld_set(chrncy_vld);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_qdes_reg_viq_chrncy_vld_get(&chrncy_vld);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_reg_viq_chrncy_vld_get( %u)\n",
                chrncy_vld);
        }
        else
        {
    ...
    {
        uint32_t viq_head_vld = gtmv(m, 32);
        bdmf_session_print(session, "ag_drv_dsptchr_qdes_reg_veq_head_vld_set( %u)\n",
            viq_head_vld);
        ag_err = ag_drv_dsptchr_qdes_reg_veq_head_vld_set(viq_head_vld);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_qdes_reg_veq_head_vld_get(&viq_head_vld);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_reg_veq_head_vld_get( %u)\n",
                viq_head_vld);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_qdes_reg_qdes_buf_avl_cntrl_set( %u %u)\n",
            use_buf_avl, dec_bufout_when_mltcst);
        ag_err = ag_drv_dsptchr_qdes_reg_qdes_buf_avl_cntrl_set(use_buf_avl, dec_bufout_when_mltcst);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_qdes_reg_qdes_buf_avl_cntrl_get(&use_buf_avl, &dec_bufout_when_mltcst);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_reg_qdes_buf_avl_cntrl_get( %u %u)\n",
                use_buf_avl, dec_bufout_when_mltcst);
        }
        else
        {
        ...
        if (use_buf_avl != gtmv(m, 1) || dec_bufout_when_mltcst != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_flldes_flldrop_set( %u)\n",
            drpcnt);
        ag_err = ag_drv_dsptchr_flldes_flldrop_set(drpcnt);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_flldes_flldrop_get(&drpcnt);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_flldes_flldrop_get( %u)\n",
                drpcnt);
        }
        else
        {
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_flldes_bufavail_get( %u)\n",
                bufavail);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_flldes_freemin_get( %u)\n",
                freemin);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_bdram_next_data_set( %u %u)\n", temp_index,
            data);
        ag_err = ag_drv_dsptchr_bdram_next_data_set(temp_index, data);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_bdram_next_data_get(temp_index, &data);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_bdram_next_data_get( %u %u)\n", temp_index,
                data);
        }
        else
        {
...

    {
        uint16_t temp_index = gtmv(m, 10);
        uint16_t data = gtmv(m, 10);
        bdmf_session_print(session, "ag_drv_dsptchr_bdram_prev_data_set( %u %u)\n", temp_index,
            data);
        ag_err = ag_drv_dsptchr_bdram_prev_data_set(temp_index, data);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_bdram_prev_data_get(temp_index, &data);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_bdram_prev_data_get( %u %u)\n", temp_index,
                data);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_dsptchr_pdram_data_set( %u %u %u)\n", temp_index,
            pdram_data.reorder_ram_data[0], pdram_data.reorder_ram_data[1]);
        ag_err = ag_drv_dsptchr_pdram_data_set(temp_index, &pdram_data);
        if (!ag_err)
            ag_err = ag_drv_dsptchr_pdram_data_get(temp_index, &pdram_data);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_pdram_data_get( %u %u %u)\n", temp_index,
                pdram_data.reorder_ram_data[0], pdram_data.reorder_ram_data[1]);
        }
        else
        {
        ...
        if (pdram_data.reorder_ram_data[0] != gtmv(m, 32) || pdram_data.reorder_ram_data[1] != gtmv(m, 32))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...
#ifdef HAL_DRV_TEST_ENABLE
static int ag_drv_dsptchr_cli_ext_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_dsptchr_cngs_params:
    {
        ...
        if ((start_idx >= max_viq_idx) || (stop_idx >= max_viq_idx))
        {
        ...
        for (viq_idx = 0; viq_idx < max_viq_idx; viq_idx++)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_cngs_params_set( %u %u %u %u)\n", viq_idx,
                cngs_params.frst_lvl, cngs_params.scnd_lvl, cngs_params.hyst_thrs);
            ag_err = ag_drv_dsptchr_cngs_params_set(viq_idx, &cngs_params);
        ...
        m = input_method;
        cngs_params.frst_lvl = gtmv(m, 12);
        cngs_params.scnd_lvl = gtmv(m, 12);
        cngs_params.hyst_thrs = gtmv(m, 8);

        for (viq_idx = start_idx; viq_idx <= stop_idx; viq_idx++)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_cngs_params_set( %u %u %u %u)\n", viq_idx,
                cngs_params.frst_lvl, cngs_params.scnd_lvl, cngs_params.hyst_thrs);
            ag_err = ag_drv_dsptchr_cngs_params_set(viq_idx, &cngs_params);
        ...
        for (viq_idx = 0; viq_idx < max_viq_idx; viq_idx++)
        {
            if (viq_idx < start_idx || viq_idx > stop_idx)
            ...
            if (cngs_params.frst_lvl != gtmv(m, 12) || 
                cngs_params.scnd_lvl != gtmv(m, 12) || 
                cngs_params.hyst_thrs != gtmv(m, 8) || 
                0)
            {
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of cngs_params completed. Number of tested entries %u.\n", max_viq_idx);
    ...
    case cli_dsptchr_q_size_params:
    {
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of q_size_params completed. Number of tested entries %u.\n", max_q_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_credit_cnt:
    {
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of credit_cnt completed. Number of tested entries %u.\n", max_q_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_q_limits_params:
    {
        ...
        for (q_idx = 0; q_idx < max_q_idx; q_idx++)
        {
            ...
            if (cmn_max != gtmv(m, 10) || gurntd_max != gtmv(m, 10) || 0)
            {
                bdmf_session_print(session, "Test failed on comparing set and get results of entry %u\n", q_idx);
                ext_test_failure_cnt++;
            }
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of q_limits_params completed. Number of tested entries %u.\n", max_q_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_ingress_coherency_params:
    {
        ...
        for (q_idx = 0; q_idx < max_q_idx; q_idx++)
        {
            ...
            if (chrncy_en != gtmv(m, 1) || chrncy_cnt != gtmv(m, 10) || 0)
            {
                bdmf_session_print(session, "Test failed on comparing set and get results of entry %u\n", q_idx);
                ext_test_failure_cnt++;
            }
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of ingress_coherency_params completed. Number of tested entries %u.\n", max_q_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_rnr_dsptch_addr:
    {
        ...
        /* Set the specified entries to values according to the method */
        m = input_method;
        rnr_dsptch_addr.base_add = gtmv(m, 16);
        rnr_dsptch_addr.offset_add = gtmv(m, 16);
        ...
        for (rnr_idx = 0; rnr_idx < max_rnr_idx; rnr_idx++)
        {
            ...
            if (rnr_dsptch_addr.base_add != gtmv(m, 16) || 
                rnr_dsptch_addr.offset_add != gtmv(m, 16) || 
                0)
            {
                bdmf_session_print(session, "Test failed on comparing set and get results of entry %u\n", rnr_idx);
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of rnr_dsptch_addr completed. Number of tested entries %u.\n", max_rnr_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_queue_mapping_crdt_cfg:
    {
        ...
        for (q_idx = 0; q_idx < max_q_idx; q_idx++)
        {
            ...
            if (bb_id != gtmv(m, 8) || trgt_add != gtmv(m, 16) || 0)
            {
                bdmf_session_print(session, "Test failed on comparing set and get results of entry %u\n", q_idx);
                ext_test_failure_cnt++;
            }
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of queue_mapping_crdt_cfg completed. Number of tested entries %u.\n", max_q_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_mask_msk_tsk_255_0:
    {
        uint8_t max_group_idx = 8;
        uint8_t group_idx = gtmv(m, 3);
        dsptchr_mask_msk_tsk_255_0 mask_msk_tsk_255_0 = {.task_mask = {gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32), gtmv(m, 32) } };

        if ((start_idx >= max_group_idx) || (stop_idx >= max_group_idx))
        {
            bdmf_session_print(session, "ERROR: start_idx and stop_idx must be < %u\n", max_group_idx);
            return BDMF_ERR_PARM;
        }
        ...
        bdmf_session_print(session, "\n ======== Set all array entries to the init values ========\n");
        for (group_idx = 0; group_idx < max_group_idx; group_idx++)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_mask_msk_tsk_255_0_set( %u %u %u %u %u %u %u %u %u)\n", group_idx,
                mask_msk_tsk_255_0.task_mask[0], mask_msk_tsk_255_0.task_mask[1], mask_msk_tsk_255_0.task_mask[2], mask_msk_tsk_255_0.task_mask[3], 
                mask_msk_tsk_255_0.task_mask[4], mask_msk_tsk_255_0.task_mask[5], mask_msk_tsk_255_0.task_mask[6], mask_msk_tsk_255_0.task_mask[7]);
        ...
        /* Set the specified entries to values according to the method */
        m = input_method;
        mask_msk_tsk_255_0.task_mask[0] = gtmv(m, 32);
        mask_msk_tsk_255_0.task_mask[1] = gtmv(m, 32);
        mask_msk_tsk_255_0.task_mask[2] = gtmv(m, 32);
        mask_msk_tsk_255_0.task_mask[3] = gtmv(m, 32);
        mask_msk_tsk_255_0.task_mask[4] = gtmv(m, 32);
        mask_msk_tsk_255_0.task_mask[5] = gtmv(m, 32);
        mask_msk_tsk_255_0.task_mask[6] = gtmv(m, 32);
        mask_msk_tsk_255_0.task_mask[7] = gtmv(m, 32);

        for (group_idx = start_idx; group_idx <= stop_idx; group_idx++)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_mask_msk_tsk_255_0_set( %u %u %u %u %u %u %u %u %u)\n", group_idx,
                mask_msk_tsk_255_0.task_mask[0], mask_msk_tsk_255_0.task_mask[1], mask_msk_tsk_255_0.task_mask[2], mask_msk_tsk_255_0.task_mask[3], 
                mask_msk_tsk_255_0.task_mask[4], mask_msk_tsk_255_0.task_mask[5], mask_msk_tsk_255_0.task_mask[6], mask_msk_tsk_255_0.task_mask[7]);
        ...
        for (group_idx = 0; group_idx < max_group_idx; group_idx++)
        {
            if (group_idx < start_idx || group_idx > stop_idx)
                m = ag_drv_cli_test_method_high; /* method for checking "unchanged" entries */
            else
                m = input_method; /* method for checking entries [start_idx..stop_idx] */
            ...
            if (mask_msk_tsk_255_0.task_mask[0] != gtmv(m, 32) || 
                mask_msk_tsk_255_0.task_mask[1] != gtmv(m, 32) || 
                mask_msk_tsk_255_0.task_mask[2] != gtmv(m, 32) || 
                mask_msk_tsk_255_0.task_mask[3] != gtmv(m, 32) || 
                mask_msk_tsk_255_0.task_mask[4] != gtmv(m, 32) || 
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of mask_msk_tsk_255_0 completed. Number of tested entries %u.\n", max_group_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_mask_msk_q:
    {
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of mask_msk_q completed. Number of tested entries %u.\n", max_group_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_disptch_scheduling_dwrr_info:
    {
        uint8_t max_dwrr_q_idx = 32;
        uint8_t dwrr_q_idx = gtmv(m, 5);
        uint32_t q_crdt = gtmv(m, 20);
        bdmf_boolean ngtv = gtmv(m, 1);
        uint16_t quntum = gtmv(m, 11);

        if ((start_idx >= max_dwrr_q_idx) || (stop_idx >= max_dwrr_q_idx))
        {
            bdmf_session_print(session, "ERROR: start_idx and stop_idx must be < %u\n", max_dwrr_q_idx);
            return BDMF_ERR_PARM;
        }
        ...
        bdmf_session_print(session, "\n ======== Set all array entries to the init values ========\n");
        for (dwrr_q_idx = 0; dwrr_q_idx < max_dwrr_q_idx; dwrr_q_idx++)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_disptch_scheduling_dwrr_info_set( %u %u %u %u)\n", dwrr_q_idx,
                q_crdt, ngtv, quntum);
            ag_err = ag_drv_dsptchr_disptch_scheduling_dwrr_info_set(dwrr_q_idx, q_crdt, ngtv, quntum);
        ...
        for (dwrr_q_idx = start_idx; dwrr_q_idx <= stop_idx; dwrr_q_idx++)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_disptch_scheduling_dwrr_info_set( %u %u %u %u)\n", dwrr_q_idx,
                q_crdt, ngtv, quntum);
            ag_err = ag_drv_dsptchr_disptch_scheduling_dwrr_info_set(dwrr_q_idx, q_crdt, ngtv, quntum);
        ...
        for (dwrr_q_idx = 0; dwrr_q_idx < max_dwrr_q_idx; dwrr_q_idx++)
        {
            if (dwrr_q_idx < start_idx || dwrr_q_idx > stop_idx)
                m = ag_drv_cli_test_method_high; /* method for checking "unchanged" entries */
            else
                m = input_method; /* method for checking entries [start_idx..stop_idx] */
            ...
            if (q_crdt != gtmv(m, 20) || ngtv != gtmv(m, 1) || quntum != gtmv(m, 11) || 0)
            {
                bdmf_session_print(session, "Test failed on comparing set and get results of entry %u\n", dwrr_q_idx);
                ext_test_failure_cnt++;
            }
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of disptch_scheduling_dwrr_info completed. Number of tested entries %u.\n", max_dwrr_q_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_load_balancing_tsk_to_rg_mapping:
    {
        uint8_t max_task_to_rg_mapping = 32;
        uint8_t task_to_rg_mapping = gtmv(m, 5);
        dsptchr_load_balancing_tsk_to_rg_mapping load_balancing_tsk_to_rg_mapping = {
            .tsk0 = gtmv(m, 3), 
            .tsk1 = gtmv(m, 3), 
        ...
        if ((start_idx >= max_task_to_rg_mapping) || (stop_idx >= max_task_to_rg_mapping))
        {
            bdmf_session_print(session, "ERROR: start_idx and stop_idx must be < %u\n", max_task_to_rg_mapping);
            return BDMF_ERR_PARM;
        }

        bdmf_session_print(session, "\n ======== Set all array entries to the init values ========\n");
        for (task_to_rg_mapping = 0; task_to_rg_mapping < max_task_to_rg_mapping; task_to_rg_mapping++)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_tsk_to_rg_mapping_set( %u %u %u %u %u %u %u %u %u)\n", task_to_rg_mapping,
                load_balancing_tsk_to_rg_mapping.tsk0, load_balancing_tsk_to_rg_mapping.tsk1, load_balancing_tsk_to_rg_mapping.tsk2, load_balancing_tsk_to_rg_mapping.tsk3, 
                load_balancing_tsk_to_rg_mapping.tsk4, load_balancing_tsk_to_rg_mapping.tsk5, load_balancing_tsk_to_rg_mapping.tsk6, load_balancing_tsk_to_rg_mapping.tsk7);
        ...
        /* Set the specified entries to values according to the method */
        m = input_method;
        load_balancing_tsk_to_rg_mapping.tsk0 = gtmv(m, 3);
        load_balancing_tsk_to_rg_mapping.tsk1 = gtmv(m, 3);
        load_balancing_tsk_to_rg_mapping.tsk2 = gtmv(m, 3);
        load_balancing_tsk_to_rg_mapping.tsk3 = gtmv(m, 3);
        load_balancing_tsk_to_rg_mapping.tsk4 = gtmv(m, 3);
        load_balancing_tsk_to_rg_mapping.tsk5 = gtmv(m, 3);
        load_balancing_tsk_to_rg_mapping.tsk6 = gtmv(m, 3);
        load_balancing_tsk_to_rg_mapping.tsk7 = gtmv(m, 3);

        for (task_to_rg_mapping = start_idx; task_to_rg_mapping <= stop_idx; task_to_rg_mapping++)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_load_balancing_tsk_to_rg_mapping_set( %u %u %u %u %u %u %u %u %u)\n", task_to_rg_mapping,
                load_balancing_tsk_to_rg_mapping.tsk0, load_balancing_tsk_to_rg_mapping.tsk1, load_balancing_tsk_to_rg_mapping.tsk2, load_balancing_tsk_to_rg_mapping.tsk3, 
                load_balancing_tsk_to_rg_mapping.tsk4, load_balancing_tsk_to_rg_mapping.tsk5, load_balancing_tsk_to_rg_mapping.tsk6, load_balancing_tsk_to_rg_mapping.tsk7);
        ...
        for (task_to_rg_mapping = 0; task_to_rg_mapping < max_task_to_rg_mapping; task_to_rg_mapping++)
        {
            if (task_to_rg_mapping < start_idx || task_to_rg_mapping > stop_idx)
                m = ag_drv_cli_test_method_high; /* method for checking "unchanged" entries */
            else
                m = input_method; /* method for checking entries [start_idx..stop_idx] */
            ...
            if (load_balancing_tsk_to_rg_mapping.tsk0 != gtmv(m, 3) || 
                load_balancing_tsk_to_rg_mapping.tsk1 != gtmv(m, 3) || 
                load_balancing_tsk_to_rg_mapping.tsk2 != gtmv(m, 3) || 
                load_balancing_tsk_to_rg_mapping.tsk3 != gtmv(m, 3) || 
                load_balancing_tsk_to_rg_mapping.tsk4 != gtmv(m, 3) || 
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of load_balancing_tsk_to_rg_mapping completed. Number of tested entries %u.\n", max_task_to_rg_mapping);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_qdes_head:
    {
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of qdes_head completed. Number of tested entries %u.\n", max_q_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_qdes_bfout:
    {
        ...
        /* Set the specified entries to values according to the method */
        m = input_method;
        qdes_bfout.qdes_bfout[0] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[1] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[2] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[3] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[4] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[5] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[6] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[7] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[8] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[9] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[10] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[11] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[12] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[13] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[14] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[15] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[16] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[17] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[18] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[19] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[20] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[21] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[22] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[23] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[24] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[25] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[26] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[27] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[28] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[29] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[30] = gtmv(m, 32);
        qdes_bfout.qdes_bfout[31] = gtmv(m, 32);
        ...
        for (zero = 0; zero < max_zero; zero++)
        {
            ...
            if (qdes_bfout.qdes_bfout[0] != gtmv(m, 32) || 
                qdes_bfout.qdes_bfout[1] != gtmv(m, 32) || 
                qdes_bfout.qdes_bfout[2] != gtmv(m, 32) || 
                qdes_bfout.qdes_bfout[3] != gtmv(m, 32) || 
                qdes_bfout.qdes_bfout[4] != gtmv(m, 32) || 
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of qdes_bfout completed. Number of tested entries %u.\n", max_zero);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_qdes_bufin:
    {
        ...
        /* Set the specified entries to values according to the method */
        m = input_method;
        qdes_bufin.qdes_bfin[0] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[1] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[2] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[3] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[4] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[5] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[6] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[7] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[8] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[9] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[10] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[11] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[12] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[13] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[14] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[15] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[16] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[17] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[18] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[19] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[20] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[21] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[22] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[23] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[24] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[25] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[26] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[27] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[28] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[29] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[30] = gtmv(m, 32);
        qdes_bufin.qdes_bfin[31] = gtmv(m, 32);
        ...
        for (zero = 0; zero < max_zero; zero++)
        {
            ...
            if (qdes_bufin.qdes_bfin[0] != gtmv(m, 32) || 
                qdes_bufin.qdes_bfin[1] != gtmv(m, 32) || 
                qdes_bufin.qdes_bfin[2] != gtmv(m, 32) || 
                qdes_bufin.qdes_bfin[3] != gtmv(m, 32) || 
                qdes_bufin.qdes_bfin[4] != gtmv(m, 32) || 
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of qdes_bufin completed. Number of tested entries %u.\n", max_zero);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_qdes_tail:
    {
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of qdes_tail completed. Number of tested entries %u.\n", max_q_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_qdes_fbdnull:
    {
        ...
        /* Set the specified entries to values according to the method */
        m = input_method;
        qdes_fbdnull.qdes_fbdnull[0] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[1] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[2] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[3] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[4] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[5] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[6] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[7] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[8] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[9] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[10] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[11] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[12] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[13] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[14] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[15] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[16] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[17] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[18] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[19] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[20] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[21] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[22] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[23] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[24] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[25] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[26] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[27] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[28] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[29] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[30] = gtmv(m, 32);
        qdes_fbdnull.qdes_fbdnull[31] = gtmv(m, 32);
        ...
        for (zero = 0; zero < max_zero; zero++)
        {
            ...
            if (qdes_fbdnull.qdes_fbdnull[0] != gtmv(m, 32) || 
                qdes_fbdnull.qdes_fbdnull[1] != gtmv(m, 32) || 
                qdes_fbdnull.qdes_fbdnull[2] != gtmv(m, 32) || 
                qdes_fbdnull.qdes_fbdnull[3] != gtmv(m, 32) || 
                qdes_fbdnull.qdes_fbdnull[4] != gtmv(m, 32) || 
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of qdes_fbdnull completed. Number of tested entries %u.\n", max_zero);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_qdes_nullbd:
    {
        ...
        /* Set the specified entries to values according to the method */
        m = input_method;
        qdes_nullbd.qdes_nullbd[0] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[1] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[2] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[3] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[4] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[5] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[6] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[7] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[8] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[9] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[10] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[11] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[12] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[13] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[14] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[15] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[16] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[17] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[18] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[19] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[20] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[21] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[22] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[23] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[24] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[25] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[26] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[27] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[28] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[29] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[30] = gtmv(m, 32);
        qdes_nullbd.qdes_nullbd[31] = gtmv(m, 32);
        ...
        for (zero = 0; zero < max_zero; zero++)
        {
            ...
            if (qdes_nullbd.qdes_nullbd[0] != gtmv(m, 32) || 
                qdes_nullbd.qdes_nullbd[1] != gtmv(m, 32) || 
                qdes_nullbd.qdes_nullbd[2] != gtmv(m, 32) || 
                qdes_nullbd.qdes_nullbd[3] != gtmv(m, 32) || 
                qdes_nullbd.qdes_nullbd[4] != gtmv(m, 32) || 
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of qdes_nullbd completed. Number of tested entries %u.\n", max_zero);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_qdes_reg_q_head:
    {
        uint8_t max_q_head_idx = 32;
        uint8_t q_head_idx = gtmv(m, 5);
        uint16_t head = gtmv(m, 10);

        if ((start_idx >= max_q_head_idx) || (stop_idx >= max_q_head_idx))
        {
            bdmf_session_print(session, "ERROR: start_idx and stop_idx must be < %u\n", max_q_head_idx);
            return BDMF_ERR_PARM;
        }
        ...
        bdmf_session_print(session, "\n ======== Set all array entries to the init values ========\n");
        for (q_head_idx = 0; q_head_idx < max_q_head_idx; q_head_idx++)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_reg_q_head_set( %u %u)\n", q_head_idx,
                head);
            ag_err = ag_drv_dsptchr_qdes_reg_q_head_set(q_head_idx, head);
        ...
        for (q_head_idx = start_idx; q_head_idx <= stop_idx; q_head_idx++)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_qdes_reg_q_head_set( %u %u)\n", q_head_idx,
                head);
            ag_err = ag_drv_dsptchr_qdes_reg_q_head_set(q_head_idx, head);
        ...
        for (q_head_idx = 0; q_head_idx < max_q_head_idx; q_head_idx++)
        {
            if (q_head_idx < start_idx || q_head_idx > stop_idx)
                m = ag_drv_cli_test_method_high; /* method for checking "unchanged" entries */
            else
                m = input_method; /* method for checking entries [start_idx..stop_idx] */
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of qdes_reg_q_head completed. Number of tested entries %u.\n", max_q_head_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_bdram_next_data:
    {
        uint16_t max_temp_index = 1024;
        uint16_t temp_index = gtmv(m, 10);
        uint16_t data = gtmv(m, 10);

        if ((start_idx >= max_temp_index) || (stop_idx >= max_temp_index))
        {
            bdmf_session_print(session, "ERROR: start_idx and stop_idx must be < %u\n", max_temp_index);
            return BDMF_ERR_PARM;
        }
        ...
        bdmf_session_print(session, "\n ======== Set all array entries to the init values ========\n");
        for (temp_index = 0; temp_index < max_temp_index; temp_index++)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_bdram_next_data_set( %u %u)\n", temp_index,
                data);
            ag_err = ag_drv_dsptchr_bdram_next_data_set(temp_index, data);
        ...
        for (temp_index = start_idx; temp_index <= stop_idx; temp_index++)
        {
            bdmf_session_print(session, "ag_drv_dsptchr_bdram_next_data_set( %u %u)\n", temp_index,
                data);
            ag_err = ag_drv_dsptchr_bdram_next_data_set(temp_index, data);
        ...
        for (temp_index = 0; temp_index < max_temp_index; temp_index++)
        {
            if (temp_index < start_idx || temp_index > stop_idx)
                m = ag_drv_cli_test_method_high; /* method for checking "unchanged" entries */
            else
                m = input_method; /* method for checking entries [start_idx..stop_idx] */
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of bdram_next_data completed. Number of tested entries %u.\n", max_temp_index);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_bdram_prev_data:
    {
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of bdram_prev_data completed. Number of tested entries %u.\n", max_temp_index);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_dsptchr_pdram_data:
    {
        ...
        /* Set the specified entries to values according to the method */
        m = input_method;
        pdram_data.reorder_ram_data[0] = gtmv(m, 32);
        pdram_data.reorder_ram_data[1] = gtmv(m, 32);
        ...
        for (temp_index = 0; temp_index < max_temp_index; temp_index++)
        {
            ...
            if (pdram_data.reorder_ram_data[0] != gtmv(m, 32) || 
                pdram_data.reorder_ram_data[1] != gtmv(m, 32) || 
                0)
            {
                bdmf_session_print(session, "Test failed on comparing set and get results of entry %u\n", temp_index);
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of pdram_data completed. Number of tested entries %u.\n", max_temp_index);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
...
#ifdef HAL_DRV_TEST_ENABLE
static int ag_drv_dsptchr_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case bdmf_address_ingrs_queues_q_ingrs_cohrency: reg = &RU_REG(DSPTCHR, INGRS_QUEUES_Q_INGRS_COHRENCY); blk = &RU_BLK(DSPTCHR); break;
    ...
    case bdmf_address_queue_mapping_pd_dsptch_add_rnr_grp: reg = &RU_REG(DSPTCHR, QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP); blk = &RU_BLK(DSPTCHR); break;
    ...
    case bdmf_address_debug_intr_vec_0: reg = &RU_REG(DSPTCHR, DEBUG_INTR_VEC_0); blk = &RU_BLK(DSPTCHR); break;
    case bdmf_address_debug_intr_vec_1: reg = &RU_REG(DSPTCHR, DEBUG_INTR_VEC_1); blk = &RU_BLK(DSPTCHR); break;
    case bdmf_address_debug_intr_vec_2: reg = &RU_REG(DSPTCHR, DEBUG_INTR_VEC_2); blk = &RU_BLK(DSPTCHR); break;
    case bdmf_address_debug_intr_vec_3: reg = &RU_REG(DSPTCHR, DEBUG_INTR_VEC_3); blk = &RU_BLK(DSPTCHR); break;
    case bdmf_address_debug_intr_vec_4: reg = &RU_REG(DSPTCHR, DEBUG_INTR_VEC_4); blk = &RU_BLK(DSPTCHR); break;
...
bdmfmon_handle_t ag_drv_dsptchr_cli_init(bdmfmon_handle_t root_dir)
{
    ...
    dir = bdmfmon_dir_add(root_dir, "dsptchr", "dsptchr", BDMF_ACCESS_ADMIN, NULL);
    BUG_ON(dir == NULL);

    {
        static bdmfmon_cmd_parm_t set_cngs_params[] = {
            BDMFMON_MAKE_PARM("viq_idx", "viq_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("frst_lvl", "frst_lvl", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("scnd_lvl", "scnd_lvl", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("hyst_thrs", "hyst_thrs", BDMFMON_PARM_UNUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_q_size_params[] = {
            ...
            BDMFMON_MAKE_PARM("cmn_cnt", "cmn_cnt", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_credit_cnt[] = {
            BDMFMON_MAKE_PARM("q_idx", "q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("credit_cnt", "credit_cnt", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_q_limits_params[] = {
            BDMFMON_MAKE_PARM("q_idx", "q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("cmn_max", "cmn_max", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("gurntd_max", "gurntd_max", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_ingress_coherency_params[] = {
            BDMFMON_MAKE_PARM("q_idx", "q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("chrncy_en", "chrncy_en", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("chrncy_cnt", "chrncy_cnt", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_pools_limits[] = {
            BDMFMON_MAKE_PARM("cmn_pool_lmt", "cmn_pool_lmt", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("grnted_pool_lmt", "grnted_pool_lmt", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("mcast_pool_lmt", "mcast_pool_lmt", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr_pool_lmt", "rnr_pool_lmt", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("cmn_pool_size", "cmn_pool_size", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("grnted_pool_size", "grnted_pool_size", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("mcast_pool_size", "mcast_pool_size", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr_pool_size", "rnr_pool_size", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("processing_pool_size", "processing_pool_size", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_fll_entry[] = {
            BDMFMON_MAKE_PARM("head", "head", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tail", "tail", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("minbuf", "minbuf", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("bfin", "bfin", BDMFMON_PARM_UNUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_rnr_dsptch_addr[] = {
            ...
            BDMFMON_MAKE_PARM("base_add", "base_add", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("offset_add", "offset_add", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_reorder_cfg_dsptchr_reordr_cfg[] = {
            BDMFMON_MAKE_PARM("disp_enable", "disp_enable", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("auto_init_en", "auto_init_en", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("auto_init_size", "auto_init_size", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rdy", "rdy", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("reordr_par_mod", "reordr_par_mod", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("per_q_egrs_congst_en", "per_q_egrs_congst_en", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("dsptch_sm_enh_mod", "dsptch_sm_enh_mod", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("ingrs_pipe_dly_en", "ingrs_pipe_dly_en", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("ingrs_pipe_dly_cnt", "ingrs_pipe_dly_cnt", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("egrs_drop_only", "egrs_drop_only", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("crdt_eff_rep", "crdt_eff_rep", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_free_num_place", "tsk_free_num_place", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_reorder_cfg_bb_cfg[] = {
            BDMFMON_MAKE_PARM("src_id", "src_id", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("dst_id_ovride", "dst_id_ovride", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("route_ovride", "route_ovride", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("ovride_en", "ovride_en", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_queue_mapping_crdt_cfg[] = {
            BDMFMON_MAKE_PARM("q_idx", "q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("bb_id", "bb_id", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("trgt_add", "trgt_add", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_queue_mapping_q_dest[] = {
            BDMFMON_MAKE_PARM("is_dest_disp", "is_dest_disp", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_queue_mapping_pd_dsptch_add_rnr_grp[] = {
            BDMFMON_MAKE_PARM("rnr_g_sel0", "rnr_g_sel0", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr_g_sel1", "rnr_g_sel1", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr_g_sel2", "rnr_g_sel2", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr_g_sel3", "rnr_g_sel3", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr_g_sel4", "rnr_g_sel4", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr_g_sel5", "rnr_g_sel5", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr_g_sel6", "rnr_g_sel6", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr_g_sel7", "rnr_g_sel7", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_mask_msk_tsk_255_0[] = {
            BDMFMON_MAKE_PARM("group_idx", "group_idx", BDMFMON_PARM_UNUMBER, 0),
        ...
        static bdmfmon_cmd_parm_t set_mask_dly_q[] = {
            BDMFMON_MAKE_PARM("set_delay", "set_delay", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_mask_non_dly_q[] = {
            BDMFMON_MAKE_PARM("set_non_delay", "set_non_delay", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_egrs_queues_egrs_dly_qm_crdt[] = {
            BDMFMON_MAKE_PARM("dly_crdt", "dly_crdt", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_egrs_queues_egrs_non_dly_qm_crdt[] = {
            BDMFMON_MAKE_PARM("non_dly_crdt", "non_dly_crdt", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_egrs_queues_total_q_egrs_size[] = {
            BDMFMON_MAKE_PARM("total_egrs_size", "total_egrs_size", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_wakeup_control_wkup_req[] = {
            ...
            BDMFMON_MAKE_PARM("q2", "q2", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q3", "q3", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q4", "q4", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q5", "q5", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q6", "q6", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q7", "q7", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q8", "q8", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q9", "q9", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q10", "q10", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q11", "q11", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q12", "q12", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q13", "q13", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q14", "q14", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q15", "q15", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q16", "q16", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q17", "q17", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q18", "q18", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q19", "q19", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q20", "q20", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q21", "q21", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q22", "q22", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q23", "q23", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q24", "q24", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q25", "q25", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q26", "q26", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q27", "q27", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q28", "q28", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q29", "q29", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q30", "q30", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q31", "q31", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_wakeup_control_wkup_thrshld[] = {
            BDMFMON_MAKE_PARM("wkup_thrshld", "wkup_thrshld", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_disptch_scheduling_dwrr_info[] = {
            BDMFMON_MAKE_PARM("dwrr_q_idx", "dwrr_q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("q_crdt", "q_crdt", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("ngtv", "ngtv", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("quntum", "quntum", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_load_balancing_lb_cfg[] = {
            BDMFMON_MAKE_PARM("lb_mode", "lb_mode", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("sp_thrshld", "sp_thrshld", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_load_balancing_free_task_0_1[] = {
            BDMFMON_MAKE_PARM("rnr0", "rnr0", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr1", "rnr1", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_load_balancing_free_task_2_3[] = {
            BDMFMON_MAKE_PARM("rnr2", "rnr2", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr3", "rnr3", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_load_balancing_free_task_4_5[] = {
            BDMFMON_MAKE_PARM("rnr4", "rnr4", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr5", "rnr5", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_load_balancing_free_task_6_7[] = {
            BDMFMON_MAKE_PARM("rnr6", "rnr6", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr7", "rnr7", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_load_balancing_free_task_8_9[] = {
            BDMFMON_MAKE_PARM("rnr8", "rnr8", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr9", "rnr9", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_load_balancing_free_task_10_11[] = {
            BDMFMON_MAKE_PARM("rnr10", "rnr10", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr11", "rnr11", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_load_balancing_free_task_12_13[] = {
            BDMFMON_MAKE_PARM("rnr12", "rnr12", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr13", "rnr13", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_load_balancing_free_task_14_15[] = {
            BDMFMON_MAKE_PARM("rnr14", "rnr14", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("rnr15", "rnr15", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_load_balancing_tsk_to_rg_mapping[] = {
            BDMFMON_MAKE_PARM("task_to_rg_mapping", "task_to_rg_mapping", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk0", "tsk0", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk1", "tsk1", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk2", "tsk2", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk3", "tsk3", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk4", "tsk4", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk5", "tsk5", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk6", "tsk6", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk7", "tsk7", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_load_balancing_rg_avlabl_tsk_0_3[] = {
            BDMFMON_MAKE_PARM("tsk_cnt_rg_0", "tsk_cnt_rg_0", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rg_1", "tsk_cnt_rg_1", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rg_2", "tsk_cnt_rg_2", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rg_3", "tsk_cnt_rg_3", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_load_balancing_rg_avlabl_tsk_4_7[] = {
            BDMFMON_MAKE_PARM("tsk_cnt_rg_4", "tsk_cnt_rg_4", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rg_5", "tsk_cnt_rg_5", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rg_6", "tsk_cnt_rg_6", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rg_7", "tsk_cnt_rg_7", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_dsptcher_reordr_top_intr_ctrl_0_isr[] = {
            BDMFMON_MAKE_PARM("fll_return_buf", "fll_return_buf", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("fll_cnt_drp", "fll_cnt_drp", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("unknwn_msg", "unknwn_msg", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("fll_overflow", "fll_overflow", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("fll_neg", "fll_neg", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_dsptcher_reordr_top_intr_ctrl_1_isr[] = {
            BDMFMON_MAKE_PARM("qdest0_int", "qdest0_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest1_int", "qdest1_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest2_int", "qdest2_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest3_int", "qdest3_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest4_int", "qdest4_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest5_int", "qdest5_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest6_int", "qdest6_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest7_int", "qdest7_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest8_int", "qdest8_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest9_int", "qdest9_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest10_int", "qdest10_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest11_int", "qdest11_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest12_int", "qdest12_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest13_int", "qdest13_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest14_int", "qdest14_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest15_int", "qdest15_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest16_int", "qdest16_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest17_int", "qdest17_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest18_int", "qdest18_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest19_int", "qdest19_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest20_int", "qdest20_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest21_int", "qdest21_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest22_int", "qdest22_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest23_int", "qdest23_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest24_int", "qdest24_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest25_int", "qdest25_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest26_int", "qdest26_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest27_int", "qdest27_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest28_int", "qdest28_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest29_int", "qdest29_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest30_int", "qdest30_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("qdest31_int", "qdest31_int", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_debug_dbg_bypss_cntrl[] = {
            BDMFMON_MAKE_PARM("en_byp", "en_byp", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("bbid_non_dly", "bbid_non_dly", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("bbid_dly", "bbid_dly", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_debug_glbl_tsk_cnt_0_7[] = {
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_0", "tsk_cnt_rnr_0", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_1", "tsk_cnt_rnr_1", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_2", "tsk_cnt_rnr_2", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_3", "tsk_cnt_rnr_3", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_4", "tsk_cnt_rnr_4", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_5", "tsk_cnt_rnr_5", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_6", "tsk_cnt_rnr_6", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_7", "tsk_cnt_rnr_7", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_debug_glbl_tsk_cnt_8_15[] = {
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_8", "tsk_cnt_rnr_8", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_9", "tsk_cnt_rnr_9", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_10", "tsk_cnt_rnr_10", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_11", "tsk_cnt_rnr_11", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_12", "tsk_cnt_rnr_12", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_13", "tsk_cnt_rnr_13", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_14", "tsk_cnt_rnr_14", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tsk_cnt_rnr_15", "tsk_cnt_rnr_15", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_debug_dbg_bus_cntrl[] = {
            BDMFMON_MAKE_PARM("dbg_sel", "dbg_sel", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_debug_statistics_dbg_sttstcs_ctrl[] = {
            BDMFMON_MAKE_PARM("dbg_mode", "dbg_mode", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("en_cntrs", "en_cntrs", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("clr_cntrs", "clr_cntrs", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("dbg_rnr_sel", "dbg_rnr_sel", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_qdes_reg_q_head[] = {
            BDMFMON_MAKE_PARM("q_head_idx", "q_head_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("head", "head", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_qdes_reg_viq_head_vld[] = {
            BDMFMON_MAKE_PARM("viq_head_vld", "viq_head_vld", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_qdes_reg_viq_chrncy_vld[] = {
            BDMFMON_MAKE_PARM("chrncy_vld", "chrncy_vld", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_qdes_reg_qdes_buf_avl_cntrl[] = {
            BDMFMON_MAKE_PARM("use_buf_avl", "use_buf_avl", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("dec_bufout_when_mltcst", "dec_bufout_when_mltcst", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_flldes_flldrop[] = {
            BDMFMON_MAKE_PARM("drpcnt", "drpcnt", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_bdram_next_data[] = {
            BDMFMON_MAKE_PARM("temp_index", "temp_index", BDMFMON_PARM_UNUMBER, 0),
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name = "congestion_total_egrs_congstn", .val = cli_dsptchr_congestion_total_egrs_congstn, .parms = set_cngs_params },
            ...
            { .name = "queue_mapping_pd_dsptch_add_rnr_grp", .val = cli_dsptchr_queue_mapping_pd_dsptch_add_rnr_grp, .parms = set_queue_mapping_pd_dsptch_add_rnr_grp },
        ...
        BDMFMON_MAKE_CMD(dir, "set", "set", ag_drv_dsptchr_cli_set,
    ...
    }
    {
        ...
        static bdmfmon_cmd_parm_t get_cngs_params[] = {
            BDMFMON_MAKE_PARM("viq_idx", "viq_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_q_size_params[] = {
            BDMFMON_MAKE_PARM("q_idx", "q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_credit_cnt[] = {
            BDMFMON_MAKE_PARM("q_idx", "q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_q_limits_params[] = {
            BDMFMON_MAKE_PARM("q_idx", "q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_ingress_coherency_params[] = {
            BDMFMON_MAKE_PARM("q_idx", "q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_rnr_dsptch_addr[] = {
            BDMFMON_MAKE_PARM("rnr_idx", "rnr_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_queue_mapping_crdt_cfg[] = {
            BDMFMON_MAKE_PARM("q_idx", "q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_mask_msk_tsk_255_0[] = {
            BDMFMON_MAKE_PARM("group_idx", "group_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_mask_msk_q[] = {
            BDMFMON_MAKE_PARM("group_idx", "group_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_egrs_queues_per_q_egrs_size[] = {
            BDMFMON_MAKE_PARM("q_idx", "q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_disptch_scheduling_dwrr_info[] = {
            BDMFMON_MAKE_PARM("dwrr_q_idx", "dwrr_q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_load_balancing_tsk_to_rg_mapping[] = {
            BDMFMON_MAKE_PARM("task_to_rg_mapping", "task_to_rg_mapping", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_debug_statistics_dbg_cnt[] = {
            BDMFMON_MAKE_PARM("index", "index", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_qdes_head[] = {
            BDMFMON_MAKE_PARM("q_idx", "q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_qdes_bfout[] = {
            BDMFMON_MAKE_PARM("zero", "zero", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_qdes_bufin[] = {
            BDMFMON_MAKE_PARM("zero", "zero", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_qdes_tail[] = {
            BDMFMON_MAKE_PARM("q_idx", "q_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_qdes_fbdnull[] = {
            BDMFMON_MAKE_PARM("zero", "zero", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_qdes_nullbd[] = {
            BDMFMON_MAKE_PARM("zero", "zero", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_qdes_bufavail[] = {
            BDMFMON_MAKE_PARM("zero", "zero", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_qdes_reg_q_head[] = {
            BDMFMON_MAKE_PARM("q_head_idx", "q_head_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_bdram_next_data[] = {
            BDMFMON_MAKE_PARM("temp_index", "temp_index", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_bdram_prev_data[] = {
            BDMFMON_MAKE_PARM("temp_index", "temp_index", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_pdram_data[] = {
            BDMFMON_MAKE_PARM("temp_index", "temp_index", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_enum_val_t selector_table[] = {
            { .name = "cngs_params", .val = cli_dsptchr_cngs_params, .parms = get_cngs_params },
            { .name = "glbl_cngs_params", .val = cli_dsptchr_glbl_cngs_params, .parms = get_default },
            { .name = "q_size_params", .val = cli_dsptchr_q_size_params, .parms = get_q_size_params },
            { .name = "credit_cnt", .val = cli_dsptchr_credit_cnt, .parms = get_credit_cnt },
            { .name = "q_limits_params", .val = cli_dsptchr_q_limits_params, .parms = get_q_limits_params },
            { .name = "ingress_coherency_params", .val = cli_dsptchr_ingress_coherency_params, .parms = get_ingress_coherency_params },
            { .name = "pools_limits", .val = cli_dsptchr_pools_limits, .parms = get_default },
            { .name = "fll_entry", .val = cli_dsptchr_fll_entry, .parms = get_default },
            { .name = "rnr_dsptch_addr", .val = cli_dsptchr_rnr_dsptch_addr, .parms = get_rnr_dsptch_addr },
            { .name = "reorder_cfg_dsptchr_reordr_cfg", .val = cli_dsptchr_reorder_cfg_dsptchr_reordr_cfg, .parms = get_default },
            { .name = "reorder_cfg_vq_en", .val = cli_dsptchr_reorder_cfg_vq_en, .parms = get_default },
            { .name = "reorder_cfg_bb_cfg", .val = cli_dsptchr_reorder_cfg_bb_cfg, .parms = get_default },
            { .name = "reorder_cfg_clk_gate_cntrl", .val = cli_dsptchr_reorder_cfg_clk_gate_cntrl, .parms = get_default },
            { .name = "congestion_egrs_congstn", .val = cli_dsptchr_congestion_egrs_congstn, .parms = get_cngs_params },
            { .name = "congestion_total_egrs_congstn", .val = cli_dsptchr_congestion_total_egrs_congstn, .parms = get_cngs_params },
            { .name = "congestion_congstn_status", .val = cli_dsptchr_congestion_congstn_status, .parms = get_default },
            { .name = "congestion_per_q_ingrs_congstn_low", .val = cli_dsptchr_congestion_per_q_ingrs_congstn_low, .parms = get_default },
            { .name = "congestion_per_q_ingrs_congstn_high", .val = cli_dsptchr_congestion_per_q_ingrs_congstn_high, .parms = get_default },
            { .name = "congestion_per_q_egrs_congstn_low", .val = cli_dsptchr_congestion_per_q_egrs_congstn_low, .parms = get_default },
            { .name = "congestion_per_q_egrs_congstn_high", .val = cli_dsptchr_congestion_per_q_egrs_congstn_high, .parms = get_default },
            { .name = "queue_mapping_crdt_cfg", .val = cli_dsptchr_queue_mapping_crdt_cfg, .parms = get_queue_mapping_crdt_cfg },
            { .name = "queue_mapping_q_dest", .val = cli_dsptchr_queue_mapping_q_dest, .parms = get_default },
            { .name = "queue_mapping_pd_dsptch_add_rnr_grp", .val = cli_dsptchr_queue_mapping_pd_dsptch_add_rnr_grp, .parms = get_default },
            { .name = "mask_msk_tsk_255_0", .val = cli_dsptchr_mask_msk_tsk_255_0, .parms = get_mask_msk_tsk_255_0 },
            { .name = "mask_msk_q", .val = cli_dsptchr_mask_msk_q, .parms = get_mask_msk_q },
            { .name = "mask_dly_q", .val = cli_dsptchr_mask_dly_q, .parms = get_default },
            { .name = "mask_non_dly_q", .val = cli_dsptchr_mask_non_dly_q, .parms = get_default },
            { .name = "egrs_queues_egrs_dly_qm_crdt", .val = cli_dsptchr_egrs_queues_egrs_dly_qm_crdt, .parms = get_default },
            { .name = "egrs_queues_egrs_non_dly_qm_crdt", .val = cli_dsptchr_egrs_queues_egrs_non_dly_qm_crdt, .parms = get_default },
            { .name = "egrs_queues_total_q_egrs_size", .val = cli_dsptchr_egrs_queues_total_q_egrs_size, .parms = get_default },
            { .name = "egrs_queues_per_q_egrs_size", .val = cli_dsptchr_egrs_queues_per_q_egrs_size, .parms = get_egrs_queues_per_q_egrs_size },
            { .name = "wakeup_control_wkup_req", .val = cli_dsptchr_wakeup_control_wkup_req, .parms = get_default },
            { .name = "wakeup_control_wkup_thrshld", .val = cli_dsptchr_wakeup_control_wkup_thrshld, .parms = get_default },
            { .name = "disptch_scheduling_dwrr_info", .val = cli_dsptchr_disptch_scheduling_dwrr_info, .parms = get_disptch_scheduling_dwrr_info },
            { .name = "disptch_scheduling_vld_crdt", .val = cli_dsptchr_disptch_scheduling_vld_crdt, .parms = get_default },
            { .name = "load_balancing_lb_cfg", .val = cli_dsptchr_load_balancing_lb_cfg, .parms = get_default },
            { .name = "load_balancing_free_task_0_1", .val = cli_dsptchr_load_balancing_free_task_0_1, .parms = get_default },
            { .name = "load_balancing_free_task_2_3", .val = cli_dsptchr_load_balancing_free_task_2_3, .parms = get_default },
            { .name = "load_balancing_free_task_4_5", .val = cli_dsptchr_load_balancing_free_task_4_5, .parms = get_default },
            { .name = "load_balancing_free_task_6_7", .val = cli_dsptchr_load_balancing_free_task_6_7, .parms = get_default },
            { .name = "load_balancing_free_task_8_9", .val = cli_dsptchr_load_balancing_free_task_8_9, .parms = get_default },
            { .name = "load_balancing_free_task_10_11", .val = cli_dsptchr_load_balancing_free_task_10_11, .parms = get_default },
            { .name = "load_balancing_free_task_12_13", .val = cli_dsptchr_load_balancing_free_task_12_13, .parms = get_default },
            { .name = "load_balancing_free_task_14_15", .val = cli_dsptchr_load_balancing_free_task_14_15, .parms = get_default },
            { .name = "load_balancing_tsk_to_rg_mapping", .val = cli_dsptchr_load_balancing_tsk_to_rg_mapping, .parms = get_load_balancing_tsk_to_rg_mapping },
            { .name = "load_balancing_rg_avlabl_tsk_0_3", .val = cli_dsptchr_load_balancing_rg_avlabl_tsk_0_3, .parms = get_default },
            { .name = "load_balancing_rg_avlabl_tsk_4_7", .val = cli_dsptchr_load_balancing_rg_avlabl_tsk_4_7, .parms = get_default },
            { .name = "dsptcher_reordr_top_intr_ctrl_0_isr", .val = cli_dsptchr_dsptcher_reordr_top_intr_ctrl_0_isr, .parms = get_default },
            { .name = "dsptcher_reordr_top_intr_ctrl_0_ism", .val = cli_dsptchr_dsptcher_reordr_top_intr_ctrl_0_ism, .parms = get_default },
            { .name = "dsptcher_reordr_top_intr_ctrl_0_ier", .val = cli_dsptchr_dsptcher_reordr_top_intr_ctrl_0_ier, .parms = get_default },
            { .name = "dsptcher_reordr_top_intr_ctrl_0_itr", .val = cli_dsptchr_dsptcher_reordr_top_intr_ctrl_0_itr, .parms = get_default },
            { .name = "dsptcher_reordr_top_intr_ctrl_1_isr", .val = cli_dsptchr_dsptcher_reordr_top_intr_ctrl_1_isr, .parms = get_default },
            { .name = "dsptcher_reordr_top_intr_ctrl_1_ism", .val = cli_dsptchr_dsptcher_reordr_top_intr_ctrl_1_ism, .parms = get_default },
            { .name = "dsptcher_reordr_top_intr_ctrl_1_ier", .val = cli_dsptchr_dsptcher_reordr_top_intr_ctrl_1_ier, .parms = get_default },
            { .name = "dsptcher_reordr_top_intr_ctrl_1_itr", .val = cli_dsptchr_dsptcher_reordr_top_intr_ctrl_1_itr, .parms = get_default },
            { .name = "debug_dbg_bypss_cntrl", .val = cli_dsptchr_debug_dbg_bypss_cntrl, .parms = get_default },
            { .name = "debug_glbl_tsk_cnt_0_7", .val = cli_dsptchr_debug_glbl_tsk_cnt_0_7, .parms = get_default },
            { .name = "debug_glbl_tsk_cnt_8_15", .val = cli_dsptchr_debug_glbl_tsk_cnt_8_15, .parms = get_default },
            { .name = "debug_dbg_bus_cntrl", .val = cli_dsptchr_debug_dbg_bus_cntrl, .parms = get_default },
            { .name = "debug_dbg_vec_0", .val = cli_dsptchr_debug_dbg_vec_0, .parms = get_default },
            { .name = "debug_dbg_vec_1", .val = cli_dsptchr_debug_dbg_vec_1, .parms = get_default },
            { .name = "debug_dbg_vec_2", .val = cli_dsptchr_debug_dbg_vec_2, .parms = get_default },
            { .name = "debug_dbg_vec_3", .val = cli_dsptchr_debug_dbg_vec_3, .parms = get_default },
            { .name = "debug_dbg_vec_4", .val = cli_dsptchr_debug_dbg_vec_4, .parms = get_default },
            { .name = "debug_dbg_vec_5", .val = cli_dsptchr_debug_dbg_vec_5, .parms = get_default },
            { .name = "debug_dbg_vec_6", .val = cli_dsptchr_debug_dbg_vec_6, .parms = get_default },
            { .name = "debug_dbg_vec_7", .val = cli_dsptchr_debug_dbg_vec_7, .parms = get_default },
            { .name = "debug_dbg_vec_8", .val = cli_dsptchr_debug_dbg_vec_8, .parms = get_default },
            { .name = "debug_dbg_vec_9", .val = cli_dsptchr_debug_dbg_vec_9, .parms = get_default },
            { .name = "debug_dbg_vec_10", .val = cli_dsptchr_debug_dbg_vec_10, .parms = get_default },
            { .name = "debug_dbg_vec_11", .val = cli_dsptchr_debug_dbg_vec_11, .parms = get_default },
            { .name = "debug_dbg_vec_12", .val = cli_dsptchr_debug_dbg_vec_12, .parms = get_default },
            { .name = "debug_dbg_vec_13", .val = cli_dsptchr_debug_dbg_vec_13, .parms = get_default },
            { .name = "debug_dbg_vec_14", .val = cli_dsptchr_debug_dbg_vec_14, .parms = get_default },
            { .name = "debug_dbg_vec_15", .val = cli_dsptchr_debug_dbg_vec_15, .parms = get_default },
            { .name = "debug_dbg_vec_16", .val = cli_dsptchr_debug_dbg_vec_16, .parms = get_default },
            { .name = "debug_dbg_vec_17", .val = cli_dsptchr_debug_dbg_vec_17, .parms = get_default },
            { .name = "debug_dbg_vec_18", .val = cli_dsptchr_debug_dbg_vec_18, .parms = get_default },
            { .name = "debug_dbg_vec_19", .val = cli_dsptchr_debug_dbg_vec_19, .parms = get_default },
            { .name = "debug_dbg_vec_20", .val = cli_dsptchr_debug_dbg_vec_20, .parms = get_default },
            { .name = "debug_dbg_vec_21", .val = cli_dsptchr_debug_dbg_vec_21, .parms = get_default },
            { .name = "debug_dbg_vec_22", .val = cli_dsptchr_debug_dbg_vec_22, .parms = get_default },
            { .name = "debug_dbg_vec_23", .val = cli_dsptchr_debug_dbg_vec_23, .parms = get_default },
            { .name = "debug_intr_vec_0", .val = cli_dsptchr_debug_intr_vec_0, .parms = get_default },
            { .name = "debug_intr_vec_1", .val = cli_dsptchr_debug_intr_vec_1, .parms = get_default },
            { .name = "debug_intr_vec_2", .val = cli_dsptchr_debug_intr_vec_2, .parms = get_default },
            { .name = "debug_intr_vec_3", .val = cli_dsptchr_debug_intr_vec_3, .parms = get_default },
            { .name = "debug_intr_vec_4", .val = cli_dsptchr_debug_intr_vec_4, .parms = get_default },
            { .name = "debug_statistics_dbg_sttstcs_ctrl", .val = cli_dsptchr_debug_statistics_dbg_sttstcs_ctrl, .parms = get_default },
            { .name = "debug_statistics_dbg_cnt", .val = cli_dsptchr_debug_statistics_dbg_cnt, .parms = get_debug_statistics_dbg_cnt },
            { .name = "qdes_head", .val = cli_dsptchr_qdes_head, .parms = get_qdes_head },
            { .name = "qdes_bfout", .val = cli_dsptchr_qdes_bfout, .parms = get_qdes_bfout },
            { .name = "qdes_bufin", .val = cli_dsptchr_qdes_bufin, .parms = get_qdes_bufin },
            { .name = "qdes_tail", .val = cli_dsptchr_qdes_tail, .parms = get_qdes_tail },
            { .name = "qdes_fbdnull", .val = cli_dsptchr_qdes_fbdnull, .parms = get_qdes_fbdnull },
            { .name = "qdes_nullbd", .val = cli_dsptchr_qdes_nullbd, .parms = get_qdes_nullbd },
            { .name = "qdes_bufavail", .val = cli_dsptchr_qdes_bufavail, .parms = get_qdes_bufavail },
            { .name = "qdes_reg_q_head", .val = cli_dsptchr_qdes_reg_q_head, .parms = get_qdes_reg_q_head },
            { .name = "qdes_reg_viq_head_vld", .val = cli_dsptchr_qdes_reg_viq_head_vld, .parms = get_default },
            { .name = "qdes_reg_viq_chrncy_vld", .val = cli_dsptchr_qdes_reg_viq_chrncy_vld, .parms = get_default },
            { .name = "qdes_reg_veq_head_vld", .val = cli_dsptchr_qdes_reg_veq_head_vld, .parms = get_default },
            { .name = "qdes_reg_qdes_buf_avl_cntrl", .val = cli_dsptchr_qdes_reg_qdes_buf_avl_cntrl, .parms = get_default },
            { .name = "flldes_flldrop", .val = cli_dsptchr_flldes_flldrop, .parms = get_default },
            { .name = "flldes_bufavail", .val = cli_dsptchr_flldes_bufavail, .parms = get_default },
            { .name = "flldes_freemin", .val = cli_dsptchr_flldes_freemin, .parms = get_default },
            { .name = "bdram_next_data", .val = cli_dsptchr_bdram_next_data, .parms = get_bdram_next_data },
            { .name = "bdram_prev_data", .val = cli_dsptchr_bdram_prev_data, .parms = get_bdram_prev_data },
            { .name = "pdram_data", .val = cli_dsptchr_pdram_data, .parms = get_pdram_data },
            BDMFMON_ENUM_LAST
        };
...
#ifdef HAL_DRV_TEST_ENABLE
    {
        ...
        BDMFMON_MAKE_PARM(dir, "test", "test", ag_drv_dsptchr_cli_test,
...
#ifdef HAL_DRV_TEST_ENABLE
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            { .name = "cngs_params", .val = cli_dsptchr_cngs_params, .parms = ext_test_default},
            { .name = "q_size_params", .val = cli_dsptchr_q_size_params, .parms = ext_test_default},
            { .name = "credit_cnt", .val = cli_dsptchr_credit_cnt, .parms = ext_test_default},
            { .name = "q_limits_params", .val = cli_dsptchr_q_limits_params, .parms = ext_test_default},
            { .name = "ingress_coherency_params", .val = cli_dsptchr_ingress_coherency_params, .parms = ext_test_default},
            { .name = "rnr_dsptch_addr", .val = cli_dsptchr_rnr_dsptch_addr, .parms = ext_test_default},
            { .name = "congestion_egrs_congstn", .val = cli_dsptchr_congestion_egrs_congstn, .parms = ext_test_default},
            { .name = "congestion_total_egrs_congstn", .val = cli_dsptchr_congestion_total_egrs_congstn, .parms = ext_test_default},
            { .name = "queue_mapping_crdt_cfg", .val = cli_dsptchr_queue_mapping_crdt_cfg, .parms = ext_test_default},
            { .name = "mask_msk_tsk_255_0", .val = cli_dsptchr_mask_msk_tsk_255_0, .parms = ext_test_default},
            { .name = "mask_msk_q", .val = cli_dsptchr_mask_msk_q, .parms = ext_test_default},
            { .name = "disptch_scheduling_dwrr_info", .val = cli_dsptchr_disptch_scheduling_dwrr_info, .parms = ext_test_default},
            { .name = "load_balancing_tsk_to_rg_mapping", .val = cli_dsptchr_load_balancing_tsk_to_rg_mapping, .parms = ext_test_default},
            { .name = "qdes_head", .val = cli_dsptchr_qdes_head, .parms = ext_test_default},
            { .name = "qdes_bfout", .val = cli_dsptchr_qdes_bfout, .parms = ext_test_default},
            { .name = "qdes_bufin", .val = cli_dsptchr_qdes_bufin, .parms = ext_test_default},
            { .name = "qdes_tail", .val = cli_dsptchr_qdes_tail, .parms = ext_test_default},
            { .name = "qdes_fbdnull", .val = cli_dsptchr_qdes_fbdnull, .parms = ext_test_default},
            { .name = "qdes_nullbd", .val = cli_dsptchr_qdes_nullbd, .parms = ext_test_default},
            { .name = "qdes_reg_q_head", .val = cli_dsptchr_qdes_reg_q_head, .parms = ext_test_default},
            { .name = "bdram_next_data", .val = cli_dsptchr_bdram_next_data, .parms = ext_test_default},
            { .name = "bdram_prev_data", .val = cli_dsptchr_bdram_prev_data, .parms = ext_test_default},
            { .name = "pdram_data", .val = cli_dsptchr_pdram_data, .parms = ext_test_default},
            BDMFMON_ENUM_LAST
        };
        static bdmfmon_enum_val_t enum_table_test_method[] = {
            { .name = "low", .val = ag_drv_cli_test_method_low },
        ...
        BDMFMON_MAKE_PARM(dir, "ext_test", "ext_test", ag_drv_dsptchr_cli_ext_test,
            BDMFMON_MAKE_PARM_ENUM("method", "low: 0000, mid: 1000, high: 1111", enum_table_test_method, 0),
            BDMFMON_MAKE_PARM_SELECTOR("purpose", "purpose", selector_table, 0),
...
#ifdef HAL_DRV_TEST_ENABLE
    {
        static bdmfmon_enum_val_t enum_table_address[] = {
            ...
            { .name = "INGRS_QUEUES_Q_INGRS_COHRENCY", .val = bdmf_address_ingrs_queues_q_ingrs_cohrency },
            ...
            { .name = "QUEUE_MAPPING_PD_DSPTCH_ADD_RNR_GRP", .val = bdmf_address_queue_mapping_pd_dsptch_add_rnr_grp },
            ...
            { .name = "DEBUG_INTR_VEC_0", .val = bdmf_address_debug_intr_vec_0 },
            { .name = "DEBUG_INTR_VEC_1", .val = bdmf_address_debug_intr_vec_1 },
            { .name = "DEBUG_INTR_VEC_2", .val = bdmf_address_debug_intr_vec_2 },
            { .name = "DEBUG_INTR_VEC_3", .val = bdmf_address_debug_intr_vec_3 },
            { .name = "DEBUG_INTR_VEC_4", .val = bdmf_address_debug_intr_vec_4 },
        ...
        BDMFMON_MAKE_PARM(dir, "address", "address", bcm_dsptchr_cli_address,
