...
bdmf_error_t ag_drv_fpm_pool1_intr_msk_set(const fpm_pool1_intr_msk *pool1_intr_msk)
{
    ...
    if ((pool1_intr_msk->alloc_fifo_full_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->free_fifo_full_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->pool_full_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->free_token_no_valid_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->free_token_index_out_of_range_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->multi_token_no_valid_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->multi_token_index_out_of_range_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->pool_dis_free_multi_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->memory_corrupt_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->xoff_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->xon_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->illegal_address_access_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->illegal_alloc_request_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->expired_token_det_msk >= _1BITS_MAX_VAL_) ||
       (pool1_intr_msk->expired_token_recov_msk >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, ALLOC_FIFO_FULL_MSK, reg_pool1_intr_msk, pool1_intr_msk->alloc_fifo_full_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, FREE_FIFO_FULL_MSK, reg_pool1_intr_msk, pool1_intr_msk->free_fifo_full_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, POOL_FULL_MSK, reg_pool1_intr_msk, pool1_intr_msk->pool_full_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, FREE_TOKEN_NO_VALID_MSK, reg_pool1_intr_msk, pool1_intr_msk->free_token_no_valid_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, FREE_TOKEN_INDEX_OUT_OF_RANGE_MSK, reg_pool1_intr_msk, pool1_intr_msk->free_token_index_out_of_range_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, MULTI_TOKEN_NO_VALID_MSK, reg_pool1_intr_msk, pool1_intr_msk->multi_token_no_valid_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, MULTI_TOKEN_INDEX_OUT_OF_RANGE_MSK, reg_pool1_intr_msk, pool1_intr_msk->multi_token_index_out_of_range_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, POOL_DIS_FREE_MULTI_MSK, reg_pool1_intr_msk, pool1_intr_msk->pool_dis_free_multi_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, MEMORY_CORRUPT_MSK, reg_pool1_intr_msk, pool1_intr_msk->memory_corrupt_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, XOFF_MSK, reg_pool1_intr_msk, pool1_intr_msk->xoff_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, XON_MSK, reg_pool1_intr_msk, pool1_intr_msk->xon_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, ILLEGAL_ADDRESS_ACCESS_MSK, reg_pool1_intr_msk, pool1_intr_msk->illegal_address_access_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, ILLEGAL_ALLOC_REQUEST_MSK, reg_pool1_intr_msk, pool1_intr_msk->illegal_alloc_request_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, EXPIRED_TOKEN_DET_MSK, reg_pool1_intr_msk, pool1_intr_msk->expired_token_det_msk);
    reg_pool1_intr_msk = RU_FIELD_SET(0, FPM, POOL1_INTR_MSK, EXPIRED_TOKEN_RECOV_MSK, reg_pool1_intr_msk, pool1_intr_msk->expired_token_recov_msk);

    RU_REG_WRITE(0, FPM, POOL1_INTR_MSK, reg_pool1_intr_msk);
...
bdmf_error_t ag_drv_fpm_pool1_intr_msk_get(fpm_pool1_intr_msk *pool1_intr_msk)
{
    ...
    RU_REG_READ(0, FPM, POOL1_INTR_MSK, reg_pool1_intr_msk);

    pool1_intr_msk->alloc_fifo_full_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, ALLOC_FIFO_FULL_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->free_fifo_full_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, FREE_FIFO_FULL_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->pool_full_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, POOL_FULL_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->free_token_no_valid_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, FREE_TOKEN_NO_VALID_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->free_token_index_out_of_range_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, FREE_TOKEN_INDEX_OUT_OF_RANGE_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->multi_token_no_valid_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, MULTI_TOKEN_NO_VALID_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->multi_token_index_out_of_range_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, MULTI_TOKEN_INDEX_OUT_OF_RANGE_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->pool_dis_free_multi_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, POOL_DIS_FREE_MULTI_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->memory_corrupt_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, MEMORY_CORRUPT_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->xoff_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, XOFF_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->xon_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, XON_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->illegal_address_access_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, ILLEGAL_ADDRESS_ACCESS_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->illegal_alloc_request_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, ILLEGAL_ALLOC_REQUEST_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->expired_token_det_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, EXPIRED_TOKEN_DET_MSK, reg_pool1_intr_msk);
    pool1_intr_msk->expired_token_recov_msk = RU_FIELD_GET(0, FPM, POOL1_INTR_MSK, EXPIRED_TOKEN_RECOV_MSK, reg_pool1_intr_msk);
...
bdmf_error_t ag_drv_fpm_pool1_intr_sts_set(const fpm_pool1_intr_sts *pool1_intr_sts)
{
    ...
    if ((pool1_intr_sts->alloc_fifo_full_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->free_fifo_full_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->pool_full_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->free_token_no_valid_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->free_token_index_out_of_range_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->multi_token_no_valid_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->multi_token_index_out_of_range_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->pool_dis_free_multi_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->memory_corrupt_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->xoff_state_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->xon_state_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->illegal_address_access_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->illegal_alloc_request_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->expired_token_det_sts >= _1BITS_MAX_VAL_) ||
       (pool1_intr_sts->expired_token_recov_sts >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, ALLOC_FIFO_FULL_STS, reg_pool1_intr_sts, pool1_intr_sts->alloc_fifo_full_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, FREE_FIFO_FULL_STS, reg_pool1_intr_sts, pool1_intr_sts->free_fifo_full_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, POOL_FULL_STS, reg_pool1_intr_sts, pool1_intr_sts->pool_full_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, FREE_TOKEN_NO_VALID_STS, reg_pool1_intr_sts, pool1_intr_sts->free_token_no_valid_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, FREE_TOKEN_INDEX_OUT_OF_RANGE_STS, reg_pool1_intr_sts, pool1_intr_sts->free_token_index_out_of_range_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, MULTI_TOKEN_NO_VALID_STS, reg_pool1_intr_sts, pool1_intr_sts->multi_token_no_valid_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, MULTI_TOKEN_INDEX_OUT_OF_RANGE_STS, reg_pool1_intr_sts, pool1_intr_sts->multi_token_index_out_of_range_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, POOL_DIS_FREE_MULTI_STS, reg_pool1_intr_sts, pool1_intr_sts->pool_dis_free_multi_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, MEMORY_CORRUPT_STS, reg_pool1_intr_sts, pool1_intr_sts->memory_corrupt_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, XOFF_STATE_STS, reg_pool1_intr_sts, pool1_intr_sts->xoff_state_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, XON_STATE_STS, reg_pool1_intr_sts, pool1_intr_sts->xon_state_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, ILLEGAL_ADDRESS_ACCESS_STS, reg_pool1_intr_sts, pool1_intr_sts->illegal_address_access_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, ILLEGAL_ALLOC_REQUEST_STS, reg_pool1_intr_sts, pool1_intr_sts->illegal_alloc_request_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, EXPIRED_TOKEN_DET_STS, reg_pool1_intr_sts, pool1_intr_sts->expired_token_det_sts);
    reg_pool1_intr_sts = RU_FIELD_SET(0, FPM, POOL1_INTR_STS, EXPIRED_TOKEN_RECOV_STS, reg_pool1_intr_sts, pool1_intr_sts->expired_token_recov_sts);

    RU_REG_WRITE(0, FPM, POOL1_INTR_STS, reg_pool1_intr_sts);
...
bdmf_error_t ag_drv_fpm_pool1_intr_sts_get(fpm_pool1_intr_sts *pool1_intr_sts)
{
    ...
    RU_REG_READ(0, FPM, POOL1_INTR_STS, reg_pool1_intr_sts);

    pool1_intr_sts->alloc_fifo_full_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, ALLOC_FIFO_FULL_STS, reg_pool1_intr_sts);
    pool1_intr_sts->free_fifo_full_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, FREE_FIFO_FULL_STS, reg_pool1_intr_sts);
    pool1_intr_sts->pool_full_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, POOL_FULL_STS, reg_pool1_intr_sts);
    pool1_intr_sts->free_token_no_valid_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, FREE_TOKEN_NO_VALID_STS, reg_pool1_intr_sts);
    pool1_intr_sts->free_token_index_out_of_range_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, FREE_TOKEN_INDEX_OUT_OF_RANGE_STS, reg_pool1_intr_sts);
    pool1_intr_sts->multi_token_no_valid_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, MULTI_TOKEN_NO_VALID_STS, reg_pool1_intr_sts);
    pool1_intr_sts->multi_token_index_out_of_range_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, MULTI_TOKEN_INDEX_OUT_OF_RANGE_STS, reg_pool1_intr_sts);
    pool1_intr_sts->pool_dis_free_multi_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, POOL_DIS_FREE_MULTI_STS, reg_pool1_intr_sts);
    pool1_intr_sts->memory_corrupt_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, MEMORY_CORRUPT_STS, reg_pool1_intr_sts);
    pool1_intr_sts->xoff_state_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, XOFF_STATE_STS, reg_pool1_intr_sts);
    pool1_intr_sts->xon_state_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, XON_STATE_STS, reg_pool1_intr_sts);
    pool1_intr_sts->illegal_address_access_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, ILLEGAL_ADDRESS_ACCESS_STS, reg_pool1_intr_sts);
    pool1_intr_sts->illegal_alloc_request_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, ILLEGAL_ALLOC_REQUEST_STS, reg_pool1_intr_sts);
    pool1_intr_sts->expired_token_det_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, EXPIRED_TOKEN_DET_STS, reg_pool1_intr_sts);
    pool1_intr_sts->expired_token_recov_sts = RU_FIELD_GET(0, FPM, POOL1_INTR_STS, EXPIRED_TOKEN_RECOV_STS, reg_pool1_intr_sts);
...
{
    uint32_t reg_pool1_stall_msk = 0;
    ...
    if ((pool1_stall_msk->free_token_no_valid_stall_msk >= _1BITS_MAX_VAL_) ||
       (pool1_stall_msk->free_token_index_out_of_range_stall_msk >= _1BITS_MAX_VAL_) ||
       (pool1_stall_msk->multi_token_no_valid_stall_msk >= _1BITS_MAX_VAL_) ||
       (pool1_stall_msk->multi_token_index_out_of_range_stall_msk >= _1BITS_MAX_VAL_) ||
       (pool1_stall_msk->memory_corrupt_stall_msk >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_pool1_stall_msk = RU_FIELD_SET(0, FPM, POOL1_STALL_MSK, FREE_TOKEN_NO_VALID_STALL_MSK, reg_pool1_stall_msk, pool1_stall_msk->free_token_no_valid_stall_msk);
    reg_pool1_stall_msk = RU_FIELD_SET(0, FPM, POOL1_STALL_MSK, FREE_TOKEN_INDEX_OUT_OF_RANGE_STALL_MSK, reg_pool1_stall_msk, pool1_stall_msk->free_token_index_out_of_range_stall_msk);
    reg_pool1_stall_msk = RU_FIELD_SET(0, FPM, POOL1_STALL_MSK, MULTI_TOKEN_NO_VALID_STALL_MSK, reg_pool1_stall_msk, pool1_stall_msk->multi_token_no_valid_stall_msk);
    reg_pool1_stall_msk = RU_FIELD_SET(0, FPM, POOL1_STALL_MSK, MULTI_TOKEN_INDEX_OUT_OF_RANGE_STALL_MSK, reg_pool1_stall_msk, pool1_stall_msk->multi_token_index_out_of_range_stall_msk);
    reg_pool1_stall_msk = RU_FIELD_SET(0, FPM, POOL1_STALL_MSK, MEMORY_CORRUPT_STALL_MSK, reg_pool1_stall_msk, pool1_stall_msk->memory_corrupt_stall_msk);

    RU_REG_WRITE(0, FPM, POOL1_STALL_MSK, reg_pool1_stall_msk);
...
bdmf_error_t ag_drv_fpm_pool1_stall_msk_get(fpm_pool1_stall_msk *pool1_stall_msk)
{
    ...
    RU_REG_READ(0, FPM, POOL1_STALL_MSK, reg_pool1_stall_msk);

    pool1_stall_msk->free_token_no_valid_stall_msk = RU_FIELD_GET(0, FPM, POOL1_STALL_MSK, FREE_TOKEN_NO_VALID_STALL_MSK, reg_pool1_stall_msk);
    pool1_stall_msk->free_token_index_out_of_range_stall_msk = RU_FIELD_GET(0, FPM, POOL1_STALL_MSK, FREE_TOKEN_INDEX_OUT_OF_RANGE_STALL_MSK, reg_pool1_stall_msk);
    pool1_stall_msk->multi_token_no_valid_stall_msk = RU_FIELD_GET(0, FPM, POOL1_STALL_MSK, MULTI_TOKEN_NO_VALID_STALL_MSK, reg_pool1_stall_msk);
    pool1_stall_msk->multi_token_index_out_of_range_stall_msk = RU_FIELD_GET(0, FPM, POOL1_STALL_MSK, MULTI_TOKEN_INDEX_OUT_OF_RANGE_STALL_MSK, reg_pool1_stall_msk);
    pool1_stall_msk->memory_corrupt_stall_msk = RU_FIELD_GET(0, FPM, POOL1_STALL_MSK, MEMORY_CORRUPT_STALL_MSK, reg_pool1_stall_msk);
...
int bcm_fpm_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_fpm_pool1_intr_msk:
    {
        fpm_pool1_intr_msk pool1_intr_msk;
        ag_err = ag_drv_fpm_pool1_intr_msk_get(&pool1_intr_msk);
        bdmf_session_print(session, "alloc_fifo_full_msk = %u = 0x%x\n", pool1_intr_msk.alloc_fifo_full_msk, pool1_intr_msk.alloc_fifo_full_msk);
        bdmf_session_print(session, "free_fifo_full_msk = %u = 0x%x\n", pool1_intr_msk.free_fifo_full_msk, pool1_intr_msk.free_fifo_full_msk);
        bdmf_session_print(session, "pool_full_msk = %u = 0x%x\n", pool1_intr_msk.pool_full_msk, pool1_intr_msk.pool_full_msk);
        bdmf_session_print(session, "free_token_no_valid_msk = %u = 0x%x\n", pool1_intr_msk.free_token_no_valid_msk, pool1_intr_msk.free_token_no_valid_msk);
        bdmf_session_print(session, "free_token_index_out_of_range_msk = %u = 0x%x\n", pool1_intr_msk.free_token_index_out_of_range_msk, pool1_intr_msk.free_token_index_out_of_range_msk);
        bdmf_session_print(session, "multi_token_no_valid_msk = %u = 0x%x\n", pool1_intr_msk.multi_token_no_valid_msk, pool1_intr_msk.multi_token_no_valid_msk);
        bdmf_session_print(session, "multi_token_index_out_of_range_msk = %u = 0x%x\n", pool1_intr_msk.multi_token_index_out_of_range_msk, pool1_intr_msk.multi_token_index_out_of_range_msk);
        bdmf_session_print(session, "pool_dis_free_multi_msk = %u = 0x%x\n", pool1_intr_msk.pool_dis_free_multi_msk, pool1_intr_msk.pool_dis_free_multi_msk);
        bdmf_session_print(session, "memory_corrupt_msk = %u = 0x%x\n", pool1_intr_msk.memory_corrupt_msk, pool1_intr_msk.memory_corrupt_msk);
        bdmf_session_print(session, "xoff_msk = %u = 0x%x\n", pool1_intr_msk.xoff_msk, pool1_intr_msk.xoff_msk);
        bdmf_session_print(session, "xon_msk = %u = 0x%x\n", pool1_intr_msk.xon_msk, pool1_intr_msk.xon_msk);
        bdmf_session_print(session, "illegal_address_access_msk = %u = 0x%x\n", pool1_intr_msk.illegal_address_access_msk, pool1_intr_msk.illegal_address_access_msk);
        bdmf_session_print(session, "illegal_alloc_request_msk = %u = 0x%x\n", pool1_intr_msk.illegal_alloc_request_msk, pool1_intr_msk.illegal_alloc_request_msk);
        bdmf_session_print(session, "expired_token_det_msk = %u = 0x%x\n", pool1_intr_msk.expired_token_det_msk, pool1_intr_msk.expired_token_det_msk);
        bdmf_session_print(session, "expired_token_recov_msk = %u = 0x%x\n", pool1_intr_msk.expired_token_recov_msk, pool1_intr_msk.expired_token_recov_msk);
        break;
    }
    case cli_fpm_pool1_intr_sts:
    {
        fpm_pool1_intr_sts pool1_intr_sts;
        ag_err = ag_drv_fpm_pool1_intr_sts_get(&pool1_intr_sts);
        bdmf_session_print(session, "alloc_fifo_full_sts = %u = 0x%x\n", pool1_intr_sts.alloc_fifo_full_sts, pool1_intr_sts.alloc_fifo_full_sts);
        bdmf_session_print(session, "free_fifo_full_sts = %u = 0x%x\n", pool1_intr_sts.free_fifo_full_sts, pool1_intr_sts.free_fifo_full_sts);
        bdmf_session_print(session, "pool_full_sts = %u = 0x%x\n", pool1_intr_sts.pool_full_sts, pool1_intr_sts.pool_full_sts);
        bdmf_session_print(session, "free_token_no_valid_sts = %u = 0x%x\n", pool1_intr_sts.free_token_no_valid_sts, pool1_intr_sts.free_token_no_valid_sts);
        bdmf_session_print(session, "free_token_index_out_of_range_sts = %u = 0x%x\n", pool1_intr_sts.free_token_index_out_of_range_sts, pool1_intr_sts.free_token_index_out_of_range_sts);
        bdmf_session_print(session, "multi_token_no_valid_sts = %u = 0x%x\n", pool1_intr_sts.multi_token_no_valid_sts, pool1_intr_sts.multi_token_no_valid_sts);
        bdmf_session_print(session, "multi_token_index_out_of_range_sts = %u = 0x%x\n", pool1_intr_sts.multi_token_index_out_of_range_sts, pool1_intr_sts.multi_token_index_out_of_range_sts);
        bdmf_session_print(session, "pool_dis_free_multi_sts = %u = 0x%x\n", pool1_intr_sts.pool_dis_free_multi_sts, pool1_intr_sts.pool_dis_free_multi_sts);
        bdmf_session_print(session, "memory_corrupt_sts = %u = 0x%x\n", pool1_intr_sts.memory_corrupt_sts, pool1_intr_sts.memory_corrupt_sts);
        bdmf_session_print(session, "xoff_state_sts = %u = 0x%x\n", pool1_intr_sts.xoff_state_sts, pool1_intr_sts.xoff_state_sts);
        bdmf_session_print(session, "xon_state_sts = %u = 0x%x\n", pool1_intr_sts.xon_state_sts, pool1_intr_sts.xon_state_sts);
        bdmf_session_print(session, "illegal_address_access_sts = %u = 0x%x\n", pool1_intr_sts.illegal_address_access_sts, pool1_intr_sts.illegal_address_access_sts);
        bdmf_session_print(session, "illegal_alloc_request_sts = %u = 0x%x\n", pool1_intr_sts.illegal_alloc_request_sts, pool1_intr_sts.illegal_alloc_request_sts);
        bdmf_session_print(session, "expired_token_det_sts = %u = 0x%x\n", pool1_intr_sts.expired_token_det_sts, pool1_intr_sts.expired_token_det_sts);
        bdmf_session_print(session, "expired_token_recov_sts = %u = 0x%x\n", pool1_intr_sts.expired_token_recov_sts, pool1_intr_sts.expired_token_recov_sts);
        break;
    }
    case cli_fpm_pool1_stall_msk:
    {
        fpm_pool1_stall_msk pool1_stall_msk;
        ag_err = ag_drv_fpm_pool1_stall_msk_get(&pool1_stall_msk);
        bdmf_session_print(session, "free_token_no_valid_stall_msk = %u = 0x%x\n", pool1_stall_msk.free_token_no_valid_stall_msk, pool1_stall_msk.free_token_no_valid_stall_msk);
        bdmf_session_print(session, "free_token_index_out_of_range_stall_msk = %u = 0x%x\n", pool1_stall_msk.free_token_index_out_of_range_stall_msk, pool1_stall_msk.free_token_index_out_of_range_stall_msk);
        bdmf_session_print(session, "multi_token_no_valid_stall_msk = %u = 0x%x\n", pool1_stall_msk.multi_token_no_valid_stall_msk, pool1_stall_msk.multi_token_no_valid_stall_msk);
        bdmf_session_print(session, "multi_token_index_out_of_range_stall_msk = %u = 0x%x\n", pool1_stall_msk.multi_token_index_out_of_range_stall_msk, pool1_stall_msk.multi_token_index_out_of_range_stall_msk);
        bdmf_session_print(session, "memory_corrupt_stall_msk = %u = 0x%x\n", pool1_stall_msk.memory_corrupt_stall_msk, pool1_stall_msk.memory_corrupt_stall_msk);
        break;
    }
    case cli_fpm_pool1_cfg4:
    {
...
static int ag_drv_fpm_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        fpm_pool1_intr_msk pool1_intr_msk = {.alloc_fifo_full_msk = gtmv(m, 1), .free_fifo_full_msk = gtmv(m, 1), .pool_full_msk = gtmv(m, 1), .free_token_no_valid_msk = gtmv(m, 1), .free_token_index_out_of_range_msk = gtmv(m, 1), .multi_token_no_valid_msk = gtmv(m, 1), .multi_token_index_out_of_range_msk = gtmv(m, 1), .pool_dis_free_multi_msk = gtmv(m, 1), .memory_corrupt_msk = gtmv(m, 1), .xoff_msk = gtmv(m, 1), .xon_msk = gtmv(m, 1), .illegal_address_access_msk = gtmv(m, 1), .illegal_alloc_request_msk = gtmv(m, 1), .expired_token_det_msk = gtmv(m, 1), .expired_token_recov_msk = gtmv(m, 1)};
        bdmf_session_print(session, "ag_drv_fpm_pool1_intr_msk_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n",
            pool1_intr_msk.alloc_fifo_full_msk, pool1_intr_msk.free_fifo_full_msk, pool1_intr_msk.pool_full_msk, pool1_intr_msk.free_token_no_valid_msk, 
            pool1_intr_msk.free_token_index_out_of_range_msk, pool1_intr_msk.multi_token_no_valid_msk, pool1_intr_msk.multi_token_index_out_of_range_msk, pool1_intr_msk.pool_dis_free_multi_msk, 
            pool1_intr_msk.memory_corrupt_msk, pool1_intr_msk.xoff_msk, pool1_intr_msk.xon_msk, pool1_intr_msk.illegal_address_access_msk, 
            pool1_intr_msk.illegal_alloc_request_msk, pool1_intr_msk.expired_token_det_msk, pool1_intr_msk.expired_token_recov_msk);
        ag_err = ag_drv_fpm_pool1_intr_msk_set(&pool1_intr_msk);
        if (!ag_err)
            ag_err = ag_drv_fpm_pool1_intr_msk_get(&pool1_intr_msk);
        ...
        if (pool1_intr_msk.alloc_fifo_full_msk != gtmv(m, 1) || pool1_intr_msk.free_fifo_full_msk != gtmv(m, 1) || pool1_intr_msk.pool_full_msk != gtmv(m, 1) || pool1_intr_msk.free_token_no_valid_msk != gtmv(m, 1) || pool1_intr_msk.free_token_index_out_of_range_msk != gtmv(m, 1) || pool1_intr_msk.multi_token_no_valid_msk != gtmv(m, 1) || pool1_intr_msk.multi_token_index_out_of_range_msk != gtmv(m, 1) || pool1_intr_msk.pool_dis_free_multi_msk != gtmv(m, 1) || pool1_intr_msk.memory_corrupt_msk != gtmv(m, 1) || pool1_intr_msk.xoff_msk != gtmv(m, 1) || pool1_intr_msk.xon_msk != gtmv(m, 1) || pool1_intr_msk.illegal_address_access_msk != gtmv(m, 1) || pool1_intr_msk.illegal_alloc_request_msk != gtmv(m, 1) || pool1_intr_msk.expired_token_det_msk != gtmv(m, 1) || pool1_intr_msk.expired_token_recov_msk != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
    ...
    {
        fpm_pool1_intr_sts pool1_intr_sts = {.alloc_fifo_full_sts = gtmv(m, 1), .free_fifo_full_sts = gtmv(m, 1), .pool_full_sts = gtmv(m, 1), .free_token_no_valid_sts = gtmv(m, 1), .free_token_index_out_of_range_sts = gtmv(m, 1), .multi_token_no_valid_sts = gtmv(m, 1), .multi_token_index_out_of_range_sts = gtmv(m, 1), .pool_dis_free_multi_sts = gtmv(m, 1), .memory_corrupt_sts = gtmv(m, 1), .xoff_state_sts = gtmv(m, 1), .xon_state_sts = gtmv(m, 1), .illegal_address_access_sts = gtmv(m, 1), .illegal_alloc_request_sts = gtmv(m, 1), .expired_token_det_sts = gtmv(m, 1), .expired_token_recov_sts = gtmv(m, 1)};
        bdmf_session_print(session, "ag_drv_fpm_pool1_intr_sts_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n",
            pool1_intr_sts.alloc_fifo_full_sts, pool1_intr_sts.free_fifo_full_sts, pool1_intr_sts.pool_full_sts, pool1_intr_sts.free_token_no_valid_sts, 
            pool1_intr_sts.free_token_index_out_of_range_sts, pool1_intr_sts.multi_token_no_valid_sts, pool1_intr_sts.multi_token_index_out_of_range_sts, pool1_intr_sts.pool_dis_free_multi_sts, 
            pool1_intr_sts.memory_corrupt_sts, pool1_intr_sts.xoff_state_sts, pool1_intr_sts.xon_state_sts, pool1_intr_sts.illegal_address_access_sts, 
            pool1_intr_sts.illegal_alloc_request_sts, pool1_intr_sts.expired_token_det_sts, pool1_intr_sts.expired_token_recov_sts);
        ag_err = ag_drv_fpm_pool1_intr_sts_set(&pool1_intr_sts);
        if (!ag_err)
            ag_err = ag_drv_fpm_pool1_intr_sts_get(&pool1_intr_sts);
        ...
        if (pool1_intr_sts.alloc_fifo_full_sts != gtmv(m, 1) || pool1_intr_sts.free_fifo_full_sts != gtmv(m, 1) || pool1_intr_sts.pool_full_sts != gtmv(m, 1) || pool1_intr_sts.free_token_no_valid_sts != gtmv(m, 1) || pool1_intr_sts.free_token_index_out_of_range_sts != gtmv(m, 1) || pool1_intr_sts.multi_token_no_valid_sts != gtmv(m, 1) || pool1_intr_sts.multi_token_index_out_of_range_sts != gtmv(m, 1) || pool1_intr_sts.pool_dis_free_multi_sts != gtmv(m, 1) || pool1_intr_sts.memory_corrupt_sts != gtmv(m, 1) || pool1_intr_sts.xoff_state_sts != gtmv(m, 1) || pool1_intr_sts.xon_state_sts != gtmv(m, 1) || pool1_intr_sts.illegal_address_access_sts != gtmv(m, 1) || pool1_intr_sts.illegal_alloc_request_sts != gtmv(m, 1) || pool1_intr_sts.expired_token_det_sts != gtmv(m, 1) || pool1_intr_sts.expired_token_recov_sts != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
    ...
    {
        fpm_pool1_stall_msk pool1_stall_msk = {.free_token_no_valid_stall_msk = gtmv(m, 1), .free_token_index_out_of_range_stall_msk = gtmv(m, 1), .multi_token_no_valid_stall_msk = gtmv(m, 1), .multi_token_index_out_of_range_stall_msk = gtmv(m, 1), .memory_corrupt_stall_msk = gtmv(m, 1)};
        bdmf_session_print(session, "ag_drv_fpm_pool1_stall_msk_set( %u %u %u %u %u)\n",
            pool1_stall_msk.free_token_no_valid_stall_msk, pool1_stall_msk.free_token_index_out_of_range_stall_msk, pool1_stall_msk.multi_token_no_valid_stall_msk, pool1_stall_msk.multi_token_index_out_of_range_stall_msk, 
            pool1_stall_msk.memory_corrupt_stall_msk);
        ag_err = ag_drv_fpm_pool1_stall_msk_set(&pool1_stall_msk);
        if (!ag_err)
            ag_err = ag_drv_fpm_pool1_stall_msk_get(&pool1_stall_msk);
        ...
        if (pool1_stall_msk.free_token_no_valid_stall_msk != gtmv(m, 1) || pool1_stall_msk.free_token_index_out_of_range_stall_msk != gtmv(m, 1) || pool1_stall_msk.multi_token_no_valid_stall_msk != gtmv(m, 1) || pool1_stall_msk.multi_token_index_out_of_range_stall_msk != gtmv(m, 1) || pool1_stall_msk.memory_corrupt_stall_msk != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...
bdmfmon_handle_t ag_drv_fpm_cli_init(bdmfmon_handle_t root_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_pool1_intr_msk[] = {
        ...
        static bdmfmon_cmd_parm_t set_pool1_intr_sts[] = {
        ...
        static bdmfmon_cmd_parm_t set_pool1_stall_msk[] = {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name = "pool1_intr_msk", .val = cli_fpm_pool1_intr_msk, .parms = set_pool1_intr_msk },
            { .name = "pool1_intr_sts", .val = cli_fpm_pool1_intr_sts, .parms = set_pool1_intr_sts },
            { .name = "pool1_stall_msk", .val = cli_fpm_pool1_stall_msk, .parms = set_pool1_stall_msk },
