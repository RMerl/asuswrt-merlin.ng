...
/******************************************************************************
 * Register: NAME: RNR_QUAD_GENERAL_CONFIG_MULTI_PSEL_LOCK, TYPE: Type_RCQ_COMMON_REGS_RCQ_GENERAL_CONFIG_MULTI_PSEL_LOCK
 ******************************************************************************/

#if RU_INCLUDE_FIELD_DB
/***** Field: DISABLE_ACCESS_TO_MULTI_PSEL *****/
const ru_field_rec RNR_QUAD_GENERAL_CONFIG_MULTI_PSEL_LOCK_DISABLE_ACCESS_TO_MULTI_PSEL_FIELD =
{
    "DISABLE_ACCESS_TO_MULTI_PSEL",
#if RU_INCLUDE_DESC
    "",
    "If set to 1, access to multi_psel register (0xC8) is disabled. This register cannot be set back to 0.\n",
#endif
    { RNR_QUAD_GENERAL_CONFIG_MULTI_PSEL_LOCK_DISABLE_ACCESS_TO_MULTI_PSEL_FIELD_MASK },
    0,
    { RNR_QUAD_GENERAL_CONFIG_MULTI_PSEL_LOCK_DISABLE_ACCESS_TO_MULTI_PSEL_FIELD_WIDTH },
    { RNR_QUAD_GENERAL_CONFIG_MULTI_PSEL_LOCK_DISABLE_ACCESS_TO_MULTI_PSEL_FIELD_SHIFT },
    0,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
#endif
...
#if RU_INCLUDE_FIELD_DB
static const ru_field_rec *RNR_QUAD_GENERAL_CONFIG_MULTI_PSEL_LOCK_FIELDS[] =
{
    &RNR_QUAD_GENERAL_CONFIG_MULTI_PSEL_LOCK_DISABLE_ACCESS_TO_MULTI_PSEL_FIELD,
};
#endif /* RU_INCLUDE_FIELD_DB */

/***** Register struct: RNR_QUAD_GENERAL_CONFIG_MULTI_PSEL_LOCK *****/
const ru_reg_rec RNR_QUAD_GENERAL_CONFIG_MULTI_PSEL_LOCK_REG =
{
    "GENERAL_CONFIG_MULTI_PSEL_LOCK",
#if RU_INCLUDE_DESC
    "MULTI_PSEL_LOCK Register",
    "Lock multiple access register. Once the register is set to 1, it cannot be set back to 0 - only via reset.\n",
#endif
    { RNR_QUAD_GENERAL_CONFIG_MULTI_PSEL_LOCK_REG_OFFSET },
    0,
    0,
    956,
#if RU_INCLUDE_ACCESS
...
#if RU_INCLUDE_FIELD_DB
    1,
    RNR_QUAD_GENERAL_CONFIG_MULTI_PSEL_LOCK_FIELDS,
#endif
};
...
static const ru_reg_rec *RNR_QUAD_REGS[] =
{
    ...
    &RNR_QUAD_GENERAL_CONFIG_MULTI_PSEL_LOCK_REG,
