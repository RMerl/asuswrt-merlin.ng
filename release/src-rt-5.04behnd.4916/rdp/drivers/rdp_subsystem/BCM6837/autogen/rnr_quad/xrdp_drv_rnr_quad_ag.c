...
bdmf_error_t ag_drv_rnr_quad_general_config_multi_psel_cfg_set(uint8_t quad_idx, uint8_t multi_psel_master_sel, uint8_t multi_psel_mask)
{
    uint32_t reg_general_config_multi_psel_cfg = 0;

#ifdef VALIDATE_PARMS
    if ((quad_idx >= BLOCK_ADDR_COUNT) ||
       (multi_psel_master_sel >= _7BITS_MAX_VAL_) ||
       (multi_psel_mask >= _7BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
...
bdmf_error_t ag_drv_rnr_quad_general_config_multi_psel_cfg_get(uint8_t quad_idx, uint8_t *multi_psel_master_sel, uint8_t *multi_psel_mask)
{
...
bdmf_error_t ag_drv_rnr_quad_general_config_multi_psel_lock_set(uint8_t quad_idx, bdmf_boolean disable_access_to_multi_psel)
{
    uint32_t reg_general_config_multi_psel_lock = 0;

#ifdef VALIDATE_PARMS
    if ((quad_idx >= BLOCK_ADDR_COUNT) ||
       (disable_access_to_multi_psel >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_general_config_multi_psel_lock = RU_FIELD_SET(quad_idx, RNR_QUAD, GENERAL_CONFIG_MULTI_PSEL_LOCK, DISABLE_ACCESS_TO_MULTI_PSEL, reg_general_config_multi_psel_lock, disable_access_to_multi_psel);

    RU_REG_WRITE(quad_idx, RNR_QUAD, GENERAL_CONFIG_MULTI_PSEL_LOCK, reg_general_config_multi_psel_lock);

    return BDMF_ERR_OK;
}

bdmf_error_t ag_drv_rnr_quad_general_config_multi_psel_lock_get(uint8_t quad_idx, bdmf_boolean *disable_access_to_multi_psel)
{
    uint32_t reg_general_config_multi_psel_lock;

#ifdef VALIDATE_PARMS
    if (!disable_access_to_multi_psel)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    RU_REG_READ(quad_idx, RNR_QUAD, GENERAL_CONFIG_MULTI_PSEL_LOCK, reg_general_config_multi_psel_lock);

    *disable_access_to_multi_psel = RU_FIELD_GET(quad_idx, RNR_QUAD, GENERAL_CONFIG_MULTI_PSEL_LOCK, DISABLE_ACCESS_TO_MULTI_PSEL, reg_general_config_multi_psel_lock);
...
typedef enum
{
    ...
    bdmf_address_general_config_multi_psel_lock,
...
static int ag_drv_rnr_quad_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        rnr_quad_general_config_profiling_config general_config_profiling_config = { .counter_lsb_sel = parm[2].value.unumber, .enable_trace_core_0 = parm[3].value.unumber, .enable_trace_core_1 = parm[4].value.unumber, .enable_trace_core_2 = parm[5].value.unumber, .enable_trace_core_3 = parm[6].value.unumber, .enable_trace_core_4 = parm[7].value.unumber, .enable_trace_core_5 = parm[8].value.unumber, .enable_trace_core_6 = parm[9].value.unumber};
    ...
    case cli_rnr_quad_general_config_multi_psel_cfg:
        ...
        break;
    case cli_rnr_quad_general_config_multi_psel_lock:
        ag_err = ag_drv_rnr_quad_general_config_multi_psel_lock_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
...
int bcm_rnr_quad_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_rnr_quad_general_config_multi_psel_cfg:
    {
        uint8_t multi_psel_master_sel;
        uint8_t multi_psel_mask;
    ...
    case cli_rnr_quad_general_config_multi_psel_lock:
    {
        bdmf_boolean disable_access_to_multi_psel;
        ag_err = ag_drv_rnr_quad_general_config_multi_psel_lock_get(parm[1].value.unumber, &disable_access_to_multi_psel);
        bdmf_session_print(session, "disable_access_to_multi_psel = %u = 0x%x\n", disable_access_to_multi_psel, disable_access_to_multi_psel);
        break;
    }
    case cli_rnr_quad_debug_fifo_config:
    {
...
static int ag_drv_rnr_quad_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        rnr_quad_general_config_profiling_config general_config_profiling_config = {.counter_lsb_sel = gtmv(m, 5), .enable_trace_core_0 = gtmv(m, 1), .enable_trace_core_1 = gtmv(m, 1), .enable_trace_core_2 = gtmv(m, 1), .enable_trace_core_3 = gtmv(m, 1), .enable_trace_core_4 = gtmv(m, 1), .enable_trace_core_5 = gtmv(m, 1), .enable_trace_core_6 = gtmv(m, 1)};
        bdmf_session_print(session, "ag_drv_rnr_quad_general_config_profiling_config_set(%u %u %u %u %u %u %u %u %u)\n", quad_idx,
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_rnr_quad_general_config_profiling_config_get(%u %u %u %u %u %u %u %u %u)\n", quad_idx,
                general_config_profiling_config.counter_lsb_sel, general_config_profiling_config.enable_trace_core_0, general_config_profiling_config.enable_trace_core_1, general_config_profiling_config.enable_trace_core_2, 
                general_config_profiling_config.enable_trace_core_3, general_config_profiling_config.enable_trace_core_4, general_config_profiling_config.enable_trace_core_5, general_config_profiling_config.enable_trace_core_6);
        }
        else
        ...
        if (general_config_profiling_config.counter_lsb_sel != gtmv(m, 5) || general_config_profiling_config.enable_trace_core_0 != gtmv(m, 1) || general_config_profiling_config.enable_trace_core_1 != gtmv(m, 1) || general_config_profiling_config.enable_trace_core_2 != gtmv(m, 1) || general_config_profiling_config.enable_trace_core_3 != gtmv(m, 1) || general_config_profiling_config.enable_trace_core_4 != gtmv(m, 1) || general_config_profiling_config.enable_trace_core_5 != gtmv(m, 1) || general_config_profiling_config.enable_trace_core_6 != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
    ...
    {
        rnr_quad_general_config_powersave_config general_config_powersave_config = {.time_counter = gtmv(m, 8), .enable_powersave_core_0 = gtmv(m, 1), .enable_powersave_core_1 = gtmv(m, 1), .enable_powersave_core_2 = gtmv(m, 1), .enable_powersave_core_3 = gtmv(m, 1), .enable_powersave_core_4 = gtmv(m, 1), .enable_powersave_core_5 = gtmv(m, 1), .enable_powersave_core_6 = gtmv(m, 1), .enable_cpu_if_clk_gating = gtmv(m, 1), .enable_common_reg_clk_gating = gtmv(m, 1), .enable_ec_blocks_clk_gating = gtmv(m, 1)};
        bdmf_session_print(session, "ag_drv_rnr_quad_general_config_powersave_config_set(%u %u %u %u %u %u %u %u %u %u %u %u)\n", quad_idx,
            ...
            general_config_powersave_config.enable_cpu_if_clk_gating, general_config_powersave_config.enable_common_reg_clk_gating, general_config_powersave_config.enable_ec_blocks_clk_gating);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_rnr_quad_general_config_powersave_config_get(%u %u %u %u %u %u %u %u %u %u %u %u)\n", quad_idx,
                general_config_powersave_config.time_counter, general_config_powersave_config.enable_powersave_core_0, general_config_powersave_config.enable_powersave_core_1, general_config_powersave_config.enable_powersave_core_2, 
                general_config_powersave_config.enable_powersave_core_3, general_config_powersave_config.enable_powersave_core_4, general_config_powersave_config.enable_powersave_core_5, general_config_powersave_config.enable_powersave_core_6, 
                general_config_powersave_config.enable_cpu_if_clk_gating, general_config_powersave_config.enable_common_reg_clk_gating, general_config_powersave_config.enable_ec_blocks_clk_gating);
        }
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_rnr_quad_general_config_powersave_status_get(%u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", quad_idx,
                ...
                general_config_powersave_status.acc_status_4, general_config_powersave_status.acc_status_5, general_config_powersave_status.acc_status_6, general_config_powersave_status.core_status_0, 
                general_config_powersave_status.core_status_1, general_config_powersave_status.core_status_2, general_config_powersave_status.core_status_3, general_config_powersave_status.core_status_4, 
                general_config_powersave_status.core_status_5, general_config_powersave_status.core_status_6);
        }
    }
    ...
    {
        uint8_t multi_psel_master_sel = gtmv(m, 7);
        uint8_t multi_psel_mask = gtmv(m, 7);
        ...
        if (multi_psel_master_sel != gtmv(m, 7) || multi_psel_mask != gtmv(m, 7))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
    ...
    {
        bdmf_boolean disable_access_to_multi_psel = gtmv(m, 1);
        bdmf_session_print(session, "ag_drv_rnr_quad_general_config_multi_psel_lock_set(%u %u)\n", quad_idx,
            disable_access_to_multi_psel);
        ag_err = ag_drv_rnr_quad_general_config_multi_psel_lock_set(quad_idx, disable_access_to_multi_psel);
        if (!ag_err)
            ag_err = ag_drv_rnr_quad_general_config_multi_psel_lock_get(quad_idx, &disable_access_to_multi_psel);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_rnr_quad_general_config_multi_psel_lock_get(%u %u)\n", quad_idx,
                disable_access_to_multi_psel);
        }
        else
        {
        ...
        if (disable_access_to_multi_psel != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...
static int ag_drv_rnr_quad_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case bdmf_address_general_config_multi_psel_lock: reg = &RU_REG(RNR_QUAD, GENERAL_CONFIG_MULTI_PSEL_LOCK); blk = &RU_BLK(RNR_QUAD); break;
...
bdmfmon_handle_t ag_drv_rnr_quad_cli_init(bdmfmon_handle_t root_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_general_config_multi_psel_lock[] = {
            BDMFMON_MAKE_PARM("quad_idx", "quad_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("disable_access_to_multi_psel", "disable_access_to_multi_psel", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name = "general_config_multi_psel_lock", .val = cli_rnr_quad_general_config_multi_psel_lock, .parms = set_general_config_multi_psel_lock },
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name = "general_config_multi_psel_lock", .val = cli_rnr_quad_general_config_multi_psel_lock, .parms = get_default },
...
#ifdef HAL_DRV_TEST_ENABLE
    {
        static bdmfmon_enum_val_t enum_table_address[] = {
            ...
            { .name = "GENERAL_CONFIG_MULTI_PSEL_LOCK", .val = bdmf_address_general_config_multi_psel_lock },
