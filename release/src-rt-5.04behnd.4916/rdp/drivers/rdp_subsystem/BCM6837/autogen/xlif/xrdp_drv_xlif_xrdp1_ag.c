...
bdmf_error_t ag_drv_xlif_xrdp1_channel_xlif_tx_if_loopback_set(uint8_t channel_id, bdmf_boolean xlmac_rx2tx, bdmf_boolean bbh_rx2tx)
{
    ...
    reg_channel_xlif_tx_if_loopback = RU_FIELD_SET(channel_id, XLIF_XRDP1, CHANNEL_XLIF_TX_IF_LOOPBACK, XLMAC_RX2TX, reg_channel_xlif_tx_if_loopback, xlmac_rx2tx);
    reg_channel_xlif_tx_if_loopback = RU_FIELD_SET(channel_id, XLIF_XRDP1, CHANNEL_XLIF_TX_IF_LOOPBACK, BBH_RX2TX, reg_channel_xlif_tx_if_loopback, bbh_rx2tx);

    RU_REG_WRITE(channel_id, XLIF_XRDP1, CHANNEL_XLIF_TX_IF_LOOPBACK, reg_channel_xlif_tx_if_loopback);
...
bdmf_error_t ag_drv_xlif_xrdp1_channel_xlif_tx_if_loopback_get(uint8_t channel_id, bdmf_boolean *xlmac_rx2tx, bdmf_boolean *bbh_rx2tx)
{
    ...
    RU_REG_READ(channel_id, XLIF_XRDP1, CHANNEL_XLIF_TX_IF_LOOPBACK, reg_channel_xlif_tx_if_loopback);

    *xlmac_rx2tx = RU_FIELD_GET(channel_id, XLIF_XRDP1, CHANNEL_XLIF_TX_IF_LOOPBACK, XLMAC_RX2TX, reg_channel_xlif_tx_if_loopback);
    *bbh_rx2tx = RU_FIELD_GET(channel_id, XLIF_XRDP1, CHANNEL_XLIF_TX_IF_LOOPBACK, BBH_RX2TX, reg_channel_xlif_tx_if_loopback);
...
static int ag_drv_xlif_xrdp1_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_xlif_xrdp1_channel_xlif_tx_if_tdm_mode:
        ...
        break;
    case cli_xlif_xrdp1_channel_xlif_tx_if_loopback:
        ag_err = ag_drv_xlif_xrdp1_channel_xlif_tx_if_loopback_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber);
        break;
...
int bcm_xlif_xrdp1_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_xlif_xrdp1_channel_xlif_tx_if_loopback:
    {
        ...
        ag_err = ag_drv_xlif_xrdp1_channel_xlif_tx_if_loopback_get(parm[1].value.unumber, &xlmac_rx2tx, &bbh_rx2tx);
...
static int ag_drv_xlif_xrdp1_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
...

    {
        ...
        bdmf_session_print(session, "ag_drv_xlif_xrdp1_channel_xlif_tx_if_loopback_set(%u %u %u)\n", channel_id,
            xlmac_rx2tx, bbh_rx2tx);
        ag_err = ag_drv_xlif_xrdp1_channel_xlif_tx_if_loopback_set(channel_id, xlmac_rx2tx, bbh_rx2tx);
        if (!ag_err)
            ag_err = ag_drv_xlif_xrdp1_channel_xlif_tx_if_loopback_get(channel_id, &xlmac_rx2tx, &bbh_rx2tx);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_xlif_xrdp1_channel_xlif_tx_if_loopback_get(%u %u %u)\n", channel_id,
                xlmac_rx2tx, bbh_rx2tx);
        }
        else
        {
...
static int ag_drv_xlif_xrdp1_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case bdmf_address_channel_xlif_tx_if_loopback: reg = &RU_REG(XLIF_XRDP1, CHANNEL_XLIF_TX_IF_LOOPBACK); blk = &RU_BLK(XLIF_XRDP1); break;
...
bdmfmon_handle_t ag_drv_xlif_xrdp1_cli_init(bdmfmon_handle_t root_dir)
{
...

    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name = "channel_xlif_tx_if_loopback", .val = cli_xlif_xrdp1_channel_xlif_tx_if_loopback, .parms = set_channel_xlif_tx_if_loopback },
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name = "channel_xlif_tx_if_loopback", .val = cli_xlif_xrdp1_channel_xlif_tx_if_loopback, .parms = get_default },
