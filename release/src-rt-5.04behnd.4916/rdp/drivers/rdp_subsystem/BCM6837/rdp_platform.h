...
/* XLIF */
#define XLIF0_ACTIVE_CHANNELS 1
...
CNPL_PERIODIC_UPDATE_QUANTA_NS is 21845 */

#define CNPL_PERIODIC_UPDATE_US    2796  /*n = 7*/
...
#define IS_PROCESSING_RUNNER_IMAGE(i)  ((rdp_core_to_image_map[i] == processing0_runner_image) || (rdp_core_to_image_map[i] == processing1_runner_image)|| (rdp_core_to_image_map[i] == processing2_runner_image) || (rdp_core_to_image_map[i] == processing3_runner_image) || (rdp_core_to_image_map[i] == processing5_runner_image))
...
#define HASH_MODE hash_mode_crc32_high
...
#define BBH_TX_GPON_PD_WAKE_UP_TH 12
...
#define DMA_AVAIL_CHUNKS 32
#define DMA_CHUNKS_1GB 4
#define DMA_CHUNKS_2_5GB 5
#define DMA_CHUNKS_5GB 8
#define DMA_CHUNKS_10GB 10
...
#define DISP_REOR_VIQ_BBH_RX_ETH_MAX_NUM DISP_REOR_VIQ_BBH_RX8_NORMAL
...
#define SERVICE_QUEUES_THREAD_NUMBER IMAGE_3_IMAGE_3_SERVICE_QUEUES_THREAD_NUMBER

#define RC_MAX_PMC_CORES 4
#endif
