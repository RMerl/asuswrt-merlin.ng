...
#define MAX_TX_QUEUES__NUM_OF             288
...
#define SBPM_INIT_OFFSET                    (SBPM_MAX_BUFFER_NUMBER - RDPA_MAX_TUNNELS)  /* last buffers used for tunneling */
...
#define RDP_TCAM_TABLE_SIZE     1024
...
#define DISP_REOR_VIQ_BBH_PON_RX_EXCL DISP_REOR_VIQ_BBH_RX8_EXCL
