...
#if RU_INCLUDE_FIELD_DB
/***** Field: CRCDROP *****/
const ru_field_rec BBH_TX_COMMON_CONFIGURATIONS_GENERAL_CFG_CRCDROP_FIELD =
{
    "CRCDROP",
#if RU_INCLUDE_DESC
    "",
    "when asserted, the BBH TX will drop the 4 bytes of CRC before sending the data to the MAC\n",
#endif
    { BBH_TX_COMMON_CONFIGURATIONS_GENERAL_CFG_CRCDROP_FIELD_MASK },
    0,
    { BBH_TX_COMMON_CONFIGURATIONS_GENERAL_CFG_CRCDROP_FIELD_WIDTH },
    { BBH_TX_COMMON_CONFIGURATIONS_GENERAL_CFG_CRCDROP_FIELD_SHIFT },
    0,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
#endif
...
static const ru_field_rec *BBH_TX_COMMON_CONFIGURATIONS_GENERAL_CFG_FIELDS[] =
{
    ...
    &BBH_TX_COMMON_CONFIGURATIONS_GENERAL_CFG_CRCDROP_FIELD,
