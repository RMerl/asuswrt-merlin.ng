...
bdmf_error_t ag_drv_bbh_tx_common_configurations_general_cfg_set(uint8_t bbh_id, const bbh_tx_common_configurations_general_cfg *common_configurations_general_cfg)
{
    ...
    if ((bbh_id >= BLOCK_ADDR_COUNT) ||
       ...
       (common_configurations_general_cfg->crcdrop >= _1BITS_MAX_VAL_) ||
    ...
    reg_common_configurations_general_cfg = RU_FIELD_SET(bbh_id, BBH_TX, COMMON_CONFIGURATIONS_GENERAL_CFG, CRCDROP, reg_common_configurations_general_cfg, common_configurations_general_cfg->crcdrop);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_general_cfg_get(uint8_t bbh_id, bbh_tx_common_configurations_general_cfg *common_configurations_general_cfg)
{
    ...
    common_configurations_general_cfg->crcdrop = RU_FIELD_GET(bbh_id, BBH_TX, COMMON_CONFIGURATIONS_GENERAL_CFG, CRCDROP, reg_common_configurations_general_cfg);
...
static int ag_drv_bbh_tx_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        bbh_tx_common_configurations_general_cfg common_configurations_general_cfg = { .dsdma = parm[2].value.unumber, .agg640 = parm[3].value.unumber, .pair256 = parm[4].value.unumber, .macdrop = parm[5].value.unumber, .embhdr = parm[6].value.unumber, .ecnrmrk = parm[7].value.unumber, .crcdrop = parm[8].value.unumber, .dblsop = parm[9].value.unumber, .fpmini = parm[10].value.unumber, .crdtfix = parm[11].value.unumber, .discopycrdt = parm[12].value.unumber};
...
int bcm_bbh_tx_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_bbh_tx_common_configurations_general_cfg:
    {
        ...
        bdmf_session_print(session, "crcdrop = %u = 0x%x\n", common_configurations_general_cfg.crcdrop, common_configurations_general_cfg.crcdrop);
...
static int ag_drv_bbh_tx_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        bbh_tx_common_configurations_general_cfg common_configurations_general_cfg = {.dsdma = gtmv(m, 1), .agg640 = gtmv(m, 1), .pair256 = gtmv(m, 1), .macdrop = gtmv(m, 1), .embhdr = gtmv(m, 1), .ecnrmrk = gtmv(m, 1), .crcdrop = gtmv(m, 1), .dblsop = gtmv(m, 1), .fpmini = gtmv(m, 1), .crdtfix = gtmv(m, 1), .discopycrdt = gtmv(m, 1)};
        bdmf_session_print(session, "ag_drv_bbh_tx_common_configurations_general_cfg_set(%u %u %u %u %u %u %u %u %u %u %u %u)\n", bbh_id,
            ...
            common_configurations_general_cfg.embhdr, common_configurations_general_cfg.ecnrmrk, common_configurations_general_cfg.crcdrop, common_configurations_general_cfg.dblsop, 
        ...
        if (common_configurations_general_cfg.dsdma != gtmv(m, 1) || common_configurations_general_cfg.agg640 != gtmv(m, 1) || common_configurations_general_cfg.pair256 != gtmv(m, 1) || common_configurations_general_cfg.macdrop != gtmv(m, 1) || common_configurations_general_cfg.embhdr != gtmv(m, 1) || common_configurations_general_cfg.ecnrmrk != gtmv(m, 1) || common_configurations_general_cfg.crcdrop != gtmv(m, 1) || common_configurations_general_cfg.dblsop != gtmv(m, 1) || common_configurations_general_cfg.fpmini != gtmv(m, 1) || common_configurations_general_cfg.crdtfix != gtmv(m, 1) || common_configurations_general_cfg.discopycrdt != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...
bdmfmon_handle_t ag_drv_bbh_tx_cli_init(bdmfmon_handle_t root_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_common_configurations_general_cfg[] = {
            ...
            BDMFMON_MAKE_PARM("crcdrop", "crcdrop", BDMFMON_PARM_UNUMBER, 0),
