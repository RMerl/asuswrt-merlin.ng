 ...
 *     Valid Token Indicator
 *     0: No buffers available
 *     1: A valid token index is provided. If a token multi-cast value is updated without this bit set, that causes an
 *     error and the token will be ignored, error counter in register offset 0xBC will be incremented.
 *     
 **********************************************************************************************************************/
...
enum
{
    ...
    cli_fpm_pool3_intr_msk,
    cli_fpm_pool3_intr_sts,
    cli_fpm_pool3_stall_msk,
    cli_fpm_pool1_cfg4,
    cli_fpm_pool1_stat5,
    cli_fpm_pool2_stat1,
    cli_fpm_pool2_stat2,
    ...
    cli_fpm_pool_multi,
    cli_fpm_pool1_alloc_dealloc_1,
    cli_fpm_pool2_alloc_dealloc_1,
    cli_fpm_pool3_alloc_dealloc_1,
    cli_fpm_pool4_alloc_dealloc_1,
    cli_fpm_pool_multi_1,
