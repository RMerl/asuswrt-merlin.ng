...
#ifndef _XRDP_DRV_FPM_FPMINI_AG_H_
#define _XRDP_DRV_FPM_FPMINI_AG_H_
...
} fpm_fpmini_fpmini_prfm_cntrs_gen_cfg;
...
enum
{
    cli_fpm_fpmini_fpmini_lvl_0_reg_l0,
    cli_fpm_fpmini_fpmini_cfg0_l2_init,
    cli_fpm_fpmini_fpmini_cfg0_allc_fast_ack,
    cli_fpm_fpmini_fpmini_prfm_cntrs_num_avail_tkns,
    cli_fpm_fpmini_fpmini_prfm_cntrs_num_avail_tkns_low_wm,
    cli_fpm_fpmini_fpmini_prfm_cntrs_free_err,
    cli_fpm_fpmini_fpmini_prfm_cntrs_gen_cfg,
    cli_fpm_fpmini_fpmini_debug_dbgsel,
    cli_fpm_fpmini_fpmini_debug_dbgbus,
    cli_fpm_fpmini_fpmcast_cfg0_mc_init,
    cli_fpm_fpmini_fpmcast_cfg0_free_bp_mc,
    cli_fpm_fpmini_fpmcast_prfm_cntrs_mc_inc_err,
    cli_fpm_fpmini_fpmcast_prfm_cntrs_mc_dec_err,
    cli_fpm_fpmini_fpmcast_debug_dbgsel,
    cli_fpm_fpmini_fpmcast_debug_dbgbus,
};
