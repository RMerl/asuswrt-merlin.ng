...
bdmf_error_t ag_drv_hash_lkup_tbl_cfg_tbl_cfg_set(uint8_t tbl_idx, const hash_lkup_tbl_cfg_tbl_cfg *lkup_tbl_cfg_tbl_cfg)
{
    ...
    if ((tbl_idx >= 7) ||
       ...
       (lkup_tbl_cfg_tbl_cfg->tbl_size >= _4BITS_MAX_VAL_) ||
...
{
    uint32_t reg_cam_configuration_tm_cfg = 0;

#ifdef VALIDATE_PARMS
#endif

    reg_cam_configuration_tm_cfg = RU_FIELD_SET(0, HASH, CAM_CONFIGURATION_TM_CFG, VAL, reg_cam_configuration_tm_cfg, val);

    RU_REG_WRITE(0, HASH, CAM_CONFIGURATION_TM_CFG, reg_cam_configuration_tm_cfg);
...
{
    uint32_t reg_cam_configuration_tm_cfg;
    ...
    RU_REG_READ(0, HASH, CAM_CONFIGURATION_TM_CFG, reg_cam_configuration_tm_cfg);

    *val = RU_FIELD_GET(0, HASH, CAM_CONFIGURATION_TM_CFG, VAL, reg_cam_configuration_tm_cfg);
...
bdmf_error_t ag_drv_hash_aging_ram_aging_set(uint16_t entry_idx, bdmf_boolean age)
{
    ...
    reg_aging_ram_aging = RU_FLD_VAL_SET(reg_aging_ram_aging, 0x1 << (entry_idx % 32), entry_idx % 32, age);
...
bdmf_error_t ag_drv_hash_aging_ram_aging_get(uint16_t entry_idx, bdmf_boolean *age)
{
    ...
    *age = RU_FLD_VAL_GET(reg_aging_ram_aging, 0x1 << (entry_idx % 32), entry_idx % 32);
...
typedef enum
{
    ...
    bdmf_address_cam_configuration_tm_cfg,
...
static int ag_drv_hash_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    bdmf_error_t ag_err;
    ...
    case cli_hash_key_padding:
        ag_err = ag_drv_hash_key_padding_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_hash_mask:
    {
        hash_mask mask = { .maskl = parm[2].value.unumber, .maskh = parm[3].value.unumber};
        ag_err = ag_drv_hash_mask_set(parm[1].value.unumber, &mask);
        break;
    }
    case cli_hash_general_configuration_pwr_sav_en:
        ag_err = ag_drv_hash_general_configuration_pwr_sav_en_set(parm[1].value.unumber);
        break;
    case cli_hash_general_configuration_undo_fix:
        ag_err = ag_drv_hash_general_configuration_undo_fix_set(parm[1].value.unumber);
        break;
    case cli_hash_pm_counters_frz_cnt:
        ag_err = ag_drv_hash_pm_counters_frz_cnt_set(parm[1].value.unumber);
        break;
    case cli_hash_lkup_tbl_cfg_tbl_cfg:
    {
        ...
        ag_err = ag_drv_hash_lkup_tbl_cfg_tbl_cfg_set(parm[1].value.unumber, &lkup_tbl_cfg_tbl_cfg);
        break;
    }
    case cli_hash_lkup_tbl_cfg_cntxt_cfg:
    {
        ...
        ag_err = ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_set(parm[1].value.unumber, &lkup_tbl_cfg_cntxt_cfg);
        break;
    }
    case cli_hash_cam_base_addr:
        ag_err = ag_drv_hash_cam_base_addr_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_configuration_tm_cfg:
        ag_err = ag_drv_hash_cam_configuration_tm_cfg_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_indirect_op:
        ag_err = ag_drv_hash_cam_indirect_op_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_indirect_addr:
        ag_err = ag_drv_hash_cam_indirect_addr_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_hash_cam_indirect_vlid_in:
        ag_err = ag_drv_hash_cam_indirect_vlid_in_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_indirect_vlid_out:
        ag_err = ag_drv_hash_cam_indirect_vlid_out_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_indirect_key_in:
    {
        ...
        ag_err = ag_drv_hash_cam_indirect_key_in_set(parm[1].value.unumber, &cam_indirect_key_in);
        break;
    }
    case cli_hash_cam_bist_bist_dbg_compare_en:
        ag_err = ag_drv_hash_cam_bist_bist_dbg_compare_en_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_bist_bist_dbg_data:
        ag_err = ag_drv_hash_cam_bist_bist_dbg_data_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_bist_bist_dbg_data_slice_or_status_sel:
        ag_err = ag_drv_hash_cam_bist_bist_dbg_data_slice_or_status_sel_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_bist_bist_dbg_data_valid:
        ag_err = ag_drv_hash_cam_bist_bist_dbg_data_valid_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_bist_bist_en:
        ag_err = ag_drv_hash_cam_bist_bist_en_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_bist_bist_mode:
        ag_err = ag_drv_hash_cam_bist_bist_mode_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_bist_bist_rst_l:
        ag_err = ag_drv_hash_cam_bist_bist_rst_l_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_bist_bist_skip_error_cnt:
        ag_err = ag_drv_hash_cam_bist_bist_skip_error_cnt_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_bist_dbg_en:
        ag_err = ag_drv_hash_cam_bist_dbg_en_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_bist_bist_cascade_select:
        ag_err = ag_drv_hash_cam_bist_bist_cascade_select_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_bist_bist_block_select:
        ag_err = ag_drv_hash_cam_bist_bist_block_select_set(parm[1].value.unumber);
        break;
    case cli_hash_cam_bist_bist_repair_enable:
        ag_err = ag_drv_hash_cam_bist_bist_repair_enable_set(parm[1].value.unumber);
        break;
    case cli_hash_intr_ctrl_isr:
    {
        ...
        ag_err = ag_drv_hash_intr_ctrl_isr_set(&intr_ctrl_isr);
        break;
    }
    case cli_hash_intr_ctrl_ier:
        ag_err = ag_drv_hash_intr_ctrl_ier_set(parm[1].value.unumber);
        break;
    case cli_hash_intr_ctrl_itr:
        ag_err = ag_drv_hash_intr_ctrl_itr_set(parm[1].value.unumber);
        break;
    case cli_hash_debug_dbg_sel:
        ag_err = ag_drv_hash_debug_dbg_sel_set(parm[1].value.unumber);
        break;
    case cli_hash_aging_ram_aging:
        ag_err = ag_drv_hash_aging_ram_aging_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_hash_context_ram_context_47_24:
        ag_err = ag_drv_hash_context_ram_context_47_24_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_hash_context_ram_context_23_0:
        ag_err = ag_drv_hash_context_ram_context_23_0_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_hash_ram_eng_high:
        ag_err = ag_drv_hash_ram_eng_high_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_hash_ram_eng_low:
        ag_err = ag_drv_hash_ram_eng_low_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber, parm[5].value.unumber);
        break;
    default:
...
int bcm_hash_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_hash_key_padding:
    {
        uint32_t key_pad_h;
        uint32_t key_pad_l;
        ag_err = ag_drv_hash_key_padding_get(&key_pad_h, &key_pad_l);
    ...
    {
        hash_mask mask;
        ag_err = ag_drv_hash_mask_get(parm[1].value.unumber, &mask);
    ...
    {
        bdmf_boolean value;
        ag_err = ag_drv_hash_general_configuration_pwr_sav_en_get(&value);
    ...
    {
        uint8_t val;
        ag_err = ag_drv_hash_general_configuration_mult_hit_err_get(&val);
    ...
    case cli_hash_general_configuration_undo_fix:
    {
        ...
        ag_err = ag_drv_hash_general_configuration_undo_fix_get(&frst_mul_hit);
    ...
    {
        uint32_t cnt;
        ag_err = ag_drv_hash_pm_counters_hits_get(&cnt);
    ...
    {
        uint32_t cnt;
        ag_err = ag_drv_hash_pm_counters_srchs_get(&cnt);
        bdmf_session_print(session, "cnt = %u = 0x%x\n", cnt, cnt);
        break;
    }
    ...
    {
        uint32_t cnt;
        ag_err = ag_drv_hash_pm_counters_miss_get(&cnt);
        bdmf_session_print(session, "cnt = %u = 0x%x\n", cnt, cnt);
        break;
    }
    ...
    {
        uint32_t cnt;
        ag_err = ag_drv_hash_pm_counters_hit_1st_acs_get(&cnt);
        bdmf_session_print(session, "cnt = %u = 0x%x\n", cnt, cnt);
        break;
    }
    ...
    {
        uint32_t cnt;
        ag_err = ag_drv_hash_pm_counters_hit_2nd_acs_get(&cnt);
        bdmf_session_print(session, "cnt = %u = 0x%x\n", cnt, cnt);
        break;
    }
    ...
    {
        uint32_t cnt;
        ag_err = ag_drv_hash_pm_counters_hit_3rd_acs_get(&cnt);
        bdmf_session_print(session, "cnt = %u = 0x%x\n", cnt, cnt);
        break;
    }
    ...
    {
        uint32_t cnt;
        ag_err = ag_drv_hash_pm_counters_hit_4th_acs_get(&cnt);
        bdmf_session_print(session, "cnt = %u = 0x%x\n", cnt, cnt);
        break;
    }
    case cli_hash_pm_counters_frz_cnt:
    {
        bdmf_boolean val;
        ag_err = ag_drv_hash_pm_counters_frz_cnt_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    case cli_hash_lkup_tbl_cfg_tbl_cfg:
    {
        ...
        ag_err = ag_drv_hash_lkup_tbl_cfg_tbl_cfg_get(parm[1].value.unumber, &lkup_tbl_cfg_tbl_cfg);
    ...
    case cli_hash_lkup_tbl_cfg_cntxt_cfg:
    {
        ...
        ag_err = ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_get(parm[1].value.unumber, &lkup_tbl_cfg_cntxt_cfg);
    ...
    case cli_hash_cam_base_addr:
    {
        ...
        ag_err = ag_drv_hash_cam_base_addr_get(&base_address);
    ...
    {
        uint16_t val;
        ag_err = ag_drv_hash_cam_configuration_tm_cfg_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    case cli_hash_cam_indirect_op:
    {
        uint8_t cmd;
        ag_err = ag_drv_hash_cam_indirect_op_get(&cmd);
    ...
    {
        bdmf_boolean val;
        ag_err = ag_drv_hash_cam_indirect_op_done_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    case cli_hash_cam_indirect_addr:
    {
        ...
        uint8_t entry_addr;
        ag_err = ag_drv_hash_cam_indirect_addr_get(&key1_ind, &entry_addr);
    ...
    {
        bdmf_boolean valid;
        ag_err = ag_drv_hash_cam_indirect_vlid_in_get(&valid);
    ...
    {
        bdmf_boolean valid;
        ag_err = ag_drv_hash_cam_indirect_vlid_out_get(&valid);
        bdmf_session_print(session, "valid = %u = 0x%x\n", valid, valid);
        break;
    }
    case cli_hash_cam_indirect_rslt:
    {
        bdmf_boolean match;
        uint8_t index;
        ag_err = ag_drv_hash_cam_indirect_rslt_get(&match, &index);
    ...
    case cli_hash_cam_indirect_key_in:
    {
        ...
        ag_err = ag_drv_hash_cam_indirect_key_in_get(parm[1].value.unumber, &cam_indirect_key_in);
    ...
    case cli_hash_cam_indirect_key_out:
    {
        ...
        ag_err = ag_drv_hash_cam_indirect_key_out_get(parm[1].value.unumber, &cam_indirect_key_out);
    ...
    {
        uint32_t value;
        ag_err = ag_drv_hash_cam_bist_bist_status_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_cam_bist_bist_dbg_compare_en:
    {
        bdmf_boolean value;
        ag_err = ag_drv_hash_cam_bist_bist_dbg_compare_en_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_cam_bist_bist_dbg_data:
    {
        uint32_t value;
        ag_err = ag_drv_hash_cam_bist_bist_dbg_data_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_cam_bist_bist_dbg_data_slice_or_status_sel:
    {
        uint8_t value;
        ag_err = ag_drv_hash_cam_bist_bist_dbg_data_slice_or_status_sel_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_cam_bist_bist_dbg_data_valid:
    {
        bdmf_boolean value;
        ag_err = ag_drv_hash_cam_bist_bist_dbg_data_valid_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_cam_bist_bist_en:
    {
        uint16_t value;
        ag_err = ag_drv_hash_cam_bist_bist_en_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_cam_bist_bist_mode:
    {
        uint8_t value;
        ag_err = ag_drv_hash_cam_bist_bist_mode_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_cam_bist_bist_rst_l:
    {
        bdmf_boolean value;
        ag_err = ag_drv_hash_cam_bist_bist_rst_l_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_cam_bist_bist_skip_error_cnt:
    {
        uint8_t value;
        ag_err = ag_drv_hash_cam_bist_bist_skip_error_cnt_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_cam_bist_dbg_en:
    {
        uint16_t value;
        ag_err = ag_drv_hash_cam_bist_dbg_en_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_cam_bist_bist_cascade_select:
    {
        uint8_t value;
        ag_err = ag_drv_hash_cam_bist_bist_cascade_select_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_cam_bist_bist_block_select:
    {
        uint8_t value;
        ag_err = ag_drv_hash_cam_bist_bist_block_select_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_cam_bist_bist_repair_enable:
    {
        bdmf_boolean value;
        ag_err = ag_drv_hash_cam_bist_bist_repair_enable_get(&value);
        bdmf_session_print(session, "value = %u = 0x%x\n", value, value);
        break;
    }
    case cli_hash_intr_ctrl_isr:
    {
        ...
        ag_err = ag_drv_hash_intr_ctrl_isr_get(&intr_ctrl_isr);
    ...
    {
        uint32_t ism;
        ag_err = ag_drv_hash_intr_ctrl_ism_get(&ism);
    ...
    {
        uint32_t iem;
        ag_err = ag_drv_hash_intr_ctrl_ier_get(&iem);
    ...
    {
        uint32_t ist;
        ag_err = ag_drv_hash_intr_ctrl_itr_get(&ist);
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg0_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg1_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg2_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg3_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg4_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg5_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg6_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg7_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg8_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg9_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg10_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg11_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg12_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg13_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg14_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg15_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg16_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg17_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg18_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg19_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    ...
    {
        uint32_t val;
        ag_err = ag_drv_hash_debug_dbg20_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    case cli_hash_debug_dbg_sel:
    {
        uint8_t val;
        ag_err = ag_drv_hash_debug_dbg_sel_get(&val);
        bdmf_session_print(session, "val = %u = 0x%x\n", val, val);
        break;
    }
    case cli_hash_aging_ram_aging:
    {
        bdmf_boolean age;
        ag_err = ag_drv_hash_aging_ram_aging_get(parm[1].value.unumber, &age);
    ...
    {
        uint32_t bits;
        ag_err = ag_drv_hash_context_ram_context_47_24_get(parm[1].value.unumber, &bits);
    ...
    {
        uint32_t bits;
        ag_err = ag_drv_hash_context_ram_context_23_0_get(parm[1].value.unumber, &bits);
        bdmf_session_print(session, "bits = %u = 0x%x\n", bits, bits);
        break;
    }
    case cli_hash_ram_eng_high:
    {
        ...
        ag_err = ag_drv_hash_ram_eng_high_get(parm[1].value.unumber, &key_59_28_or_dat);
    ...
    case cli_hash_ram_eng_low:
    {
        ...
        ag_err = ag_drv_hash_ram_eng_low_get(parm[1].value.unumber, &skp, &cfg, &key_11_0, &key_27_12_or_dat);
...
static int ag_drv_hash_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_key_padding_set( %u %u)\n",
            key_pad_h, key_pad_l);
        ag_err = ag_drv_hash_key_padding_set(key_pad_h, key_pad_l);
        if (!ag_err)
            ag_err = ag_drv_hash_key_padding_get(&key_pad_h, &key_pad_l);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_key_padding_get( %u %u)\n",
                key_pad_h, key_pad_l);
        }
        else
        {
        ...
        if (key_pad_h != gtmv(m, 28) || key_pad_l != gtmv(m, 32))
        {
            test_failure_cnt++;
    ...
    {
        uint8_t tbl_idx = gtmv(m, 2);
        hash_mask mask = {.maskl = gtmv(m, 32), .maskh = gtmv(m, 28)};
        bdmf_session_print(session, "ag_drv_hash_mask_set( %u %u %u)\n", tbl_idx,
            mask.maskl, mask.maskh);
        ag_err = ag_drv_hash_mask_set(tbl_idx, &mask);
        if (!ag_err)
            ag_err = ag_drv_hash_mask_get(tbl_idx, &mask);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_mask_get( %u %u %u)\n", tbl_idx,
                mask.maskl, mask.maskh);
        }
        else
        {
        ...
        if (mask.maskl != gtmv(m, 32) || mask.maskh != gtmv(m, 28))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_general_configuration_pwr_sav_en_set( %u)\n",
            value);
        ag_err = ag_drv_hash_general_configuration_pwr_sav_en_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_general_configuration_pwr_sav_en_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_general_configuration_pwr_sav_en_get( %u)\n",
                value);
        }
        else
        {
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_general_configuration_mult_hit_err_get( %u)\n",
                val);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_general_configuration_undo_fix_set( %u)\n",
            frst_mul_hit);
        ag_err = ag_drv_hash_general_configuration_undo_fix_set(frst_mul_hit);
        if (!ag_err)
            ag_err = ag_drv_hash_general_configuration_undo_fix_get(&frst_mul_hit);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_general_configuration_undo_fix_get( %u)\n",
                frst_mul_hit);
        }
        else
        {
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_pm_counters_hits_get( %u)\n",
                cnt);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_pm_counters_srchs_get( %u)\n",
                cnt);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_pm_counters_miss_get( %u)\n",
                cnt);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_pm_counters_hit_1st_acs_get( %u)\n",
                cnt);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_pm_counters_hit_2nd_acs_get( %u)\n",
                cnt);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_pm_counters_hit_3rd_acs_get( %u)\n",
                cnt);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_pm_counters_hit_4th_acs_get( %u)\n",
                cnt);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_pm_counters_frz_cnt_set( %u)\n",
            val);
        ag_err = ag_drv_hash_pm_counters_frz_cnt_set(val);
        if (!ag_err)
            ag_err = ag_drv_hash_pm_counters_frz_cnt_get(&val);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_pm_counters_frz_cnt_get( %u)\n",
                val);
        }
        else
        {
    ...
    {
        uint8_t tbl_idx = gtmv(m, 2);
        hash_lkup_tbl_cfg_tbl_cfg lkup_tbl_cfg_tbl_cfg = {.hash_base_addr = gtmv(m, 11), .tbl_size = gtmv(m, 4), .max_hop = gtmv(m, 4), .cam_en = gtmv(m, 1), .direct_lkup_en = gtmv(m, 1), .hash_type = gtmv(m, 1), .int_ctx_size = gtmv(m, 2)};
        bdmf_session_print(session, "ag_drv_hash_lkup_tbl_cfg_tbl_cfg_set( %u %u %u %u %u %u %u %u)\n", tbl_idx,
            lkup_tbl_cfg_tbl_cfg.hash_base_addr, lkup_tbl_cfg_tbl_cfg.tbl_size, lkup_tbl_cfg_tbl_cfg.max_hop, lkup_tbl_cfg_tbl_cfg.cam_en, 
            lkup_tbl_cfg_tbl_cfg.direct_lkup_en, lkup_tbl_cfg_tbl_cfg.hash_type, lkup_tbl_cfg_tbl_cfg.int_ctx_size);
        ag_err = ag_drv_hash_lkup_tbl_cfg_tbl_cfg_set(tbl_idx, &lkup_tbl_cfg_tbl_cfg);
        if (!ag_err)
            ag_err = ag_drv_hash_lkup_tbl_cfg_tbl_cfg_get(tbl_idx, &lkup_tbl_cfg_tbl_cfg);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_lkup_tbl_cfg_tbl_cfg_get( %u %u %u %u %u %u %u %u)\n", tbl_idx,
                lkup_tbl_cfg_tbl_cfg.hash_base_addr, lkup_tbl_cfg_tbl_cfg.tbl_size, lkup_tbl_cfg_tbl_cfg.max_hop, lkup_tbl_cfg_tbl_cfg.cam_en, 
                lkup_tbl_cfg_tbl_cfg.direct_lkup_en, lkup_tbl_cfg_tbl_cfg.hash_type, lkup_tbl_cfg_tbl_cfg.int_ctx_size);
        }
        else
        ...
        if (lkup_tbl_cfg_tbl_cfg.hash_base_addr != gtmv(m, 11) || lkup_tbl_cfg_tbl_cfg.tbl_size != gtmv(m, 4) || lkup_tbl_cfg_tbl_cfg.max_hop != gtmv(m, 4) || lkup_tbl_cfg_tbl_cfg.cam_en != gtmv(m, 1) || lkup_tbl_cfg_tbl_cfg.direct_lkup_en != gtmv(m, 1) || lkup_tbl_cfg_tbl_cfg.hash_type != gtmv(m, 1) || lkup_tbl_cfg_tbl_cfg.int_ctx_size != gtmv(m, 2))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_set( %u %u %u %u)\n", tbl_idx,
            lkup_tbl_cfg_cntxt_cfg.base_address, lkup_tbl_cfg_cntxt_cfg.first_hash_idx, lkup_tbl_cfg_cntxt_cfg.ext_ctx_size);
        ag_err = ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_set(tbl_idx, &lkup_tbl_cfg_cntxt_cfg);
        if (!ag_err)
            ag_err = ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_get(tbl_idx, &lkup_tbl_cfg_cntxt_cfg);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_lkup_tbl_cfg_cntxt_cfg_get( %u %u %u %u)\n", tbl_idx,
                lkup_tbl_cfg_cntxt_cfg.base_address, lkup_tbl_cfg_cntxt_cfg.first_hash_idx, lkup_tbl_cfg_cntxt_cfg.ext_ctx_size);
        }
        else
        {
        ...
        if (lkup_tbl_cfg_cntxt_cfg.base_address != gtmv(m, 12) || lkup_tbl_cfg_cntxt_cfg.first_hash_idx != gtmv(m, 13) || lkup_tbl_cfg_cntxt_cfg.ext_ctx_size != gtmv(m, 3))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_cam_base_addr_set( %u)\n",
            base_address);
        ag_err = ag_drv_hash_cam_base_addr_set(base_address);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_base_addr_get(&base_address);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_base_addr_get( %u)\n",
                base_address);
        }
        else
        {
    ...
    {
        uint16_t val = gtmv(m, 16);
        bdmf_session_print(session, "ag_drv_hash_cam_configuration_tm_cfg_set( %u)\n",
            val);
        ag_err = ag_drv_hash_cam_configuration_tm_cfg_set(val);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_configuration_tm_cfg_get(&val);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_configuration_tm_cfg_get( %u)\n",
                val);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_cam_indirect_op_set( %u)\n",
            cmd);
        ag_err = ag_drv_hash_cam_indirect_op_set(cmd);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_indirect_op_get(&cmd);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_indirect_op_get( %u)\n",
                cmd);
        }
        else
        {
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_indirect_op_done_get( %u)\n",
                val);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_cam_indirect_addr_set( %u %u)\n",
            key1_ind, entry_addr);
        ag_err = ag_drv_hash_cam_indirect_addr_set(key1_ind, entry_addr);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_indirect_addr_get(&key1_ind, &entry_addr);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_indirect_addr_get( %u %u)\n",
                key1_ind, entry_addr);
        }
        else
        {
        ...
        if (key1_ind != gtmv(m, 1) || entry_addr != gtmv(m, 6))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_cam_indirect_vlid_in_set( %u)\n",
            valid);
        ag_err = ag_drv_hash_cam_indirect_vlid_in_set(valid);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_indirect_vlid_in_get(&valid);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_indirect_vlid_in_get( %u)\n",
                valid);
        }
        else
        {
    ...
    {
        bdmf_boolean valid = gtmv(m, 1);
        bdmf_session_print(session, "ag_drv_hash_cam_indirect_vlid_out_set( %u)\n",
            valid);
        ag_err = ag_drv_hash_cam_indirect_vlid_out_set(valid);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_indirect_vlid_out_get(&valid);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_indirect_vlid_out_get( %u)\n",
                valid);
        }
        else
        {
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_indirect_rslt_get( %u %u)\n",
                match, index);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_cam_indirect_key_in_set( %u %u %u)\n", zero,
            cam_indirect_key_in.key_in[0], cam_indirect_key_in.key_in[1]);
        ag_err = ag_drv_hash_cam_indirect_key_in_set(zero, &cam_indirect_key_in);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_indirect_key_in_get(zero, &cam_indirect_key_in);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_indirect_key_in_get( %u %u %u)\n", zero,
                cam_indirect_key_in.key_in[0], cam_indirect_key_in.key_in[1]);
        }
        else
        {
        ...
        if (cam_indirect_key_in.key_in[0] != gtmv(m, 32) || cam_indirect_key_in.key_in[1] != gtmv(m, 32))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        if (!ag_err)
            ag_err = ag_drv_hash_cam_indirect_key_out_get(zero, &cam_indirect_key_out);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_indirect_key_out_get( %u %u %u)\n", zero,
                cam_indirect_key_out.key_out[0], cam_indirect_key_out.key_out[1]);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_status_get( %u)\n",
                value);
        }
    }
    ...
    {
        bdmf_boolean value = gtmv(m, 1);
        bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_dbg_compare_en_set( %u)\n",
            value);
        ag_err = ag_drv_hash_cam_bist_bist_dbg_compare_en_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_bist_bist_dbg_compare_en_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_dbg_compare_en_get( %u)\n",
                value);
        }
        else
        {
    ...
    {
        uint32_t value = gtmv(m, 32);
        bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_dbg_data_set( %u)\n",
            value);
        ag_err = ag_drv_hash_cam_bist_bist_dbg_data_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_bist_bist_dbg_data_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_dbg_data_get( %u)\n",
                value);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_dbg_data_slice_or_status_sel_set( %u)\n",
            value);
        ag_err = ag_drv_hash_cam_bist_bist_dbg_data_slice_or_status_sel_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_bist_bist_dbg_data_slice_or_status_sel_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_dbg_data_slice_or_status_sel_get( %u)\n",
                value);
        }
        else
        {
    ...
    {
        bdmf_boolean value = gtmv(m, 1);
        bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_dbg_data_valid_set( %u)\n",
            value);
        ag_err = ag_drv_hash_cam_bist_bist_dbg_data_valid_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_bist_bist_dbg_data_valid_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_dbg_data_valid_get( %u)\n",
                value);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_en_set( %u)\n",
            value);
        ag_err = ag_drv_hash_cam_bist_bist_en_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_bist_bist_en_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_en_get( %u)\n",
                value);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_mode_set( %u)\n",
            value);
        ag_err = ag_drv_hash_cam_bist_bist_mode_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_bist_bist_mode_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_mode_get( %u)\n",
                value);
        }
        else
        {
    ...
    {
        bdmf_boolean value = gtmv(m, 1);
        bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_rst_l_set( %u)\n",
            value);
        ag_err = ag_drv_hash_cam_bist_bist_rst_l_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_bist_bist_rst_l_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_rst_l_get( %u)\n",
                value);
        }
        else
        {
    ...
    {
        uint8_t value = gtmv(m, 8);
        bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_skip_error_cnt_set( %u)\n",
            value);
        ag_err = ag_drv_hash_cam_bist_bist_skip_error_cnt_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_bist_bist_skip_error_cnt_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_skip_error_cnt_get( %u)\n",
                value);
        }
        else
        {
    ...
    {
        uint16_t value = gtmv(m, 16);
        bdmf_session_print(session, "ag_drv_hash_cam_bist_dbg_en_set( %u)\n",
            value);
        ag_err = ag_drv_hash_cam_bist_dbg_en_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_bist_dbg_en_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_dbg_en_get( %u)\n",
                value);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_cascade_select_set( %u)\n",
            value);
        ag_err = ag_drv_hash_cam_bist_bist_cascade_select_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_bist_bist_cascade_select_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_cascade_select_get( %u)\n",
                value);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_block_select_set( %u)\n",
            value);
        ag_err = ag_drv_hash_cam_bist_bist_block_select_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_bist_bist_block_select_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_block_select_get( %u)\n",
                value);
        }
        else
        {
    ...
    {
        bdmf_boolean value = gtmv(m, 1);
        bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_repair_enable_set( %u)\n",
            value);
        ag_err = ag_drv_hash_cam_bist_bist_repair_enable_set(value);
        if (!ag_err)
            ag_err = ag_drv_hash_cam_bist_bist_repair_enable_get(&value);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_cam_bist_bist_repair_enable_get( %u)\n",
                value);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_intr_ctrl_isr_set( %u %u %u %u %u %u %u)\n",
            intr_ctrl_isr.invld_cmd, intr_ctrl_isr.mult_match, intr_ctrl_isr.hash_0_idx_ovflv, intr_ctrl_isr.hash_1_idx_ovflv, 
            intr_ctrl_isr.hash_2_idx_ovflv, intr_ctrl_isr.hash_3_idx_ovflv, intr_ctrl_isr.cntxt_idx_ovflv);
        ag_err = ag_drv_hash_intr_ctrl_isr_set(&intr_ctrl_isr);
        if (!ag_err)
            ag_err = ag_drv_hash_intr_ctrl_isr_get(&intr_ctrl_isr);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_intr_ctrl_isr_get( %u %u %u %u %u %u %u)\n",
                intr_ctrl_isr.invld_cmd, intr_ctrl_isr.mult_match, intr_ctrl_isr.hash_0_idx_ovflv, intr_ctrl_isr.hash_1_idx_ovflv, 
                intr_ctrl_isr.hash_2_idx_ovflv, intr_ctrl_isr.hash_3_idx_ovflv, intr_ctrl_isr.cntxt_idx_ovflv);
        }
        else
        ...
        if (intr_ctrl_isr.invld_cmd != gtmv(m, 1) || intr_ctrl_isr.mult_match != gtmv(m, 1) || intr_ctrl_isr.hash_0_idx_ovflv != gtmv(m, 1) || intr_ctrl_isr.hash_1_idx_ovflv != gtmv(m, 1) || intr_ctrl_isr.hash_2_idx_ovflv != gtmv(m, 1) || intr_ctrl_isr.hash_3_idx_ovflv != gtmv(m, 1) || intr_ctrl_isr.cntxt_idx_ovflv != gtmv(m, 1))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_intr_ctrl_ism_get( %u)\n",
                ism);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_intr_ctrl_ier_set( %u)\n",
            iem);
        ag_err = ag_drv_hash_intr_ctrl_ier_set(iem);
        if (!ag_err)
            ag_err = ag_drv_hash_intr_ctrl_ier_get(&iem);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_intr_ctrl_ier_get( %u)\n",
                iem);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_intr_ctrl_itr_set( %u)\n",
            ist);
        ag_err = ag_drv_hash_intr_ctrl_itr_set(ist);
        if (!ag_err)
            ag_err = ag_drv_hash_intr_ctrl_itr_get(&ist);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_intr_ctrl_itr_get( %u)\n",
                ist);
        }
        else
        {
...

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg0_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg1_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg2_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg3_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg4_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg5_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg6_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg7_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg8_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg9_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg10_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg11_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg12_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg13_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg14_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg15_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg16_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg17_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg18_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg19_get( %u)\n",
                val);
        }
    }

    {
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg20_get( %u)\n",
                val);
        }
    }

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_debug_dbg_sel_set( %u)\n",
            val);
        ag_err = ag_drv_hash_debug_dbg_sel_set(val);
        if (!ag_err)
            ag_err = ag_drv_hash_debug_dbg_sel_get(&val);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_debug_dbg_sel_get( %u)\n",
                val);
        }
        else
        {
    ...
    {
        uint16_t entry_idx = gtmv(m, 12);
        bdmf_boolean age = gtmv(m, 1);
        bdmf_session_print(session, "ag_drv_hash_aging_ram_aging_set( %u %u)\n", entry_idx,
            age);
        ag_err = ag_drv_hash_aging_ram_aging_set(entry_idx, age);
        if (!ag_err)
            ag_err = ag_drv_hash_aging_ram_aging_get(entry_idx, &age);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_aging_ram_aging_get( %u %u)\n", entry_idx,
                age);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_context_ram_context_47_24_set( %u %u)\n", ctx_idx,
            bits);
        ag_err = ag_drv_hash_context_ram_context_47_24_set(ctx_idx, bits);
        if (!ag_err)
            ag_err = ag_drv_hash_context_ram_context_47_24_get(ctx_idx, &bits);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_context_ram_context_47_24_get( %u %u)\n", ctx_idx,
                bits);
        }
        else
        {
...

    {
        uint16_t ctx_idx = gtmv(m, 11);
        uint32_t bits = gtmv(m, 24);
        bdmf_session_print(session, "ag_drv_hash_context_ram_context_23_0_set( %u %u)\n", ctx_idx,
            bits);
        ag_err = ag_drv_hash_context_ram_context_23_0_set(ctx_idx, bits);
        if (!ag_err)
            ag_err = ag_drv_hash_context_ram_context_23_0_get(ctx_idx, &bits);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_context_ram_context_23_0_get( %u %u)\n", ctx_idx,
                bits);
        }
        else
        {
    ...
    {
        uint16_t idx = gtmv(m, 12);
        uint32_t key_59_28_or_dat = gtmv(m, 32);
        bdmf_session_print(session, "ag_drv_hash_ram_eng_high_set( %u %u)\n", idx,
            key_59_28_or_dat);
        ag_err = ag_drv_hash_ram_eng_high_set(idx, key_59_28_or_dat);
        if (!ag_err)
            ag_err = ag_drv_hash_ram_eng_high_get(idx, &key_59_28_or_dat);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_ram_eng_high_get( %u %u)\n", idx,
                key_59_28_or_dat);
        }
        else
        {
...

    {
        ...
        bdmf_session_print(session, "ag_drv_hash_ram_eng_low_set( %u %u %u %u %u)\n", idx,
            skp, cfg, key_11_0, key_27_12_or_dat);
        ag_err = ag_drv_hash_ram_eng_low_set(idx, skp, cfg, key_11_0, key_27_12_or_dat);
        if (!ag_err)
            ag_err = ag_drv_hash_ram_eng_low_get(idx, &skp, &cfg, &key_11_0, &key_27_12_or_dat);

        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_hash_ram_eng_low_get( %u %u %u %u %u)\n", idx,
                skp, cfg, key_11_0, key_27_12_or_dat);
        }
        else
        {
        ...
        if (skp != gtmv(m, 1) || cfg != gtmv(m, 3) || key_11_0 != gtmv(m, 12) || key_27_12_or_dat != gtmv(m, 16))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...
#ifdef HAL_DRV_TEST_ENABLE
static int ag_drv_hash_cli_ext_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_hash_mask:
    {
        uint8_t max_tbl_idx = 7;
        uint8_t tbl_idx = gtmv(m, 2);
        hash_mask mask = {
            .maskl = gtmv(m, 32), 
            .maskh = gtmv(m, 28) };

        if ((start_idx >= max_tbl_idx) || (stop_idx >= max_tbl_idx))
        {
        ...
        for (tbl_idx = 0; tbl_idx < max_tbl_idx; tbl_idx++)
        {
            bdmf_session_print(session, "ag_drv_hash_mask_set( %u %u %u)\n", tbl_idx,
                mask.maskl, mask.maskh);
            ag_err = ag_drv_hash_mask_set(tbl_idx, &mask);
        ...
        m = input_method;
        mask.maskl = gtmv(m, 32);
        mask.maskh = gtmv(m, 28);
        ...
        for (tbl_idx = 0; tbl_idx < max_tbl_idx; tbl_idx++)
        {
            if (tbl_idx < start_idx || tbl_idx > stop_idx)
    ...
    case cli_hash_lkup_tbl_cfg_tbl_cfg:
    {
        ...
        uint8_t tbl_idx = gtmv(m, 2);
        hash_lkup_tbl_cfg_tbl_cfg lkup_tbl_cfg_tbl_cfg = {
            .hash_base_addr = gtmv(m, 11), 
            .tbl_size = gtmv(m, 4), 
            .max_hop = gtmv(m, 4), 
            .cam_en = gtmv(m, 1), 
            .direct_lkup_en = gtmv(m, 1), 
            .hash_type = gtmv(m, 1), 
            .int_ctx_size = gtmv(m, 2) };
        ...
        /* Set the specified entries to values according to the method */
        m = input_method;
        lkup_tbl_cfg_tbl_cfg.hash_base_addr = gtmv(m, 11);
        lkup_tbl_cfg_tbl_cfg.tbl_size = gtmv(m, 4);
        lkup_tbl_cfg_tbl_cfg.max_hop = gtmv(m, 4);
        lkup_tbl_cfg_tbl_cfg.cam_en = gtmv(m, 1);
        lkup_tbl_cfg_tbl_cfg.direct_lkup_en = gtmv(m, 1);
        lkup_tbl_cfg_tbl_cfg.hash_type = gtmv(m, 1);
        lkup_tbl_cfg_tbl_cfg.int_ctx_size = gtmv(m, 2);
        ...
        for (tbl_idx = 0; tbl_idx < max_tbl_idx; tbl_idx++)
        {
            ...
            if (lkup_tbl_cfg_tbl_cfg.hash_base_addr != gtmv(m, 11) || 
                lkup_tbl_cfg_tbl_cfg.tbl_size != gtmv(m, 4) || 
                lkup_tbl_cfg_tbl_cfg.max_hop != gtmv(m, 4) || 
                lkup_tbl_cfg_tbl_cfg.cam_en != gtmv(m, 1) || 
                lkup_tbl_cfg_tbl_cfg.direct_lkup_en != gtmv(m, 1) || 
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of lkup_tbl_cfg_tbl_cfg completed. Number of tested entries %u.\n", max_tbl_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_hash_lkup_tbl_cfg_cntxt_cfg:
    {
        ...
        uint8_t tbl_idx = gtmv(m, 2);
        hash_lkup_tbl_cfg_cntxt_cfg lkup_tbl_cfg_cntxt_cfg = {
            .base_address = gtmv(m, 12), 
            .first_hash_idx = gtmv(m, 13), 
            .ext_ctx_size = gtmv(m, 3) };
        ...
        /* Set the specified entries to values according to the method */
        m = input_method;
        lkup_tbl_cfg_cntxt_cfg.base_address = gtmv(m, 12);
        lkup_tbl_cfg_cntxt_cfg.first_hash_idx = gtmv(m, 13);
        lkup_tbl_cfg_cntxt_cfg.ext_ctx_size = gtmv(m, 3);
        ...
        for (tbl_idx = 0; tbl_idx < max_tbl_idx; tbl_idx++)
        {
            ...
            if (lkup_tbl_cfg_cntxt_cfg.base_address != gtmv(m, 12) || 
                lkup_tbl_cfg_cntxt_cfg.first_hash_idx != gtmv(m, 13) || 
                lkup_tbl_cfg_cntxt_cfg.ext_ctx_size != gtmv(m, 3) || 
                0)
            {
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of lkup_tbl_cfg_cntxt_cfg completed. Number of tested entries %u.\n", max_tbl_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_hash_cam_indirect_key_in:
    {
        ...
        /* Set the specified entries to values according to the method */
        m = input_method;
        cam_indirect_key_in.key_in[0] = gtmv(m, 32);
        cam_indirect_key_in.key_in[1] = gtmv(m, 32);
        ...
        for (zero = 0; zero < max_zero; zero++)
        {
            ...
            if (cam_indirect_key_in.key_in[0] != gtmv(m, 32) || 
                cam_indirect_key_in.key_in[1] != gtmv(m, 32) || 
                0)
            {
                bdmf_session_print(session, "Test failed on comparing set and get results of entry %u\n", zero);
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of cam_indirect_key_in completed. Number of tested entries %u.\n", max_zero);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_hash_aging_ram_aging:
    {
        uint16_t max_entry_idx = 4160;
        uint16_t entry_idx = gtmv(m, 12);
        bdmf_boolean age = gtmv(m, 1);

        if ((start_idx >= max_entry_idx) || (stop_idx >= max_entry_idx))
        {
            bdmf_session_print(session, "ERROR: start_idx and stop_idx must be < %u\n", max_entry_idx);
            return BDMF_ERR_PARM;
        }
        ...
        bdmf_session_print(session, "\n ======== Set all array entries to the init values ========\n");
        for (entry_idx = 0; entry_idx < max_entry_idx; entry_idx++)
        {
            bdmf_session_print(session, "ag_drv_hash_aging_ram_aging_set( %u %u)\n", entry_idx,
                age);
            ag_err = ag_drv_hash_aging_ram_aging_set(entry_idx, age);
        ...
        for (entry_idx = start_idx; entry_idx <= stop_idx; entry_idx++)
        {
            bdmf_session_print(session, "ag_drv_hash_aging_ram_aging_set( %u %u)\n", entry_idx,
                age);
            ag_err = ag_drv_hash_aging_ram_aging_set(entry_idx, age);
        ...
        for (entry_idx = 0; entry_idx < max_entry_idx; entry_idx++)
        {
            if (entry_idx < start_idx || entry_idx > stop_idx)
                m = ag_drv_cli_test_method_high; /* method for checking "unchanged" entries */
            else
                m = input_method; /* method for checking entries [start_idx..stop_idx] */
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of aging_ram_aging completed. Number of tested entries %u.\n", max_entry_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_hash_context_ram_context_47_24:
    {
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of context_ram_context_47_24 completed. Number of tested entries %u.\n", max_ctx_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_hash_context_ram_context_23_0:
    {
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of context_ram_context_23_0 completed. Number of tested entries %u.\n", max_ctx_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_hash_ram_eng_high:
    {
        ...
        for (idx = 0; idx < max_idx; idx++)
        {
            ...
            if (key_59_28_or_dat != gtmv(m, 32) || 0)
            {
                bdmf_session_print(session, "Test failed on comparing set and get results of entry %u\n", idx);
                ext_test_failure_cnt++;
            }
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of ram_eng_high completed. Number of tested entries %u.\n", max_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
    ...
    case cli_hash_ram_eng_low:
    {
        ...
        for (idx = 0; idx < max_idx; idx++)
        {
            ...
            if (skp != gtmv(m, 1) || cfg != gtmv(m, 3) || key_11_0 != gtmv(m, 12) || key_27_12_or_dat != gtmv(m, 16) || 0)
            {
                bdmf_session_print(session, "Test failed on comparing set and get results of entry %u\n", idx);
                ext_test_failure_cnt++;
            }
        ...
        bdmf_session_print(session, "========================================================================\n");
        bdmf_session_print(session, "Test of ram_eng_low completed. Number of tested entries %u.\n", max_idx);
        bdmf_session_print(session, "SUCCESSES: %u, FAILURES: %u\n", ext_test_success_cnt, ext_test_failure_cnt);
        bdmf_session_print(session, "========================================================================\n\n");
...
#ifdef HAL_DRV_TEST_ENABLE
static int ag_drv_hash_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case bdmf_address_cam_configuration_tm_cfg: reg = &RU_REG(HASH, CAM_CONFIGURATION_TM_CFG); blk = &RU_BLK(HASH); break;
...
bdmfmon_handle_t ag_drv_hash_cli_init(bdmfmon_handle_t root_dir)
{
    ...
    dir = bdmfmon_dir_add(root_dir, "hash", "hash", BDMF_ACCESS_ADMIN, NULL);
    BUG_ON(dir == NULL);

    {
        static bdmfmon_cmd_parm_t set_key_padding[] = {
            BDMFMON_MAKE_PARM("key_pad_h", "key_pad_h", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("key_pad_l", "key_pad_l", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_mask[] = {
            BDMFMON_MAKE_PARM("tbl_idx", "tbl_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("maskl", "maskl", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("maskh", "maskh", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_general_configuration_undo_fix[] = {
            BDMFMON_MAKE_PARM("frst_mul_hit", "frst_mul_hit", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_lkup_tbl_cfg_tbl_cfg[] = {
            BDMFMON_MAKE_PARM("tbl_idx", "tbl_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("hash_base_addr", "hash_base_addr", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("tbl_size", "tbl_size", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("max_hop", "max_hop", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("cam_en", "cam_en", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("direct_lkup_en", "direct_lkup_en", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("hash_type", "hash_type", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("int_ctx_size", "int_ctx_size", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_lkup_tbl_cfg_cntxt_cfg[] = {
            BDMFMON_MAKE_PARM("tbl_idx", "tbl_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("base_address", "base_address", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("first_hash_idx", "first_hash_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("ext_ctx_size", "ext_ctx_size", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_cam_configuration_tm_cfg[] = {
            BDMFMON_MAKE_PARM("val", "val", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_intr_ctrl_isr[] = {
            BDMFMON_MAKE_PARM("invld_cmd", "invld_cmd", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("mult_match", "mult_match", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("hash_0_idx_ovflv", "hash_0_idx_ovflv", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("hash_1_idx_ovflv", "hash_1_idx_ovflv", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("hash_2_idx_ovflv", "hash_2_idx_ovflv", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("hash_3_idx_ovflv", "hash_3_idx_ovflv", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("cntxt_idx_ovflv", "cntxt_idx_ovflv", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_aging_ram_aging[] = {
            BDMFMON_MAKE_PARM("entry_idx", "entry_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("age", "age", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_context_ram_context_47_24[] = {
            BDMFMON_MAKE_PARM("ctx_idx", "ctx_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("bits", "bits", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        ...
        static bdmfmon_cmd_parm_t set_ram_eng_high[] = {
            ...
            BDMFMON_MAKE_PARM("key_59_28_or_dat", "key_59_28_or_dat", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_ram_eng_low[] = {
            BDMFMON_MAKE_PARM("idx", "idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("skp", "skp", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("cfg", "cfg", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("key_11_0", "key_11_0", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_MAKE_PARM("key_27_12_or_dat", "key_27_12_or_dat", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_enum_val_t selector_table[] = {
            ...
            { .name = "cam_configuration_tm_cfg", .val = cli_hash_cam_configuration_tm_cfg, .parms = set_cam_configuration_tm_cfg },
        ...
        BDMFMON_MAKE_CMD(dir, "set", "set", ag_drv_hash_cli_set,
    ...
    }
    {
        ...
        static bdmfmon_cmd_parm_t get_lkup_tbl_cfg_tbl_cfg[] = {
            BDMFMON_MAKE_PARM("tbl_idx", "tbl_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_lkup_tbl_cfg_cntxt_cfg[] = {
            BDMFMON_MAKE_PARM("tbl_idx", "tbl_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_cam_indirect_key_in[] = {
            BDMFMON_MAKE_PARM("zero", "zero", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_cam_indirect_key_out[] = {
            BDMFMON_MAKE_PARM("zero", "zero", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_aging_ram_aging[] = {
            BDMFMON_MAKE_PARM("entry_idx", "entry_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_context_ram_context_47_24[] = {
            BDMFMON_MAKE_PARM("ctx_idx", "ctx_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_context_ram_context_23_0[] = {
            BDMFMON_MAKE_PARM("ctx_idx", "ctx_idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_ram_eng_high[] = {
            BDMFMON_MAKE_PARM("idx", "idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t get_ram_eng_low[] = {
            BDMFMON_MAKE_PARM("idx", "idx", BDMFMON_PARM_UNUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_enum_val_t selector_table[] = {
            { .name = "key_padding", .val = cli_hash_key_padding, .parms = get_default },
            { .name = "mask", .val = cli_hash_mask, .parms = get_mask },
            { .name = "general_configuration_pwr_sav_en", .val = cli_hash_general_configuration_pwr_sav_en, .parms = get_default },
            { .name = "general_configuration_mult_hit_err", .val = cli_hash_general_configuration_mult_hit_err, .parms = get_default },
            { .name = "general_configuration_undo_fix", .val = cli_hash_general_configuration_undo_fix, .parms = get_default },
            { .name = "pm_counters_hits", .val = cli_hash_pm_counters_hits, .parms = get_default },
            { .name = "pm_counters_srchs", .val = cli_hash_pm_counters_srchs, .parms = get_default },
            { .name = "pm_counters_miss", .val = cli_hash_pm_counters_miss, .parms = get_default },
            { .name = "pm_counters_hit_1st_acs", .val = cli_hash_pm_counters_hit_1st_acs, .parms = get_default },
            { .name = "pm_counters_hit_2nd_acs", .val = cli_hash_pm_counters_hit_2nd_acs, .parms = get_default },
            { .name = "pm_counters_hit_3rd_acs", .val = cli_hash_pm_counters_hit_3rd_acs, .parms = get_default },
            { .name = "pm_counters_hit_4th_acs", .val = cli_hash_pm_counters_hit_4th_acs, .parms = get_default },
            { .name = "pm_counters_frz_cnt", .val = cli_hash_pm_counters_frz_cnt, .parms = get_default },
            { .name = "lkup_tbl_cfg_tbl_cfg", .val = cli_hash_lkup_tbl_cfg_tbl_cfg, .parms = get_lkup_tbl_cfg_tbl_cfg },
            { .name = "lkup_tbl_cfg_cntxt_cfg", .val = cli_hash_lkup_tbl_cfg_cntxt_cfg, .parms = get_lkup_tbl_cfg_cntxt_cfg },
            { .name = "cam_base_addr", .val = cli_hash_cam_base_addr, .parms = get_default },
            { .name = "cam_configuration_tm_cfg", .val = cli_hash_cam_configuration_tm_cfg, .parms = get_default },
            { .name = "cam_indirect_op", .val = cli_hash_cam_indirect_op, .parms = get_default },
            { .name = "cam_indirect_op_done", .val = cli_hash_cam_indirect_op_done, .parms = get_default },
            { .name = "cam_indirect_addr", .val = cli_hash_cam_indirect_addr, .parms = get_default },
            { .name = "cam_indirect_vlid_in", .val = cli_hash_cam_indirect_vlid_in, .parms = get_default },
            { .name = "cam_indirect_vlid_out", .val = cli_hash_cam_indirect_vlid_out, .parms = get_default },
            { .name = "cam_indirect_rslt", .val = cli_hash_cam_indirect_rslt, .parms = get_default },
            { .name = "cam_indirect_key_in", .val = cli_hash_cam_indirect_key_in, .parms = get_cam_indirect_key_in },
            { .name = "cam_indirect_key_out", .val = cli_hash_cam_indirect_key_out, .parms = get_cam_indirect_key_out },
            { .name = "cam_bist_bist_status", .val = cli_hash_cam_bist_bist_status, .parms = get_default },
            { .name = "cam_bist_bist_dbg_compare_en", .val = cli_hash_cam_bist_bist_dbg_compare_en, .parms = get_default },
            { .name = "cam_bist_bist_dbg_data", .val = cli_hash_cam_bist_bist_dbg_data, .parms = get_default },
            { .name = "cam_bist_bist_dbg_data_slice_or_status_sel", .val = cli_hash_cam_bist_bist_dbg_data_slice_or_status_sel, .parms = get_default },
            { .name = "cam_bist_bist_dbg_data_valid", .val = cli_hash_cam_bist_bist_dbg_data_valid, .parms = get_default },
            { .name = "cam_bist_bist_en", .val = cli_hash_cam_bist_bist_en, .parms = get_default },
            { .name = "cam_bist_bist_mode", .val = cli_hash_cam_bist_bist_mode, .parms = get_default },
            { .name = "cam_bist_bist_rst_l", .val = cli_hash_cam_bist_bist_rst_l, .parms = get_default },
            { .name = "cam_bist_bist_skip_error_cnt", .val = cli_hash_cam_bist_bist_skip_error_cnt, .parms = get_default },
            { .name = "cam_bist_dbg_en", .val = cli_hash_cam_bist_dbg_en, .parms = get_default },
            { .name = "cam_bist_bist_cascade_select", .val = cli_hash_cam_bist_bist_cascade_select, .parms = get_default },
            { .name = "cam_bist_bist_block_select", .val = cli_hash_cam_bist_bist_block_select, .parms = get_default },
            { .name = "cam_bist_bist_repair_enable", .val = cli_hash_cam_bist_bist_repair_enable, .parms = get_default },
            { .name = "intr_ctrl_isr", .val = cli_hash_intr_ctrl_isr, .parms = get_default },
            { .name = "intr_ctrl_ism", .val = cli_hash_intr_ctrl_ism, .parms = get_default },
            { .name = "intr_ctrl_ier", .val = cli_hash_intr_ctrl_ier, .parms = get_default },
            { .name = "intr_ctrl_itr", .val = cli_hash_intr_ctrl_itr, .parms = get_default },
            { .name = "debug_dbg0", .val = cli_hash_debug_dbg0, .parms = get_default },
            { .name = "debug_dbg1", .val = cli_hash_debug_dbg1, .parms = get_default },
            { .name = "debug_dbg2", .val = cli_hash_debug_dbg2, .parms = get_default },
            { .name = "debug_dbg3", .val = cli_hash_debug_dbg3, .parms = get_default },
            { .name = "debug_dbg4", .val = cli_hash_debug_dbg4, .parms = get_default },
            { .name = "debug_dbg5", .val = cli_hash_debug_dbg5, .parms = get_default },
            { .name = "debug_dbg6", .val = cli_hash_debug_dbg6, .parms = get_default },
            { .name = "debug_dbg7", .val = cli_hash_debug_dbg7, .parms = get_default },
            { .name = "debug_dbg8", .val = cli_hash_debug_dbg8, .parms = get_default },
            { .name = "debug_dbg9", .val = cli_hash_debug_dbg9, .parms = get_default },
            { .name = "debug_dbg10", .val = cli_hash_debug_dbg10, .parms = get_default },
            { .name = "debug_dbg11", .val = cli_hash_debug_dbg11, .parms = get_default },
            { .name = "debug_dbg12", .val = cli_hash_debug_dbg12, .parms = get_default },
            { .name = "debug_dbg13", .val = cli_hash_debug_dbg13, .parms = get_default },
            { .name = "debug_dbg14", .val = cli_hash_debug_dbg14, .parms = get_default },
            { .name = "debug_dbg15", .val = cli_hash_debug_dbg15, .parms = get_default },
            { .name = "debug_dbg16", .val = cli_hash_debug_dbg16, .parms = get_default },
            { .name = "debug_dbg17", .val = cli_hash_debug_dbg17, .parms = get_default },
            { .name = "debug_dbg18", .val = cli_hash_debug_dbg18, .parms = get_default },
            { .name = "debug_dbg19", .val = cli_hash_debug_dbg19, .parms = get_default },
            { .name = "debug_dbg20", .val = cli_hash_debug_dbg20, .parms = get_default },
            { .name = "debug_dbg_sel", .val = cli_hash_debug_dbg_sel, .parms = get_default },
            { .name = "aging_ram_aging", .val = cli_hash_aging_ram_aging, .parms = get_aging_ram_aging },
            { .name = "context_ram_context_47_24", .val = cli_hash_context_ram_context_47_24, .parms = get_context_ram_context_47_24 },
            { .name = "context_ram_context_23_0", .val = cli_hash_context_ram_context_23_0, .parms = get_context_ram_context_23_0 },
            { .name = "ram_eng_high", .val = cli_hash_ram_eng_high, .parms = get_ram_eng_high },
            { .name = "ram_eng_low", .val = cli_hash_ram_eng_low, .parms = get_ram_eng_low },
            BDMFMON_ENUM_LAST
        };
...
#ifdef HAL_DRV_TEST_ENABLE
    {
        ...
        BDMFMON_MAKE_PARM(dir, "test", "test", ag_drv_hash_cli_test,
...
#ifdef HAL_DRV_TEST_ENABLE
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            { .name = "mask", .val = cli_hash_mask, .parms = ext_test_default},
            { .name = "lkup_tbl_cfg_tbl_cfg", .val = cli_hash_lkup_tbl_cfg_tbl_cfg, .parms = ext_test_default},
            { .name = "lkup_tbl_cfg_cntxt_cfg", .val = cli_hash_lkup_tbl_cfg_cntxt_cfg, .parms = ext_test_default},
            { .name = "cam_indirect_key_in", .val = cli_hash_cam_indirect_key_in, .parms = ext_test_default},
            { .name = "aging_ram_aging", .val = cli_hash_aging_ram_aging, .parms = ext_test_default},
            { .name = "context_ram_context_47_24", .val = cli_hash_context_ram_context_47_24, .parms = ext_test_default},
            { .name = "context_ram_context_23_0", .val = cli_hash_context_ram_context_23_0, .parms = ext_test_default},
            { .name = "ram_eng_high", .val = cli_hash_ram_eng_high, .parms = ext_test_default},
            { .name = "ram_eng_low", .val = cli_hash_ram_eng_low, .parms = ext_test_default},
            BDMFMON_ENUM_LAST
        };
        static bdmfmon_enum_val_t enum_table_test_method[] = {
            { .name = "low", .val = ag_drv_cli_test_method_low },
        ...
        BDMFMON_MAKE_PARM(dir, "ext_test", "ext_test", ag_drv_hash_cli_ext_test,
            BDMFMON_MAKE_PARM_ENUM("method", "low: 0000, mid: 1000, high: 1111", enum_table_test_method, 0),
            BDMFMON_MAKE_PARM_SELECTOR("purpose", "purpose", selector_table, 0),
...
#ifdef HAL_DRV_TEST_ENABLE
    {
        static bdmfmon_enum_val_t enum_table_address[] = {
            ...
            { .name = "CAM_CONFIGURATION_TM_CFG", .val = bdmf_address_cam_configuration_tm_cfg },
        ...
        BDMFMON_MAKE_PARM(dir, "address", "address", bcm_hash_cli_address,
