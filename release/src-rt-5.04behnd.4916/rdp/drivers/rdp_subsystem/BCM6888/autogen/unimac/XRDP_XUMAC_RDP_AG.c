...
#if RU_INCLUDE_FIELD_DB
/***** Field: HD_RANDOM_JAM *****/
const ru_field_rec XUMAC_RDP_IPG_HD_BKP_CNTL_HD_RANDOM_JAM_FIELD =
{
    "HD_RANDOM_JAM",
#if RU_INCLUDE_DESC
    "",
...
#endif
    { XUMAC_RDP_IPG_HD_BKP_CNTL_HD_RANDOM_JAM_FIELD_MASK },
    0,
    { XUMAC_RDP_IPG_HD_BKP_CNTL_HD_RANDOM_JAM_FIELD_WIDTH },
    { XUMAC_RDP_IPG_HD_BKP_CNTL_HD_RANDOM_JAM_FIELD_SHIFT },
    0,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
#endif
...
static const ru_field_rec *XUMAC_RDP_IPG_HD_BKP_CNTL_FIELDS[] =
{
    ...
    &XUMAC_RDP_IPG_HD_BKP_CNTL_HD_RANDOM_JAM_FIELD,
};
