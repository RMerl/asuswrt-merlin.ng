...
#if RU_INCLUDE_FIELD_DB
/***** Field: FLOW_CNTR_CLR_ON_RD_EN *****/
const ru_field_rec NATC_FLOW_CNTR_CNTL_FLOW_CNTR_CLR_ON_RD_EN_FIELD =
{
...
#endif
    { NATC_FLOW_CNTR_CNTL_FLOW_CNTR_CLR_ON_RD_EN_FIELD_MASK },
    0,
    { NATC_FLOW_CNTR_CNTL_FLOW_CNTR_CLR_ON_RD_EN_FIELD_WIDTH },
    { NATC_FLOW_CNTR_CNTL_FLOW_CNTR_CLR_ON_RD_EN_FIELD_SHIFT },
    0,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
#endif
...
{
    &NATC_FLOW_CNTR_CNTL_FLOW_CNTR_CLR_ON_RD_EN_FIELD,
