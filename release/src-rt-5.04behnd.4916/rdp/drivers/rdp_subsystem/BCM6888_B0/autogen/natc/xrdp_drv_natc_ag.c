...
bdmf_error_t ag_drv_natc_flow_cntr_cntl_set(const natc_flow_cntr_cntl *flow_cntr_cntl)
{
    ...
    if ((flow_cntr_cntl->flow_cntr_clr_on_rd_en >= _1BITS_MAX_VAL_) ||
       (flow_cntr_cntl->flow_cntr_en_tbl7 >= _1BITS_MAX_VAL_) ||
    ...
    reg_flow_cntr_cntl = RU_FIELD_SET(0, NATC, FLOW_CNTR_CNTL, FLOW_CNTR_CLR_ON_RD_EN, reg_flow_cntr_cntl, flow_cntr_cntl->flow_cntr_clr_on_rd_en);
...
bdmf_error_t ag_drv_natc_flow_cntr_cntl_get(natc_flow_cntr_cntl *flow_cntr_cntl)
{
    ...
    flow_cntr_cntl->flow_cntr_clr_on_rd_en = RU_FIELD_GET(0, NATC, FLOW_CNTR_CNTL, FLOW_CNTR_CLR_ON_RD_EN, reg_flow_cntr_cntl);
...
static int ag_drv_natc_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        natc_flow_cntr_cntl flow_cntr_cntl = { .flow_cntr_clr_on_rd_en = parm[1].value.unumber, .flow_cntr_en_tbl7 = parm[2].value.unumber, .flow_cntr_en_tbl6 = parm[3].value.unumber, .flow_cntr_en_tbl5 = parm[4].value.unumber, .flow_cntr_en_tbl4 = parm[5].value.unumber, .flow_cntr_en_tbl3 = parm[6].value.unumber, .flow_cntr_en_tbl2 = parm[7].value.unumber, .flow_cntr_en_tbl1 = parm[8].value.unumber, .flow_cntr_en_tbl0 = parm[9].value.unumber, .context_offset = parm[10].value.unumber};
...
int bcm_natc_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_natc_flow_cntr_cntl:
    {
        ...
        bdmf_session_print(session, "flow_cntr_clr_on_rd_en = %u = 0x%x\n", flow_cntr_cntl.flow_cntr_clr_on_rd_en, flow_cntr_cntl.flow_cntr_clr_on_rd_en);
...
static int ag_drv_natc_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        natc_flow_cntr_cntl flow_cntr_cntl = {.flow_cntr_clr_on_rd_en = gtmv(m, 1), .flow_cntr_en_tbl7 = gtmv(m, 1), .flow_cntr_en_tbl6 = gtmv(m, 1), .flow_cntr_en_tbl5 = gtmv(m, 1), .flow_cntr_en_tbl4 = gtmv(m, 1), .flow_cntr_en_tbl3 = gtmv(m, 1), .flow_cntr_en_tbl2 = gtmv(m, 1), .flow_cntr_en_tbl1 = gtmv(m, 1), .flow_cntr_en_tbl0 = gtmv(m, 1), .context_offset = gtmv(m, 7)};
        bdmf_session_print(session, "ag_drv_natc_flow_cntr_cntl_set( %u %u %u %u %u %u %u %u %u %u)\n",
            flow_cntr_cntl.flow_cntr_clr_on_rd_en, flow_cntr_cntl.flow_cntr_en_tbl7, flow_cntr_cntl.flow_cntr_en_tbl6, flow_cntr_cntl.flow_cntr_en_tbl5, 
            flow_cntr_cntl.flow_cntr_en_tbl4, flow_cntr_cntl.flow_cntr_en_tbl3, flow_cntr_cntl.flow_cntr_en_tbl2, flow_cntr_cntl.flow_cntr_en_tbl1, 
            flow_cntr_cntl.flow_cntr_en_tbl0, flow_cntr_cntl.context_offset);
        ag_err = ag_drv_natc_flow_cntr_cntl_set(&flow_cntr_cntl);
        if (!ag_err)
            ag_err = ag_drv_natc_flow_cntr_cntl_get(&flow_cntr_cntl);
        ...
        if (!ag_err)
        {
            bdmf_session_print(session, "ag_drv_natc_flow_cntr_cntl_get( %u %u %u %u %u %u %u %u %u %u)\n",
                flow_cntr_cntl.flow_cntr_clr_on_rd_en, flow_cntr_cntl.flow_cntr_en_tbl7, flow_cntr_cntl.flow_cntr_en_tbl6, flow_cntr_cntl.flow_cntr_en_tbl5, 
                flow_cntr_cntl.flow_cntr_en_tbl4, flow_cntr_cntl.flow_cntr_en_tbl3, flow_cntr_cntl.flow_cntr_en_tbl2, flow_cntr_cntl.flow_cntr_en_tbl1, 
                flow_cntr_cntl.flow_cntr_en_tbl0, flow_cntr_cntl.context_offset);
        }
        ...
        if (flow_cntr_cntl.flow_cntr_clr_on_rd_en != gtmv(m, 1) || flow_cntr_cntl.flow_cntr_en_tbl7 != gtmv(m, 1) || flow_cntr_cntl.flow_cntr_en_tbl6 != gtmv(m, 1) || flow_cntr_cntl.flow_cntr_en_tbl5 != gtmv(m, 1) || flow_cntr_cntl.flow_cntr_en_tbl4 != gtmv(m, 1) || flow_cntr_cntl.flow_cntr_en_tbl3 != gtmv(m, 1) || flow_cntr_cntl.flow_cntr_en_tbl2 != gtmv(m, 1) || flow_cntr_cntl.flow_cntr_en_tbl1 != gtmv(m, 1) || flow_cntr_cntl.flow_cntr_en_tbl0 != gtmv(m, 1) || flow_cntr_cntl.context_offset != gtmv(m, 7))
        {
            test_failure_cnt++;
            bdmf_session_print(session, "  register failed match; failures=%u\n", test_failure_cnt);        }
        else
...
bdmfmon_handle_t ag_drv_natc_cli_init(bdmfmon_handle_t root_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_flow_cntr_cntl[] = {
            BDMFMON_MAKE_PARM("flow_cntr_clr_on_rd_en", "flow_cntr_clr_on_rd_en", BDMFMON_PARM_UNUMBER, 0),
