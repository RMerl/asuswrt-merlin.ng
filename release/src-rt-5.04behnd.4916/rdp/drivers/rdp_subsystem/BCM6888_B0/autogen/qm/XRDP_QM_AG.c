...
#if RU_INCLUDE_DESC
    "COUNTER 0..1791 Register",
    "Counter.\nword0:{15b0,pkt_cnt[16:0]}\nword1:{2b0,byte_cnt[29:0]}\nword2:{14b0,res_cnt[17:0]}\nword3: reserved\n\nThere are three words per queue starting at queue0 up to queue 448.\n",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Mode/Chicken bits for count pkts instead of PDs jira fix:\nQM_PD_CONGESTION_DROP_CNT (crossing max pds per queue - total_pd_thr)\n",
#endif
...
const ru_reg_rec QM_GLOBAL_CFG_DQM_FULL_REG =
{
    "GLOBAL_CFG_DQM_FULL",
#if RU_INCLUDE_DESC
    "DQM_FULL 0..13 Register",
    "Queue Full indication\nEach register includes a batch of 32 queues non-empty indication.\n14 Batches are needed for 448 queues.\nFirst Batch is for queues 31-0 and so on until the last batch representing queues 447-416.\n",
#endif
...
#if RU_INCLUDE_DESC
    "DQM_NOT_EMPTY 0..13 Register",
    "Queue Not Empty indication\nEach register includes a batch of 32 queues non-empty indication.\n14 Batches are need for 448 queues.\nFirst Batch is for queues 31-0 and so on until the last batch representing queues 447-416.\n",
#endif
...
#if RU_INCLUDE_DESC
    "AGGREGATION_CONTEXT_VALID 0..13 Register",
...
const ru_reg_rec QM_GLOBAL_CFG_AQM_CLK_COUNTER_CYCLE_REG =
{
    ...
    "Clock counter cycle value. Default is 1000d for 1uSec @1Ghz clk. Sets the cycles for the timestamp counter.\nSet 880d for 1usec @880MHz clk.\n*Note that 1d is illegal value.\n",
#endif
