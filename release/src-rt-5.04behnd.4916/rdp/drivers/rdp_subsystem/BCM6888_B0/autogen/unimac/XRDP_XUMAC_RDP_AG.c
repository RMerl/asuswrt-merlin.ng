...
#if RU_INCLUDE_FIELD_DB
/***** Field: LPI_CLOCK_GATING_EN *****/
const ru_field_rec XUMAC_RDP_UMAC_EEE_CTRL_LPI_CLOCK_GATING_EN_FIELD =
{
    "LPI_CLOCK_GATING_EN",
#if RU_INCLUDE_DESC
    "",
    "When set to 1, RX and TX clocks to certain modules are shut down in LPI mode. When set to 0, RX and TX clocks are still on in LPI mode.\n",
#endif
    { XUMAC_RDP_UMAC_EEE_CTRL_LPI_CLOCK_GATING_EN_FIELD_MASK },
    0,
    { XUMAC_RDP_UMAC_EEE_CTRL_LPI_CLOCK_GATING_EN_FIELD_WIDTH },
    { XUMAC_RDP_UMAC_EEE_CTRL_LPI_CLOCK_GATING_EN_FIELD_SHIFT },
    1,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
#endif
...
static const ru_field_rec *XUMAC_RDP_UMAC_EEE_CTRL_FIELDS[] =
{
    ...
    &XUMAC_RDP_UMAC_EEE_CTRL_LPI_CLOCK_GATING_EN_FIELD,
};
#endif /* RU_INCLUDE_FIELD_DB */
...
#if RU_INCLUDE_FIELD_DB
/***** Field: IDLE_STUFFING_MODE *****/
const ru_field_rec XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_IDLE_STUFFING_MODE_FIELD =
{
    "IDLE_STUFFING_MODE",
#if RU_INCLUDE_DESC
    "",
    "When cleared, TX_START_THRESHOLD is used from the register and idles are generated based on the XIB??s packet byte counter.\nWhen set and the idle stuffing is enabled (TX_IDLE_STUFFING_CTRL != 4'b0), idle stuffing logic uses packet size provided by the MAC on SOP (where supported) in order to calculate TX_START_THRESHOLD and as well to generate idles. This mode reduces packet transmission latency.\n",
#endif
    { XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_IDLE_STUFFING_MODE_FIELD_MASK },
    0,
    { XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_IDLE_STUFFING_MODE_FIELD_WIDTH },
    { XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_IDLE_STUFFING_MODE_FIELD_SHIFT },
    0,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
#endif
...
#if RU_INCLUDE_FIELD_DB
/***** Field: TX_START_THRESHOLD_OFFSET *****/
const ru_field_rec XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_TX_START_THRESHOLD_OFFSET_FIELD =
{
    "TX_START_THRESHOLD_OFFSET",
#if RU_INCLUDE_DESC
    "",
    "When IDLE_STUFFING_MODE = 1, TX_START_THRESHOLD is calculated for each packet as TX_START_THRESHOLD = N*MAC_PKT_SIZE/8 + TX_START_THRESHOLD_OFFSET where MAC_PKT_SIZE is communicated by the MAC on SOP using the side-band interface and N=1/2 for 1X and 3/4 for 3X idle stuffing modes. Note that TX_START_THRESHOLD is calculated only for 1X and 3X modes and for all other modes TX_START_THRESHOLD = MAC_PKT_SIZE.\n",
#endif
    { XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_TX_START_THRESHOLD_OFFSET_FIELD_MASK },
    0,
    { XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_TX_START_THRESHOLD_OFFSET_FIELD_WIDTH },
    { XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_TX_START_THRESHOLD_OFFSET_FIELD_SHIFT },
    1,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
#endif
...
#if RU_INCLUDE_FIELD_DB
/***** Field: TX_START_ON_EOP *****/
const ru_field_rec XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_TX_START_ON_EOP_FIELD =
{
    "TX_START_ON_EOP",
#if RU_INCLUDE_DESC
    "",
...
#endif
    { XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_TX_START_ON_EOP_FIELD_MASK },
    0,
    { XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_TX_START_ON_EOP_FIELD_WIDTH },
    { XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_TX_START_ON_EOP_FIELD_SHIFT },
    0,
#if RU_INCLUDE_ACCESS
    ru_access_rw,
#endif
...
static const ru_field_rec *XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_FIELDS[] =
{
    ...
    &XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_IDLE_STUFFING_MODE_FIELD,
    &XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_TX_START_THRESHOLD_OFFSET_FIELD,
    &XUMAC_RDP_TX_IDLE_STUFFING_CONTROL_TX_START_ON_EOP_FIELD,
};
#endif /* RU_INCLUDE_FIELD_DB */
