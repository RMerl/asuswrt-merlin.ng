...
typedef enum {
    ...
    rdpa_dscp_to_pbit_attr_qos_mapping = 1, /* qos_mapping : RI : bool : Yes : qos mapping table, no : vlan action per vport table */
 ...
 *
 * Get Yes : qos mapping table, no : vlan action per vport table.
 * \param[in]   mo_ dscp_to_pbit object handle or mattr transaction handle
 ...
 *
 * Set Yes : qos mapping table, no : vlan action per vport table.
 * \param[in]   mo_ dscp_to_pbit object handle or mattr transaction handle
