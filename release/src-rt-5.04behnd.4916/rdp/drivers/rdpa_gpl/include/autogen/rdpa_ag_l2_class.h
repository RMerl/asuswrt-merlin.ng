...
typedef enum {
    ...
    rdpa_l2_class_attr_flow_idx_pool_ptr = 2, /* flow_idx_pool_ptr : RI : pointer : Flow ID Pool Virtual Address */
    rdpa_l2_class_attr_flow = 3, /* flow : RWADF : aggregate[] l2_flow_info(rdpa_l2_flow_info_t) : L2 flow entry */
    rdpa_l2_class_attr_flow_stat = 4, /* flow_stat : RF : aggregate[] rdpa_stat(rdpa_stat_t) : L2 flow entry statistics */
    rdpa_l2_class_attr_flush = 5, /* flush : W : bool : Flush flows */
    rdpa_l2_class_attr_pathstat = 6, /* pathstat : RF : aggregate[] rdpa_stat(rdpa_stat_t) : L2 class path entry statistics */
    rdpa_l2_class_attr_tos_mflows = 7, /* tos_mflows : R : bool : TOS multi-flows (common for L3 and L2) */
...
/** Get l2_class/flow_idx_pool_ptr attribute.
 *
 ...
 */
static inline int rdpa_l2_class_flow_idx_pool_ptr_get(bdmf_object_handle mo_, void * *flow_idx_pool_ptr_)
{
    bdmf_number _nn_;
    int _rc_;
    _rc_ = bdmf_attr_get_as_num(mo_, rdpa_l2_class_attr_flow_idx_pool_ptr, &_nn_);
    *flow_idx_pool_ptr_ = (void *)(long)_nn_;
    return _rc_;
}


/** Set l2_class/flow_idx_pool_ptr attribute.
 *
 ...
 * The function can be called in task and softirq contexts.
 */
static inline int rdpa_l2_class_flow_idx_pool_ptr_set(bdmf_object_handle mo_, void * flow_idx_pool_ptr_)
{
    return bdmf_attr_set_as_num(mo_, rdpa_l2_class_attr_flow_idx_pool_ptr, (long)flow_idx_pool_ptr_);
}
...
/** Get l2_class/tos_mflows attribute.
 *
 ...
 * The function can be called in task context only.
 */
static inline int rdpa_l2_class_tos_mflows_get(bdmf_object_handle mo_, bdmf_boolean *tos_mflows_)
{
    bdmf_number _nn_;
    int _rc_;
    _rc_ = bdmf_attr_get_as_num(mo_, rdpa_l2_class_attr_tos_mflows, &_nn_);
    *tos_mflows_ = (bdmf_boolean)_nn_;
    return _rc_;
}
