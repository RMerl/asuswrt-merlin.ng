...
typedef enum {
    ...
    rdpa_llid_attr_fec_overhead = 9, /* fec_overhead : RW : bool : FEC overhead for ghost reporting */
    rdpa_llid_attr_sci_overhead = 10, /* sci_overhead : RW : bool : sci overhead for ghost reporting */
    rdpa_llid_attr_q_802_1ae = 11, /* q_802_1ae : RW : bool : 802.1AE overhead for ghost reporting */
    rdpa_llid_attr_is_empty = 12, /* is_empty : R : bool : check if LLID is empty  */
    rdpa_llid_attr_pbit_to_queue = 13, /* pbit_to_queue : R : object : Handle to linked pbit to queue object */
...
/** Get llid/pbit_to_queue attribute.
 *
 ...
 * The function can be called in task context only.
 */
static inline int rdpa_llid_pbit_to_queue_get(bdmf_object_handle mo_, bdmf_object_handle *pbit_to_queue_)
{
    bdmf_number _nn_;
    int _rc_;
    _rc_ = bdmf_attr_get_as_num(mo_, rdpa_llid_attr_pbit_to_queue, &_nn_);
