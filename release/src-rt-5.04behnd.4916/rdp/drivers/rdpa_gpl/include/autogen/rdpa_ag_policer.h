...
typedef enum {
    rdpa_policer_attr_index = 0, /* index : KRI : number : Policer Index */
    rdpa_policer_attr_cfg = 1, /* cfg : RW : aggregate tm_policer_cfg(rdpa_tm_policer_cfg_t) : Configuration */
    rdpa_policer_attr_stat = 2, /* stat : RW : aggregate tm_policer_stat(rdpa_tm_policer_stat_t) : Statistics */
} rdpa_policer_attr_types;

extern int (*f_rdpa_policer_get)(bdmf_number index_, bdmf_object_handle *pmo);
