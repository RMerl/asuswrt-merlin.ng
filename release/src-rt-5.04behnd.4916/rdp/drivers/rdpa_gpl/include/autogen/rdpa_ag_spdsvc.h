...
typedef enum {
    ...
    rdpa_spdsvc_attr_analyzer = 1, /* analyzer : RWADF : aggregate[] udpspdtest_rx_params(rdpa_udpspdtest_rx_params_t) : Traffic Analyzer */
 ...
 * The function can be called in task and softirq contexts.
 */
static inline int rdpa_spdsvc_analyzer_get(bdmf_object_handle mo_, bdmf_index ai_, rdpa_udpspdtest_rx_params_t * analyzer_)
{
 ...
 * The function can be called in task and softirq contexts.
 */
static inline int rdpa_spdsvc_analyzer_add(bdmf_object_handle mo_, bdmf_index * ai_, const rdpa_udpspdtest_rx_params_t * analyzer_)
{
    int rc;
