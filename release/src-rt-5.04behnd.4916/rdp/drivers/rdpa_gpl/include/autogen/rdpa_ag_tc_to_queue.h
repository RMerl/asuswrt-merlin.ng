...
typedef enum {
    ...
    rdpa_tc_to_queue_attr_dir = 1, /* dir : R : enum : Traffic Direction */
    rdpa_tc_to_queue_attr_tc_map = 2, /* tc_map : RWF : number[] : TC to queue array */
} rdpa_tc_to_queue_attr_types;

extern int (*f_rdpa_tc_to_queue_get)(bdmf_number table_, bdmf_object_handle *pmo);
 ...
 */
int rdpa_tc_to_queue_get(bdmf_number table_, bdmf_object_handle *tc_to_queue_obj);
