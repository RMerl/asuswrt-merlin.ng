...
#elif defined(BCM63146) || defined(BCM4912) || defined(BCM6813) || defined(BCM6855) || defined(BCM6888) || defined(BCM6837)
...
typedef struct {
    ...
    uint8_t *rdd_cmd_list1_p;       /* Pointer to rdd cmd list array    - Input/Output */
    ...
    uint32_t rdd_cmd_list1_offset;  /* Offset of cmd list array in rdd  - Input */
