...
typedef struct {
    ...
    uint64_t field_mask; /**< Fields used for classification. A combination of rdpa_ic_fields. */
    uint32_t prty;  /**< Defines the priority of classifier inside rdpa_ic_value . value between 0 - 127, higher value stands for higher priority. */
    ...
    rdpa_ic_gen_rule_cfg_t gen_rule_cfg3; /**< Third generic rule configuration, if available. */
    rdpa_ic_gen_rule_cfg_t gen_rule_cfg4; /**< Fourth generic rule configuration, if available. */
