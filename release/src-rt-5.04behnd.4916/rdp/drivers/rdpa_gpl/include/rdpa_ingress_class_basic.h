...
typedef enum {
    ...
    RDPA_IC_GENERIC_3,
    RDPA_IC_GENERIC_4,
    RDPA_IC_GENERIC_MAX = RDPA_IC_GENERIC_4,
#else
    RDPA_IC_GENERIC_MAX = RDPA_IC_GENERIC_2,
#endif
...
typedef enum
{
    RDPA_IC_MASK_SRC_IP          = (1ULL << RDPA_IC_SRC_IP),          /**< Source IP address */
    RDPA_IC_MASK_DST_IP          = (1ULL << RDPA_IC_DST_IP),          /**< Destination IP address */
    RDPA_IC_MASK_IPV6_FLOW_LABEL = (1ULL << RDPA_IC_IPV6_FLOW_LABEL), /**< IPv6 Flow Label field */
    RDPA_IC_MASK_GENERIC_1       = (1ULL << RDPA_IC_GENERIC_1),       /**< Generic key 0 (type L2/L3/L4, offset, mask */
    RDPA_IC_MASK_GENERIC_2       = (1ULL << RDPA_IC_GENERIC_2),       /**< Generic key 1 (type L2/L3/L4, offset, mask */
    RDPA_IC_MASK_GENERIC_MASK    = (1ULL << RDPA_IC_GENERIC_MASK),    /**< Generic key 0 mask (per flow)*/
    RDPA_IC_MASK_GENERIC_2_MASK  = (1ULL << RDPA_IC_GENERIC_2_MASK),  /**< Generic key 1 mask (per flow)*/
#if defined(RDP_UFC)
    RDPA_IC_MASK_GENERIC_3       = (1ULL << RDPA_IC_GENERIC_3),       /**< Generic key 3 (type L2/L3/L4, offset, mask */
    RDPA_IC_MASK_GENERIC_4       = (1ULL << RDPA_IC_GENERIC_4),       /**< Generic key 4 (type L2/L3/L4, offset, mask */
#endif
    RDPA_IC_MASK_OUTER_TPID      = (1ULL << RDPA_IC_OUTER_TPID),      /**< Outer TPID */
    RDPA_IC_MASK_INNER_TPID      = (1ULL << RDPA_IC_INNER_TPID),      /**< Inner TPID */
    RDPA_IC_MASK_SRC_PORT        = (1ULL << RDPA_IC_SRC_PORT),        /**< Source port */
    RDPA_IC_MASK_DST_PORT        = (1ULL << RDPA_IC_DST_PORT),        /**< Destination port */
    RDPA_IC_MASK_OUTER_VID       = (1ULL << RDPA_IC_OUTER_VID),       /**< Outer VID */
    RDPA_IC_MASK_INNER_VID       = (1ULL << RDPA_IC_INNER_VID),       /**< Inner VID */
    RDPA_IC_MASK_DST_MAC         = (1ULL << RDPA_IC_DST_MAC),         /**< Destination MAC address */
    RDPA_IC_MASK_SRC_MAC         = (1ULL << RDPA_IC_SRC_MAC),         /**< Source MAC address */
    RDPA_IC_MASK_ETHER_TYPE      = (1ULL << RDPA_IC_ETHER_TYPE),      /**< Ether Type */
    RDPA_IC_MASK_IP_PROTOCOL     = (1ULL << RDPA_IC_IP_PROTOCOL),     /**< Protocol */
#if defined(XRDP) || defined(BCM_XRDP)
    RDPA_IC_MASK_TOS             = (1ULL << RDPA_IC_TOS),             /**< IP Type of Service */
#endif
    RDPA_IC_MASK_DSCP            = (1ULL << RDPA_IC_DSCP),            /* IP Differentiated Services Code Point */
    RDPA_IC_MASK_SSID            = (1ULL << RDPA_IC_SSID),            /**< Ingress SSID */
    RDPA_IC_MASK_INGRESS_PORT    = (1ULL << RDPA_IC_INGRESS_PORT),    /**< LAN port */
    RDPA_IC_MASK_OUTER_PBIT      = (1ULL << RDPA_IC_OUTER_PBIT),      /**< Outer PBIT */
    RDPA_IC_MASK_INNER_PBIT      = (1ULL << RDPA_IC_INNER_PBIT),      /**< Inner PBIT */
    RDPA_IC_MASK_NUM_OF_VLANS    = (1ULL << RDPA_IC_NUM_OF_VLANS),    /**< Number of VLAN in packet */
...
typedef struct
{
    ...
    bdmf_object_handle          port_ingress_obj; /**< US - ingress port object */
    ...
    uint8_t                     outer_cfi;        /**< Outer CFI \RDP_UFC_LIMITED */
    uint8_t                     inner_cfi;        /**< Inner CFI \RDP_UFC_LIMITED */
#ifdef PARSER_BC_MC_SUPPORT
    uint8_t                     bc;               /**< Outer BC */
    uint8_t                     mc;               /**< Outer MC */
    uint8_t                     mc_l3;            /**< Outer MC_L3 */
#endif
    uint8_t                     number_of_vlans;  /**< Number of VLANs */
    uint32_t                    ipv6_flow_label;  /**< IPv6 Flow Label field */
    uint16_t                    outer_tpid;       /**< Outer TPID */
    uint8_t                     outer_tpid_idx;   /**< Outer TPID 3-bit index */    
    uint16_t                    inner_tpid;       /**< Inner TPID */
    uint8_t                     inner_tpid_idx;   /**< Inner TPID 3-bit index */    
    ...
    uint32_t                    generic_key_3;    /**< Key for third generic field matching \RDP_UFC_LIMITED */
    uint32_t                    generic_key_4;    /**< Key for fourth generic field matching \RDP_UFC_LIMITED */
    ...
    uint32_t                    generic_mask_3;   /**< Mask per flow for generic key 3 \RDP_UFC_LIMITED */
    uint32_t                    generic_mask_4;   /**< Mask per flow for generic key 4 \RDP_UFC_LIMITED */
...
typedef struct
{
    ...
    rdpa_iq_priority iq_priority; /**< Low/High priority for Ingress QoS. drop/pass decision under high ingress congestion */
    ...
    bdmf_boolean ct_override; /**< Trap packets not in CT \XRDP_LIMITED */
    bdmf_object_handle port_egress_obj; /**< Egress port object */
} rdpa_ic_result_t;
