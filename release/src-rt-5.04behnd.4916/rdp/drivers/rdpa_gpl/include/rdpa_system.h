...
typedef struct
{
    ...
    uint32_t parser_exception_path;             /**< packet pass VPORT_EXCEPTION_PATH */
    uint32_t vport_exception_path;              /**< packet pass PARSER_EXCEPTION_PATH */
} rdpa_debug_stat_t;
...
#define RDPA_SYSTEM_PORT_TM_MAP_TABLE_SIZE          8
