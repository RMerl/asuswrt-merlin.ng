...
int (*f_rdpa_policer_get)(bdmf_number index_, bdmf_object_handle *pmo);
 ...
 */
int rdpa_policer_get(bdmf_number index_, bdmf_object_handle *policer_obj)
{
   if (!f_rdpa_policer_get)
       return BDMF_ERR_STATE;
   return f_rdpa_policer_get(index_, policer_obj);
}
