...
#if defined(OREN) || defined(G9991_PRV) || defined(DSL_63138) || defined(DSL_63148) || defined(WL4908)
...
#define RDD_CPU_TX_DESCRIPTOR_IPTV_MAC_IDX_WRITE(v, p)       RDP_FIELD_MWRITE_32(((uint8_t *)p + 0), 0,  9, v)
