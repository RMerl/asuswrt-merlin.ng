...
void rdd_egress_ethertype_config(uint16_t ether_type_1, uint16_t ether_type_2)
{
    ...
    system_cfg_register = (RDD_SYSTEM_CONFIGURATION_DTS *)(DEVICE_ADDRESS(RUNNER_PRIVATE_0_OFFSET) + DS_SYSTEM_CONFIGURATION_ADDRESS);
    RDD_SYSTEM_CONFIGURATION_EGRESS_ETHER_TYPE_1_WRITE(ether_type_1, system_cfg_register);
    RDD_SYSTEM_CONFIGURATION_EGRESS_ETHER_TYPE_2_WRITE(ether_type_2, system_cfg_register);
}
...
void rdd_vlan_command_always_egress_ether_type_config(uint16_t ether_type_3)
{
    ...
    system_cfg_register = (RDD_SYSTEM_CONFIGURATION_DTS *)(DEVICE_ADDRESS(RUNNER_PRIVATE_0_OFFSET) + DS_SYSTEM_CONFIGURATION_ADDRESS);
    RDD_SYSTEM_CONFIGURATION_EGRESS_ETHER_TYPE_3_WRITE(ether_type_3, system_cfg_register);
}
