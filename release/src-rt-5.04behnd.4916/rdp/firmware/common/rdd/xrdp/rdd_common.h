...
#define SET_ADDR_HIGH_LOW(msb_addr, lsb_addr, phys_ring_address) \
    do {\
           phys_ring_address = ((uintptr_t)msb_addr) << 32;\
           phys_ring_address |= lsb_addr;\
    } while (0)
#else
/* 32 bit */
#define GET_ADDR_HIGH_LOW(msb_addr, lsb_addr, phys_ring_address) \
...
#define SET_ADDR_HIGH_LOW(msb_addr, lsb_addr, phys_ring_address) \
    do {\
           phys_ring_address = (uintptr_t)(lsb_addr);\
           ;\
    } while (0)
#endif

#if defined(BCM63158) || defined(BCM63146) || defined(BCM6813)
