...
{
    RDD_BYTES_2_BITS_WRITE_CORE(bits, RDD_PKTGEN_CURR_SBPM_HDR_PTR_ADDRESS_ARR, 0, core_id);
...
{
    RDD_BYTES_2_BITS_READ_CORE(*bits, RDD_PKTGEN_CURR_SBPM_HDR_PTR_ADDRESS_ARR, 0, core_id);
...
{
    RDD_BYTES_2_BITS_WRITE_CORE(bits, RDD_PKTGEN_NUM_OF_AVAIL_SBPM_HDRS_ADDRESS_ARR, 0, core_id);
...
{
    RDD_BYTES_2_BITS_READ_CORE(*bits, RDD_PKTGEN_NUM_OF_AVAIL_SBPM_HDRS_ADDRESS_ARR, 0, core_id);
...
{
    RDD_BYTES_2_BITS_WRITE_CORE(bits, RDD_PKTGEN_SBPM_END_PTR_ADDRESS_ARR, 0, core_id);
...
{
    RDD_BYTES_2_BITS_READ_CORE(*bits, RDD_PKTGEN_SBPM_END_PTR_ADDRESS_ARR, 0, core_id);
