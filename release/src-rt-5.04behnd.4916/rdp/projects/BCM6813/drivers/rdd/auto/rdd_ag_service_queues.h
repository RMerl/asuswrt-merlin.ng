...
int rdd_ag_service_queues_codel_drop_descriptor_get_core(rdd_codel_drop_descriptor_t *codel_drop_descriptor, int core_id);
int rdd_ag_service_queues_codel_drop_descriptor_set_core(rdd_codel_drop_descriptor_t *codel_drop_descriptor, int core_id);
...
int rdd_ag_service_queues_codel_drop_descriptor_flush_packet_counter_set(uint32_t flush_packet_counter);
int rdd_ag_service_queues_codel_drop_descriptor_flush_packet_counter_set_core(uint32_t flush_packet_counter, int core_id);
int rdd_ag_service_queues_codel_drop_descriptor_flush_packet_counter_get(uint32_t *flush_packet_counter);
int rdd_ag_service_queues_codel_drop_descriptor_flush_packet_counter_get_core(uint32_t *flush_packet_counter, int core_id);
int rdd_ag_service_queues_codel_drop_descriptor_flush_enable_set(uint32_t flush_enable);
int rdd_ag_service_queues_codel_drop_descriptor_flush_enable_set_core(uint32_t flush_enable, int core_id);
int rdd_ag_service_queues_codel_drop_descriptor_flush_enable_get(uint32_t *flush_enable);
int rdd_ag_service_queues_codel_drop_descriptor_flush_enable_get_core(uint32_t *flush_enable, int core_id);
