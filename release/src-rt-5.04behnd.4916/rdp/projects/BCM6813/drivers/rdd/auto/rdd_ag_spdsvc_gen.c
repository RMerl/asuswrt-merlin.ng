...
int rdd_ag_spdsvc_gen_udpspdt_stream_tx_stat_get_core(uint32_t _entry, rdd_udpspdt_stream_tx_stat_t *udpspdt_stream_tx_stat, int core_id)
{
    ...
    RDD_UDPSPDT_STREAM_TX_STAT_TX_DROPS_NO_SPBM_READ_CORE(udpspdt_stream_tx_stat->tx_drops_no_spbm, RDD_UDPSPDT_STREAM_TX_STAT_TABLE_ADDRESS_ARR, _entry, core_id);
...
int rdd_ag_spdsvc_gen_udpspdt_stream_tx_stat_set_core(uint32_t _entry, rdd_udpspdt_stream_tx_stat_t *udpspdt_stream_tx_stat, int core_id)
{
    ...
    RDD_UDPSPDT_STREAM_TX_STAT_TX_DROPS_NO_SPBM_WRITE_CORE(udpspdt_stream_tx_stat->tx_drops_no_spbm, RDD_UDPSPDT_STREAM_TX_STAT_TABLE_ADDRESS_ARR, _entry, core_id);
