...
int rdd_ag_us_tm_codel_drop_descriptor_get(rdd_codel_drop_descriptor_t *codel_drop_descriptor)
{
    ...
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_PACKET_COUNTER_READ_G(codel_drop_descriptor->flush_packet_counter, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0);
    ...
    RDD_CODEL_DROP_DESCRIPTOR_SCRATCHPAD_1_READ_G(codel_drop_descriptor->scratchpad_1, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0);
    RDD_CODEL_DROP_DESCRIPTOR_SCRATCHPAD_2_READ_G(codel_drop_descriptor->scratchpad_2, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0);
...
int rdd_ag_us_tm_codel_drop_descriptor_set(rdd_codel_drop_descriptor_t *codel_drop_descriptor)
{
    ...
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_PACKET_COUNTER_WRITE_G(codel_drop_descriptor->flush_packet_counter, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0);
    ...
    RDD_CODEL_DROP_DESCRIPTOR_SCRATCHPAD_1_WRITE_G(codel_drop_descriptor->scratchpad_1, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0);
    RDD_CODEL_DROP_DESCRIPTOR_SCRATCHPAD_2_WRITE_G(codel_drop_descriptor->scratchpad_2, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0);
...
{
    RDD_CODEL_DROP_DESCRIPTOR_MAX_SEQ_DROPS_READ_CORE(codel_drop_descriptor->max_seq_drops, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_TASK_WAKEUP_VALUE_READ_CORE(codel_drop_descriptor->flush_task_wakeup_value, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_CFG_PTR_READ_CORE(codel_drop_descriptor->flush_cfg_ptr, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_ENABLE_PTR_READ_CORE(codel_drop_descriptor->flush_enable_ptr, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_PACKET_COUNTER_READ_CORE(codel_drop_descriptor->flush_packet_counter, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_ENABLE_READ_CORE(codel_drop_descriptor->flush_enable, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_SCRATCHPAD_1_READ_CORE(codel_drop_descriptor->scratchpad_1, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_SCRATCHPAD_2_READ_CORE(codel_drop_descriptor->scratchpad_2, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
...
{
    RDD_CODEL_DROP_DESCRIPTOR_MAX_SEQ_DROPS_WRITE_CORE(codel_drop_descriptor->max_seq_drops, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_TASK_WAKEUP_VALUE_WRITE_CORE(codel_drop_descriptor->flush_task_wakeup_value, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_CFG_PTR_WRITE_CORE(codel_drop_descriptor->flush_cfg_ptr, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_ENABLE_PTR_WRITE_CORE(codel_drop_descriptor->flush_enable_ptr, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_PACKET_COUNTER_WRITE_CORE(codel_drop_descriptor->flush_packet_counter, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_FLUSH_ENABLE_WRITE_CORE(codel_drop_descriptor->flush_enable, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_SCRATCHPAD_1_WRITE_CORE(codel_drop_descriptor->scratchpad_1, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
    RDD_CODEL_DROP_DESCRIPTOR_SCRATCHPAD_2_WRITE_CORE(codel_drop_descriptor->scratchpad_2, RDD_US_TM_CODEL_DROP_DESCRIPTOR_ADDRESS_ARR, 0, core_id);
