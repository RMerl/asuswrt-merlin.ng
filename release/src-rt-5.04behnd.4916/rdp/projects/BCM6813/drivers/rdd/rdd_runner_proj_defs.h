...
#define RDD_TM_FLOW_CNTR_TABLE_SIZE      (RDD_US_TM_PON_TM_FLOW_CNTR_TABLE_SIZE + RDD_US_TM_ETH_TM_FLOW_CNTR_TABLE_SIZE)
...
#define DS_TM_BUDGET_ALLOCATION_THREAD_NUMBER       IMAGE_0_IMAGE_0_BUDGET_ALLOCATION_DS_THREAD_NUMBER
#define TM_BUDGET_ALLOCATION_US_THREAD_NUMBER       IMAGE_1_IMAGE_1_BUDGET_ALLOCATION_US_THREAD_NUMBER


/* REPORTING */
#define REPORTING_THREAD_NUMBER     IMAGE_7_IMAGE_7_REPORTING_THREAD_NUMBER
#define REPORTING_COUNTER_ADDRESS   IMAGE_7_REPORTING_COUNTER_TABLE_ADDRESS

#define SERVICE_QUEUES_UPDATE_FIFO_THREAD_NUMBER  IMAGE_0_IMAGE_0_SERVICE_QUEUES_UPDATE_FIFO_THREAD_NUMBER
#define SERVICE_QUEUES_AQM_TIMER_THREAD_NUMBER    IMAGE_0_IMAGE_0_SERVICE_QUEUES_AQM_TIMER_THREAD_NUMBER
/* Service queues AQM timer task interval in us */
#define AQM_TIMER_TASK_TIMER_INTERVAL    100

#define US_TM_BUFFER_CONG_MGT_THREAD_NUMBER         IMAGE_1_IMAGE_1_BUFFER_CONG_MGT_THREAD_NUMBER
#define DS_TM_BUFFER_CONG_MGT_THREAD_NUMBER         IMAGE_0_IMAGE_0_BUFFER_CONG_MGT_THREAD_NUMBER
...
#define CPU_TX_MCORE_THREAD_NUMBER                  IMAGE_7_IMAGE_7_CPU_TX_MCORE_THREAD_NUMBER
#define CPU_TX_MCORE_TIMER_TASK                     IMAGE_7_IMAGE_7_GENERAL_TIMER_THREAD_NUMBER
...
#define RDD_US_TM_FLUSH_CFG_FW_TABLE_ADDRESS                IMAGE_1_US_TM_FLUSH_CFG_FW_TABLE_ADDRESS
#define RDD_US_TM_FLUSH_CFG_ENABLE_TABLE_ADDRESS            IMAGE_1_US_TM_FLUSH_CFG_ENABLE_TABLE_ADDRESS
...
#define SPU_RESPONSE_THREAD_NUMBER IMAGE_6_IMAGE_6_SPU_RESPONSE_THREAD_NUMBER
