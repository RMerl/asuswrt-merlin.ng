...
/*  The flag below is used for 'obj_ref' attributes. It disables storing reference to the attribute in the referenced object. 
    In result, deleting the referenced object will not auto-clear the reference from the attribute. 
    The flag is used for performance optimization in scenarios where all references are always removed by the management stack
    before removing the referenced object.*/
#define BDMF_ATTR_NO_REF_USE    0x00800000  /**< No need to manage reference count for this attr */
