...
typedef struct mutex bdmf_mutex;
...
typedef bdmf_linux_ta_mutex bdmf_ta_mutex;
...
#define bdmf_usleep(_us)       udelay(_us)
#define bdmf_msleep(_ms)       mdelay(_ms)
 ...
 */
#define bdmf_print(format,args...)      printk(format, ## args)
