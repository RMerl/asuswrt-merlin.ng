...
#define RDD_PARSER_L2_LKP_ENTRY_CLIENT_IDX_READ_G(r, g, idx)                                    GROUP_RDP_FIELD_MREAD_16((g), (idx)*sizeof(PARSER_L2_LKP_ENTRY_STRUCT) + 14, 4, 8, (r))
#define RDD_PARSER_L2_LKP_ENTRY_CLIENT_IDX_WRITE_G(v, g, idx)                                   GROUP_RDP_FIELD_MWRITE_16((g), (idx)*sizeof(PARSER_L2_LKP_ENTRY_STRUCT) + 14, 4, 8, (v))
#define RDD_PARSER_L2_LKP_ENTRY_CLIENT_IDX_READ_CORE(r, g, idx, core_id)                        CORE_RDP_FIELD_MREAD_16((g), (idx)*sizeof(PARSER_L2_LKP_ENTRY_STRUCT) + 14, 4, 8, (r), core_id)
#define RDD_PARSER_L2_LKP_ENTRY_CLIENT_IDX_WRITE_CORE(v, g, idx, core_id)                       CORE_RDP_FIELD_MWRITE_16((g), (idx)*sizeof(PARSER_L2_LKP_ENTRY_STRUCT) + 14, 4, 8, (v), core_id)
#define RDD_PARSER_L2_LKP_ENTRY_CLIENT_IDX_READ(r, p)                                           RDP_FIELD_MREAD_16((uint8_t *)(p) + 14, 4, 8, (r))
#define RDD_PARSER_L2_LKP_ENTRY_CLIENT_IDX_WRITE(v, p)                                          RDP_FIELD_MWRITE_16((uint8_t *)(p) + 14, 4, 8, (v))
...
typedef union
	...
	union{
        ...
        uint32_t	reservedSU2_reserved3  	:4	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
...
#define RDD_PARSER_RESULTS_PARSER_L2_LKP_ENTRY_CLIENT_IDX_READ_G(r, g, idx)                                          GROUP_RDP_FIELD_MREAD_16((g), (idx)*sizeof(PARSER_RESULTS_STRUCT) + 42, 4, 8, (r))
#define RDD_PARSER_RESULTS_PARSER_L2_LKP_ENTRY_CLIENT_IDX_WRITE_G(v, g, idx)                                         GROUP_RDP_FIELD_MWRITE_16((g), (idx)*sizeof(PARSER_RESULTS_STRUCT) + 42, 4, 8, (v))
#define RDD_PARSER_RESULTS_PARSER_L2_LKP_ENTRY_CLIENT_IDX_READ_CORE(r, g, idx, core_id)                              CORE_RDP_FIELD_MREAD_16((g), (idx)*sizeof(PARSER_RESULTS_STRUCT) + 42, 4, 8, (r), core_id)
#define RDD_PARSER_RESULTS_PARSER_L2_LKP_ENTRY_CLIENT_IDX_WRITE_CORE(v, g, idx, core_id)                             CORE_RDP_FIELD_MWRITE_16((g), (idx)*sizeof(PARSER_RESULTS_STRUCT) + 42, 4, 8, (v), core_id)
#define RDD_PARSER_RESULTS_PARSER_L2_LKP_ENTRY_CLIENT_IDX_READ(r, p)                                                 RDP_FIELD_MREAD_16((uint8_t *)(p) + 42, 4, 8, (r))
#define RDD_PARSER_RESULTS_PARSER_L2_LKP_ENTRY_CLIENT_IDX_WRITE(v, p)                                                RDP_FIELD_MWRITE_16((uint8_t *)(p) + 42, 4, 8, (v))
...
#define RDD_PARSER_RESULTS_PARSER_IC_LKP_ENTRY_RESERVED3_READ_G(r, g, idx)                                           GROUP_RDP_FIELD_MREAD_8((g), (idx)*sizeof(PARSER_RESULTS_STRUCT) + 94, 0, 4, (r))
#define RDD_PARSER_RESULTS_PARSER_IC_LKP_ENTRY_RESERVED3_WRITE_G(v, g, idx)                                          GROUP_RDP_FIELD_MWRITE_8((g), (idx)*sizeof(PARSER_RESULTS_STRUCT) + 94, 0, 4, (v))
#define RDD_PARSER_RESULTS_PARSER_IC_LKP_ENTRY_RESERVED3_READ_CORE(r, g, idx, core_id)                               CORE_RDP_FIELD_MREAD_8((g), (idx)*sizeof(PARSER_RESULTS_STRUCT) + 94, 0, 4, (r), core_id)
#define RDD_PARSER_RESULTS_PARSER_IC_LKP_ENTRY_RESERVED3_WRITE_CORE(v, g, idx, core_id)                              CORE_RDP_FIELD_MWRITE_8((g), (idx)*sizeof(PARSER_RESULTS_STRUCT) + 94, 0, 4, (v), core_id)
#define RDD_PARSER_RESULTS_PARSER_IC_LKP_ENTRY_RESERVED3_READ(r, p)                                                  RDP_FIELD_MREAD_8((uint8_t *)(p) + 94, 0, 4, (r))
#define RDD_PARSER_RESULTS_PARSER_IC_LKP_ENTRY_RESERVED3_WRITE(v, p)                                                 RDP_FIELD_MWRITE_8((uint8_t *)(p) + 94, 0, 4, (v))
...
#define PARSER_L2_LKP_ENTRY_CLIENT_IDX_F_OFFSET                                     4
#define PARSER_L2_LKP_ENTRY_CLIENT_IDX_F_WIDTH                                      8
#define PARSER_L2_LKP_ENTRY_CLIENT_IDX_OFFSET                                       14
#define PARSER_L2_LKP_ENTRY_CLIENT_IDX_WORD_OFFSET                                  3
#define PARSER_L2_LKP_ENTRY_CLIENT_IDX_F_OFFSET_MOD16                               4
...
#define PARSER_RESULTS_PARSER_L2_LKP_ENTRY_CLIENT_IDX_F_OFFSET                 4
#define PARSER_RESULTS_PARSER_L2_LKP_ENTRY_CLIENT_IDX_F_WIDTH                  8
#define PARSER_RESULTS_PARSER_L2_LKP_ENTRY_CLIENT_IDX_OFFSET                   42
#define PARSER_RESULTS_PARSER_L2_LKP_ENTRY_CLIENT_IDX_WORD_OFFSET              10
#define PARSER_RESULTS_PARSER_L2_LKP_ENTRY_CLIENT_IDX_F_OFFSET_MOD16           4
...
#define PARSER_RESULTS_PARSER_IC_LKP_ENTRY_RESERVED3_F_OFFSET                  8
#define PARSER_RESULTS_PARSER_IC_LKP_ENTRY_RESERVED3_F_WIDTH                   4
...
#define PARSER_RESULTS_PARSER_IC_LKP_ENTRY_RESERVED3_F_OFFSET_MOD8             0
#define PARSER_RESULTS_PARSER_IC_LKP_ENTRY_RESERVED3_F_OFFSET_MOD16            8
