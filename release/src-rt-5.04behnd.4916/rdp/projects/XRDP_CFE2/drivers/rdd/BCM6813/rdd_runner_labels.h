...
#define image_0_cpu_tx_wakeup_request        (0x4d8)
...
#define image_0_start_task_cpu_tx_wakeup_request        (0x4d8)
...
#define image_0_cpu_tx_wakeup_request        (0x136)
...
#define image_0_start_task_cpu_tx_wakeup_request        (0x136)
