...
typedef union
	...
	union{
        ...
        uint32_t	reservedSU1_reserved6       	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
        ...
        uint32_t	reservedSU2_reserved6       	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
        ...
        uint32_t	reservedSU3_reserved6       	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
	...
	union{
        ...
        uint32_t	ssid              	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
        uint32_t	bn1_or_fpm        	:14	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* This is a field union */
		};
		/* Sub Union 1 */
		struct{
        uint32_t	reservedSU1_error           	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
        ...
        uint32_t	flow                        	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of ingress_port union */
        uint32_t	reservedSU1_reserved8       	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
        uint32_t	reservedSU1_ssid            	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
        uint32_t	bn1_last                    	:14	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of bn1_or_fpm union */
		};
		/* Sub Union 2 */
		struct{
        uint32_t	reservedSU2_error           	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
        ...
        uint32_t	source_port                 	:8	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of ingress_port union */
        uint32_t	reservedSU2_reserved8       	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
        uint32_t	reservedSU2_ssid            	:3	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
        uint32_t	bn1_last_truncated          	:14	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of bn1_or_fpm union */
		};
	};
	/* Union WORD 3 */
	union{
        ...
        uint32_t	reservedSU3_target_mem_0    	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__;
        uint32_t	reserved4                   	:1	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of payload_offset_sop union */
        uint32_t	abs_0                       	:29	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of payload_offset_sop union */
		};
		/* Sub Union 4 */
		struct{
        ...
        uint32_t	reserved5                   	:10	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of payload_offset_sop union */
        uint32_t	bn_fpm_pool                 	:2	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of payload_offset_sop union */
        uint32_t	bn_fpm_num                  	:18	__PACKING_ATTRIBUTE_FIELD_LEVEL__; /* Member of payload_offset_sop union */
		};
	};
#else
	/* Union WORD 0 */
...
#define RDD_PROCESSING_RX_DESCRIPTOR_SSID_READ_G(r, g, idx)                                              GROUP_RDP_FIELD_MREAD_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 8, 14, 3, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_SSID_WRITE_G(v, g, idx)                                             GROUP_RDP_FIELD_MWRITE_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 8, 14, 3, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_SSID_READ_CORE(r, g, idx, core_id)                                  CORE_RDP_FIELD_MREAD_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 8, 14, 3, (r), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_SSID_WRITE_CORE(v, g, idx, core_id)                                 CORE_RDP_FIELD_MWRITE_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 8, 14, 3, (v), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_SSID_READ(r, p)                                                     RDP_FIELD_MREAD_32((uint8_t *)(p) + 8, 14, 3, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_SSID_WRITE(v, p)                                                    RDP_FIELD_MWRITE_32((uint8_t *)(p) + 8, 14, 3, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_OR_FPM_READ_G(r, g, idx)                                        GROUP_RDP_FIELD_MREAD_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 10, 0, 14, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_OR_FPM_WRITE_G(v, g, idx)                                       GROUP_RDP_FIELD_MWRITE_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 10, 0, 14, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_OR_FPM_READ_CORE(r, g, idx, core_id)                            CORE_RDP_FIELD_MREAD_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 10, 0, 14, (r), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_OR_FPM_WRITE_CORE(v, g, idx, core_id)                           CORE_RDP_FIELD_MWRITE_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 10, 0, 14, (v), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_OR_FPM_READ(r, p)                                               RDP_FIELD_MREAD_16((uint8_t *)(p) + 10, 0, 14, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_OR_FPM_WRITE(v, p)                                              RDP_FIELD_MWRITE_16((uint8_t *)(p) + 10, 0, 14, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_LAST_READ_G(r, g, idx)                                          GROUP_RDP_FIELD_MREAD_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 10, 0, 14, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_LAST_WRITE_G(v, g, idx)                                         GROUP_RDP_FIELD_MWRITE_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 10, 0, 14, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_LAST_READ_CORE(r, g, idx, core_id)                              CORE_RDP_FIELD_MREAD_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 10, 0, 14, (r), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_LAST_WRITE_CORE(v, g, idx, core_id)                             CORE_RDP_FIELD_MWRITE_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 10, 0, 14, (v), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_LAST_READ(r, p)                                                 RDP_FIELD_MREAD_16((uint8_t *)(p) + 10, 0, 14, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_LAST_WRITE(v, p)                                                RDP_FIELD_MWRITE_16((uint8_t *)(p) + 10, 0, 14, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_LAST_TRUNCATED_READ_G(r, g, idx)                                GROUP_RDP_FIELD_MREAD_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 10, 0, 14, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_LAST_TRUNCATED_WRITE_G(v, g, idx)                               GROUP_RDP_FIELD_MWRITE_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 10, 0, 14, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_LAST_TRUNCATED_READ_CORE(r, g, idx, core_id)                    CORE_RDP_FIELD_MREAD_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 10, 0, 14, (r), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_LAST_TRUNCATED_WRITE_CORE(v, g, idx, core_id)                   CORE_RDP_FIELD_MWRITE_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 10, 0, 14, (v), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_LAST_TRUNCATED_READ(r, p)                                       RDP_FIELD_MREAD_16((uint8_t *)(p) + 10, 0, 14, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN1_LAST_TRUNCATED_WRITE(v, p)                                      RDP_FIELD_MWRITE_16((uint8_t *)(p) + 10, 0, 14, (v))
...
#define RDD_PROCESSING_RX_DESCRIPTOR_SOP_FPM_READ_G(r, g, idx)                                           GROUP_RDP_FIELD_MREAD_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 4, 10, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_SOP_FPM_WRITE_G(v, g, idx)                                          GROUP_RDP_FIELD_MWRITE_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 4, 10, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_SOP_FPM_READ_CORE(r, g, idx, core_id)                               CORE_RDP_FIELD_MREAD_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 4, 10, (r), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_SOP_FPM_WRITE_CORE(v, g, idx, core_id)                              CORE_RDP_FIELD_MWRITE_16((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 4, 10, (v), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_SOP_FPM_READ(r, p)                                                  RDP_FIELD_MREAD_16((uint8_t *)(p) + 12, 4, 10, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_SOP_FPM_WRITE(v, p)                                                 RDP_FIELD_MWRITE_16((uint8_t *)(p) + 12, 4, 10, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_READ_G(r, g, idx)                                            GROUP_RDP_FIELD_MREAD_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 0, 20, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_WRITE_G(v, g, idx)                                           GROUP_RDP_FIELD_MWRITE_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 0, 20, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_READ_CORE(r, g, idx, core_id)                                CORE_RDP_FIELD_MREAD_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 0, 20, (r), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_WRITE_CORE(v, g, idx, core_id)                               CORE_RDP_FIELD_MWRITE_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 0, 20, (v), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_READ(r, p)                                                   RDP_FIELD_MREAD_32((uint8_t *)(p) + 12, 0, 20, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_WRITE(v, p)                                                  RDP_FIELD_MWRITE_32((uint8_t *)(p) + 12, 0, 20, (v))
...
#define RDD_PROCESSING_RX_DESCRIPTOR_ABS_0_READ_G(r, g, idx)                                             GROUP_RDP_FIELD_MREAD_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 0, 29, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_ABS_0_WRITE_G(v, g, idx)                                            GROUP_RDP_FIELD_MWRITE_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 0, 29, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_ABS_0_READ_CORE(r, g, idx, core_id)                                 CORE_RDP_FIELD_MREAD_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 0, 29, (r), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_ABS_0_WRITE_CORE(v, g, idx, core_id)                                CORE_RDP_FIELD_MWRITE_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 0, 29, (v), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_ABS_0_READ(r, p)                                                    RDP_FIELD_MREAD_32((uint8_t *)(p) + 12, 0, 29, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_ABS_0_WRITE(v, p)                                                   RDP_FIELD_MWRITE_32((uint8_t *)(p) + 12, 0, 29, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_POOL_READ_G(r, g, idx)                                       GROUP_RDP_FIELD_MREAD_8((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 13, 2, 2, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_POOL_WRITE_G(v, g, idx)                                      GROUP_RDP_FIELD_MWRITE_8((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 13, 2, 2, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_POOL_READ_CORE(r, g, idx, core_id)                           CORE_RDP_FIELD_MREAD_8((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 13, 2, 2, (r), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_POOL_WRITE_CORE(v, g, idx, core_id)                          CORE_RDP_FIELD_MWRITE_8((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 13, 2, 2, (v), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_POOL_READ(r, p)                                              RDP_FIELD_MREAD_8((uint8_t *)(p) + 13, 2, 2, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_POOL_WRITE(v, p)                                             RDP_FIELD_MWRITE_8((uint8_t *)(p) + 13, 2, 2, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_NUM_READ_G(r, g, idx)                                        GROUP_RDP_FIELD_MREAD_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 0, 18, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_NUM_WRITE_G(v, g, idx)                                       GROUP_RDP_FIELD_MWRITE_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 0, 18, (v))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_NUM_READ_CORE(r, g, idx, core_id)                            CORE_RDP_FIELD_MREAD_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 0, 18, (r), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_NUM_WRITE_CORE(v, g, idx, core_id)                           CORE_RDP_FIELD_MWRITE_32((g), (idx)*sizeof(PROCESSING_RX_DESCRIPTOR_STRUCT) + 12, 0, 18, (v), core_id)
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_NUM_READ(r, p)                                               RDP_FIELD_MREAD_32((uint8_t *)(p) + 12, 0, 18, (r))
#define RDD_PROCESSING_RX_DESCRIPTOR_BN_FPM_NUM_WRITE(v, p)                                              RDP_FIELD_MWRITE_32((uint8_t *)(p) + 12, 0, 18, (v))
/* <<<PROCESSING_RX_DESCRIPTOR_STRUCT */
