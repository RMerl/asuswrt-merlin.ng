...
/* >>>RDD_US_TM_BBH_TX_EGRESS_COUNTER_TABLE1_ADDRESS_ARR */
uint32_t RDD_US_TM_BBH_TX_EGRESS_COUNTER_TABLE1_ADDRESS_ARR[NUM_OF_RUNNER_CORES] = {
	0x1c0,
};
/* <<<RDD_US_TM_BBH_TX_EGRESS_COUNTER_TABLE1_ADDRESS_ARR */


/* >>>RDD_DS_TM_BBH_TX_EGRESS_COUNTER_TABLE1_ADDRESS_ARR */
uint32_t RDD_DS_TM_BBH_TX_EGRESS_COUNTER_TABLE1_ADDRESS_ARR[NUM_OF_RUNNER_CORES] = {
	0x200,
};
/* <<<RDD_DS_TM_BBH_TX_EGRESS_COUNTER_TABLE1_ADDRESS_ARR */


/* >>>RDD_US_TM_BBH_TX_EGRESS_COUNTER_TABLE2_ADDRESS_ARR */
uint32_t RDD_US_TM_BBH_TX_EGRESS_COUNTER_TABLE2_ADDRESS_ARR[NUM_OF_RUNNER_CORES] = {
	0x240,
};
/* <<<RDD_US_TM_BBH_TX_EGRESS_COUNTER_TABLE2_ADDRESS_ARR */


/* >>>RDD_DS_TM_BBH_TX_EGRESS_COUNTER_TABLE2_ADDRESS_ARR */
uint32_t RDD_DS_TM_BBH_TX_EGRESS_COUNTER_TABLE2_ADDRESS_ARR[NUM_OF_RUNNER_CORES] = {
	0x280,
};
/* <<<RDD_DS_TM_BBH_TX_EGRESS_COUNTER_TABLE2_ADDRESS_ARR */
