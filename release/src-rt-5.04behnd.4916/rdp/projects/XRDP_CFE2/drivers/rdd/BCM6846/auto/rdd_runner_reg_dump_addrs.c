...
static DUMP_RUNNERREG_STRUCT BBH_TX_RING_TABLE =
{
	16,
	{
		{ dump_RDD_BBH_TX_DESCRIPTOR, 0x50 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BBH_TX_BB_DESTINATION_TABLE =
{
	4,
	{
		{ dump_RDD_BB_DESTINATION_ENTRY, 0xdc },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined XRDP_CFE
static DUMP_RUNNERREG_STRUCT US_TM_BBH_TX_EGRESS_COUNTER_TABLE1 =
{
	8,
	{
		{ dump_RDD_BBH_TX_EGRESS_COUNTER_ENTRY, 0x1c0 },
		{ 0, 0 },
	}
};
#endif
#if defined XRDP_CFE
static DUMP_RUNNERREG_STRUCT DS_TM_BBH_TX_EGRESS_COUNTER_TABLE1 =
{
	8,
	{
		{ dump_RDD_BBH_TX_EGRESS_COUNTER_ENTRY, 0x200 },
		{ 0, 0 },
	}
};
#endif
#if defined XRDP_CFE
static DUMP_RUNNERREG_STRUCT US_TM_BBH_TX_EGRESS_COUNTER_TABLE2 =
{
	8,
	{
		{ dump_RDD_BBH_TX_EGRESS_COUNTER_ENTRY, 0x240 },
		{ 0, 0 },
	}
};
#endif
#if defined XRDP_CFE
static DUMP_RUNNERREG_STRUCT DS_TM_BBH_TX_EGRESS_COUNTER_TABLE2 =
{
	8,
	{
		{ dump_RDD_BBH_TX_EGRESS_COUNTER_ENTRY, 0x280 },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined XRDP_CFE
	{ "US_TM_BBH_TX_EGRESS_COUNTER_TABLE1", 1, CORE_0_INDEX, &US_TM_BBH_TX_EGRESS_COUNTER_TABLE1, 8, 1, 1 },
#endif
#if defined XRDP_CFE
	{ "DS_TM_BBH_TX_EGRESS_COUNTER_TABLE1", 1, CORE_0_INDEX, &DS_TM_BBH_TX_EGRESS_COUNTER_TABLE1, 8, 1, 1 },
#endif
#if defined XRDP_CFE
	{ "US_TM_BBH_TX_EGRESS_COUNTER_TABLE2", 1, CORE_0_INDEX, &US_TM_BBH_TX_EGRESS_COUNTER_TABLE2, 8, 1, 1 },
#endif
#if defined XRDP_CFE
	{ "DS_TM_BBH_TX_EGRESS_COUNTER_TABLE2", 1, CORE_0_INDEX, &DS_TM_BBH_TX_EGRESS_COUNTER_TABLE2, 8, 1, 1 },
#endif
#if defined XRDP_CFE
