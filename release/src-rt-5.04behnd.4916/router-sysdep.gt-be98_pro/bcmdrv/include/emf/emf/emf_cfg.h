...
#define EMFCFG_CMD_IF_LIST_IPV6     20
#define EMFCFG_CMD_EMF_STATS_IPV6   21

#define MACF                        "%02x:%02x:%02x:%02x:%02x:%02x"
#define MAC_TO_MACF(addr)           addr[0], addr[1], addr[2], \
...
#ifdef CMWIFI_WMF_IPV6
int32 emf_instance_append(void *p, uint8 *inst_id);
int32 emf_instance_unlink(uint8 *inst_id);
#endif /* CMWIFI_WMF_IPV6 */
#endif /* _EMF_CFG_H_ */
