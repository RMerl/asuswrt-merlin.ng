...
# voice disabled - remove MTA related compilation
DEPENDS_remove = "${@bb.utils.contains('BRCM_VOICE_ENABLE', 'n', 'ccsp-mta-agent', '', d)}"
SRC_URI_append += "${@bb.utils.contains('BRCM_VOICE_ENABLE', 'n', 'file://0002-fix-TDK-compiling-issue.patch', '', d)}"
