...
/****************************************************************************
 *
 * Putting these defines here for a lack of a better, centralized place.
 * These defs are used by tr69c and obuspa.
 *
 ****************************************************************************/

// Note that there are a bunch of similar defs in tr69c/inc/tr69cdefs.h.
// Must keep these defs in sync.

#define CMSPSP_VENDOR_CFG_TOKEN     "vendorCfg"
