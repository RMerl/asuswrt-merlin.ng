 ...
 *  be configured  as either LAN or WAN (preferred).
 *  This function is deprecated, call bcm_enet_driver_getWanPreferredPortIfNameList() instead.
 *  TODO: Delete in 5.04L.03.
 *
 *  @param WanPreferredPortIfNameList (OUT) Pointer to char * of pWanPreferredPortIfNameList.
 *              This function will malloc() a buffer big enough to hold a list
...
/** Get number of LAN Wan Eth interface names in the system.
 *
 ...
 *  @return BcmRet code.
 */
BcmRet ethswUtil_getLANWanEthPortNumByPrefix(const char *prefix,
