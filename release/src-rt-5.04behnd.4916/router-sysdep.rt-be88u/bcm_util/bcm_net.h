 ...
 * If failed to get the value from uboot or the value is not true or false, return 0.
 */
int bcmNet_getNodhcpVar(char* nodhcp, int len);

/*
 *  Function: This function will return wanType string.
 *  @param wanType (IN) a string to hold the wanType string
 *  @param wanType (IN) len of string wanType can hold
 *  @return 0 on success, -1 on error
 */
