...
typedef struct emfc_wrapper
{
	...
	/* Function used retrieve the mapping mac address for the ifp.
	 * Initially set to NULL for non-WMF instance */
	int32	(*mfdb_ifinfo_mac_map_fn) (void *ifp, uint8 *out_mac);
