...
#define INTERRUPT_WAN_GPON_TX             (SPI_TABLE_OFFSET + 140)
#define INTERRUPT_WAN_GPON_RX             (SPI_TABLE_OFFSET + 141)
#define INTERRUPT_WAN_XGRX                (SPI_TABLE_OFFSET + 129)
#define INTERRUPT_WAN_XGTX_INTR2          (SPI_TABLE_OFFSET + 131)
#define INTERRUPT_WAN_XGTX_INTR1          (SPI_TABLE_OFFSET + 132)
#define INTERRUPT_WAN_XGTX_INTR0          (SPI_TABLE_OFFSET + 133)
