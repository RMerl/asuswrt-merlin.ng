...
#ifndef __6888_INTR_H
#define __6888_INTR_H
...
/*=====================================================================*/
#define INTERRUPT_ID_DG                   _2MAP(INTERRUPT_DYING_GASP_IRQ)
#define INTERRUPT_ID_NAND_FLASH           _2MAP(INTERRUPT_NAND_FLASH_IRQ)
