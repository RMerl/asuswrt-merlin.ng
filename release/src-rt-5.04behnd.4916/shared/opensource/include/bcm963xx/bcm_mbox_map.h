...
/* mailbox mappings per platform */ 
extern unsigned int __iomem *mbox_base;
   ...
   || defined(_BCM94912_) || defined(CONFIG_BCM94912) \
   || defined(_BCM96813_) || defined(CONFIG_BCM96813) \
   || defined(_BCM96756_) || defined(CONFIG_BCM96756) || defined(CONFIG_BCM96888)
 
/* mbox_base: MISC->miscSWdebugNW */
/* since this is only for CFE based image, just define the base address 
   directly here, instead of adding it to all the chip dtsi file */
#if defined(CONFIG_BCM96813) || defined(CONFIG_BCM96756) || defined(CONFIG_BCM947622) ||\
    defined(CONFIG_BCM963158) || defined(CONFIG_BCM94912) || defined(CONFIG_BCM963178) ||\
    defined(CONFIG_BCM963146) || defined(CONFIG_BCM96855) || defined(CONFIG_BCM96878) ||\
    defined(CONFIG_BCM96888)
#define BCM_MBOX_PHY_BASE                       0xff802628
#elif defined(CONFIG_BCM96846) || defined(CONFIG_BCM96856)
#define BCM_MBOX_PHY_BASE                       0xff80263c
#elif defined(CONFIG_BCM96858)
#define BCM_MBOX_PHY_BASE                       0xff802624
#endif
#define BCM_MBOX_SIZE                           0x8
  
/* bit 31 of this register is used for BOOT_INACTIVE_IMAGE_ONCE_REG */
#define BCM_MBOX                                *mbox_base /* MISC->miscSWdebugNW[0] */
#define BCM_MBOX1                               *(mbox_base+1) /* MISC->miscSWdebugNW[1] */
...
#define BCM_MBOX_PHY_BASE                       0xfffe9000
#elif defined(CONFIG_BCM94908)
#define BCM_MBOX_PHY_BASE                       0xff801000
#endif
#define BCM_MBOX_SIZE                           0x200
...
#define BCM_MBOX1                                *(mbox_base+126) /* HS_SPI_PROFILES[7].polling_timeout */
#define BCM_MBOX                                 *(mbox_base+124) /* HS_SPI_PROFILES[7].polling_and_mask */

#define HS_SPI_GLB_CTRL                          *mbox_base /* HS_SPI->hs_spiGlobalCtrl */
