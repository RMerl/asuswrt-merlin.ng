...
#if defined (_BCM94912_) || defined(_BCM96813_)
#define BTRM_SBI_AUTH_HDR_MAX_SIZE              (8*1024)
#define BTRM_SBI_IMAGE_MAX_ALLOWED_SIZE		(256*1024)

#elif defined(_BCM96846_) || defined(_BCM6856_) || defined (_BCM963178_) || defined (_BCM947622_) || \
      defined (_BCM963146_) || defined (_BCM96756_)
#define BTRM_SBI_AUTH_HDR_MAX_SIZE              (8*1024)
