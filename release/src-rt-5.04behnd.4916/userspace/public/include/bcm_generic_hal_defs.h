...
// Typically, this struct is returned in an array.  See cmsUtl_freeParamInfoArray() for
// helper function to free it.
typedef struct {
   char   *fullpath;
...
// Typically, this struct is returned in an array.  See cmsUtl_freeParamAttrArray() for
// helper function to free it.
typedef struct {
   char  *fullpath;
...
// These values are the generic equivalents to NDA_TR69_xxx_NOTIFICATION in 
// cms_mdm.h, used in the notif field in BcmGenericParamAttr.
#define GENATTR_NO_NOTIFICATION      0
#define GENATTR_PASSIVE_NOTIFICATION 1
#define GENATTR_ACTIVE_NOTIFICATION  2
#define GENATTR_CLEAR_NOTIFICATION   64
...
// Clear counters in the statistics object.  This is a legacy feature of
// some Broadcom objects which track statistics.  Not all statistics objects
// support clearing of statistics.
#define BCM_DATABASEOP_CLEAR_STATISTICS               "clearStatistics"
#define BCM_DATABASEOP_CLEAR_STATISTICS_LOCAL         "clearStatisticsLocal"
...
// For BCM_DATABASEOP_GET_CHANGED_PARAMS_LOCAL and
// BCM_DATABASEOP_GET_ALT_CHANGED_PARAMS_LOCAL, when we send the changed values
// over the bus, the format is:
// <_DELIM_>fullpath,type,value</_DELIM_><_DELIM_>fullpath,type,value</_DELIM_>
// This allows us to send values which contain commas, but means values
// must not contain the string </_DELIM_>, which is highly unlikely.
#define BCM_DATABASEOP_DELIM_BEGIN      "<_DELIM_>"
#define BCM_DATABASEOP_DELIM_END        "</_DELIM_>"
#define BCM_DATABASEOP_DELIM_BEGIN_LEN  9
#define BCM_DATABASEOP_DELIM_END_LEN    10
