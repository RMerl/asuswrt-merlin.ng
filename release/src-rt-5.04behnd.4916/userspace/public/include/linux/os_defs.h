...
/** Decimal string representation of decimal data.
 * We decided to use char * instead of float or double because a string can represent very large value, 
 * whereas float and double have a max value.
 *
 * This is to support TR69 data types.
 */
...
#if !defined(MAC_ADDR_LEN) /* obuspa also defined this */
