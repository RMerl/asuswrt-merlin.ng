...
typedef enum
{
   ...
   LOG_DEST_UNKNOWN = 100  /**< Unknown setting in bcmuLog */
} CmsLogDestination;
...
#define CMSLOG_HDRMASK_THREAD_ID  0x0010
 ...
 */
#define CMSLOG_HDRMASK_DATETIME   0x0020
...
/** Convert cmsLogDestination enum to a bcmuLog dest mask.
 * @param cmsLogDestination (IN) message logging destination.
 * @return The bcmuLog dest mask.
 */
