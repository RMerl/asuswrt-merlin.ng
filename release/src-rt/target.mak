...
export RT-BE92U += BUILD_NAME="RT-BE92U" EXT_PHY="BCM84880" NVSIZE="192" DHDAP=n HND_WL=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y \
		...
		FRS_LIVE_UPDATE=n ASUSCTRL=y HAS_5G_2=n CAPTCHA=y OUTFOX=y AMAS_ETHDETECT=y INSTANT_GUARD=y AVBLCHAN=y ACL96=y OWE_TRANS=y \
		EXTEND_LIMIT=y GOOGLE_ASST=y WIREGUARD=y BCMBSD_V2=y SW_CTRL_ALLLED=y COMFW=y WIFI7=y BW320M=y PC_SCHED_V3=y MULTISERVICE_WAN=y \
