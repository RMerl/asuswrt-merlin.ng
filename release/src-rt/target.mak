...
export RT-AC68U_BASE := IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
			...
			CONNDIAG=y NFCM=n FORCE_AUTO_UPGRADE=n FORCE_ROAMING=y BCN_RPT=y BTM_11V=y OOKLA=y FTP_SSL=y \
...
export HND-94908_BASE := HND_ROUTER=y PROFILE="94908HND" SW_HW_AUTH=y AMAS=y UTF8_SSID=y ETHOBD=y DWB=y SAMBA3="3.6.x" \
			 CONNDIAG=y OOKLA=y WL_SCHED_V3=y FTP_SSL=y
...
export GT-AX11000 += BUILD_NAME="GT-AX11000" EXT_PHY="BCM84880" SWITCH2="" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
		...
		BCM_CEVENTD=y UTF8_SSID=y RGBLED=y AURASYNC=y I2CTOOLS=y AMAS=y DBLOG=y ETHOBD=y CONNDIAG=y NFCM=n \
...
export HND-963178_BASE := HND_ROUTER=y PROFILE="96750GW" SAMBA3="3.6.x" OOKLA=y WL_SCHED_V3=y FTP_SSL=y
...
export HND-947622_BASE := HND_ROUTER=y PROFILE="947622GW" SAMBA3="3.6.x" OOKLA=y WL_SCHED_V3=y FTP_SSL=y
...
export HND-962118_BASE := HND_ROUTER=y PROFILE="962118GW" SAMBA3="3.6.x" TFAT=y NTFS="tuxera" FTP_SSL=y \
...
export RT-AX68U += BUILD_NAME="RT-AX68U" NVSIZE="128" DHDAP=n HND_WL=y DPSTA=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
		...
		CFGSYNC_LOCSYNC=y CONNDIAG=y NFCM=n CRASHLOG=y BRCM_HOSTAPD=y IPERF3=y FRS_LIVE_UPDATE=n BCN_RPT=y \
...
export RT-AC88U_BASE := IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=3.6.x \
		...
		UUPLUGIN=y SW_CTRL_ALLLED=y OOKLA=y WL_SCHED_V3=y FTP_SSL=y \
		NFS=y DNSFILTER=y SNMPD=y TOR=y UPNPIGD2=n NANO=y OPENSSL11=y NTPD=y DNSPRIVACY=y \
