 ...
 */
pjsip_generic_string_hdr* pjsua_im_create_rport(pj_pool_t *pool, pj_str_t *rport);

/**
 * Create timeout header for MESSAGE.
 */
pjsip_generic_string_hdr* pjsua_im_create_timeout(pj_pool_t *pool, pj_str_t *timeout);
