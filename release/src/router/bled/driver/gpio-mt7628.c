...
/* copy from rt_mmap.h, ralink_gpio.h */
 ...
 ///linux-2.6.36.x/arch/mips/include/asm/mach-ralink/rt_mmap.h
#define RALINK_PIO_BASE			0xB0000600
 //linux-2.6.36.x/drivers/char/ralink_gpio.h
...
static int get_gpio_register(int gpio_nr, int value, u32 *reg, u32 *mask)
{
	...
	if (!reg || !mask)
		return -1;
	for (p = &gpio_reg_tbl[0]; p->start >= 0; ++p) {
