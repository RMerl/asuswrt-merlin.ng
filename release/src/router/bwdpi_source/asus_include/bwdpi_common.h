...
*/
#if defined(RTCONFIG_SOC_IPQ8064) || defined(RTCONFIG_QCA956X) || (defined(RTCONFIG_RALINK) && !defined(RTCONFIG_RALINK_MT7622) && !defined(RTCONFIG_RALINK_MT7621) && !defined(RTCONFIG_MT798X)) \
