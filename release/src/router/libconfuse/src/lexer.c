...
void cfg_yyset_in  (FILE * _in_str  );

FILE *cfg_yyget_out (void );

void cfg_yyset_out  (FILE * _out_str  );
...
void cfg_yyset_lineno (int _line_number  );
...
void cfg_yyset_debug (int  _bdebug )
{
        cfg_yy_flex_debug = _bdebug ;
}
