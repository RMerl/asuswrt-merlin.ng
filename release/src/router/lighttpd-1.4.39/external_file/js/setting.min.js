...
var e=a+"/"+$(this).attr("url")+"/"+b,f=$(this).attr("createtime"),g=$(this).attr("expiretime"),k=parseFloat($(this).attr("lefttime")),h=parseInt(k/3600),q=parseInt(k%3600/60);c+="<tr nid='"+i+"' class='even'>";c+="<td fid='check' align='center'><input type='checkbox' id='check_del' name='check_del' class='check_del' link=\""+$(this).attr("url")+'"></td>';c+="<td fid='filename' align='center'><div style='overflow:hidden;'>";c+="<a class='share_link_url' uhref=\""+e+"\" href='#' title=\""+d+"\" style='white-space:nowrap;'>"+
d+"</a>";c+="</div></td>";c+="<td fid='createtime' align='center'>"+f+"</td>";g==0?(c+="<td fid='expiretime' align='center'>"+m.getString("title_unlimited")+"</td>",c+="<td fid='lefttime' align='center'>"+m.getString("title_unlimited")+"</td>"):(c+="<td fid='expiretime' align='center'>"+g+"</td>",c+="<td fid='lefttime' align='center'>"+h+" hours "+q+" mins</td>");c+="<td fid='remove' align='center'><a>";c+="<div class='dellink' title='remove' link=\""+$(this).attr("url")+"\" style='cursor:pointer'></div>";
c+="</a></td>";c+="</tr>"}catch(r){}i++});c+="</tbody>";c+="</table>";c+="<div class='delcheck_block'>";c+="<span>\u522a\u9664\u9078\u53d6\u9023\u7d50</span>";c+="</div>";$("#tab2").html(encodeSafeString(c));$("div.delcheck_block").css("visibility","hidden");$("a.share_link_url").click(function(){$("#filelink").css("display","block");$("#filelink").css("left",tempX);tempY+$("#filelink").height()>$("body").height()?$("#filelink").css("top",$("body").height()-$("#filelink").height()):$("#filelink").css("top",
