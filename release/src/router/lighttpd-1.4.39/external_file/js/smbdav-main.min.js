...
l!=""?(t=l,q=l=mydecodeURI(l)):g=""):g="");g!=""&&(h=="httpd/unix-directory"?g_folder_array.push({contenttype:h,furl:g,name:l,uname:t,shortname:q,online:v,time:y,size:s,ip:o,mac:k,uid:n,type:w,freadonly:z,fhidden:u,routersyncfolder:x,matadatatitle:B,thumb:C}):g_file_array.push({contenttype:h,furl:g,name:l,uname:t,shortname:q,online:v,time:y,size:s,ip:o,mac:k,uid:n,type:w,freadonly:z,fhidden:u,routersyncfolder:x,matadatatitle:B,thumb:C}))}}}
...
String(r[g].childNodes[0].nodeValue);else if(r[g].nodeName=="D:getattr"){var p=r[g].childNodes;for(h=0;h<p.length;h++)if(p[h].nodeName=="D:readonly")t=p[h].childNodes[0].nodeValue;else if(p[h].nodeName=="D:hidden")x=p[h].childNodes[0].nodeValue}}}else C[j].nodeType==1&&C[j].nodeName=="D:href"&&(n=String(C[j].childNodes[0].nodeValue),d="",n.match(/^http/)&&(d=g_storage.get("request_host_url")),g=d+addPathSlash("/"),n!=g?(n=n.replace(d,""),v=n.substring(n.lastIndexOf("/")+1,n.length),v!=""?(B=v,y=v=
mydecodeURI(v),d=g_list_view.get()==0?12:45,y.length>d&&(y=y.substring(0,d)+"...")):n=""):n="");n!=""&&l=="httpd/unix-directory"&&a.push({contenttype:l,href:n,name:v,uname:B,shortname:y,online:s,time:o,size:k,ip:w,mac:z,uid:q,type:u,freadonly:t,fhidden:x})}a.sort(sortByName);for(B=0;B<a.length;B++)a[B].type=="usbdisk"&&arraymove(a,B,0);createHostList(e,a)}},null,1)}catch(a){alert("catch error: "+a)}}function sortByName(a,b){var c=a.name.toLowerCase(),e=b.name.toLowerCase();return c<e?-1:c>e?1:0}
...
h=g_storage.get("lan_https_port"),n=g_storage.get("request_host_url"),l="http",q=c;n.indexOf("://")!=-1&&(n=n.substr(n.indexOf("://")+3));b==0&&!isPrivateIP()?alert(m.getString("msg_no_config")):(a==1?(l="https",q=d):(l="http",q=c),isPrivateIP()?(b=l+"://"+n.split(":")[0],a==1?b+=":"+h:g&&(b+=":"+g)):(b=l+"://"+n.split(":")[0],q!=""&&(b+=":"+q)),window.location=b)}else a=="rescan_samba"?confirmCancelUploadFile()!=0&&(a=confirm(m.getString("title_desc_rescan")),a==!0&&doRescanSamba()):a=="sharelink"?
...
"onselectstart"in document.documentElement;if(!a.ui||!a.ui.widget){var j=a.cleanData;a.cleanData=function(b){for(var c=0,d;(d=b[c])!=null;c++)try{a(d).triggerHandler("remove")}catch(e){}j(b)}}var d=null,g=!1,h=a(window),n=0,l={},q={},v={},y={selector:null,appendTo:null,trigger:"right",autoHide:!1,delay:200,reposition:!0,determinePosition:function(b){if(a.ui&&a.ui.position)b.css("display","block").position({my:"center top",at:"center bottom",of:this,offset:"0 5",collision:"fit"}).css("display","none");
...
e.context=o.get(0),h=e.context!==document);switch(c){case "create":if(!e.selector)throw Error("No selector specified");if(e.selector.match(/.context-menu-(list|item|input)($|\s)/))throw Error('Cannot bind to selector "'+e.selector+'" as it contains a reserved className');if(!e.build&&(!e.items||a.isEmptyObject(e.items)))throw Error("No Items specified");n++;e.ns=".contextMenu"+n;if(!h)l[e.selector]=e.ns;q[e.ns]=e;if(!e.trigger)e.trigger="right";g||(f.on({"contextmenu:hide.contextMenu":k.hideMenu,
...
null}f.off(l[e.selector])}}else f.off(".contextMenu .contextMenuAutoHide"),a.each(q,function(b,c){a(c.context).off(c.ns)}),l={},q={},n=0,g=!1,a("#context-menu-layer, .context-menu-list").remove();break;case "html5":(!a.support.htmlCommand&&!a.support.htmlMenuitem||typeof d=="boolean"&&d)&&a('menu[type="context"]').each(function(){this.id&&a.contextMenu({selector:"[contextmenu="+this.id+"]",items:a.contextMenu.fromMenu(this)})}).css("display","none");break;default:throw Error('Unknown operation "'+
