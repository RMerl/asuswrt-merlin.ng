...
function openAudioPlayer(c){for(var d=[],a=0;a<g_file_array.length;a++)getFileExt(g_file_array[a].furl)=="mp3"&&d.push(g_file_array[a]);if(d.length==0)alert("No audio files");else{for(var e="",b=0,a=0;a<d.length;a++){var k=d[a].furl;c==k&&(b=a);e+=k;a!=d.length-1&&(e+=",")}d=$("div#modalWindow");g_modal_url="/smb/css/audio.html?a="+c+"&alist="+e+"&index="+b+"&s=0";g_modal_window_width=480;g_modal_window_height=160;$("#jqmMsg").css("display","none");$("#jqmTitleText").text(m.getString("title_audioplayer"));
d&&d.jqmShow()}}
function openImageViewer(c){for(var d=[],a=0;a<g_file_array.length;a++){var e=getFileExt(g_file_array[a].furl);(e=="jpg"||e=="jpeg"||e=="png"||e=="gif")&&d.push(g_file_array[a])}if(d.length==0)alert(m.getString("msg_no_image_list"));else{for(a=e=0;a<d.length;a++)c==d[a].furl&&(e=a);c="";a=getPageSize();c+='<div id="image_slide_show" class="barousel unselectable" style="height: 0; width: 0; position: fixed; background-color: rgb(0, 0, 0); left: '+a[0]/2+"px; top: "+a[1]/2+'px; z-index: 2999;">';c+=
'<div class="barousel_image">';for(a=0;a<d.length;a++){var b=d[a].furl;c+=a==e?'<img src="" path="'+b+'" alt="" class="default"/>':'<img src="" path="'+b+'" alt="" class=""/>'}c+="</div>";c+='<div class="barousel_nav">';c+='<div class="barousel_content transparent" style="display: block; ">';for(a=0;a<d.length;a++)c+='<div class="',a==e&&(c+="default"),c+='" style="display: none; ">',c+='<p class="header">'+d[a].name+"</p>",c+="</div>";c+="</div>";c+="</div>";c+='<div class="barousel_loading" style="position:absolute;display:none;z-index=99;"><img src="/smb/css/load.gif" width="18px" height="18px"/></div>';
...
'" online="0">'+m.getString("btn_prevpage"),b+="</a>",b+="</div>",b+="</td></tr>",b+="</tbody>",b+="</table>",b+="</div>");for(d=0;d<a.length;d++)k=m.getString("table_filename")+": "+a[d].name,a[d].time!=""&&(k+="\n"+m.getString("table_time")+": "+a[d].time),b+='<div class="albumDiv" ',b+=' title="',b+=k,b+='">',b+='<table class="thumb-table-parent">',b+="<tbody>",b+="<tr><td>",b+='<div class="picDiv" popupmenu="',b+=c=="0"?"1":"0",b+='" uhref="',b+=a[d].furl,b+='">',b+=c=="2"?a[d].type=="usbdisk"?
...
b+=c,b+='" isdir="1" uhref="',b+=a[d].furl,b+='" title="',b+=a[d].name,b+='" online="',b+=a[d].online,b+='" ip="" mac="',b+=a[d].mac,b+='" uid="',b+=a[d].uid,b+='" freadonly="',b+=a[d].freadonly,b+='" fhidden="',b+=a[d].fhidden,b+=a[d].type=="usbdisk"?'" isusb="1"':'" isusb="0"',b+='">',b+=a[d].shortname,a[d].online=="0"&&c=="2"&&(b+="("+m.getString("title_offline")+")"),b+="</a>",b+="</div>",b+="</td></tr>",b+="<tr><td>",b+="</td></tr>",b+="</tbody>",b+="</table>",b+="</div>";for(d=0;d<e.length;d++)k=
m.getString("table_filename")+": "+e[d].name+"\n"+m.getString("table_time")+": "+e[d].time+"\n"+m.getString("table_size")+": "+e[d].size,b+='<div class="albumDiv"',b+=' title="',b+=k,b+='">',b+='<table class="thumb-table-parent">',b+="<tbody>",a=getFileExt(String(e[d].furl)),a.length>5&&(a=""),b+="<tr><td>",b+=c=="0"?'<div class="picDiv" popupmenu="1" uhref="':'<div class="picDiv" popupmenu="0" uhref="',b+=e[d].furl,b+='">',b+=a=="jpg"||a=="jpeg"||a=="png"||a=="gif"||a=="bmp"?'<div id="fileviewicon" class="imgfileDiv bicon">':
...
'<div id="fileviewicon" class="fileDiv bicon">',b+='<div class="selectDiv sicon"></div>',b+='<div class="selectHintDiv sicon"></div>',b+="</div></div>",b+="</td></tr>",b+="<tr><td>",b+='<div class="albuminfo" style="font-size:80%">',b+='<a id="list_item" qtype="1" isdir="0" uhref="',b+=e[d].furl,b+='" title="',b+=e[d].name,b+='" uid="',b+=e[d].uid,b+='" ext="',b+=a,b+='" freadonly="',b+=e[d].freadonly,b+='" fhidden="',b+=e[d].fhidden,b+='">',b+=e[d].shortname,b+="</a>",b+="</div>",b+="</td></tr>",
