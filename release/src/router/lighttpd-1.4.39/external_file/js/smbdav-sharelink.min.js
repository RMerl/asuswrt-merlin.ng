...
"D:href"&&(i=String(p[l].childNodes[0].nodeValue),n="",i.match(/^http/)&&(n=window.location.protocol+"//"+window.location.host),f=n+addPathSlash(c),i!=f?(i=i.replace(n,""),o=i.substring(i.lastIndexOf("/")+1,i.length),o!=""?(h=o,t=o=mydecodeURI(o)):i=""):i="");i!=""&&(r=="httpd/unix-directory"?g_folder_array.push({contenttype:r,furl:i,name:o,uname:h,shortname:t,online:u,time:v,size:w,ip:x,mac:y,uid:s,type:z,freadonly:A,fhidden:B,routersyncfolder:C}):g_file_array.push({contenttype:r,furl:i,name:o,uname:h,
shortname:t,online:u,time:v,size:w,ip:x,mac:y,uid:s,type:z,freadonly:A,fhidden:B,routersyncfolder:C}))}g_folder_array.sort(sortByName);g_file_array.sort(sortByName);h=addPathSlash(c);h!="/"&&(h=h.substring(0,h.length-1),h=h.substring(0,h.lastIndexOf("/")),h==""&&(h="/"));createThumbView(e,h,g_folder_array,g_file_array);g_storage.set(g_sharelink_openurl_key,c);$("div#fileview").scrollLeft(g_storage.get("contentscrollLeft"));$("div#fileview").scrollTop(g_storage.get("contentscrollTop"));closeJqmWindow(0);
d!=void 0&&d()}else a==501?doPROPFIND(c):alert(m.getString(a))},null,1)}catch(e){alert("catch error: "+e)}}
