...
int get_amas_wired_client_info(struct json_object *json_object_ptr, AMAS_DATA_FORMAT_T DATA_FORMAT, struct json_object *wiredClientListFileObj_in);
 ...
 * @param wiredClientListFileObj Input wired client JSON object content.
 * @return int Returns 1 on success (MAC found); returns 0 otherwise.
 */
int amas_re_get_pap_mac(const char *client_mac, char *pap_mac_buffer, struct json_object* wiredClientListFileObj);
