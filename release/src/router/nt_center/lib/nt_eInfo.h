...
struct eInfo mapInfo[] =
{
	...
	{"SYS_FW_NWE_VERSION_AVAILABLE_EVENT"        ,SYS_FW_NWE_VERSION_AVAILABLE_EVENT          ,TYPE_OF_IMPORTANT  ,ACT(AIHOME)    ,ACT_NOTIFY_DB, 1, PRI_LOW },
	...
	{"PROTECTION_MALICIOUS_SITE_EVENT"           ,PROTECTION_MALICIOUS_SITE_EVENT             ,TYPE_OF_IMPORTANT  ,ACT(AIHOME)    ,ACT_NOTIFY_DB | ACT_NOTIFY_EMAIL, 0, PRI_LOW },
