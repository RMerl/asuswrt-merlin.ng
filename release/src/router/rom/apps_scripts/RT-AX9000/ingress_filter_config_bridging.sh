...
bs /b/c port/index=lan3 ingress_filter[dhcp]={enabled=yes,action=host}
bs /b/c port/index=lan5 ingress_filter[dhcp]={enabled=yes,action=host}
...
bs /b/c port/index=lan3 ingress_filter[etype_arp]={enabled=yes,action=host}
bs /b/c port/index=lan5 ingress_filter[etype_arp]={enabled=yes,action=host}
...
bs /b/c port/index=lan3 ingress_filter[ip_frag]={enabled=yes,action=host}
bs /b/c port/index=lan5 ingress_filter[ip_frag]={enabled=yes,action=host}
...
bs /b/c port/index=lan3 ingress_filter[hdr_err]={enabled=yes,action=host}
bs /b/c port/index=lan5 ingress_filter[hdr_err]={enabled=yes,action=host}
...
bs /b/c port/index=lan3 ingress_filter[bcast]={enabled=yes,action=host}
bs /b/c port/index=lan5 ingress_filter[bcast]={enabled=yes,action=host}
...
bs /b/c port/index=wan0 ingress_filter[mcast]={enabled=yes,action=host}
...
bs /b/c port/index=lan3 ingress_filter[mcast]={enabled=yes,action=host}
bs /b/c port/index=lan5 ingress_filter[mcast]={enabled=yes,action=host}

bs /b/c port/index=wan0 ingress_filter[ip_mcast_control]={enabled=yes,action=host}
...
bs /b/c port/index=lan3 ingress_filter[ip_mcast_control]={enabled=yes,action=host}
bs /b/c port/index=lan5 ingress_filter[ip_mcast_control]={enabled=yes,action=host}

bs /b/c port/index=wan0 ingress_filter[igmp]={enabled=yes,action=host}
...
bs /b/c port/index=lan3 ingress_filter[igmp]={enabled=yes,action=host}
bs /b/c port/index=lan5 ingress_filter[igmp]={enabled=yes,action=host}
...
bs /b/c port/index=wan0 ingress_filter[mld]={enabled=yes,action=host}
...
bs /b/c port/index=lan3 ingress_filter[mld]={enabled=yes,action=host}
bs /b/c port/index=lan5 ingress_filter[mld]={enabled=yes,action=host}
...
bs /b/c port/index=wan0 ingress_filter[etype_802_1ag_cfm]={enabled=yes,action=host}
...
bs /b/c port/index=lan3 ingress_filter[etype_802_1ag_cfm]={enabled=yes,action=host}
bs /b/c port/index=lan5 ingress_filter[etype_802_1ag_cfm]={enabled=yes,action=host}
...
bs /b/c port/index=wan0 ingress_filter[etype_udef_0]={enabled=yes,action=host}
...
bs /b/c port/index=lan3 ingress_filter[etype_udef_0]={enabled=yes,action=host}
bs /b/c port/index=lan5 ingress_filter[etype_udef_0]={enabled=yes,action=host}
