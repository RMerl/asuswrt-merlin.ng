...
wl -i eth1 PM 0
wl -i eth1 stbc_tx 0
wl -i eth1 bw_cap 2g 1
wl -i eth1 bi 65535
wl -i eth1 mimo_txbw -1
wl -i eth1 frameburst 1
wl -i eth1 spatial_policy 1
wl -i eth1 txcore  -s 1 -c 3
wl -i eth1 band b
wl -i eth1 chanspec 1/20
wl -i eth1 he features 3
wl -i eth1 up
wl -i eth1 phy_forcecal 1
wl -i eth1 phy_watchdog 0
wl -i eth1 2g_rate -e 7 -s 1 -i 1 --ldpc -b 20
wl -i eth1 txpwr1 -1
wl -i eth1 phy_forcecal 1
wl -i eth1 pkteng_start wl -i eth5 mpc 0
wl -i eth1 down
wl -i eth1 country ALL
wl -i eth1 wsec 0
wl -i eth1 stbc_rx 1
...
wl -i eth1 txpwr1 -1
wl -i eth1 phy_forcecal 1
wl -i eth1 pkteng_stop rx
wl -i eth1 pkteng_stop tx
wl -i eth1 mpc 0
wl -i eth1 isup
wl -i eth1 interference
wl -i eth1 interference_override 0
wl -i eth1 pkteng_maxlen
wl -i eth1 ap
wl -i eth1 ssid ""
wl -i eth1 pkteng_start 00:11:22:33:44:55 tx 30 1563 0 00:90:4C:32:B0:00
...
wl -i eth2 ap
wl -i eth2 ssid ""
wl -i eth2 pkteng_start 00:11:22:33:44:55 tx 30 1563 0 30:17:AB:AB:A9:14
