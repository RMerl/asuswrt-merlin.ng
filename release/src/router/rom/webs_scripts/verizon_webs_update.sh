...
if [ "$forsq" == "1" ]; then
	...
	wget $wget_options https://dlcdnets.asus.com/pub/ASUS/LiveUpdate/Release/Wireless_SQ/wlan_update_verizon.zip -O /tmp/wlan_update.txt		
else
	echo "---- update real normal----" > /tmp/webs_upgrade.log
	wget $wget_options https://dlcdnets.asus.com/pub/ASUS/LiveUpdate/Release/Wireless/wlan_update_verizon.zip -O /tmp/wlan_update.txt
fi	
