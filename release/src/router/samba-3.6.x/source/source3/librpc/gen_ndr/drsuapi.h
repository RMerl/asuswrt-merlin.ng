...
union drsuapi_DsBindInfo {
	struct drsuapi_DsBindInfo24 info24;/* [case(24),subcontext(4)] */
	struct drsuapi_DsBindInfo28 info28;/* [case(28),subcontext(4)] */
	struct drsuapi_DsBindInfo48 info48;/* [case(48),subcontext(4)] */
	struct drsuapi_DsBindInfoFallBack FallBack;/* [default,subcontext(4)] */
}/* [nodiscriminant] */;
...
struct drsuapi_DsGetNCChangesMSZIPCtr1 {
	...
	struct drsuapi_DsGetNCChangesCtr1TS *ts;/* [subcontext_size(compressed_length),unique,compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length),subcontext(4)] */
}/* [nopush] */;
...
struct drsuapi_DsGetNCChangesXPRESSCtr1 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr1TS *ts;/* [subcontext(4),compression(NDR_COMPRESSION_XPRESS,compressed_length,decompressed_length),unique,subcontext_size(compressed_length)] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesXPRESSCtr6 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr6TS *ts;/* [unique,subcontext_size(compressed_length),subcontext(4),compression(NDR_COMPRESSION_XPRESS,compressed_length,decompressed_length)] */
}/* [nopush] */;
