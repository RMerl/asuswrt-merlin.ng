...
enum awsiotEventType {
	...
	EID_AWSIOT_UPDATE_WIREGUARD_MASTER_IP = 6,
	EID_AWSIOT_UNBIND_DEVICE = 7,
	EID_AWSIOT_MAX
};
...
#define AAE_AWSIOT_UPDATE_WIREGUARD_MASTER_IP_MSG	 "{\""AAE_AWSIOT_PREFIX"\":{\""AAE_IPC_EVENT_ID"\":%d, \"ip\":\"%s\"}}"
#define AAE_AWSIOT_UNBIND_DEVICE_MSG	 "{\""AAE_AWSIOT_PREFIX"\":{\""AAE_IPC_EVENT_ID"\":%d}}"
//#endif
...
#define AAE_HTTPD_DURATION_PREFIX "duration"
...
enum aaeHttpdEventType {
	...
	AAE_EID_HTTPD_DEL_PROVISION_PINCODE = 6,
	AAE_EID_HTTPD_MAX
};
...
#define AAE_HTTPD_GET_PROVISION_PINCODE_MSG	 "{\""AAE_HTTPD_PREFIX"\":{\""AAE_IPC_EVENT_ID"\":%d, \""AAE_HTTPD_DURATION_PREFIX"\":%d}}"
#define AAE_HTTPD_GET_PROVISION_PINCODE_RESP_MSG	 "{\""AAE_HTTPD_PREFIX"\":{\""AAE_IPC_EVENT_ID"\":%d, \""AAE_IPC_STATUS"\":\"%s\", \""PIN_CODE"\":\"%s\"}}"
#define AAE_HTTPD_DEL_PROVISION_PINCODE_MSG	 "{\""AAE_HTTPD_PREFIX"\":{\""AAE_IPC_EVENT_ID"\":%d}}"
#define AAE_HTTPD_DEL_PROVISION_PINCODE_RESP_MSG	 "{\""AAE_HTTPD_PREFIX"\":{\""AAE_IPC_EVENT_ID"\":%d, \""AAE_IPC_STATUS"\":\"%s\"}}"
//#endif
