...
#if defined(HND_ROUTER) && !defined(RTCONFIG_HND_ROUTER_AX_675X) && !defined(RTCONFIG_HND_ROUTER_AX_6756) && !defined(RTCONFIG_HND_ROUTER_BE_4916)
...
#define WGN_WL_BAND_6GH			4

#define WGN_MAX_NO_GUEST_NETWORK			8
#define WGN_MAXINUM_SUBNET_RULELIST			WGN_MAX_NO_GUEST_NETWORK
#define WGN_MAXINUM_VLAN_RULELIST			WGN_MAX_NO_GUEST_NETWORK
...
#define WGN_VLAN_RULE_WLANSET_SIZE		32
