...
#define WGN_VLAN_RULE_MAX_BUFFER_SIZE		1024 * WGN_MAX_NO_GUEST_NETWORK
#define WGN_SUBNET_RULE_MAX_BUFFER_SIZE		1024 * WGN_MAX_NO_GUEST_NETWORK

typedef struct wgn_subnet_rule_t 
{
#define WGN_SUBNET_RULE_NVRAM 				"subnet_rulelist"	
#define WGN_SUBNET_RULE_MAX_FIELDS			11
...
extern wgn_subnet_rule* wgn_subnet_list_get_from_content(char *content, wgn_subnet_rule *list, size_t max_list_size, size_t *ret_list_size);
...
#define WGN_VLAN_RULE_MAX_FIELDS		10	
...
extern wgn_vlan_rule* 	wgn_vlan_list_get_from_content(char *content, wgn_vlan_rule *list, size_t max_list_size, size_t *ret_list_size);
