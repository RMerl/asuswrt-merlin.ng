...
static const struct led_btn_table_s {
...
#endif
#if defined(RTAX82U) || defined(DSL_AX82U) || defined(GSAX3000) || defined(GSAX5400) || defined(TUFAX5400) || defined(GTAX6000) || defined(GT10) || defined(RTAX82U_V2) || defined(TUFAX5400_V2) || defined(GSBE18000) || defined(GSBE12000) || defined(GS7_PRO) || defined(GT7) || defined(GS7_PRO_MAX)
...
#if !defined(GTAX11000_PRO) && !defined(GTAXE16000) && !defined(GTAX6000) && !defined(GT10) && !defined(GSBE18000) && !defined(GSBE12000) && !defined(GS7_PRO) && !defined(GT7) && !defined(GS7_PRO_MAX)
...
#endif
#if defined(RTAX95Q) || defined(XT8PRO) || defined(BT12) || defined(BT10) || defined(BQ16) || defined(BQ16_PRO) || defined(BM68) || defined(XT8_V2) || defined(RTAXE95Q) || defined(ET8PRO) || defined(ET8_V2) || defined(RTAX56_XD4) || defined(XD4PRO) || defined(RTAX82_XD6) || defined(RTAX82_XD6S)  || defined(ET12) || defined(XT12) || defined(XD6_V2) || defined(XC5) || defined(BN12)
...
#endif
#if defined(RTBE96U) || defined(GTBE98) || defined(GTBE98_PRO) || defined(GTBE96) || defined(RTBE88U) || defined(RTBE86U) || defined(GTBE19000) || defined(GTBE19000AI) || defined(GTBE96_AI) || defined(GTBN98_PRO) || defined(GTBN96X) || defined(GTBN98) || defined(GTBN96)
	{ "led_10g_white_gpio",         &led_gpio_table[LED_10G_WHITE] },
#endif
	...
	{ "led_ar3012_dis_gpio",          &led_gpio_table[LED_AR3012_DIS] },
	{ "led_ar3012_rst_gpio",          &led_gpio_table[LED_AR3012_RST] },
	{ "led_poe_alert_gpio",           &led_gpio_table[LED_POE_ALERT] },
#endif
	...
	{ "led_afc2_gpio",		&led_gpio_table[LED_AFC2] },
#endif
#if defined(GTBE19000AI) || defined(GSBE18000) || defined(GS7_PRO) || defined(GTBE96_AI)
	{ "es_rst_gpio",		&led_gpio_table[ES_RESET] },
	{ "es_sop0_gpio",		&led_gpio_table[ES_SOP0] },
	{ "es_sop1_gpio",		&led_gpio_table[ES_SOP1] },
	{ "es_sop2_gpio",		&led_gpio_table[ES_SOP2] },
	{ "pwr_switch_gpio",	&led_gpio_table[PWR_SWITCH] },
...
#if defined(EBG19) || defined(EBG19P)
...
#elif defined(RTBE58U) || defined(TUFBE3600) || defined(RTBE58U_V2) || defined(TUFBE3600_V2) || defined(RTBE92U) || defined(RTBE95U) || defined(RTBE82U) || defined(TUFBE82) || defined(RTBE58U_PRO) || defined(RTCONFIG_MXL_826XX)
		/* set pinmux of GPIO 67 as 4 to enable GPIO mode */
		system("sw 0xff800554 0");
		system("sw 0xff800558 0x4043");
		system("sw 0xff80055c 0x21");
#elif defined(GTBE19000AI) || defined(GTBE96_AI)
		/* set pinmux of GPIO 59 as 4 to enable GPIO mode */
		system("sw 0xff800554 0");
		system("sw 0xff800558 0x403b");
		system("sw 0xff80055c 0x21");
...
#endif
{
...
#if (defined(RTAX9000) || defined(RTBE58U) || defined(TUFBE3600) || defined(RTBE58U_V2) || defined(TUFBE3600_V2) || defined(RTBE55) || defined(RTBE82U) || defined(TUFBE82) || defined(RTBE58U_PRO) || defined(RTCONFIG_MXL_826XX) || defined(RTBE58_GO) || defined(RTBE92U)) && !defined(RTCONFIG_BCM_MFG)
	if ((which == LED_WAN_NORMAL) && (mode == LED_ON)) {
#if defined(RTBE82U) || defined(TUFBE82) || defined(RTBE58U_PRO) || defined(RTBE58_GO) || defined(RTBE55) || defined(GT7) || defined(GS7_PRO_MAX)
	...
	if (nvram_match("AllLED", "0") && nvram_match("asus_mfg", "0") && (mode == LED_ON)
		&& (which != PWR_USB)
#if defined(GTBE19000AI) || defined(GSBE18000) || defined(GS7_PRO) || defined(GTBE96_AI)
		&& (which != ES_RESET)
		&& (which != ES_SOP0)
		...
		dbg2("skip turning on LED %d (0x%x)\n", gpio_nr, gpio_nr);
		return 0;
	}
#endif
...
int ethctl_get_phy(const char *ifname)
{
	struct ifreq ifr;
	struct ethctl_data ethctl;
	int skfd;
...
// turn into a general way?
	...
	foreach(word, nvram_safe_get("lan_ifnames"), next) {
		...
		if (!strcmp(word, "eth1") && is_rtl8372_boardid())
			continue;
#endif
...
int lanport_ctrl(int ctrl)
{
	...
	foreach(word, nvram_safe_get("lanports"), next) {
		...
		if ((nvram_get_int("ext_phy_model") == EXT_PHY_BCM54991) &&
			ctrl && (safe_atoi(word) == 5)) {
			if (bootup_skip)
				bootup_skip = 0;
			else
				doSystem("ethctl eth%d phy-reset", safe_atoi(word));
		}
#endif
#if defined(GTAXE16000) || defined(GTBE98) || defined(GTBE98_PRO) || defined(GTAX11000_PRO) || defined(RTAX88U_PRO) || defined(RTBE96U) || defined(GTBE96) || defined(GTBE19000) || defined(GTBE19000AI) || defined(GTBE96_AI) || defined(GTBN98_PRO) || defined(GTBN96X) || defined(GTBN98) || defined(GTBN96)
#if defined(GTBE98) || defined(GTBE98_PRO) || defined(GTBE96) || defined(GTBE19000) || defined(GTBE19000AI) || defined(GTBE96_AI)
		if (is_rtl8372_boardid() && safe_atoi(word) == 1)
			continue;
		if ((is_rtl8372_boardid() && safe_atoi(word) == 3) || (!is_rtl8372_boardid() && safe_atoi(word) == 6))
#else
		if(safe_atoi(word) == 5 || safe_atoi(word) == 6)
#endif
		{
			if(ctrl) {
				_dprintf("%s: perform PHY reset upon eth%d...\n", __func__, safe_atoi(word));
				doSystem("ethctl eth%d phy-reset", safe_atoi(word));
			}
		}
		else
...
#endif
		doSystem("ethctl eth%d phy-power %s", safe_atoi(word), ctrl ? "up" : "down");
#else
		mask |= (0x0001<<atoi(word));
#endif
	}
...
#if defined(GTBE98) || defined(GTBE98_PRO) || defined(EBG19P) || defined(GTBE96) || defined(GTBE19000) || defined(GTBE19000AI) || defined(GTBE96_AI)
#if !defined(EBG19)
	if (is_rtl8372_boardid())
#endif
	if (ctrl)
