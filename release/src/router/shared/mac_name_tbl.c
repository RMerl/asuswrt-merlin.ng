...
char *search_mnt(char *mac)
{
	...
	sprintf(s_mac, "%C%C:%C%C:%C%C:%C%C:%C%C:%C%C\0", upperMac[0], upperMac[1], upperMac[2], upperMac[3], upperMac[4], upperMac[5], upperMac[6], upperMac[7], upperMac[8], upperMac[9], upperMac[10], upperMac[11]);
