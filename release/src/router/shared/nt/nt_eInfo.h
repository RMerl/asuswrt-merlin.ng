...
{
	/* RESERVATION EVENT */
	{"RESERVATION_MAIL_REPORT_EVENT"             ,RESERVATION_MAIL_REPORT_EVENT               ,TYPE_OF_RSV        ,-1             ,ACT_NOTIFY_RSV, 0, PRI_RSV },
	{"RESERVATION_MAIL_CONFIRM_EVENT"            ,RESERVATION_MAIL_CONFIRM_EVENT              ,TYPE_OF_RSV        ,-1             ,ACT_NOTIFY_RSV, 0, PRI_RSV },
	/* ------------------------------
	   ### System ###
	---------------------------------*/
	...
	{"SYS_LAN_PORT_IN_EVENT"                     ,SYS_LAN_PORT_IN_EVENT                       ,TYPE_OF_TIPS       ,ACT(AIHOME)    ,ACT_NOTIFY_DB, 1, PRI_LOW },
	{"SYS_LAN_PORT_OUT_EVENT"                    ,SYS_LAN_PORT_OUT_EVENT                      ,TYPE_OF_TIPS       ,ACT(AIHOME)    ,ACT_NOTIFY_DB, 1, PRI_LOW },
