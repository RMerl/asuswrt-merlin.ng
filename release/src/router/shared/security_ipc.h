...
#include <rtconfig.h> // for RTCONFIG flag
...
#define EAPD_WKSP_QOSMGMT_UDP_PORT	51100
#define EAPD_WKSP_QOSMGMT_UDP_RPORT	EAPD_WKSP_QOSMGMT_UDP_PORT
#define EAPD_WKSP_QOSMGMT_UDP_SPORT	EAPD_WKSP_QOSMGMT_UDP_PORT + EAPD_WKSP_SPORT_OFFSET
#endif
