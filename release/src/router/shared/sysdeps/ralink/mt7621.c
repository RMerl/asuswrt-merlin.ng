...
#if defined(RTN14U) || defined(RTAC51U) ||defined(RTN54U) || defined(RPAC56)
/// RT-N14U mapping
enum {
	WAN_PORT=0,
	LAN1_PORT=1,
...
ralink_gpio_write_bit(int idx, int value)
{
	...
	{              
#if defined(RTN14U) || defined(RTAC52U) || defined(RTAC51U) || defined(RTN11P) || defined(RTN54U)  || defined (RPAC56)//wlan led
