...
#define _WPA_CIPHER_AES_128_CMAC_ BIT(5)
#define _WPA_CIPHER_GCMP_ BIT(6)
#define _WPA_CIPHER_SMS4_ BIT(7)
#define _WPA_CIPHER_GCMP_256_ BIT(8)
#define _WPA_CIPHER_CCMP_256_ BIT(9)
#define _WPA_CIPHER_BIP_GMAC_128_ BIT(11)
#define _WPA_CIPHER_BIP_GMAC_256_ BIT(12)
#define _WPA_CIPHER_BIP_CMAC_256_ BIT(13)
#define _WPA_CIPHER_GTK_NOT_USED_ BIT(14)
...
#define _RSN_AKM_SAE_PSK_EXT_ BIT(6)
#endif
