...
function initial(){
	...
	else if(based_modelid == "RT-AC86U" || based_modelid == "AC2900" || based_modelid == "RT-AX88U" || based_modelid == "GT-AX11000" || based_modelid == "RT-AX92U" || based_modelid == "RT-AX95Q" || based_modelid == "RT-AX58U" || based_modelid == "TUF-AX3000" || based_modelid == "RT-AX56U"){
		document.getElementById("ctf_tr").style.display = "none";
	}
