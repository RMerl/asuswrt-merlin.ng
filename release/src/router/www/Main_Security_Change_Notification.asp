...
<input type="hidden" name="current_page" value="Main_Security_Change_Notification.asp">
<input type="hidden" name="next_page" value="Main_Security_Change_Notification.asp">
