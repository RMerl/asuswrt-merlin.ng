    ...
    <script>
        ...
        function validForm() {
            ...
            if (document.form.qos_enable.value == 0 && document.form.qos_enable_orig.value == 0) {
                if (geforceNow_support || ark_qoe_enable) {
        ...
        function genMain_table() {
            ...
            code += '</div>';
            code += '</td>';
            code += '<td style="border-bottom:2px solid #000;text-align:right;"><input type="text" id="download_rate" class="input_6_table" maxlength="6" onkeypress="return validator.bandwidth_code(this, event);" onkeyup="check_field();"><span style="margin: 0 5px;color:var(--text-primary, #FFF);">Mb/s</span></td>';
            code += '<td style="border-bottom:2px solid #000;text-align:right;"><input type="text" id="upload_rate" class="input_6_table" maxlength="6" onkeypress="return validator.bandwidth_code(this, event);" onkeyup="check_field();"><span style="margin: 0 5px;color:var(--text-primary, #FFF);">Mb/s</span></td>';
