...
function initial(){
	...
	if((isSwMode("RP") || isSwMode("mb")) && (wl_unit_value == wlc_band_value) && wl_subunit_value != '1' && !concurrep_support){
		_change_wl_unit(wl_unit_value);
	}
	
	if(isSwMode("RP") && concurrep_support && wl_subunit_value != '1'){
		_change_wl_unit(wl_unit_value);
	}
	...
	if(concurrep_support && (isSwMode("RP") || isSwMode("ew"))){
		inputCtrl(document.form.wl_nmode_x, 0);
...
function _change_wl_unit(val){
	...
	if(!concurrep_support && (isSwMode("RP") || isSwMode("mb")) && val == wlc_band_value)
		document.form.wl_subunit.value = 1;
	else
		document.form.wl_subunit.value = -1;

	if(concurrep_support && (isSwMode("RP") || isSwMode("mb") || isSwMode("ew")))
		document.form.wl_subunit.value = 1;
