...
#WDSAPList{
	...
	*width:259px;
	...
	backdrop-filter: blur(17.6688px);
	border-radius: 8px;
}
#WDSAPList div{
	background-color:rgba(245, 245, 245, 1);
...
function show_wl_wdslist(){
	...
	if(wl_wdslist_row.length == 1){
		code +='<tr><td style=""><#IPConnection_VSList_Norule#></td>';
	}		
	else{
						...
						<table width="760px" border="0" cellpadding="4" cellspacing="0" class="FormTitle" id="FormTitle">
							...
							<tr>
								<td  valign="top">
									...
									<div class="warning_title"><#ADSL_FW_note#></div>
									<div class="explain_desc" style="">
									...
									<div id="wl_bw_hint" class="warning_desc" style="font-size:13px;"><#WLANConfig11b_display41_sectiondesc#></div>
									<div id="wl_ch_hint" class="warning_desc" style="font-size:13px;"><#WLANConfig11b_display42_sectiondesc#></div>
