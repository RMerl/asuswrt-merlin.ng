...
function initial(){
	...
	if(wl_info.band5g_2_support || wl_info.band6g_support){
		if(band6g_support){
			...
			document.getElementById("wl_6g_mac").style.display = "";
		}
								...
								<td bgcolor="#4D595D" valign="top">
									...
									<table id="MainTable1" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
										...
										<tr id="wl_2g_mac">
											<th>2.4 GHz MAC</th>
											<td>
												<input type="text" maxlength="17" class="input_20_table" id="wl0_hwaddr" name="wl0_hwaddr" value="<% nvram_get("wl3_hwaddr"); %>" readonly autocorrect="off" autocapitalize="off">
											</td>		
										</tr>					
										<tr id="wl_5g_mac">
											<th id="wl_5g_mac_th1">5 GHz MAC</th>
											<td>
												<input type="text" maxlength="17" class="input_20_table" id="wl1_hwaddr" name="wl1_hwaddr" value="<% nvram_get("wl0_hwaddr"); %>" readonly autocorrect="off" autocapitalize="off">
											</td>		
										</tr>	
										<tr id="wl_5g_mac_2" style="display:none">
											<th id="5g2_title">5 GHz-2 MAC</th>
											<td>
												<input type="text" maxlength="17" class="input_20_table" id="wl2_hwaddr" name="wl2_hwaddr" value="<% nvram_get("wl1_hwaddr"); %>" readonly autocorrect="off" autocapitalize="off">
											</td>		
										</tr>
										<tr id="wl_6g_mac" style="display:none">
											<th id="5g2_title">6 GHz MAC</th>
											<td>
