			...
			<tr id="wps_band_tr">
				...
				<td  id="wps_select" style="display:none">
						<select name="wps_unit" class="input_option" onChange="SelectBand();">
							<option id="wps_opt0" class="content_input_fd" value="3" <% nvram_match("wps_band_x", "3","selected"); %>>2.4 GHz</option>
							...
							<option id="wps_opt3" class="content_input_fd" value="2" <% nvram_match("wps_band_x", "2","selected"); %>>6 GHz</option>
						</select>			
				</td>
			</tr>
