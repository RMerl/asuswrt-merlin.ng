...
(function(){
	...
	[wl_ifnames[0], wl_ifnames[1], wl_ifnames[2]] = [wl_ifnames[2], wl_ifnames[0], wl_ifnames[1]];
	for(let i=0; i< wl_info.wl_if_total; i++){
		let shift = i;
		
		if(based_modelid == 'GT10' || based_modelid == 'RT-AX9000'){		// wireless介面順序變換調整
			shift = (i + 2) % 3;		// wireless unit ['2', '0', '1']			
		}
